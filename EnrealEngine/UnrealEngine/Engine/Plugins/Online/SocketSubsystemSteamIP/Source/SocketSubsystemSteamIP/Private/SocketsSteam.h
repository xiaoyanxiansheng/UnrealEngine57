...
public:
	 ...
	 */
	FSocketSteam(ISteamNetworking* InSteamNetworkingPtr, const CSteamID& InLocalSteamId, const FString& InSocketDescription, const FName& InSocketProtocol) :
	...
	{
		SocketSubsystem = (FSocketSubsystemSteam*)ISocketSubsystem::Get(STEAMIP_SUBSYSTEMNAME);
	}
