...
DECLARE_MULTICAST_DELEGATE_FourParams(FOnVoiceChatAfterCaptureAudioReadDelegate2, const FString& /* ChannelName */, TArrayView<int16> /* PcmSamples */, int /* SampleRate */, int /* Channels */);
DECLARE_MULTICAST_DELEGATE_FiveParams(FOnVoiceChatBeforeCaptureAudioSentDelegate2, const FString& /* ChannelName */, TArrayView<const int16> /* PcmSamples */, int /* SampleRate */, int /* Channels */, bool /* bIsSpeaking */);
...
public:
	 ...
	 * @param Position
	 */
	virtual void Set3DPosition(const FString& ChannelName, const FVector& Position) = 0;
	 ...
	 */
	virtual FDelegateHandle RegisterOnVoiceChatAfterCaptureAudioReadDelegate(const FOnVoiceChatAfterCaptureAudioReadDelegate2::FDelegate& Delegate) = 0;
	virtual void UnregisterOnVoiceChatAfterCaptureAudioReadDelegate(FDelegateHandle Handle) = 0;

	virtual FDelegateHandle RegisterOnVoiceChatBeforeCaptureAudioSentDelegate(const FOnVoiceChatBeforeCaptureAudioSentDelegate2::FDelegate& Delegate) = 0;
	...
	UE_DEPRECATED(5.6, "Please pass a FOnVoiceChatBeforeCaptureAudioSentDelegate2, which adds the ChannelName param")
	virtual FDelegateHandle RegisterOnVoiceChatAfterCaptureAudioReadDelegate(const FOnVoiceChatAfterCaptureAudioReadDelegate::FDelegate& Delegate) final
	{
		return RegisterOnVoiceChatAfterCaptureAudioReadDelegate(FOnVoiceChatAfterCaptureAudioReadDelegate2::FDelegate::CreateLambda([Delegate](const FString& /* ChannelName */, TArrayView<int16> PcmSamples, int SampleRate, int Channels)
			{
				Delegate.ExecuteIfBound(PcmSamples, SampleRate, Channels);
			}));
	}

	UE_DEPRECATED(5.6, "Please pass a FOnVoiceChatBeforeCaptureAudioSentDelegate2, which adds the ChannelName param")
		virtual FDelegateHandle RegisterOnVoiceChatBeforeCaptureAudioSentDelegate(const FOnVoiceChatBeforeCaptureAudioSentDelegate::FDelegate& Delegate) final
	{
		return RegisterOnVoiceChatBeforeCaptureAudioSentDelegate(FOnVoiceChatBeforeCaptureAudioSentDelegate2::FDelegate::CreateLambda([Delegate](const FString& /* ChannelName */, TArrayView<const int16> PcmSamples, int SampleRate, int Channels, bool bIsSpeaking)
			{
				Delegate.ExecuteIfBound(PcmSamples, SampleRate, Channels, bIsSpeaking);
			}));
	}
