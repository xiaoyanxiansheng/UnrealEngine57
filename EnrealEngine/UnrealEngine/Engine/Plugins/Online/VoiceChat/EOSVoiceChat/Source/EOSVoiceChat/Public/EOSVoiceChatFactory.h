...
class FEOSVoiceChatFactory : public IModularFeature, public FSelfRegisteringExec
{
public:
	...
	EOSVOICECHAT_API IVoiceChatPtr CreateInstance();
	...
	EOSVOICECHAT_API IVoiceChatPtr CreateInstanceWithPlatform(const IEOSPlatformHandlePtr& PlatformHandle);

	// ~Begin FSelfRegisteringExec
#if UE_ALLOW_EXEC_COMMANDS
	EOSVOICECHAT_API virtual bool Exec(UWorld* InWorld, const TCHAR* Cmd, FOutputDevice& Ar) override;
#endif
