...
class FEpicProductUserIdResolverEOSGS : public TOnlineComponent<IEpicProductUserIdResolver>
{
public:
	FEpicProductUserIdResolverEOSGS(class FOnlineServicesEOSGS& InServices);
