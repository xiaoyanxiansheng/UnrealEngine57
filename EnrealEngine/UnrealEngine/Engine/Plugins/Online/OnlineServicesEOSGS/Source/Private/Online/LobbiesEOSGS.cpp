...
void FLobbiesEOSGS::Initialize()
{
	...
	LobbyPrerequisites = MakeShared<FLobbyPrerequisitesEOS>(
		LobbyInterfaceHandle,
		Services.Get<IEpicProductUserIdResolver>(),
		FLobbyBucketIdEOS(SDKManager->GetProductName(), GetBuildUniqueId()),
		SchemaRegistry);
