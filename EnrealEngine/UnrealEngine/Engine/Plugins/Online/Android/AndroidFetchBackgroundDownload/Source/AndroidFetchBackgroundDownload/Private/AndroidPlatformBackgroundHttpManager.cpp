...
#include "AndroidJniDownloadUEDownloadWorker.h"
...
namespace FAndroidBackgroundDownloadDelegates
{
	...
	DECLARE_DELEGATE_SixParams(FAndroidBackgroundDownload_OnMetrics, jobject /*UnderlyingWorker*/, FString /*RequestID*/, int64_t /*TotalBytesDownloaded*/, int64_t /*DownloadDuration*/, int64_t /*DownloadStartTimeUTC*/, int64_t /*DownloadEndTimeUTC*/);
...
void FAndroidPlatformBackgroundHttpManager::Java_OnDownloadMetrics(jobject UnderlyingWorker, FString RequestID, int64_t TotalBytesDownloaded, int64_t DownloadDuration, int64_t DownloadStartTimeUTC, int64_t DownloadEndTimeUTC)
{
	...
	if (CompletedRequest.IsValid())
	{
		...
		MetricsExtended.TotalBytesDownloaded = TotalBytesDownloaded;
		MetricsExtended.DownloadDuration = (float)((double)DownloadDuration / 1000.0f);
		MetricsExtended.FetchStartTimeUTC = FDateTime::FromUnixTimestampDecimal((double)DownloadStartTimeUTC / 1000.0f);
		MetricsExtended.FetchEndTimeUTC = FDateTime::FromUnixTimestampDecimal((double)DownloadEndTimeUTC / 1000.0f);

		CompletedRequest->NotifyRequestMetricsExtendedAvailable(MetricsExtended);
	}
}
...
void FAndroidPlatformBackgroundHttpManager::FJavaClassInfo::Initialize()
{
	...
	if (!bHasInitialized)
	{
		...
		if (ensureAlwaysMsgf(Env, TEXT("Invalid JNIEnv! Skipping Initialize!")))
		{
			...
			{
				UEDownloadWorkerClass = UE::Jni::Class<UE::Jni::Download::FUEDownloadWorker>;
				check(UEDownloadWorkerClass);
				...
				check(DownloadDescriptionClass);
			}
...
void JNICALL UE::Jni::Download::FUEDownloadWorker::nativeAndroidBackgroundDownloadOnWorkerStart(JNIEnv* jenv, jobject thiz, jstring WorkID)
{
...
void JNICALL UE::Jni::Download::FUEDownloadWorker::nativeAndroidBackgroundDownloadOnWorkerStop(JNIEnv* jenv, jobject thiz, jstring WorkID)
{
...
void JNICALL UE::Jni::Download::FUEDownloadWorker::nativeAndroidBackgroundDownloadOnProgress(JNIEnv* jenv, jobject thiz, jstring TaskID, jlong BytesWrittenSinceLastCall, jlong TotalBytesWritten)
{
...
void JNICALL UE::Jni::Download::FUEDownloadWorker::nativeAndroidBackgroundDownloadOnComplete(JNIEnv* jenv, jobject thiz, jstring TaskID, jstring CompleteLocation, jboolean bWasSuccess)
{
	FString RequestID = FJavaHelper::FStringFromParam(jenv, TaskID);
...
void JNICALL UE::Jni::Download::FUEDownloadWorker::nativeAndroidBackgroundDownloadOnMetrics(JNIEnv* jenv, jobject thiz, jstring TaskID, jlong TotalBytesDownloaded, jlong DownloadDuration, jlong DownloadStartTimeUTC, jlong DownloadEndTimeUTC)
{
	FString RequestID = FJavaHelper::FStringFromParam(jenv, TaskID);
	...
	int64_t ConvertedDownloadStartTimeUTC = static_cast<uint64_t>(DownloadStartTimeUTC);
	int64_t ConvertedDownloadEndTimeUTC = static_cast<uint64_t>(DownloadEndTimeUTC);

	FAndroidBackgroundDownloadDelegates::AndroidBackgroundDownload_OnMetrics.ExecuteIfBound(thiz, RequestID, ConvertedTotalBytesDownloaded, ConvertedDownloadDuration, ConvertedDownloadStartTimeUTC, ConvertedDownloadEndTimeUTC);
}

void JNICALL UE::Jni::Download::FUEDownloadWorker::nativeAndroidBackgroundDownloadOnAllComplete(JNIEnv* jenv, jobject thiz, jboolean bDidAllRequestsSucceed)
{
...
void JNICALL UE::Jni::Download::FUEDownloadWorker::nativeAndroidBackgroundDownloadOnTick(JNIEnv* jenv, jobject thiz)
{
