...
public class FetchManager implements FetchDownloadProgressOwner, FetchEnqueueResultListener
{
	...
	public static synchronized FetchManager GetSharedManager()
	{
...
//		synchronized(this)
	...
	private synchronized void CompleteDownload(DownloadDescription DownloadDesc, ECompleteReason CompleteReason, boolean CheckForAllCompleted)
	{
		...
		{
			long ElapsedDownloadTime = DownloadFinishTime - DownloadDesc.DownloadStartTime;

			DownloadDuration = ElapsedDownloadTime - DownloadDesc.TotalPausedTime;
		}

		DownloadDesc.ProgressListener.OnDownloadMetrics(DownloadDesc.RequestID, DownloadDesc.TotalDownloadedBytes, DownloadDuration, DownloadDesc.DownloadStartTime, DownloadFinishTime);
	...
	private void SendAllDownloadsCompleteNotification(DownloadProgressListener ProgressListener, boolean bForceFailure)
	{
		...
		{
			AllDownloadsCompletedListener.OnAllDownloadsCompleted(bDidAllSucceed);
		}
	}
	...
	public synchronized void SetAllDownloadsCompletedListener(@NonNull FetchAllDownloadsCompletedListener Listener)
	{
	...
	private static volatile FetchManager SharedManager = new FetchManager();
	
	private volatile Fetch FetchInstance = null;

	private volatile FetchRequestProgressListener FetchListener = null;
	private volatile FetchAllDownloadsCompletedListener AllDownloadsCompletedListener = null;
	...
	public interface FetchAllDownloadsCompletedListener
	{
