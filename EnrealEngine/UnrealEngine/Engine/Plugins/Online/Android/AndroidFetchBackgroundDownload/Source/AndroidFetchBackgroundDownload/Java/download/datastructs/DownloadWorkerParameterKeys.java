...
public class DownloadWorkerParameterKeys
{
	...
	public final static String NOTIFICATION_CONTENT_AIRPLANE_MODE_TEXT_KEY = "NotificationContentAirplaneModeText";
	public final static String NOTIFICATION_CONTENT_DATA_SAVER_ENABLED_TEXT_KEY = "NotificationContentDataSaverEnabledText";
