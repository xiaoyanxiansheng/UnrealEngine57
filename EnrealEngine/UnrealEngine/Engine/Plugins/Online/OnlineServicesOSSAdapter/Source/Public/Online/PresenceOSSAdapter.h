...
public:
	...
	ONLINESERVICESOSSADAPTER_API static EUserPresenceStatus StatusV1toV2(EOnlinePresenceState::Type Status);
	ONLINESERVICESOSSADAPTER_API static EOnlinePresenceState::Type StatusV2toV1(EUserPresenceStatus Status);

protected:
	const FAuthOSSAdapter* Auth;
	IOnlinePresencePtr PresenceInt;

	TSharedRef<FUserPresence> PresenceV1toV2(FAccountId Accountid, FOnlineUserPresence& Presence);
