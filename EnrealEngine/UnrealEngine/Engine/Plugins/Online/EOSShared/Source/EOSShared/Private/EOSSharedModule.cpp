...
{
	GConfig->GetArray(CONFIG_SECTION_NAME, TEXT("SuppressedLogStrings"), SuppressedLogStrings_Log, GEngineIni);
	GConfig->GetArray(CONFIG_SECTION_NAME, TEXT("SuppressedLogCategories"), SuppressedLogCategories_Log, GEngineIni);
	GConfig->GetArray(CONFIG_SECTION_NAME, TEXT("SuppressedLogStrings_VeryVerbose"), SuppressedLogStrings_VeryVerbose, GEngineIni);
	GConfig->GetArray(CONFIG_SECTION_NAME, TEXT("SuppressedLogCategories_VeryVerbose"), SuppressedLogCategories_VeryVerbose, GEngineIni);
}
