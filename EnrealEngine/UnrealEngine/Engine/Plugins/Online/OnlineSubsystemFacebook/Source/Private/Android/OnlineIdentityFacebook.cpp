...
void JNICALL UE::Jni::FFacebookLogin::nativeLoginComplete(JNIEnv* jenv, jobject thiz, jsize responseCode, jstring accessToken, Java::Lang::TArray<jstring>* grantedPermissions, Java::Lang::TArray<jstring>* declinedPermissions)
{
...
void JNICALL UE::Jni::FFacebookLogin::nativeLogoutComplete(JNIEnv* jenv, jobject thiz, jsize responseCode)
{
