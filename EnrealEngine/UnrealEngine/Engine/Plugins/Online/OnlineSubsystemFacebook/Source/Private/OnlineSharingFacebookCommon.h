...
private:
	...
	class FFacebookPermissionsJson : public FJsonSerializable
	{
		public:
			...
			public:
				...
				BEGIN_JSON_SERIALIZER
					JSON_SERIALIZE(PERM_JSON_PERMISSION_NAME, Name);
					JSON_SERIALIZE(PERM_JSON_PERMISSION_STATUS, Status);
				END_JSON_SERIALIZER
			};
			...
			BEGIN_JSON_SERIALIZER
				JSON_SERIALIZE_ARRAY_SERIALIZABLE(PERM_JSON_PERMISSIONS, Permissions, FFacebookPermissionJson);
			END_JSON_SERIALIZER
	};
