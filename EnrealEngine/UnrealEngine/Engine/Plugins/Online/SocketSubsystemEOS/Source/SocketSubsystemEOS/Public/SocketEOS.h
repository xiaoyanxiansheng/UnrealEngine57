...
private:
	...
	/** Name of the NetDriver that will use the socket */
	FString SocketName;
	...
	/** Delegate fired when the EOS SDK network status changes */
	FDelegateHandle NetworkStatusChangedDelegateHandle;
#endif
};
