...
{
	[GIDSignIn.sharedInstance signInWithPresentingViewController:(UIViewController*)[IOSAppDelegate GetDelegate].IOSController
							hint:nil
		...
		else
		{
			...
			else
			{
				[User addScopes: MissingScopes 
					 presentingViewController: (UIViewController*)[IOSAppDelegate GetDelegate].IOSController
