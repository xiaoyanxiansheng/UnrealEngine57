...
#include "OnlineJniGoogleLogin.h"
...
bool FGoogleLoginWrapper::Init(const FString& ServerClientId, bool bRequestServerAuthCode)
{
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (!GoogleLoginInstance)
		{
			...
			InitMethod = FJavaWrapper::FindMethod(Env, UE::Jni::Class<UE::Jni::FGoogleLogin>, "Init", "(Ljava/lang/String;Z)Z", false);
			UE_CLOG_ONLINE_IDENTITY(InitMethod == nullptr, Error, TEXT("Failed to find Init in GoogleLogin class"));
			LoginMethod = FJavaWrapper::FindMethod(Env, UE::Jni::Class<UE::Jni::FGoogleLogin>, "Login", "([Ljava/lang/String;)V", false);
			UE_CLOG_ONLINE_IDENTITY(LoginMethod == nullptr, Error, TEXT("Failed to find Login in GoogleLogin class"));
			LogoutMethod = FJavaWrapper::FindMethod(Env, UE::Jni::Class<UE::Jni::FGoogleLogin>, "Logout", "()V", false);
...
void JNICALL UE::Jni::FGoogleLogin::nativeLoginSuccess(JNIEnv* jenv, jobject thiz, jstring InUserId, jstring InGivenName, jstring InFamilyName, jstring InDisplayName, jstring InPhotoUrl, jstring InIdToken, jstring InServerAuthCode)
{
...
void JNICALL UE::Jni::FGoogleLogin::nativeLoginFailed(JNIEnv* jenv, jobject thiz, jint ResponseCode)
{
...
void JNICALL UE::Jni::FGoogleLogin::nativeLogoutComplete(JNIEnv* jenv, jobject thiz, jsize responseCode)
{
