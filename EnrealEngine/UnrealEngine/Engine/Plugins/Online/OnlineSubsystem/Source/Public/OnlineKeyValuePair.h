...
public:
	...
	inline FOnlineKeyValuePairs() {}
	inline FOnlineKeyValuePairs(FOnlineKeyValuePairs&& Other) : Super(MoveTemp(Other)) {}
	inline FOnlineKeyValuePairs(const FOnlineKeyValuePairs&  Other) : Super(Other) {}
	inline FOnlineKeyValuePairs& operator=(FOnlineKeyValuePairs&& Other) { Super::operator=(MoveTemp(Other)); return *this; }
	inline FOnlineKeyValuePairs& operator=(const FOnlineKeyValuePairs&  Other) { Super::operator=(Other); return *this; }
...
public:
	...
	*/
	...
	inline void Increment(TYPE IncBy)
	{
		checkSlow(IsNumeric());
		if (Type == ENUM_TYPE)
		{
	 ...
	 */
	template<typename TYPE, EOnlineKeyValuePairDataType::Type ENUM_TYPE>
	inline void Decrement(TYPE DecBy)
	{
		checkSlow(IsNumeric());
		if (Type == ENUM_TYPE)
		{
