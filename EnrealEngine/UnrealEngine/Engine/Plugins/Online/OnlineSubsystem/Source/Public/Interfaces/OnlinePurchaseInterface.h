...
public:
		...
		: public FJsonSerializable
	{
		...
		BEGIN_JSON_SERIALIZER
			JSON_SERIALIZE("itemName", ItemName);
			JSON_SERIALIZE("uniqueItemId", UniqueId);
			JSON_SERIALIZE("validationInfo", ValidationInfo);
		END_JSON_SERIALIZER
	};
		...
		: public FJsonSerializable
	{
		...
		BEGIN_JSON_SERIALIZER
			...
			JSON_SERIALIZE("offerId", OfferId);
			JSON_SERIALIZE("quantity", Quantity);
			JSON_SERIALIZE_ARRAY_SERIALIZABLE("items", LineItems, FLineItemInfo);
		END_JSON_SERIALIZER
	};
	...
	BEGIN_JSON_SERIALIZER
		...
		JSON_SERIALIZE_ARRAY_SERIALIZABLE("receiptList", ReceiptOffers, FReceiptOfferEntry);
	END_JSON_SERIALIZER
