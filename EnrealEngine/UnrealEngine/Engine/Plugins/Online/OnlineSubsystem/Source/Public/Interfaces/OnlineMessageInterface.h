...
public:
	 ...
	 */
	UE_API void ToBytes(TArray<uint8>& OutBytes) const;
	 ...
	 */
	UE_API void FromBytes(const TArray<uint8>& InBytes);
	 ...
	 */
	UE_API void ToJson(FJsonObject& OutJsonObject) const;
	 ...
	 */
	UE_API FString ToJsonStr() const;
	 ...
	 */
	UE_API void FromJson(const FJsonObject& JsonObject);
	 ...
	 */
	UE_API void FromJsonStr(const FString& JsonStr);
	 ...
	 */
	UE_API bool GetAttribute(const FString& AttrName, FVariantData& OutAttrValue) const;
	 ...
	 */
	UE_API void SetAttribute(const FString& AttrName, const FVariantData& AttrValue);
