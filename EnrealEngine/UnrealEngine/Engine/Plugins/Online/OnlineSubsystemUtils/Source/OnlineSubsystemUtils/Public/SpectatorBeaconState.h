...
class USpectatorBeaconState : public UObject
{
	GENERATED_UCLASS_BODY()
		...
		*/
		UE_API virtual bool InitState(int32 InMaxReservations, FName InSessionName);
	...
	*/
	UE_API virtual bool AddReservation(const FSpectatorReservation& ReservationRequest);
	...
	*/
	UE_API virtual bool RemoveReservation(const FUniqueNetIdRepl& Spectator);
	...
	*/
	UE_API void RegisterAuthTicket(const FUniqueNetIdRepl& InSpectatorId, const FString& InAuthTicket);
	...
	*/
	UE_API virtual int32 GetExistingReservation(const FUniqueNetIdRepl& Spectator) const;
	...
	*/
	UE_API virtual bool DoesReservationFit(const FSpectatorReservation& ReservationRequest) const;
	...
	* @return true if a reservation exists, false otherwise
	*/
	UE_API virtual bool UpdateMemberPlatform(const FUniqueNetIdRepl& Spectator, const FString& PlatformName);
	...
	*/
	UE_API virtual bool CrossPlayAllowed(const FSpectatorReservation& ReservationRequest) const;
	...
	*/
	UE_API virtual int32 GetReservationPlatformCount(const FString& InPlatform) const;
