...
class ASpectatorBeaconHost : public AOnlineBeaconHostObject
{
	...
	*/
	UE_API virtual bool InitHostBeacon(int32 InMaxReservations, FName InSessionName);
	...
	* @return true if successful created, false otherwise
	*/
	UE_API virtual bool InitFromBeaconState(USpectatorBeaconState* PrevState);
	...
	*/
	UE_API virtual ESpectatorReservationResult::Type AddSpectatorReservation(const FSpectatorReservation& ReservationRequest);
	...
	*/
	UE_API virtual ESpectatorReservationResult::Type RemoveSpectatorReservation(const FUniqueNetIdRepl& Spectator);
	...
	*/
	UE_API virtual void ProcessReservationRequest(ASpectatorBeaconClient* Client, const FString& SessionId, const FSpectatorReservation& ReservationRequest);
	...
	* @param Spectator reservation owner
	*/
	UE_API virtual void ProcessCancelReservationRequest(ASpectatorBeaconClient* Client, const FUniqueNetIdRepl& Spectator);
