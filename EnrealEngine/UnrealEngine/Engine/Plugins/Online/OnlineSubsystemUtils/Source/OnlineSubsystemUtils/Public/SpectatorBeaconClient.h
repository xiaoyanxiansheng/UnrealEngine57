...
class ASpectatorBeaconClient : public AOnlineBeaconClient
{
	...
	*/
	UE_API virtual bool RequestReservation(const FString& ConnectInfoStr, const FString& InSessionId, const FUniqueNetIdRepl& RequestingSpectator, const FPlayerReservation& Reservation);
	...
	* @return true if the request able to be sent, false if it failed to send
	*/
	UE_API virtual bool RequestReservation(const FOnlineSessionSearchResult& DesiredHost, const FUniqueNetIdRepl& RequestingSpectator, const FPlayerReservation& Reservation);
	...
	*/
	UFUNCTION(client, reliable)
		UE_API virtual void ClientReservationResponse(ESpectatorReservationResult::Type ReservationResponse);
	...
	*/
	UFUNCTION(client, reliable)
		UE_API virtual void ClientCancelReservationResponse(ESpectatorReservationResult::Type ReservationResponse);
...
protected:
	...
	UE_API void ProcessReservationResponse(ESpectatorReservationResult::Type ReservationResponse);
	/** Process a response to our CancelReservation request to the server */
	UE_API void ProcessCancelReservationResponse(ESpectatorReservationResult::Type ReservationResponse);
	...
	*/
	UFUNCTION(server, reliable, WithValidation)
		UE_API virtual void ServerReservationRequest(const FString& SessionId, const FSpectatorReservation& Reservation);
	...
	*/
	UFUNCTION(server, reliable, WithValidation)
		UE_API virtual void ServerCancelReservationRequest(const FUniqueNetIdRepl& Spectator);
