...
public:
	...
	BEGIN_JSON_SERIALIZER
		JSON_SERIALIZE("gameAccountId", UserId);
		JSON_SERIALIZE("internalToken", SecretKey);
		JSON_SERIALIZE("authTicket", AuthTicket);
		JSON_SERIALIZE_MAP("additionalAuthData", AdditionalAuthData);
	END_JSON_SERIALIZER
};
