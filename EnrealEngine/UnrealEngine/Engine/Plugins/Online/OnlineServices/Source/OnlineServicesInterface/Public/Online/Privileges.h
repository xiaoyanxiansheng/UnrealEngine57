...
enum class EShowPrivilegeResolutionUI : uint8
{
	/** Behavior matching the recommended practices for the platform */
	Default,
...
ONLINESERVICESINTERFACE_API FString LexToString(EShowPrivilegeResolutionUI Type);
ONLINESERVICESINTERFACE_API void LexFromString(EShowPrivilegeResolutionUI& OutType, const FString& InStr);
...
struct FQueryUserPrivilege
{
	...
	struct Params
	{
		...
		/** Should external UI be shown when not possessing the queried privilege */
		EShowPrivilegeResolutionUI ShowExternalUI;
...
BEGIN_ONLINE_STRUCT_META(FQueryUserPrivilege::Params)
	...
	ONLINE_STRUCT_FIELD(FQueryUserPrivilege::Params, ShowExternalUI)
