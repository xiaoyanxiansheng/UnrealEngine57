...
using FOnlineEventParams =  TMap<FString, FSchemaVariant>;
...
{
	static constexpr TCHAR Name[] = TEXT("TriggerEvent");
...
public:
	...
	/**
	 * Trigger a stat modifying event
	 *
	 * @param Parameters for the TriggerEvent call
	 * @return
	 */
	virtual TOnlineAsyncOpHandle<FTriggerEvent> TriggerEvent(FTriggerEvent::Params&& Params) = 0;
...
BEGIN_ONLINE_STRUCT_META(FTriggerEvent::Params)
	ONLINE_STRUCT_FIELD(FTriggerEvent::Params, LocalAccountId),
	ONLINE_STRUCT_FIELD(FTriggerEvent::Params, EventName),
	ONLINE_STRUCT_FIELD(FTriggerEvent::Params, EventParams)
END_ONLINE_STRUCT_META()

BEGIN_ONLINE_STRUCT_META(FTriggerEvent::Result)
END_ONLINE_STRUCT_META()
