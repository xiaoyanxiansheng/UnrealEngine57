...
UE_ONLINE_ERROR_COMMON(Common, AlreadyInSession, 24, TEXT("already_in_session"), LOCTEXT("AlreadyInSession", "Player is already in session"))
UE_ONLINE_ERROR_COMMON(Common, NotInSession, 25, TEXT("not_in_session"), LOCTEXT("NotInSession", "Player is not in any session"))
UE_ONLINE_ERROR_COMMON(Common, SessionJoinDenied, 26, TEXT("session_join_denied"), LOCTEXT("SessionJoinDenied", "Server denied session join"))
UE_ONLINE_ERROR_COMMON(Common, SessionFull, 27, TEXT("session_full"), LOCTEXT("SessionFull", "Server session is full"))
} /* namespace UE::Online::Errors */
