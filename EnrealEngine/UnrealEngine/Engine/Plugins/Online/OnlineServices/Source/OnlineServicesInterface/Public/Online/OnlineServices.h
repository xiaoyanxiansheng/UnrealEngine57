...
enum class EOnlinePlatformType : uint8
{
	Epic,
	Steam,
	PSN,
...
ONLINESERVICESINTERFACE_API const TCHAR* LexToString(EOnlinePlatformType EnumVal);
ONLINESERVICESINTERFACE_API void LexFromString(EOnlinePlatformType& OutPlatformType, const TCHAR* InStr);
