...
struct FGetSessionName
{
	static constexpr TCHAR Name[] = TEXT("GetSessionName");

	struct Params
	{
		/** Id handle for the session to be retrieved the name from */
		FOnlineSessionId SessionId;
	};
...
struct FLeaveSession
{
	...
	struct Params
	{
		...
		/** Local name for the session */
		FName SessionName; // TODO (MATIAS): This could be a FOnlineSessionId 
...
struct FRemoveSessionMember
{
	...
	struct Params
	{
		...
		FAccountId TargetAccountId; // TODO: Can we consider adding this parameter ?
		/** Local name for the session */
		FName SessionName;
	};
...
public:
	 ...
	 *
	 * @params Parameters for the GetSessionName call
	 * return
	 */
	virtual TOnlineResult<FGetSessionName> GetSessionName(FGetSessionName::Params&& Params) const = 0;
...
BEGIN_ONLINE_STRUCT_META(FGetSessionName::Params)
	ONLINE_STRUCT_FIELD(FGetSessionName::Params, SessionId)
END_ONLINE_STRUCT_META()

BEGIN_ONLINE_STRUCT_META(FGetSessionName::Result)
	ONLINE_STRUCT_FIELD(FGetSessionName::Result, SessionName)
END_ONLINE_STRUCT_META()
...
BEGIN_ONLINE_STRUCT_META(FJoinSession::Params)
	...
	ONLINE_STRUCT_FIELD(FJoinSession::Params, bJoinAsSpectator)
END_ONLINE_STRUCT_META()
...
BEGIN_ONLINE_STRUCT_META(FRemoveSessionMember::Params)
	...
	ONLINE_STRUCT_FIELD(FRemoveSessionMember::Params, TargetAccountId),
...
ONLINE_STRUCT_FIELD(FSessionJoined, LocalAccountId),
ONLINE_STRUCT_FIELD(FSessionJoined, SessionId)
END_ONLINE_STRUCT_META()
