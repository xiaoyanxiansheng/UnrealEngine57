...
PACKAGE_SCOPE:
	...
	UE_API virtual ~FOnlineEncryptedAppTicketSteam();
...
public:
	 ...
	 */
	UE_API bool RequestEncryptedAppTicket(void* DataToEncrypt, int SizeOfDataToEncrypt);
	 ...
	 */
	UE_API bool GetEncryptedAppTicket(TArray<uint8>& OutEncryptedData);
