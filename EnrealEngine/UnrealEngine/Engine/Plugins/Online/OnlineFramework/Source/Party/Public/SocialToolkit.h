...
public:
	...
	UE_API const UE::Online::TOnlineResult<UE::Online::FGetCachedPresence> GetPresenceInfoV2(ESocialSubsystem SubsystemType) const;
	UE_API virtual void SetLocalUserOnlineState(EOnlinePresenceState::Type OnlineState);
	UE_API virtual void SetLocalUserOnlineStateV2(UE::Online::EUserPresenceStatus OnlineState);
...
protected:
	...
	virtual void OnFriendPresenceDidChangeV2(const USocialUser& FriendSocialUser, const TSharedRef<const UE::Online::FUserPresence>& NewPresence, ESocialSubsystem SubsystemType) {}
...
private:	// Handlers
	...
	UE_API void HandleServicesPresenceUpdated(const UE::Online::FPresenceUpdated& Event, ESocialSubsystem SubsystemType);
	...
	UE_API void HandleFriendsChanged(ESocialSubsystem SubsystemType);
	...
	UE_API void HandleBlockListChanged(int32 LocalUserNum, const FString& ListName, ESocialSubsystem SubsystemType);
	...
	TMap<ESocialSubsystem, UE::Online::FOnlineEventDelegateHandle> OnPresenceUpdatedHandles;
...
private:
	...
	void ProcessOSSBlockedPlayers(ESocialSubsystem SubsystemType, const TArray<TSharedRef<FOnlineBlockedPlayer>>& BlockedPlayers);
	TMap<ESocialSubsystem, TSet<FUniqueNetIdRepl>> BlockedUsers;
