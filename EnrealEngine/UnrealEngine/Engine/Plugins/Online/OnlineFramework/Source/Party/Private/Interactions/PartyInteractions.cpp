...
DEFINE_SOCIAL_INTERACTION(InviteToParty)
...
DEFINE_SOCIAL_INTERACTION(JoinParty)
...
DEFINE_SOCIAL_INTERACTION(RequestToJoinParty)
...
DEFINE_SOCIAL_INTERACTION(AcceptJoinRequest)
...
DEFINE_SOCIAL_INTERACTION(DismissJoinRequest)
...
DEFINE_SOCIAL_INTERACTION(AcceptPartyInvite)
...
{
	return User.HasSentPartyInvite(IOnlinePartySystem::GetPrimaryPartyTypeId()) && User.CheckPartyJoinability(IOnlinePartySystem::GetPrimaryPartyTypeId()).WasSuccessful();
}
...
DEFINE_SOCIAL_INTERACTION(RejectPartyInvite)
...
DEFINE_SOCIAL_INTERACTION(LeaveParty)
...
DEFINE_SOCIAL_INTERACTION(KickPartyMember)
...
DEFINE_SOCIAL_INTERACTION(PromoteToPartyLeader)
