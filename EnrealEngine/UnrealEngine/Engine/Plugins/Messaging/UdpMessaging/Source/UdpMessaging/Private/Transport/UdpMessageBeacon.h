...
public:
	 ...
	 *
	 * @param InSocketSender The network socket sender used to send Hello segments.
	 ...
	 */
	FUdpMessageBeacon(
		UE::UdpMessaging::FSocketSender* InSocketSender,
		const FGuid& InSocketId,
...
private:
	...
	/** Holds the socket sender used to send Hello segments. */
	UE::UdpMessaging::FSocketSender* SocketSender;
