...
private:
	...
	UPROPERTY(EditAnywhere, Category = "Chooser", Meta = (EditConditionHides, EditCondition="bShowModeSetting"))
	EEvaluateChooserMode Mode;

	UPROPERTY(EditAnywhere, Category = "Chooser", Meta = (EditConditionHides, EditCondition="bShowModeSetting"))
	bool bReturnSoftObjectReference = false;

	UPROPERTY(Transient)
	bool bShowModeSetting = false;
