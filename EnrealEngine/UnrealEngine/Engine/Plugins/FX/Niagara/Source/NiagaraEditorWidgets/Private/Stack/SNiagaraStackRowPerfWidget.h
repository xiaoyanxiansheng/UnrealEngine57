...
public:
	...
	void Construct(const FArguments& InArgs, UNiagaraStackEntry* InStackEntry, ENiagaraPerformanceStateScopeMode InStatScopeMode);

	virtual void Tick(const FGeometry& AllottedGeometry, const double InCurrentTime, const float InDeltaTime) override;
	
private:
	float GetFullBarWidth() const;
	EVisibility GetPerfBarVisibility() const;
	...
	ENiagaraPerformanceStateScopeMode StatScopeMode;
