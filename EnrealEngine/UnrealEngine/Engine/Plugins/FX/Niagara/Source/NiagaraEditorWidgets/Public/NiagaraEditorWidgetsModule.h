...
private:
	...
	public:
		...
		virtual TSharedRef<SWidget> CreateCurveKeySelector(TSharedPtr<FCurveEditor> InCurveEditor, const TArray<FCurveEditorTreeItemID>& InCurveTreeItemIds, TSharedPtr<SCurveEditorTree> InCurveEditorTree) const override;
		virtual TSharedRef<SWidget> CreateCurveThumbnail(const FRichCurve& Curve) const override;
