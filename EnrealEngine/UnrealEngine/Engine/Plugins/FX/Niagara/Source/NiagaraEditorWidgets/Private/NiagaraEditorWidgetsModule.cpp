...
TSharedRef<SWidget> FNiagaraEditorWidgetsModule::FNiagaraEditorWidgetProvider::CreateCurveKeySelector(TSharedPtr<FCurveEditor> InCurveEditor, const TArray<FCurveEditorTreeItemID>& InCurveTreeItemIds, TSharedPtr<SCurveEditorTree> InCurveEditorTree) const
{
	return SNew(SNiagaraCurveKeySelector, InCurveEditor, InCurveTreeItemIds, InCurveEditorTree);
}

TSharedRef<SWidget> FNiagaraEditorWidgetsModule::FNiagaraEditorWidgetProvider::CreateCurveThumbnail(const FRichCurve& Curve) const
{
	return SNew(SNiagaraCurveThumbnail, Curve);
}
