...
TArray<TSharedPtr<FNiagaraMenuAction_Generic>> SNiagaraStackItemGroupAddMenu::CollectActions()
{
	...
	{		
		...
		NewNodeAction->PreviewMoviePath = AddAction->GetPreviewMoviePath();
	...
	const TSharedPtr<FNiagaraMenuAction_Generic>& Item)
{
	...
	ActionData.PreviewMovieViewModel = SourceEntry.IsValid() ? SourceEntry->GetSystemViewModel()->GetPreviewMovieViewModel() : nullptr;
