...
FText FNiagaraDataInterfaceSpriteRendererInfoDetails::CreateRendererTextLabel(const UNiagaraSpriteRendererProperties* Properties)
{
	...
	UNiagaraEmitterEditorData* EmitterEditorData = Properties->GetEmitterData() ? static_cast<UNiagaraEmitterEditorData*>(Properties->GetEmitterData()->GetEditorData()) : nullptr;
