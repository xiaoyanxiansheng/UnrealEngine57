...
/////////////////////////////////////////////////////
// FNDCAccessContextOperationNodeDetailsDetails - Customizes instances of UK2Node_DataChannelAccessContextOperation 

class FNDCAccessContextOperationNodeDetailsDetails : public IDetailCustomization
{
public:
...
private:
	...
	TWeakObjectPtr<class UK2Node_DataChannelAccessContextOperation> HideUnconnectedPinsNode;
