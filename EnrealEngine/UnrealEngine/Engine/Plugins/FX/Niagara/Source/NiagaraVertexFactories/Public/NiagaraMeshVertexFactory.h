...
public:
	...
	*/
	...
	inline uint32 GetColorIndexMask() const
	{
		return Data.ColorIndexMask;
	}

	inline int GetNumTexcoords() const
	{
	...
	NIAGARAVERTEXFACTORIES_API static bool IsGPUSceneEnabled(const FStaticShaderPlatform Platform, const FStaticFeatureLevel FeatureLevel);
