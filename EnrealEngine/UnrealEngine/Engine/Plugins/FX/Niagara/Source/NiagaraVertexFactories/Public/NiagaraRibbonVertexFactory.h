...
public:
	...
	*/
	inline void SetRibbonUniformBuffer(FNiagaraRibbonUniformBufferRef InSpriteUniformBuffer)
	{
	...
	*/
	inline FNiagaraRibbonUniformBufferRef GetRibbonUniformBuffer() const
	{
