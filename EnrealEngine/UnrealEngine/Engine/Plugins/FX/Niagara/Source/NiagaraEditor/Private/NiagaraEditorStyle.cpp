...
void FNiagaraEditorStyle::InitParameters()
{
	...
	Set("NiagaraEditor.StaticInputIcon", new IMAGE_BRUSH_SVG("Icons/StaticInput", Icon12x12));
...
void FNiagaraEditorStyle::InitIcons()
{
	...
	*SlateBrush = FAppStyle::Get().GetWidgetStyle<FEditableTextBoxStyle>("NormalEditableTextBox").BackgroundImageNormal;
	...
	Set("NiagaraEditor.DistributionEditor.Array", new IMAGE_BRUSH("Icons/DistributionEditor/Array", Icon20x20));
	...
	Set("NiagaraEditor.DistributionEditor.ColorGradient", new IMAGE_BRUSH("Icons/DistributionEditor/ColorGradient", Icon20x20));
...
void FNiagaraEditorStyle::InitAssetColors()
{
	...
	Set("NiagaraEditor.AssetColors.StatelessEmitterTemplate", FLinearColor(0.9f, 0.3f, 0.25f));
...
void FNiagaraEditorStyle::InitStackIcons()
{
	...
	Set("NiagaraEditor.Stack.LWEIcon", new IMAGE_BRUSH("Icons/Simulate_LW_x40", Icon16x16));
}
