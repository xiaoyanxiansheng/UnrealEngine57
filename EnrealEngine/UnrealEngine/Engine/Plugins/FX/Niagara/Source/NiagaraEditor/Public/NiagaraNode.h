...
public:
	...
	virtual FText GetCompactTitle() const { return FText::GetEmpty(); }
	virtual bool ShouldShowPinNamesInCompactMode() { return false; }
	virtual TOptional<float> GetCompactModeFontSizeOverride() const { return {}; }
