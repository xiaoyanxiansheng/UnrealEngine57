...
private:
	...
	virtual bool SupportsDebugDraw() const override;
	virtual TOptional<FText> GetDebugDrawTooltip() const override;
	virtual bool IsDebugDrawEnabled() const override;
	virtual void SetDebugDrawEnabled(bool bInEnabled) override;
