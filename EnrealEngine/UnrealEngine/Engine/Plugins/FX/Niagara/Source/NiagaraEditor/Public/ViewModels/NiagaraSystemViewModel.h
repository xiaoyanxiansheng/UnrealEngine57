...
public:
	...
	bool DeleteParameter(const FNiagaraVariableBase Parameter);
	...
	TSharedPtr<FNiagaraPreviewMovieViewModel> GetPreviewMovieViewModel() const { return PreviewMovieViewModel; }
...
private:
	...
	/** The view model that owns and manages the singular movie player available to an asset. */
