...
public:
	...
	virtual bool SupportsDebugDraw() const { return false; }
	virtual TOptional<FText> GetDebugDrawTooltip() const { return {}; }
	virtual bool IsDebugDrawEnabled() const { return false; }
	virtual void SetDebugDrawEnabled(bool bInEnabled) {}
