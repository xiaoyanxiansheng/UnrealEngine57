...
#include UE_INLINE_GENERATED_CPP_BY_NAME(NiagaraRenderTargetVolumeSimCacheVisualizer)
...
TSharedRef<FEditorViewportClient> SNiagaraVolumeTextureViewport::MakeEditorViewportClient()
{
	...
	ViewportClient->SetCameraSpeedSettings(FEditorViewportCameraSpeedSettings(0.33f));
