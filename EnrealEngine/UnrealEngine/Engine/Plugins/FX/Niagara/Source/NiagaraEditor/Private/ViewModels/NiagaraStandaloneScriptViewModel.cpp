...
TSharedPtr<IAssetReferenceFilter> FNiagaraStandaloneScriptViewModel::MakeAssetReferenceFilter() const
{
	if (SourceScript.Script && GEditor)
	{
		FAssetReferenceFilterContext AssetReferenceFilterContext;
		AssetReferenceFilterContext.AddReferencingAsset(SourceScript.Script);
