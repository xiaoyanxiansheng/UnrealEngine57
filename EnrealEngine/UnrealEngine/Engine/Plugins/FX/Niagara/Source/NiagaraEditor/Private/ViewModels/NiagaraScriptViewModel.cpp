...
void FNiagaraScriptViewModel::InputParameterValueChanged(TConstArrayView<FName> ParameterName)
{
	MarkAllDirty(TEXT("Input parameter value changed"));
}

void FNiagaraScriptViewModel::OutputParameterValueChanged(TConstArrayView<FName> ParameterName)
{
