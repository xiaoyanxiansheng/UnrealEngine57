...
bool UNiagaraEditorSettings::IsCurveInputSnapEnabled() const
{
	return CurveEditorSharedSettings.bCurveInputSnapEnabled;
}

bool UNiagaraEditorSettings::IsCurveOutputSnapEnabled() const
{
	return CurveEditorSharedSettings.bCurveOutputSnapEnabled;
}

void UNiagaraEditorSettings::SetCurveInputSnapEnabled(bool bEnabled)
{
	CurveEditorSharedSettings.bCurveInputSnapEnabled = bEnabled;
}

void UNiagaraEditorSettings::SetCurveOutputSnapEnabled(bool bEnabled)
{
	CurveEditorSharedSettings.bCurveOutputSnapEnabled = bEnabled;
}
