...
private:
	...
	FVersionedNiagaraEmitterBaseWeakPtr			WeakVersionedEmitter;
	FGuid										EmitterHandleGuid;		/** The emitter handle guid this binding is used in. Used to gather available parameters for the system & this emitter (not all emitters) */
	TWeakObjectPtr<UNiagaraRendererProperties>	WeakRendererProperties;
	TWeakObjectPtr<UNiagaraSimulationStageBase>	WeakSimulationStage;
...
//** Properties customization for FNDCAccessContext. */
class FNDCAccessContextDetailsCustomization : public IPropertyTypeCustomization
{
public:
	static TSharedRef<IPropertyTypeCustomization> MakeInstance() { return MakeShared<FNDCAccessContextDetailsCustomization>(); }
	virtual void CustomizeHeader(TSharedRef<IPropertyHandle> PropertyHandle, FDetailWidgetRow& HeaderRow, IPropertyTypeCustomizationUtils& CustomizationUtils) override;
	virtual void CustomizeChildren(TSharedRef<IPropertyHandle> PropertyHandle, IDetailChildrenBuilder& ChildBuilder, IPropertyTypeCustomizationUtils& CustomizationUtils) override;
};
...
{
public:
	static TSharedRef<IPropertyTypeCustomization> MakeInstance() { return MakeShared<FNiagaraDataChannelReferenceDetailsCustomization>(); }
	virtual void CustomizeHeader(TSharedRef<IPropertyHandle> PropertyHandle, FDetailWidgetRow& HeaderRow, IPropertyTypeCustomizationUtils& CustomizationUtils) override;
	virtual void CustomizeChildren(TSharedRef<IPropertyHandle> PropertyHandle, IDetailChildrenBuilder& ChildBuilder, IPropertyTypeCustomizationUtils& CustomizationUtils) override;
...
private:
	...
	TSharedPtr<IPropertyHandle> PropertyPtr;
};
