...
public:
	...
	void Construct(const FArguments& InArgs, UMovieSceneNiagaraEmitterTrack& InEmitterTrack)
	{
		...
		UNiagaraEmitterBase* NiagaraEmitter = EmitterTrack->GetEmitterHandleViewModel()->GetEmitterHandle()->GetEmitterBase();
	...
	~SEmitterTrackWidget()
	{
		if ( UNiagaraEmitterBase* NiagaraEmitter = WeakNiagaraEmitter.Get() )
		{
...
private:
	...
	TWeakObjectPtr<UNiagaraEmitterBase> WeakNiagaraEmitter;
