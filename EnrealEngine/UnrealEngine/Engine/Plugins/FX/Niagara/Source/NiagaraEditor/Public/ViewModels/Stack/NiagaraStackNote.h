...
public:
	...
	NIAGARAEDITOR_API void UpdateNoteColor(FLinearColor LinearColor);
	...
	NIAGARAEDITOR_API FLinearColor GetColor() const;
protected:
	...
	virtual bool KeepExpanderIndentation() const override { return false; }
