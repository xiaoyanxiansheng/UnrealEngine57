...
TObjectPtr<UObject> FNiagaraScriptParameterViewModel::GetDefaultValueObjectAsset()
{
	return ValueObjectAsset;
}

void FNiagaraScriptParameterViewModel::SetDefaultValueObjectAsset(TObjectPtr<UObject> Object)
{
