...
protected:
	...
	void RefreshParameterViewModels(TConstArrayView<FName> ChangedParameters);
...
private:
	TSharedPtr<FNiagaraCollectionParameterViewModel> CreateParameterViewModel(const FNiagaraVariable& Var);
	...
	FDelegateHandle ParameterValuesChangedHandle;
};
