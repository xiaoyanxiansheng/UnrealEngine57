...
public:
	...
	UNiagaraComponent* GetPreviewComponent() const;
...
private:
	...
	mutable TObjectPtr<UNiagaraComponent> PreviewComponent = nullptr;
	mutable TSharedPtr<FAdvancedPreviewScene> AdvancedPreviewScene;
	mutable TObjectPtr<USceneCaptureComponent2D> SceneCaptureComponent = nullptr;
