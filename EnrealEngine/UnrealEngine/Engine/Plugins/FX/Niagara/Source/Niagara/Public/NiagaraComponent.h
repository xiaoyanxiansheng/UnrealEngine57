...
private:
	...
	UPROPERTY(transient)
	TMap<FNiagaraVariableBase, FNiagaraVariant> TemplateParameterOverridesCache;

	UPROPERTY(transient)
	TMap<FNiagaraVariableBase, FNiagaraVariant> InstanceParameterOverridesCache;
...
public:
	...
	bool IsActiveForUpdateContext() const;
...
public:
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = Niagara, meta = (DisplayName = "Get Niagara Variable (Bool)", Keywords = "user parameter variable bool"))
	[[nodiscard]] NIAGARA_API bool GetVariableBool(FName InVariableName, bool& bIsValid) const;

	/** Gets a Niagara int parameter by name. */
	UFUNCTION(BlueprintCallable, Category = Niagara, meta = (DisplayName = "Get Niagara Variable (Int32)", Keywords = "user parameter variable int"))
	[[nodiscard]] NIAGARA_API int32 GetVariableInt(FName InVariableName, bool& bIsValid) const;

	/** Gets a Niagara float parameter by name. */
	UFUNCTION(BlueprintCallable, Category = Niagara, meta = (DisplayName = "Get Niagara Variable (Float)", Keywords = "user parameter variable float"))
	[[nodiscard]] NIAGARA_API float GetVariableFloat(FName InVariableName, bool& bIsValid) const;

	/** Gets a Niagara Vector2 parameter by name. */
	UFUNCTION(BlueprintCallable, Category = Niagara, meta = (DisplayName = "Get Niagara Variable (Vector2)", Keywords = "user parameter variable vector"))
	[[nodiscard]] NIAGARA_API FVector2D GetVariableVec2(FName InVariableName, bool& bIsValid) const;

	/** Gets a Niagara Vector3 parameter by name. */
	UFUNCTION(BlueprintCallable, Category = Niagara, meta = (DisplayName = "Get Niagara Variable (Vector3)", Keywords = "user parameter variable vector"))
	[[nodiscard]] NIAGARA_API FVector GetVariableVec3(FName InVariableName, bool& bIsValid) const;

	/** Gets a Niagara Vector4 parameter by name. */
	UFUNCTION(BlueprintCallable, Category = Niagara, meta = (DisplayName = "Get Niagara Variable (Vector4)", Keywords = "user parameter variable vector"))
	[[nodiscard]] NIAGARA_API FVector4 GetVariableVec4(FName InVariableName, bool& bIsValid) const;

	/** Gets a Niagara Position parameter by name. */
	UFUNCTION(BlueprintCallable, Category = Niagara, meta = (DisplayName = "Get Niagara Variable (Position)", Keywords = "user parameter variable vector position lwc"))
	[[nodiscard]] NIAGARA_API FVector GetVariablePosition(FName InVariableName, bool& bIsValid) const;

	/** Gets a Niagara Linear Color parameter by name. */
	UFUNCTION(BlueprintCallable, Category = Niagara, meta = (DisplayName = "Get Niagara Variable (LinearColor)", Keywords = "user parameter variable color"))
	[[nodiscard]] NIAGARA_API FLinearColor GetVariableColor(FName InVariableName, bool& bIsValid) const;

	/** Gets a Niagara quaternion parameter by name. */
	UFUNCTION(BlueprintCallable, Category = Niagara, meta = (DisplayName = "Get Niagara Variable (Quaternion)", Keywords = "user parameter variable quaternion rotation"))
	[[nodiscard]] NIAGARA_API FQuat GetVariableQuat(FName InVariableName, bool& bIsValid) const;

	/** Gets a Niagara matrix parameter by name. */
	UFUNCTION(BlueprintCallable, Category = Niagara, meta = (DisplayName = "Get Niagara Variable (Matrix)", Keywords = "user parameter variable matrix"))
	[[nodiscard]] NIAGARA_API FMatrix GetVariableMatrix(FName InVariableName, bool& bIsValid) const;
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = Preview, meta = (Keywords = "preview LOD Distance scalability"))
	inline bool GetPreviewLODDistanceEnabled()const;

	UFUNCTION(BlueprintCallable, Category = Preview, meta = (Keywords = "preview LOD Distance scalability"))
	inline float GetPreviewLODDistance()const;
...
#if WITH_EDITOR
	void CacheAndClearEditorParameterOverrides();
	void CopyCachedEditorParameterOverrides();
...
public:
	...
	UPROPERTY(EditAnywhere, Category = "Niagara Utilities", meta = (UIMin="1", ClampMin="1", DisplayName="NumFramesToCapture"))
	TOptional<int32> SimCacheDebugNumFramesToCapture;
#endif
	...
	*/
	...
	inline bool IsRegisteredWithScalabilityManager()const { return ScalabilityManagerHandle != INDEX_NONE; }
	inline int32 GetScalabilityManagerHandle()const { return ScalabilityManagerHandle; }

	inline void BeginUpdateContextReset(){ bDuringUpdateContextReset = true; }
	inline void EndUpdateContextReset(){ bDuringUpdateContextReset = false; }
	...
	inline bool IsUsingCullProxy()const { return CullProxy != nullptr; }
...
inline bool UNiagaraComponent::GetPreviewLODDistanceEnabled()const { return bEnablePreviewLODDistance; }
inline float UNiagaraComponent::GetPreviewLODDistance()const { return bEnablePreviewLODDistance ? PreviewLODDistance : 0.0f; }
