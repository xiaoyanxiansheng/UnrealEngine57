...
void UNiagaraSimulationStageGeneric::PostLoad()
{
	...
	// Make sure we post load all FNiagaraVariableAttributeBinding
	EnabledBinding.PostLoad(ENiagaraRendererSourceDataMode::Emitter);
	ParticleIterationStateBinding.PostLoad(ENiagaraRendererSourceDataMode::Particles);
...
FVersionedNiagaraEmitterBase UNiagaraSimulationStageBase::GetOuterEmitterBase() const
{
