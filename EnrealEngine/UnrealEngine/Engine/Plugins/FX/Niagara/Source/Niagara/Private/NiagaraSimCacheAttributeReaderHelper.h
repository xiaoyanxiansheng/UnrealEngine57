...
struct FNiagaraSimCacheAttributeReaderHelper
{
	...
	static int32 FindVariableIndex(const UNiagaraSimCache* SimCache, const FNiagaraVariableBase& Variable, int EmitterIndex)
	{
	...
	static const FNiagaraSimCacheVariable* FindVariable(const UNiagaraSimCache* SimCache, const FNiagaraVariableBase& Variable, int EmitterIndex)
	{
