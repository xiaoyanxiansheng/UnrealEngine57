...
public:
	...
	inline bool NeedsWarmup()const { return WarmupTickCount > 0 && WarmupTickDelta > SMALL_NUMBER; }
	inline float GetWarmupTime()const { return WarmupTime; }
	inline int32 GetWarmupTickCount()const { return WarmupTickCount; }
	inline float GetWarmupTickDelta()const { return WarmupTickDelta; }

	inline bool HasFixedTickDelta() const { return bFixedTickDelta; }
	inline float GetFixedTickDeltaTime()const { return FixedTickDeltaTime; }
	...
	inline bool NeedsDeterminism() const { return bDeterminism; }
	inline int32 GetRandomSeed() const { return RandomSeed; }
	...
	TArray<FNiagaraAssetTagDefinitionReference> AssetTags_DEPRECATED;
	...
	UPROPERTY(EditAnywhere, AdvancedDisplay, Category="Asset Options", AssetRegistrySearchable, meta = (SkipSystemResetOnChange = "true", AllowedClasses="/Script/MediaAssets.FileMediaSource"))
	...
	inline bool IsInitialOwnerVelocityFromActor() const { return bInitialOwnerVelocityFromActor; }

#if WITH_EDITORONLY_DATA
	NIAGARA_API void ReportAnalyticsData(bool bIsCooking);
	NIAGARA_API bool UsesEmitter(UNiagaraEmitterBase* Emitter) const;
	NIAGARA_API bool UsesEmitter(const FVersionedNiagaraEmitter& VersionedEmitter) const;
	NIAGARA_API bool UsesEmitter(const FVersionedNiagaraEmitterBase& VersionedEmitter) const;
	...
	inline bool GetCompileForEdit() const { return bCompileForEdit; }
	...
	inline bool ShouldUseRapidIterationParameters() const { return bCompileForEdit ? !bBakeOutRapidIteration : !bBakeOutRapidIterationOnCook; }
	inline bool ShouldTrimAttributes() const { return bCompileForEdit ? bTrimAttributes : bTrimAttributesOnCook; }
	inline bool ShouldIgnoreParticleReadsForAttributeTrim() const { return bIgnoreParticleReadsForAttributeTrim; }
	inline bool ShouldDisableDebugSwitches() const { return bCompileForEdit ? bDisableDebugSwitches : bDisableDebugSwitchesOnCook; }
	inline bool ShouldCompressAttributes() const { return bCompressAttributes; }

	inline void SetBakeOutRapidIterationOnCook(bool bBakeOut) { bBakeOutRapidIteration = bBakeOut; bBakeOutRapidIterationOnCook = bBakeOut; }
	inline void SetTrimAttributesOnCook(bool bTrim) { bTrimAttributes = bTrim; bTrimAttributesOnCook = bTrim; }
...
public:
	...
	*/
	...
	inline TConstArrayView<FNiagaraEmitterExecutionIndex> GetEmitterExecutionOrder() const { return MakeArrayView(EmitterExecutionOrder); }
	inline TConstArrayView<FNiagaraRendererExecutionIndex> GetRendererPostTickOrder() const { return MakeArrayView(RendererPostTickOrder); }
	inline TConstArrayView<FNiagaraRendererExecutionIndex> GetRendererCompletionOrder() const { return MakeArrayView(RendererCompletionOrder); }

	inline TConstArrayView<int32> GetRendererDrawOrder() const { return MakeArrayView(RendererDrawOrder); }
	...
	inline UNiagaraParameterCollectionInstance* GetParameterCollectionOverride(UNiagaraParameterCollection* Collection)
	{
...
public:
	...
	inline bool HasDIsWithPostSimulateTick() const { return bHasDIsWithPostSimulateTick; }
	inline bool AllDIsPostSimulateCanOverlapFrames() const { return bAllDIsPostSimulateCanOverlapFrames; }
	inline bool AsyncWorkCanOverlapTickGroups() const { return bAllDIsPostStageCanOverlapTickGroups; }
	inline bool HasAnyGPUEmitters()const{ return bHasAnyGPUEmitters; }
	inline bool NeedsGPUContextInitForDataInterfaces() const { return bNeedsGPUContextInitForDataInterfaces; }

	NIAGARA_API FBox GetFixedBounds() const;
	inline void SetFixedBounds(const FBox& Box) { FixedBounds = Box;  }
	...
	inline bool GetOverrideScalabilitySettings()const { return bOverrideScalabilitySettings; }
	inline void SetOverrideScalabilitySettings(bool bOverride) { bOverrideScalabilitySettings = bOverride; }
	...
	inline const FNiagaraSystemScalabilitySettings& GetScalabilitySettings()const { return CurrentScalabilitySettings; }
	NIAGARA_API const FNiagaraSystemScalabilityOverride& GetCurrentOverrideSettings() const;
	inline bool NeedsSortedSignificanceCull()const{ return bNeedsSortedSignificanceCull; }

	inline void GetMaxInstanceCounts(int32& OutSystemInstanceMax, int32& OutFXTypeInstanceMax, bool bBudgetAdjusted)const;
	...
	inline void RegisterActiveInstance();
	inline void UnregisterActiveInstance();
	inline int32& GetActiveInstancesCount() { return ActiveInstances; }
...
inline void UNiagaraSystem::RegisterActiveInstance()
{
	++ActiveInstances;
}

inline void UNiagaraSystem::UnregisterActiveInstance()
{
	--ActiveInstances;
}


inline void UNiagaraSystem::GetMaxInstanceCounts(int32& OutSystemInstanceMax, int32& OutFXTypeInstanceMax, bool bBudgetAdjusted)const 
{
