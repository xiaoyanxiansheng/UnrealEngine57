...
public:
	...
	/**
	 * Whether lights from this renderer should be handled by MegaLights.
	...
	/**
	 * Whether lights from this renderer can cast shadows when handled by MegaLights.
	 */
	UPROPERTY(EditAnywhere, Category = "Light Rendering", meta = (EditCondition = "bAllowMegaLights", EditConditionHides))
	uint32 bMegaLightsCastShadows : 1;
	...
	*/
	...
	FNiagaraDataSetAccessor<int32> LightIdAccessor;
