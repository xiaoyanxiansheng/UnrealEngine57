...
struct FNiagaraConstants
{
	...
	static NIAGARA_API FText GetAttributeDescription(const FNiagaraVariableBase& InVar);
	static NIAGARA_API FString GetAttributeDefaultValue(const FNiagaraVariableBase& InVar);
	static NIAGARA_API FNiagaraVariable GetAttributeWithDefaultValue(const FNiagaraVariableBase& InAttribute);
	static NIAGARA_API FNiagaraVariableBase GetAttributeAsParticleDataSetKey(const FNiagaraVariableBase& InAttribute);
	static NIAGARA_API FNiagaraVariableBase GetAttributeAsEmitterDataSetKey(const FNiagaraVariableBase& InAttribute);
	static NIAGARA_API FNiagaraVariableAttributeBinding GetAttributeDefaultBinding(const FNiagaraVariableBase& InAttribute);

	static NIAGARA_API bool IsNiagaraConstant(const FNiagaraVariableBase& InVar);
	static NIAGARA_API const FNiagaraVariableMetaData* GetConstantMetaData(const FNiagaraVariableBase& InVar);
	...
	static NIAGARA_API bool IsEngineManagedAttribute(const FNiagaraVariableBase& Var);
...
private:
	...
	static TMap<FNiagaraVariableBase, FString> AttrDefaultsStrMap;
	static TMap<FNiagaraVariableBase, FNiagaraVariable> AttrDefaultsValueMap;
	static TMap<FNiagaraVariableBase, FNiagaraVariable> AttrDataSetKeyMap;
	static TMap<FNiagaraVariableBase, FText> AttrDescStrMap;
	static TMap<FNiagaraVariableBase, FNiagaraVariableMetaData> AttrMetaData;
