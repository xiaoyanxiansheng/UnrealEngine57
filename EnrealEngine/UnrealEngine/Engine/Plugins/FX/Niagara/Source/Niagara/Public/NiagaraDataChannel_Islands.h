...
class UNiagaraDataChannelHandler_Islands : public UNiagaraDataChannelHandler
{
	...
	NIAGARA_API virtual void BeginFrame(float DeltaTime)override;
	NIAGARA_API virtual void EndFrame(float DeltaTime)override;
	NIAGARA_API virtual void Tick(float DeltaTime, ETickingGroup TickGroup) override;
