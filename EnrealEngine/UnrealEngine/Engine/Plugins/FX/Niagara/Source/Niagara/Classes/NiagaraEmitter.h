...
struct FVersionedNiagaraEmitterData
{
	...
	**/
	...
	inline const TArray<FNiagaraEventScriptProperties>& GetEventHandlers() const { return EventHandlerScriptProps; }
	...
	inline const FNiagaraEmitterScalabilitySettings& GetScalabilitySettings()const { return CurrentScalabilitySettings; }
	...
	inline static FBox GetDefaultFixedBounds() { return FBox(FVector(-100), FVector(100)); }
...
public:
	...
	virtual FNiagaraVariableBase GetResolvedDIBinding(const FNiagaraVariableBase& InVariable) const override;
...
#if WITH_EDITORONLY_DATA
protected:
	virtual void OnUniqueEmitterNameChanged(const FString& OldName) override;
public:
#endif //WITH_EDITORONLY_DATA
#if WITH_EDITOR
...
template<typename TAction>
void FVersionedNiagaraEmitterData::ForEachEnabledRendererWithIndex(TAction Func) const
{
