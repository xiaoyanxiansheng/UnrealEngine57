...
#include UE_INLINE_GENERATED_CPP_BY_NAME(NiagaraDataChannel_Islands)
...
void UNiagaraDataChannelHandler_Islands::BeginFrame(float DeltaTime)
{
...
void UNiagaraDataChannelHandler_Islands::EndFrame(float DeltaTime)
{
...
void UNiagaraDataChannelHandler_Islands::Tick(float DeltaTime, ETickingGroup TickGroup)
{
