...
public:
	...
	/** If this script is displayed inline in the overview (dynamic input in the overview node for example), use this display name.
	 *  Should be short and concise. */
	UPROPERTY(EditAnywhere, Category = Script)
	FText InlineOverviewDisplayName;
...
#if WITH_EDITORONLY_DATA
	UPROPERTY(EditAnywhere, Category="Preview", AssetRegistrySearchable, meta = (AllowedClasses="/Script/MediaAssets.FileMediaSource"))
...
public:
	...
	inline FNiagaraVMExecutableData& GetVMExecutableData() { return CachedScriptVM; }
	inline const FNiagaraVMExecutableData& GetVMExecutableData() const { return CachedScriptVM; }
	inline const FNiagaraVMExecutableDataId& GetVMExecutableDataCompilationId() const { return CachedScriptVMId; }
