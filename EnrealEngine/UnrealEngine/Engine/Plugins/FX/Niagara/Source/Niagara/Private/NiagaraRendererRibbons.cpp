...
struct FNiagaraRibbonGPUInitComputeBuffers
{
	...
	void InitOrUpdateBuffers(FRHICommandListBase& RHICmdList, int32 NeededSize, bool bWantsMultiRibbon, bool bWantsTessellation, bool bWantsTessellationTwist)
	{
		...
		const uint32 AccumulationBufferStructSize = sizeof(FRibbonAccumulationValues);
...
{	
	...
	PerViewUniformParameters.PrevPositionDataOffset = SelectVFComponent(VFVariables, ENiagaraRibbonVFLayout::PrevPosition, ENiagaraRibbonVFLayout::Position);
	...
	PerViewUniformParameters.PrevWidthDataOffset = SelectVFComponent(VFVariables, ENiagaraRibbonVFLayout::PrevRibbonWidth, ENiagaraRibbonVFLayout::Width);
	PerViewUniformParameters.TwistDataOffset = VFVariables[ENiagaraRibbonVFLayout::Twist].GetGPUOffset();
	PerViewUniformParameters.PrevTwistDataOffset = SelectVFComponent(VFVariables, ENiagaraRibbonVFLayout::PrevRibbonTwist, ENiagaraRibbonVFLayout::PrevRibbonTwist);
	...
	PerViewUniformParameters.PrevFacingDataOffset = bShouldDoFacing ? SelectVFComponent(VFVariables, ENiagaraRibbonVFLayout::PrevRibbonFacing, ENiagaraRibbonVFLayout::Facing) : -1;
