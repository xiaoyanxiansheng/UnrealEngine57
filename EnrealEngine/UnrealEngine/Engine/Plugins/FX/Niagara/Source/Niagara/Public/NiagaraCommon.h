...
struct FNiagaraDataSetID
{
	...
	inline bool operator==(const FNiagaraDataSetID& Other)const
	{
...
inline FArchive& operator<<(FArchive& Ar, FNiagaraDataSetID& VarInfo)
{
	Ar << VarInfo.Name << VarInfo.Type;
	return Ar;
}

inline uint32 GetTypeHash(const FNiagaraDataSetID& Var)
{
...
struct FVMExternalFunctionBindingInfo
{
	...
	inline int32 GetNumInputs() const { return InputParamLocations.Num(); }
	inline int32 GetNumOutputs() const { return NumOutputs; }
...
#if WITH_EDITORONLY_DATA
	NIAGARA_API void Add(const FVersionedNiagaraEmitterBase& Emitter, bool bReInit);
...
struct FNiagaraVariableAttributeBinding
{
	...
	NIAGARA_API void SetValue(const FName& InValue, const FVersionedNiagaraEmitterBase& InEmitter, ENiagaraRendererSourceDataMode InSourceMode);
	NIAGARA_API void SetAsPreviousValue(const FNiagaraVariableBase& Src, const FVersionedNiagaraEmitterBase& InEmitter, ENiagaraRendererSourceDataMode InSourceMode);
	NIAGARA_API void SetAsPreviousValue(const FNiagaraVariableAttributeBinding& Src, const FVersionedNiagaraEmitterBase& InEmitter, ENiagaraRendererSourceDataMode InSourceMode);
	NIAGARA_API void CacheValues(const FVersionedNiagaraEmitterBase& InEmitter, ENiagaraRendererSourceDataMode InSourceMode);
	NIAGARA_API bool RenameVariableIfMatching(const FNiagaraVariableBase& OldVariable, const FNiagaraVariableBase& NewVariable, const FVersionedNiagaraEmitterBase& InEmitter, ENiagaraRendererSourceDataMode InSourceMode);
	NIAGARA_API bool Matches(const FNiagaraVariableBase& OldVariable, const FVersionedNiagaraEmitterBase& InEmitter, ENiagaraRendererSourceDataMode InSourceMode) const;

	UE_DEPRECATED(5.7, "Please change to use FVersionedNiagaraEmitterBase from FVersionedNiagaraEmitter")
	NIAGARA_API void SetValue(const FName& InValue, const FVersionedNiagaraEmitter& InEmitter, ENiagaraRendererSourceDataMode InSourceMode);
	UE_DEPRECATED(5.7, "Please change to use FVersionedNiagaraEmitterBase from FVersionedNiagaraEmitter")
	NIAGARA_API void SetAsPreviousValue(const FNiagaraVariableBase& Src, const FVersionedNiagaraEmitter& InEmitter, ENiagaraRendererSourceDataMode InSourceMode);
	UE_DEPRECATED(5.7, "Please change to use FVersionedNiagaraEmitterBase from FVersionedNiagaraEmitter")
	NIAGARA_API void SetAsPreviousValue(const FNiagaraVariableAttributeBinding& Src, const FVersionedNiagaraEmitter& InEmitter, ENiagaraRendererSourceDataMode InSourceMode);
	UE_DEPRECATED(5.7, "Please change to use FVersionedNiagaraEmitterBase from FVersionedNiagaraEmitter")
	NIAGARA_API void CacheValues(const FVersionedNiagaraEmitter& InEmitter, ENiagaraRendererSourceDataMode InSourceMode);
	UE_DEPRECATED(5.7, "Please change to use FVersionedNiagaraEmitterBase from FVersionedNiagaraEmitter")
	NIAGARA_API bool RenameVariableIfMatching(const FNiagaraVariableBase& OldVariable, const FNiagaraVariableBase& NewVariable, const FVersionedNiagaraEmitter& InEmitter, ENiagaraRendererSourceDataMode InSourceMode);
	UE_DEPRECATED(5.7, "Please change to use FVersionedNiagaraEmitterBase from FVersionedNiagaraEmitter")
	NIAGARA_API bool Matches(const FNiagaraVariableBase& OldVariable, const FVersionedNiagaraEmitter& InEmitter, ENiagaraRendererSourceDataMode InSourceMode) const;
	UE_DEPRECATED(5.7, "Please change to use FVersionedNiagaraEmitterBase from FVersionedNiagaraEmitter")
	NIAGARA_API void ResetToDefault(const FNiagaraVariableAttributeBinding& InOther, const FVersionedNiagaraEmitter& InEmitter, ENiagaraRendererSourceDataMode InSourceMode);
	...
	template<typename T>
	UE_DEPRECATED(5.7, "To reduce memory usage of renderers the default value is no longer stored inside the attribute binding.  Please use FNiagaraConstants::GetAttributeWithDefaultValue to get the value.")
	...
	void NIAGARA_API ResetToDefault(const FNiagaraVariableAttributeBinding& InOther, const FVersionedNiagaraEmitterBase& InEmitter, ENiagaraRendererSourceDataMode InSourceMode);
...
private:
	[[nodiscard]] FNiagaraVariableBase GetRootVariable() const { return FNiagaraVariableBase(ParamMapVariable.GetType(), RootName); }
...
protected:
	...
	UPROPERTY()
	FNiagaraVariable RootVariable_DEPRECATED;
#endif
};
...
struct FNiagaraMaterialAttributeBinding
{
	...
	NIAGARA_API void CacheValues(const UNiagaraEmitterBase* InEmitter);
	NIAGARA_API const FNiagaraVariableBase& GetParamMapBindableVariable() const;

	NIAGARA_API bool RenameVariableIfMatching(const FNiagaraVariableBase& OldVariable, const FNiagaraVariableBase& NewVariable, const UNiagaraEmitterBase* InEmitter, ENiagaraRendererSourceDataMode InSourceMode);
	NIAGARA_API bool Matches(const FNiagaraVariableBase& OldVariable, const UNiagaraEmitterBase* InEmitter, ENiagaraRendererSourceDataMode InSourceMode);
};
...
namespace FNiagaraUtilities
{
	...
	inline bool ShouldSyncCpuToGpu(ENiagaraGpuSyncMode SyncMode)
	{
	...
	inline bool ShouldSyncGpuToCpu(ENiagaraGpuSyncMode SyncMode)
	{
...
struct FNiagaraUserParameterBinding
{
	...
	inline bool operator==(const FNiagaraUserParameterBinding& Other)const
	{
...
public:
	...
	inline bool operator==(const FNiagaraCompileDependency& Other)const
	{
