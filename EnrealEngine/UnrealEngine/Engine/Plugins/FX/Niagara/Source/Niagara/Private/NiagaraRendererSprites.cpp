...
void FNiagaraRendererSprites::GetDynamicRayTracingInstances(FRayTracingInstanceCollector& Collector, const FNiagaraSceneProxy* SceneProxy)
{
	...
	if (NumInstances > 0)
	{
		...
		FMeshBatch MeshBatch;
		CreateMeshBatchForView(RHICmdList, ParticleSpriteRenderData, MeshBatch, *FirstActiveView, *SceneProxy, VertexFactory, NumInstances, GPUCountBufferOffset, ParticleSpriteRenderData.bNeedsCull);
