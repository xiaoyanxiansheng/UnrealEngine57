...
struct FNiagaraScalabilityManager
{
	...
	FNiagaraScalabilityManager(FNiagaraWorldManager* InOwner);
...
private: 
	...
	void UpdateInternal(FComponentIterationContext& Context);
	bool EvaluateCullState(FComponentIterationContext& Context, int32 ComponentIndex, int32& UpdateCounter);
	void ProcessSignificance(UNiagaraSignificanceHandler* SignificanceHandler, FComponentIterationContext& Context);
