...
class UNiagaraDataInterfaceDynamicMesh : public UNiagaraDataInterface, public INiagaraRenderableMeshInterface, public INiagaraSimCacheCustomStorageInterface
{
