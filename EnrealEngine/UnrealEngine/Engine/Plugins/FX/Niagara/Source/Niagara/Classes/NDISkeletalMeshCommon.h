...
struct FSkeletalMeshAccessorHelper
{
	...
	inline void Init(const FNDISkeletalMesh_InstanceData* InstData)
	{
	...
	inline bool AreBonesAccessible() const
	{
		return Mesh != nullptr;
	}

	inline bool IsLODAccessible() const
	{
...
{
	inline int32 GetBoneCount(FSkeletalMeshAccessorHelper& Accessor, bool RequiresPrevious) const = delete;
	inline void GetTriangleIndices(int32 Tri, int32& Idx0, int32& Idx1, int32& Idx2) = delete;
	inline void GetSkinnedTrianglePositions(FSkeletalMeshAccessorHelper& Accessor, int32 Tri, FVector3f& OutPos0, FVector3f& OutPos1, FVector3f& OutPos2, FVector3f& OutPrev0, FVector3f& OutPrev1, FVector3f& OutPrev2, int32& Idx0, int32& Idx1, int32& Idx2) = delete;
	inline void GetSkinnedTrianglePositions(FSkeletalMeshAccessorHelper& Accessor, int32 Tri, FVector3f& OutPos0, FVector3f& OutPos1, FVector3f& OutPos2, int32& Idx0, int32& Idx1, int32& Idx2) = delete;
	inline FVector3f GetSkinnedVertexPosition(FSkeletalMeshAccessorHelper& Accessor, int32 VertexIndex) = delete;
	inline FVector3f GetSkinnedVertexPreviousPosition(FSkeletalMeshAccessorHelper& Accessor, int32 VertexIndex) = delete;
	inline void GetSkinnedTangentBasis(FSkeletalMeshAccessorHelper& Accessor, int32 VertexIndex, FVector3f& OutTangentX, FVector3f& OutTangentY, FVector3f& OutTangentZ) = delete;
	inline void GetSkinnedPreviousTangentBasis(FSkeletalMeshAccessorHelper& Accessor, int32 VertexIndex, FVector3f& OutTangentX, FVector3f& OutTangentY, FVector3f& OutTangentZ) = delete;
	inline FVector3f GetSkinnedBonePosition(FSkeletalMeshAccessorHelper& Accessor, int32 BoneIndex) = delete;
	inline FVector3f GetSkinnedBonePreviousPosition(FSkeletalMeshAccessorHelper& Accessor, int32 BoneIndex) = delete;
	inline FQuat4f GetSkinnedBoneRotation(FSkeletalMeshAccessorHelper& Accessor, int32 BoneIndex) = delete;
	inline FQuat4f GetSkinnedBonePreviousRotation(FSkeletalMeshAccessorHelper& Accessor, int32 BoneIndex) = delete;
	inline FVector3f GetSkinnedBoneScale(FSkeletalMeshAccessorHelper& Accessor, int32 BoneIndex) = delete;
	inline FVector3f GetSkinnedBonePreviousScale(FSkeletalMeshAccessorHelper& Accessor, int32 BoneIndex) = delete;
};

template<>
struct FSkinnedPositionAccessorHelper<TNDISkelMesh_SkinningModeInvalid>
{
	inline int32 GetBoneCount(FSkeletalMeshAccessorHelper& Accessor, bool RequiresPrevious) const
	{
	...
	inline void GetTriangleIndices(FSkeletalMeshAccessorHelper& Accessor, int32 Tri, int32& Idx0, int32& Idx1, int32& Idx2)
	{
		Idx0 = Idx1 = Idx2 = -1;
	}

	inline void GetSkinnedTrianglePositions(FSkeletalMeshAccessorHelper& Accessor, int32 Idx0, int32 Idx1, int32 Idx2, FVector3f& OutPos0, FVector3f& OutPos1, FVector3f& OutPos2)
	{
		OutPos0 = OutPos1 = OutPos2 = FVector3f::ZeroVector;
	}

	inline void GetSkinnedTrianglePreviousPositions(FSkeletalMeshAccessorHelper& Accessor, int32 Idx0, int32 Idx1, int32 Idx2, FVector3f& OutPos0, FVector3f& OutPos1, FVector3f& OutPos2)
	{
		OutPos0 = OutPos1 = OutPos2 = FVector3f::ZeroVector;
	}

	inline FVector3f GetSkinnedVertexPosition(FSkeletalMeshAccessorHelper& Accessor, int32 VertexIndex)
	{
		return FVector3f::ZeroVector;
	}

	inline FVector3f GetSkinnedVertexPreviousPosition(FSkeletalMeshAccessorHelper& Accessor, int32 VertexIndex)
	{
		return FVector3f::ZeroVector;
	}

	inline void GetSkinnedTangentBasis(FSkeletalMeshAccessorHelper& Accessor, int32 VertexIndex, FVector3f& OutTangentX, FVector3f& OutTangentY, FVector3f& OutTangentZ)
	{
	...
	inline void GetSkinnedPreviousTangentBasis(FSkeletalMeshAccessorHelper& Accessor, int32 VertexIndex, FVector3f& OutTangentX, FVector3f& OutTangentY, FVector3f& OutTangentZ)
	{
		OutTangentX = FVector3f(1.0f, 0.0f, 0.0f);
		OutTangentY = FVector3f(0.0f, 1.0f, 0.0f);
		OutTangentZ = FVector3f(0.0f, 0.0f, 1.0f);
	...
	inline FVector3f GetSkinnedBonePosition(FSkeletalMeshAccessorHelper& Accessor, int32 BoneIndex)
	{
	...
	inline FVector3f GetSkinnedBonePreviousPosition(FSkeletalMeshAccessorHelper& Accessor, int32 BoneIndex)
	{
		return GetSkinnedBonePosition(Accessor, BoneIndex);
	}

	inline FQuat4f GetSkinnedBoneRotation(FSkeletalMeshAccessorHelper& Accessor, int32 BoneIndex)
	{
		const int32 NumRealBones = Accessor.Mesh->GetRefSkeleton().GetRawBoneNum();
		if (BoneIndex < NumRealBones)
		{
	...
	inline FQuat4f GetSkinnedBonePreviousRotation(FSkeletalMeshAccessorHelper& Accessor, int32 BoneIndex)
	{
		return GetSkinnedBoneRotation(Accessor, BoneIndex);
	}

	inline FVector3f GetSkinnedBoneScale(FSkeletalMeshAccessorHelper& Accessor, int32 BoneIndex)
	{
		const int32 NumRealBones = Accessor.Mesh->GetRefSkeleton().GetRawBoneNum();
		if (BoneIndex < NumRealBones)
		{
	...
	inline FVector3f GetSkinnedBonePreviousScale(FSkeletalMeshAccessorHelper& Accessor, int32 BoneIndex)
	{
...
{
	inline FVector2D GetVertexUV(const FSkeletalMeshLODRenderData* LODData, int32 VertexIdx, int32 UVChannel)const
	{
		check(LODData);
	...
	inline FLinearColor GetVertexColor(FSkeletalMeshLODRenderData* LODData, int32 VertexIdx)const
	{
		check(LODData);
...
struct FSkelMeshVertexAccessorNoop
{
	...
	inline FLinearColor GetVertexColor(const FSkeletalMeshLODRenderData* LODData, int32 VertexIdx)const
	{
	...
	static void Bind(UNiagaraDataInterface* Interface, const FVMExternalFunctionBindingInfo& BindingInfo, void* InstanceData, FVMExternalFunction &OutFunc)
	{
		...
		if (InstData->bAllowCPUMeshDataAccess)
		{
			...
			else
			{
				...
				const FSkeletalMeshSamplingInfo& SamplingInfo = InstData->SkeletalMesh->GetSamplingInfo();
				const FSkeletalMeshSamplingBuiltData& SamplingBuildData = SamplingInfo.GetBuiltData();

				bAreaWeighting =
					SamplingBuildData.WholeMeshBuiltData.IsValidIndex(LODIndex) &&
					(SamplingBuildData.WholeMeshBuiltData[LODIndex].AreaWeightedTriangleSampler.GetNumEntries() > 0) &&
					InstData->SkeletalMesh->GetLODInfo(LODIndex)->bSupportUniformlyDistributedSampling;
			}
		}
