...
protected:
	...
	inline float NormalizeTime(float T) const
	{
	...
	inline float UnnormalizeTime(float T) const
	{
...
public:
	...
	inline float GetMinTime()const { return LUTMinTime; }
	inline float GetMaxTime()const { return LUTMaxTime; }
	inline float GetInvTimeRange()const { return LUTInvTimeRange; }
