...
TMap<FNiagaraVariableBase, FString> FNiagaraConstants::AttrDefaultsStrMap;
TMap<FNiagaraVariableBase, FText> FNiagaraConstants::AttrDescStrMap;
TMap<FNiagaraVariableBase, FNiagaraVariableMetaData> FNiagaraConstants::AttrMetaData;
TMap<FNiagaraVariableBase, FNiagaraVariable> FNiagaraConstants::AttrDefaultsValueMap;
TMap<FNiagaraVariableBase, FNiagaraVariable> FNiagaraConstants::AttrDataSetKeyMap;
...
bool FNiagaraConstants::IsEngineManagedAttribute(const FNiagaraVariableBase& Var)
{
...
FString FNiagaraConstants::GetAttributeDefaultValue(const FNiagaraVariableBase& InAttribute)
{
...
FText FNiagaraConstants::GetAttributeDescription(const FNiagaraVariableBase& InAttribute)
{
...
bool FNiagaraConstants::IsNiagaraConstant(const FNiagaraVariableBase& InVar)
{
...
const FNiagaraVariableMetaData* FNiagaraConstants::GetConstantMetaData(const FNiagaraVariableBase& InVar)
{
	check(AttrMetaData.Num() != 0);
	return AttrMetaData.Find(InVar);
}

FNiagaraVariable FNiagaraConstants::GetAttributeWithDefaultValue(const FNiagaraVariableBase& InAttribute)
{
...
FNiagaraVariableBase FNiagaraConstants::GetAttributeAsParticleDataSetKey(const FNiagaraVariableBase& InVar)
{
	static FString ParticlesString = TEXT("Particles.");
	static FString StackContextString = TEXT("StackContext.");

	FNiagaraVariableBase OutVar = InVar;
...
FNiagaraVariableBase FNiagaraConstants::GetAttributeAsEmitterDataSetKey(const FNiagaraVariableBase& InVar)
{
...
FNiagaraVariableAttributeBinding FNiagaraConstants::GetAttributeDefaultBinding(const FNiagaraVariableBase& InVar)
{
