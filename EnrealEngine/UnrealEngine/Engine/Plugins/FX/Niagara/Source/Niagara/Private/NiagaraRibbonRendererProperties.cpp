...
void UNiagaraRibbonRendererProperties::PostLoad()
{
	...
	SetPreviousBindings(FVersionedNiagaraEmitterBase());
...
void UNiagaraRibbonRendererProperties::SetPreviousBindings(const FVersionedNiagaraEmitterBase& SrcEmitter)
{
...
void UNiagaraRibbonRendererProperties::GetRendererMaterialUsageFeedback(TArray<FNiagaraRendererFeedback>& OutFeedback) const
{
	Super::GetRendererMaterialUsageFeedback(OutFeedback);
	GetMaterialUsageFeedback(MATUSAGE_NiagaraRibbons, OutFeedback);
}

void UNiagaraRibbonRendererProperties::RenameVariable(const FNiagaraVariableBase& OldVariable, const FNiagaraVariableBase& NewVariable, const FVersionedNiagaraEmitterBase& InEmitter)
{
...
void UNiagaraRibbonRendererProperties::RemoveVariable(const FNiagaraVariableBase& OldVariable, const FVersionedNiagaraEmitterBase& InEmitter)
{
