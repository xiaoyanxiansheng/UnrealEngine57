...
#include "VectorVM.h"
#include "NiagaraDataInterfaceVirtualTextureSample.generated.h"

/** Data Interface allowing sampling of a texture */
UCLASS(EditInlineNew, Category = "Texture", CollapseCategories, meta = (DisplayName = "Virtual Texture Sample", Experimental), MinimalAPI)
class UNiagaraDataInterfaceVirtualTextureSample : public UNiagaraDataInterface
{
	...
	BEGIN_SHADER_PARAMETER_STRUCT(FShaderParameters, )
		...
		SHADER_PARAMETER_TEXTURE(Texture2D,		PageTableTexture0)
		SHADER_PARAMETER_TEXTURE(Texture2D,		PageTableTexture1)
		SHADER_PARAMETER_SRV(Texture2D,			PhysicalTexture)
