...
#define NIAGARA_SYSTEM_INSTANCE_CONTROLLER_DEFFERED_METHOD(MethodName) \
	...
	inline void MethodName ## _Deferred(ArgTypes... Args) { \
...
#else
#define NIAGARA_SYSTEM_INSTANCE_CONTROLLER_DEFFERED_METHOD(MethodName) \
	template <typename... ArgTypes> inline void MethodName ## _Deferred(ArgTypes... Args) { this->MethodName(Forward<ArgTypes>(Args)...); }
#endif
