...
FNiagaraVariant::FNiagaraVariant(TObjectPtr<UObject> InObject)
{
...
TObjectPtr<UObject> FNiagaraVariant::GetUObject() const
{
	ensure(CurrentMode == ENiagaraVariantMode::Object);
	return Object;
}

void FNiagaraVariant::SetUObject(TObjectPtr<UObject> InObject)
{
