...
#include UE_INLINE_GENERATED_CPP_BY_NAME(NiagaraAssetTagDefinitions)
...
FText UDEPRECATED_NiagaraAssetTagDefinitions::GetDisplayName() const
{
...
FText UDEPRECATED_NiagaraAssetTagDefinitions::GetDescription() const
{
	return Description;
}

bool UDEPRECATED_NiagaraAssetTagDefinitions::DoesAssetDataContainAnyTag(const FAssetData& AssetData) const
{
