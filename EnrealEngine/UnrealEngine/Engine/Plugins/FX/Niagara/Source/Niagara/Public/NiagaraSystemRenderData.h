...
public:
	...
	inline bool IsRenderingEnabled_GT() const { return bRenderingEnabled_GT && EmitterRenderers_GT.Num() > 0; }
	inline bool IsRenderingEnabled_RT() const { return bRenderingEnabled_RT && EmitterRenderers_RT.Num() > 0; }

	inline bool HasAnyMotionBlurEnabled() const { return bAnyMotionBlurEnabled; }
	inline bool HasAnyHeterogeneousVolumesEnabled() const { return bAnyHeterogeneousVolumesEnabled; }

	inline int32 GetNumRenderers() const { return RendererDrawOrder.Num(); }
