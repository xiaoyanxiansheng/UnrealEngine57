...
public:
	...
	FNiagaraGraphViewSettings(const UE::Slate::FDeprecateVector2DParameter& InLocation, float InZoom)
		: Location(InLocation)
		, Zoom(InZoom)
		, bIsValid(true)
	{
	...
	const FDeprecateSlateVector2D& GetLocation() const { return Location; }
