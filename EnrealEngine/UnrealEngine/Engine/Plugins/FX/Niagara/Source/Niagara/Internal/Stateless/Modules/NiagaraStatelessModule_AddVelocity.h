...
public:
	...
	UPROPERTY(EditAnywhere, Category = "Parameters", meta = (DisplayName = "Velocity Scale", DisableRangeDistribution, EditConditionHides, EditCondition = "VelocityType == ENSM_VelocityType::Linear"))
	FNiagaraDistributionRangeFloat LinearVelocityScale = FNiagaraDistributionRangeFloat(1.0f);
