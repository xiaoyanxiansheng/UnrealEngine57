...
struct FNiagaraDeviceProfileStateEntry
{
	...
	inline ENiagaraPlatformSelectionState GetState(int32 QualityLevel)const;

	inline void SetState(int32 QualityLevel, ENiagaraPlatformSelectionState State);

	inline bool AllDefaulted()const { return SetQualityLevelMask == 0; }

	inline bool operator==(const FNiagaraDeviceProfileStateEntry& Other)const
	{
...
struct FNiagaraCVarValue
{
	...
	template<typename T> inline void SetTyped(const FString& Str);
	inline void Set(const FString& Str, IConsoleVariable* CVar);
};

template<> inline bool FNiagaraCVarValue::Get<bool>()const{ return Data.bValue; }
template<> inline void FNiagaraCVarValue::SetTyped<bool>(const FString& Str){ LexFromString(Data.bValue, *Str); }

template<> inline int32 FNiagaraCVarValue::Get<int32>()const { return Data.IntValue; }
template<> inline void FNiagaraCVarValue::SetTyped<int32>(const FString& Str) { LexFromString(Data.IntValue, *Str); }

template<> inline float FNiagaraCVarValue::Get<float>()const { return Data.FloatValue; }
template<> inline void FNiagaraCVarValue::SetTyped<float>(const FString& Str) { LexFromString(Data.FloatValue, *Str); }

inline void FNiagaraCVarValue::Set(const FString& Str, IConsoleVariable* CVar)
{
...
struct FNiagaraPlatformSetCVarCondition
{
	...
	inline bool CheckValue(bool CVarValue)const { return CVarValue == Value; }
	inline bool CheckValue(int32 CVarValue)const { return (!bUseMinInt || CVarValue >= MinInt) && (!bUseMaxInt || CVarValue <= MaxInt); }
	inline bool CheckValue(float CVarValue)const { return (!bUseMinFloat || CVarValue >= MinFloat) && (!bUseMaxFloat || CVarValue <= MaxFloat); }

	template<typename T>
	inline T GetCVarValue(IConsoleVariable* CVar)const;
...
struct FNiagaraPlatformSet
{
	...
	static inline int32 QualityLevelFromMask(int32 QLMask);
	static inline int32 CreateQualityLevelMask(int32 QL);
...
inline int32 FNiagaraPlatformSet::QualityLevelFromMask(int32 QLMask)
{
...
inline int32 FNiagaraPlatformSet::CreateQualityLevelMask(int32 QL)
{
	return QL == INDEX_NONE ? INDEX_NONE : (1 << QL);
}


inline ENiagaraPlatformSelectionState FNiagaraDeviceProfileStateEntry::GetState(int32 QualityLevel)const
{
...
inline void FNiagaraDeviceProfileStateEntry::SetState(int32 QualityLevel, ENiagaraPlatformSelectionState State)
{
	int32 QLMask = FNiagaraPlatformSet::CreateQualityLevelMask(QualityLevel);
