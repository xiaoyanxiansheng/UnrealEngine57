...
class UNiagaraSettings : public UDeveloperSettings
{
	...
	/**
	Enable HLSL 2021 compilation flag.
	Note: Only GPU simulations on some platforms will work with HLSL 2021.
	*/
	UPROPERTY(config, EditAnywhere, Category = Niagara, meta = (ConfigRestartRequired = true, ConsoleVariable="fx.Niagara.Shader.EnableHLSL2021"))
	bool bEnableHLSL2021 = false;
#endif
