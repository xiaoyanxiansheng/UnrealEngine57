 ...
 */
class FConstrainedMeshDeformer : public FConstrainedMeshDeformationSolver
{
public:
	UE_API FConstrainedMeshDeformer(const FDynamicMesh3& DynamicMesh, const ELaplacianWeightScheme LaplacianType);
	...
	UE_API bool Deform(TArray<FVector3d>& PositionBuffer) override;
 ...
 */
class FSoftMeshDeformer : public FSoftMeshDeformationSolver
{
public:
	UE_API FSoftMeshDeformer(const FDynamicMesh3& DynamicMesh);
