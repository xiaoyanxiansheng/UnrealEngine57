 ...
 */
class FOffsetMeshRegion : public FOffsetMeshRegionFixLayout
{
public:
...
public:
	UE_API FOffsetMeshRegion(FDynamicMesh3* mesh);
	...
	static UE_API bool EdgesSeparateSameGroupsAndAreColinearAtBorder(FDynamicMesh3* Mesh,
		int32 Eid1, int32 Eid2, bool bCheckColinearityAtBorder);
protected:

	UE_API virtual bool ApplyOffset(FOffsetInfo& Region);

	UE_API virtual bool ApplyOffset_Legacy(FOffsetInfo& Region);
	UE_API virtual bool ApplyOffset_Version1(FOffsetInfo& Region);
};
