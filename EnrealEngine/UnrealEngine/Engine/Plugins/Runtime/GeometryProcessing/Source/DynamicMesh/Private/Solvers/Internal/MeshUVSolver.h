 ...
 */
class FConstrainedMeshUVSolver : public UE::Solvers::IConstrainedMeshUVSolver
{
public:
	typedef UE::Solvers::FUVConstraint  FUVConstraint;
	
	UE_API FConstrainedMeshUVSolver(const FDynamicMesh3& DynamicMesh);
	...
	UE_API void AddConstraint(const int32 VtxId, const double Weight, const FVector2d& Pos, const bool bPostFix) override;

	// Update the position of an existing constraint. Bool return if a corresponding constraint weight exists.
	UE_API bool UpdateConstraintPosition(const int32 VtxId, const FVector2d& Position, const bool bPostFix) override;
 ...
 */
class FConformalMeshUVSolver : public FConstrainedMeshUVSolver
{
public:
	 ...
	 */
	UE_API void ConstructConformalEnergyMatrix(FSparseMatrixD& OutConfromalEnergy,
...
protected:
	 ...
	 */
	UE_API void ConstructVectorAreaMatrix(FSparseMatrixD& OutAreaMatrix);
	 ...
	 */
	UE_API void ConstructWeightedVectorAreaMatrix(FSparseMatrixD& OutAreaMatrix, 
										   double& OutMaxArea,
										   const double InSmallTriangleArea = SMALL_NUMBER); 
 ...
 */
class FLeastSquaresConformalMeshUVSolver : public FConformalMeshUVSolver
{
public:
	...
	UE_API virtual bool SolveUVs(const FDynamicMesh3* InMesh, TArray<FVector2d>& OutUVBuffer) override;
...
protected:
	 ...
	 */
	UE_API void ConstructSystemMatrices(FSparseMatrixD& OutSystemMatrix);
	 ...
	 */
	UE_API bool SolveParameterization(const FSparseMatrixD& InSystemMatrix, 
 ...
 */
class FSpectralConformalMeshUVSolver : public FConformalMeshUVSolver
{
public:
...
public:
	 ...
	 */ 
	UE_API void SetInitialSolution(const TArray<FVector2d>& InInitialUVs);
	 ...
	 */
	UE_API void SetInitialSolution(const FRandomStream& InRandomStream);
...
protected: 
	 ...
	 */
	UE_API void ConstructSystemMatrices(FSparseMatrixD& OutConformalEnergy, 
	 ...
	 */
	UE_API bool SolveParameterization(const FSparseMatrixD& InConformalEnergy,
