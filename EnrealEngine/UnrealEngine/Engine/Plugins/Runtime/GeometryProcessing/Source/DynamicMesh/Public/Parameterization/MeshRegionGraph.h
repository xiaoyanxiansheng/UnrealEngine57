...
private:
	// MergeRegion without validation, for internal use where we know the inputs are valid neighbors
	bool MergeRegionUnsafe(int32 RemoveRgnIdx, int32 MergeToRgnIdx);
