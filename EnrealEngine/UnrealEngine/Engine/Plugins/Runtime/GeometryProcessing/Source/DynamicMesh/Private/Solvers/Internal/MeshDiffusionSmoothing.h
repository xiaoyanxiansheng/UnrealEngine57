...
public:
	...
	FLaplacianDiffusionMeshSmoother(const FDynamicMesh3& DynamicMesh, const ELaplacianWeightScheme Scheme, FProgressCancel* Progress = nullptr)
		: FMeshDiffusionIntegrator(DynamicMesh, Scheme, Progress)
	{
...
public:
	...
	FBiHarmonicDiffusionMeshSmoother(const FDynamicMesh3& DynamicMesh, const ELaplacianWeightScheme Scheme, FProgressCancel* Progress = nullptr)
		: FMeshDiffusionIntegrator(DynamicMesh, Scheme, Progress)
	{
		Initialize(DynamicMesh, Scheme);
	}
