...
const void* FOpenXRViveTracker::OnCreateSession(XrInstance InInstance, XrSystemId InSystem, const void* InNext)
{
	...
	FCStringAnsi::Strncpy(CreateInfo.actionSetName, "trackers", XR_MAX_ACTION_SET_NAME_SIZE);
	FCStringAnsi::Strncpy(CreateInfo.localizedActionSetName, "Vive Trackers",
