...
namespace Metasound
{
	namespace Editor
	{
		...
		{
			FDeprecateSlateVector2D P0;
			FDeprecateSlateVector2D P0Tangent;
			FDeprecateSlateVector2D P1;
			FDeprecateSlateVector2D P1Tangent;
			...
			FDeprecateSlateVector2D ClosestPoint;

			const FMetasoundFrontendEdgeStyle* EdgeStyle = nullptr;

			FDrawConnectionData(const UE::Slate::FDeprecateVector2DParameter& InStart, const UE::Slate::FDeprecateVector2DParameter& InEnd, const FEditor& Editor, const UE::Slate::FDeprecateVector2DParameter& InSplineTangent, const FConnectionParams& InParams, const UGraphEditorSettings& InSettings, const UE::Slate::FDeprecateVector2DParameter& InMousePosition);
		...
		public:
			...
			virtual void DrawConnection(int32 LayerId, const FVector2f& Start, const FVector2f& End, const FConnectionParams& InParams) override;
