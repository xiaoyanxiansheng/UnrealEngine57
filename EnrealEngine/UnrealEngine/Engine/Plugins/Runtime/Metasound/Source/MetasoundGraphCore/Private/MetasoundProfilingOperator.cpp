...
namespace Metasound
{
	...
	void FProfilingOperator::SetAssetMetaData(const ThreadLocalDebug::FAssetMetaData& InAssetMetaData)
	{
...
#if UE_METASOUND_DEBUG_ENABLED
		const ThreadLocalDebug::FAssetMetaData& AssetMetaData = DerivedOperator->AssetMetaData;
		UE_TRACE_METADATA_SCOPE_ASSET_FNAME(AssetMetaData.ClassName, AssetMetaData.AssetName, AssetMetaData.AssetPath);
#endif // #if UE_METASOUND_DEBUG_ENABLED
