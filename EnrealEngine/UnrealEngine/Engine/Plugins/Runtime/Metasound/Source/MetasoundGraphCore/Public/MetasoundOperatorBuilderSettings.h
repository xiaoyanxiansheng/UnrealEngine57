...
namespace Metasound
{
	...
	struct FOperatorBuilderSettings
	{
		...
		*/
		...
		static UE_API const FOperatorBuilderSettings& GetDefaultSettings();

		/** Return the default settings for a debug build environment. */
		static UE_API const FOperatorBuilderSettings& GetDefaultDebugSettings();

		/** Return the default settings for a development build environment. */
		static UE_API const FOperatorBuilderSettings& GetDefaultDevelopementSettings();

		/** Return the default settings for a test build environment. */
		static UE_API const FOperatorBuilderSettings& GetDefaultTestSettings();

		/** Return the default settings for a shipping build environment. */
		static UE_API const FOperatorBuilderSettings& GetDefaultShippingSettings();
	};
} // namespace Metasound
