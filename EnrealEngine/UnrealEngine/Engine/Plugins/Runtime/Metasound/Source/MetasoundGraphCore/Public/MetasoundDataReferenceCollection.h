...
namespace Metasound
{
	...
	class FDataReferenceCollection
	{
		...
		public:
			...
			UE_API void AddDataReference(const FVertexName& InName, FAnyDataReference&& InDataReference);
			 ...
			 */
			UE_API bool AddDataReadReferenceFrom(const FVertexName& InLocalName, const FDataReferenceCollection& InOtherCollection, const FVertexName& InOtherName, const FName& InOtherTypeName);
			 ...
			 * @return True if the data was successfully added. False otherwise. 
			 */
			UE_API bool AddDataWriteReferenceFrom(const FVertexName& InLocalName, const FDataReferenceCollection& InOtherCollection, const FVertexName& InOtherName, const FName& InOtherTypeName);
			 ...
			 */
			UE_API bool ContainsDataReadReference(const FVertexName& InName, const FName& InTypeName) const;
			 ...
			 * @return True if the data exists in the collection. False otherwise. 
			 */
			UE_API bool ContainsDataWriteReference(const FVertexName& InName, const FName& InTypeName) const;
			 ...
			 */
			UE_API const FAnyDataReference* FindDataReference(const FVertexName& InName) const;
