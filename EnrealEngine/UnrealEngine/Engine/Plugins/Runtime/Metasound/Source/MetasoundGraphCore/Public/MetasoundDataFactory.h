				...
				case ELiteralType::UObjectProxy:
					{
						...
						if constexpr (!bIsParsable && bIsParsableWithDeprecatedPtr)
						{
							...
							auto Result = FFactoryForDeprecatedPtr::CreateExplicitArgs(InSettings, (const TUniquePtr<Audio::IProxyData>&)DeprecatedProxyDataPtr);
				...
				case ELiteralType::UObjectProxyArray:
					{
						...
						if constexpr (!bIsParsable && bIsParsableWithDeprecatedPtr)
						{
							...
							auto Result = FFactoryForDeprecatedPtr::CreateExplicitArgs(InSettings, (const TArray<TUniquePtr<Audio::IProxyData>>&)DeprecatedArray);
