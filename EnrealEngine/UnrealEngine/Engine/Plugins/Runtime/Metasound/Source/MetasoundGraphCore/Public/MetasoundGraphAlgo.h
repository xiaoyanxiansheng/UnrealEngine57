...
namespace Metasound
{
	...
	struct FDirectedGraphAlgo
	{
		 ...
		 */
		static UE_API TPimplPtr<FDirectedGraphAlgoAdapter> CreateDirectedGraphAlgoAdapter(const IGraph& InGraph);
		 ...
		 */
		static UE_API bool DepthFirstTopologicalSort(const IGraph& InGraph, TArray<const INode*>& OutNodeOrder);
		 ...
		 * @return True if sorting was successful, false otherwise. 
		 */
		static UE_API bool DepthFirstTopologicalSort(const FDirectedGraphAlgoAdapter& InAdapter, TArray<const INode*>& OutNodeOrder);
		 ...
		 * @return True if sorting was successful, false otherwise. 
		 */
		static UE_API bool KahnTopologicalSort(const IGraph& InGraph, TArray<const INode*>& OutNodeOrder);
		 ...
		 * @return True if sorting was successful, false otherwise. 
		 */
		static UE_API bool KahnTopologicalSort(const FDirectedGraphAlgoAdapter& InAdapter, TArray<const INode*>& OutNodeOrder);
		 ...
		 */
		static UE_API bool TarjanStronglyConnectedComponents(const IGraph& InGraph, TArray<DirectedGraphAlgo::FStronglyConnectedComponent>& OutComponents, bool bExcludeSingleVertex = true);
		 ...
		 *         to OutComponents. False otherwise. 
		 */
		static UE_API bool TarjanStronglyConnectedComponents(const FDirectedGraphAlgoAdapter& InAdapter, TArray<DirectedGraphAlgo::FStronglyConnectedComponent>& OutComponents, bool bExcludeSingleVertex = true);
		 ...
		 */
		static UE_API void FindReachableNodesFromInput(const IGraph& InGraph, TSet<const INode*>& OutNodes);
		 ...
		 * @param OutNodes  - The nodes which were reached during traversal.
		 */
		static UE_API void FindReachableNodesFromInput(const FDirectedGraphAlgoAdapter& InAdapter, TSet<const INode*>& OutNodes);
		 ...
		 * @param OutNodes - The nodes which were reached during traversal.
		 */
		static UE_API void FindReachableNodesFromOutput(const IGraph& InGraph, TSet<const INode*>& OutNodes);
		 ...
		 * @param OutNodes  - The nodes which were reached during traversal.
		 */
		static UE_API void FindReachableNodesFromOutput(const FDirectedGraphAlgoAdapter& InAdapter, TSet<const INode*>& OutNodes);
		 ...
		 * @param OutNodes - The nodes which were reached during traversal.
		 */
		static UE_API void FindReachableNodes(const IGraph& InGraph, TSet<const INode*>& OutNodes);
		 ...
		 * @param OutNodes  - The nodes which were reached during traversal.
		 */
		static UE_API void FindReachableNodes(const FDirectedGraphAlgoAdapter& InAdapter, TSet<const INode*>& OutNodes);
	};
