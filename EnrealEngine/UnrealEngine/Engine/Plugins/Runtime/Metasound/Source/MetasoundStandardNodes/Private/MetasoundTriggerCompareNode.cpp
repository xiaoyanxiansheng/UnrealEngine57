	...
	namespace MetasoundTriggerCompareNodePrivate
	{
		FNodeClassMetadata CreateNodeClassMetadata(const FName& InDataTypeName, const FName& InOperatorName, const FText& InDisplayName, const FText& InDescription, const FVertexInterface& InDefaultInterface)
		{
			FNodeClassMetadata Metadata
			{
				...
				{
					METASOUND_LOCTEXT("EqualsKeyword", "="), METASOUND_LOCTEXT("NotEqualsKeyword", "!="),
					METASOUND_LOCTEXT("LessThanKeyword", "<"), METASOUND_LOCTEXT("GreaterThanKeyword", ">"),
					METASOUND_LOCTEXT("LessEqualsKeyword", "<="), METASOUND_LOCTEXT("GreaterEqualsKeyword", ">="),
					METASOUND_LOCTEXT("EqualsTextKeyword", "equal"), METASOUND_LOCTEXT("InequalsKeyword", "inequal"),
					METASOUND_LOCTEXT("NotKeyword", "not"),
					METASOUND_LOCTEXT("LessThanTextKeyword", "less"),
					METASOUND_LOCTEXT("GreatThanTextKeyword", "greater"),
					METASOUND_LOCTEXT("IfKeyword", "if"), METASOUND_LOCTEXT("BranchKeyword", "branch")},
				FNodeDisplayStyle()
			};
