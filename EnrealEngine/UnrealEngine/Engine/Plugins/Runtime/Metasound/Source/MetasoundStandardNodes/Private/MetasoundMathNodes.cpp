...
namespace Metasound
{
	...
	public:
		...
		{
			TMathOpClass::Reset(InstanceData, PrimaryOperandRef, AdditionalOperandRefs, ValueRef);
		}
	...
	public:
		...
		static void Reset(TMathOpAdd<TDataClass, TOperandDataClass>& InInstanceData, const TDataClassReadRef& InPrimaryOperand, const TArray<TOperandDataClassReadRef>& InAdditionalOperands, TDataClassWriteRef& OutResult)
		{
			Calculate(InInstanceData, InPrimaryOperand, InAdditionalOperands, OutResult);
		}
	...
	public:
		...
		static void Reset(TMathOpSubtract<TDataClass, TOperandDataClass>& InInstanceData, const TDataClassReadRef& InPrimaryOperand, const TArray<TOperandDataClassReadRef>& InAdditionalOperands, TDataClassWriteRef& OutResult)
		{
			Calculate(InInstanceData, InPrimaryOperand, InAdditionalOperands, OutResult);
		}
	...
	public:
		...
		static void Reset(TMathOpMultiply<TDataClass, TOperandDataClass>& InInstanceData, const TDataClassReadRef& InPrimaryOperand, const TArray<TOperandDataClassReadRef>& InAdditionalOperands, TDataClassWriteRef& OutResult)
		{
			Calculate(InInstanceData, InPrimaryOperand, InAdditionalOperands, OutResult);
		}
	...
	public:
		...
		static void Reset(TMathOpDivide<TDataClass, TOperandDataClass>& InInstanceData, const TDataClassReadRef& InPrimaryOperand, const TArray<TOperandDataClassReadRef>& InAdditionalOperands, TDataClassWriteRef& OutResult)
		{
			Calculate(InInstanceData, InPrimaryOperand, InAdditionalOperands, OutResult);
		}
	...
	public:
		...
		static void Reset(TMathOpModulo<TDataClass, TOperandDataClass>& InInstanceData, const TDataClassReadRef& InPrimaryOperand, const TArray<TOperandDataClassReadRef>& InAdditionalOperands, TDataClassWriteRef& OutResult)
		{
			Calculate(InInstanceData, InPrimaryOperand, InAdditionalOperands, OutResult);
		}
	...
	public:
		...
		static void Reset(TMathOpPower<TDataClass, TOperandDataClass>& InInstanceData, const TDataClassReadRef& InPrimaryOperand, const TArray<TOperandDataClassReadRef>& InAdditionalOperands, TDataClassWriteRef& OutResult)
		{
			Calculate(InInstanceData, InPrimaryOperand, InAdditionalOperands, OutResult);
		}
	...
	public:
		...
		static void Reset(TMathOpLogarithm<TDataClass, TOperandDataClass>& InInstanceData, const TDataClassReadRef& InPrimaryOperand, const TArray<TOperandDataClassReadRef>& InAdditionalOperands, TDataClassWriteRef& OutResult)
		{
			Calculate(InInstanceData, InPrimaryOperand, InAdditionalOperands, OutResult);
		}
	...
	public:
		...
		static void Calculate(TMathOpAdd<FAudioBuffer>& InInstanceData, const FAudioBufferReadRef& InPrimaryOperand, const TArray<FAudioBufferReadRef>& InAdditionalOperands, FAudioBufferWriteRef& OutResult)
		{
			if (!ensure(!InAdditionalOperands.IsEmpty()))
			{
				OutResult->Zero();
		...
		static void Reset(TMathOpAdd<FAudioBuffer>& InInstanceData, const FAudioBufferReadRef& InPrimaryOperand, const TArray<FAudioBufferReadRef>& InAdditionalOperands, FAudioBufferWriteRef& OutResult)
		{
			Calculate(InInstanceData, InPrimaryOperand, InAdditionalOperands, OutResult);
		}
	...
	public:
		...
		static void Reset(TMathOpAdd& InInstanceData, const FTimeReadRef& InPrimaryOperand, const TArray<FTimeReadRef>& InAdditionalOperands, FTimeWriteRef& OutResult)
		{
			Calculate(InInstanceData, InPrimaryOperand, InAdditionalOperands, OutResult);
		}
	...
	public:
		...
		static void Reset(TMathOpAdd& InInstanceData, const FAudioBufferReadRef& InPrimaryOperand, const TArray<FFloatReadRef>& InAdditionalOperands, FAudioBufferWriteRef& OutResult)
		{
			Calculate(InInstanceData, InPrimaryOperand, InAdditionalOperands, OutResult);
		}
	...
	public:
		...
		static void Calculate(TMathOpSubtract& InInstanceData, const FAudioBufferReadRef& InPrimaryOperand, const TArray<FAudioBufferReadRef>& InAdditionalOperands, FAudioBufferWriteRef& OutResult)
		{
			if (!ensure(!InAdditionalOperands.IsEmpty()))
			{
				OutResult->Zero();
		...
		static void Reset(TMathOpSubtract& InInstanceData, const FAudioBufferReadRef& InPrimaryOperand, const TArray<FAudioBufferReadRef>& InAdditionalOperands, FAudioBufferWriteRef& OutResult)
		{
			Calculate(InInstanceData, InPrimaryOperand, InAdditionalOperands, OutResult);
		}
	...
	public:
		...
		static void Reset(TMathOpSubtract& InInstanceData, const FTimeReadRef& InPrimaryOperand, const TArray<FTimeReadRef>& InAdditionalOperands, FTimeWriteRef& OutResult)
		{
			Calculate(InInstanceData, InPrimaryOperand, InAdditionalOperands, OutResult);
		}
	...
	public:
		...
		static void Reset(TMathOpMultiply& InInstanceData, const FAudioBufferReadRef& InPrimaryOperand, const TArray<FAudioBufferReadRef>& InAdditionalOperands, FAudioBufferWriteRef& OutResult)
		{
			Calculate(InInstanceData, InPrimaryOperand, InAdditionalOperands, OutResult);
		}
	...
	public:
		...
		static void Reset(TMathOpMultiply& InInstanceData, const FAudioBufferReadRef& InPrimaryOperand, const TArray<FFloatReadRef>& InAdditionalOperands, FAudioBufferWriteRef& OutResult)
		{
			InInstanceData.bInit = false;
			OutResult->Zero();
		}
	...
	public:
		...
		static void Reset(TMathOpMultiply& InInstanceData, const FTimeReadRef& InPrimaryOperand, const TArray<FFloatReadRef>& InAdditionalOperands, FTimeWriteRef& OutResult)
		{
			Calculate(InInstanceData, InPrimaryOperand, InAdditionalOperands, OutResult);
		}
	...
	public:
		...
		static void Reset(TMathOpDivide& InInstanceData, const FTimeReadRef& InPrimaryOperand, const TArray<FFloatReadRef>& InAdditionalOperands, FTimeWriteRef& OutResult)
		{
			Calculate(InInstanceData, InPrimaryOperand, InAdditionalOperands, OutResult);
		}
