...
namespace Metasound
{
	 ...
	 */
	class FMultichannelAudioFormat : public IAudioDataType
	{
		public:
			UE_API FMultichannelAudioFormat();
			 ...
			 */
			UE_API FMultichannelAudioFormat(int32 InNumFrames, int32 InNumChannels);
			 ...
			 */
			UE_API explicit FMultichannelAudioFormat(const FOperatorSettings& InSettings, int32 InNumChannels);
			 ...
			 */
			UE_API FMultichannelAudioFormat(TArrayView<const FAudioBufferWriteRef> InWriteRefs);
		...
		private:
			...
			UE_API FMultichannelAudioFormat(TArrayView<const FAudioBufferReadRef> InReadRefs);
