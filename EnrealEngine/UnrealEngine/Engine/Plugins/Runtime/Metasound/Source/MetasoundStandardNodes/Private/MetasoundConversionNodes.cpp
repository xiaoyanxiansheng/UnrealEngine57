...
#define METASOUND_REGISTER_CONVERSION(NodeClass, FromDataType, ToDataType) \
	METASOUND_IMPLEMENT_REGISTRATION_ACTION(UE_JOIN(Conversion,NodeClass), (&Metasound::RegisterConversionOperator<FromDataType, ToDataType>), nullptr)
...
namespace Metasound
{
	...
	bool RegisterConversionOperator(const Frontend::FModuleInfo& InModuleInfo)
	{
