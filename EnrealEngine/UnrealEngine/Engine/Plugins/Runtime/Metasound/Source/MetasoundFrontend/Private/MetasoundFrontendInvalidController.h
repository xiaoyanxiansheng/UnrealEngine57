...
namespace Metasound
{
	namespace Frontend
	{
		...
		class FInvalidGraphController : public IGraphController 
		{
			...
			virtual FMetasoundFrontendLiteral GetDefaultInput(const FGuid& InVertexID, TArrayView<const FGuid> InPageOrder) const override { return FMetasoundFrontendLiteral{}; }
			...
			virtual bool SetDefaultInput(const FGuid& InVertexID, const FMetasoundFrontendLiteral& InLiteral, TArrayView<const FGuid> InPageOrder) override { return false; }
