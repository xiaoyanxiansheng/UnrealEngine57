...
namespace Metasound
{
	namespace Frontend
	{
		namespace MetasoundFrontendProxyDataCachePrivate
		{
			...
			void CreateAndCacheProxies(FProxyDataCache& InCache, const DocElementType& InDocElement, TArrayView<const FGuid> InPageOrder)
			{
				...
				ForEachLiteral(InDocElement, CreateProxies, InPageOrder);
			}
		}

		void FProxyDataCache::CreateAndCacheProxies(const FMetasoundFrontendDocument& InDocument, TArrayView<const FGuid> InPageOrder)
		{
			METASOUND_TRACE_CPUPROFILER_EVENT_SCOPE(Metasound::FProxyDataCache::CreateAndCacheProxies_Document)
			MetasoundFrontendProxyDataCachePrivate::CreateAndCacheProxies(*this, InDocument, InPageOrder);
		}

		void FProxyDataCache::CreateAndCacheProxies(const FMetasoundFrontendGraphClass& InGraphClass, TArrayView<const FGuid> InPageOrder)
		{
			METASOUND_TRACE_CPUPROFILER_EVENT_SCOPE(Metasound::FProxyDataCache::CreateAndCacheProxies_GraphClass)
			MetasoundFrontendProxyDataCachePrivate::CreateAndCacheProxies(*this, InGraphClass, InPageOrder);
		}

		void FProxyDataCache::CreateAndCacheProxies(const FMetasoundFrontendClass& InClass, TArrayView<const FGuid> InPageOrder)
		{
			METASOUND_TRACE_CPUPROFILER_EVENT_SCOPE(Metasound::FProxyDataCache::CreateAndCacheProxies_Class)
			MetasoundFrontendProxyDataCachePrivate::CreateAndCacheProxies(*this, InClass, InPageOrder);
		}
