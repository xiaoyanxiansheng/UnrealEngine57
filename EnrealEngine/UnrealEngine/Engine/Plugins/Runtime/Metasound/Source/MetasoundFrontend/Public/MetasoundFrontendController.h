...
namespace Metasound
{
	namespace Frontend
	{
		...
		public:
			...
			UE_DEPRECATED(5.6, "Moved to FMetaSoundFrontendDocumentBuilder")
		...
		class IGraphController : public TSharedFromThis<IGraphController>, public IDocumentAccessor
		{
			...
			virtual FMetasoundFrontendLiteral GetDefaultInput(const FGuid& InVertexID, TArrayView<const FGuid> InPageOrder) const = 0;
			...
			virtual bool SetDefaultInput(const FGuid& InVertexID, const FMetasoundFrontendLiteral& InLiteral, TArrayView<const FGuid> InPageOrder) = 0;
