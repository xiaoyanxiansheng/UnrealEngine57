...
namespace Metasound
{
	...
	namespace Frontend
	{
		...
		public:
			...
			UE_DEPRECATED(5.7, "Use version which provides page order")
			virtual FMetasoundFrontendLiteral GetDefaultInput(const FGuid& InVertexID) const override;

			virtual FMetasoundFrontendLiteral GetDefaultInput(const FGuid& InVertexID, TArrayView<const FGuid> InPageOrder) const override;
			...
			UE_DEPRECATED(5.7, "Use version which provides page order")
			virtual bool SetDefaultInput(const FGuid& InVertexID, const FMetasoundFrontendLiteral& InLiteral) override;

			virtual bool SetDefaultInput(const FGuid& InVertexID, const FMetasoundFrontendLiteral& InLiteral, TArrayView<const FGuid> InPageOrder) override;
