...
void FAndroidDeviceProfileSelector::VerifySelectorParams()
{
	...
	check(SelectorProperties.Find(FAndroidProfileSelectorSourceProperties::SRC_VKQuality));
}
...
FString FAndroidDeviceProfileSelector::FindMatchingProfile(const FString& FallbackProfileName)
{
	...
	FString VKQuality			= SelectorProperties.FindChecked(FAndroidProfileSelectorSourceProperties::SRC_VKQuality);
