...
struct FMassStaticMeshInstanceVisualizationMeshDesc
{
	...
	friend inline uint32 GetTypeHash(const FMassStaticMeshInstanceVisualizationMeshDesc& MeshDesc)
	{
		uint32 Hash = 0x0;
...
public:
	...
	inline FMassLODSignificanceRange* GetLODSignificanceRange(float LODSignificance)
	{
...
{
	FMassInstancedStaticMeshInfoArrayViewAccessDetector(TArrayView<FMassInstancedStaticMeshInfo> InInstancedStaticMeshInfos, const FRWAccessDetector& InAccessDetector)
	...
	inline FMassInstancedStaticMeshInfo& operator[](int32 Index) const
	{
