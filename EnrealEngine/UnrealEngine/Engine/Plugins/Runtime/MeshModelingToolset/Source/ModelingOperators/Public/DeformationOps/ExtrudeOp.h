...
class FExtrudeOp : public FDynamicMeshOperator
{
public:
...
protected:
	UE_API virtual bool BooleanExtrude(FProgressCancel* Progress);
	UE_API virtual bool MoveAndStitchExtrude(FProgressCancel* Progress);
};
