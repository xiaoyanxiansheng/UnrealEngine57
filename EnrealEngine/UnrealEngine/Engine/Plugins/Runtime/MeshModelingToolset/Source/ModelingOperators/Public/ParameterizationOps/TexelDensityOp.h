...
public:
	...
	UFUNCTION()
	UE_API virtual bool InSamplingMode() const;
...
namespace UE
{
	namespace Geometry
	{
		...
		class FUVEditorTexelDensityOp : public FDynamicMeshOperator
		{
		public:
		...
		protected:
			...
			UE_API void ScaleMeshSubRegionByDensity(FDynamicMeshUVOverlay* UVLayer, const TArray<int32>& Tids, TSet<int32>& UVElements, int32 TileResolution);
 ...
 */
UCLASS(MinimalAPI)
class UUVTexelDensityOperatorFactory : public UObject, public UE::Geometry::IDynamicMeshOperatorFactory
{
	GENERATED_BODY()
