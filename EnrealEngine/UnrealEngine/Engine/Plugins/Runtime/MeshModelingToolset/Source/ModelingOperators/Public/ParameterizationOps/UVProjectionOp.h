...
public:
	...
	UE_API virtual void CalculateResult_Box(FProgressCancel* Progress);
	UE_API virtual void CalculateResult_Plane(FProgressCancel* Progress);
	UE_API virtual void CalculateResult_ExpMap(FProgressCancel* Progress);
	UE_API virtual void CalculateResult_Cylinder(FProgressCancel* Progress);
};
