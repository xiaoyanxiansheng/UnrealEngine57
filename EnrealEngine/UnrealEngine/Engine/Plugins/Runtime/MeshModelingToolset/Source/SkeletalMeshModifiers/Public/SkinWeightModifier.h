...
public:
	...
	UE_API bool SetSkeletalMesh(USkeletalMesh* InMesh);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Mesh")
	UE_API bool CommitWeightsToSkeletalMesh();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Mesh Query")
	UE_API TArray<FName> GetAllBoneNames();
	...
	UE_API TMap<FName, float> GetVertexWeights(const int32 VertexID);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Weights")
	UE_API bool NormalizeVertexWeights(const int32 VertexID);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Weights")
	UE_API bool NormalizeAllWeights();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Weights")
	UE_API bool EnforceMaxInfluences(const int32 MaxInfluences=-1);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Weights")
	UE_API bool PruneVertexWeights(const int32 VertexID, const float WeightThreshold);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Weights")
	UE_API bool PruneAllWeights(const float WeightThreshold);
...
private:
	...
	UE_API bool NormalizeVertexInternal(const int32 VertexID);
	UE_API void EnforceMaxInfluenceInternal(const int32 VertexID, const int32 Max);
	UE_API bool PruneVertexWeightInternal(const int32 VertexID, const float WeightThreshold);
