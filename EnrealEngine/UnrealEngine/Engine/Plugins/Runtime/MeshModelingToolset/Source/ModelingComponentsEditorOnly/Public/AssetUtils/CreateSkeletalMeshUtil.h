...
#include "Engine/EngineTypes.h" // for NaniteSettings
...
namespace UE::AssetUtils
{
	...
	struct FSkeletalMeshAssetOptions
	{
		...
		// Whether to use the specified NaniteSettings when generating the Asset. If false, the default settings (nanite disabled) will be used.
		bool bApplyNaniteSettings = false;
		// Nanite settings to set on skeletal mesh asset, if bApplyNaniteSettings is true
