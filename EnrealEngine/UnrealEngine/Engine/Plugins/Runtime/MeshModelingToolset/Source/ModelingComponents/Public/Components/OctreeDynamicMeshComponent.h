...
public:
	 ...
	 */
	UE_API virtual void SetMesh(UE::Geometry::FDynamicMesh3&& MoveMesh) override;
	 ...
	 */
	UE_API virtual void ApplyTransform(const FTransform3d& Transform, bool bInvert) override;
	 ...
	 */
	UE_API virtual void NotifyMeshUpdated() override;
...
protected:
	 ...
	 */
	UE_API virtual void NotifyMaterialSetUpdated();
...
private:
	...
	UE_API void OnPreMeshObjectChanged(UDynamicMesh* ChangedMeshObject, FDynamicMeshChangeInfo ChangeInfo);
	...
	UE_API FColor GetTriangleColor(int TriangleID);
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "DynamicMesh")
	UE_API void SetDynamicMesh(UDynamicMesh* NewMesh);
};
