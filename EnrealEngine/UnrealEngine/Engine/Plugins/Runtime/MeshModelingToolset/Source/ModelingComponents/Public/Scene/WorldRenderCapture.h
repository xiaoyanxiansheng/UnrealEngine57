...
struct TRenderCaptureTypeData
{
	...
	inline T& operator[](ERenderCaptureType CaptureType)
	{
		switch (CaptureType)
		{
	...
	inline const T& operator[](ERenderCaptureType CaptureType) const
	{
 ...
 */
class FWorldRenderCapture : public FGCObject
{
public:
...
protected:
	...
	TObjectPtr<UTextureRenderTarget2D> LinearRenderTexture = nullptr;
	TObjectPtr<UTextureRenderTarget2D> GammaRenderTexture = nullptr;
	TObjectPtr<UTextureRenderTarget2D> DepthRenderTexture = nullptr;
	...
	TArray<TObjectPtr<UPrimitiveComponent>> ComponentsRestoreMaxDrawDistance;
	void RestoreComponentsMaxDrawDistance();
};
