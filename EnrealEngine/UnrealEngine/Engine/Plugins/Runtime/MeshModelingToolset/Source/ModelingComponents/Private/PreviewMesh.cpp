...
void UPreviewMesh::CreateInWorld(UWorld* World, const FTransform& WithTransform)
{
	...
	// Disable View Mode Overrides because we don't want editor mode visualizations 
	// to be removed/replaced by View Mode Overrides
	DynamicMeshComponent->SetViewModeOverridesEnabled(false);
}
