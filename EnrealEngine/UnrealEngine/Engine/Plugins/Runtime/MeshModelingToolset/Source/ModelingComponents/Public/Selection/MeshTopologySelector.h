...
public:
	 ...
	 */
	UE_API bool FindSelectedElement(const FSelectionSettings& Settings, const FRay3d& Ray, FGroupTopologySelection& ResultOut,
	 ...
	 * @return true if something was selected.
	 */
	UE_API bool FindSelectedElement(const FSelectionSettings& Settings, const FCameraRectangle& CameraRectangle, 
...
protected:
	...
	UE_API bool DoCornerBasedSelection(const FSelectionSettings& Settings, const FRay3d& Ray,
	...
	UE_API bool DoEdgeBasedSelection(const FSelectionSettings& Settings, const FRay3d& Ray,
		FDynamicMeshAABBTree3* Spatial, const FGeometrySet3& TopoSpatial,
		FGroupTopologySelection& ResultOut, FVector3d& SelectedPositionOut, int32 *EdgeSegmentIdOut) const;
};
