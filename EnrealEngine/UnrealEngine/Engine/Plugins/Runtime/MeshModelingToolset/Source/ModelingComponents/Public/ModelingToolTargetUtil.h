...
/**
 * Delete an AActor in the correct way for the editor, with a fallback for the non-editor case
 */
MODELINGCOMPONENTS_API void SafeDeleteActor(AActor* TargetActor);
