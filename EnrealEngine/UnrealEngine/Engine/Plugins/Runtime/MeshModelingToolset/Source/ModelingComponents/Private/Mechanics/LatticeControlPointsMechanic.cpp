...
void ULatticeControlPointsMechanic::UpdatePointLocations(const TArray<FVector3d>& NewLocations)
{
	if (ControlPoints.Num() == NewLocations.Num())
	{
		ControlPoints = NewLocations;
	}
	UpdateDrawables();
}
