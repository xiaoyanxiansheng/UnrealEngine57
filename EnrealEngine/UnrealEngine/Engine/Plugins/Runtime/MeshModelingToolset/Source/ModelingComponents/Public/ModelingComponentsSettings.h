...
public:
	...
	UPROPERTY(config, EditAnywhere, Category = "Modeling Tools|New Mesh Objects")
	TEnumAsByte<enum ECollisionTraceFlag> CollisionMode = ECollisionTraceFlag::CTF_UseSimpleAndComplex;

	static UE_API void ApplyDefaultsToCreateMeshObjectParams(FCreateMeshObjectParams& Params);
