...
#include "AndroidJniLocationServices.h"
...
void JNICALL UE::Jni::FLocationServices::nativeHandleLocationChanged(JNIEnv* jenv, jobject thiz, jlong time, jdouble longitude, jdouble latitude, jfloat accuracy, jdouble altitude)
{
