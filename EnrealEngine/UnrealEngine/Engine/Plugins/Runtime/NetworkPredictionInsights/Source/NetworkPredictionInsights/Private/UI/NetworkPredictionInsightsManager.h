...
public:
	/**
	 * @return the global instance of the Network Prediction Insights manager.
	 * This is an internal singleton and cannot be used outside NetworkPredictionInsights module.
	 */
