...
public:
	...
	UE_API virtual ~UMIDIDeviceOutputController();
	...
	*/
	...
	UE_API void SendMIDIEvent(EMIDIEventType EventType, int32 Channel, int32 data1, int32 data2);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "MIDI Device Output Controller")
	UE_API void SendMIDINoteOn(int32 Channel, int32 Note, int32 Velocity);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "MIDI Device Output Controller")
	UE_API void SendMIDINoteOff(int32 Channel, int32 Note, int32 Velocity);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "MIDI Device Output Controller")
	UE_API void SendMIDIPitchBend(int32 Channel, int32 Pitch);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "MIDI Device Output Controller")
	UE_API void SendMIDINoteAftertouch(int32 Channel, int32 Note, float Amount);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "MIDI Device Output Controller")
	UE_API void SendMIDIControlChange(int32 Channel, int32 Type, int32 Value);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "MIDI Device Output Controller")
	UE_API void SendMIDIProgramChange(int32 Channel, int32 ProgramNumber);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "MIDI Device Output Controller")
	UE_API void SendMIDIChannelAftertouch(int32 Channel, float Amount);


	/** Called from UMIDIDeviceManager after the controller is created to get it ready to use.  Don't call this directly. */
	UE_API virtual void StartupDevice(const int32 InitDeviceID, const int32 InitMIDIBufferSize, bool& bOutWasSuccessful) override;

	/** Called during destruction to clean up this device.  Don't call this directly. */
	UE_API virtual void ShutdownDevice() override;
