...
class UMotionTrackedDeviceFunctionLibrary : public UBlueprintFunctionLibrary
{
	...
	*/
	...
	static UE_API bool IsMotionTrackedDeviceCountManagementNecessary();
	...
	*/
	...
	static UE_API void SetIsControllerMotionTrackingEnabledByDefault(bool Enable);
	...
	*/
	UFUNCTION(BlueprintPure, Category = "Input|MotionTracking")
	static UE_API int32 GetMaximumMotionTrackedControllerCount();
	...
	*/
	UFUNCTION(BlueprintPure, Category = "Input|MotionTracking")
	static UE_API int32 GetMotionTrackingEnabledControllerCount();
	...
	static UE_API bool IsMotionTrackingEnabledForDevice(int32 PlayerIndex, EControllerHand Hand);
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Input|MotionTracking")
	static UE_API bool IsMotionTrackingEnabledForSource(int32 PlayerIndex, FName SourceName);
	...
	*/
	UFUNCTION(BlueprintPure, Category = "Input|MotionTracking")
	static UE_API bool IsMotionTrackingEnabledForComponent(const class UMotionControllerComponent* MotionControllerComponent);
	...
	static UE_API bool EnableMotionTrackingOfDevice(int32 PlayerIndex, EControllerHand Hand);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Input|MotionTracking")
	static UE_API bool EnableMotionTrackingOfSource(int32 PlayerIndex, FName SourceName);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Input|MotionTracking")
	static UE_API bool EnableMotionTrackingForComponent(class UMotionControllerComponent* MotionControllerComponent);
	...
	static UE_API void DisableMotionTrackingOfDevice(int32 PlayerIndex, EControllerHand Hand);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Input|MotionTracking")
	static UE_API void DisableMotionTrackingOfSource(int32 PlayerIndex, FName SourceName);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Input|MotionTracking")
	static UE_API void DisableMotionTrackingForComponent(const class UMotionControllerComponent* MotionControllerComponent);

	/**
	* Disable tracking for all controllers.
	*/
	UFUNCTION(BlueprintCallable, Category = "Input|MotionTracking")
	static UE_API void DisableMotionTrackingOfAllControllers();
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Input|MotionTracking")
	static UE_API void DisableMotionTrackingOfControllersForPlayer(int32 PlayerIndex);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Input|MotionTracking")
	static UE_API TArray<FName> EnumerateMotionSources();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Input|MotionTracking")
	static UE_API FName GetActiveTrackingSystemName();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Input|MotionTracking")
	static UE_API bool IsMotionSourceTracking(int32 PlayerIndex, FName SourceName);
};
