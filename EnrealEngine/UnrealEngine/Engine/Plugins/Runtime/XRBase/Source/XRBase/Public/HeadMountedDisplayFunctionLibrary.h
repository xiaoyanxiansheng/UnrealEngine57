...
class UHeadMountedDisplayFunctionLibrary : public UBlueprintFunctionLibrary
{
	...
	static UE_API bool IsHeadMountedDisplayEnabled();
	...
	*/
	UFUNCTION(BlueprintPure, Category = "Input|HeadMountedDisplay", meta = (KeyWords = "HMD"))
	static UE_API bool IsHeadMountedDisplayConnected();
	...
	static UE_API bool EnableHMD(bool bEnable);
	...
	static UE_API FName GetHMDDeviceName();
	...
	*/
	UFUNCTION(BlueprintPure, Category = "Input|HeadMountedDisplay")
	static UE_API EHMDWornState::Type GetHMDWornState();
	...
	*/
	...
	static UE_API void GetTrackingSensorParameters(FVector& Origin, FRotator& Rotation, float& LeftFOV, float& RightFOV, float& TopFOV, float& BottomFOV, float& Distance, float& NearPlane, float& FarPlane, bool& IsActive, int32 Index = 0);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Input|HeadMountedDisplay")
	static UE_API void ResetOrientationAndPosition(float Yaw = 0.f, EOrientPositionSelector::Type Options = EOrientPositionSelector::OrientationAndPosition);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Input|HeadMountedDisplay")
	static UE_API void SetClippingPlanes(float Near, float Far);
	...
	static UE_API float GetXRSecondaryScreenPercentage();
	...
	*/
	...
	static UE_API void SetWorldToMetersScale(UObject* WorldContext, float NewScale = 100.f);
	...
	*/
	...
	static UE_API float GetWorldToMetersScale(UObject* WorldContext);

	/**
	 * Sets current tracking origin type (eye level or floor level).
	 */
	UFUNCTION(BlueprintCallable, Category = "Input|HeadMountedDisplay")
	static UE_API void SetTrackingOrigin(TEnumAsByte<EHMDTrackingOrigin::Type> Origin);

	/**
	 * Returns current tracking origin type (eye level or floor level).
	 */
	UFUNCTION(BlueprintPure, Category = "Input|HeadMountedDisplay")
	static UE_API TEnumAsByte<EHMDTrackingOrigin::Type> GetTrackingOrigin();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Input|HeadMountedDisplay",  meta=(WorldContext="WorldContext"))
	static UE_API FTransform GetTrackingToWorldTransform(UObject* WorldContext);
	...
	*/
	...
	static UE_API void CalibrateExternalTrackingToHMD(const FTransform& ExternalTrackingTransform);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Input|HeadMountedDisplay|ExternalTracking")
	static UE_API void UpdateExternalTrackingHMDPosition(const FTransform& ExternalTrackingTransform);
	...
	static UE_API void GetVRFocusState(bool& bUseFocus, bool& bHasFocus);
	...
	*/
	...
	static UE_API bool IsSpectatorScreenModeControllable();
	...
	*/
	...
	static UE_API void SetSpectatorScreenMode(ESpectatorScreenMode Mode);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Input|HeadMountedDisplay|SpectatorScreen")
	static UE_API void SetSpectatorScreenTexture(UTexture* InTexture);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Input|HeadMountedDisplay|SpectatorScreen")
	static UE_API void SetSpectatorScreenModeTexturePlusEyeLayout(FVector2D EyeRectMin, FVector2D EyeRectMax, FVector2D TextureRectMin, FVector2D TextureRectMax, bool bDrawEyeFirst = true, bool bClearBlack = false, bool bUseAlpha = false);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Input|HeadMountedDisplay")
	static UE_API bool SetHMDColorScaleAndBias(FLinearColor ColorScale, FLinearColor ColorBias);
	...
	static UE_API TArray<FXRDeviceId> EnumerateTrackedDevices(const FName SystemId = NAME_None, EXRTrackedDeviceType DeviceType = EXRTrackedDeviceType::Any);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Input|XRTracking")
	static UE_API void GetDevicePose(const FXRDeviceId& XRDeviceId, bool& bIsTracked, FRotator& Orientation, bool& bHasPositionalTracking, FVector& Position);
	...
	static UE_API void GetDeviceWorldPose(UObject* WorldContext, const FXRDeviceId& XRDeviceId, bool& bIsTracked, FRotator& Orientation, bool& bHasPositionalTracking, FVector& Position);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Input|XRTracking")
	static UE_API bool IsDeviceTracking(const FXRDeviceId& XRDeviceId);

	/**
	 * Cross XR-System query that returns critical information about the HMD display (position, orientation, device name)
	 */
	UFUNCTION(BlueprintCallable, Category = "Input|XRTracking")
	static UE_API void GetHMDData(UObject* WorldContext, FXRHMDData& HMDData);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Input|XRTracking")
	static UE_API void GetMotionControllerState(UObject* WorldContext, const EXRSpaceType XRSpaceType, const EControllerHand Hand, const EXRControllerPoseType ControllerPoseType, FXRMotionControllerState& MotionControllerState);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Input|XRTracking")
	static UE_API void GetHandTrackingState(UObject* WorldContext, const EXRSpaceType XRSpaceType, const EControllerHand Hand, FXRHandTrackingState& HandTrackingState);
	...
	static UE_API bool GetCurrentInteractionProfile(const EControllerHand Hand, FString& InteractionProfile);
	
	/** Connect to a remote device */
	UFUNCTION(BlueprintCallable, Category = "XR|HeadMountedDisplay")
	static UE_API EXRDeviceConnectionResult::Type ConnectRemoteXRDevice(const FString& IpAddress, const int32 BitRate);
	/** Disconnect remote AR Device */
	UFUNCTION(BlueprintCallable, Category = "XR|HeadMountedDisplay")
	static UE_API void DisconnectRemoteXRDevice();
	UFUNCTION(BlueprintCallable, Category = "XR|HeadMountedDisplay")
	static UE_API void SetXRDisconnectDelegate(const FXRDeviceOnDisconnectDelegate& InDisconnectedDelegate);
	static UE_API FXRDeviceOnDisconnectDelegate OnXRDeviceOnDisconnectDelegate;
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Input|XRTracking")
	static UE_API void SetXRTimedInputActionDelegate(const FName& ActionName, const FXRTimedInputActionDelegate& InDelegate);
	//** Clear a delegate to get an OpenXR action event with action time.*/
	UFUNCTION(BlueprintCallable, Category = "Input|XRTracking")
	static UE_API void ClearXRTimedInputActionDelegate(const FName& ActionPath);
	static UE_API TMap<FName, FXRTimedInputActionDelegate> OnXRTimedInputActionDelegateMap;
	...
	*/
	...
	static UE_API void BreakKey(FKey InKey, FString& InteractionProfile, EControllerHand& Hand, FName& MotionSource, FString& Indentifier, FString& Component);
};
