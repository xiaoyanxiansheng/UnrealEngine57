...
APEXDESTRUCTION_API bool UDestructibleMesh::BuildFromStaticMesh( UStaticMesh& StaticMesh )
{
	...
	if ( StaticMesh.GetAssetImportData() && StaticMesh.GetAssetImportData()->SourceData.SourceFiles.Num() == 1)
	{
		SourceSMImportTimestamp = StaticMesh.GetAssetImportData()->SourceData.SourceFiles[0].Timestamp;
	}
