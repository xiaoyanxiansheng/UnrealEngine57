...
#define UE_API DATAREGISTRYEDITOR_API
 ...
 */
class FDataRegistryEditorModule : public IModuleInterface, public IHasMenuExtensibility, public IHasToolBarExtensibility
{
public:
	 ...
	 */
	static UE_API TSharedRef<SWidget> MakeDataRegistryTypeSelector(FOnGetDataRegistryDisplayText OnGetDisplayText, FOnSetDataRegistryType OnSetType, bool bAllowClear = true, FName FilterStructName = NAME_None);
	...
	static UE_API void GenerateDataRegistryTypeComboBoxStrings(TArray< TSharedPtr<FString> >& OutComboBoxStrings, TArray<TSharedPtr<SToolTip>>& OutToolTips, TArray<bool>& OutRestrictedItems, bool bAllowClear, FName FilterStructName);
	 ...
	 * @param bAllowClear If true, add None option to top
	 */
	static UE_API TSharedRef<SWidget> MakeDataRegistryItemNameSelector(FOnGetDataRegistryDisplayText OnGetDisplayText, FOnGetDataRegistryId OnGetId, FOnSetDataRegistryId OnSetId, FOnGetCustomDataRegistryItemNames OnGetCustomItemNames = FOnGetCustomDataRegistryItemNames(), bool bAllowClear = true);
