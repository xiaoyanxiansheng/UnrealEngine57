...
DEFINE_LOG_CATEGORY_STATIC(LogDataRegistryIdCustomization, Log, All);
...
void SDataRegistryItemNameWidget::OnTypeChanged(bool bClearInvalid)
{
	...
	{
		UE_LOG(LogDataRegistryIdCustomization, Warning, TEXT("%s reset to None because it's not a valid data registry ID"), *CachedIdValue.ToString());
