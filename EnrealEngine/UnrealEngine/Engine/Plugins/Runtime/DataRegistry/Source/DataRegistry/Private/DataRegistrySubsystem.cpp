...
bool UDataRegistrySubsystem::IsReadyForInitialization() const
{
#if WITH_EDITOR
	return bReadyForInitialization || bLoadAllRegistriesOnNextPIE;
#else
	return bReadyForInitialization;
#endif
}
...
#if WITH_EDITOR
	if (WantsDelayedDataRegistryLoadingUntilPIE())
	{
...
bool UDataRegistrySubsystem::WantsDelayedDataRegistryLoadingUntilPIE() const
{
	return GIsEditor && !IsRunningCommandlet() && GetDefault<UDataRegistrySettings>()->bDelayLoadingDataRegistriesUntilPIE;
}
