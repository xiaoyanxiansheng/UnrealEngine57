...
struct FOpenXREmulatedInstance
{
	FOpenXREmulatedInstance()
	{
		...
		FCStringAnsi::Strncpy(NullPathString.GetData(), "XR_NULL_PATH", XR_MAX_PATH_LENGTH);
...
XrResult FOpenXREmulationLayer::XrLayerStringToPath(XrInstance instance, const char* pathString, XrPath* path)
{
	...
	else
	{
		...
		FCStringAnsi::Strncpy(EmulatedPathString.GetData(), pathString, XR_MAX_PATH_LENGTH);
		{
			FWriteScopeLock InstanceLock(InstanceMutex);
...
XrResult FOpenXREmulationLayer::XrLayerCreateActionSet(XrInstance instance, const XrActionSetCreateInfo* createInfo, XrActionSet* actionSet)
{
	...
	FCStringAnsi::Strncpy(ActionSet->ActionSetName.GetData(), createInfo->actionSetName, XR_MAX_ACTION_NAME_SIZE);
	FCStringAnsi::Strncpy(ActionSet->LocalizedActionSetName.GetData(), createInfo->localizedActionSetName, XR_MAX_LOCALIZED_ACTION_NAME_SIZE);
...
XrResult FOpenXREmulationLayer::XrLayerCreateAction(XrActionSet actionSet, const XrActionCreateInfo* createInfo, XrAction* action) 
{
	...
	FCStringAnsi::Strncpy(Action->ActionName.GetData(), createInfo->actionName, XR_MAX_ACTION_NAME_SIZE);
	FCStringAnsi::Strncpy(Action->LocalizedActionName.GetData(), createInfo->localizedActionName, XR_MAX_LOCALIZED_ACTION_NAME_SIZE);
