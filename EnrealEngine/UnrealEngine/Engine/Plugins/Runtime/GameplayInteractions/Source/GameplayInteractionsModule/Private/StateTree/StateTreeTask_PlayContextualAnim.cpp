...
FText FStateTreeTask_PlayContextualAnim::GetDescription(const FGuid& ID, FStateTreeDataView InstanceDataView, const IStateTreeBindingLookup& BindingLookup, EStateTreeNodeFormatting Formatting) const
{
	...
	// Asset
	FText SceneAssetValue = BindingLookup.GetBindingSourceDisplayName(FPropertyBindingPath(ID, GET_MEMBER_NAME_CHECKED(UInstanceDataType, SceneAsset)), Formatting);
	...
	// Section
	FText SectionNameValue = BindingLookup.GetBindingSourceDisplayName(FPropertyBindingPath(ID, GET_MEMBER_NAME_CHECKED(UInstanceDataType, SectionName)), Formatting);
	...
	// Roles
	TArray<FText> Roles;
	const FText PrimaryActorValue = BindingLookup.GetBindingSourceDisplayName(FPropertyBindingPath(ID, GET_MEMBER_NAME_CHECKED(UInstanceDataType, PrimaryActor)), Formatting);
	if (!PrimaryActorValue.IsEmpty())
	{
		Roles.Add(PrimaryActorValue);
	}
	const FText SecondaryActorValue = BindingLookup.GetBindingSourceDisplayName(FPropertyBindingPath(ID, GET_MEMBER_NAME_CHECKED(UInstanceDataType, SecondaryActor)), Formatting);
	if (!SecondaryActorValue.IsEmpty())
	{
		Roles.Add(SecondaryActorValue);
	}
	const FText TertiaryActorValue = BindingLookup.GetBindingSourceDisplayName(FPropertyBindingPath(ID, GET_MEMBER_NAME_CHECKED(UInstanceDataType, TertiaryActor)), Formatting);
