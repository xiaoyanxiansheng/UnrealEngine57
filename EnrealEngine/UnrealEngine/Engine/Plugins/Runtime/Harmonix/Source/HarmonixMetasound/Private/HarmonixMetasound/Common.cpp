...
namespace HarmonixMetasound
{
	...
	namespace CommonPinNames
	{
		namespace Inputs
		{
			...
			DEFINE_INPUT_METASOUND_PARAM(AudioCenter,                   "Audio Center",                       "5.1/7.1: The center channel audio.")
			DEFINE_INPUT_METASOUND_PARAM(AudioLFE,                      "Audio LFE",                          "5.1/7.1: The LFE channel audio.")
			DEFINE_INPUT_METASOUND_PARAM(AudioLeftSide,                 "Audio Left Side",                    "Quad/5.1: Left Surround, 7.1: Left Side.")
			DEFINE_INPUT_METASOUND_PARAM(AudioRightSide,                "Audio Right Side",                   "Quad/5.1: Right Surround, 7.1: Right Side.")
			DEFINE_INPUT_METASOUND_PARAM(AudioLeftBack,                 "Audio Left Back - Surround",         "7.1: Left Back.")
			DEFINE_INPUT_METASOUND_PARAM(AudioRightBack,                "Audio Right Back - Surround",        "7.1: Right Back.")
		...
		namespace Outputs
		{
			...
			DEFINE_OUTPUT_METASOUND_PARAM(TransportPlay,      "Play",                        "Transport play requested.")
			DEFINE_OUTPUT_METASOUND_PARAM(TransportPause,     "Pause",                       "Transport pause requested.")
			DEFINE_OUTPUT_METASOUND_PARAM(TransportContinue,  "Continue",                    "Transport continue requested.")
			DEFINE_OUTPUT_METASOUND_PARAM(TransportStop,      "Stop",                        "Transport stop requested.")
			DEFINE_OUTPUT_METASOUND_PARAM(TransportKill,      "Kill",                        "Transport kill requested.")
			DEFINE_OUTPUT_METASOUND_PARAM(TransportSeek,      "Seek",                        "Transport seek requested.")
