...
namespace HarmonixMetasound::Nodes::BarBeatToSeekTarget
{
	...
	{
		static const FNodeClassName ClassName { HarmonixNodeNamespace, TEXT("BarBeatToSeekTarget"), TEXT("") };
		return ClassName;
	}
	...
	using FBarBeatToSeekTargetNode = Metasound::TNodeFacade<FBarBeatToSeekTargetOperator>;
...
namespace HarmonixMetasound::Nodes::TimeMsToSeekTarget
{
	...
	const FNodeClassName& GetClassName()
	{
		static const FNodeClassName ClassName { HarmonixNodeNamespace, TEXT("TimeMsToSeekTarget"), TEXT("") };
		return ClassName;
	}
	...
	using FTimeMsToSeekTargetNode = Metasound::TNodeFacade<FTimeMsToSeekTargetOperator>;
...
namespace HarmonixMetasound::Nodes::MusicTimestampToSeekTarget
{
	...
	const FNodeClassName& GetClassName()
	{
		static const FNodeClassName ClassName { HarmonixNodeNamespace, TEXT("MusicTimestampToSeekTarget"), TEXT("") };
		return ClassName;
	}
	...
	using FMusicTimestampToSeekTargetNode = Metasound::TNodeFacade<FMusicTimestampToSeekTargetOperator>;
