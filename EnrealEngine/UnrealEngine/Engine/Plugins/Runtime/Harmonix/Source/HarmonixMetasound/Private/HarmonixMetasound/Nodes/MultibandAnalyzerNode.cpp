...
namespace HarmonixMetasound::Nodes::MultibandAnalyzer
{
	...
	public:
		...
		static TUniquePtr<IOperator> CreateOperator(const Metasound::FBuildOperatorParams& InParams, Metasound::FBuildResults& OutResults)
		{
			FInputs Inputs
			{
				...
				InParams.InputData.GetOrCreateDefaultDataReadReference<Metasound::FAudioBuffer>(Inputs::AudioMonoName, InParams.OperatorSettings),
	...
	using FMultibandAnalyzerNode = Metasound::TNodeFacade<FOp>;
