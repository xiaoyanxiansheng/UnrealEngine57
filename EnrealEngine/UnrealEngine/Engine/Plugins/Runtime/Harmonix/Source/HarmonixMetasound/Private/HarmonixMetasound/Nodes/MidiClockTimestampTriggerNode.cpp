...
namespace HarmonixMetasound
{
	...
	using FMidiClockTimestampTriggerNode = Metasound::TNodeFacade<FMidiClockTimestampTriggerOperator>;
	...
	TUniquePtr<IOperator> FMidiClockTimestampTriggerOperator::CreateOperator(const FBuildOperatorParams& InParams, FBuildResults& OutResults)
	{
		...
		FMusicTimestampReadRef InTimestamp = InputData.GetOrCreateDefaultDataReadReference<FMusicTimestamp>(METASOUND_GET_PARAM_NAME(Inputs::Timestamp), InParams.OperatorSettings);
