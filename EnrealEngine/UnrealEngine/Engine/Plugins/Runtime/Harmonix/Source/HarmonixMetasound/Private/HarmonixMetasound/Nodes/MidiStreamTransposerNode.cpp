...
namespace HarmonixMetasound::Nodes::MidiNoteTranspose
{
	...
	public:
		...
		static TUniquePtr<IOperator> CreateOperator(const FBuildOperatorParams& InParams, FBuildResults& OutResults)
		{
			...
			FInputs Inputs
			{
				...
				InputData.GetOrCreateDefaultDataReadReference<FMidiStream>(METASOUND_GET_PARAM_NAME(Inputs::MidiStream), InParams.OperatorSettings),
	...
	using FMidiNoteTransposeNode = TNodeFacade<FMidiNoteTransposeOperator>;
