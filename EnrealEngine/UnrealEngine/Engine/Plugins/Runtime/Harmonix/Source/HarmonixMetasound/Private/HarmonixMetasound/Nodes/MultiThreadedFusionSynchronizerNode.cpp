...
#undef PIN_NAME_SET_ITEM	
	...
	*********************************************************************************************************/
	...
	using F4MonoInstanceSynchronizerNode = Metasound::TNodeFacade<TMultiThreadedFusionSynchronizerOperator<4,1>>;
	using F8MonoInstanceSynchronizerNode = Metasound::TNodeFacade<TMultiThreadedFusionSynchronizerOperator<8,1>>;
	METASOUND_REGISTER_NODE(F4MonoInstanceSynchronizerNode)
	METASOUND_REGISTER_NODE(F8MonoInstanceSynchronizerNode)
	using F4StereoInstanceSynchronizerNode = Metasound::TNodeFacade<TMultiThreadedFusionSynchronizerOperator<4,2>>;
	using F8StereoInstanceSynchronizerNode = Metasound::TNodeFacade<TMultiThreadedFusionSynchronizerOperator<8,2>>;
