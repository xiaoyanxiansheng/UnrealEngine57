...
UCLASS(MinimalAPI, BlueprintType, Category = "Music", Meta = (DisplayName = "MIDI Step Sequence"))
class UMidiStepSequence : public UObject, public IAudioProxyDataFactory
{
	GENERATED_BODY()
...
public:
	...
	UE_API UMidiStepSequence(const FObjectInitializer& Initializer);

	UE_API virtual void PostReinitProperties() override;

	UFUNCTION(BlueprintCallable, Category = "MidiStepSequence")
	UE_API void SetNumPages(int32 Count);

	UFUNCTION(BlueprintCallable, Category = "MidiStepSequence")
	UE_API void SetNumColumns(int32 Count);

	UFUNCTION(BlueprintCallable, Category = "MidiStepSequence")
	UE_API void SetNumRows(int32 Count);

	UFUNCTION(BlueprintCallable, Category = "MidiStepSequence")
	UE_API void DisableRowsAbove(int32 FirstDisabledRow);

	UFUNCTION(BlueprintCallable, Category = "MidiStepSequence")
	UE_API bool SetRowNoteNumber(int32 RowIndex, int32 MidiNoteNumber);

	UFUNCTION(BlueprintCallable, Category = "MidiStepSequence")
	UE_API bool SetRowVelocity(int32 RowIndex, int32 MidiVelocoty);

	UFUNCTION(BlueprintCallable, Category = "MidiStepSequence")
	UE_API bool SetStepSkipIndex(int32 StepIndex);

	UFUNCTION(BlueprintCallable, Category = "MidiStepSequence")
	UE_API FStepSequenceCell SetCell(int32 Row, int32 Column, bool State);

	UFUNCTION(BlueprintCallable, Category = "MidiStepSequence")
	UE_API FStepSequenceCell SetCellOnPage(int32 Page, int32 Row, int32 Column, bool State);

	UFUNCTION(BlueprintCallable, Category = "MidiStepSequence")
	UE_API FStepSequenceCell SetCellContinuation(int32 Row, int32 Column, bool bState);

	UFUNCTION(BlueprintCallable, Category = "MidiStepSequence")
	UE_API FStepSequenceCell SetCellContinuationOnPage(int32 Page, int32 Row, int32 Column, bool bState);

	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "MidiStepSequence")
	UE_API FStepSequenceCell GetCell(int32 Row, int32 Column);

	UFUNCTION(BlueprintCallable, Category = "MidiStepSequence")
	UE_API FStepSequenceCell GetCellOnPage(int32 Page, int32 Row, int32 Column);

	UFUNCTION(BlueprintCallable, Category = "MidiStepSequence")
	UE_API FStepSequenceCell ToggleCell(int32 Row, int32 Column);

	UFUNCTION(BlueprintCallable, Category = "MidiStepSequence")
	UE_API FStepSequenceCell ToggleCellOnPage(int32 Page, int32 Row, int32 Column);

	UFUNCTION(BlueprintCallable, Category = "MidiStepSequence")
	UE_API void SetStepTable(const FStepSequenceTable& NewStepTable);
	...
	UE_API const int32 GetClampedCurrentPageNumber();
	UE_API void SetClampedCurrentPageNumber(int32 InPageNumber);
#endif 
