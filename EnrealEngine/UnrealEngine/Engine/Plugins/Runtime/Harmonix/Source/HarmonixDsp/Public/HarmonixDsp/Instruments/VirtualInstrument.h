...
public:
	...
	UE_API void  ResetInstrumentState();
	UE_API void  ResetMidiState();
	...
	UE_API void Set7BitController(Harmonix::Midi::Constants::EControllerID InController, int8 InByteValue, int8 InMidiChannel = 0);
	UE_API void Set14BitController(Harmonix::Midi::Constants::EControllerID InController, int16 InByteValue, int8 InMidiChannel = 0);
	...
	UE_API void SetController(Harmonix::Midi::Constants::EControllerID InController, float InValue, int8 InMidiChannel = 0);
	UE_API void SetHighOrLowControllerByte(Harmonix::Midi::Constants::EControllerID InController, int8 InValue, int8 InMidiChannel = 0);
	...
	UE_API virtual void HandleMidiMessage(FMidiVoiceId InVoiceId, int8 InStatus, int8 InData1, int8 InData2, int32 InEventTick = 0, int32 InCurrentTick = 0, float InMsOffset = 0.0f);
	...
	static UE_API bool IsHighResController(Harmonix::Midi::Constants::EControllerID ControllerId, bool& bIsHighResLowByte);
	static UE_API bool GetMsbLsbIndexes(Harmonix::Midi::Constants::EControllerID ControllerId, int& InMsb, int& InLsb);
...
protected:
	...
	static UE_API float ConvertCCValue(Harmonix::Midi::Constants::EControllerID InController, uint8 InValue);

	FName Name;
	FHarmonixMeterData TimingData;
	FHarmonixMeterData VoiceUsage;
	static UE_API bool bShouldPrintMidiActivity;
