...
struct FNetworkPredictionPhysicsState
{
	...
	static UE_API void NetSend(const FNetSerializeParams& P, FBodyInstance* BodyInstance);
	...
	static UE_API bool ShouldReconcile(int32 PhysicsFrame, Chaos::FRewindData* RewindData, FBodyInstance* BodyInstance, FNetworkPredictionPhysicsState* RecvState);
	...
	static UE_API void PerformRollback(FBodyInstance* BodyInstance, FNetworkPredictionPhysicsState* RecvState);
	...
	static UE_API void FinalizeInterpolatedPhysics(UPrimitiveComponent* Driver, FNetworkPredictionPhysicsState* InterpolatedState);
	static UE_API void BeginInterpolation(UPrimitiveComponent* Driver);
	static UE_API void EndInterpolation(UPrimitiveComponent* Driver);
	...
	static UE_API void ToString(int32 PhysicsFrame, Chaos::FRewindData* RewindData, FBodyInstance* BodyInstance, FAnsiStringBuilderBase& Builder);
	
	// Current state to string
	static UE_API void ToString(FBodyInstance* BodyInstance, FAnsiStringBuilderBase& Builder);
