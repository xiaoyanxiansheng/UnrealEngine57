...
void FDisplayClusterLightCardEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND(PerspectiveProjection, "Perspective", "A perspective projection from the stage's view point", EUserInterfaceActionType::RadioButton, FInputChord());
	UI_COMMAND(OrthographicProjection, "Orthographic", "An orthographic projection from the stage's view point", EUserInterfaceActionType::RadioButton, FInputChord());
	UI_COMMAND(AzimuthalProjection, "Dome", "A hemispherical projection from the stage's view point", EUserInterfaceActionType::RadioButton, FInputChord());
