...
* @param pDevice       - D3D12 device object pointer
*/
typedef EasyBlendSDKError(__stdcall* EasyBlendSDK_InitializeDX12_DeviceProc)(EasyBlendSDK_Mesh* msm, ID3D12Device* pDevice);
...
*/
typedef EasyBlendSDKError(__stdcall* EasyBlendSDK_TransformInputToOutputDX12_CommandListProc)(EasyBlendSDK_Mesh* msm, ID3D12Resource* InputTexture, ID3D12Resource* OutputTexture, D3D12_CPU_DESCRIPTOR_HANDLE OutputRTV, ID3D12GraphicsCommandList* pCommandList);
