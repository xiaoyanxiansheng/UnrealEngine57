...
const FEditorViewportCameraSpeedSettings& FDisplayClusterConfiguratorSCSEditorViewportClient::GetCameraSpeedSettings() const
{
	return GetDefault<UEditorPerProjectUserSettings>()->SCSViewportCameraSpeedSettings;
}

void FDisplayClusterConfiguratorSCSEditorViewportClient::SetCameraSpeedSettings(const FEditorViewportCameraSpeedSettings& InCameraSpeedSettings)
{
	GetMutableDefault<UEditorPerProjectUserSettings>()->SCSViewportCameraSpeedSettings = InCameraSpeedSettings;
}
