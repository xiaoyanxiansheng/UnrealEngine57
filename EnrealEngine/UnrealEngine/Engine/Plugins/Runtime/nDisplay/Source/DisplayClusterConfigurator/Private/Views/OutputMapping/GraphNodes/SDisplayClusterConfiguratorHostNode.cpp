...
void SDisplayClusterConfiguratorHostNode::MoveTo(const FVector2f& NewPosition, FNodeSet& NodeFilter, bool bMarkDirty)
{
...
FVector2f SDisplayClusterConfiguratorHostNode::GetPosition2f() const
{
	return SDisplayClusterConfiguratorBaseNode::GetPosition2f() - FVector2f(BorderThickness.Left, BorderThickness.Top);
}
