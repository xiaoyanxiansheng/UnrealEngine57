...
struct FDisplayClusterMoviePipelineConfiguration
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "nDisplay", meta = (DisplayName = "Allowed Viewport Names List", EditCondition = "!bRenderAllViewports && DCRootActor != nullptr"))
