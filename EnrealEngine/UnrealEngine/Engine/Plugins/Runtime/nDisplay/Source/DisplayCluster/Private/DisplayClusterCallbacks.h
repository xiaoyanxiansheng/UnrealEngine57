...
public:
	...
	{
		return DisplayClusterProcessLatencyEvent;
	}

	virtual FDisplayClusterPostResolveOverridden_RenderThread& OnDisplayClusterPostResolveOverridden_RenderThread() override
	{
		return DisplayClusterPostResolveOverriddenEvent;
	}
	...
	{
		return DisplayClusterPreProcessIcvfxEvent;
	}
...
private:
	...
	FDisplayClusterProcessLatency_RenderThread       DisplayClusterProcessLatencyEvent;
	FDisplayClusterPostResolveOverridden_RenderThread DisplayClusterPostResolveOverriddenEvent;
	...
	FDisplayClusterPreProcessIcvfx_RenderThread      DisplayClusterPreProcessIcvfxEvent;
};
