...
protected:
	...
	void ImplInitDynamicRHI_RenderTargetResource2D(FRHICommandListBase& RHICmdList, FTextureRHIRef& OutRenderTargetTextureRHI, FTextureRHIRef& OutTextureRHI);

	/** Helper function: create 2D texture. */
	void ImplInitDynamicRHI_TextureResource2D(FRHICommandListBase& RHICmdList, FTextureRHIRef& OutTextureRHI);
