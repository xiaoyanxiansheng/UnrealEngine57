...
bool FDisplayClusterViewportManager::ShouldUseFullSizeFrameTargetableResource() const
{
	...
	// Postprocess requests an full-size FrameTargetable resource via
	// FDisplayClusterRenderFrameSettings::bUseFullSizeFrameTargetableForPostprocess
	// Note: FDisplayClusterViewport::ShouldUseFullSizeFrameTargetableResource() relies on this flag.
...
bool FDisplayClusterViewportManager::ShouldUseAdditionalFrameTargetableResource() const
{
	...
	// AdditionalFrameTargetable is a subresource of FrameTargetable.
	if(!ShouldUseOutputFrameTargetableResources())
	{
		return false;
	}

	// Postprocess requests an AdditionalFrameTargetable resource via
	// FDisplayClusterRenderFrameSettings::bUseAdditionalFrameTargetableForPostprocess
	// Note: FDisplayClusterViewport::IsResourceUsedImpl() relies on this flag.
...
void FDisplayClusterViewportManager::UpdateCurrentRenderFrameViewports() const
{
	...
	Configuration->ClearCurrentRenderFrameViewportsOutOfDate();
}
...
void FDisplayClusterViewportManager::InitializeNewFrame()
{
	...
	FDisplayClusterUpscaler::InitializeNewFrame();
...
TSharedPtr<FDisplayClusterViewport, ESPMode::ThreadSafe> FDisplayClusterViewportManager::ImplCreateViewport(const FString& ViewportId, const TSharedPtr<IDisplayClusterProjectionPolicy, ESPMode::ThreadSafe>& InProjectionPolicy)
{
	...
	if (NewViewport.IsValid())
	{
		...
		Configuration->MarkCurrentRenderFrameViewportsOutOfDate();
