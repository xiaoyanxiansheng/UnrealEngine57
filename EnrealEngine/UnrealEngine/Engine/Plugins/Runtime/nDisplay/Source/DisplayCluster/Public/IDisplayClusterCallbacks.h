...
public:
	...
	/** Called for every viewport that has configured content override **/
	DECLARE_EVENT_TwoParams(IDisplayClusterCallbacks, FDisplayClusterPostResolveOverridden_RenderThread, FRHICommandListImmediate&, const IDisplayClusterViewportProxy*);
	virtual FDisplayClusterPostResolveOverridden_RenderThread& OnDisplayClusterPostResolveOverridden_RenderThread() = 0;
