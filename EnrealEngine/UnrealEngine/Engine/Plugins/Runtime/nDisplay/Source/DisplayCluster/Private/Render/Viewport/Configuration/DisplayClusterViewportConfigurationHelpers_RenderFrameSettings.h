...
public:
	...
	static bool UpdateRenderFrameConfiguration(EDisplayClusterRenderFrameMode InRenderMode, const FString& InClusterNodeId, FDisplayClusterViewportConfiguration& InOutConfiguration);
