...
void FDisplayClusterViewportResource::ImplInitDynamicRHI_RenderTargetResource2D(FRHICommandListBase& RHICmdList, FTextureRHIRef& OutRenderTargetTextureRHI, FTextureRHIRef& OutTextureRHI)
{
	...
	OutRenderTargetTextureRHI = OutTextureRHI = RHICmdList.CreateTexture(Desc);
}

void FDisplayClusterViewportResource::ImplInitDynamicRHI_TextureResource2D(FRHICommandListBase& RHICmdList, FTextureRHIRef& OutTextureRHI)
{
	...
	OutTextureRHI = RHICmdList.CreateTexture(Desc);
}
