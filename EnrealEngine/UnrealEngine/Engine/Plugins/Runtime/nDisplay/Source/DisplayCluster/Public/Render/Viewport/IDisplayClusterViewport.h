...
public:
	...
	/** Calculate View data
	 * Updates data within the FDisplayClusterViewport_Context.
	 * This function calls IDisplayClusterProjectionPolicy::CalculateView() and IDisplayClusterProjectionPolicy::GetProjectionMatrix().
	 * 
	 * Note: Called once per frame from IDisplayClusterViewport::CalculateView().
	 *
	...
	*/
	virtual bool CalculateViewData(const uint32 InContextNum, const FVector& InViewLocation, const FRotator& InViewRotation, const float WorldToMeters) = 0;
