...
private:
	// True if the "Backbuffer does not support stereo" error has already been logged.
	// Used to ensure the error is only written to the log once.
	mutable uint8 bHasLoggedBackbufferStereoUnsupported : 1 = 0;
