...
/**
* Defines how the overscan blend width is interpreted.
* Allows blending between tiles to be specified in
* a percentage of the overscan size, or disabled entirely.
*/
UENUM()
enum class EDisplayClusterConfigurationViewportOverscanBlendMode : uint8
{
	/** Disable blending across overscan region */
	Disable     UMETA(DisplayName = "Disable"),

	/** Blend width defined as 25% of the overscan size */
	Percent25   UMETA(DisplayName = "25%"),

	/** Blend width defined as 50% of the overscan size */
	Percent50   UMETA(DisplayName = "50%"),

	/** Blend width defined as 75% of the overscan size */
	Percent75   UMETA(DisplayName = "75%"),
};
