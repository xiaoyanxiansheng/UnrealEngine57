...
namespace JSON500
{
	...
	UDisplayClusterConfigurationData* FDisplayClusterConfigurationJsonParser::ConvertDataToInternalTypes()
	{
		...
		Config->RenderFrameSettings.ClusterICVFXOuterViewportBufferRatioMult = CfgJson.Misc.ClusterOuterViewportsBufferRatio;
		...
		// Cluster
		{
			...
			// Failover
			{
				Config->Cluster->Failover.bEnabled = CfgJson.Cluster.Failover.bEnabled;
				Config->Cluster->Failover.PrimaryBackups.ItemNames = CfgJson.Cluster.Failover.PrimaryBackups;
				Config->Cluster->Failover.CriticalNodes.ItemNames  = CfgJson.Cluster.Failover.CriticalNodes;
			}
	...
	bool FDisplayClusterConfigurationJsonParser::ConvertDataToExternalTypes(const UDisplayClusterConfigurationData* Config)
	{
		...
		Json.Misc.ClusterOuterViewportsBufferRatio = Config->RenderFrameSettings.ClusterICVFXOuterViewportBufferRatioMult;
		...
		// Cluster
		{
			...
			// Failover
			{
				Json.Cluster.Failover.bEnabled = Config->Cluster->Failover.bEnabled;
				Json.Cluster.Failover.PrimaryBackups = Config->Cluster->Failover.PrimaryBackups.ItemNames;
				Json.Cluster.Failover.CriticalNodes  = Config->Cluster->Failover.CriticalNodes.ItemNames;
			}
