 ...
 */
struct FRigVMFindInBlueprintSearchTags
{
	/** Properties tag, for Blueprint variables */
	static RIGVMEDITOR_API const FText FiB_Properties;

	/** Components tags */
	static RIGVMEDITOR_API const FText FiB_Components;
	static RIGVMEDITOR_API const FText FiB_IsSCSComponent;
	/** End Components tags */

	/** Nodes tag */
	static RIGVMEDITOR_API const FText FiB_Nodes;

	/** Schema Name tag, to identify the schema that a graph uses */
	static RIGVMEDITOR_API const FText FiB_SchemaName;
	/** Uber graphs tag */
	static RIGVMEDITOR_API const FText FiB_UberGraphs;
	/** Function graph tag */
	static RIGVMEDITOR_API const FText FiB_Functions;
	/** Macro graph tag */
	static RIGVMEDITOR_API const FText FiB_Macros;
	/** Sub graph tag, for any sub-graphs in a Blueprint */
	static RIGVMEDITOR_API const FText FiB_SubGraphs;
	/** Extension graph tag, for any graphs in a Blueprint Extension */
	static RIGVMEDITOR_API const FText FiB_ExtensionGraphs;
	/** Blueprint extension tag. */
	static RIGVMEDITOR_API const FText FiB_Extensions;

	/** Name tag */
	static RIGVMEDITOR_API const FText FiB_Name;
	/** Native Name tag */
	static RIGVMEDITOR_API const FText FiB_NativeName;
	/** Class Name tag */
	static RIGVMEDITOR_API const FText FiB_ClassName;
	/** NodeGuid tag */
	static RIGVMEDITOR_API const FText FiB_NodeGuid;
	/** Default value */
	static RIGVMEDITOR_API const FText FiB_DefaultValue;
	/** Tooltip tag */
	static RIGVMEDITOR_API const FText FiB_Tooltip;
	/** Description tag */
	static RIGVMEDITOR_API const FText FiB_Description;
	/** Comment tag */
	static RIGVMEDITOR_API const FText FiB_Comment;
	/** Path tag */
	static RIGVMEDITOR_API const FText FiB_Path;
	/** Parent Class tag */
	static RIGVMEDITOR_API const FText FiB_ParentClass;
	/** Interfaces tag */
	static RIGVMEDITOR_API const FText FiB_Interfaces;
	/** Class that originally defined the function tag */
	static RIGVMEDITOR_API const FText FiB_FuncOriginClass;

	/** Pin type tags */

	/** Pins tag */
	static RIGVMEDITOR_API const FText FiB_Pins;

	/** Pin Category tag */
	static RIGVMEDITOR_API const FText FiB_PinCategory;
	/** Pin Sub-Category tag */
	static RIGVMEDITOR_API const FText FiB_PinSubCategory;
	/** Pin object class tag */
	static RIGVMEDITOR_API const FText FiB_ObjectClass;
	/** Pin IsArray tag */
	static RIGVMEDITOR_API const FText FiB_IsArray;
	/** Pin IsReference tag */
	static RIGVMEDITOR_API const FText FiB_IsReference;
	/** Glyph icon tag */
	static RIGVMEDITOR_API const FText FiB_Glyph;
	/** Style set the glyph belongs to */
	static RIGVMEDITOR_API const FText FiB_GlyphStyleSet;
	/** Glyph icon color tag */
	static RIGVMEDITOR_API const FText FiB_GlyphColor;

	// Identifier for metadata storage, completely unsearchable tag
	static RIGVMEDITOR_API const FText FiBMetaDataTag;
...
struct FRigVMFiBMD
{
	static RIGVMEDITOR_API const FString FiBSearchableMD;
	static RIGVMEDITOR_API const FString FiBSearchableShallowMD;
	static RIGVMEDITOR_API const FString FiBSearchableExplicitMD;
	static RIGVMEDITOR_API const FString FiBSearchableHiddenExplicitMD;
	static RIGVMEDITOR_API const FString FiBSearchableFormatVersionMD;
};
...
struct FRigVMFindInBlueprintCachingOptions
{
...
class FRigVMFindInBlueprintsResult : public TSharedFromThis< FRigVMFindInBlueprintsResult >
{
public:
	...
	/* Create a root */
	RIGVMEDITOR_API explicit FRigVMFindInBlueprintsResult(const FText& InDisplayText);

	/* Called when user clicks on the search item */
	RIGVMEDITOR_API virtual FReply OnClick();

	/* Get Category for this search result */
	RIGVMEDITOR_API virtual FText GetCategory() const;

	/* Create an icon to represent the result */
	RIGVMEDITOR_API virtual TSharedRef<SWidget>	CreateIcon() const;
	...
	RIGVMEDITOR_API FString GetCommentText() const;

	/** gets the blueprint housing all these search results */
	RIGVMEDITOR_API UBlueprint* GetParentBlueprint() const;
	...
	*/
	...
	RIGVMEDITOR_API virtual UObject* GetObject(UBlueprint* InBlueprint) const;

	/** Returns the display string for the row */
	RIGVMEDITOR_API FText GetDisplayString() const;
...
struct FRigVMStreamSearchOptions
{
 ...
 */
class FRigVMStreamSearch : public FRunnable
{
public:
	/** Constructor */
	RIGVMEDITOR_API FRigVMStreamSearch(const FString& InSearchValue, const FRigVMStreamSearchOptions& InSearchOptions = FRigVMStreamSearchOptions());

	/** Begin FRunnable Interface */
	RIGVMEDITOR_API virtual bool Init() override;

	RIGVMEDITOR_API virtual uint32 Run() override;

	RIGVMEDITOR_API virtual void Stop() override;

	RIGVMEDITOR_API virtual void Exit() override;
	/** End FRunnable Interface */

	/** Brings the thread to a safe stop before continuing. */
	RIGVMEDITOR_API void EnsureCompletion();

	/** Returns TRUE if the thread is done with it's work. */
	RIGVMEDITOR_API bool IsComplete() const;

	/** Returns TRUE if Stop() was called while work is still pending. */
	RIGVMEDITOR_API bool WasStopped() const;
	 ...
	 */
	RIGVMEDITOR_API void GetFilteredItems(TArray<TSharedPtr<class FRigVMFindInBlueprintsResult>>& OutItemsFound);

	/** Helper function to query the percent complete this search is */
	RIGVMEDITOR_API float GetPercentComplete() const;
	...
	RIGVMEDITOR_API void GetFilteredImaginaryResults(TArray<FRigVMImaginaryFiBDataSharedPtr>& OutFilteredImaginaryResults);
...
class FRigVMFindInBlueprintSearchManager : public FTickableEditorObject
{
public:
	static RIGVMEDITOR_API FRigVMFindInBlueprintSearchManager* Instance;
	static RIGVMEDITOR_API FRigVMFindInBlueprintSearchManager& Get();

	RIGVMEDITOR_API FRigVMFindInBlueprintSearchManager();
	RIGVMEDITOR_API ~FRigVMFindInBlueprintSearchManager();

	//~ Begin FTickableObject Interface
	RIGVMEDITOR_API virtual void Tick(float DeltaTime) override;
	RIGVMEDITOR_API virtual bool IsTickable() const override;
	RIGVMEDITOR_API virtual TStatId GetStatId() const override;
	 ...
	 */
	RIGVMEDITOR_API void ApplySearchDataToDatabase(FRigVMSearchData InSearchData, bool bAllowNewEntry = false);
	 ...
	 */
	RIGVMEDITOR_API FRigVMSearchData GetSearchDataForAssetPath(const FSoftObjectPath& InAssetPath);
	 ...
	 */
	RIGVMEDITOR_API void AddOrUpdateBlueprintSearchMetadata(UBlueprint* InBlueprint, ERigVMAddOrUpdateBlueprintSearchMetadataFlags InFlags = ERigVMAddOrUpdateBlueprintSearchMetadataFlags::None, ERigVMFiBVersion InVersion = ERigVMFiBVersion::RIGVM_FIB_VER_NONE);
	 ...
	 */
	RIGVMEDITOR_API void BeginSearchQuery(const class FRigVMStreamSearch* InSearchOriginator);
	 ...
	 */
	RIGVMEDITOR_API bool ContinueSearchQuery(const class FRigVMStreamSearch* InSearchOriginator, FRigVMSearchData& OutSearchData);
	 ...
	 */
	RIGVMEDITOR_API void EnsureSearchQueryEnds(const class FRigVMStreamSearch* InSearchOriginator);
	 ...
	 */
	RIGVMEDITOR_API float GetPercentComplete(const class FRigVMStreamSearch* InSearchOriginator) const;
	 ...
	 */
	RIGVMEDITOR_API FRigVMSearchData QuerySingleBlueprint(UBlueprint* InBlueprint, bool bInRebuildSearchData);
	...
	RIGVMEDITOR_API bool ProcessEncodedValueForUnloadedBlueprint(FRigVMSearchData& SearchData);

	/** Returns the number of unindexed Blueprints, either due to not having been indexed before, or AR data being out-of-date */
	RIGVMEDITOR_API int32 GetNumberUnindexedAssets() const;

	/** Returns the number of uncached assets during an active indexing operation */
	RIGVMEDITOR_API int32 GetNumberUncachedAssets() const;
	 ...
	 */
	RIGVMEDITOR_API void CacheAllAssets(TWeakPtr< class SRigVMFindInBlueprints > InSourceWidget, const FRigVMFindInBlueprintCachingOptions& InCachingOptions);

	/**
	 * Exports a list of all unindexed assets to Saved/RigVMFindInBlueprints_OutdatedAssetList.txt
	 */
	RIGVMEDITOR_API void ExportOutdatedAssetList();
	 ...
	 */
	RIGVMEDITOR_API void OnCacheAllUnindexedAssets(bool bInSourceControlActive, bool bInCheckoutAndSave);

	/** Stops the caching process where it currently is at, the rest can be continued later */
	RIGVMEDITOR_API void CancelCacheAll(SRigVMFindInBlueprints* InFindInBlueprintWidget);
	...
	RIGVMEDITOR_API FSoftObjectPath GetCurrentCacheBlueprintPath() const;

	/** Returns the progress complete on the caching */
	RIGVMEDITOR_API float GetCacheProgress() const;
	...
	RIGVMEDITOR_API void StartedCachingBlueprints(ERigVMFiBCacheOpType InCacheOpType, ERigVMFiBCacheOpFlags InCacheOpFlags);
	 ...
	 */
	RIGVMEDITOR_API void FinishedCachingBlueprints(ERigVMFiBCacheOpType InCacheOpType, ERigVMFiBCacheOpFlags InCacheOpFlags, int32 InNumberCached, TSet<FSoftObjectPath>& InFailedToCacheList);
	...
	RIGVMEDITOR_API bool IsUnindexedCacheInProgress() const;

	/** Returns TRUE if we're still inside the initial asset discovery and registration stage */
	RIGVMEDITOR_API bool IsAssetDiscoveryInProgress() const;

	/** Returns TRUE if there are one or more active asynchronous search queries */
	RIGVMEDITOR_API bool IsAsyncSearchQueryInProgress() const;
	...
	RIGVMEDITOR_API TSharedPtr<SRigVMFindInBlueprints> GetGlobalFindResults();

	/** Enable or disable the global find results tab feature */
	RIGVMEDITOR_API void EnableGlobalFindResults(bool bEnable);

	/** Close any orphaned global find results tabs for a particular tab manager */
	RIGVMEDITOR_API void CloseOrphanedGlobalFindResultsTabs(TSharedPtr<class FTabManager> TabManager);
...
private:
	...
	RIGVMEDITOR_API FRigVMSearchData GetSearchDataForIndex(int32 CacheIndex);
	...
	RIGVMEDITOR_API void CleanCache();
	...
	RIGVMEDITOR_API void BuildCache();
	 ...
	 */
	RIGVMEDITOR_API int32 AddSearchDataToDatabase(FRigVMSearchData InSearchData);

	/** Removes a Blueprint from being managed by the FiB system by passing in the UBlueprint's path */
	RIGVMEDITOR_API void RemoveBlueprintByPath(const FSoftObjectPath& InPath);

	/** Adds a new search database entry for unloaded asset data */
	RIGVMEDITOR_API void AddUnloadedBlueprintSearchMetadata(const FAssetData& InAssetData);

	/** Begins the process of extracting FiB data from an unloaded asset */
	RIGVMEDITOR_API void ExtractUnloadedFiBData(const FAssetData& InAssetData, FString* InFiBData, FName InKeyForFiBData, ERigVMFiBVersion InFiBDataVersion);

	/** Determines the global find results tab label */
	RIGVMEDITOR_API FText GetGlobalFindResultsTabLabel(int32 TabIdx);

	/** Handler for a request to spawn a new global find results tab */
	RIGVMEDITOR_API TSharedRef<SDockTab> SpawnGlobalFindResultsTab(const FSpawnTabArgs& SpawnTabArgs, int32 TabIdx);

	/** Creates and opens a new global find results tab */
	RIGVMEDITOR_API TSharedPtr<SRigVMFindInBlueprints> OpenGlobalFindResultsTab();
...
protected:
	...
	RIGVMEDITOR_API FActiveSearchQueryPtr FindSearchQuery(const class FRigVMStreamSearch* InSearchOriginator) const;

	/** Returns the next pending search data for the given query and advances the index to the next entry */
	RIGVMEDITOR_API FRigVMSearchData GetNextSearchDataForQuery(const FRigVMStreamSearch* InSearchOriginator, FActiveSearchQueryPtr InSearchQueryPtr, bool bCheckDeferredList);

	/** If searches are paused, blocks the calling thread until searching is resumed */
	RIGVMEDITOR_API void BlockSearchQueryIfPaused();
...
struct FRigVMDisableGatheringDataOnScope
{
