...
UCLASS(MinimalAPI, BlueprintType, meta=(ScriptName="RigVMBlueprintLibrary"))
...
public:
	...
	static UE_API void RecompileVM(URigVMBlueprint* InBlueprint);

	UFUNCTION(BlueprintCallable, Category = "RigVM Blueprint")
	static UE_API void RecompileVMIfRequired(URigVMBlueprint* InBlueprint);
	
	UFUNCTION(BlueprintCallable, Category = "RigVM Blueprint")
	static UE_API void RequestAutoVMRecompilation(URigVMBlueprint* InBlueprint);

	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "RigVM Blueprint")
	static UE_API URigVMGraph* GetModel(URigVMBlueprint* InBlueprint);

	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "RigVM Blueprint")
	static UE_API URigVMController* GetController(URigVMBlueprint* InBlueprint);

	UFUNCTION(BlueprintCallable, Category = "RigVM Blueprint")
	static UE_API TArray<URigVMBlueprint*> LoadAssets();

	UFUNCTION(BlueprintCallable, Category = "RigVM Blueprint")
	static UE_API TArray<URigVMBlueprint*> LoadAssetsByClass(TSubclassOf<URigVMBlueprint> InClass);
	...
	UFUNCTION(BlueprintCallable, Category = "RigVM Blueprint", meta = (DisplayName = "LoadAssetsWithBlueprintFilter", ScriptName = "LoadAssetsWithBlueprintFilter"))
		static UE_API TArray<URigVMBlueprint*> LoadAssetsWithBlueprintFilter_ForBlueprint(
	...
	UFUNCTION(BlueprintCallable, Category = "RigVM Blueprint", meta = (DisplayName = "LoadAssetsWithAssetDataFilter", ScriptName = "LoadAssetsWithAssetDataFilter"))
		static UE_API TArray<URigVMBlueprint*> LoadAssetsWithAssetDataFilter_ForBlueprint(
		TSubclassOf<URigVMBlueprint> InClass,
	...
	static UE_API TArray<URigVMBlueprint*> LoadAssetsWithNodeFilter_ForBlueprint(
		TSubclassOf<URigVMBlueprint> InClass,
		FRigVMNodeFilterDynamic InNodeFilter);

	static UE_API TArray<URigVMBlueprint*> LoadAssetsWithNodeFilter(
		TSubclassOf<URigVMBlueprint> InClass,
	...
	static UE_API TArray<URigVMBlueprint*> LoadAssetsWithAssetDataAndBlueprintFilters_ForBlueprint(
		TSubclassOf<URigVMBlueprint> InClass,
		FRigVMAssetDataFilterDynamic InAssetDataFilter,
		FRigVMBlueprintFilterDynamic InBlueprintFilter);

	static UE_API TArray<URigVMBlueprint*> LoadAssetsWithAssetDataAndBlueprintFilters(
		TSubclassOf<URigVMBlueprint> InClass,
	...
	static UE_API TArray<URigVMBlueprint*> LoadAssetsWithAssetDataAndNodeFilters_ForBlueprint(
		TSubclassOf<URigVMBlueprint> InClass,
		FRigVMAssetDataFilterDynamic InAssetDataFilter,
		FRigVMNodeFilterDynamic InNodeFilter);

	static UE_API TArray<URigVMBlueprint*> LoadAssetsWithAssetDataAndNodeFilters(
		TSubclassOf<URigVMBlueprint> InClass,
		FRigVMAssetDataFilter InAssetDataFilter,
		FRigVMNodeFilter InNodeFilter);

	UFUNCTION(BlueprintCallable, Category = "RigVM Blueprint", meta = (DisplayName = "GetAssetsWithFilter", ScriptName = "GetAssetsWithFilter"))
	static UE_API TArray<FAssetData> GetAssetsWithFilter_ForBlueprint(
		TSubclassOf<URigVMBlueprint> InClass,
		FRigVMAssetDataFilterDynamic InAssetDataFilter);

	static UE_API TArray<FAssetData> GetAssetsWithFilter(
		UClass* InClass,
		FRigVMAssetDataFilter InAssetDataFilter);
};
