...
FRigVMFunction_DebugRectangleNoSpace_Execute()
{
	...
	ExecuteContext.GetDrawInterface()->DrawRectangle(WorldOffset, Transform, Scale, Color, Thickness, DebugDrawSettings.DepthPriority, DebugDrawSettings.Lifetime);
}
...
FRigVMFunction_DebugArcNoSpace_Execute()
{
	...
	ExecuteContext.GetDrawInterface()->DrawArc(WorldOffset, Transform, Radius, FMath::DegreesToRadians(MinimumDegrees), FMath::DegreesToRadians(MaximumDegrees), Color, Thickness, Detail, DebugDrawSettings.DepthPriority, DebugDrawSettings.Lifetime);
}
...
FRigVMFunction_DebugBoxNoSpace_Execute()
{
	...
	ExecuteContext.GetDrawInterface()->DrawBox(WorldOffset, Transform, Color, Thickness, DebugDrawSettings.DepthPriority, DebugDrawSettings.Lifetime);
}
