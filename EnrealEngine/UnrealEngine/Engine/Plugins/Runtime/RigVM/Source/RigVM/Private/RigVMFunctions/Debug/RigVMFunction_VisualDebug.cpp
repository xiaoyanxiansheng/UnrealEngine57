...
{
	FRigVMFunction_VisualDebugVectorNoSpace::StaticExecute(ExecuteContext, Value, bEnabled, Mode, Color, Thickness, Scale, DebugDrawSettings);
}
...
{
	FRigVMFunction_VisualDebugQuatNoSpace::StaticExecute(ExecuteContext, Value, bEnabled, Thickness, Scale, DebugDrawSettings);
}
...
FRigVMFunction_VisualDebugQuatNoSpace_Execute()
{
	...
	FRigVMFunction_VisualDebugTransformNoSpace::StaticExecute(ExecuteContext, Transform, bEnabled, Thickness, Scale, DebugDrawSettings);
}

FRigVMFunction_VisualDebugTransform_Execute()
{
	FRigVMFunction_VisualDebugTransformNoSpace::StaticExecute(ExecuteContext, Value, bEnabled, Thickness, Scale, DebugDrawSettings);
}
