...
FRigVMStructUpgradeInfo FRigVMFunction_MathTransformMake::GetUpgradeInfo() const
{
	...
	Info.AddRemappedPin(TEXT("Translation"), TEXT("Value.Translation"));
	Info.AddRemappedPin(TEXT("Rotation"), TEXT("Value.Rotation"));
	Info.AddRemappedPin(TEXT("Scale"), TEXT("Value.Scale"));
	return Info;
}
