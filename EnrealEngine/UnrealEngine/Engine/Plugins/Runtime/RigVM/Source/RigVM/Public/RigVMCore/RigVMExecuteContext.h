...
struct FRigVMExtendedExecuteContext
{
	...
	RIGVM_API int32 GetInstructionIndex() const;
	RIGVM_API FString GetVMPathName() const;
	...
	UE_DEPRECATED(5.6, "OnExecutionReachedExit has been deprecated, please use OnExecutionReachedExitCallback.")
