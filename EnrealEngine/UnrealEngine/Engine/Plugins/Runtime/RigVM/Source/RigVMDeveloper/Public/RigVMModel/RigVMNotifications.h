...
enum class ERigVMGraphNotifType : uint8
{
	...
	NodeEarlyExitChanged, // The node's early exit state has changed
	LocalVariableDefaultValueChanged, // A local variable default value has been set (Subject == URigVMLibraryNode)
	LocalVariableAdded, // A local variable has been added to a function (Subject == URigVMLibraryNode)
	LocalVariableRemoved, // A local variable has been removed from a function (Subject == URigVMLibraryNode)
	LocalVariableRenamed, // A local variable has been renamed inside a function (Subject == URigVMLibraryNode)
	LocalVariableTypeChanged, // A local variable has been renamed inside a function (Subject == URigVMLibraryNode)
