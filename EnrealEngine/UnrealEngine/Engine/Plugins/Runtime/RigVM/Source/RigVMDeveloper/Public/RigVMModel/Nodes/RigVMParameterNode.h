...
public:
	...
	UE_API FName GetParameterName() const;

	// Returns true if this node is an input
	UFUNCTION(BlueprintCallable, Category = RigVMParameterNode)
	UE_API bool IsInput() const;
	...
	UFUNCTION(BlueprintCallable, Category = RigVMParameterNode)
	UE_API FRigVMGraphParameterDescription GetParameterDescription() const;
