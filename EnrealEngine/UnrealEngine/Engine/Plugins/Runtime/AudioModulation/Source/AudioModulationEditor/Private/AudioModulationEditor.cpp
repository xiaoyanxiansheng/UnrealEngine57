...
#include "Insights/Views/ModulationMatrixDashboardViewFactory.h"
...
namespace
{
	...
	void RegisterModulationInAudioInsights()
	{
		...
		if (!IsRunningCommandlet())
		{
			...
			{
				IAudioInsightsEditorModule& InsightsEditorModule = IAudioInsightsEditorModule::GetChecked();
				InsightsEditorModule.RegisterDashboardViewFactory(MakeShared<AudioModulationEditor::FControlBusDashboardViewFactory>());
				InsightsEditorModule.RegisterDashboardViewFactory(MakeShared<AudioModulationEditor::FModulationMatrixDashboardViewFactory>());
	...
	void UnregisterModulationInAudioInsights()
	{
		if (bIsModulationRegisteredInAudioInsights)
		{
			...
			{
				IAudioInsightsEditorModule& InsightsEditorModule = IAudioInsightsEditorModule::GetChecked();
				InsightsEditorModule.UnregisterDashboardViewFactory("ControlBuses");
				InsightsEditorModule.UnregisterDashboardViewFactory("ModulationMatrix");
