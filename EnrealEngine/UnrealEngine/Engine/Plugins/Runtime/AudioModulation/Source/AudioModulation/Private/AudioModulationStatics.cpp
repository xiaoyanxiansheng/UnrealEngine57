...
USoundControlBus* UAudioModulationStatics::CreateBus(UObject* WorldContextObject, FName Name, USoundModulationParameter* Parameter, bool Activate)
{
	...
	FName UniqueName = MakeUniqueObjectName(WorldContextObject, USoundControlBus::StaticClass(), Name);
	USoundControlBus* NewBus = NewObject<USoundControlBus>(WorldContextObject, UniqueName);
...
USoundControlBusMix* UAudioModulationStatics::CreateBusMix(UObject* WorldContextObject, FName Name, TArray<FSoundControlBusMixStage> Stages, bool Activate, double Duration, bool bRetriggerOnActivation)
{
	...
	FName UniqueName = MakeUniqueObjectName(WorldContextObject, USoundControlBusMix::StaticClass(), Name);
	USoundControlBusMix* NewBusMix = NewObject<USoundControlBusMix>(WorldContextObject, UniqueName);
	...
	NewBusMix->Duration = Duration;
	NewBusMix->bRetriggerOnActivation = bRetriggerOnActivation;
...
USoundModulationParameter* UAudioModulationStatics::CreateModulationParameter(UObject* WorldContextObject, FName Name, TSubclassOf<USoundModulationParameter> ParamClass, float DefaultValue)
{
	...
	FName UniqueName = MakeUniqueObjectName(WorldContextObject, USoundModulationParameter::StaticClass(), Name);
	USoundModulationParameter* NewParam = NewObject<USoundModulationParameter>(WorldContextObject, ParamClass, UniqueName);
...
USoundModulationGeneratorEnvelopeFollower* UAudioModulationStatics::CreateEnvelopeFollowerGenerator(UObject* WorldContextObject, FName Name, FEnvelopeFollowerGeneratorParams Params)
{
	...
	FName UniqueName = MakeUniqueObjectName(WorldContextObject, USoundModulationGeneratorEnvelopeFollower::StaticClass(), Name);
	USoundModulationGeneratorEnvelopeFollower* NewGenerator = NewObject<USoundModulationGeneratorEnvelopeFollower>(WorldContextObject, USoundModulationGeneratorEnvelopeFollower::StaticClass(), UniqueName);
...
USoundModulationGeneratorLFO* UAudioModulationStatics::CreateLFOGenerator(UObject* WorldContextObject, FName Name, FSoundModulationLFOParams Params)
{
	...
	FName UniqueName = MakeUniqueObjectName(WorldContextObject, USoundModulationGeneratorLFO::StaticClass(), Name);
	USoundModulationGeneratorLFO* NewGenerator = NewObject<USoundModulationGeneratorLFO>(WorldContextObject, USoundModulationGeneratorLFO::StaticClass(), UniqueName);
...
USoundModulationGeneratorADEnvelope* UAudioModulationStatics::CreateADEnvelopeGenerator(UObject* WorldContextObject, FName Name, const FSoundModulationADEnvelopeParams& Params)
{
	...
	FName UniqueName = MakeUniqueObjectName(WorldContextObject, USoundModulationGeneratorADEnvelope::StaticClass(), Name);
	USoundModulationGeneratorADEnvelope* NewGenerator = NewObject<USoundModulationGeneratorADEnvelope>(WorldContextObject, USoundModulationGeneratorADEnvelope::StaticClass(), UniqueName);
...
UAudioModulationDestination* UAudioModulationStatics::CreateModulationDestination(UObject* WorldContextObject, FName Name, USoundModulatorBase* Modulator)
{
	...
	FName UniqueName = MakeUniqueObjectName(WorldContextObject, UAudioModulationDestination::StaticClass(), Name);
	UAudioModulationDestination* NewDestination = NewObject<UAudioModulationDestination>(WorldContextObject, UAudioModulationDestination::StaticClass(), UniqueName);
	if (NewDestination)
	{
...
void UAudioModulationStatics::UpdateMix(const UObject* WorldContextObject, USoundControlBusMix* Mix, TArray<FSoundControlBusMixStage> Stages, float InFadeTime, double Duration, bool bRetriggerOnActivation)
{
	if (Mix)
	{
		UWorld* World = GetAudioWorld(WorldContextObject);
		if (AudioModulation::FAudioModulationManager* ModSystem = GetModulation(World))
		{
			...
			ModSystem->UpdateMix(Stages, *Mix, false /* bUpdateObject */, InFadeTime, Duration, bRetriggerOnActivation);
		}
	}
}
