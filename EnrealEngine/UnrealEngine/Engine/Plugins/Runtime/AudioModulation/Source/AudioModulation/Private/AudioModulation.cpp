...
namespace AudioModulation
{
	...
	{
		UE_LOG(LogAudioModulation, VeryVerbose, TEXT("FAudioModulationManager::ActivateBus is deprecated. Use UAudioModulationDestination API (see SetModulator) instead to enforce bus lifetime"));
	...
	{
		UE_LOG(LogAudioModulation, VeryVerbose, TEXT("FAudioModulationManager::ActivateGenerator is deprecated. Use UAudioModulationDestination API (see SetModulator) instead to enforce generator lifetime"));
	...
	{
		UE_LOG(LogAudioModulation, VeryVerbose, TEXT("FAudioModulationManager::DeactivateBus is deprecated. Use UAudioModulationDestination API (see ClearModulator) instead to enforce bus lifetime."));
	...
	{
		UE_LOG(LogAudioModulation, VeryVerbose, TEXT("FAudioModulationManager::DeactivateGenerator is deprecated. Use UAudioModulationDestination API (see ClearModulator) instead to enforce generator lifetime"));
	...
	void FAudioModulationManager::SetDebugActiveMixesEnabled(bool bInIsEnabled)
	{
		ModSystem->SetDebugActiveMixesEnabled(bInIsEnabled);
	}

	void FAudioModulationManager::SetDebugActiveGlobalMixesEnabled(bool bInIsEnabled)
	{
		ModSystem->SetDebugActiveGlobalMixesEnabled(bInIsEnabled);
	}
...
#if WITH_AUDIOMODULATION_METASOUND_SUPPORT
	UE_LOG(LogAudioModulation, Log, TEXT("Unregistering Modulation MetaSound Nodes..."));
