...
namespace AudioModulation
{
	...
	public:
		...
		friend inline uint32 GetTypeHash(const AudioModulation::FSoundModulatorAsset& InModulatorAsset)
		{
	...
	public:
		...
		friend inline uint32 GetTypeHash(const AudioModulation::FSoundModulationParameterAsset& InModulationParameterAsset)
		{
