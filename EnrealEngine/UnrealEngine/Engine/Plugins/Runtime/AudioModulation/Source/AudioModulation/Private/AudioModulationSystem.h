...
namespace AudioModulation
{
	...
	public:
		...
		/* Returns whether the given bus Mix is a Global Bus Mix, created using the SetGlobalBusMixValue function. */
		bool IsBusMixGlobal(FBusMixId InBusMixId) const;
	...
	private:
		...
		// the key in this map is the Bus's unique ID, not the Control Bus Mix's.
	...
	public:
		...
		virtual void SetDebugActiveMixesEnabled(bool bInIsEnabled);
		virtual void SetDebugActiveGlobalMixesEnabled(bool bInIsEnabled);
