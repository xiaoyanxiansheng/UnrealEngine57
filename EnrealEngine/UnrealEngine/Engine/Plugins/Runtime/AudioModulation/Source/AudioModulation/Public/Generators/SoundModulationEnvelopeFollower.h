...
UCLASS(MinimalAPI, hidecategories = Object, BlueprintType, editinlinenew, meta = (DisplayName = "Envelope Follower Generator"))
...
public:
	...
	UE_API virtual AudioModulation::FGeneratorPtr CreateInstance() const override;
};
