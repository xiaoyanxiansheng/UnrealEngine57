...
class UScriptableSingleClickTool : public UScriptableInteractiveTool, public IClickBehaviorTarget, public IHoverBehaviorTarget
{
	GENERATED_BODY()
...
public:
	...
	UE_API FInputRayHit TestIfHitByClick(FInputDeviceRay ClickPos, const FScriptableToolModifierStates& Modifiers);

	UE_API virtual FInputRayHit TestIfHitByClick_Implementation(FInputDeviceRay ClickPos, const FScriptableToolModifierStates& Modifiers);
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, Category = "Click Events")
	UE_API void OnHitByClick(FInputDeviceRay ClickPos, const FScriptableToolModifierStates& Modifiers);

	UE_API virtual void OnHitByClick_Implementation(FInputDeviceRay ClickPos, const FScriptableToolModifierStates& Modifiers);
