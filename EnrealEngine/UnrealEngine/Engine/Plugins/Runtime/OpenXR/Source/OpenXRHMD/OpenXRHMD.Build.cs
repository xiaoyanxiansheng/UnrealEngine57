...
namespace UnrealBuildTool.Rules
{
	public class OpenXRHMD : ModuleRules
	{
		public OpenXRHMD(ReadOnlyTargetRules Target) : base(Target)
        {
            ...
            {
				PrivateDefinitions.Add("OPENXRHMD_HAVE_DX11");
				PrivateDefinitions.Add("OPENXRHMD_HAVE_DX12");
            ...
            if (Target.Platform == UnrealTargetPlatform.Win64 || Target.Platform == UnrealTargetPlatform.Android)
            {
				if (Target.Platform == UnrealTargetPlatform.Win64)
				{
					PrivateDefinitions.Add("OPENXRHMD_HAVE_OPENGL");
				}
			
				if (Target.Platform == UnrealTargetPlatform.Android)
				{
					PrivateDefinitions.Add("OPENXRHMD_HAVE_OPENGLES");
				}
            ...
            {
				PrivateDefinitions.Add("OPENXRHMD_HAVE_VULKAN");
