...
public:
	...
	UPROPERTY(Transient, Replicated)
	TObjectPtr<UTestReplicatedIrisObjectWithObjectReference> TypedRawObjectPtrRef;

	UPROPERTY(Transient, Replicated)
	TWeakObjectPtr<UTestReplicatedIrisObjectWithObjectReference> TypedWeakObjectPtrObjectRef;

	UPROPERTY(Transient, Replicated)
	TSoftObjectPtr<UTestReplicatedIrisObjectWithObjectReference> TypedSoftObjectPtrRef;
...
public:
	...
	void SetInitialOnlyInt(int32 InValue);
	int32 GetInitialOnlyInt() const;

	void SetInitialOrOwnerInt(int32 InValue);
	int32 GetInitialOrOwnerInt() const;
...
public:
	...
	FNetRefHandle BeginReplication(FNetRefHandle OwnerHandle, UReplicatedTestObject* Instance, FNetRefHandle InsertRelativeToSubObjectHandle = FNetRefHandle::GetInvalid(), UE::Net::ESubObjectInsertionOrder InsertionOrder = UE::Net::ESubObjectInsertionOrder::None);
	...
	void SetExternalPreUpdateFunctor(TFunction<void(TArrayView<UObject*>, const UObjectReplicationBridge*)> PreUpdateFunctor);
