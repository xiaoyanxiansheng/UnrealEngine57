...
protected:
	...
	void CreateServers(unsigned ServerCount, const FReplicationSystemTestNode::FReplicationSystemParamsOverride* ParamsOverride = nullptr);
	...
	FReplicationSystemTestServer* CreateServer(const FReplicationSystemTestNode::FReplicationSystemParamsOverride* ParamsOverride = nullptr);

	/** Destroys a server and all of its clients */
	void DestroyServer(FReplicationSystemTestServer* Server);
