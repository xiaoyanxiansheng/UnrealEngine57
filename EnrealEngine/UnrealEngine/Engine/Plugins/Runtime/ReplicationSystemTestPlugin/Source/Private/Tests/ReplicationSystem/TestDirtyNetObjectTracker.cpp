...
UE_NET_TEST_FIXTURE(FReplicationSystemServerClientTestFixture, NetForceUpdateOtherObjectInsidePreUpdateTest)
{
	...
	auto PreUpdateObjectA = [&](TArrayView<UObject*> Instances, const UObjectReplicationBridge* Bridge)
	{
	...
	auto PreUpdateObjectB = [&](TArrayView<UObject*> Instances, const UObjectReplicationBridge* Bridge)
	{
		for (UObject* ReplicatedObject : Instances)
		{
