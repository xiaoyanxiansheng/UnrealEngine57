...
FAndroidMediaPlayerStreamer::FAndroidMediaPlayerStreamer()
	...
	, CurrentPosition(-1)
{
	JavaMediaPlayer = MakeShareable(new FJavaAndroidMediaPlayer(false, FAndroidMisc::ShouldUseVulkan(), false, true));
...
bool FAndroidMediaPlayerStreamer::Tick(FRHICommandListBase& RHICmdList, float DeltaTime)
{
