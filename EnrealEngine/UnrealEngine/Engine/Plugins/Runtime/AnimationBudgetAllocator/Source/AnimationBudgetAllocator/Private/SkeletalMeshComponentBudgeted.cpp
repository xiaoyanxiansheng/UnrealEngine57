...
static_assert(sizeof(USkeletalMeshComponentBudgeted) <= 4368, "We expect SkeletalMeshComponentBudgeted to be 4368 or less, otherwise we waste memory on 304bytes of padding on MallocBinned2. Please improve padding on this class hierarchy to pay for your added variable.");
#endif
