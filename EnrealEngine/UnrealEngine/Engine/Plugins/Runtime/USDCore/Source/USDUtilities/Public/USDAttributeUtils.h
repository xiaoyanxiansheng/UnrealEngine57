...
namespace UsdUtils
{
	...
	/** Returns the attribute that has the strongest spec, acrosss the provided Attributes array */
	USDUTILITIES_API UE::FUsdAttribute GetStrongestAttribute(const TArray<UE::FUsdAttribute>& Attributes, double TimeCode);
#endif	  // USE_USD_SDK
}
