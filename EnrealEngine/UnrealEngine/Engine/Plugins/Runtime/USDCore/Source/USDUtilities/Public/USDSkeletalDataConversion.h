...
namespace UsdUtils
{
	struct FUsdBlendShapeInbetween
	{
...
namespace UsdToUnreal
{
	 ...
	 * be played since the start of the stage to match the intended composed animation. The baked UAnimSequence will only contain the range between the
	 ...
	 * with seconds.
	 * @param OutScaleSeconds - Optional output parameter that will be filled with the total scale difference between the playback speed of the 
	 * baked AnimSequence and the stage
	 * @return Whether the conversion was successful or not.
	 */
