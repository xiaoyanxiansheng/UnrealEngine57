...
namespace UE
{
	...
	public:
		...
		TMap<FString, UE::FVtValue> GetAllMetadata() const;
		TMap<FString, UE::FVtValue> GetAllAuthoredMetadata() const;

		FString GetDisplayName() const;
		bool SetDisplayName(const FString& Name) const;
	...
	public:
		...
		TArray<FSdfPrimSpec> GetPrimStack() const;

		FPcpPrimIndex GetPrimIndex() const;
		FPcpPrimIndex ComputeExpandedPrimIndex() const;
