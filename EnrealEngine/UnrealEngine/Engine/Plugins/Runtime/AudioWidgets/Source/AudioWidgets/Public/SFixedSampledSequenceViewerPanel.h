...
class SFixedSampledSequenceViewerPanel : public SCompoundWidget, public IFixedSampledSequenceViewReceiver
{
public:
	...
	UE_API void UpdateSequenceViewerStyle(const FSampledSequenceViewerStyle UpdatedStyle);
	UE_API void UpdateRulerStyle(const FFixedSampleSequenceRulerStyle UpdatedStyle);
	UE_API void UpdatePlayheadOverlayStyle(const FPlayheadOverlayStyle UpdatedStyle);
	UE_API void UpdateValueGridOverlayStyle(const FSampledSequenceValueGridOverlayStyle UpdatedStyle);
	
private:
	UE_API virtual void CreateLayout();
