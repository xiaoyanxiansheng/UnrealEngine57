...
namespace SampledSequenceDrawingUtils
{
	...
	*/
	...
	{
		UE_API explicit FDimensionSlot(const uint16 DimensionToDraw, const uint16 TotalNumDimensions, const FGeometry& InAllottedGeometry, const FSampledSequenceDrawingParams& Params);
