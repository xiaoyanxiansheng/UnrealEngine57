...
struct FAudioOscilloscopePanelStyle : public FSlateWidgetStyle
{
	...
	UE_API static FOnNewTimeRulerStyle        OnNewTimeRulerStyle;
	UE_API static FOnNewValueGridOverlayStyle OnNewValueGridOverlayStyle;
	UE_API static FOnNewWaveformViewerStyle   OnNewWaveformViewerStyle;
};
