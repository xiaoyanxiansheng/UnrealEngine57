...
protected:
...
#if WITH_EDITOR
	GAMEPLAYSTATETREEMODULE_API virtual const UObject* GetAssociatedAsset(TOptional<FBehaviorTreeNodeDebugContext> DebugContext) const override;
#endif //WITH_EDITOR
	...
	/** Saved actor used by the schema requirement. */
