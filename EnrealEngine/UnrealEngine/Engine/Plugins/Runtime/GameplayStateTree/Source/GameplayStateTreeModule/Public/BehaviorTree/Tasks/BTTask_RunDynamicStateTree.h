...
public:
	...
	FGameplayTag GetInjectionTag() const { return InjectionTag; }
...
#if WITH_EDITOR
	GAMEPLAYSTATETREEMODULE_API const UObject* GetAssociatedAsset(TOptional<FBehaviorTreeNodeDebugContext> DebugContext) const override;
#endif //WITH_EDITOR
