...
public:
	...
	*/
	...
	static UE_API int GetPolyPathNumVertices(FGeometryScriptPolyPath PolyPath);

	/**
	* Returns the index of the last vertex in the PolyPath.  
	*/
	UFUNCTION(BlueprintPure, Category = "GeometryScript|PolyPath", meta=(ScriptMethod))
	static UE_API int GetPolyPathLastIndex(FGeometryScriptPolyPath PolyPath);
	...
	*/
	UFUNCTION(BlueprintPure, Category = "GeometryScript|PolyPath", meta=(ScriptMethod))
	static UE_API FVector GetPolyPathVertex(FGeometryScriptPolyPath PolyPath, int Index, bool& bIsValidIndex);
	...
	*/
	UFUNCTION(BlueprintPure, Category = "GeometryScript|PolyPath", meta = (ScriptMethod))
	static UE_API FVector GetPolyPathTangent(FGeometryScriptPolyPath PolyPath, int Index, bool& bIsValidIndex);

	/**
	* Returns the length of the PolyPath.
	*/
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolyPath", meta = (ScriptMethod))
	static UE_API double GetPolyPathArcLength(FGeometryScriptPolyPath PolyPath);

	/** Find the index of the vertex closest to a given point.  Returns -1 if the PolyPath has no vertices. */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolyPath", meta = (ScriptMethod))
	static UE_API int32 GetNearestVertexIndex(FGeometryScriptPolyPath PolyPath, FVector Point);
	...
	static UE_API UPARAM(DisplayName = "Poly Path") FGeometryScriptPolyPath FlattenTo2DOnAxis(FGeometryScriptPolyPath PolyPath, EGeometryScriptAxis DropAxis = EGeometryScriptAxis::Z);
	...
	static UE_API UPARAM(DisplayName = "Poly Path") FGeometryScriptPolyPath CreateCirclePath3D(FTransform Transform, float Radius = 10, int NumPoints = 10);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolyPath")
	static UE_API UPARAM(DisplayName = "Poly Path") FGeometryScriptPolyPath CreateArcPath3D(FTransform Transform, float Radius = 10, int NumPoints = 10, float StartAngle = 0, float EndAngle = 90);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolyPath")
	static UE_API UPARAM(DisplayName = "Poly Path") FGeometryScriptPolyPath CreateCirclePath2D(FVector2D Center = FVector2D(0, 0), float Radius = 10, int NumPoints = 10);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolyPath")
	static UE_API UPARAM(DisplayName = "Poly Path") FGeometryScriptPolyPath CreateArcPath2D(FVector2D Center = FVector2D(0, 0), float Radius = 10, int NumPoints = 10, float StartAngle = 0, float EndAngle = 90);

	/**
	 * Sample positions from a USplineComponent into a PolyPath, based on the given SamplingOptions
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolyPath")
	static UE_API void ConvertSplineToPolyPath(const USplineComponent* Spline, FGeometryScriptPolyPath& PolyPath, FGeometryScriptSplineSamplingOptions SamplingOptions);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolyPath")
	static UE_API UPARAM(DisplayName = "Times Use Constant Velocity") bool SampleSplineToTransforms(
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolyPath", meta=(ScriptMethod))
	static UE_API void ConvertPolyPathToArray(FGeometryScriptPolyPath PolyPath, TArray<FVector>& VertexArray);

	/**
	* Creates a PolyPath from an array of 3D position vectors.
	*/
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolyPath")
	static UE_API void ConvertArrayToPolyPath(const TArray<FVector>& VertexArray, FGeometryScriptPolyPath& PolyPath);

	/**
	* Creates an array of 2D Vectors with the PolyPath vertex locations projected onto the XY plane.
	*/
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolyPath", meta = (ScriptMethod))
	static UE_API void ConvertPolyPathToArrayOfVector2D(FGeometryScriptPolyPath PolyPath, TArray<FVector2D>& VertexArray);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolyPath")
	static UE_API void ConvertArrayOfVector2DToPolyPath(const TArray<FVector2D>& VertexArray, FGeometryScriptPolyPath& PolyPath);
	...
	*/
	...
	static UE_API TArray<FVector> Conv_GeometryScriptPolyPathToArray(FGeometryScriptPolyPath PolyPath);
	...
	*/
	...
	static UE_API TArray<FVector2D> Conv_GeometryScriptPolyPathToArrayOfVector2D(FGeometryScriptPolyPath PolyPath);
	...
	*/
	...
	static UE_API FGeometryScriptPolyPath Conv_ArrayToGeometryScriptPolyPath(const TArray<FVector>& PathVertices);
	...
	*/
	...
	static UE_API FGeometryScriptPolyPath Conv_ArrayOfVector2DToGeometryScriptPolyPath(const TArray<FVector2D>& PathVertices);
};
