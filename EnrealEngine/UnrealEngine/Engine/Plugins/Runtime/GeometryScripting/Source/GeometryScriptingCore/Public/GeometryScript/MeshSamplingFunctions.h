...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|MeshSampling", meta = (ScriptMethod, HidePin = "Debug"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|MeshSampling", meta = (HidePin = "Debug", AutoCreateRefTerm = "Options"))
	static UE_API void
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|MeshSampling", meta = (HidePin = "Debug"))
	static UE_API void
