...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|Scene", meta = (HidePin = "Debug", ExpandEnumAsExecs = "Outcome"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|Scene", meta = (HidePin = "Debug"))
	static UE_API void
	 ...
	 * For Complex Collision, FromObject can be a Static/Skeletal Mesh Asset/Component, Dynamic Mesh Component, or other Component w/ complex collision support
	 * @param bTransformToWorld if true, output mesh is in World space
	 * @param LocalToWorld local-to-world transform is returned here (whether mesh is in local or world space)
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|Scene", meta = (HidePin = "Debug", AutoCreateRefTerm = "SourceMeshes, SourceMeshTransforms, TransparentMeshes, TransparentMeshTransforms, OccludeMeshes, OccludeMeshTransforms, OcclusionOptions"))
