...
public:
	...
	static UE_API int32 GetPolygonVertexCount(FGeometryScriptSimplePolygon Polygon);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|SimplePolygon", meta = (ScriptMethod))
	static UE_API FVector2D GetPolygonVertex(FGeometryScriptSimplePolygon Polygon, int32 VertexIndex, bool& bPolygonIsEmpty);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|SimplePolygon", meta = (ScriptMethod))
	static UE_API void SetPolygonVertex(UPARAM(ref) FGeometryScriptSimplePolygon Polygon, int32 VertexIndex, FVector2D Position, bool& bPolygonIsEmpty);

	/**
	 * Set the specified vertex of a Simple Polygon. Returns the index of the added vertex.
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|SimplePolygon", meta = (ScriptMethod))
	static UE_API UPARAM(DisplayName = "Vertex Index") int32 AddPolygonVertex(UPARAM(ref) FGeometryScriptSimplePolygon& Polygon, FVector2D Position);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|SimplePolygon", meta = (ScriptMethod))
	static UE_API FVector2D GetPolygonTangent(FGeometryScriptSimplePolygon Polygon, int32 VertexIndex, bool& bPolygonIsEmpty);

	/**
	 * Returns the arc length of a Simple Polygon
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|SimplePolygon", meta = (ScriptMethod))
	static UE_API double GetPolygonArcLength(FGeometryScriptSimplePolygon Polygon);

	/**
	 * Returns the area enclosed by a Simple Polygon
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|SimplePolygon", meta = (ScriptMethod, DisplayName = "Get Simple Polygon Area"))
	static UE_API double GetPolygonArea(FGeometryScriptSimplePolygon Polygon);

	/**
	 * Returns the bounding box of a Simple Polygon
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|SimplePolygon", meta = (ScriptMethod))
	static UE_API FBox2D GetPolygonBounds(FGeometryScriptSimplePolygon Polygon);
	...
	static UE_API void ConvertSplineToPolygon(const USplineComponent* Spline, FGeometryScriptSimplePolygon& Polygon, FGeometryScriptSplineSamplingOptions SamplingOptions, EGeometryScriptAxis DropAxis = EGeometryScriptAxis::Z);
	...
	static UE_API TArray<FVector> Conv_GeometryScriptSimplePolygonToArray(FGeometryScriptSimplePolygon Polygon);
	...
	static UE_API TArray<FVector2D> Conv_GeometryScriptSimplePolygonToArrayOfVector2D(FGeometryScriptSimplePolygon Polygon);
	...
	static UE_API FGeometryScriptSimplePolygon Conv_ArrayToGeometryScriptSimplePolygon(const TArray<FVector>& PathVertices);
	...
	static UE_API FGeometryScriptSimplePolygon Conv_ArrayOfVector2DToGeometryScriptSimplePolygon(const TArray<FVector2D>& PathVertices);
};
...
public:
	...
	static UE_API int32 GetPolygonCount(FGeometryScriptGeneralPolygonList PolygonList);

	/**
	 * Returns the number of holes in a Polygon. Returns zero for an invalid PolygonIndex.
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta = (ScriptMethod))
	static UE_API int32 GetPolygonHoleCount(FGeometryScriptGeneralPolygonList PolygonList, bool& bValidIndex, int32 PolygonIndex);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta=(ScriptMethod))
	static UE_API int32 GetPolygonVertexCount(FGeometryScriptGeneralPolygonList PolygonList, bool& bValidIndices, int32 PolygonIndex, int32 HoleIndex = -1);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta = (ScriptMethod))
	static UE_API void GetPolygonVertices(FGeometryScriptGeneralPolygonList PolygonList, TArray<FVector2D>& OutVertices, bool& bValidIndices, int32 PolygonIndex, int32 HoleIndex = -1);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta = (ScriptMethod))
	static UE_API FGeometryScriptSimplePolygon GetSimplePolygon(FGeometryScriptGeneralPolygonList PolygonList, bool& bValidIndices, int32 PolygonIndex, int32 HoleIndex = -1);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta = (ScriptMethod))
	static UE_API FVector2D GetPolygonVertex(FGeometryScriptGeneralPolygonList PolygonList, bool& bIsValidVertex, int32 VertexIndex, int32 PolygonIndex, int32 HoleIndex = -1);

	/**
	 * Returns the area enclosed by a specified Polygon in a Polygon List. Returns zero for an invalid PolygonIndex. 
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta = (ScriptMethod, DisplayName = "Get Area of Polygon in List"))
	static UE_API double GetPolygonArea(FGeometryScriptGeneralPolygonList PolygonList, bool& bValidIndex, int32 PolygonIndex);

	/**
	 * Returns the bounding box of a Polygon. Returns an empty, invalid box for an invalid PolygonIndex.
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta = (ScriptMethod))
	static UE_API FBox2D GetPolygonBounds(FGeometryScriptGeneralPolygonList PolygonList, bool& bValidIndex, int32 PolygonIndex);

	/**
	 * Returns the area enclosed by a Polygon List
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta = (ScriptMethod))
	static UE_API double GetPolygonListArea(FGeometryScriptGeneralPolygonList PolygonList);

	/**
	 * Returns the bounding box of a Polygon List
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta = (ScriptMethod))
	static UE_API FBox2D GetPolygonListBounds(FGeometryScriptGeneralPolygonList PolygonList);
	...
	static UE_API UPARAM(DisplayName = "Polygon List") FGeometryScriptGeneralPolygonList CreatePolygonListFromSinglePolygon(FGeometryScriptSimplePolygon OuterPolygon, const TArray<FGeometryScriptSimplePolygon>& HolePolygons, bool bFixHoleOrientations = true);

	/**
	 * Add Polygon to a Polygon List, with optional holes. Returns index of the added polygon.
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta = (ScriptMethod, AutoCreateRefTerm = "HolePolygons"))
	static UE_API UPARAM(DisplayName = "Polygon Index") int32 AddPolygonToList(UPARAM(ref) FGeometryScriptGeneralPolygonList& PolygonList, FGeometryScriptSimplePolygon OuterPolygon, const TArray<FGeometryScriptSimplePolygon>& HolePolygons, bool bFixHoleOrientations = true);

	/**
	 * Create a Polygon List from an array of Simple Polygons
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList")
	static UE_API UPARAM(DisplayName = "Polygon List") FGeometryScriptGeneralPolygonList CreatePolygonListFromSimplePolygons(const TArray<FGeometryScriptSimplePolygon>& OuterPolygons);

	/**
	 * Append the polygons in 'Polygons to Append' to Polygon List
	 */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta = (ScriptMethod))
	static UE_API void AppendPolygonList(UPARAM(ref) FGeometryScriptGeneralPolygonList& PolygonList, FGeometryScriptGeneralPolygonList PolygonsToAppend);
	
	/** Compute union of all polygons in Polygon List. Also resolves self-intersections within each polygon. */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta = (ScriptMethod))
	static UE_API FGeometryScriptGeneralPolygonList PolygonsUnion(FGeometryScriptGeneralPolygonList PolygonList, bool bCopyInputOnFailure = true);

	/** Compute difference of Polygon List and Polygons to Subtract */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta = (ScriptMethod))
	static UE_API FGeometryScriptGeneralPolygonList PolygonsDifference(FGeometryScriptGeneralPolygonList PolygonList, FGeometryScriptGeneralPolygonList PolygonsToSubtract);
	
	/** Compute intersection of Polygon List and Polygons to Intersect */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta = (ScriptMethod))
	static UE_API FGeometryScriptGeneralPolygonList PolygonsIntersection(FGeometryScriptGeneralPolygonList PolygonList, FGeometryScriptGeneralPolygonList PolygonsToIntersect);
	
	/** Compute exclusive or of Polygon List and Polygons to Exclusive Or */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta = (ScriptMethod))
	static UE_API FGeometryScriptGeneralPolygonList PolygonsExclusiveOr(FGeometryScriptGeneralPolygonList PolygonList, FGeometryScriptGeneralPolygonList PolygonsToExclusiveOr);

	/** Apply a single offset to a list of closed polygons */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta = (ScriptMethod))
	static UE_API FGeometryScriptGeneralPolygonList PolygonsOffset(FGeometryScriptGeneralPolygonList PolygonList, FGeometryScriptPolygonOffsetOptions OffsetOptions,
	...
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta = (ScriptMethod))
	static UE_API FGeometryScriptGeneralPolygonList PolygonsOffsets(FGeometryScriptGeneralPolygonList PolygonList, FGeometryScriptPolygonOffsetOptions OffsetOptions,
	...
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta = (ScriptMethod))
	static UE_API FGeometryScriptGeneralPolygonList PolygonsMorphologyOpen(FGeometryScriptGeneralPolygonList PolygonList, FGeometryScriptPolygonOffsetOptions OffsetOptions,
		double Offset, bool& bOperationSuccess, bool bCopyInputOnFailure = true);
	...
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList", meta = (ScriptMethod))
	static UE_API FGeometryScriptGeneralPolygonList PolygonsMorphologyClose(FGeometryScriptGeneralPolygonList PolygonList, FGeometryScriptPolygonOffsetOptions OffsetOptions,
		double Offset, bool& bOperationSuccess, bool bCopyInputOnFailure = true);

	/** Apply an offset to a single open 2D path, generating closed polygons as a result */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList")
	static UE_API FGeometryScriptGeneralPolygonList CreatePolygonsFromPathOffset(TArray<FVector2D> Path, FGeometryScriptOpenPathOffsetOptions OffsetOptions,
		double Offset, bool& bOperationSuccess, bool bCopyInputOnFailure = true);
	
	/** Apply an offset to a set of open 2D PolyPaths, generating closed polygons as a result */
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|PolygonList")
	static UE_API FGeometryScriptGeneralPolygonList CreatePolygonsFromOpenPolyPathsOffset(TArray<FGeometryScriptPolyPath> PolyPaths, FGeometryScriptOpenPathOffsetOptions OffsetOptions,
		double Offset, bool& bOperationSuccess, bool bCopyInputOnFailure = true);
