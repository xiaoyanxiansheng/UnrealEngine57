...
private:
	...
	// Copy/Paste group
	void OnCopyGroupItem(int32 CurrentSlot, EMaterialPanelType InType);
	bool OnCanCopyGroupItem(int32 CurrentSlot, EMaterialPanelType InType) const;
	void OnPasteGroupItem(int32 CurrentSlot, EMaterialPanelType InType);

	// Copy/Paste LOD
	void OnCopyLODItem(int32 CurrentSlot, int32 InLODIndex);
	bool OnCanCopyLODItem(int32 CurrentSlot, int32 InLODIndex) const;
	void OnPasteLODItem(int32 CurrentSlot, int32 InLODIndex);
