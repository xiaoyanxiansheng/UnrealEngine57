...
inline EHairResourceStatus  operator& (EHairResourceStatus In,  EHairResourceStatus::EStatus InStatus) { EHairResourceStatus Out = In; Out.Status = static_cast<EHairResourceStatus::EStatus>(static_cast<uint8>(Out.Status) & static_cast<uint8>(InStatus)); return Out; }
inline EHairResourceStatus  operator| (EHairResourceStatus In,  EHairResourceStatus::EStatus InStatus) { EHairResourceStatus Out = In; Out.Status = static_cast<EHairResourceStatus::EStatus>(static_cast<uint8>(Out.Status) | static_cast<uint8>(InStatus)); return Out; }
inline EHairResourceStatus& operator|=(EHairResourceStatus&Out, EHairResourceStatus::EStatus InStatus) { return Out=Out|InStatus; }

inline bool operator! (EHairResourceStatus A) { return static_cast<uint8>(A.Status) != 0 && A.AvailableCurveCount > 0; }
...
struct FHairStrandsLODRestRootResource : public FHairCommonResource
{
	...
	inline bool IsBulkDataValid() const { return BulkDataArray.IsValidIndex(BulkDataIndex); }

	inline const FHairStrandsRootBulkData& GetBulkData() const
	{
		check(BulkDataArray.IsValidIndex(BulkDataIndex));
		return BulkDataArray[BulkDataIndex];
	}

	inline FHairStrandsRootBulkData& GetBulkData()
	{
		check(BulkDataArray.IsValidIndex(BulkDataIndex));
		return BulkDataArray[BulkDataIndex];
	}
