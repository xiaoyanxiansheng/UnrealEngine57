	...
	FHairStrandsRDGTextures& Output)
{
	...
	for (uint32 GroupIndex = 0; GroupIndex < GroupCount; ++GroupIndex)
	{
...

		{
			...
			Instance.Common.SourcePointCount = GroupResource.Strands.RestResource->BulkData.GetNumSourcePoints();
			Instance.Common.SourceCurveCount = GroupResource.Strands.RestResource->BulkData.GetNumSourceCurves();
