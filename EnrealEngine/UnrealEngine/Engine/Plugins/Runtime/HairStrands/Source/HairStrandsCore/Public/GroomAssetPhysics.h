...
struct FHairSolverSettings
{
	...
	UPROPERTY(EditAnywhere, Category = "SolverSettings", meta = (ToolTip = "Use deformer for the groom solver", DisplayName = "Enable Deformation"))
	bool bEnableDeformation;

	/** Use niagara for simulation */
	UPROPERTY(EditAnywhere, Category = "SolverSettings", meta = (ToolTip = "Use niagara for the groom solver", DisplayName = "Enable Simulation"))
