...
struct FHairGroupInstance : public FHairStrandsInstance
{
	...
	inline const FTransform& GetRestLocalToWorld() const
	{
	...
	inline const FTransform& GetCurrentLocalToWorld() const
	{
	...
	inline const FTransform& GetPreviousLocalToWorld() const
	{
