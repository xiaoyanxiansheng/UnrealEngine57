...
void FHairGroupsPhysics::BuildDDCKey(FArchive& Ar)
{
	// This is used to know if curve/point mapping needs to be built for a particular groom/group
	Ar << SolverSettings.bEnableDeformation;
}
