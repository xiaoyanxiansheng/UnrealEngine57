...
public:
	...
	UE_API USynesthesiaSpectrumAnalyzer();
	...
	UE_API void GetCenterFrequencies(UPARAM(DisplayName = "Sample Rate") const float InSampleRate, UPARAM(DisplayName = "Center Frequencies") TArray<float>& OutCenterFrequencies);
