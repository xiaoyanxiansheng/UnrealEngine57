...
#define UE_API SKELETALMERGING_API
...
public:	
	...
	*/
	...
	static UE_API class USkeletalMesh* MergeMeshes(const FSkeletalMeshMergeParams& Params);
	...
	*/
	...
	static UE_API class USkeleton* MergeSkeletons(const FSkeletonMergeParams& Params);

protected:
	static UE_API void AddSockets(USkeleton* InSkeleton, const TArray<TObjectPtr<class USkeletalMeshSocket>>& InSockets);
	static UE_API void AddVirtualBones(USkeleton* InSkeleton, const TArray<const struct FVirtualBone*>& InVirtualBones);
	static UE_API void AddCurveNames(USkeleton* InSkeleton, const TMap<FName, const struct FCurveMetaData*>& InCurves);
	static UE_API void AddBlendProfiles(USkeleton* InSkeleton, const TMap<FName, TArray<const class UBlendProfile*>>& InBlendProfiles);
	static UE_API void AddAnimationSlotGroups(USkeleton* InSkeleton, const TMap<FName, TSet<FName>>& InSlotGroupsNames);
};
