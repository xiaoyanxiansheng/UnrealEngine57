...
int32 FMVVMFieldNotificationDelegates::RemoveAllFieldValueChangedDelegates(UObject* InOwner, FDelegateUserObjectConst InUserObject)
{
	int32 bResult = 0;
	if (InUserObject)
	{
...
int32 FMVVMFieldNotificationDelegates::RemoveAllFieldValueChangedDelegates(UObject* InOwner, UE::FieldNotification::FFieldId InFieldId, FDelegateUserObjectConst InUserObject)
{
	int32 bResult = 0;
