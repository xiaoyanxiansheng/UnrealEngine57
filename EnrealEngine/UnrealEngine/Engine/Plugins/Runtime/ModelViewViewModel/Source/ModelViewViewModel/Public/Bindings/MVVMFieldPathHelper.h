...
namespace UE::MVVM::FieldPathHelper
{
	...
	/**
	 * Returns the generated widget blueprint class of the widget that owns this component.
	 * Accessor: the widget blueprint class that owns the binding.
	 * ComponentPaths: The path to a field on a component.
	 */
	[[nodiscard]] MODELVIEWVIEWMODEL_API const UWidgetBlueprintGeneratedClass* GetComponentPropertyPathSource(TArray<UE::MVVM::FMVVMConstFieldVariant> ComponentPaths, const UWidgetBlueprintGeneratedClass* Accessor);
