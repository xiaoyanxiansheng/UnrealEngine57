...
#if WITH_EDITOR
void UMVVMView::HandleBlueprintPreCompile(UBlueprint* Blueprint)
{
	if (Blueprint && GeneratedViewClass->GetOuter() == Blueprint->GeneratedClass)
	{
		Destruct();
	}
}
