...
void UMVVMBlueprintInstancedViewModelBase::GenerateClass(bool bForceGeneration)
{
	...
	if (GeneratedClass == nullptr)
	{
		...
		PreviousClass = StaticFindObjectFastInternal(nullptr, Outermost, NewClassName, EFindObjectFlags::ExactClass);
		if (PreviousClass)
		{
...
void UMVVMBlueprintInstancedViewModelBase::AddOnRepFunction(FProperty* NewProperty)
{
	...
	UObject* PreviousObj = StaticFindObjectFastInternal(nullptr, GeneratedClass, Name_OnRepCallFunctionName, EFindObjectFlags::ExactClass);
