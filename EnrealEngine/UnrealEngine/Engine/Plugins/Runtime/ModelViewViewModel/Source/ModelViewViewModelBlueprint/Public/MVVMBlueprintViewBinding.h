...
public:
	...
	UE_API void GenerateWrapper(UBlueprint* Blueprint);
	UE_API void SavePinValues(UBlueprint* Blueprint);
	UE_API void DeprecateViewConversionFunction(UBlueprint* Blueprint, FMVVMBlueprintViewBinding& Owner);
...
struct FMVVMBlueprintViewBinding
{
	 ...
	 */
	UE_API FString GetDisplayNameString(const UWidgetBlueprint* WidgetBlueprint, bool bUseDisplayName = false) const;
	 ...
	 */
	UE_API FString GetSearchableString(const UWidgetBlueprint* WidgetBlueprint) const;
};
