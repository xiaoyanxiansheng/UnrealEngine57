...
public:
	MODELVIEWVIEWMODELBLUEPRINT_API FText ToText(const UWidgetBlueprint* Blueprint, bool bUseDisplayName) const;
	MODELVIEWVIEWMODELBLUEPRINT_API FString ToString(const UWidgetBlueprint* Blueprint, bool bUseDisplayName, bool bIncludeMetaData) const;
