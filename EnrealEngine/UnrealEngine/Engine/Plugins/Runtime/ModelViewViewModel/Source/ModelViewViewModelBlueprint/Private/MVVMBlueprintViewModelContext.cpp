...
bool GSupportUseAsInterfaceSetting = false;
static FAutoConsoleVariableRef CVarSupportUseAsInterfaceSetting(
	TEXT("MVVM.SupportUseAsInterfaceSetting"),
	GSupportUseAsInterfaceSetting,
	TEXT("Enable in order to have the UseAsInterface option available in UMG's viewmodel."),
	ECVF_ReadOnly
);
