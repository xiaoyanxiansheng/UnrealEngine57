...
private:
	...
	void HandleUseAsInterfaceChanged();
	...
	FText GetViewModelNameValueAsText() const;
	bool CanRenameViewModel() const;
	...
	bool IsUseAsInterfaceAvailable() const;
	...
	TSharedPtr<IPropertyHandle> UseAsInterfaceHandle;
