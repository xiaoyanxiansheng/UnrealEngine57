...
public:
	...
	static UE_API FSmartObjectClaimHandle GetValueAsSOClaimHandle(UBlackboardComponent* BlackboardComponent, const FName& KeyName);
	
	UFUNCTION(BlueprintCallable, Category = "SmartObject")
	static UE_API void SetValueAsSOClaimHandle(UBlackboardComponent* BlackboardComponent, const FName& KeyName, FSmartObjectClaimHandle Value);
	...
	static UE_API FSmartObjectClaimHandle SmartObjectClaimHandle_Invalid();
	...
	static UE_API bool AddOrRemoveSmartObject(UPARAM(DisplayName = "SmartObjectActor") AActor* SmartObject, UPARAM(DisplayName = "bAdd") const bool bEnabled);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SmartObject", meta=(ReturnDisplayName="bSuccess"))
	static UE_API bool AddOrRemoveMultipleSmartObjects(const TArray<AActor*>& SmartObjectActors, const bool bAdd);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SmartObject", meta=(ReturnDisplayName="bSuccess"))
	static UE_API bool AddSmartObject(AActor* SmartObjectActor);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SmartObject", meta=(ReturnDisplayName="bSuccess"))
	static UE_API bool AddMultipleSmartObjects(const TArray<AActor*>& SmartObjectActors);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SmartObject", meta=(ReturnDisplayName="bSuccess"))
	static UE_API bool RemoveSmartObject(AActor* SmartObjectActor);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SmartObject", meta=(ReturnDisplayName="bSuccess"))
	static UE_API bool RemoveMultipleSmartObjects(const TArray<AActor*>& SmartObjectActors);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SmartObject", meta=(ReturnDisplayName="bSuccess"))
	static UE_API bool SetSmartObjectEnabled(AActor* SmartObjectActor, const bool bEnabled);
	...
	static UE_API FSmartObjectClaimHandle MarkSmartObjectSlotAsClaimed(UObject* WorldContextObject, const FSmartObjectSlotHandle SlotHandle, const AActor* UserActor = nullptr, ESmartObjectClaimPriority ClaimPriority = ESmartObjectClaimPriority::Normal);
	...
	static UE_API const USmartObjectBehaviorDefinition* MarkSmartObjectSlotAsOccupied(UObject* WorldContextObject, const FSmartObjectClaimHandle ClaimHandle, TSubclassOf<USmartObjectBehaviorDefinition> DefinitionClass);
	...
	static UE_API bool MarkSmartObjectSlotAsFree(UObject* WorldContextObject, const FSmartObjectClaimHandle ClaimHandle);
	...
	static UE_API bool FindSmartObjectsInComponent(const FSmartObjectRequestFilter& Filter, USmartObjectComponent* SmartObjectComponent, TArray<FSmartObjectRequestResult>& OutResults, const AActor* UserActor = nullptr);
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure = False, Category = "SmartObject", Meta = (ReturnDisplayName = "bSuccess"))
	static UE_API bool FindSmartObjectsInActor(const FSmartObjectRequestFilter& Filter, AActor* SearchActor, TArray<FSmartObjectRequestResult>& OutResults, const AActor* UserActor = nullptr);
	...
	static UE_API bool FindSmartObjectsInTargetingRequest(UObject* WorldContextObject, const FSmartObjectRequestFilter& Filter, const FTargetingRequestHandle TargetingHandle, TArray<FSmartObjectRequestResult>& OutResults, const AActor* UserActor = nullptr);
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure = False, Category = "SmartObject", Meta = (WorldContext="WorldContextObject", ReturnDisplayName = "bSuccess"))
	static UE_API bool FindSmartObjectsInList(UObject* WorldContextObject, const FSmartObjectRequestFilter& Filter, const TArray<AActor*>& ActorList, TArray<FSmartObjectRequestResult>& OutResults, const AActor* UserActor = nullptr);
	...
	static UE_API FString Conv_SmartObjectClaimHandleToString(const FSmartObjectClaimHandle& Result);
	...
	static UE_API FString Conv_SmartObjectRequestResultToString(const FSmartObjectRequestResult& Result);
	...
	static UE_API FString Conv_SmartObjectDefinitionToString(const USmartObjectDefinition* Definition);
	...
	static UE_API FString Conv_SmartObjectHandleToString(const FSmartObjectHandle& Handle);
	...
	static UE_API bool NotEqual_SmartObjectHandleSmartObjectHandle(const FSmartObjectHandle& A, const FSmartObjectHandle& B);
	...
	static UE_API bool Equal_SmartObjectHandleSmartObjectHandle(const FSmartObjectHandle& A, const FSmartObjectHandle& B);
	...
	static UE_API bool IsValidSmartObjectHandle(const FSmartObjectHandle& Handle);
	...
	static UE_API FString Conv_SmartObjectSlotHandleToString(const FSmartObjectSlotHandle& Handle);
	...
	static UE_API bool Equal_SmartObjectSlotHandleSmartObjectSlotHandle(const FSmartObjectSlotHandle& A, const FSmartObjectSlotHandle& B);
	...
	static UE_API bool NotEqual_SmartObjectSlotHandleSmartObjectSlotHandle(const FSmartObjectSlotHandle& A, const FSmartObjectSlotHandle& B);
	...
	static UE_API bool IsValidSmartObjectSlotHandle(const FSmartObjectSlotHandle& Handle);
	...
	static UE_API bool SetMultipleSmartObjectsEnabled(const TArray<AActor*>& SmartObjectActors, const bool bEnabled);
	...
	static UE_API void SetBlackboardValueAsSOClaimHandle(UBTNode* NodeOwner, const FBlackboardKeySelector& Key, const FSmartObjectClaimHandle& Value);
	...
	static UE_API FSmartObjectClaimHandle GetBlackboardValueAsSOClaimHandle(UBTNode* NodeOwner, const FBlackboardKeySelector& Key);
};
