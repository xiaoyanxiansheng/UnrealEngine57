...
UObject* UMovieSceneGeometryCacheSection::GetSourceObject() const
{
	return Params.GeometryCacheAsset;
}
...
TOptional<TRange<FFrameNumber> > UMovieSceneGeometryCacheSection::GetAutoSizeRange() const
{
	...
	int32 IFrameNumber = AnimationLength.FrameNumber.Value + static_cast<int32>(AnimationLength.GetSubFrame() + 0.5f);
