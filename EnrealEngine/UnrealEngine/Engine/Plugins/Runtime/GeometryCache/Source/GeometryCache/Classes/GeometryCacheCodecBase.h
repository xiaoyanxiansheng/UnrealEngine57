...
class UGeometryCacheCodecBase : public UObject
{
	...
	UE_API virtual void BeginCoding(TArray<FStreamedGeometryCacheChunk> &AppendChunksTo);
	virtual void EndCoding() {}
	UE_API virtual void CodeFrame(const FGeometryCacheCodecEncodeArguments& Args);
	virtual int32 GetEncoderFrameNumer() { return EncoderBaseData.FrameId; }
#endif

	static UE_API bool IsSameTopology(const TArray<int32>& TopologyRanges, int32 FrameA, int32 FrameB);
