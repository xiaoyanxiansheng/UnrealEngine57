...
public:
	...
	/** The name of the accessory mesh to use as the backstop mesh. If none is specified, the default animated mesh will be used */
	UPROPERTY(EditAnywhere, Category = "Backstop Properties")
	FChaosClothAssetConnectableIStringValue BackstopMeshName;
