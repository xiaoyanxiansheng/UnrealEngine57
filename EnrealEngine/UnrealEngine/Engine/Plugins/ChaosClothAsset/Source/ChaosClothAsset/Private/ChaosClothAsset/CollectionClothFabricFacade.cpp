...
namespace UE::Chaos::ClothAsset
{
	...
	FCollectionClothFabricConstFacade::FCollectionClothFabricConstFacade(const TSharedRef<const FConstClothCollection>& ClothCollection, int32 InFabricIndex)
	...
	TSharedRef<class FClothCollection> FCollectionClothFabricFacade::GetClothCollection()
	{
