...
namespace UE::Chaos::ClothAsset
{
	...
	const FSoftObjectPath& FCollectionClothRenderPatternConstFacade::GetRenderMaterialSoftObjectPathName() const
	{
		static const FSoftObjectPath EmptyString;
		return ClothCollection->GetRenderMaterialSoftObjectPathName() && ClothCollection->GetNumElements(ClothCollectionGroup::RenderPatterns) > GetElementIndex() ?
			(*ClothCollection->GetRenderMaterialSoftObjectPathName())[GetElementIndex()] : EmptyString;
	}
	...
	FCollectionClothRenderPatternConstFacade::FCollectionClothRenderPatternConstFacade(const TSharedRef<const FConstClothCollection>& ClothCollection, int32 InPatternIndex)
	...
	void FCollectionClothRenderPatternFacade::Initialize(const FCollectionClothRenderPatternConstFacade& Other, int32 SimVertex3DOffset)
	{
		...
		SetRenderMaterialSoftObjectPathName(Other.GetRenderMaterialSoftObjectPathName());
	...
	void FCollectionClothRenderPatternFacade::SetRenderMaterialSoftObjectPathName(const FSoftObjectPath& PathName)
	{
		(*GetClothCollection()->GetRenderMaterialSoftObjectPathName())[GetElementIndex()] = PathName;
	}
	...
	TSharedRef<class FClothCollection> FCollectionClothRenderPatternFacade::GetClothCollection()
	{
