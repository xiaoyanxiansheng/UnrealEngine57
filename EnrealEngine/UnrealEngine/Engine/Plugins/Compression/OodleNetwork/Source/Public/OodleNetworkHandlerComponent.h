...
public:
	 ...
	 */
	inline void IncomingStats(uint32 CompressedLength, uint32 DecompressedLength)
	{
	 ...
	 */
	inline void OutgoingStats(uint32 CompressedLength, uint32 UncompressedLength)
	{
