...
public:
	FElectraVideoDecoderH265_Apple(const TMap<FString, FVariant>& InOptions);
...
TSharedPtr<IElectraDecoder, ESPMode::ThreadSafe> IElectraVideoDecoderH265_Apple::Create(const TMap<FString, FVariant>& InOptions)
{
	TSharedPtr<FElectraVideoDecoderH265_Apple, ESPMode::ThreadSafe> New = MakeShared<FElectraVideoDecoderH265_Apple>(InOptions);
	return New;
}

FElectraVideoDecoderH265_Apple::FElectraVideoDecoderH265_Apple(const TMap<FString, FVariant>& InOptions)
{
