...
{
public:
	FElectraVideoDecoderH264_Android(const TMap<FString, FVariant>& InOptions);
...
TSharedPtr<IElectraDecoder, ESPMode::ThreadSafe> IElectraVideoDecoderH264_Android::Create(const TMap<FString, FVariant>& InOptions)
{
	TSharedPtr<FElectraVideoDecoderH264_Android, ESPMode::ThreadSafe> New = MakeShared<FElectraVideoDecoderH264_Android>(InOptions);
	return New;
}


FElectraVideoDecoderH264_Android::FElectraVideoDecoderH264_Android(const TMap<FString, FVariant>& InOptions)
