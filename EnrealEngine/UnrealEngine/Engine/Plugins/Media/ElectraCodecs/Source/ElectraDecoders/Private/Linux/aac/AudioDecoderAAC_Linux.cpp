...
{
public:
	FElectraAudioDecoderAAC_Linux(const TMap<FString, FVariant>& InOptions);
...
TSharedPtr<IElectraDecoder, ESPMode::ThreadSafe> IElectraAudioDecoderAAC_Linux::Create(const TMap<FString, FVariant>& InOptions)
{
	TSharedPtr<FElectraAudioDecoderAAC_Linux, ESPMode::ThreadSafe> New = MakeShared<FElectraAudioDecoderAAC_Linux>(InOptions);
	return New;
}

FElectraAudioDecoderAAC_Linux::FElectraAudioDecoderAAC_Linux(const TMap<FString, FVariant>& InOptions)
{
