...
{
public:
	FElectraAudioDecoderAAC_Android(const TMap<FString, FVariant>& InOptions);
...
TSharedPtr<IElectraDecoder, ESPMode::ThreadSafe> IElectraAudioDecoderAAC_Android::Create(const TMap<FString, FVariant>& InOptions)
{
	TSharedPtr<FElectraAudioDecoderAAC_Android, ESPMode::ThreadSafe> New = MakeShared<FElectraAudioDecoderAAC_Android>(InOptions);
	return New;
}


FElectraAudioDecoderAAC_Android::FElectraAudioDecoderAAC_Android(const TMap<FString, FVariant>& InOptions)
{
