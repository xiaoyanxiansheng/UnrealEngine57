...
{
public:
	FElectraAudioDecoderAAC_Apple(const TMap<FString, FVariant>& InOptions);
...
TSharedPtr<IElectraDecoder, ESPMode::ThreadSafe> IElectraAudioDecoderAAC_Apple::Create(const TMap<FString, FVariant>& InOptions)
{
	TSharedPtr<FElectraAudioDecoderAAC_Apple, ESPMode::ThreadSafe> New = MakeShared<FElectraAudioDecoderAAC_Apple>(InOptions);
	return New;
}


FElectraAudioDecoderAAC_Apple::FElectraAudioDecoderAAC_Apple(const TMap<FString, FVariant>& InOptions)
{
