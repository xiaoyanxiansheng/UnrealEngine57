...
{
public:
	FElectraVideoDecoderVPx_Android(const TMap<FString, FVariant>& InOptions);
...
TSharedPtr<IElectraDecoder, ESPMode::ThreadSafe> IElectraVideoDecoderVPx_Android::Create(const TMap<FString, FVariant>& InOptions)
{
	TSharedPtr<FElectraVideoDecoderVPx_Android, ESPMode::ThreadSafe> New = MakeShared<FElectraVideoDecoderVPx_Android>(InOptions);
	return New;
}


FElectraVideoDecoderVPx_Android::FElectraVideoDecoderVPx_Android(const TMap<FString, FVariant>& InOptions)
