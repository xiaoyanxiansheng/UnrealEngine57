...
public:
	...
	{
		return IElectraVideoDecoderH264_DX::Create(InOptions);
	}
...
IElectraDecoder::FError IElectraVideoDecoderH264_DX::PlatformCreateMFDecoderTransform(IPlatformHandle** OutPlatformHandle, const TMap<FString, FVariant>& InOptions)
{
