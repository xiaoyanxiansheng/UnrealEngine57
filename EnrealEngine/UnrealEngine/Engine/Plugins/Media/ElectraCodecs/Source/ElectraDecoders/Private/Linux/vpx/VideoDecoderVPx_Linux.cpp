...
{
public:
	FElectraVideoDecoderVPx_Linux(const TMap<FString, FVariant>& InOptions);
...
TSharedPtr<IElectraDecoder, ESPMode::ThreadSafe> IElectraVideoDecoderVPx_Linux::Create(const TMap<FString, FVariant>& InOptions)
{
	TSharedPtr<FElectraVideoDecoderVPx_Linux, ESPMode::ThreadSafe> New = MakeShared<FElectraVideoDecoderVPx_Linux>(InOptions);
	return New;
}

FElectraVideoDecoderVPx_Linux::FElectraVideoDecoderVPx_Linux(const TMap<FString, FVariant>& InOptions)
{
