	...
	namespace MPEG
	{
		namespace H264
		{
			...
			struct FRBSP
			{
				...
				void TrimToBitstream(const Electra::FBitstreamReader& InBSR)
				{
			...
			{
			public:
				FBitstreamReaderH264() = default;
				FBitstreamReaderH264(const uint8* InData, uint64 InDataSize)
