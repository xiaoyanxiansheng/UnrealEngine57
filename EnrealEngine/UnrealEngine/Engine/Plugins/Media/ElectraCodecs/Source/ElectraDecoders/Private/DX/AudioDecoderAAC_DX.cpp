...
{
public:
	FElectraAudioDecoderAAC_DX(const TMap<FString, FVariant>& InOptions);
...
TSharedPtr<IElectraDecoder, ESPMode::ThreadSafe> IElectraAudioDecoderAAC_DX::Create(const TMap<FString, FVariant>& InOptions)
{
	TSharedPtr<FElectraAudioDecoderAAC_DX, ESPMode::ThreadSafe> New = MakeShared<FElectraAudioDecoderAAC_DX>(InOptions);
	return New;
}


FElectraAudioDecoderAAC_DX::FElectraAudioDecoderAAC_DX(const TMap<FString, FVariant>& InOptions)
{
