...
{
public:
	FElectraVideoDecoderH264_Linux(const TMap<FString, FVariant>& InOptions);
...
TSharedPtr<IElectraDecoder, ESPMode::ThreadSafe> IElectraVideoDecoderH264_Linux::Create(const TMap<FString, FVariant>& InOptions)
{
	TSharedPtr<FElectraVideoDecoderH264_Linux, ESPMode::ThreadSafe> New = MakeShared<FElectraVideoDecoderH264_Linux>(InOptions);
	return New;
}

FElectraVideoDecoderH264_Linux::FElectraVideoDecoderH264_Linux(const TMap<FString, FVariant>& InOptions)
{
