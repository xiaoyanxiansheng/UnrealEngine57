...
namespace ElectraDecodersUtil
{
	namespace VPxVideo
	{
		...
		{
			auto ReadColorConfig = [](FVP9UncompressedHeader& OutHeader, Electra::FBitstreamReader& BitReader) -> bool
			{
			...
			auto ReadFrameSize = [](FVP9UncompressedHeader& OutHeader, Electra::FBitstreamReader& BitReader) -> bool
			{
			...
			auto ReadRenderSize = [](FVP9UncompressedHeader& OutHeader, Electra::FBitstreamReader& BitReader) -> bool
			{
			...
			Electra::FBitstreamReader BitReader(Data, (uint64) Size);
