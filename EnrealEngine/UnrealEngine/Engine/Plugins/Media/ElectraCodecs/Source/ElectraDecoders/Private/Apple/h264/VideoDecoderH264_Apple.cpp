...
public:
	FElectraVideoDecoderH264_Apple(const TMap<FString, FVariant>& InOptions);
...
TSharedPtr<IElectraDecoder, ESPMode::ThreadSafe> IElectraVideoDecoderH264_Apple::Create(const TMap<FString, FVariant>& InOptions)
{
	TSharedPtr<FElectraVideoDecoderH264_Apple, ESPMode::ThreadSafe> New = MakeShared<FElectraVideoDecoderH264_Apple>(InOptions);
	return New;
}

FElectraVideoDecoderH264_Apple::FElectraVideoDecoderH264_Apple(const TMap<FString, FVariant>& InOptions)
{
