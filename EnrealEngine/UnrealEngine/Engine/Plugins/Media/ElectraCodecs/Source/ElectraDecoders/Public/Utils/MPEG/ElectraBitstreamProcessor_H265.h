...
class FElectraDecoderBitstreamProcessorH265 : public IElectraDecoderBitstreamProcessor
{
public:
	...
	{ return MakeShareable<>(new FElectraDecoderBitstreamProcessorH265(InDecoderParams, InFormatParams)); }

	virtual ~FElectraDecoderBitstreamProcessorH265();
...
private:
	ELECTRADECODERS_API FElectraDecoderBitstreamProcessorH265(const TMap<FString, FVariant>& InDecoderParams, const TMap<FString, FVariant>& InFormatParams);
	class FImpl;
