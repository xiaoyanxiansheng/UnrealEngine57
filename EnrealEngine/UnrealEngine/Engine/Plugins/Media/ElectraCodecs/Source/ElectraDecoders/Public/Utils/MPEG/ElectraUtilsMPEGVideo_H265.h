...
namespace ElectraDecodersUtil
{
	namespace MPEG
	{
		namespace H265
		{
			...
			{
			public:
				FBitstreamReaderH265() = default;
				FBitstreamReaderH265(const uint8* InData, uint64 InDataSize)
			...
			struct FProfileTierLevel
			{
				...
				UE_API bool Parse(FBitstreamReaderH265& br, bool profilePresentFlag, uint32 maxNumSubLayersMinus1);
				void Reset()
				{
			...
			{
				UE_API bool Parse(FBitstreamReaderH265& br, bool commonInfPresentFlag, uint32 maxNumSubLayersMinus1);
				void Reset()
				{
			...
			struct FVUIParameters
			{
				...
				UE_API bool Parse(FBitstreamReaderH265& br, uint32 In_sps_max_sub_layers_minus1);
				void Reset()
				{
			...
			{
				UE_API bool Parse(FBitstreamReaderH265& br);
			...
			struct FStRefPicSet
			{
				UE_API bool Parse(FBitstreamReaderH265& br, int32 stRpsIdx, const TArray<FStRefPicSet>& InReferencePicSetList, int32 InReferencePicSetListNum);
				void Reset()
				{
			...
			struct FPictureParameterSet
			{
				...
				struct FPPSRangeExtension
				{
					...
					bool Parse(FBitstreamReaderH265& br);
					void Reset()
					{
