...
{
public:
	FElectraVideoDecoderH265_Linux(const TMap<FString, FVariant>& InOptions);
...
TSharedPtr<IElectraDecoder, ESPMode::ThreadSafe> IElectraVideoDecoderH265_Linux::Create(const TMap<FString, FVariant>& InOptions)
{
	TSharedPtr<FElectraVideoDecoderH265_Linux, ESPMode::ThreadSafe> New = MakeShared<FElectraVideoDecoderH265_Linux>(InOptions);
	return New;
}

FElectraVideoDecoderH265_Linux::FElectraVideoDecoderH265_Linux(const TMap<FString, FVariant>& InOptions)
{
