...
public:
	...
	/** If true, the specified framerate alignment will be used instead of the media's frame rate. Use this in case the automatic media frame rate is inaccurate. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Media", meta = (InlineEditConditionToggle), AdvancedDisplay)
	bool bManualFrameRateAlignment;

	/** Specify the frame rate for internal presentation frame alignment (i.e. frame duration used for Block On Range calculation). */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Media", meta = (EditCondition = "bManualFrameRateAlignment"), AdvancedDisplay)
	FFrameRate FrameRateAlignment;
