...
public:
	 ...
	 * @param EffectiveURL
	 * @param ETag
	 * @param InResponseHeaders
	 *
	 * @return
	 */
	virtual FErrorDetail BuildFromMPD(TSharedPtrTS<FManifestDASHInternal>& OutMPD, TCHAR* InOutMPDXML, const FString& EffectiveURL, const FString& ETag, const TArray<FElectraHTTPStreamHeader>& InResponseHeaders) = 0;
};
