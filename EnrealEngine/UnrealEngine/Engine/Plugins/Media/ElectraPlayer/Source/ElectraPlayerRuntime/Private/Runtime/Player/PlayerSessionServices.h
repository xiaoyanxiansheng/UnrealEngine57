...
namespace Electra
{
	...
	public:
		...
		/**
		 * Returns the player ABR control interface.
		 */
		virtual IPlayerABRLiveControl* GetPlayerARBControl() = 0;
		...
		/**
		 * Returns the CMCD handler for this player instance.
		 */
		virtual TSharedPtrTS<FCMCDHandler> GetCMCDHandler() = 0;
		...
		/**
		 * Returns the dictionary used in queries via GetMediaInfo().
		 * This is used to expose metadata through the IMediaPlayer interface.
		 */
		virtual FParamDictTS& GetMediaInfoDictionary() = 0;
