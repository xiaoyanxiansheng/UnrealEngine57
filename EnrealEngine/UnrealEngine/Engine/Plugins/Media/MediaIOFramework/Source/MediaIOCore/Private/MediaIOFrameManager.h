...
namespace UE::MediaCaptureData
{
	...
	public:
		...
		/** Whether this frame is used to preroll the output. Preroll frames are only used to create render resources to avoid a startup hitch. */
		bool bPrerollFrame = true;
	};
