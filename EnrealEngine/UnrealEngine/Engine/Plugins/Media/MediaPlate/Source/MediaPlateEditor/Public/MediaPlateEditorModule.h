...
public:
	...
	/**
	 * Delegate called when getting the media plate materials asset paths.
	 * This allows for additional plugins to provide new media plate material templates. 
	 */
	DECLARE_MULTICAST_DELEGATE_OneParam(FOnGetMediaPlateMaterialAssetPaths, TArray<FName>& /*OutAssetPaths*/);
	MEDIAPLATEEDITOR_API FOnGetMediaPlateMaterialAssetPaths& OnGetMediaPlateMaterialAssetPaths();
...
private:
	...
	/** Event Delegate for OnGetMediaPlateMaterialAssetPaths. */
	FOnGetMediaPlateMaterialAssetPaths OnGetMediaPlateMaterialAssetPathsDelegate;
