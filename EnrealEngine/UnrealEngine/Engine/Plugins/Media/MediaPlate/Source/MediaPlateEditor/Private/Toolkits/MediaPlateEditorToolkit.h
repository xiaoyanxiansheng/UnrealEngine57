...
private:
	/** Callback to validate playback button events. */
	bool CanHandleMediaPlateEvent(EMediaPlateEventState InState);

	/** Callback to handle playback button events. */
	void HandleMediaPlateEvent(EMediaPlateEventState InState);
