...
public:
	...
	inline const UTimeSynchronizationSource* GetInputSource() const
	{
		return InputSource;
	}

	inline bool IsInputSourceValid() const
	{
...
private:
	...
	inline static FString SynchronizationStateToString(ESynchronizationState InState)
	{
		switch (InState)
		{
