...
#define RootToCoreContentDir MediaFrameworkUtilitiesStyle::StyleInstance->RootToCoreContentDir
...
void FMediaFrameworkUtilitiesEditorStyle::Register()
{
	...
	MediaFrameworkUtilitiesStyle::StyleInstance->SetCoreContentRoot(FPaths::EngineContentDir() / TEXT("Slate"));
	...
	MediaFrameworkUtilitiesStyle::StyleInstance->Set("ToolbarIcon.Timecode", new IMAGE_BRUSH_SVG("Timecode", MediaFrameworkUtilitiesStyle::Icon16x16));
	MediaFrameworkUtilitiesStyle::StyleInstance->Set("ToolbarIcon.Genlock", new IMAGE_BRUSH_SVG("Genlock", MediaFrameworkUtilitiesStyle::Icon16x16));

	MediaFrameworkUtilitiesStyle::StyleInstance->Set("ToolbarIcon.Refresh", new CORE_IMAGE_BRUSH_SVG("Starship/Common/Update", MediaFrameworkUtilitiesStyle::Icon16x16));
