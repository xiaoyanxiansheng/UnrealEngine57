...
public:
	...
	EElectraTextureSamplePixelEncoding PixelEncoding = EElectraTextureSamplePixelEncoding::Native;
...
FVideoDecoderProResElectra::EConvertResult FVideoDecoderProResElectra::ConvertDecoderOutput()
{
	...
	switch(pixelFormat)
	{
		...
		{
			NewOutput->PixelFormat = EPixelFormat::PF_A16B16G16R16;
			NewOutput->PixelEncoding = EElectraTextureSamplePixelEncoding::YCbCr_Alpha;
			break;
		}
		case kCVPixelFormatType_420YpCbCr8BiPlanarVideoRange:
		case kCVPixelFormatType_420YpCbCr8BiPlanarFullRange:
		{
			NewOutput->PixelFormat = EPixelFormat::PF_NV12;
			NewOutput->PixelEncoding = EElectraTextureSamplePixelEncoding::Native;
			break;
		}
		case kCVPixelFormatType_420YpCbCr10BiPlanarVideoRange:
		case kCVPixelFormatType_420YpCbCr10BiPlanarFullRange:
		{
			NewOutput->PixelFormat = EPixelFormat::PF_P010;
			NewOutput->PixelEncoding = EElectraTextureSamplePixelEncoding::Native;
			break;
		}
		default:
		{
			...
			NewOutput->PixelFormat = EPixelFormat::PF_Unknown;
			NewOutput->PixelEncoding = EElectraTextureSamplePixelEncoding::Native;
		}
	}
