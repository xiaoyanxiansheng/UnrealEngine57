 ...
 */
UCLASS(BlueprintType, hideCategories=(Platforms,Object), PrioritizeCategories=(Blackmagic, Video, Audio, Ancillary, Synchronization, Debug), meta=(MediaIOCustomLayout="Blackmagic"))
...
public:
	...
	/** Assigns a default configuration (The first one in the list of configurations). */
