...
namespace BlackmagicDesign
{
	...
	*****************************************************************************/
	struct BLACKMAGICCORE_API FOutputChannelOptions
	{
		...
		{
			return FormatInfo.FieldDominance == EFieldDominance::Interlaced;
		}
		...
		bool bOutputInterlaceOnEvenFrames;
		bool bLogDropFrames;
		bool bUseGPUDMA;
	...
	*****************************************************************************/
	...
	BLACKMAGICCORE_API bool ShouldCaptureThisFrame(const FChannelInfo& InChannelInfo, ::FTimecode Timecode, uint32 FrameNumber);
