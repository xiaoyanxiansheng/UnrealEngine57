...
namespace BlackmagicDesign
{
	...
	*****************************************************************************/
	FOutputChannelOptions::FOutputChannelOptions()
		...
		, bOutputInterlaceOnEvenFrames(false)
	...
	*****************************************************************************/
	...
	bool ShouldCaptureThisFrame(const FChannelInfo& InChannelInfo, ::FTimecode Timecode, uint32 FrameNumber)
	{
		return Private::FDevice::GetDevice()->ShouldCaptureThisFrame(InChannelInfo, Timecode, FrameNumber);
	}
