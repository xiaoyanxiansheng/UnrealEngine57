...
namespace UE::PixelStreaming2Servers
{
	...
	protected:
		...
		virtual void SendPlayerMessage(uint16 PlayerId, TSharedPtr<FJsonObject> JSONObj, bool bLog = true);
		virtual void SendStreamerMessage(uint16 StreamerId, TSharedPtr<FJsonObject> JSONObj, bool bLog = true);
