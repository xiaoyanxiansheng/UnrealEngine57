...
public:
	...
	jobject GetVideoLastMediaFrameData(int32& CurrentPosition, bool& bRegionChanged);
...
private:
	...
	FJavaClassMethod OpenCameraMethod;
	...
	// interfaces of getting video frame data through ImageReader
	...
	jfieldID FrameUpdateInfo_BRFrameData;
	...
	void UpdateScaleRotationOffset();
