 ...
 */
UCLASS(BlueprintType, hideCategories=(Platforms,Object), PrioritizeCategories=(AJA, Video, Audio, Ancillary, Synchronization, Debug), meta=(MediaIOCustomLayout="AJA"))
...
public:
	...
	bool bStopInputOnCardTimeout = true;
...
public:
	...
	virtual void GetDetailsPanelInfoElements(TArray<TTuple<FText, FText, FText>>& OutInfoElements) const override;
#endif //WITH_EDITOR
