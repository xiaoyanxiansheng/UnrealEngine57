...
protected:
	...
	virtual void PostCaptureCleanupImpl() override;
	virtual bool SupportsStopCapture_Future() const override { return true; }
	virtual TFuture<void> StopCapture_Future() override;
	virtual bool ShouldCaptureRHIResource() const override;
	virtual bool ShouldCaptureThisFrame(const FCaptureBaseData& InBaseData) const override;
