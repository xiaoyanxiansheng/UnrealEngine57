...
public:
	...
	* @param RHICmdList the command list used to create the texture.
	 ...
	 */
	FTextureRHIRef GetOrCreateDestinationTexture(FRHICommandListBase& RHICmdList)
	{
		...
		DestinationTexture = RHICmdList.CreateTexture(Desc);
	...
	* @param RHICmdList the command list used to create the texture.
	 * @return Destination texture
	 */
	FTextureRHIRef GetOrCreateDestinationAlphaTexture(FRHICommandListBase& RHICmdList)
	{
		...
		DestinationAlphaTexture = RHICmdList.CreateTexture(Desc);
