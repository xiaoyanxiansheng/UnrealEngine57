...
public:
	...
	static UE_API FLazyName CustomFormatAttributeName;
	/** Name of attribute in the Exr file for the tile width for our custom format. */
	static UE_API FLazyName CustomFormatTileWidthAttributeName;
	/** Name of attribute in the Exr file for the tile height for our custom format. */
	static UE_API FLazyName CustomFormatTileHeightAttributeName;
	/** Name of attribute in the Exr file for the tile border size for our custom format. */
	static UE_API FLazyName CustomFormatTileBorderAttributeName;

protected:

	/** Holds the global cache. */
	static UE_API TSharedPtr<FImgMediaGlobalCache, ESPMode::ThreadSafe> GlobalCache;
};
