...
public:
	...
	UE_API void AddRectangleShape(FVector2D Position, FVector2D Size);
	UE_API void AddCircleShape(FVector2D Position, FVector2D Size);
	...
	UE_API void Triangulate(TArray<FVector2D>& Target, bool bIncludeBoxes) const;
};
