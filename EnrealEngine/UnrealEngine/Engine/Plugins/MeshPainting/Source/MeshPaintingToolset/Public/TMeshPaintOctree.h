...
struct FMeshPaintTriangleOctreeSemantics
{
	...
	*/
	inline static FBoxCenterAndExtent GetBoundingBox(const FMeshPaintTriangle& Element)
	{
	...
	*/
	inline static bool AreElementsEqual(const FMeshPaintTriangle& A, const FMeshPaintTriangle& B)
	{
		return (A.Index == B.Index);
	}

	/** Ignored for this implementation */
	inline static void SetElementId(const FMeshPaintTriangle& Element, FOctreeElementId2 Id)
	{
