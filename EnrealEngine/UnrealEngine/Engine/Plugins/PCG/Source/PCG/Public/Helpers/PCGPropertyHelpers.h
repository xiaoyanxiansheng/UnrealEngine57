...
namespace PCGPropertyHelpers
{
	...
	*/
	...
	/**
	* More permissive search for a property name in a UserDefinedStruct.
	...
	*/
	const FProperty* FindPropertyInUserDefinedStruct(const UUserDefinedStruct* InStruct, const FName InName);
