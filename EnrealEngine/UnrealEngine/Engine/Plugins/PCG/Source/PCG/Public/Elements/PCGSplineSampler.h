...
struct FPCGSplineSamplerParams
{
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = Settings, meta = (PCG_Overridable, PCG_OverridableChildProperties="ExternalCurve", EditCondition = "Dimension==EPCGSplineSamplingDimension::OnInterior", EditConditionHides))
