...
public:
	...
	PCG_API void RegisterPCGDataVisualization(const TSubclassOf<UPCGData> DataClass, TUniquePtr<const IPCGDataVisualization> Visualization);

	/** Unregister an external PCGData visualization. */
	PCG_API void UnregisterPCGDataVisualization(const TSubclassOf<UPCGData> DataClass);
	...
	PCG_API const IPCGDataVisualization* GetDataVisualization(const TSubclassOf<UPCGData> PCGDataTypeClass) const;
