...
public:
	UPCGClusterSettings(const FObjectInitializer& ObjectInitializer);
...
public:
	...
	/** Cluster IDs will be written to this attribute on the main output. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings, meta = (PCG_Overridable))
	FPCGAttributePropertyOutputNoSourceSelector ClusterAttribute;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings, AdvancedDisplay, meta = (ClampMin = "1", PCG_Overridable))
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings, AdvancedDisplay, meta = (ClampMin = "0.0001", EditCondition = "Algorithm == EPCGClusterAlgorithm::EM", EditConditionHides, PCG_Overridable))
	...
	/** Output the element count for each of the final centroids. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings, AdvancedDisplay, meta = (EditCondition = "bOutputFinalCentroids", EditConditionHides, PCG_Overridable))
	bool bOutputFinalCentroidElementCount = false;

	/** Final centroid element count will be written to this attribute on the Final Centroid output. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings, AdvancedDisplay, meta = (EditCondition = "bOutputFinalCentroidElementCount", EditConditionHides, PCG_Overridable))
	FPCGAttributePropertyOutputNoSourceSelector FinalCentroidElementCountAttribute;
};
