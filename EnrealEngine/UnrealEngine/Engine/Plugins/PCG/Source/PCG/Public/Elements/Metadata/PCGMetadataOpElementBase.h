...
public:
	...
	UE_API virtual FPCGDataTypeIdentifier GetCurrentPinTypesID(const UPCGPin* InPin) const override;
...
public:
	virtual FPCGAttributePropertyInputSelector GetInputSource(uint32 Index) const PURE_VIRTUAL(UPCGMetadataSettingsBase::GetInputSource, return FPCGAttributePropertyInputSelector(); )
...
protected:
	UE_DEPRECATED(5.7, "Use GetInputPinTypeID")
	...
	UE_API FPCGDataTypeIdentifier GetInputPinTypeID(uint32 Index) const;
