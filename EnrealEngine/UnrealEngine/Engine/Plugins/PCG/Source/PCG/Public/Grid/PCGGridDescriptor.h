...
public:
	...
	FPCGGridDescriptor& SetHLODLayer(const TSoftObjectPtr<UHLODLayer>& InHLODLayer) { check(!Hash.IsSet()); HLODLayer = InHLODLayer; return *this; }
	const TSoftObjectPtr<UHLODLayer>& GetHLODLayer() const { return HLODLayer; }
#endif // WITH_EDITOR
