...
ESearchResult ExecuteSearchIteration(const FSearchSettings& SearchSettings, FSearchState& SearchState, TConstArrayView<FPCGPoint> GoalPoints, TArray<FPCGPoint>& OutPath);
}
