...
struct FPCGGPUCompilationContext
{
	...
	const FPCGKernelAttributeTable* GetStaticAttributeTable() { return StaticAttributeTable; }
	void SetStaticAttributeTable(const FPCGKernelAttributeTable* InStaticAttributeTable) { StaticAttributeTable = InStaticAttributeTable; }
...
private:
	...
	/** Attribute table of the currently compiling compute graph. */
	const FPCGKernelAttributeTable* StaticAttributeTable = nullptr;
};
