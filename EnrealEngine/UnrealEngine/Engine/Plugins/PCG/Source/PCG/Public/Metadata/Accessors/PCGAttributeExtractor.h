...
namespace PCGAttributeExtractorConstants
{
	...
	// String
	const FName StringLength = TEXT("Length");
}
...
namespace PCGAttributeExtractor
{
	...
	TUniquePtr<IPCGAttributeAccessor> CreateStringExtractor(TUniquePtr<IPCGAttributeAccessor> InAccessor, FName Name, bool& bOutSuccess);
}
