...
#undef PCG_ALL_TYPES
		...
		*/
		...
		struct MetadataTraits<FString> : DefaultCompareTraits<FString>, DefaultStringTraits<FString>, CompareBasedFindNearestTraits<MetadataTraits<FString>, FString>, DefaultHashTraits<FString>
		{
			...
			static bool Substring(const FString& A, const FString& B, const ESearchCase::Type SearchCase = ESearchCase::IgnoreCase)
			{
				return A.Contains(B, SearchCase);
			}

			static bool Matches(const FString& A, const FString& B, const ESearchCase::Type SearchCase = ESearchCase::IgnoreCase)
			{
				return A.MatchesWildcard(B, SearchCase);
			}
		};
		...
		struct MetadataTraits<FName> : DefaultStringTraits<FName>, CompareBasedFindNearestTraits<MetadataTraits<FName>, FName>, DefaultHashTraits<FName>
		{
			...
			static bool Substring(const FName& A, const FName& B, const ESearchCase::Type SearchCase = ESearchCase::IgnoreCase)
			{
				return A.ToString().Contains(B.ToString(), SearchCase);
			}

			static bool Matches(const FName& A, const FName& B, const ESearchCase::Type SearchCase = ESearchCase::IgnoreCase)
			{
		...
		struct SoftObjectPathTraits : CompareBasedFindNearestTraits<SoftObjectPathTraits<T>, T>
		{
			...
			static bool Substring(const T& A, const T& B, const ESearchCase::Type SearchCase = ESearchCase::IgnoreCase)
			{
				return A.ToString().Contains(B.ToString(), SearchCase);
			}

			static bool Matches(const T& A, const T& B, const ESearchCase::Type SearchCase = ESearchCase::IgnoreCase)
			{
				return A.ToString().MatchesWildcard(B.ToString(), SearchCase);
			}
