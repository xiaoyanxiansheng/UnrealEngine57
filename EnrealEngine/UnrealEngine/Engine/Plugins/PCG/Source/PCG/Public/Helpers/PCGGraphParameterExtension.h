...
template<> 
UE_DEPRECATED(5.7, "This function is not working properly and the non-pointer version should be used instead.")
PCG_API TValueOrError<FSoftObjectPath*, EPropertyBagResult> FPCGGraphParameterExtension::GetGraphParameter(const FInstancedPropertyBag& PropertyBag, const FName PropertyName);

template<> 
UE_DEPRECATED(5.7, "This function is not working properly and the non-pointer version should be used instead.")
PCG_API TValueOrError<FSoftClassPath*, EPropertyBagResult> FPCGGraphParameterExtension::GetGraphParameter(const FInstancedPropertyBag& PropertyBag, const FName PropertyName);
