...
namespace PCGMetadataBooleanSettings
{
	...
	inline bool BinaryOp(const bool& Value1, const bool& Value2, EPCGMetadataBooleanOperation Operation)
	{
		...
		case EPCGMetadataBooleanOperation::Xor:
			return (Value1 != Value2);
		case EPCGMetadataBooleanOperation::Nand:
			return !(Value1 && Value2);
		case EPCGMetadataBooleanOperation::Nor:
			return !(Value1 || Value2);
		case EPCGMetadataBooleanOperation::Xnor:
			return (Value1 == Value2);
		case EPCGMetadataBooleanOperation::Imply:
			return !Value1 || Value2;
		case EPCGMetadataBooleanOperation::Nimply:
			return Value1 && !Value2;
		default:
			return false;
		}
...
bool UPCGMetadataBooleanSettings::IsSupportedInputType(uint16 TypeId, uint32 InputIndex, bool& bHasSpecialRequirement) const
{
	...
	return PCG::Private::IsBroadcastableOrConstructible(TypeId, PCG::Private::MetadataTypes<bool>::Id);
}
