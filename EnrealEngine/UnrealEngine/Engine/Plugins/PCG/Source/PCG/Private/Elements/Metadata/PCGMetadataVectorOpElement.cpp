...
EPCGMetadataTypes UPCGMetadataVectorSettings::GetPinInitialDefaultValueType(const FName PinLabel) const
{
	// Only the angle pin on Rotate Around Axis should be double, otherwise vector.
	return Operation == EPCGMetadataVectorOperation::RotateAroundAxis && PinLabel == PCGMetadataVectorConstants::AngleLabel
