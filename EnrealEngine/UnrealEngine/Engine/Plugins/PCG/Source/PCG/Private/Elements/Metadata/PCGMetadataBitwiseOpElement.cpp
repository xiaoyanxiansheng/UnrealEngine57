...
namespace PCGMetadataBitwiseSettings
{
	...
	inline int64 BinaryOp(const int64& Value1, const int64& Value2, EPCGMetadataBitwiseOperation Operation)
	{
		...
		case EPCGMetadataBitwiseOperation::Xor:
			return (Value1 ^ Value2);
		case EPCGMetadataBitwiseOperation::ShiftLeft:
			return Value1 << Value2;
		case EPCGMetadataBitwiseOperation::ShiftRight:
			return Value1 >> Value2;
		default:
			return 0;
		}
...
{
	const bool bIsShiftOp = Operation == EPCGMetadataBitwiseOperation::ShiftLeft ||
			Operation == EPCGMetadataBitwiseOperation::ShiftRight;
	
	switch (Index)
	{
	case 0:
		return (Operation == EPCGMetadataBitwiseOperation::Not || bIsShiftOp) ? PCGPinConstants::DefaultInputLabel : PCGMetadataSettingsBaseConstants::DoubleInputFirstLabel;
	case 1:
		return bIsShiftOp ? PCGMetadataBitwiseConstants::ShiftInputLabel : PCGMetadataSettingsBaseConstants::DoubleInputSecondLabel;
	default:
		return NAME_None;
	}
}
