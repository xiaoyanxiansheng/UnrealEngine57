...
#include UE_INLINE_GENERATED_CPP_BY_NAME(PCGGetActorProperty)
...
FPCGDataTypeIdentifier UPCGGetActorPropertySettings::GetCurrentPinTypesID(const UPCGPin* InPin) const
{
	check(InPin);
