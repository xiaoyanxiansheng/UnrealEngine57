...
bool FPCGSelectionKey::IsMatching(const UObject* InObject, const UPCGComponent* InComponent) const
{
	...
	return IsMatching(FPCGSelectionKey::CreateFromObjectPtr(InObject), InComponent);
}
...
bool FPCGSelectionKey::IsMatching(const FPCGSelectionKey& InSelectionKey, const UPCGComponent* InComponent) const
{
...
bool FPCGSelectionKey::IsMatching(const UObject* InObject, const TSet<FName>& InRemovedTags, const TSet<UPCGComponent*>& InComponents, TSet<UPCGComponent*>* OptionalMatchedComponents) const
{
	...
	return IsMatching(FPCGSelectionKey::CreateFromObjectPtr(InObject), InRemovedTags, InComponents, OptionalMatchedComponents);
}
