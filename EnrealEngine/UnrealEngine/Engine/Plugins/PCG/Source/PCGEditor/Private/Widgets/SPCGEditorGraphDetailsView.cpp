				...
				[
					...
					[
						...
						.OnClicked_Lambda([PropertyHandle]
						{
							...
							FPCGEditorCommon::Helpers::DispatchEditorToast(Constants::DebugMaterialButtonToastText, Constants::DebugMaterialDensityButtonToastSubText);
					...
					[
						...
						.OnClicked_Lambda([PropertyHandle]
						{
							...
							FPCGEditorCommon::Helpers::DispatchEditorToast(Constants::DebugMaterialButtonToastText, Constants::DebugMaterialColorButtonToastSubText);
