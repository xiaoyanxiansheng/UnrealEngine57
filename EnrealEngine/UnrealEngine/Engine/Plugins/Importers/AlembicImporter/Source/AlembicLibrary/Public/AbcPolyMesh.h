...
{
public:
	UE_API FAbcPolyMesh(const Alembic::AbcGeom::IPolyMesh& InPolyMesh, const FAbcFile* InFile, IAbcObject* InParent = nullptr);
...
protected:
	...
	UE_API void CalculateNormalsForSample(FAbcMeshSample* Sample);
