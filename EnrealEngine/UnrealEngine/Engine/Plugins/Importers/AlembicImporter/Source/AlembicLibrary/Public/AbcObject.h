...
{
public:
	ALEMBICLIBRARY_API IAbcObject(const Alembic::Abc::IObject& InObject, const FAbcFile* InFile, IAbcObject* InParent);
	virtual ~IAbcObject() {}

	const FString& GetName() const { return Name; }
	ALEMBICLIBRARY_API float GetTimeForFrameIndex(const int32 FrameIndex) const;
