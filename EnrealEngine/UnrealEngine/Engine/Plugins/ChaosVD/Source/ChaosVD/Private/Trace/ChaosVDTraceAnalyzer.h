...
public:
	...
	void PushSimulatedSolverTrackForGTData(const UE::Trace::IAnalyzer::FOnEventContext& Context, const UE::Trace::IAnalyzer::FEventData& EventData);
	virtual bool OnEvent(uint16 RouteId, EStyle Style, const FOnEventContext& Context) override;

	FChaosVDTraceAnalysisComplete& OnAnalysisComplete()
	{
		return ChaosVDTraceAnalysisCompleteDelegate;
	}
...
private:
	...
	enum : uint16
	{
		...
		RouteId_ChaosVDRolledBackDataID,
		RouteId_ChaosVDUsesAutoRTFM,
	};
