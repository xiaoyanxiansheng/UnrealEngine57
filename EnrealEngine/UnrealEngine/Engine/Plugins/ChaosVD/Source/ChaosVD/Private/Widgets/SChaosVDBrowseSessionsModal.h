...
public:
	...
	EAppReturnType::Type GetResponse() const
	{
		return UserResponse;
	}
	...
	FString GetSelectedTraceStoreAddress() const
	{
		return CurrentTraceStoreAddress;
	}

	/** Returns the default connection mode to be used when loading the data for the selected session */
	EChaosVDLoadRecordedDataMode GetSelectedConnectionMode() const
	{
...
protected:
	...
	EChaosVDLoadRecordedDataMode ConnectionMode = EChaosVDLoadRecordedDataMode::SingleSource;
