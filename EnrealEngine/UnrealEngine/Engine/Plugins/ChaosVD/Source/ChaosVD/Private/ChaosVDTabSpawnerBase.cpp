...
void FChaosVDTabSpawnerBase::HandleTabSpawned(TSharedRef<SDockTab> InTabSpawned)
{
	OnTabSpawned().Broadcast(InTabSpawned);
	InTabSpawned->SetOnTabClosed(SDockTab::FOnTabClosedCallback::CreateRaw(this, &FChaosVDTabSpawnerBase::HandleTabClosed));
}
