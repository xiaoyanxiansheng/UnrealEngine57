...
void UNeuralMorphModel::PostLoad()
{
	...
	const int32 Version = GetLinkerCustomVersion(UE::MLDeformer::FMLDeformerObjectVersion::GUID);
	if (Version < UE::MLDeformer::FMLDeformerObjectVersion::LODSupportAdded)
	{
