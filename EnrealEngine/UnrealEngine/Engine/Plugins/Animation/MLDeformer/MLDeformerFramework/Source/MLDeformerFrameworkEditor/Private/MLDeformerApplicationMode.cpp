...
namespace UE::MLDeformer
{
		...
		: FApplicationMode(MLDeformerEditorModes::Editor)
	{
		...
		// Hide certain property categories inside the advanced preview scene settings tab.
		FPersonaAdvancedPreviewSceneTabSettings AdvancedPreviewSceneTabSettings;
		AdvancedPreviewSceneTabSettings.bHideAdditionalMeshesCategory = true;
		AdvancedPreviewSceneTabSettings.bHideAnimationCategory = true;
		AdvancedPreviewSceneTabSettings.bHideMeshCategory = true;
		AdvancedPreviewSceneTabSettings.bHidePhysicsCategory = true;
		AdvancedPreviewSceneTabSettings.bHideAnimationBlueprintCategory = true;
		...
		TabFactories.RegisterFactory(PersonaModule.CreateAdvancedPreviewSceneTabFactory(InHostingApp, InPreviewScene, AdvancedPreviewSceneTabSettings));
