...
namespace UE::MLDeformer
{
	...
	public:
		UE_API ~FMLDeformerEditorModelRegistry();
		 ...
		 */
		UE_API void RegisterEditorModel(UClass* ModelType, FOnGetEditorModelInstance Delegate, int32 ModelPriority = 0);
		 ...
		 */
		UE_API void UnregisterEditorModel(const UClass* ModelType);
		 ...
		 */
		UE_API UClass* GetHighestPriorityModel() const;
		 ...
		 */
		UE_API int32 GetPriorityForModel(UClass* ModelType) const;
		 ...
		 */
		UE_API const TMap<UClass*, FOnGetEditorModelInstance>& GetRegisteredModels() const;
		 ...
		 */
		UE_API const TMap<UMLDeformerModel*, FMLDeformerEditorModel*>& GetModelInstances() const;
		 ...
		 */
		UE_API int32 GetHighestPriorityModelIndex() const;
	...
	private:
		 ...
		 */
		UE_API void UpdateHighestPriorityModel();

		/**
		 * Remove a given editor model instance.
		 * @param EditorModel A pointer to the editor model to remove.
		 */
		UE_API void RemoveEditorModelInstance(FMLDeformerEditorModel* EditorModel);
		 ...
		 */
		UE_API FMLDeformerEditorModel* CreateEditorModel(UMLDeformerModel* Model);
