...
namespace UE::MLDeformer
{
	...
	void FDeformerGraphSkeletonWithWeightedQuatsDataProviderProxy::AllocateResources(FRDGBuilder& GraphBuilder, FAllocationData const& InAllocationData)
	{
	...
	void FDeformerGraphSkeletonWithWeightedQuatsDataProviderProxy::CacheRefToLocalQuats(TArray<FQuat4f>& OutRefToLocalQuats) const
	{
		...
		TConstArrayView<FMatrix44f> RefToLocalMatrices = SkeletalMeshObject->GetReferenceToLocalMatrices();
