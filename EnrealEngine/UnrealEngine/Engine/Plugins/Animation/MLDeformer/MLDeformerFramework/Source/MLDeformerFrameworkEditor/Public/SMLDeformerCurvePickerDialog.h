...
namespace UE::MLDeformer
{
	...
	public:
		 ...
		 */
		UE_API const TArray<FName>& GetPickedCurveNames() const;

	private:
		UE_API TSharedRef<SMLDeformerCurvePickerListView> CreateListWidget();
		...
		UE_API void RefreshListElements() const;
