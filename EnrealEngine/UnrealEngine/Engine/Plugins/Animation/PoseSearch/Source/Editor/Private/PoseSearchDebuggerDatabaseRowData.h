...
{
public:
	TWeakObjectPtr<UPoseSearchDatabase> SourceDatabase;
	
	UE_DEPRECATED(5.7, "Use GetNameSafe(SourceDatabase.Get()) instead")
	FString DatabaseName = "";
	UE_DEPRECATED(5.7, "Use GetPathNameSafe(SourceDatabase.Get()) instead")
