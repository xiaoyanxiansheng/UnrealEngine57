...
{
	RegisterCustomPropertyTypeLayout("PoseSearchDatabaseAnimationAsset", FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FPoseSearchDatabaseAnimationAssetCustomization::MakeInstance));
}
