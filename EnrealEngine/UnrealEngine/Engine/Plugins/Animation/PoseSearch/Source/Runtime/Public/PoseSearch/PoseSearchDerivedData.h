...
namespace UE::PoseSearch
{
	...
	{
	public:
		static UE_API EAsyncBuildIndexResult RequestAsyncBuildIndex(const UPoseSearchDatabase* Database, ERequestAsyncBuildFlag Flag);
	...
	{
		UE_API EAsyncBuildIndexResult operator()(const UPoseSearchDatabase* Database, ERequestAsyncBuildFlag RequestAsyncBuildFlag = ERequestAsyncBuildFlag::ContinueRequest);
	private:
		TMap<const UPoseSearchDatabase*, EAsyncBuildIndexResult, TInlineSetAllocator<32>> CachedRequests;
	};
} // namespace UE::PoseSearch
