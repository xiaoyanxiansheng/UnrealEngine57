...
class MockedReader : public Reader {
    public:
        ...
        ArrayView<const std::uint16_t> getJointIndicesForLOD(std::uint16_t lod) const override {
            return {};
        }
        ...
        ArrayView<const std::uint16_t> getBlendShapeChannelIndicesForLOD(std::uint16_t lod) const override {
            return {};
        }
        ...
        ArrayView<const std::uint16_t> getAnimatedMapIndicesForLOD(std::uint16_t lod) const override {
            return {};
        }
        ...
        ArrayView<const std::uint16_t> getMeshBlendShapeChannelMappingIndicesForLOD(std::uint16_t lod) const override {
            return {};
        }

        ArrayView<const std::uint16_t> getMeshIndicesForLOD(std::uint16_t lod) const override {
            return {};
        }
        ...
        ArrayView<const std::uint16_t> getGUIToRawInputIndices() const override {
            return {};
        }

        ArrayView<const std::uint16_t> getGUIToRawOutputIndices() const override {
            return {};
        }
        ...
        ArrayView<const std::uint16_t> getPSDRowIndices() const override {
            return {};
        }

        ArrayView<const std::uint16_t> getPSDColumnIndices() const override {
            return {};
        }
        ...
        ArrayView<const std::uint16_t> getJointVariableAttributeIndices(std::uint16_t lod) const override {
            return {};
        }
        ...
        ArrayView<const std::uint16_t> getJointGroupLODs(std::uint16_t jointGroupIndex) const override {
            return {};
        }

        ArrayView<const std::uint16_t> getJointGroupInputIndices(std::uint16_t jointGroupIndex) const override {
            return {};
        }

        ArrayView<const std::uint16_t> getJointGroupOutputIndices(std::uint16_t jointGroupIndex) const override {
            return {};
        }
        ...
        ArrayView<const std::uint16_t> getJointGroupJointIndices(std::uint16_t jointGroupIndex) const override {
            return {};
        }

        ArrayView<const std::uint16_t> getBlendShapeChannelLODs() const override {
            return {};
        }

        ArrayView<const std::uint16_t> getBlendShapeChannelInputIndices() const override {
            return {};
        }

        ArrayView<const std::uint16_t> getBlendShapeChannelOutputIndices() const override {
            return {};
        }

        ArrayView<const std::uint16_t> getAnimatedMapLODs() const override {
            return {};
        }

        ArrayView<const std::uint16_t> getAnimatedMapInputIndices() const override {
            return {};
        }

        ArrayView<const std::uint16_t> getAnimatedMapOutputIndices() const override {
            return {};
        }
        ...
        ArrayView<const std::uint32_t> getFaceVertexLayoutIndices(std::uint16_t meshIndex,
        ...
        ArrayView<const std::uint32_t> getVertexLayoutPositionIndices(std::uint16_t meshIndex) const override {
            return {};
        }

        ArrayView<const std::uint32_t> getVertexLayoutTextureCoordinateIndices(std::uint16_t meshIndex) const override {
            return {};
        }

        ArrayView<const std::uint32_t> getVertexLayoutNormalIndices(std::uint16_t meshIndex) const override {
            return {};
        }
        ...
        ArrayView<const std::uint16_t> getSkinWeightsJointIndices(std::uint16_t meshIndex,
        ...
        ArrayView<const std::uint32_t> getBlendShapeTargetVertexIndices(std::uint16_t meshIndex,
                                                                        std::uint16_t blendShapeTargetIndex) const override {
            return {};
        }
        ...
        void unload(DataLayer dataLayer) override {
