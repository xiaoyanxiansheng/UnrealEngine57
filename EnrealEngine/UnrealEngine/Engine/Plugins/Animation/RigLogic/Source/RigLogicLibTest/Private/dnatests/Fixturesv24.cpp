...
const unsigned char RawV24::header[] = {
    ...
    0x00, 0x00, 0x0d, 0x7a,  // Machine learned behavior offset
    ...
    0x00, 0x00, 0x10, 0x74,  // RBF behavior offset
    0x00, 0x00, 0x01, 0x47,  // RBF behavior size (327)
    0x6a, 0x62, 0x6d, 0x64,  // Joint behavior metadata id
    0x00, 0x01, 0x00, 0x00,  // Joint behavior metadata version
    0x00, 0x00, 0x11, 0xbb,  // Joint behavior metadata offset
    0x00, 0x00, 0x00, 0x3a,  // Joint behavior metadata size (58)
    0x74, 0x77, 0x73, 0x77,  // Twist swing setups id
    0x00, 0x01, 0x00, 0x00,  // Twist swing setups version
    0x00, 0x00, 0x11, 0xf5,  // Twist swing setups offset
    0x00, 0x00, 0x00, 0xc8  // Twist swing setups size (248)
};

const unsigned char RawV24::descriptor[] = {
...
const unsigned char RawV24::definition[] = {
...
const unsigned char RawV24::conditionals[] {
    // Input indices
...
const unsigned char RawV24::psds[] {
    // Rows
...
const unsigned char RawV24::controls[] = {
    0x00, 0x0c  // PSD count
};

const unsigned char RawV24::joints[] = {
    0x00, 0x51,  // Rows = 81
...
const unsigned char RawV24::blendshapes[] = {
    0x00, 0x00, 0x00, 0x02,  // LOD count
...
const unsigned char RawV24::animatedmaps[] = {
    // LOD sizes
...
const unsigned char RawV24::geometry[] = {
...
const unsigned char RawV24::machineLearnedBehavior[] = {
    0x00, 0x00, 0x00, 0x09,  // Raw control names length
    0x00, 0x00, 0x00, 0x02,  // Raw control name 0 length
...
const unsigned char RawV24::rbfBehavior[] = {
...
const unsigned char RawV24::jointBehaviorMetadata[] = {
...
const unsigned char RawV24::twistSwingBehavior[] = {
...
std::vector<char> RawV24::getBytes() {
...
std::vector<char> RawV23DowngradedFromV24::getBytes() {
    auto bytes = RawV24::getBytes();
    bytes[5] = 0x00;
    bytes[6] = 0x03;
    return bytes;
}
...
#endif
// Descriptor
const pma::String<char> DecodedV24::name = "test";
const Archetype DecodedV24::archetype = Archetype::other;
const Gender DecodedV24::gender = Gender::other;
const std::uint16_t DecodedV24::age = 42u;
const pma::Vector<DecodedV24::StringPair> DecodedV24::metadata = {
    {"key-A", "value-A"},
    {"key-B", "value-B"}
};
const TranslationUnit DecodedV24::translationUnit = TranslationUnit::m;
const RotationUnit DecodedV24::rotationUnit = RotationUnit::radians;
const CoordinateSystem DecodedV24::coordinateSystem = {
    Direction::right,
    Direction::up,
    Direction::front
};
const std::uint16_t DecodedV24::lodCount[] = {
    2u,  // MaxLOD-0 - MinLOD-1
    1u,  // MaxLOD-1 - MinLOD-1
    1u  // MaxLOD-0 - MinLOD-0
};
const std::uint16_t DecodedV24::maxLODs[] = {
    0u,  // MaxLOD-0 - MinLOD-1
    1u,  // MaxLOD-1 - MinLOD-0
    0u  // MaxLOD-0 - MinLOD-0
};
const pma::String<char> DecodedV24::complexity = "A";
const pma::String<char> DecodedV24::dbName = "testDB";

// Definition
const pma::Vector<pma::String<char> > DecodedV24::guiControlNames = {
    "GA", "GB", "GC", "GD", "GE", "GF", "GG", "GH", "GI"
};
const pma::Vector<pma::String<char> > DecodedV24::rawControlNames = {
    "RA", "RB", "RC", "RD", "RE", "RF", "RG", "RH", "RI"
};
const DecodedV24::VectorOfCharStringMatrix DecodedV24::jointNames = {
    {  // MaxLOD-0 - MinLOD-1
...
const DecodedV24::VectorOfCharStringMatrix DecodedV24::blendShapeNames = {
    {  // MaxLOD-0 - MinLOD-1
...
const DecodedV24::VectorOfCharStringMatrix DecodedV24::animatedMapNames = {
    {  // MaxLOD-0 - MinLOD-1
...
const DecodedV24::VectorOfCharStringMatrix DecodedV24::meshNames = {
    {  // MaxLOD-0 - MinLOD-1
        {"MA", "MB"},
        {"MC"}
    },
...
const pma::Vector<pma::Matrix<std::uint16_t> > DecodedV24::meshBlendShapeIndices = {
    {  // MaxLOD-0 - MinLOD-1
        {0, 1, 2, 3, 4, 5, 6},
        {7, 8}
    },
...
const pma::Matrix<std::uint16_t> DecodedV24::jointHierarchy = {
    {  // MaxLOD-0 - MinLOD-1
        {0, 0, 0, 1, 1, 4, 2, 4, 2}
    },
    {  // MaxLOD-1 - MinLOD-1
...
const pma::Vector<pma::Matrix<Vector3> > DecodedV24::neutralJointTranslations = {
    {  // MaxLOD-0 - MinLOD-1
        {
            {1.0f, 1.0f, 1.0f},
            {2.0f, 2.0f, 2.0f},
...
const pma::Vector<pma::Matrix<Vector3> > DecodedV24::neutralJointRotations = {
    {  // MaxLOD-0 - MinLOD-1
        {
            {1.0f, 1.0f, 1.0f},
            {2.0f, 2.0f, 2.0f},
...
// Behavior
const std::uint16_t DecodedV24::guiControlCount = 9u;
const std::uint16_t DecodedV24::rawControlCount = 9u;
const std::uint16_t DecodedV24::psdCount = 12u;
// Behavior->Conditionals
const pma::Vector<pma::Matrix<std::uint16_t> > DecodedV24::conditionalInputIndices = {
    {  // MaxLOD-0 - MinLOD-1
...
const pma::Vector<pma::Matrix<std::uint16_t> > DecodedV24::conditionalOutputIndices = {
    {  // MaxLOD-0 - MinLOD-1
        {0, 1, 1, 2, 3, 3, 4, 4, 4, 5, 6, 7, 7, 8, 8},
        {0, 1, 1, 2, 3, 3},
    },
...
const pma::Vector<pma::Matrix<float> > DecodedV24::conditionalFromValues = {
    {  // MaxLOD-0 - MinLOD-1
...
const pma::Vector<pma::Matrix<float> > DecodedV24::conditionalToValues = {
    {  // MaxLOD-0 - MinLOD-1
...
const pma::Vector<pma::Matrix<float> > DecodedV24::conditionalSlopeValues = {
    {  // MaxLOD-0 - MinLOD-1
...
const pma::Vector<pma::Matrix<float> > DecodedV24::conditionalCutValues = {
    {  // MaxLOD-0 - MinLOD-1
...
// Behavior->PSDs
const pma::Vector<std::uint16_t> DecodedV24::psdRowIndices = {
    8, 8, 8, 9, 9, 10, 10, 10, 11, 12, 13, 13, 13, 14, 14, 15, 16, 18, 18, 18, 18, 19, 19, 20
};
const pma::Vector<std::uint16_t> DecodedV24::psdColumnIndices = {
    0, 3, 6, 2, 5, 2, 3, 7, 3, 2, 0, 1, 2, 3, 6, 0, 4, 0, 3, 4, 5, 6, 7, 2
};
const pma::Vector<float> DecodedV24::psdValues = {
    1.0f, 0.9f, 0.9f, 0.6f, 1.0f, 0.8f, 0.9f, 0.8f, 1.0f, 0.3f, 1.0f, 0.9f, 1.0f, 0.9f, 0.5f, 0.5f, 0.9f, 0.7f, 0.6f, 1.0f, 1.0f,
    1.0f, 0.6f, 1.0f
};
// Behavior->Joints
const pma::Vector<std::uint16_t> DecodedV24::jointRowCount = {
    81u,  // MaxLOD-0 - MinLOD-1
    54u,  // MaxLOD-1 - MinLOD-1
    81u  // MaxLOD-0 - MinLOD-0
};
const std::uint16_t DecodedV24::jointColumnCount = 10u;
const pma::Vector<pma::Matrix<std::uint16_t> > DecodedV24::jointVariableIndices = {
    {  // MaxLOD-0 - MinLOD-1
...
const pma::Vector<pma::Matrix<std::uint16_t> > DecodedV24::jointGroupLODs = {
    {  // Joint Group 0
...
const pma::Vector<pma::Vector<pma::Matrix<std::uint16_t> > > DecodedV24::jointGroupInputIndices = {
    {  // Joint Group 0
        {  // MaxLOD-0 - MaxLOD-1
            {0, 1, 2, 3, 6, 7, 8},
            {0, 1, 2, 3, 6, 7, 8}
...
const pma::Vector<pma::Vector<pma::Matrix<std::uint16_t> > > DecodedV24::jointGroupOutputIndices = {
    {  // Joint Group 0
        {  // MaxLOD-0 - MaxLOD-1
            {2, 3, 5},
            {2, 3, 5}
...
const pma::Vector<pma::Vector<pma::Matrix<float> > > DecodedV24::jointGroupValues = {
    {  // Joint Group 0
        {  // MaxLOD-0 - MaxLOD-1
            {
...
const pma::Vector<pma::Vector<pma::Matrix<std::uint16_t> > > DecodedV24::jointGroupJointIndices = {
    {  // Joint Group 0
        {  // MaxLOD-0 - MaxLOD-1
            {0},
            {0}
...
const pma::Matrix<std::uint16_t> DecodedV24::blendShapeLODs = {
    {
...
const pma::Vector<pma::Matrix<std::uint16_t> > DecodedV24::blendShapeInputIndices = {
    {  // MaxLOD-0 - MaxLOD-1
        {0, 1, 2, 3, 6, 7, 8},
        {0, 1, 2, 3}
    },
...
const pma::Vector<pma::Matrix<std::uint16_t> > DecodedV24::blendShapeOutputIndices = {
    {  // MaxLOD-0 - MaxLOD-1
        {0, 1, 2, 3, 6, 7, 8},
        {0, 1, 2, 3}
    },
...
const pma::Vector<std::uint16_t> DecodedV24::animatedMapCount = {
    10,  // MaxLOD-0 - MaxLOD-1
    4,  // MaxLOD-1 - MinLOD-1
    10  // MaxLOD-0 - MinLOD-0
};
const pma::Matrix<std::uint16_t> DecodedV24::animatedMapLODs = {
    {
...
// Geometry
const pma::Vector<std::uint32_t> DecodedV24::meshCount = {
    3u,  // MaxLOD-0 - MaxLOD-1
    1u,  // MaxLOD-1 - MinLOD-1
    2u  // MaxLOD-0 - MinLOD-0
};
const pma::Vector<pma::Matrix<Vector3> > DecodedV24::vertexPositions = {
    {  // MaxLOD-0 - MaxLOD-1
        {  // Mesh-0
            {7.0f, 7.0f, 7.0f},
            {8.0f, 8.0f, 8.0f},
...
const pma::Vector<pma::Matrix<TextureCoordinate> > DecodedV24::vertexTextureCoordinates = {
    {  // MaxLOD-0 - MaxLOD-1
        {  // Mesh-0
            {7.0f, 7.0f},
            {8.0f, 8.0f},
...
const pma::Vector<pma::Matrix<Vector3> > DecodedV24::vertexNormals = {
    {  // MaxLOD-0 - MaxLOD-1
        {  // Mesh-0
            {7.0f, 7.0f, 7.0f},
            {8.0f, 8.0f, 8.0f},
...
const pma::Vector<pma::Matrix<VertexLayout> > DecodedV24::vertexLayouts = {
    {  // MaxLOD-0 - MaxLOD-1
        {  // Mesh-0
            {0, 0, 0},
            {1, 1, 1},
...
const pma::Matrix<pma::Matrix<std::uint32_t> > DecodedV24::faces = {
    {  // MaxLOD-0 - MaxLOD-1
        {  // Mesh-0
            {0, 1, 2}
        },
...
const pma::Matrix<std::uint16_t> DecodedV24::maxInfluencePerVertex = {
    {  // MaxLOD-0 - MaxLOD-1
        8u,  // Mesh-0
        8u,  // Mesh-1
        8u  // Mesh-2
...
const pma::Matrix<pma::Matrix<float> > DecodedV24::skinWeightsValues = {
    {  // MaxLOD-0 - MinLOD-1
        {  // Mesh-0
            {0.7f, 0.1f, 0.2f},
            {0.5f, 0.5f},
...
const pma::Matrix<pma::Matrix<std::uint16_t> > DecodedV24::skinWeightsJointIndices = {
    {  // MaxLOD-0 - MaxLOD-1
        {  // Mesh-0
            {0, 1, 2},
            {3, 4},
...
const pma::Vector<pma::Matrix<std::uint16_t> > DecodedV24::correctiveBlendShapeIndices = {
    {  // MaxLOD-0 - MaxLOD-1
        {  // Mesh-0
            2
        },
...
const pma::Matrix<pma::Matrix<Vector3> > DecodedV24::correctiveBlendShapeDeltas = {
    {  // MaxLOD-0 - MaxLOD-1
        {  // Mesh-0
            {  // Blendshape-0
                {7.0f, 7.0f, 7.0f},
...
const pma::Matrix<pma::Matrix<std::uint32_t> > DecodedV24::correctiveBlendShapeVertexIndices = {
    {  // MaxLOD-0 - MaxLOD-1
        {  // Mesh-0
            {0, 1, 2},  // Blendshape-0
        },
...
// Machine learned behavior
const pma::Vector<pma::String<char> > DecodedV24::mlControlNames = {
    "MA", "MB", "MC", "MD", "ME", "MF", "MG", "MH", "MI"
};
const pma::Matrix<std::uint16_t>  DecodedV24::neuralNetworkIndicesPerLOD = {
    {  // MaxLOD-0 - MaxLOD-1
        0,  // Mesh-0 Region-0
        1,  // Mesh-0 Region-1
        2,  // Mesh-1 Region-0
...
const DecodedV24::VectorOfCharStringMatrix DecodedV24::regionNames = {
    {  // MaxLOD-0 - MinLOD-1
        {  // Mesh-0
            "RA", "RB"
        },
...
const pma::Matrix<pma::Matrix<std::uint16_t> > DecodedV24::neuralNetworkIndicesPerMeshRegion = {
    {  // MaxLOD-0 - MaxLOD-1
        {  // Mesh-0
            {  // Region-0
                0
...
const pma::Vector<pma::Matrix<std::uint16_t> > DecodedV24::neuralNetworkInputIndices = {
    {  // MaxLOD-0 - MaxLOD-1
        {  // Mesh-0 Region-0
            0, 1
        },
...
const pma::Vector<pma::Matrix<std::uint16_t> > DecodedV24::neuralNetworkOutputIndices = {
    {  // MaxLOD-0 - MaxLOD-1
        {  // Mesh-0 Region-0
            9
        },
...
const pma::Matrix<std::uint16_t> DecodedV24::neuralNetworkLayerCount = {
    {  // MaxLOD-0 - MaxLOD-1
        2,  // Mesh-0 Region-0
        2,  // Mesh-0 Region-1
        2,  // Mesh-1 Region-0
...
const pma::Vector<pma::Matrix<std::uint16_t> > DecodedV24::neuralNetworkActivationFunction = {
    {  // MaxLOD-0 - MaxLOD-1
        {  // Mesh-0 Region-0
            1, 1
        },
...
const pma::Matrix<pma::Matrix<float> > DecodedV24::neuralNetworkActivationFunctionParameters = {
    {  // MaxLOD-0 - MaxLOD-1
        {  // Mesh-0  Region-0
            {0.5f},  // Layer-0
            {0.5f}  // Layer-1
...
const pma::Matrix<pma::Matrix<float> > DecodedV24::neuralNetworkBiases = {
    {  // MaxLOD-0 - MaxLOD-1
        {  // Mesh-0 Region-0
            {1.0f, 1.0f},  // Layer-0
            {1.0f}  // Layer-1
...
const pma::Matrix<pma::Matrix<float> > DecodedV24::neuralNetworkWeights = {
    {  // MaxLOD-0 - MaxLOD-1
        {  // Mesh-0 Region-0
...
const pma::Matrix<std::uint16_t> DecodedV24::solverIndicesPerLOD {
    {  // MaxLOD-0 - MinLOD-1
        0,
        1,
        2
...
const pma::Vector<pma::String<char> > DecodedV24::solverNames {
    "RSA", "RSB", "RSC"
};

const pma::Matrix<std::uint16_t> DecodedV24::solverRawControlIndices {
    // Solver 0
    {11, 12},
    // Solver 1
    {3},
...
const pma::Matrix<std::uint16_t> DecodedV24::solverPoseIndices {
    // Solver 0
    {0, 1, 2},
    // Solver 1
    {3, 4},
...
const pma::Vector<float> DecodedV24::solverRadius {
    1.0f, 2.0f, 1.0f
};

const pma::Vector<float> DecodedV24::solverWeightThreshold {
    1.0f, 2.0f, 1.0f
};

const pma::Vector<std::uint16_t> DecodedV24::solverType {
    0, 1, 0
};

const pma::Vector<std::uint16_t> DecodedV24::solverAutomaticRadius {
    0, 0, 0
};

const pma::Vector<std::uint16_t> DecodedV24::solverDistanceMethod {
    1, 3, 1
};

const pma::Vector<std::uint16_t> DecodedV24::solverNormalizeMethod {
    0, 1, 0
};

const pma::Vector<std::uint16_t> DecodedV24::solverFunctionType {
    2, 2, 0
};

const pma::Vector<std::uint16_t> DecodedV24::solverTwistAxis {
    0, 1, 0
};

const pma::Vector<pma::String<char> > DecodedV24::poseNames {
    "RA", "RB", "RC", "RD", "RE", "RF", "RG", "RH"
};

const Vector<float> DecodedV24::poseScale {
    0.0f,  // Pose 0 (RA)
    1.0f,  // Pose 1 (RB)
    2.0f,  // Pose 2 (RC)
    2.0f,  // Pose 3 (RD)
...
const pma::Vector<std::uint16_t> DecodedV24::poseDistanceMethod {
    0,  // Pose 0 (RA)
    1,  // Pose 1 (RB)
    2,  // Pose 2 (RC)
    3,  // Pose 0 (RD)
...
const pma::Vector<std::uint16_t> DecodedV24::poseFunctionType {
    5,  // Pose 0 (RA)
    4,  // Pose 1 (RB)
    3,  // Pose 2 (RC)
    2,  // Pose 3 (RD)
...
const Matrix<float> DecodedV24::solverRawControlValues {
    {  // Solver 0
        // Pose 0 (RA)
...
const pma::Matrix<TranslationRepresentation> DecodedV24::jointTranslationRepresentation = {
    {  // MaxLOD-0 - MinLOD-1
...
const pma::Matrix<RotationRepresentation> DecodedV24::jointRotationRepresentation = {
    {  // MaxLOD-0 - MinLOD-1
...
const pma::Matrix<ScaleRepresentation> DecodedV24::jointScaleRepresentation = {
    {  // MaxLOD-0 - MinLOD-1
...
const pma::Vector<pma::Matrix<float> > DecodedV24::swingBlendWeights = {
    {  // MaxLOD-0 - MinLOD-1
        {1.0f, 2.0f},
        {-2.0f, -1.0f},
        {1.0f}
...
const pma::Vector<pma::Matrix<std::uint16_t> > DecodedV24::swingOutputJointIndices = {
    {  // MaxLOD-0 - MinLOD-1
        {0u, 1u},
        {4u, 6u},
        {5u}
...
const pma::Vector<pma::Matrix<std::uint16_t> > DecodedV24::swingInputControlIndices = {
    {  // MaxLOD-0 - MinLOD-1
        {5u, 6u, 7u, 8u},
        {11u, 12u, 13u, 14u},
        {27u, 28u, 29u, 30u}
...
const pma::Matrix<TwistAxis> DecodedV24::swingTwistAxes = {
    {  // MaxLOD-0 - MinLOD-1
        TwistAxis::X,
        TwistAxis::Y,
        TwistAxis::Z
...
const pma::Vector<pma::Matrix<float> > DecodedV24::twistBlendWeights = {
    {  // MaxLOD-0 - MinLOD-1
        {1.0f, 2.0f},
        {-2.0f, -1.0f},
        {1.0f}
...
const pma::Vector<pma::Matrix<std::uint16_t> > DecodedV24::twistOutputJointIndices = {
    {  // MaxLOD-0 - MinLOD-1
        {0u, 1u},
        {4u, 6u},
        {5u}
...
const pma::Vector<pma::Matrix<std::uint16_t> > DecodedV24::twistInputControlIndices = {
    {  // MaxLOD-0 - MinLOD-1
        {5u, 6u, 7u, 8u},
        {11u, 12u, 13u, 14u},
        {27u, 28u, 29u, 30u}
...
const pma::Matrix<TwistAxis> DecodedV24::twistTwistAxes = {
    {  // MaxLOD-0 - MinLOD-1
        TwistAxis::X,
        TwistAxis::Y,
        TwistAxis::Z
...
std::size_t DecodedV24::lodConstraintToIndex(std::uint16_t maxLOD, std::uint16_t minLOD) {
    // Relies on having only TWO available LODs (0, 1)
    return (minLOD == 1u ? maxLOD : 2ul);
}

RawJoints DecodedV24::getJoints(std::uint16_t currentMaxLOD, std::uint16_t currentMinLOD, pma::MemoryResource* memRes) {
...
RawBlendShapeChannels DecodedV24::getBlendShapes(std::uint16_t currentMaxLOD,
...
RawConditionalTable DecodedV24::getConditionals(std::uint16_t currentMaxLOD,
                                                std::uint16_t currentMinLOD,
                                                pma::MemoryResource* memRes) {
...
RawAnimatedMaps DecodedV24::getAnimatedMaps(std::uint16_t currentMaxLOD, std::uint16_t currentMinLOD,
                                            pma::MemoryResource* memRes) {
