...
USkeletalMeshGizmoWrapperBase* USkeletalMeshGizmoContextObject::GetNewWrapper(UInteractiveToolManager* InToolManager, UObject* Outer, IGizmoStateTarget* InStateTarget, const TScriptInterface<ITransformGizmoSource>& GizmoSource)
{
	...
	Gizmo->TransformGizmoSource = GizmoSource;
