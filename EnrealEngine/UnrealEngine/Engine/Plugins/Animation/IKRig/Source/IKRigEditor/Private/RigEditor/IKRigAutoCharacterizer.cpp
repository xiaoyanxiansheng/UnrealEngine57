...
// core
const FName FCharacterizationStandard::Root("Root");
const FName FCharacterizationStandard::Spine("Spine");
const FName FCharacterizationStandard::Neck("Neck");
const FName FCharacterizationStandard::Head("Head");
const FName FCharacterizationStandard::Tail("Tail");
// legs
const FName FCharacterizationStandard::LeftLeg("LeftLeg");
const FName FCharacterizationStandard::RightLeg("RightLeg");
// arms
const FName FCharacterizationStandard::LeftClavicle("LeftClavicle");
const FName FCharacterizationStandard::RightClavicle("RightClavicle");
const FName FCharacterizationStandard::LeftArm("LeftArm");
const FName FCharacterizationStandard::RightArm("RightArm");
// left hand
const FName FCharacterizationStandard::LeftThumbMetacarpal("LeftThumbMetacarpal");
const FName FCharacterizationStandard::LeftIndexMetacarpal("LeftIndexMetacarpal");
const FName FCharacterizationStandard::LeftMiddleMetacarpal("LeftMiddleMetacarpal");
const FName FCharacterizationStandard::LeftRingMetacarpal("LeftRingMetacarpal");
const FName FCharacterizationStandard::LeftPinkyMetacarpal("LeftPinkyMetacarpal");
const FName FCharacterizationStandard::LeftThumb("LeftThumb");
const FName FCharacterizationStandard::LeftIndex("LeftIndex");
const FName FCharacterizationStandard::LeftMiddle("LeftMiddle");
const FName FCharacterizationStandard::LeftRing("LeftRing");
const FName FCharacterizationStandard::LeftPinky("LeftPinky");
// right hand
const FName FCharacterizationStandard::RightThumbMetacarpal("RightThumbMetacarpal");
const FName FCharacterizationStandard::RightIndexMetacarpal("RightIndexMetacarpal");
const FName FCharacterizationStandard::RightMiddleMetacarpal("RightMiddleMetacarpal");
const FName FCharacterizationStandard::RightRingMetacarpal("RightRingMetacarpal");
const FName FCharacterizationStandard::RightPinkyMetacarpal("RightPinkyMetacarpal");
const FName FCharacterizationStandard::RightThumb("RightThumb");
const FName FCharacterizationStandard::RightIndex("RightIndex");
const FName FCharacterizationStandard::RightMiddle("RightMiddle");
const FName FCharacterizationStandard::RightRing("RightRing");
const FName FCharacterizationStandard::RightPinky("RightPinky");
// left foot
const FName FCharacterizationStandard::LeftBigToe("LeftBigToe");
const FName FCharacterizationStandard::LeftIndexToe("LeftIndexToe");
const FName FCharacterizationStandard::LeftMiddleToe("LeftMiddleToe");
const FName FCharacterizationStandard::LeftRingToe("LeftRingToe");
const FName FCharacterizationStandard::LeftPinkyToe("LeftPinkyToe");
// right foot
const FName FCharacterizationStandard::RightBigToe("RightBigToe");
const FName FCharacterizationStandard::RightIndexToe("RightIndexToe");
const FName FCharacterizationStandard::RightMiddleToe("RightMiddleToe");
const FName FCharacterizationStandard::RightRingToe("RightRingToe");
const FName FCharacterizationStandard::RightPinkyToe("RightPinkyToe");
// ik goal names
const FName FCharacterizationStandard::LeftHandIKGoal("LeftHandIK");
const FName FCharacterizationStandard::LeftFootIKGoal("LeftFootIK");
const FName FCharacterizationStandard::RightHandIKGoal("RightHandIK");
const FName FCharacterizationStandard::RightFootIKGoal("RightFootIK");

// extra limbs for creatures
const FName FCharacterizationStandard::LeftLegA("LeftLegA");
const FName FCharacterizationStandard::LeftLegB("LeftLegB");
const FName FCharacterizationStandard::LeftLegC("LeftLegC");
const FName FCharacterizationStandard::RightLegA("RightLegA");
const FName FCharacterizationStandard::RightLegB("RightLegB");
const FName FCharacterizationStandard::RightLegC("RightLegC");
//
const FName FCharacterizationStandard::LeftFootAIKGoal("LeftFootAIKGoal");
const FName FCharacterizationStandard::LeftFootBIKGoal("LeftFootBIKGoal");
const FName FCharacterizationStandard::LeftFootCIKGoal("LeftFootCIKGoal");
const FName FCharacterizationStandard::RightFootAIKGoal("RightFootAIKGoal");
const FName FCharacterizationStandard::RightFootBIKGoal("RightFootBIKGoal");
const FName FCharacterizationStandard::RightFootCIKGoal("RightFootCIKGoal");
	...
	float& OutPercentOfTemplateMatched) const
{
	...
	const float NumBonesTotal = static_cast<float>(CleanBoneNames.Num());
	const float NumMatchingBones = NumBonesTotal - static_cast<float>(OutMissingBones.Num());
	const float NumMatchingParents = NumBonesTotal - static_cast<float>(OutBonesWithDifferentParent.Num());
...
FKnownTemplateHierarchies::FKnownTemplateHierarchies()
{
	...
	// UE4 Mannequin
	[this]() // This is to fix compile times (msvc toolchain)
	{
	...
	FAutoCharacterizeResults& Results) const
{
	...
	// adapt the pelvis bone
	const int32 PelvisBoneIndex = TargetHierarchy.GetBoneIndex(Template.AutoRetargetDefinition.RetargetDefinition.RootBone, ECleanOrFullName::Clean);
	if (PelvisBoneIndex != INDEX_NONE)
	{
		// convert to the full, non-clean name to use for the actual bone chain
		const FName PelvisBoneName =  TargetHierarchy.GetBoneName(PelvisBoneIndex, ECleanOrFullName::Full);
		Results.AutoRetargetDefinition.RetargetDefinition.RootBone = PelvisBoneName;
	}
	...
	float& OutBestScore) const
{
	...
	for (const FName BoneName : NamesToCheck)
	{
		...
		float WorstCase = static_cast<float>(NameToMatchStr.Len() + CurrentNameStr.Len());
		WorstCase = WorstCase < 1.0f ? 1.0f : WorstCase;
		const float Score = 1.0f - (static_cast<float>(Algo::LevenshteinDistance(NameToMatchStr, CurrentNameStr)) / WorstCase);
