...
void FIKRigEditor::StartupModule()
{
	...
	PropertyEditorModule.RegisterCustomPropertyTypeLayout(
			...
			FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FStretchChainOpCustomization::MakeInstance));
	PropertyEditorModule.RegisterCustomPropertyTypeLayout(
			"IKRetargetFloorConstraintOpSettings",
			FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FFloorConstraintOpCustomization::MakeInstance));
