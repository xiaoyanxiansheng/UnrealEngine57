...
public:
	...
	DECLARE_TS_MULTICAST_DELEGATE_ThreeParams(FOnSubjectOutboundNameModified, const FLiveLinkSubjectKey& /*Key*/, const FString& /*PreviousOutboundName*/, const FString& /*OutboundName*/);
	/** (Internal use) Delegate called by LiveLinkHubSubjectSettings to notify. */
	virtual FOnSubjectOutboundNameModified& OnSubjectOutboundNameModified() = 0;
public:
