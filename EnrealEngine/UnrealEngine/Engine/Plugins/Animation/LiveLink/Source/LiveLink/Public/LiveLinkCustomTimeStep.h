...
public:
	...
	LIVELINK_API virtual FString GetDisplayName() const override;
	...
	LIVELINK_API virtual uint32 GetExpectedSyncCountDelta() const override;

	//~ Begin UObject Interface
	LIVELINK_API virtual void BeginDestroy() override;
#if WITH_EDITOR
