 ...
 */
UCLASS(MinimalAPI, meta = (DisplayName = "Transform Axis Switch"))
 ...
 * @note This implies that translation, rotation and scale will be affected by switching an axis.
 */
UCLASS(MinimalAPI, meta = (DisplayName = "Locator Axis Switch"))
class ULiveLinkLocatorAxisSwitchPreProcessor : public ULiveLinkTransformAxisSwitchPreProcessor
{
	GENERATED_BODY()

public:
	class FLiveLinkLocatorAxisSwitchPreProcessorWorker : public ULiveLinkTransformAxisSwitchPreProcessor::FLiveLinkTransformAxisSwitchPreProcessorWorker
	{
	public:
		virtual TSubclassOf<ULiveLinkRole> GetRole() const override;
		virtual bool PreProcessFrame(FLiveLinkFrameDataStruct& InOutFrame) const override;
