...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "LiveLink")
	static UE_API FText GetSourceTypeFromGuid(FGuid SourceGuid);
	
	/** Get a list of all enabled subject names */
	UFUNCTION(BlueprintCallable, Category = "LiveLink")
	static UE_API TArray<FLiveLinkSubjectName> GetLiveLinkEnabledSubjectNames(bool bIncludeVirtualSubject);

	/** Get a list of all subjects */
	UFUNCTION(BlueprintCallable, Category = "LiveLink")
	static UE_API TArray<FLiveLinkSubjectKey> GetLiveLinkSubjects(bool bIncludeDisabledSubject, bool bIncludeVirtualSubject);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "LiveLink")
	static UE_API bool IsSpecificLiveLinkSubjectEnabled(const FLiveLinkSubjectKey SubjectKey, bool bForThisFrame);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "LiveLink")
	static UE_API bool IsLiveLinkSubjectEnabled(const FLiveLinkSubjectName SubjectName);

	/**
	 * Returns the state of the subject with the given name.
	 */
	UFUNCTION(BlueprintCallable, Category = "LiveLink")
	static UE_API ELiveLinkSubjectState GetLiveLinkSubjectState(const FLiveLinkSubjectName SubjectName);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "LiveLink")
	static UE_API void SetLiveLinkSubjectEnabled(const FLiveLinkSubjectKey SubjectKey, bool bEnabled);

	/** Get the role of a subject from a specific source */
	UFUNCTION(BlueprintCallable, Category = "LiveLink")
	static UE_API TSubclassOf<ULiveLinkRole> GetSpecificLiveLinkSubjectRole(const FLiveLinkSubjectKey SubjectKey);

	/** Get the role of the subject with this name */
	UFUNCTION(BlueprintCallable, Category = "LiveLink")
	static UE_API TSubclassOf<ULiveLinkRole> GetLiveLinkSubjectRole(const FLiveLinkSubjectName SubjectName);

	/** Pause a subject, freezing its evaluation to the last data it received. */
	UFUNCTION(BlueprintCallable, Category = "LiveLink")
	static UE_API void PauseSubject(const FLiveLinkSubjectName SubjectName);
	
	/** Unpause a subject, resuming its normal operation. */
	UFUNCTION(BlueprintCallable, Category = "LiveLink")
	static UE_API void UnpauseSubject(const FLiveLinkSubjectName SubjectName);
	...
	static UE_API bool EvaluateLiveLinkFrame(FLiveLinkSubjectRepresentation SubjectRepresentation, FLiveLinkBaseBlueprintData& OutBlueprintData);
	...
	static UE_API bool EvaluateLiveLinkFrameWithSpecificRole(FLiveLinkSubjectName SubjectName, TSubclassOf<ULiveLinkRole> Role, FLiveLinkBaseBlueprintData& OutBlueprintData);
	...
	static UE_API bool EvaluateLiveLinkFrameAtWorldTimeOffset(FLiveLinkSubjectName SubjectName, TSubclassOf<ULiveLinkRole> Role, float WorldTimeOffset, FLiveLinkBaseBlueprintData& OutBlueprintData);
	...
	UFUNCTION(BlueprintCallable, CustomThunk, Category = LiveLink, meta = (CustomStructureParam = "OutBlueprintData", BlueprintInternalUseOnly = "true", AllowAbstract = "false"))
	static UE_API bool EvaluateLiveLinkFrameAtSceneTime(FLiveLinkSubjectName SubjectName, TSubclassOf<ULiveLinkRole> Role, FTimecode SceneTime, FLiveLinkBaseBlueprintData& OutBlueprintData);
