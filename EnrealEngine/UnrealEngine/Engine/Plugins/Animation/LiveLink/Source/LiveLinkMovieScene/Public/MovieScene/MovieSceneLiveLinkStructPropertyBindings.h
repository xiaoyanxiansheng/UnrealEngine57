...
{
public:
	UE_API FLiveLinkStructPropertyBindings(FName InPropertyName, const FString& InPropertyPath);
	 ...
	 */
	UE_API void CacheBinding(const UScriptStruct& InStruct);
	 ...
	 */
	UE_API FProperty* GetProperty(const UScriptStruct& InStruct) const;
	 ...
	 * @return ValueType	The current value
	 */
	UE_API int64 GetCurrentValueForEnumAt(int32 InIndex, const UScriptStruct& InStruct, const void* InSourceAddress);
	 ...
	 * @param InValue   The value to set
	 */
	UE_API void SetCurrentValueForEnumAt(int32 InIndex, const UScriptStruct& InStruct, void* InSourceAddress, int64 InValue);
...
private:
	...
	static UE_API FPropertyWrapper FindPropertyRecursive(const UScriptStruct* InStruct, TArray<FString>& InPropertyNames, uint32 Index, void* ContainerAddress, int32 PreviousDelta);
	static UE_API FPropertyWrapper FindProperty(const UScriptStruct& InStruct, const FString& InPropertyName);
...
private:
	...
	static UE_API TMap<FPropertyNameKey, FPropertyWrapper> PropertyCache;
