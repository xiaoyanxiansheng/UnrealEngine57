...
DECLARE_DELEGATE_OneParam(FModalSessionNameListSelected, TSharedPtr<FName>)

/** Widget that takes a list of String Views and creates a drop down menu for it for the Chaos Visual Debugger Tool.
 */
class SModalSessionNameListPicker : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SModalSessionNameListPicker){}
	SLATE_EVENT(FModalSessionNameListSelected, OnNameSleceted)
	SLATE_END_ARGS()
...
protected:
	...
	FModalSessionNameListSelected NameSelectedDelegate;
};
