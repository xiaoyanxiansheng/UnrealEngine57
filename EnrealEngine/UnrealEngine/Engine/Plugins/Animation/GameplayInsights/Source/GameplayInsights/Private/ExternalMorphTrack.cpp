...
namespace RewindDebugger
{
	...
	TConstArrayView<TSharedPtr<FRewindDebuggerTrack>> FExternalMorphSetGroupTrack::GetChildrenInternal(TArray<TSharedPtr<FRewindDebuggerTrack>>& OutTracks) const
	{
	...
	TConstArrayView<TSharedPtr<FRewindDebuggerTrack>> FExternalMorphSetTrack::GetChildrenInternal(TArray<TSharedPtr<FRewindDebuggerTrack>>& OutTracks) const
	{
		return MakeConstArrayView<TSharedPtr<FRewindDebuggerTrack>>(reinterpret_cast<const TSharedPtr<FRewindDebuggerTrack>*>(Children.GetData()), Children.Num());
	}
	...
	TSharedPtr<RewindDebugger::FRewindDebuggerTrack> FExternalMorphSetGroupTrackCreator::CreateTrackInternal(const FObjectId& InObjectId) const
	{
		return MakeShared<RewindDebugger::FExternalMorphSetGroupTrack>(InObjectId.GetMainId());
	}

	bool FExternalMorphSetGroupTrackCreator::HasDebugInfoInternal(const FObjectId& InObjectId) const
	{
		...
		{
			return AnimationProvider->HasExternalMorphSets(InObjectId.GetMainId());
		}
		return false;
	}
}
