...
#define UE_API GAMEPLAYINSIGHTS_API
...
protected:
	...
	UE_API int32 PaintCurve(const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FWidgetStyle& InWidgetStyle, bool bParentEnabled ) const;
	UE_API void UpdateCurveToolTip(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent);
