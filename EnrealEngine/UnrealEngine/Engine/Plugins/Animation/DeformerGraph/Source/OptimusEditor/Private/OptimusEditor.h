...
public:
	...
	// @TODO: Remove below if above gets removed
	TSharedPtr<SFindInDeformer> GetFindResultsWidget() const { return FindResults; }
...
private:
	...
	TSharedPtr<SFindInDeformer> FindResults;
