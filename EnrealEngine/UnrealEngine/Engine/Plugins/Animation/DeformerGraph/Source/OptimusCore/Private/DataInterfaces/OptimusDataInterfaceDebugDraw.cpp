...
{
	return new FOptimusDebugDrawDataProviderProxy(PrimitiveComponent.Get(), DebugDrawParameters);
}
...
void FOptimusDebugDrawDataProviderProxy::AllocateResources(FRDGBuilder& GraphBuilder, FAllocationData const& InAllocationData)
{
