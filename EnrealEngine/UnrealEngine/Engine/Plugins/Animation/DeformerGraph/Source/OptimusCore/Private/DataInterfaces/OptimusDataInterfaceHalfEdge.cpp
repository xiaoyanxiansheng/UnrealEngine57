...
FComputeDataProviderRenderProxy* UOptimusHalfEdgeDataProvider::GetRenderProxy()
{
	...
	return new FOptimusHalfEdgeDataProviderProxy(SkinnedMesh.Get(), OnDemandHalfEdgeBuffers);
}
...
void FOptimusHalfEdgeDataProviderProxy::AllocateResources(FRDGBuilder& GraphBuilder, FAllocationData const& InAllocationData)
{
