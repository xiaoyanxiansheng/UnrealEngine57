...
{
	return new FOptimusConnectivityDataProviderProxy(SkinnedMesh.Get(), AdjacencyBufferPerLod);
}
...
void FOptimusConnectivityDataProviderProxy::AllocateResources(FRDGBuilder& GraphBuilder, FAllocationData const& InAllocationData)
{
