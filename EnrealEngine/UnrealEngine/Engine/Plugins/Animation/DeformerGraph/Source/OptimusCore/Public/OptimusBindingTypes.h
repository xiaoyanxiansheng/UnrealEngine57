...
struct FOptimusParameterBindingArray
{
	...
	inline	TArray<FOptimusParameterBinding>::RangedForIteratorType      begin()       { return InnerArray.begin(); }
	inline	TArray<FOptimusParameterBinding>::RangedForConstIteratorType begin() const { return InnerArray.begin(); }
	inline	TArray<FOptimusParameterBinding>::RangedForIteratorType      end()         { return InnerArray.end();   }
	inline	TArray<FOptimusParameterBinding>::RangedForConstIteratorType end() const   { return InnerArray.end();   }
};
