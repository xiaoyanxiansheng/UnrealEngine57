...
public:
	...
	virtual FString GetKernelSourceText(bool bInIsUnifiedDispatch) const PURE_VIRTUAL(UOptimusNode_ComputeKernelBase::GetKernelSourceText, return FString();)
...
protected:
	...
	static const TCHAR* GetNumThreadsReservedName();
	
private:
	TOptional<FText> BindKernelDataInterfaceForComputeKernel(
	...
	TOptional<FText> ProcessOutputPinForComputeKernel(
	bool bSupportUnifiedDispatchOnly,
		const FOptimusPinTraversalContext& InTraversalContext,
