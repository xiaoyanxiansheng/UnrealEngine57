...
struct FControlRigSpaceChannelHelpers
{
	...
	static void CompensateIfNeeded(UControlRig* ControlRig, ISequencer* Sequencer, UMovieSceneControlRigParameterSection* Section, const TOptional<FFrameNumber>& Time, bool bCompPreviousTick);
