...
public:
	...
	virtual void InitRigVMEditorSuper(const EToolkitMode::Type Mode, const TSharedPtr< class IToolkitHost >& InitToolkitHost, FRigVMAssetInterfacePtr InRigVMBlueprint) override { return IControlRigLegacyEditor::InitRigVMEditor(Mode, InitToolkitHost, InRigVMBlueprint); }
...
public:
	...
	virtual bool IsControlRigLegacyEditor() const override { return true; };
	virtual FRigVMAssetInterfacePtr GetRigVMAssetInterface() const override { return IControlRigLegacyEditor::GetRigVMAssetInterface(); }
	UControlRigBlueprint* GetControlRigBlueprint() { return Cast<UControlRigBlueprint>(GetRigVMAssetInterface().GetObject()); }
	UControlRigBlueprint* GetControlRigBlueprint() const { return Cast<UControlRigBlueprint>(GetRigVMAssetInterface().GetObject()); }
...
protected:
	...
	virtual void UnbindCommandsSuper() override { return IControlRigLegacyEditor::UnbindCommands(); }
...
private:
	...
	virtual void HandleRefreshEditorFromBlueprintSuper(FRigVMAssetInterfacePtr InBlueprint) override { return IControlRigLegacyEditor::HandleRefreshEditorFromBlueprint(InBlueprint); }
