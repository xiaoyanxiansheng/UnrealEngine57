...
FRigModuleAssetBrowserTabSummoner::FRigModuleAssetBrowserTabSummoner(const TSharedRef<IControlRigBaseEditor>& InEditor)
	: FWorkflowTabFactory(TabID, InEditor->GetHostingApp()),
