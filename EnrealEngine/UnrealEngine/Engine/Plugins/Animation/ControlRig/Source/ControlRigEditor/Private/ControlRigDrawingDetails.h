...
protected:
	...
	static void ImportCurvesFromFBX(const FString& InFilePath, FControlRigAssetInterfacePtr InBlueprint, const FControlRigDrawContainerImportFbxSettings& InSettings);
