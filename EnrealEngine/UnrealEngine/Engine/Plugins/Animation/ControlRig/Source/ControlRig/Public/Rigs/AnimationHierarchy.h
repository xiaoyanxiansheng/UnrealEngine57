...
public:
	...
	UE_API FTransformConstraint* FindConstraint(const FName& TargetNode);
	UE_API void AddConstraint(const FTransformConstraint& TransformConstraint);
	UE_API void DeleteConstraint(const FName& TargetNode);
