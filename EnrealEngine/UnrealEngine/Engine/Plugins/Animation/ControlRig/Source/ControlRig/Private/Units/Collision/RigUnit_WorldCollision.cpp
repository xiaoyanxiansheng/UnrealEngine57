...
FRigUnit_LineTraceByTraceChannel_Execute()
{
	FRigUnit_SphereTraceByTraceChannel::StaticExecute(ExecuteContext, Start, End, TraceChannel, 0, bHit, HitLocation, HitNormal, WorkData);
}
...
FRigUnit_LineTraceByObjectTypes_Execute()
{
	FRigUnit_SphereTraceByObjectTypes::StaticExecute(ExecuteContext, Start, End, ObjectTypes, 0, bHit, HitLocation, HitNormal, WorkData);
}
