...
{
	FRigUnit_VisualDebugVectorItemSpace::StaticExecute(ExecuteContext, Value, bEnabled, Mode, Color, Thickness, Scale, FRigElementKey(BoneSpace, ERigElementType::Bone), DebugDrawSettings);
}
...
FRigUnit_VisualDebugVectorItemSpace_Execute()
{
	...
	switch(Mode)
	{
		...
		{
			ExecuteContext.GetDrawInterface()->DrawPoint(WorldOffset, Value, Thickness, Color, DebugDrawSettings.DepthPriority, DebugDrawSettings.Lifetime);
			break;
		}
		case ERigUnitVisualDebugPointMode::Vector:
		{
			ExecuteContext.GetDrawInterface()->DrawLine(WorldOffset, FVector::ZeroVector, Value * Scale, Color, Thickness, DebugDrawSettings.DepthPriority, DebugDrawSettings.Lifetime);
			break;
		}
		default:
		{
...
{
	FRigUnit_VisualDebugQuatItemSpace::StaticExecute(ExecuteContext, Value, bEnabled, Thickness, Scale, FRigElementKey(BoneSpace, ERigElementType::Bone), DebugDrawSettings);
}
...
FRigUnit_VisualDebugQuatItemSpace_Execute()
{
	...
	FRigUnit_VisualDebugTransformItemSpace::StaticExecute(ExecuteContext, Transform, bEnabled, Thickness, Scale, Space, DebugDrawSettings);
}

FRigUnit_VisualDebugTransform_Execute()
{
	FRigUnit_VisualDebugTransformItemSpace::StaticExecute(ExecuteContext, Value, bEnabled, Thickness, Scale, FRigElementKey(BoneSpace, ERigElementType::Bone), DebugDrawSettings);
}
...
FRigUnit_VisualDebugTransformItemSpace_Execute()
{
	...
	ExecuteContext.GetDrawInterface()->DrawAxes(WorldOffset, Value, Scale, Thickness, DebugDrawSettings.DepthPriority, DebugDrawSettings.Lifetime);
}
