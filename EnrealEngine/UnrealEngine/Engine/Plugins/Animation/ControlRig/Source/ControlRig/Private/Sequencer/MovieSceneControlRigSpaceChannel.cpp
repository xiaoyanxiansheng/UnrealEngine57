...
bool FMovieSceneControlRigSpaceChannel::Evaluate(FFrameTime InTime, FMovieSceneControlRigSpaceBaseKey& OutValue) const
{
	...
	OutValue = FMovieSceneControlRigSpaceBaseKey();
	return true;
}
...
void FMovieSceneControlRigSpaceChannel::SetDefault(const FMovieSceneControlRigSpaceBaseKey& InDefaultValue)
{
	bHasDefaultValue = true;
	DefaultValue = InDefaultValue;
}

TOptional<FMovieSceneControlRigSpaceBaseKey> FMovieSceneControlRigSpaceChannel::GetDefault() const
{
	return bHasDefaultValue ? TOptional<FMovieSceneControlRigSpaceBaseKey>(DefaultValue) : TOptional<FMovieSceneControlRigSpaceBaseKey>();
}

void FMovieSceneControlRigSpaceChannel::ClearDefault()
{
	bHasDefaultValue = false;
	DefaultValue = FMovieSceneControlRigSpaceBaseKey();
}
