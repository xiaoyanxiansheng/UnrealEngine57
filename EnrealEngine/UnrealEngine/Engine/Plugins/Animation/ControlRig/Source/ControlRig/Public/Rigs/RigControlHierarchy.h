...
struct FRigControl : public FRigElement
{
	...
	UE_API void ApplyLimits(FRigControlValue& InOutValue) const;
	...
	UE_API FTransform GetTransformFromValue(ERigControlValueType InValueType = ERigControlValueType::Current) const;
	UE_API void SetValueFromTransform(const FTransform& InTransform, ERigControlValueType InValueType = ERigControlValueType::Current);
