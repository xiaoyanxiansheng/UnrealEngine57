...
public:
	...
	void HandleOnPreConstruct(UControlRig* Subject, const FName& InEventName);
	void HandleOnPostConstructed_GameThread();
	void HandleOnPostConstructed(UControlRig* Subject, const FName& InEventName);

	CONTROLRIG_API void BindControlRigDelegates();
...
public:
	...
	*/
	...
	CONTROLRIG_API void UpdateControlRigSettingsOverrides(const FInstancedPropertyBag& InNewOverrides);
...
private:
	...
	void OnShutdownPIE(bool bIsSimulating);
