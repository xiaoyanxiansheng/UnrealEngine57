...
class FMeshResizingToolActionCommands : public TInteractiveToolCommands<T>
{
public:
	FMeshResizingToolActionCommands(const FName InContextName, const FText& InContextDesc) : TInteractiveToolCommands<T>(InContextName, InContextDesc, NAME_None, FAppStyle::GetAppStyleSetName())
	{}
...
public:
	FMeshResizingToolActionCommandBindings();
