...
public:
	static UE_API TAVResult<AMF_VIDEO_ENCODER_RATE_CONTROL_METHOD_ENUM> ConvertRateControlMode(ERateControlMode Mode);
	static UE_API TAVResult<ERateControlMode> ConvertRateControlMode(AMF_VIDEO_ENCODER_RATE_CONTROL_METHOD_ENUM Mode);

	static UE_API FName const CodecTypeH264;
	static UE_API FName const CodecTypeH265;
