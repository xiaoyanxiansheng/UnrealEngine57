...
struct FVideoDecoderConfigH264 : public FVideoDecoderConfig
{
	...
	UE_API FAVResult Parse(FVideoPacket const& Packet, TArray<UE::AVCodecCore::H264::Slice_t>& OutSlices);

    UE_API TOptional<int> GetLastSliceQP(TArray<UE::AVCodecCore::H264::Slice_t>& Slices);
};
