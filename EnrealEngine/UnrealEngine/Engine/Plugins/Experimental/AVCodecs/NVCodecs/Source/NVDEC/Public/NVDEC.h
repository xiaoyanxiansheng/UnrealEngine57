...
class FNVDEC : public FAPI, public NV_DECODE_API_FUNCTION_LIST
{
public:
	...
	NVDEC_API virtual bool IsValid() const override;

	NVDEC_API FString GetErrorString(CUresult ErrorCode) const;
