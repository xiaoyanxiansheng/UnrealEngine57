...
public:
	...
	UE_API void SetStoredPropertyData(TArray<UObject*>& Properties);
	UE_API void LoadStoredPropertyData(TArray<UObject*>& Properties);
};
 ...
 */
UCLASS(MinimalAPI, BlueprintType, hidecategories=(Object), EditorConfig = "UInteractiveToolsPresetCollectionAsset_DefaultCollection")
...
class UInteractiveToolsPresetCollectionAssetFactory : public UFactory
{
	GENERATED_BODY()
