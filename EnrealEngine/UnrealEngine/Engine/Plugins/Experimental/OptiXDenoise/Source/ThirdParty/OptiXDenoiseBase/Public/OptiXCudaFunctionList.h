...
{
	Undefined,
	CUDA_A32B32G32R32_F = 0x2204, // OPTIX_PIXEL_FORMAT_FLOAT4
	CUDA_FloatRGBA      = 0x2202, // OPTIX_PIXEL_FORMAT_HALF4
	INTERNAL_LAYER		= 0x2209  // OPTIX_PIXEL_FORMAT_INTERNAL_GUIDE_LAYER
}EOptiXImageFormat;
