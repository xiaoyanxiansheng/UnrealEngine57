...
void IGeometryCollectionEditorPlugin::RegisterMenus()
{
	...
	{
		UToolMenu* Menu = UToolMenus::Get()->ExtendMenu("LevelEditor.MainMenu.Select.GeometryCollections");

		FToolMenuSection& Section = Menu->AddSection(
			"GeometryCollections",
			NSLOCTEXT("LevelViewportContextMenu", "GeometryCollectionHeading", "Geometry Collection")
		);
