...
TUniquePtr<FDynamicMeshOperator> UMirrorOperatorFactory::MakeNewOperator()
{
	...
	switch (MirrorTool->Settings->WeldVerticesNormalMode)
	{
	case EMeshMirrorWeldNormalMode::MirrorNormals:
		MirrorOp->WeldNormalMode = UE::Geometry::EMeshMirrorNormalMode::MirrorNormals;
		break;
	case EMeshMirrorWeldNormalMode::AverageMirrorNormals:
		MirrorOp->WeldNormalMode = UE::Geometry::EMeshMirrorNormalMode::AverageMirrorNormals;
		break;
	}
