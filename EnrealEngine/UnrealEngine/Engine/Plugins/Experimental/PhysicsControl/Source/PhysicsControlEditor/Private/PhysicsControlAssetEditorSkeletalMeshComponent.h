...
#include "PhysicsControlAssetEditorSkeletalMeshComponent.generated.h"
...
UCLASS()
class UPhysicsControlAssetEditorSkeletalMeshComponent : public UDebugSkelMeshComponent
{
