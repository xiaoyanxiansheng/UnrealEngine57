...
class FSkeletonTreePhysicsControlBodyItem : public FSkeletonTreePhysicsControlItem
{
public:
	SKELETON_TREE_ITEM_TYPE(FSkeletonTreePhysicsControlBodyItem, FSkeletonTreePhysicsControlItem);

	FSkeletonTreePhysicsControlBodyItem(class USkeletalBodySetup* InBodySetup, int32 InBodySetupIndex, const FName& InBoneName, bool bInHasBodySetup, bool bInHasShapes, class UPhysicsAsset* const InPhysicsAsset, const TSharedRef<class ISkeletonTree>& InSkeletonTree);
