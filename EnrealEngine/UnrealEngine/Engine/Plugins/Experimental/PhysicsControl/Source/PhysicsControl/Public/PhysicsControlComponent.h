...
public:
	...
	*/
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void DestroyControl(
		const FName Name, const bool bApplyToControlsWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl)
	UE_API void DestroyControls(
		const TArray<FName>& Names, const bool bApplyToControlsWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetControlParent(
		const FName Name, UPrimitiveComponent* ParentComponent, const FName ParentBoneName,
		const bool bApplyToControlsWithName = true, const bool bApplyToSetsWithName = true);
	...
	UE_API void SetControlParents(
		const TArray<FName>& Names, UPrimitiveComponent* ParentComponent, const FName ParentBoneName,
		const bool bApplyToControlsWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetControlData(
		const FName Name, const FPhysicsControlData ControlData, 
		const bool bApplyToControlsWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl)
	UE_API void SetControlDatas(
		const TArray<FName>& Names, const FPhysicsControlData ControlData,
		const bool bApplyToControlsWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetControlSparseData(
		const FName Name, const FPhysicsControlSparseData ControlData,
		const bool bApplyToControlsWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl)
	UE_API void SetControlSparseDatas(
		const TArray<FName>& Names, const FPhysicsControlSparseData ControlData,
		const bool bApplyToControlsWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetControlMultiplier(
	...
	UE_API void SetControlMultipliers(
		const TArray<FName>& Names, const FPhysicsControlMultiplier ControlMultiplier, const bool bEnableControl = true,
		const bool bApplyToControlsWithName = true, const bool bApplyToSetsWithName = true);
	...
	UE_API void SetControlMultipliersInSet(
		const FName Set, const FPhysicsControlMultiplier  ControlMultiplier, const bool bEnableControl = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetControlSparseMultiplier(
	...
	UE_API void SetControlSparseMultipliers(
		const TArray<FName>& Names, const FPhysicsControlSparseMultiplier ControlMultiplier, const bool bEnableControl = true,
		const bool bApplyToControlsWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetControlLinearData(
		const FName Name,
		...
		const bool  bEnableControl = true,
		const bool  bApplyToControlsWithName = true, 
		const bool  bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetControlAngularData(
		const FName Name,
		const float Strength = 1.0f, 
		const float DampingRatio = 1.0f, 
		const float ExtraDamping = 0.0f, 
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetControlTarget(
		const FName Name, const FPhysicsControlTarget ControlTarget, const bool bEnableControl = true,
		const bool bApplyToControlsWithName = true, const bool bApplyToSetsWithName = true);
	...
	UE_API void SetControlTargets(
		const TArray<FName>& Names, const FPhysicsControlTarget ControlTarget, const bool bEnableControl = true,
		const bool bApplyToControlsWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetControlTargetPositionAndOrientation(
		const FName    Name,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetControlTargetPosition(
		const FName   Name,
		const FVector Position, 
		const float   VelocityDeltaTime, 
		const bool    bEnableControl = true,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetControlTargetOrientation(
		const FName    Name,
		const FRotator Orientation, 
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetControlUseSkeletalAnimation(
		const FName Name,
		const bool  bUseSkeletalAnimation = true,
		const float AngularTargetVelocityMultiplier = 1.0f,
		const float LinearTargetVelocityMultiplier = 1.0f,
		const bool  bApplyToControlsWithName = true, 
		const bool  bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetControlEnabled(
		const FName Name, const bool bEnable = true, 
		const bool bApplyToControlsWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl)
	UE_API void SetControlsEnabled(
		const TArray<FName>& Names, const bool bEnable = true, 
		const bool bApplyToControlsWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetControlDisableCollision(
		const FName Name, const bool bDisableCollision,
		const bool bApplyToControlsWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl)
	UE_API void SetControlsDisableCollision(
		const TArray<FName>& Names, const bool bDisableCollision,
		const bool bApplyToControlsWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void DestroyBodyModifier(
		const FName Name, const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl)
	UE_API void DestroyBodyModifiers(
		const TArray<FName>& Names, const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetBodyModifierData(
		const FName Name, const FPhysicsControlModifierData ModifierData, 
		const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl)
	UE_API void SetBodyModifierDatas(
		const TArray<FName>& Names, const FPhysicsControlModifierData ModifierData,
		const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetBodyModifierSparseData(
		const FName Name, const FPhysicsControlModifierSparseData ModifierData,
		const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl)
	UE_API void SetBodyModifierSparseDatas(
		const TArray<FName>& Names, const FPhysicsControlModifierSparseData ModifierData,
		const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetBodyModifierMovementType(
		const FName Name, const EPhysicsMovementType MovementType = EPhysicsMovementType::Simulated,
		const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	...
	UE_API void SetBodyModifiersMovementType(
		const TArray<FName>& Names, const EPhysicsMovementType MovementType = EPhysicsMovementType::Simulated,
		const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetBodyModifierCollisionType(
		const FName Name, const ECollisionEnabled::Type CollisionType = ECollisionEnabled::QueryAndPhysics,
		const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	...
	UE_API void SetBodyModifiersCollisionType(
		const TArray<FName>& Names, const ECollisionEnabled::Type CollisionType = ECollisionEnabled::QueryAndPhysics,
		const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetBodyModifierGravityMultiplier(
		const FName Name, const float GravityMultiplier = 1.0f,
		const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	...
	UE_API void SetBodyModifiersGravityMultiplier(
		const TArray<FName>& Names, const float GravityMultiplier = 1.0f,
		const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetBodyModifierPhysicsBlendWeight(
		const FName Name, const float PhysicsBlendWeight = 1.0f,
		const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	...
	UE_API void SetBodyModifiersPhysicsBlendWeight(
		const TArray<FName>& Names, const float PhysicsBlendWeight = 1.0f,
		const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetBodyModifierKinematicTargetSpace(
		const FName Name, const EPhysicsControlKinematicTargetSpace KinematicTargetSpace,
		const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl)
	UE_API void SetBodyModifiersKinematicTargetSpace(
		const TArray<FName>& Names, const EPhysicsControlKinematicTargetSpace KinematicTargetSpace,
		const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl)
	UE_API void SetBodyModifiersInSetKinematicTargetSpace(
		const FName                               Set,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void SetBodyModifierUpdateKinematicFromSimulation(
		const FName Name, const bool  bUpdateKinematicFromSimulation,
		const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	...
	UE_API void SetBodyModifiersUpdateKinematicFromSimulation(
		const TArray<FName>& Names, const bool bUpdateKinematicFromSimulation,
		const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API bool InvokeControlProfile(
		const FName ProfileName, 
		const FName ControlSetMask = TEXT(""),
		const FName BodyModifierSetMask = TEXT(""));
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = PhysicsControl, Meta = (ReturnDisplayName = "Success"))
	UE_API void ResetBodyModifierToCachedBoneTransform(
		const FName Name, const EResetToCachedTargetBehavior Behavior = EResetToCachedTargetBehavior::ResetImmediately,
		const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
	...
	UE_API void ResetBodyModifiersToCachedBoneTransforms(
		const TArray<FName>& Names, const EResetToCachedTargetBehavior Behavior = EResetToCachedTargetBehavior::ResetImmediately,
		const bool bApplyToModifiersWithName = true, const bool bApplyToSetsWithName = true);
...
public:
	...
	// If set then controls that have been disabled due to the bodies being set to NoCollision (for
	// example) will be reinitialized, if possible, when those bodies are returned to the simulation.
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings)
	bool bAttemptToRecreateDisabledControls = false;
...
protected:
	 ...
	 * 
	 * @param ControlAndModifierUpdates The updates to apply
	 * @param ControlSetMask The optional name of a control set to use as a mask, so only controls within that set will be modified.
	 *        Standard control set names will include "All", "WorldSpace", "ParentSpace" and things like "WorldSpace_ArmLeft",
	 *        depending on how controls have been created.  If unset or invalid, no mask will be applied.
	 * @param BodyModifierSetMask The optional name of a body modifier set to use as a mask, so only body modifiers within that set will be modified.
