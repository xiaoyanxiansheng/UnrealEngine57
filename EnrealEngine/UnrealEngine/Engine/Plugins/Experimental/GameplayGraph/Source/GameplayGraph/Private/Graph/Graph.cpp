...
void UGraph::RemoveEdge(const FGraphVertexHandle& VertexHandleA, const FGraphVertexHandle& VertexHandleB)
{
	RemoveEdgeInternal(VertexHandleA, VertexHandleB, true);
}
