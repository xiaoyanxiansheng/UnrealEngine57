...
#include UE_INLINE_GENERATED_CPP_BY_NAME(WaterMovementUtils)
...
FProposedMove UWaterMovementUtils::ComputeControlledWaterMove(const FWaterMoveParams& InParams)
{
	...
	OutMove.AngularVelocityDegrees = UMovementUtils::ComputeAngularVelocityDegrees(InParams.PriorOrientation, IntendedFacingDir.ToOrientationRotator(), InParams.DeltaSeconds, InParams.TurningRate);
