...
namespace UE::Learning
{
	...
	{
		TRACE_CPUPROFILER_EVENT_SCOPE(Learning::FPSOOptimizer::Resize);
	...
	{
		TRACE_CPUPROFILER_EVENT_SCOPE(Learning::FPSOOptimizer::Reset);
	...
	{
		TRACE_CPUPROFILER_EVENT_SCOPE(Learning::FPSOOptimizer::Update);
		...
		{
			TRACE_CPUPROFILER_EVENT_SCOPE(Learning::FPSOOptimizer::Update::UpdateBest);
		...
		{
			TRACE_CPUPROFILER_EVENT_SCOPE(Learning::FPSOOptimizer::Update::UpdateVelocitiesSamples);
