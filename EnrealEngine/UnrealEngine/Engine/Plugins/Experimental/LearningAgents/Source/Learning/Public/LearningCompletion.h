...
namespace UE::Learning
{
	...
	*/
	...
	{
		UE_API void Reserve(const int32 InMaxInstanceNum);

		UE_API void SetResetInstances(const FIndexSet Instances);
		UE_API void SetResetInstancesFromCompletions(const TLearningArrayView<1, const ECompletionMode> Completions, const FIndexSet Instances);
		UE_API const int32 GetResetInstanceNum() const;
		UE_API const FIndexSet GetResetInstances() const;
		UE_API const TArray<int32>& GetResetInstancesArray() const;
	...
	namespace Completion
	{
		...
		*/
		UE_API const TCHAR* CompletionModeString(const ECompletionMode Completion);
		...
		*/
		UE_API ECompletionMode Or(const ECompletionMode Lhs, const ECompletionMode Rhs);
		...
		*
		*/
		UE_API void EvaluateEndOfEpisodeCompletions(
