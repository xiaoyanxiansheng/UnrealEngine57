...
public:
	...
	UE_API ULearningAgentsCritic();
	UE_API ULearningAgentsCritic(FVTableHelper& Helper);
	UE_API virtual ~ULearningAgentsCritic();
	...
	static UE_API ULearningAgentsCritic* MakeCritic(
...
public:
	...
	UE_API float GetEstimatedDiscountedReturn(const int32 AgentId) const;

	/** Gets the current Network Asset being used */
	UFUNCTION(BlueprintPure, Category = "LearningAgents")
	UE_API ULearningAgentsNeuralNetwork* GetCriticNetworkAsset();

// ----- Non-blueprint public interface -----
public:

	/** Get a reference to this critic's critic function object. */
	UE_API UE::Learning::FNeuralNetworkCritic& GetCriticObject();
