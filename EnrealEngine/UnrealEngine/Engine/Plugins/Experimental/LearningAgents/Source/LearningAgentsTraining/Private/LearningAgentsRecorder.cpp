...
#include UE_INLINE_GENERATED_CPP_BY_NAME(LearningAgentsRecorder)
...
ULearningAgentsRecorder::FAgentRecordBuffer::FAgentRecordBuffer(
	...
	, ObservationSchema(InObservationSchema)
	, ObservationSchemaElement(InObservationSchemaElement)
	, ActionSchema(InActionSchema)
	, ActionSchemaElement(InActionSchemaElement) {};
...
ULearningAgentsInteractor* ULearningAgentsRecorder::GetInteractor() const
{
	return Interactor;
}
