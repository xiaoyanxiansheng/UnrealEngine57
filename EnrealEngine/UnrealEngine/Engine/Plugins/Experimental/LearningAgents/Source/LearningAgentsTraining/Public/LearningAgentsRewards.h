...
public:
	...
	static UE_API float MakeReward(
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "LearningAgents", meta = (AdvancedDisplay = 2, DefaultToSelf = "VisualLoggerListener"))
	static UE_API float MakeRewardOnCondition(
	...
	static UE_API float MakeRewardFromLocationDifference(
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "LearningAgents", meta = (AdvancedDisplay = 4, DefaultToSelf = "VisualLoggerListener"))
	static UE_API float MakeRewardOnLocationDifferenceBelowThreshold(
		const FVector LocationA, 
		const FVector LocationB, 
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "LearningAgents", meta = (AdvancedDisplay = 4, DefaultToSelf = "VisualLoggerListener"))
	static UE_API float MakeRewardOnLocationDifferenceAboveThreshold(
		const FVector LocationA,
		const FVector LocationB,
		const float DistanceThreshold = 100.0f,
		const float RewardScale = 1.0f,
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "LearningAgents", meta = (AdvancedDisplay = 4, DefaultToSelf = "VisualLoggerListener"))
	static UE_API float MakeRewardFromLocationSimilarity(
		const FVector LocationA, 
		const FVector LocationB, 
		const float LocationScale = 100.0f, 
		const float RewardScale = 1.0f,
	...
	static UE_API float MakeRewardFromRotationSimilarity(
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "LearningAgents", meta = (AdvancedDisplay = 3, DefaultToSelf = "VisualLoggerListener"))
	static UE_API float MakeRewardFromRotationSimilarityAsQuats(
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "LearningAgents", meta = (AdvancedDisplay = 3, DefaultToSelf = "VisualLoggerListener"))
	static UE_API float MakeRewardFromAngleSimilarity(
		const float AngleA, 
		const float AngleB, 
		const float RewardScale = 1.0f,
	...
	static UE_API float MakeRewardFromDirectionSimilarity(
	...
	static UE_API float MakeRewardFromVelocityAlongSpline(
