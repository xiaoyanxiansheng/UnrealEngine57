...
public:
	...
	static UE_API bool IsCompletionRunning(const ELearningAgentsCompletion Completion);

	/** Returns true if a completion is either truncated or terminated, otherwise false. */
	UFUNCTION(BlueprintPure, Category = "LearningAgents")
	static UE_API bool IsCompletionCompleted(const ELearningAgentsCompletion Completion);

	/** Returns true if a completion is truncated, otherwise false. */
	UFUNCTION(BlueprintPure, Category = "LearningAgents")
	static UE_API bool IsCompletionTruncation(const ELearningAgentsCompletion Completion);

	/** Returns true if a completion is terminated, otherwise false. */
	UFUNCTION(BlueprintPure, Category = "LearningAgents")
	static UE_API bool IsCompletionTermination(const ELearningAgentsCompletion Completion);
	...
	static UE_API ELearningAgentsCompletion CompletionOr(ELearningAgentsCompletion A, ELearningAgentsCompletion B);
	...
	static UE_API ELearningAgentsCompletion CompletionAnd(ELearningAgentsCompletion A, ELearningAgentsCompletion B);
	...
	static UE_API ELearningAgentsCompletion CompletionNot(ELearningAgentsCompletion A, ELearningAgentsCompletion NotRunningType = ELearningAgentsCompletion::Termination);
	...
	static UE_API ELearningAgentsCompletion MakeCompletion(
	...
	static UE_API ELearningAgentsCompletion MakeCompletionOnCondition(
	...
	static UE_API ELearningAgentsCompletion MakeCompletionOnTimeElapsed(
		const float Time, 
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "LearningAgents", meta = (AdvancedDisplay = 3, DefaultToSelf = "VisualLoggerListener"))
	static UE_API ELearningAgentsCompletion MakeCompletionOnEpisodeStepsRecorded(
	...
	static UE_API ELearningAgentsCompletion MakeCompletionOnLocationDifferenceBelowThreshold(
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "LearningAgents", meta = (AdvancedDisplay = 4, DefaultToSelf = "VisualLoggerListener"))
	static UE_API ELearningAgentsCompletion MakeCompletionOnLocationDifferenceAboveThreshold(
		const FVector LocationA, 
		const FVector LocationB, 
		const float DistanceThreshold = 100.0f, 
		const ELearningAgentsCompletion CompletionType = ELearningAgentsCompletion::Termination,
	...
	static UE_API ELearningAgentsCompletion MakeCompletionOnLocationOutsideBounds(
