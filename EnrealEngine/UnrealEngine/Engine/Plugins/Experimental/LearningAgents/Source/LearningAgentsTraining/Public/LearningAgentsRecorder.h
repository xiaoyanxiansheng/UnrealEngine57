...
public:
	...
	UE_API FLearningAgentsRecorderPathSettings();
...
public:
	...
	UE_API ULearningAgentsRecorder();
	UE_API ULearningAgentsRecorder(FVTableHelper& Helper);
	UE_API virtual ~ULearningAgentsRecorder();
	...
	static UE_API ULearningAgentsRecorder* MakeRecorder(
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "LearningAgents")
	UE_API void EndRecordingAndDiscard();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "LearningAgents")
	UE_API void AddExperience();

	/** Gets the current recording object. Note: this may be empty until EndRecording has been called. */
	UFUNCTION(BlueprintPure, Category = "LearningAgents")
	UE_API const ULearningAgentsRecording* GetRecordingAsset() const;

protected:
	UFUNCTION(BlueprintPure, Category="LearningAgents")
	UE_API ULearningAgentsInteractor* GetInteractor() const;
...
private:
	...
	struct FAgentRecordBuffer
	{
		...
		UE::Learning::Observation::FSchemaElement ObservationSchemaElement;
		UE::Learning::Action::FSchema ActionSchema;
		UE::Learning::Action::FSchemaElement ActionSchemaElement;
