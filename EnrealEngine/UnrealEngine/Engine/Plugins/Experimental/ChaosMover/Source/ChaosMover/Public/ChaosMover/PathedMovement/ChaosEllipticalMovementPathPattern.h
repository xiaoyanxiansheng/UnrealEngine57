...
#include "ChaosEllipticalMovementPathPattern.generated.h"
...
protected:
	virtual FTransform CalcUnmaskedTargetTransform(float OverallPathFraction, const FTransform& BasisTransform) const override;
