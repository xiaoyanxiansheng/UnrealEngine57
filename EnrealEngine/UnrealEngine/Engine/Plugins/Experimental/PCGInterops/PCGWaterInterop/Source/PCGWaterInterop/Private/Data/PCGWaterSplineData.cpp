...
{
	// TODO: Might be interesting for those 4 custom attributes to follow the normal flow for attribute interpolation
	// instead of having a custom interpolation here.
	Super::WriteMetadataToPoint(InputKey, OutPoint, OutMetadata);
