...
protected:
	...
	UFUNCTION(BlueprintNativeEvent, Category = "Target AOE Selection")
	UE_API FRotator GetSourceRotationOffset(const FTargetingRequestHandle& TargetingHandle) const;
...
protected:
	...
	/** The default source rotation offset used by GetSourceRotationOffset */
	UPROPERTY(EditAnywhere, Category = "Target AOE Selection | Data")
