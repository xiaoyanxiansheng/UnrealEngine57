...
public:
	...
	inline bool operator==(const FTargetingRequestHandle& InHandle) const { return Handle == InHandle.Handle; }
	inline bool operator!=(const FTargetingRequestHandle& InHandle) const { return !this->operator==(InHandle); }
