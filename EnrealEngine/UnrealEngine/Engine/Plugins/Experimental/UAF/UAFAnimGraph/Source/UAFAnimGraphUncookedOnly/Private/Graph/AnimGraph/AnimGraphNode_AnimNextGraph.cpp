...
{
	return LOCTEXT("AnimGraphNode_UAFModule_Title", "UAF Animation Graph");
}

FText UAnimGraphNode_AnimNextGraph::GetTooltipText() const
{
	return LOCTEXT("AnimGraphNode_UAFAnimationGraph_Tooltip", "Evaluates a UAF Animation Graph");
}

FText UAnimGraphNode_AnimNextGraph::GetMenuCategory() const
{
	return LOCTEXT("Category", "Animation Framework");
}
