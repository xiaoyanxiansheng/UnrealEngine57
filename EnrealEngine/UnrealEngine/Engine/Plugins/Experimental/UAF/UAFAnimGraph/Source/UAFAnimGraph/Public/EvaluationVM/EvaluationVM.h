...
// its usage through this macro to ensure that UE::UAF::GetTypeID() is declared.
...
namespace UE::UAF
{
	...
	struct FEvaluationVM
	{
		...
		UE_API FEvaluationVM(EEvaluationFlags InEvaluationFlags, const UE::UAF::FReferencePose& InReferencePose, int32 InCurrentLOD);
	...
	private:
		...
		// Reference pose
		const UE::UAF::FReferencePose* ReferencePose = nullptr;
	...
	extern UAFANIMGRAPH_API const FEvaluationVMStackName KEYFRAME_STACK_NAME;
