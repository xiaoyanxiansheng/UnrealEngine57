...
extern const FTransform UAF_API TransformAdditiveIdentity;
...
struct TTransformArrayAoS
{
	...
	void SetNum(int32 NumTransforms, EAllowShrinking AllowShrinking = UE::Core::Private::AllowShrinkingByDefault<AllocatorType>())
	{
		Transforms.SetNum(NumTransforms, AllowShrinking);
	}
	UE_ALLOWSHRINKING_BOOL_DEPRECATED("SetNum")
	inline void SetNum(int32 NumTransforms, bool bAllowShrinking)
	{
		SetNum(NumTransforms, bAllowShrinking ? EAllowShrinking::Yes : EAllowShrinking::No);
	}

	void SetNumUninitialized(int32 NumTransforms, EAllowShrinking AllowShrinking = UE::Core::Private::AllowShrinkingByDefault<AllocatorType>())
	{
		Transforms.SetNumUninitialized(NumTransforms, AllowShrinking);
	}
	UE_ALLOWSHRINKING_BOOL_DEPRECATED("SetNumUninitialized")
	inline void SetNumUninitialized(int32 NumTransforms, bool bAllowShrinking)
	{
...
private:
	...
	inline static void DiagnosticCheckNaN_Rotate(const FQuat& Rotation)
	{
	...
	inline static void DiagnosticCheckNaN_Scale3D(const FVector& Scale3D)
	{
	...
	inline static void DiagnosticCheckNaN_Translate(const FVector& Translation)
	{
