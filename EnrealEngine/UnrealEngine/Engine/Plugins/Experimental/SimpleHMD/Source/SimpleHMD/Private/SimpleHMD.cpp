...
void FSimpleHMD::DrawDistortionMesh_RenderThread(struct FHeadMountedDisplayPassContext& Context, const FIntPoint& TextureSize)
{
	...
	FBufferRHIRef VertexBufferRHI = UE::RHIResourceUtils::CreateVertexBufferFromArray(RHICmdList, TEXT("FSimpleHMD"), EBufferUsageFlags::Volatile, MakeConstArrayView(MeshVerts[View.StereoViewIndex]));
	FBufferRHIRef IndexBufferRHI = UE::RHIResourceUtils::CreateIndexBufferFromArray(RHICmdList, TEXT("FSimpleHMD"), EBufferUsageFlags::Volatile, MakeConstArrayView(Indices));
