...
void UUIFrameworkButton::LocalOnUMGWidgetCreated()
{
	...
	Button->OnReceivedFocus.BindUObject(this, &ThisClass::HandleFocusReceived);
	Button->OnLostFocus.BindUObject(this, &ThisClass::HandleFocusLost);
...
void UUIFrameworkButton::HandleFocusReceived()
{
	ServerFocusReceived(GetPlayerController());
}

void UUIFrameworkButton::ServerFocusReceived_Implementation(APlayerController* PlayerController)
{
	FUIFrameworkFocusEventArgument Argument;
	Argument.PlayerController = PlayerController;
	Argument.Sender = this;
	OnFocusReceived.Broadcast(Argument);
}

void UUIFrameworkButton::HandleFocusLost()
{
	ServerFocusLost(GetPlayerController());
}

void UUIFrameworkButton::ServerFocusLost_Implementation(APlayerController* PlayerController)
{
	FUIFrameworkFocusEventArgument Argument;
	Argument.PlayerController = PlayerController;
	Argument.Sender = this;
	OnFocusLost.Broadcast(Argument);
}

void UUIFrameworkButton::HandleHovered()
{
	ServerHovered(GetPlayerController());
}

void UUIFrameworkButton::ServerHovered_Implementation(APlayerController* PlayerController)
{
	FUIFrameworkHoverEventArgument Argument;
	Argument.PlayerController = PlayerController;
	Argument.Sender = this;
	OnHovered.Broadcast(Argument);
}

void UUIFrameworkButton::HandleUnhovered()
{
	ServerUnhovered(GetPlayerController());
}

void UUIFrameworkButton::ServerUnhovered_Implementation(APlayerController* PlayerController)
{
	FUIFrameworkHoverEventArgument Argument;
	Argument.PlayerController = PlayerController;
	Argument.Sender = this;
	OnUnhovered.Broadcast(Argument);
}
