...
namespace UE::NNERuntimeRDG::Private::Hlsl
{
	...
	bool ValidateSizeOperator(const NNERuntimeRDGData::Internal::FAttributeMap& AttributeMap, TConstArrayView<ENNETensorDataType> InputTypes, TConstArrayView<NNE::FSymbolicTensorShape> InputSizes)
	{
		bool bIsValid = true;
