...
UCLASS()
class UNNERuntimeRDGHlslImpl : public UObject, public INNERuntime
{
	GENERATED_BODY()
...
UCLASS()
class UNNERuntimeRDGHlslImplRDG : public UNNERuntimeRDGHlslImpl, public INNERuntimeRDG
{
	GENERATED_BODY()

public:
	virtual ~UNNERuntimeRDGHlslImplRDG() {}
