...
namespace UE::NNERuntimeRDG::Private::Test::CastOp
{

#if WITH_DEV_AUTOMATION_TESTS

	IMPLEMENT_NNE_SHAPEINFERENCEHELPER_UNIT_AUTOMATION_TEST(FCastCPUHelperConstOuput, "System.Engine.MachineLearning.NNE.RDG.UnitTest.CastHelper.ConstOutput");
	...
	IMPLEMENT_NNE_SHAPEINFERENCEHELPER_UNIT_AUTOMATION_TEST(FCastCPUHelperRank1FromFloat, "System.Engine.MachineLearning.NNE.RDG.UnitTest.CastHelper.Rank1FromFloat");
	bool FCastCPUHelperRank1FromFloat::RunTest(const FString& Parameter)
	{
		...
		Y = MakeTensor(TEXT("Y"), { 2 }, ENNETensorDataType::Half);
		CPUHelper::Cast::Apply(XC2, Y);
		UTEST_TRUE(TEXT("Y const if input is const"), Y.HasPreparedData());
		UTEST_EQUAL(TEXT("Cast(float->half)[0]"), Y.GetPreparedData<FFloat16>()[0], -1.0f);
		UTEST_EQUAL(TEXT("Cast(float->half)[1]"), Y.GetPreparedData<FFloat16>()[1], 1.5f);
	...
	IMPLEMENT_NNE_SHAPEINFERENCEHELPER_UNIT_AUTOMATION_TEST(FCastCPUHelperRank1FromFloat16, "System.Engine.MachineLearning.NNE.RDG.UnitTest.CastHelper.Rank1FromFloat16");
	bool FCastCPUHelperRank1FromFloat16::RunTest(const FString& Parameter)
	{
		FTensor XC2 = MakeConstTensorFloat16(TEXT("XC2"), { 2 }, { -1.0f, 1.5f });

		FTensor Y = MakeTensor(TEXT("Y"), { 2 }, ENNETensorDataType::Float);
		CPUHelper::Cast::Apply(XC2, Y);
		UTEST_TRUE(TEXT("Y const if input is const"), Y.HasPreparedData());
		UTEST_EQUAL(TEXT("Cast(half->float)[0]"), Y.GetPreparedData<float>()[0], -1.0f);
		UTEST_EQUAL(TEXT("Cast(half->float)[1]"), Y.GetPreparedData<float>()[1], 1.5f);

		Y = MakeTensor(TEXT("Y"), { 2 }, ENNETensorDataType::Half);
		CPUHelper::Cast::Apply(XC2, Y);
		UTEST_TRUE(TEXT("Y const if input is const"), Y.HasPreparedData());
		UTEST_EQUAL(TEXT("Cast(half->half)[0]"), Y.GetPreparedData<FFloat16>()[0], -1.0f);
		UTEST_EQUAL(TEXT("Cast(half->half)[1]"), Y.GetPreparedData<FFloat16>()[1], 1.5f);

		Y = MakeTensor(TEXT("Y"), { 2 }, ENNETensorDataType::Int32);
		CPUHelper::Cast::Apply(XC2, Y);
		UTEST_TRUE(TEXT("Y const if input is const"), Y.HasPreparedData());
		UTEST_EQUAL(TEXT("Cast(half->int32)[0]"), Y.GetPreparedData<int32>()[0], (int32)-1);
		UTEST_EQUAL(TEXT("Cast(half->int32)[1]"), Y.GetPreparedData<int32>()[1], (int32)1);

		Y = MakeTensor(TEXT("Y"), { 2 }, ENNETensorDataType::Int64);
		CPUHelper::Cast::Apply(XC2, Y);
		UTEST_TRUE(TEXT("Y const if input is const"), Y.HasPreparedData());
		UTEST_EQUAL(TEXT("Cast(half->int64)[0]"), Y.GetPreparedData<int64>()[0], (int64)-1);
		UTEST_EQUAL(TEXT("Cast(half->int64)[1]"), Y.GetPreparedData<int64>()[1], (int64)1);

		return true;
	}

	IMPLEMENT_NNE_SHAPEINFERENCEHELPER_UNIT_AUTOMATION_TEST(FCastCPUHelperRank1FromInt32, "System.Engine.MachineLearning.NNE.RDG.UnitTest.CastHelper.Rank1FromInt32");
	bool FCastCPUHelperRank1FromInt32::RunTest(const FString& Parameter)
	{
		...
		CPUHelper::Cast::Apply(XC2, Y);
		UTEST_TRUE(TEXT("Y const if input is const"), Y.HasPreparedData());
		UTEST_EQUAL(TEXT("Cast(int32->half)[0]"), Y.GetPreparedData<FFloat16>()[0], -2.0f);
		UTEST_EQUAL(TEXT("Cast(int32->half)[1]"), Y.GetPreparedData<FFloat16>()[1], 0.0f);
	...
	IMPLEMENT_NNE_SHAPEINFERENCEHELPER_UNIT_AUTOMATION_TEST(FCastCPUHelperRank1FromInt64, "System.Engine.MachineLearning.NNE.RDG.UnitTest.CastHelper.Rank1FromInt64");
	bool FCastCPUHelperRank1FromInt64::RunTest(const FString& Parameter)
	{
		...
		CPUHelper::Cast::Apply(XC2, Y);
		UTEST_TRUE(TEXT("Y const if input is const"), Y.HasPreparedData());
		UTEST_EQUAL(TEXT("Cast(int64->float)[0]"), Y.GetPreparedData<float>()[0], -4.0f);
		UTEST_EQUAL(TEXT("Cast(int64->float)[1]"), Y.GetPreparedData<float>()[1], 10.0f);

		Y = MakeTensor(TEXT("Y"), { 2 }, ENNETensorDataType::Half);
		CPUHelper::Cast::Apply(XC2, Y);
		UTEST_TRUE(TEXT("Y const if input is const"), Y.HasPreparedData());
		UTEST_EQUAL(TEXT("Cast(int64->half)[0]"), Y.GetPreparedData<FFloat16>()[0], -4.0f);
		UTEST_EQUAL(TEXT("Cast(int64->half)[1]"), Y.GetPreparedData<FFloat16>()[1], 10.0f);

		Y = MakeTensor(TEXT("Y"), { 2 }, ENNETensorDataType::Int32);
		CPUHelper::Cast::Apply(XC2, Y);
		UTEST_TRUE(TEXT("Y const if input is const"), Y.HasPreparedData());
		UTEST_EQUAL(TEXT("Cast(int64->int32)[0]"), Y.GetPreparedData<int32>()[0], (int32)-4);
		UTEST_EQUAL(TEXT("Cast(int64->int32)[1]"), Y.GetPreparedData<int32>()[1], (int32)10);

		Y = MakeTensor(TEXT("Y"), { 2 }, ENNETensorDataType::Int64);
		CPUHelper::Cast::Apply(XC2, Y);
		UTEST_TRUE(TEXT("Y const if input is const"), Y.HasPreparedData());
		UTEST_EQUAL(TEXT("Cast(int64->int64)[0]"), Y.GetPreparedData<int64>()[0], (int64)-4);
		UTEST_EQUAL(TEXT("Cast(int64->int64)[1]"), Y.GetPreparedData<int64>()[1], (int64)10);

		return true;
	}

	IMPLEMENT_NNE_SHAPEINFERENCEHELPER_UNIT_AUTOMATION_TEST(FCastCPUHelperRank3, "System.Engine.MachineLearning.NNE.RDG.UnitTest.CastHelper.Rank3");
