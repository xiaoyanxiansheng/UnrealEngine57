...
FTensor FShapeInferenceHelperUnitTestBase::MakeConstTensorFloat16(FString Name, TConstArrayView<uint32> Shape, TConstArrayView<FFloat16> Data)
{
	FTensor Tensor = MakeTensor(Name, Shape, ENNETensorDataType::Half);
	check(Data.Num() == Tensor.GetVolume());
	Tensor.SetPreparedData(Data);
	return Tensor;
}
...
bool FShapeInferenceHelperUnitTestBase::TestBinaryOutputIsOnlyComputedWhenItShould(NNEHlslShaders::Internal::EElementWiseBinaryOperatorType OpType)
{
...
bool FShapeInferenceHelperUnitTestBase::TestUnaryOutputIsOnlyComputedWhenItShould(NNEHlslShaders::Internal::EElementWiseUnaryOperatorType OpType)
{
	FTensor XC1 = MakeConstTensor(TEXT("XC1"), { 1 }, { 1.0f });
	FTensor XC20 = MakeConstTensor(TEXT("XC20"), { 20 }, { 3.0f, 4.0f, 3.0f, 4.0f, 3.0f, 3.0f, 4.0f, 3.0f, 4.0f, 3.0f, 3.0f, 4.0f, 3.0f, 4.0f, 3.0f, 3.0f, 4.0f, 3.0f, 4.0f, 3.0f });
	FTensor X1 = MakeTensor(TEXT("X"), { 1 });
