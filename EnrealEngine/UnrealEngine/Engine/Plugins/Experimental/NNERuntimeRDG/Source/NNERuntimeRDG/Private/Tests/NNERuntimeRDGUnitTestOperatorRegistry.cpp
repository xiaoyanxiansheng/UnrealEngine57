...
namespace UE::NNERuntimeRDG::Private::Test::Registry
{
...
public:
	...
	static bool Validate(const NNERuntimeRDGData::Internal::FAttributeMap& AttributeMap, TConstArrayView<ENNETensorDataType> InputTypes, TConstArrayView<NNE::FSymbolicTensorShape> InputShapes)
	{
		return true;
	}
};
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"System.Engine.MachineLearning.NNE.RDG.UnitTest.OperatorRegistry",
...
const int Op##OpName##OpVer##Idx = TestOps.Num() - 1;
	...
	for (int32 Idx = 0; Idx < TestOps.Num(); ++Idx)
	{
        ...
        UE::NNERuntimeRDGData::Internal::FAttributeMap					Attributes;
