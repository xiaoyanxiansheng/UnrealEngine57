...
namespace UE::NNERuntimeRDG::Private::Hlsl
{
	...
	bool ValidateIdentityOperator(const NNERuntimeRDGData::Internal::FAttributeMap& AttributeMap, TConstArrayView<ENNETensorDataType> InputTypes, TConstArrayView<NNE::FSymbolicTensorShape> InputIdentitys)
	{
		bool bIsValid = true;
