...
{
	FFractureEngineFracturing::GenerateBrickTransforms(Bounds,
		BrickTransforms,
		static_cast<EFractureBrickBondEnum>(BrickSettings->Bond),
		BrickSettings->BrickLength, BrickSettings->BrickHeight, BrickSettings->BrickDepth,
		Edges);
}
