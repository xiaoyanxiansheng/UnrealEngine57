...
public:
	...
	*/
	...
	UE_API int32 GetIndexFromAnimSequence(const UAnimSequence* Sequence);

	UFUNCTION()
	UE_API void ResetInfo();
...
#define AnimToTextureDataAsset_ASSET_ACCESSOR(ClassName, PropertyName) \
	inline ClassName* Get##PropertyName() const { return GetAsset(PropertyName); }
