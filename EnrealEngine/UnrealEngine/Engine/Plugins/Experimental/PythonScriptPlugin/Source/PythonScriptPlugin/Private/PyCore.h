...
/** Python type for FPyTickerDelegateHandle */
extern PyTypeObject PyTickerDelegateHandleType;
...
/** Type for all Unreal exposed FTSTicker::FDelegateHandle instances */
struct FPyTickerDelegateHandle : public TPyWrapperBasic<FTSTicker::FDelegateHandle, FPyTickerDelegateHandle>
{
	typedef TPyWrapperBasic<FTSTicker::FDelegateHandle, FPyTickerDelegateHandle> Super;

	/** Create and initialize a new wrapper instance from the given native instance */
	static FPyTickerDelegateHandle* CreateInstance(const FTSTicker::FDelegateHandle& InValue);

	/** Cast the given Python object to this wrapped type (returns a new reference) */
	static FPyTickerDelegateHandle* CastPyObject(PyObject* InPyObject);
};
...
typedef TPyPtr<FPyTickerDelegateHandle> FPyTickerDelegateHandlePtr;
