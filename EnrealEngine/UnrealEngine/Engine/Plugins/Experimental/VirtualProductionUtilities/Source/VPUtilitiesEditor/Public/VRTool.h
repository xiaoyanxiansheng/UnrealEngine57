...
UCLASS()
class UE_DEPRECATED(5.5,"This class will be removed from UE5.7") AVRTool : public AVPTransientEditorTickableActorBase
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(Transient, DuplicateTransient, meta=(DeprecatedProperty, DeprecationMessage="This is deprecated"))
	...
	UPROPERTY(EditAnywhere, Category = "Input|Editor", BlueprintSetter = SetReceivesEditorInput, BlueprintGetter = GetReceivesEditorInput, meta=(DeprecatedProperty, DeprecationMessage="This is deprecated"))
