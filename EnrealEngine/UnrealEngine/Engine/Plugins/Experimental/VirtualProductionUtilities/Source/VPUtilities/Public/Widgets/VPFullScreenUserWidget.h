...
enum class EVPWidgetDisplayType : uint8
{
	...
	Composure = PostProcessWithBlendMaterial UMETA(Deprecated, DisplayName = "DEPRECATED_Composure"),
...
public:
	...
	constexpr static bool DoesDisplayTypeUsePostProcessSettings(EVPWidgetDisplayType Type) { return Type == EVPWidgetDisplayType::PostProcessSceneViewExtension || Type == EVPWidgetDisplayType::PostProcessWithBlendMaterial; }
	...
	UE_DEPRECATED(5.7, "Composure is no longer support for VPFullScreenUserWidgets")
