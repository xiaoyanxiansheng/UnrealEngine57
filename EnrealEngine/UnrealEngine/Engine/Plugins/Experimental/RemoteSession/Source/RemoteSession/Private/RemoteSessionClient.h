...
public:
	...
	FRemoteSessionClient(const TCHAR* InHostAddress, bool bUsingPixelStreaming);
...
protected:
	...
	virtual void		AppendExtraInfoToBackChannelPacket(TBackChannelSharedPtr<IBackChannelPacket> Packet) override;
