...
void FRecordingMessageHandler::PlayOnControllerAnalog(FArchive& Ar)
{
	...
	const int32 LegacyControllerId = Msg.Param2;
	FPlatformUserId PlatformUser = PLATFORMUSERID_NONE;
	FInputDeviceId DeviceId = INPUTDEVICEID_NONE;
	IPlatformInputDeviceMapper::Get().RemapControllerIdToPlatformUserAndDevice(LegacyControllerId, PlatformUser, DeviceId);
	
	OnControllerAnalog(FName(*Msg.Param1), PlatformUser, DeviceId, Msg.Param3);
}
...
void FRecordingMessageHandler::PlayOnControllerButtonPressed(FArchive& Ar)
{
	...
	OnControllerButtonPressed(FName(*Msg.Param1), PlatformUser, DeviceId, Msg.Param3);
}
...
void FRecordingMessageHandler::PlayOnControllerButtonReleased(FArchive& Ar)
{
	...
	OnControllerButtonReleased(FName(*Msg.Param1), PlatformUser, DeviceId, Msg.Param3);
}
