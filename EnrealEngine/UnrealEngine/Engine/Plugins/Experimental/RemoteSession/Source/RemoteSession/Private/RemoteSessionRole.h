...
public:
	...
	/* Register for notifications whenever a hello route message arrives */
	virtual void RegisterHelloRouteMessageDelegate(FBackChannelRouteDelegate::FDelegate InDelegate) override;
...
protected:
	...
	*/
	...
	/* Children of RemoteSessionRole can use this function to extend the information that a package will carry */
	virtual void	AppendExtraInfoToBackChannelPacket(TBackChannelSharedPtr<IBackChannelPacket> Packet) {};
...
protected:
	...
	bool					bIsUsingPixelStreaming;

	FString					RemotePixelStreamingVersion;
...
private:
	...
	TArray<FBackChannelRouteDelegate::FDelegate> ExternalHelloRoutePendingDelegates;
	TArray<FDelegateHandle> ExternalHelloRouteDelegateHandles;
