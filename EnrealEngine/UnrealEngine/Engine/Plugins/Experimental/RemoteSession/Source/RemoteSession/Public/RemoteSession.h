...
public:
	...
	virtual TSharedPtr<IRemoteSessionRole> CreateClient(const TCHAR* RemoteAddress, bool bUsingPixelStreaming = false) = 0;
	...
	static UE_API FString 		GetLocalVersion();

	static UE_API FString		GetLastSupportedVersion();
