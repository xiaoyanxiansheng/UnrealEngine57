...
TSharedPtr<IRemoteSessionRole> FRemoteSessionModule::CreateClient(const TCHAR* RemoteAddress, bool bUsingPixelStreaming)
{
	...
	Client = MakeShareable(new FRemoteSessionClient(RemoteAddress, bUsingPixelStreaming));
	return Client;
}
