...
template<>
struct TStructOpsTypeTraits<FFollowSplineState> : public TStructOpsTypeTraitsBase2<FFollowSplineState>
{
	enum
	{
		WithCopy = true		// Necessary so that non-uproperty members get copied
	};
};
