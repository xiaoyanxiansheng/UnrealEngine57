...
void UFollowPathMode::SimulationTick_Implementation(const FSimulationTickParams& Params, FMoverTickEndData& OutputState)
{
	...
	FRotator StartingRotation = StartingMoveState->GetOrientation_WorldSpace();
	...
	FVector AngularVelocityDegrees = UMovementUtils::ComputeAngularVelocityDegrees(StartingRotation, NewRotation, DeltaSeconds);
