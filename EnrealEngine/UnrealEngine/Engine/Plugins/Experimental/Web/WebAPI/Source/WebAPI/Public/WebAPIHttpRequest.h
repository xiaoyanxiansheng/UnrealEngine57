...
public:
	...
	[[nodiscard]] inline FString GetVerb() const { return InternalRequest->GetVerb(); }
	[[nodiscard]] inline FString GetContentType() const { return InternalRequest->GetContentType(); }
	[[nodiscard]] inline FString GetRoute() const { return InternalRequest->GetURL(); }
