...
namespace UE::ChaosCachingUSDUtil::Private {
	...
	bool SetActivations(pxr::UsdPrim& Prim, const pxr::VtArray<float>& Activations, const pxr::UsdTimeCode& Time);
	bool DeletePointsInTimeRange(pxr::UsdPrim& Prim, float StartTime, float EndTime);
	bool DeleteUsdAttributeInTimeRange(pxr::UsdAttribute Attribute, float StartTime, float EndTime);
} // namespace UE::ChaosCachingUSDUtil::Private
