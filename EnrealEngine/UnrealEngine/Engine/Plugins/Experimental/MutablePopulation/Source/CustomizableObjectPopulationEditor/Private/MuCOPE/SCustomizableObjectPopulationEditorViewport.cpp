...
void SCustomizableObjectPopulationEditorViewport::PopulateViewportOverlays(TSharedRef<SOverlay> Overlay)
{
	Overlay->AddSlot()
		.VAlign(VAlign_Top)
		[
			SNew(SCustomizableObjectPopulationEditorViewportToolBar,/* TabBodyPtr.Pin(),*/ SharedThis(this))
