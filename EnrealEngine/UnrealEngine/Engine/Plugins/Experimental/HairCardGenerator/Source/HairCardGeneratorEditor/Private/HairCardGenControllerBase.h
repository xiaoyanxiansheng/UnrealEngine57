...
public:
	...
	UFUNCTION(BlueprintImplementableEvent, Category = Python)
	TArray<float> GenerateCardsGeometry();

	UFUNCTION(BlueprintImplementableEvent, Category = Python)
	TArray<int32> GenerateClumps(const int GroupId = -1);
	...
	UFUNCTION(BlueprintImplementableEvent, Category = Python)
	TArray<int32> ClusterTextures(int GroupIndex);

	UFUNCTION(BlueprintImplementableEvent, Category = Python)
	TArray<float> GenerateTextureLayout();
