...
#include UE_INLINE_GENERATED_CPP_BY_NAME(InterchangeLightNode)
...
FString UInterchangeSkyLightNode::GetTypeName() const
{
	return TEXT("SkyLightNode");
}

bool UInterchangeSkyLightNode::GetCustomCubemapDependency(FString& AttributeValue) const
{
	IMPLEMENT_NODE_ATTRIBUTE_GETTER(CubemapDependency, FString)
}

bool UInterchangeSkyLightNode::SetCustomCubemapDependency(FString AttributeValue)
{
	IMPLEMENT_NODE_ATTRIBUTE_SETTER_NODELEGATE(CubemapDependency, FString)
}

bool UInterchangeSkyLightNode::GetCustomSourceType(EInterchangeSkyLightSourceType& AttributeValue) const
{
	IMPLEMENT_NODE_ATTRIBUTE_GETTER(SourceType, EInterchangeSkyLightSourceType)
}

bool UInterchangeSkyLightNode::SetCustomSourceType(EInterchangeSkyLightSourceType AttributeValue)
{
