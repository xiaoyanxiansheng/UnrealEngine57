...
bool UInterchangeMaterialInstanceNode::GetCustomBlendMode(int& AttributeValue) const
{
	IMPLEMENT_NODE_ATTRIBUTE_GETTER(BlendMode, int);
}

bool UInterchangeMaterialInstanceNode::SetCustomBlendMode(int AttributeValue)
{
