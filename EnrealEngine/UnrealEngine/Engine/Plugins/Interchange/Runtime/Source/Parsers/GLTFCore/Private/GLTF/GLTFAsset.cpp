	...
	namespace
	{
		...
		void GenerateNames(const FString& Prefix, TArray<T>& Objects)
		{
			for (int32 Index = 0; Index < Objects.Num(); ++Index)
			{
				...
				UE::Interchange::SanitizeName(Obj.Name);
			}
		}
	...
	{
		{
			...
			for (size_t SceneIndex = 0; SceneIndex < Scenes.Num(); SceneIndex++)
			{
				...
				UE::Interchange::SanitizeName(Scene.Name);
			}
		}

		{
			...
			for (int32 NodeIndex = 0; NodeIndex < Nodes.Num(); ++NodeIndex)
			{
				...
				UE::Interchange::SanitizeName(Node.Name, bIsJoint);
...

		{
			...
			for (int32 TextureIndex = 0; TextureIndex < Textures.Num(); ++TextureIndex)
			{
				...
				UE::Interchange::SanitizeName(Tex.Name);
			}
		}

		{
			...
			for (int32 CameraIndex = 0; CameraIndex < Cameras.Num(); ++CameraIndex)
			{
				...
				UE::Interchange::SanitizeName(Camera.Name);
			}
		}

		{
			...
			for (int32 LightIndex = 0; LightIndex < Lights.Num(); ++LightIndex)
			{
				...
				UE::Interchange::SanitizeName(Light.Name);
			}
		}
