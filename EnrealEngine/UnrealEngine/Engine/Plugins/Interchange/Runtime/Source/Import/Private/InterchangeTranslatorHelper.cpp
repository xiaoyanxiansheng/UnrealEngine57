...
{
	FScopedTranslator::FScopedTranslator(const FString& PayLoadKey, UInterchangeResultsContainer* Results, TSharedPtr<UE::Interchange::FAnalyticsHelper> AnalyticsHelper)
	{
