...
{
	ConvertToMultilineToolTip(TEXT("UMaterialExpressionMaterialXSwizzle is now deprecated since <swizzle> node has been removed from MaterialX 1.39.3")
							  TEXT("Please use UMaterialExpressionComponent instead."), 40, OutToolTip);
}
