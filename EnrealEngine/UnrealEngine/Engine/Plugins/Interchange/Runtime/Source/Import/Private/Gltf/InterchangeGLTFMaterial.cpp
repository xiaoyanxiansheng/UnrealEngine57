...
namespace UE::Interchange::GLTFMaterials
{
	...
	FString GetMaterialFunctionPath(EShadingModel ShadingModel)
	{
		...
		return ShadingModelToMaterialInformation.FindArbitraryElement()->Value.MaterialFunctionPath;
	}
	...
	TArray<FString> GetOutputs(EShadingModel ShadingModel)
	{
		...
		return ShadingModelToMaterialInformation.FindArbitraryElement()->Value.MaterialFunctionOutputs;
	}
