...
FOnGatherConflictAndExtraInfo FInterchangePipelineBaseDetailsCustomization::OnGatherConflictAndExtraInfo;
...
void FInterchangePipelineBaseDetailsCustomization::ReCollectConflictAndExtraInfo()
{
	TArray<FInterchangeConflictInfo> ConflictInfo;
	TMap<FString, FString> ExtraInfo;
	OnGatherConflictAndExtraInfo.ExecuteIfBound(ConflictInfo, ExtraInfo);
	SetConflictsInfo(ConflictInfo);
