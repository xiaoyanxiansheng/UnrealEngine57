...
using FInterchangeConflictInfoArray = TArray<FInterchangeConflictInfo>;
using FInterchangeExtraInfoMap = TMap<FString, FString>;
DECLARE_DELEGATE_TwoParams(FOnGatherConflictAndExtraInfo, FInterchangeConflictInfoArray&, FInterchangeExtraInfoMap&);
...
public:
	...
	static void ReCollectConflictAndExtraInfo();
	static FOnGatherConflictAndExtraInfo OnGatherConflictAndExtraInfo;
