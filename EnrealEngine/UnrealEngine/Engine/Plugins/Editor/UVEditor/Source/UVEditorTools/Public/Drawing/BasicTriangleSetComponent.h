...
public:
	...
	UE_API UBasicTriangleSetComponentBase();

	/** Clears the component state and marks component as dirty. */
	UE_API void ClearComponent();

	/** Specify material that handles lines. */
	UE_API void SetTriangleMaterial(UMaterialInterface* InTriangleMaterial);

	/** Set per line material parameters that are uniform for all lines. */
	UE_API void SetTriangleSetParameters(FColor InColor, const FVector3f& NormalIn);
...
UCLASS(MinimalAPI)
class UBasic2DTriangleSetComponent final : public UBasicTriangleSetComponentBase, public TBasicElementSet<FVector2f, 3>
{
	GENERATED_BODY()
...
UCLASS(MinimalAPI)
class UBasic3DTriangleSetComponent final : public UBasicTriangleSetComponentBase, public TBasicElementSet<FVector3f, 3>
{
	GENERATED_BODY()
