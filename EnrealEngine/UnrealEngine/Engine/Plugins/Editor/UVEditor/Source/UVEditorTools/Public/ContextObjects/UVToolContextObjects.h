...
public:
	 ...
	 * for you.
	 */
	UE_API virtual void EmitToolIndependentChange(UObject* TargetObject, TUniquePtr<FToolCommandChange> Change, const FText& Description);
	 ...
	 */
	UE_API virtual void EmitToolIndependentUnwrapCanonicalChange(UUVEditorToolMeshInput* InputObject,
	 ...
	 * when it was emitted.
	 */
	UE_API virtual void EmitToolDependentChange(UObject* TargetObject, TUniquePtr<FToolCommandChange> Change, const FText& Description);
...
public:
	...
	UE_API void Initialize(UWorld* WorldIn, UInputRouter* RouterIn,
...
struct FUDIMBlock
{
	...
	UE_API int32 BlockU() const;
	UE_API int32 BlockV() const;
	UE_API void SetFromBlocks(int32 BlockU, int32 BlockV);
};
...
public:
	...
	UE_API void Set(FDynamicMesh3* MeshKey, TSharedPtr<FDynamicMeshAABBTree3> Tree,
		UUVEditorToolMeshInput* InputObject);

	UE_API TSharedPtr<FDynamicMeshAABBTree3> Get(FDynamicMesh3* MeshKey);

	UE_API void Remove(FDynamicMesh3* MeshKey);

	UE_API void RemoveByPredicate(TUniqueFunction<
