...
public:
	...
	UE_API UBasicPointSetComponentBase();

	/** Clears the component state and marks component as dirty. */
	UE_API void ClearComponent();
	...
	UE_API void SetPointSetParameters(FColor InColor, float InSize, float InDepthBias);

	/** Set per point material Color parameter that is uniform for all points. */
	UE_API void SetColor(const FColor InColor);

	/** Set per point material Size parameter tat is uniform for all points. */
	UE_API void SetPointSize(const float InSize);
...
UCLASS(MinimalAPI)
class UBasic2DPointSetComponent final : public UBasicPointSetComponentBase, public TBasicElementSet<FVector2f, 1>
{
	GENERATED_BODY()
...
UCLASS(MinimalAPI)
class UBasic3DPointSetComponent final : public UBasicPointSetComponentBase, public TBasicElementSet<FVector3f, 1>
{
	GENERATED_BODY()
