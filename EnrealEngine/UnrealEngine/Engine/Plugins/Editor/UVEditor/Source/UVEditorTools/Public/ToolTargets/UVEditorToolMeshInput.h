...
public:
	...
	*/
	...
	UE_API bool InitializeMeshes(UToolTarget* Target, 
	...
	static UE_API const TArray<int32>* const NONE_CHANGED_ARG;
	 ...
	 */
	UE_API void UpdateUnwrapPreviewOverlayFromPositions(const TArray<int32>* ChangedVids = nullptr, 
	 ...
	 * the input object.
	 */
	UE_API void UpdateUnwrapCanonicalOverlayFromPositions(const TArray<int32>* ChangedVids = nullptr, 
	 ...
	 */
	UE_API void UpdateAppliedPreviewFromUnwrapPreview(const TArray<int32>* ChangedVids = nullptr, 
		const TArray<int32>* ChangedConnectivityTids = nullptr, const TArray<int32>* FastRenderUpdateTids = nullptr);
	 ...
	 */
	UE_API void UpdateUnwrapPreviewFromAppliedPreview(
	 ...
	 */
	UE_API void UpdateCanonicalFromPreviews(const TArray<int32>* ChangedVids = nullptr, 
	 ...
	 */
	UE_API void UpdatePreviewsFromCanonical(const TArray<int32>* ChangedVids = nullptr, const TArray<int32>* ChangedConnectivityTids = nullptr,
		const TArray<int32>* FastRenderUpdateTids = nullptr);
	 ...
	 */
	UE_API void UpdateAllFromUnwrapPreview(const TArray<int32>* ChangedVids = nullptr, const TArray<int32>* ChangedConnectivityTids = nullptr, 
	 ...
	 */
	UE_API void UpdateAllFromUnwrapCanonical(const TArray<int32>* ChangedVids = nullptr, const TArray<int32>* ChangedConnectivityTids = nullptr, 
		const TArray<int32>* FastRenderUpdateTids = nullptr, bool bBroadcast = true);
	 ...
	 */
	UE_API void UpdateAllFromAppliedCanonical(const TArray<int32>* ChangedVids = nullptr, const TArray<int32>* ChangedConnectivityTids = nullptr, 
		const TArray<int32>* FastRenderUpdateTids = nullptr, bool bBroadcast = true);

	/**
	 * Updates the other meshes using the UV overlay in the live preview.
	 */
	UE_API void UpdateAllFromAppliedPreview(const TArray<int32>* ChangedElementIDs = nullptr, 
	 ...
	 */
	UE_API void UpdateFromCanonicalUnwrapUsingMeshChange(const UE::Geometry::FDynamicMeshChange& UnwrapCanonicalMeshChange, bool bBroadcast = true);
	 ...
	 */
	UE_API int32 UnwrapVidToAppliedVid(int32 UnwrapVid);
	 ...
	 */
	UE_API void AppliedVidToUnwrapVids(int32 AppliedVid, TArray<int32>& UnwrapVidsOut);
	...
	*/
	UE_API virtual bool IsToolTargetValid() const;
	 ...
	 */
	UE_API virtual bool AreMeshesValid() const;
...
protected:	
	...
	*/
	UE_API virtual EMeshRenderAttributeFlags GetUnwrapUpdateAttributeFlags() const;

	/**
	* Returns the currently configured mesh attribute buffer flags enabled on this target for updating the applied previews
	*/
	UE_API virtual EMeshRenderAttributeFlags GetAppliedUpdateAttributeFlags() const;
};
