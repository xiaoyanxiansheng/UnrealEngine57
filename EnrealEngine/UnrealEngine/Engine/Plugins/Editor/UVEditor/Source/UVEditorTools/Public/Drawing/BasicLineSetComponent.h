...
public:
	...
	UE_API UBasicLineSetComponentBase();
	...
	UE_API void SetLineSetParameters(FColor InColor, float InSize, float InDepthBias);

	/** Set per line material Line Color parameter that is uniform for all lines */
	UE_API void SetColor(FColor InColor);

	/** Set per line material Line Size/Thickness parameter that is uniform for all lines */
	UE_API void SetLineThickness(float InSize);
...
UCLASS(MinimalAPI)
class UBasic2DLineSetComponent final : public UBasicLineSetComponentBase, public TBasicElementSet<FVector2f, 2>
{
	GENERATED_BODY()
...
UCLASS(MinimalAPI)
class UBasic3DLineSetComponent final : public UBasicLineSetComponentBase, public TBasicElementSet<FVector3f, 2>
{
	GENERATED_BODY()
