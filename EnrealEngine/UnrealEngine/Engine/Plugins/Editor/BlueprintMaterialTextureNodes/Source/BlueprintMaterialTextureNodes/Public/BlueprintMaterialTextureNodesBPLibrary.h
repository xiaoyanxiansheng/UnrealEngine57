...
#define UE_API BLUEPRINTMATERIALTEXTURENODES_API
...
class UBlueprintMaterialTextureNodesBPLibrary : public UBlueprintFunctionLibrary
{
	...
	*/
	...
	static UE_API FLinearColor Texture2D_SampleUV_EditorOnly(UTexture2D* Texture, FVector2D UV);
	...
	*/
	...
	static UE_API TArray<FLinearColor> RenderTarget_SampleRectangle_EditorOnly(UTextureRenderTarget2D* InRenderTarget, FLinearColor InRect);
	...
	*/
	...
	static UE_API FLinearColor RenderTarget_SampleUV_EditorOnly(UTextureRenderTarget2D* InRenderTarget, FVector2D UV);
	...
	*/
	...
	static UE_API UMaterialInstanceConstant* CreateMIC_EditorOnly(UMaterialInterface* Material, FString Name = "MIC_");

	UFUNCTION()
	static UE_API void UpdateMIC(UMaterialInstanceConstant* MIC);
	...
	*/
	...
	static UE_API bool SetMICScalarParam_EditorOnly(UMaterialInstanceConstant* Material, FString ParamName = "test", float Value = 0.0f);
	...
	*/
	...
	static UE_API bool SetMICVectorParam_EditorOnly(UMaterialInstanceConstant* Material, FString ParamName, FLinearColor Value = FLinearColor(0, 0, 0, 0));
	...
	*/
	...
	static UE_API bool SetMICTextureParam_EditorOnly(UMaterialInstanceConstant* Material, FString ParamName, UTexture2D* Texture = nullptr);
	...
	*/
	...
	static UE_API bool SetMICShadingModel_EditorOnly(UMaterialInstanceConstant* Material, TEnumAsByte<EMaterialShadingModel> ShadingModel = MSM_DefaultLit);
	...
	*/
	...
	static UE_API bool SetMICBlendMode_EditorOnly(UMaterialInstanceConstant* Material, TEnumAsByte<EBlendMode> BlendMode = BLEND_Opaque);
	...
	*/
	...
	static UE_API bool SetMICTwoSided_EditorOnly(UMaterialInstanceConstant* Material, bool TwoSided = false);
	...
	*/
	...
	static UE_API bool SetMICIsThinSurface_EditorOnly(UMaterialInstanceConstant* Material, bool bIsThinSurface = false);	
	...
	*/
	...
	static UE_API bool SetMICDitheredLODTransition_EditorOnly(UMaterialInstanceConstant* Material, bool DitheredLODTransition = false);
};
