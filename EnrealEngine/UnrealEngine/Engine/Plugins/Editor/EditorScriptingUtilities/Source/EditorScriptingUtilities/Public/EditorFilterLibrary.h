...
public:
	...
	static UE_API TArray<class UObject*> ByClass(const TArray<class UObject*>& TargetArray
	...
	static UE_API TArray<class UObject*> ByIDName(const TArray<class UObject*>& TargetArray
	...
	static UE_API TArray<class AActor*> ByActorLabel(const TArray<class AActor*>& TargetArray
		, const FString& NameSubString
		, EEditorScriptingStringMatchType StringMatch = EEditorScriptingStringMatchType::Contains
		, EEditorScriptingFilterType FilterType = EEditorScriptingFilterType::Include
	...
	static UE_API TArray<class AActor*> ByActorTag(const TArray<class AActor*>& TargetArray, FName Tag, EEditorScriptingFilterType FilterType = EEditorScriptingFilterType::Include);
	...
	static UE_API TArray<class AActor*> ByLayer(const TArray<class AActor*>& TargetArray, FName LayerName, EEditorScriptingFilterType FilterType = EEditorScriptingFilterType::Include);
	...
	static UE_API TArray<class AActor*> ByLevelName(const TArray<class AActor*>& TargetArray, FName LevelName, EEditorScriptingFilterType FilterType = EEditorScriptingFilterType::Include);
	...
	static UE_API TArray<class AActor*> BySelection(const TArray<class AActor*>& TargetArray, EEditorScriptingFilterType FilterType = EEditorScriptingFilterType::Include);
};
