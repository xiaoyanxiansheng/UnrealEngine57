...
public:
	...
	static UE_API UObject* LoadAsset(const FString& AssetPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API UClass* LoadBlueprintClass(const FString& AssetPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API FString GetPathNameForLoadedAsset(UObject* LoadedAsset);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API FAssetData FindAssetData(const FString& AssetPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool DoesAssetExist(const FString& AssetPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool DoAssetsExist(const TArray<FString>& AssetPaths);
	...
	static UE_API UPackage* GetPackageForObject(UPARAM(Required) UObject* Object);
public:
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API TArray<FString> FindPackageReferencersForAsset(const FString& AssetPath, bool bLoadAssetsToConfirm = false);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool ConsolidateAssets(UObject* AssetToConsolidateTo, const TArray<UObject*>& AssetsToConsolidate);
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool DeleteLoadedAsset(UObject* AssetToDelete);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool DeleteLoadedAssets(const TArray<UObject*>& AssetsToDelete);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool DeleteAsset(const FString& AssetPathToDelete);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool DeleteDirectory(const FString& DirectoryPath);
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API UObject* DuplicateLoadedAsset(UObject* SourceAsset, const FString& DestinationAssetPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API UObject* DuplicateAsset(const FString& SourceAssetPath, const FString& DestinationAssetPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool DuplicateDirectory(const FString& SourceDirectoryPath, const FString& DestinationDirectoryPath);
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool RenameLoadedAsset(UObject* SourceAsset, const FString& DestinationAssetPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool RenameAsset(const FString& SourceAssetPath, const FString& DestinationAssetPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool RenameDirectory(const FString& SourceDirectoryPath, const FString& DestinationDirectoryPath);
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool CheckoutLoadedAsset(UObject* AssetToCheckout);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool CheckoutLoadedAssets(const TArray<UObject*>& AssetsToCheckout);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool CheckoutAsset(const FString& AssetToCheckout);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool CheckoutDirectory(const FString& DirectoryPath, bool bRecursive = true);
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool SaveLoadedAsset(UObject* AssetToSave, bool bOnlyIfIsDirty = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool SaveLoadedAssets(const TArray<UObject*>& AssetsToSave, bool bOnlyIfIsDirty = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool SaveAsset(const FString& AssetToSave, bool bOnlyIfIsDirty = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool SaveDirectory(const FString& DirectoryPath, bool bOnlyIfIsDirty = true, bool bRecursive = true);
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool DoesDirectoryExist(const FString& DirectoryPath);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool DoesDirectoryHaveAssets(const FString& DirectoryPath, bool bRecursive = true);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API bool MakeDirectory(const FString& DirectoryPath);
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API TArray<FString> ListAssets(const FString& DirectoryPath, bool bRecursive = true, bool bIncludeFolder = false);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API TArray<FString> ListAssetByTagValue(FName TagName, const FString& TagValue);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Asset")
	static UE_API TMap<FName, FString> GetTagValues(const FString& AssetPath);
	...
	static UE_API FString GetProjectRootAssetDirectory();

	/** These are intentionally not exposed to scripts, used by editor state machines: */
	static UE_API void OverrideProjectRootAssetDirectory(FStringView InProjectRootAssetDirectory);
	static UE_API void ResetProjectRootAssetDirectory();
public:
	/**
	...
	static UE_API TMap<FName, FString> GetMetadataTagValues(UObject* Object);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Metadata")
	static UE_API FString GetMetadataTag(UObject* Object, FName Tag);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Metadata")
	static UE_API void SetMetadataTag(UObject* Object, FName Tag, const FString& Value);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Metadata")
	static UE_API void RemoveMetadataTag(UObject* Object, FName Tag);
...
public:
	...
	static UE_API void SyncBrowserToObjects(const TArray<FString>& AssetPaths);
};
