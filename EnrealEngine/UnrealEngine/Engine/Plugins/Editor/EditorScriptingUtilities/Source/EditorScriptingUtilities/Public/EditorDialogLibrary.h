 ...
 */
UCLASS(MinimalAPI, meta=(ScriptName="EditorDialog"))
...
public:
	...
	*/
	...
	static UE_API TEnumAsByte<EAppReturnType::Type> ShowMessage(const FText& Title, const FText& Message, TEnumAsByte<EAppMsgType::Type> MessageType, TEnumAsByte<EAppReturnType::Type> DefaultValue = EAppReturnType::Type::No, EAppMsgCategory MessageCategory = EAppMsgCategory::Warning);
	...
	*/
	...
	static UE_API bool ShowSuppressableWarningDialog(const FText& Title, const FText& Message, const FString& InIniSettingName, const FString& InIniSettingFileNameOverride = TEXT(""), bool bDefaultValue = true);
	...
	*/
	...
	static UE_API bool ShowObjectDetailsView(const FText& Title, UObject* InOutObject, const FEditorDialogLibraryObjectDetailsViewOptions& Options = FEditorDialogLibraryObjectDetailsViewOptions());
	...
	*/
	...
	static UE_API bool ShowObjectsDetailsView(const FText& Title, const TArray<UObject*>& InOutObjects, const FEditorDialogLibraryObjectDetailsViewOptions& Options = FEditorDialogLibraryObjectDetailsViewOptions());
};
