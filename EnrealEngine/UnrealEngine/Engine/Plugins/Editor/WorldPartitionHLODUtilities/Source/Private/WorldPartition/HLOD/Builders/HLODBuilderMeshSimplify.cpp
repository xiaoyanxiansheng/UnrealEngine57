...
void UHLODBuilderMeshSimplifySettings::ComputeHLODHash(FHLODHashBuilder& InHashBuilder) const
{
	// Base mesh simplify key, changing this will force a rebuild of all HLODs from this builder
	FString HLODBaseKey = TEXT("833ECCC91448424CACC620661712928A");
	InHashBuilder.HashField(HLODBaseKey, TEXT("MeshSimplifyBaseKey"));

	InHashBuilder.HashField(MeshSimplifySettings, TEXT("MeshSimplifySettingsHash"));

	IMaterialBakingModule& Module = FModuleManager::Get().LoadModuleChecked<IMaterialBakingModule>("MaterialBaking");
	uint32 MaterialBakingModuleCRC = Module.GetCRC();
	InHashBuilder.HashField(MaterialBakingModuleCRC, TEXT("MaterialBakingModuleCRC"));
