...
void UHLODBuilderMeshApproximateSettings::ComputeHLODHash(FHLODHashBuilder& InHashBuilder) const
{
	// Base key, changing this will force a rebuild of all HLODs from this builder
	FString HLODBaseKey = TEXT("4E9BB187B38645A08B424895C5268B8A");
	InHashBuilder.HashField(HLODBaseKey, TEXT("MeshApproximateBaseKey"));
	InHashBuilder.HashField(MeshApproximationSettings, TEXT("MeshApproximationSettingsHash"));
