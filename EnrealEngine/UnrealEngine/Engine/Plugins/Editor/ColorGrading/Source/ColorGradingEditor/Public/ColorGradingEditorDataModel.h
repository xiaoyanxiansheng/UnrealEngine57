...
class IColorGradingEditorDataModelGenerator : public TSharedFromThis<IColorGradingEditorDataModelGenerator>
{
public:
...
private:
	...
	static UE_API TMap<TWeakObjectPtr<UClass>, FGetDetailsDataModelGenerator> RegisteredDataModelGenerators;
...
public:
	UE_API FColorGradingEditorDataModel();
	...
	UE_API FColorGradingGroup* GetSelectedColorGradingGroup();

	/** Sets the selected color grading group */
	UE_API void SetSelectedColorGradingGroup(int32 InColorGradingGroupIndex);
	...
	UE_API FColorGradingElement* GetSelectedColorGradingElement();

	/** Sets the selected color grading element */
	UE_API void SetSelectedColorGradingElement(int32 InColorGradingElementIndex);
