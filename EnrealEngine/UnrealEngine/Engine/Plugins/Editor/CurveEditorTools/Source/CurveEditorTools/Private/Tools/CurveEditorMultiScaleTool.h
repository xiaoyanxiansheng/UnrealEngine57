...
private:
	...
	/**
	 * Calls SetKeyPositions with FKeyData::LastDraggedKeyPositions and EPropertyChangeType::ValueSet tro trigger any final operations.
	 * 
	 * Some FCurveModels, such as Sequencer's FCurveChannelModel, perform special operations with EPropertyChangeType::ValueSet, e.g. cleansing of
	 * stacked values.
	 * 
	 * Called at end of drag.
	 */
	void ApplyLastKeyPositions();
...
private:
	...
	TUniquePtr<UE::CurveEditor::FScopedCurveChange> ActiveTransaction;
