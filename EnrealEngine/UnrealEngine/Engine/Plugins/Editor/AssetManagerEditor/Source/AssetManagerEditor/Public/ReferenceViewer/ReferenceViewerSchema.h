...
private:
	...
	void GetMakeCollectionWithSubMenu(UToolMenu* Menu, TWeakPtr<class SReferenceViewer> ReferenceViewer, TArray<TSharedPtr<ICollectionContainer>> CollectionContainers) const;

	/** Constructs the sub-menu for Make Collection With collection containers*/
	void GetMakeCollectionWithCollectionContainersSubMenu(UToolMenu* Menu, TWeakPtr<class SReferenceViewer> ReferenceViewer, TArray<TSharedPtr<ICollectionContainer>> CollectionContainers, bool bReferencers) const;

	/** Constructs the sub-menu for Make Collection With Referencers/Dependencies */
	void GetMakeCollectionWithReferencersOrDependenciesSubMenu(UToolMenu* Menu, bool bReferencers) const;
	void GetMakeCollectionWithReferencersOrDependenciesSubMenu(UToolMenu* Menu, TWeakPtr<class SReferenceViewer> ReferenceViewer, TSharedPtr<ICollectionContainer> CollectionContainer, bool bReferencers) const;
};
