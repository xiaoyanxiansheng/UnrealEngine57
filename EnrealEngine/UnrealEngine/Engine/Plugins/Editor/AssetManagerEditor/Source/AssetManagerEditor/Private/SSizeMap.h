...
protected:
	...
	void GetMakeCollectionWithDependenciesCollectionContainersSubMenu(class FMenuBuilder& MenuBuilder, TArray<TSharedPtr<ICollectionContainer>> CollectionContainers);
	void GetMakeCollectionWithDependenciesShareTypeSubMenu(class FMenuBuilder& MenuBuilder);
	void GetMakeCollectionWithDependenciesShareTypeSubMenu(class FMenuBuilder& MenuBuilder, TSharedPtr<ICollectionContainer> CollectionContainer);
	...
	bool CanMakeCollectionWithDependencies(ECollectionShareType::Type ShareType) const;
	void MakeCollectionWithDependencies(ECollectionShareType::Type ShareType);
	bool CanMakeCollectionWithDependencies(TSharedPtr<ICollectionContainer> CollectionContainer, ECollectionShareType::Type ShareType) const;
	void MakeCollectionWithDependencies(TSharedPtr<ICollectionContainer> CollectionContainer, ECollectionShareType::Type ShareType);
