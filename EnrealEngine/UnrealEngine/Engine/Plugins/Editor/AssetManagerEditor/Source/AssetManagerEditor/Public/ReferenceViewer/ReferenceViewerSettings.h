...
public:
	...
	const TMap<FString, bool>& GetCustomFilters() const;
	void SetCustomFilters(const TMap<FString, bool>& InCustomFilters);
...
private:
	...
	/* The list of reference viewer specific filters the user has built up */
	UPROPERTY(config)
