...
/** Widget for removing unused gameplay tags */
class SCleanupUnusedGameplayTagsWidget : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SCleanupUnusedGameplayTagsWidget) {}
	SLATE_END_ARGS();
