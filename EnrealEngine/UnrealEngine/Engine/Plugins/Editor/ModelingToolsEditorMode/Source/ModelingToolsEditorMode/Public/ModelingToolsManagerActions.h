...
UE_DECLARE_TCOMMANDS(class FModelingToolsManagerCommands, MODELINGTOOLSEDITORMODE_API)
...
{
public:
	MODELINGTOOLSEDITORMODE_API FModelingToolsManagerCommands();
...
public:
	 ...
	 */
	MODELINGTOOLSEDITORMODE_API TSharedPtr<FUICommandInfo> FindToolByName(FString Name, bool& bFound) const;
	 ...
	 */
	MODELINGTOOLSEDITORMODE_API FText GetCommandLabel(TSharedPtr<const FUICommandInfo> Command, bool bShortName) const;
	 ...
	 */
	MODELINGTOOLSEDITORMODE_API virtual void RegisterCommands() override;
	 ...
	 */
	static MODELINGTOOLSEDITORMODE_API TSharedPtr<FUICommandInfo> RegisterExtensionPaletteCommand(
		FName Name,
		const FText& Label,
		const FText& Tooltip,
