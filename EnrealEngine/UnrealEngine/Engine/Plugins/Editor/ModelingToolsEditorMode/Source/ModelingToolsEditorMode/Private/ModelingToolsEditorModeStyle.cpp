...
void FModelingToolsEditorModeStyle::Initialize()
{
	...
	// Tool Manager icons
	{
		...
		StyleSet->Set("BrushTypeIcons.InflateSt", new IMAGE_BRUSH_SVG("Icons/BrushIcons/Brush_Inflate", Icon120));
		StyleSet->Set("BrushTypeIcons.InflateMax", new IMAGE_BRUSH_SVG("Icons/BrushIcons/Brush_Inflate", Icon120)); // TODO: Need a new icon for this one
