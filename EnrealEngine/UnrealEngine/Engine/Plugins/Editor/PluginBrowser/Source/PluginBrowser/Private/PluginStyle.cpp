...
void FPluginStyle::Initialize()
{
	...
	FString ThumbnailImageFallBack = IPluginManager::Get().FindPlugin(TEXT("PluginBrowser"))->GetBaseDir() / TEXT("Resources/DefaultIcon128.png");
	StyleSet->Set( "PluginTile.ThumbnailImageFallBack", new FSlateImageBrush(ThumbnailImageFallBack, CoreStyleConstants::Icon128x128) );
