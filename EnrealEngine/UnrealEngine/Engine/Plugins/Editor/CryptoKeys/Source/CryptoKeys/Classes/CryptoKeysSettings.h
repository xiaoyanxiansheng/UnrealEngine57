...
*/
UCLASS(MinimalAPI, config = Crypto, defaultconfig)
...
public:
	...
	UE_API UCryptoKeysSettings();

	//~ Begin UObject Interface
	UE_API virtual void PostEditChangeProperty(struct FPropertyChangedEvent& PropertyChangedEvent);
