...
FReply SWaveformTransformationRenderLayer::OnKeyUp(const FGeometry& MyGeometry, const FKeyEvent& InKeyEvent)
{
	return TransformationRenderer->OnKeyUp(MyGeometry, InKeyEvent);
}
