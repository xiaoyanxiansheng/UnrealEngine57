...
{
	class FRealTimeStylusPluginAsync final : public IStylusAsyncPlugin, public FRealTimeStylusPluginBase
	{
	public:
		FRealTimeStylusPluginAsync(IStylusInputInstance* Instance, FGetWindowContextCallback&& GetWindowContext,
		...
		virtual ~FRealTimeStylusPluginAsync() override;
