...
namespace UE::StylusInput::Mac
{
	...
	public:
		...
		virtual FString GetName() const override { return ProductName; }

		virtual uint32 GetProductID() const { return ProductID; }
		virtual FString GetVendorName() const { return VendorName; }
		virtual uint32 GetVendorID() const { return VendorID; }
		virtual FString GetSerialNumber() const { return SerialNumber; }
