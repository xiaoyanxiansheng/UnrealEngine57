...
#include "Windows/EditorSysConfigFeatureUSNJournal.h"
#endif
...
private:
	...
	FEditorSysConfigFeatureUSNJournal USNJournalFeature;
...
void FEditorSysConfigAssistantModule::StartupModule()
{
	...
	IModularFeatures::Get().RegisterModularFeature(USNJournalFeature.GetModularFeatureName(), &USNJournalFeature);
#endif // PLATFORM_WINDOWS
}
...
{
#if PLATFORM_WINDOWS
	IModularFeatures::Get().UnregisterModularFeature(USNJournalFeature.GetModularFeatureName(), &USNJournalFeature);
