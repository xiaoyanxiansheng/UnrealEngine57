...
public:
	...
	UE_API virtual void PostAction(EGenerateLODAssetToolPresetAction Action);
 ...
 */
UCLASS(MinimalAPI)
class UGenerateStaticMeshLODAssetToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
...
public:
	...
	UE_API virtual void SetUseAssetEditorMode(bool bEnable);

	// Enable restrictive mode. Must be called before Setup.
	UE_API virtual void SetRestrictiveMode(bool bEnable);

	UE_API virtual void Setup() override;
	UE_API virtual void OnShutdown(EToolShutdownType ShutdownType) override;

	UE_API virtual void OnTick(float DeltaTime);

	virtual bool HasCancel() const override { return true; }
	virtual bool HasAccept() const override { return true; }
	UE_API virtual bool CanAccept() const override;

	UE_API virtual void RequestPresetAction(EGenerateLODAssetToolPresetAction ActionType);
...
protected:
	...
	UE_API void OnPresetSelectionChanged();

	UE_API bool ValidateSettings() const;
};
