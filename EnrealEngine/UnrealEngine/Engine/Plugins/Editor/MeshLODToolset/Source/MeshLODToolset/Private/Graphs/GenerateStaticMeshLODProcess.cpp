...
bool UGenerateStaticMeshLODProcess::InitializeGenerator()
{
	...
	CurrentSettings_Texture.BakeResolution = (EGenerateStaticMeshLODBakeResolution)Generator->GetCurrentBakeCacheSettings().Dimensions.X;
	...
	FMeshSimpleShapeApproximation::EProjectedHullAxisMode RHSMode = static_cast<FMeshSimpleShapeApproximation::EProjectedHullAxisMode>(SimpleCollisionSettings.SweptHullSettings.SweepAxis);
...
void UGenerateStaticMeshLODProcess::UpdateSimplifySettings(const FGenerateStaticMeshLODProcess_SimplifySettings& NewCombinedSettings)
{
		...
		NewCombinedSettings.Tolerance != CurrentSettings_Simplify.Tolerance )
	{
		...
		NewSimplifySettings.TargetType = ToUEnum(static_cast<UE::GeometryFlow::EMeshSimplifyTargetType>(NewCombinedSettings.Method));
...
void UGenerateStaticMeshLODProcess::UpdateNormalsSettings(const FGenerateStaticMeshLODProcess_NormalsSettings& NewCombinedSettings)
{
		...
		NewCombinedSettings.Angle != CurrentSettings_Normals.Angle )
	{
		...
		NewNormalsSettings.NormalsType = ToUEnum(static_cast<UE::GeometryFlow::EComputeNormalsType>(
...
void UGenerateStaticMeshLODProcess::UpdateTextureSettings(const FGenerateStaticMeshLODProcess_TextureSettings& NewCombinedSettings)
{
		 ...
		 (NewCombinedSettings.bCombineTextures != CurrentSettings_Texture.bCombineTextures))
	{
		...
		NewBakeSettings.Dimensions = FIntPoint((int32)NewCombinedSettings.BakeResolution, (int32)NewCombinedSettings.BakeResolution);
...
void UGenerateStaticMeshLODProcess::UpdateUVSettings(const FGenerateStaticMeshLODProcess_UVSettings& NewCombinedSettings)
{
		...
		|| NewCombinedSettings.PatchBuilder.SmoothingAlpha != CurrentSettings_UV.PatchBuilder.SmoothingAlpha  ) 
	{
		...
		NewAutoUVSettings.Method = ToUEnum( (EAutoUVMethod)(int)NewCombinedSettings.UVMethod);
...
void UGenerateStaticMeshLODProcess::UpdateCollisionSettings(const FGenerateStaticMeshLODProcess_CollisionSettings& NewCombinedSettings)
{
		...
		NewCombinedSettings.CollisionType != CurrentSettings_Collision.CollisionType)
	{
		...
		NewGenCollisionSettings.Type = static_cast<EGeometryFlow_SimpleCollisionGeometryType>(NewCombinedSettings.CollisionType);
		...
		NewGenCollisionSettings.SweptHullSettings.SweepAxis = static_cast<EGeometryFlow_ProjectedHullAxisMode>(NewCombinedSettings.SweepAxis);
...
bool UGenerateStaticMeshLODProcess::WriteDerivedTexture(UTexture2D* DerivedTexture, FString BaseTexName, bool bCreatingNewStaticMeshAsset)
{
	...
	DerivedTexture->GetPackage()->GetMetaData().SetValue(DerivedTexture, TEXT("StaticMeshLOD.IsBakedTexture"), TEXT("true"));
	DerivedTexture->GetPackage()->GetMetaData().SetValue(DerivedTexture, TEXT("StaticMeshLOD.SourceAssetPath"), *GetSourceAssetPath());
	DerivedTexture->GetPackage()->GetMetaData().SetValue(DerivedTexture, TEXT("StaticMeshLOD.GenerationGUID"), *DerivedAssetGUIDKey);
...
void UGenerateStaticMeshLODProcess::WriteDerivedMaterials(bool bCreatingNewStaticMeshAsset)
{
	...
	for (int32 mi = 0; mi < NumMaterials; ++mi)
	{
		...
		{
			// set metadata tag so we can identify this material later
			GeneratedMIC->GetPackage()->GetMetaData().SetValue(GeneratedMIC, TEXT("StaticMeshLOD.IsGeneratedMaterial"), TEXT("true"));
			GeneratedMIC->GetPackage()->GetMetaData().SetValue(GeneratedMIC, TEXT("StaticMeshLOD.SourceAssetPath"), *GetSourceAssetPath());
			GeneratedMIC->GetPackage()->GetMetaData().SetValue(GeneratedMIC, TEXT("StaticMeshLOD.GenerationGUID"), *DerivedAssetGUIDKey);
...
void UGenerateStaticMeshLODProcess::WriteDerivedStaticMeshAsset()
{
	...
	GeneratedStaticMesh->GetPackage()->GetMetaData().SetValue(GeneratedStaticMesh, TEXT("StaticMeshLOD.IsGeneratedMesh"), TEXT("true"));
	GeneratedStaticMesh->GetPackage()->GetMetaData().SetValue(GeneratedStaticMesh, TEXT("StaticMeshLOD.SourceAssetPath"), *GetSourceAssetPath());
	GeneratedStaticMesh->GetPackage()->GetMetaData().SetValue(GeneratedStaticMesh, TEXT("StaticMeshLOD.GenerationGUID"), *DerivedAssetGUIDKey);
...
void UGenerateStaticMeshLODProcess::UpdateSourceStaticMeshAsset(bool bSetNewHDSourceAsset)
{
	...
	SourceStaticMesh->GetPackage()->GetMetaData().SetValue(SourceStaticMesh, TEXT("StaticMeshLOD.GenerationGUID"), *DerivedAssetGUIDKey);
