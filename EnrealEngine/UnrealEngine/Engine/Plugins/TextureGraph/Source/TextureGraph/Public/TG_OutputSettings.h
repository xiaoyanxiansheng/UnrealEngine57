...
UCLASS(MinimalAPI)
class UTG_ExportSettings : public UObject
{
	GENERATED_BODY()
...
struct FTG_OutputSettings
{
	...
	UE_API void Initialize(FString PathName, FName InName = "Output");
	...
	UE_API void Set(int InWidth, int InHeight, FName Name = "None", FName Path = "None", ETG_TextureFormat Format = ETG_TextureFormat::BGRA8, ETG_TexturePresetType InTextureType = ETG_TexturePresetType::None,
	...
	UE_API void OnSetTexturePresetType(ETG_TexturePresetType Type);
	UE_API bool Validate(FString& OutErrors) const;
};
