...
protected:
	...
	UE_API virtual float						EvaluateScalar(FTG_EvaluationContext* InContext);
	UE_API virtual FVector4f					EvaluateVector(FTG_EvaluationContext* InContext);
	UE_API virtual FLinearColor				EvaluateColor(FTG_EvaluationContext* InContext);
