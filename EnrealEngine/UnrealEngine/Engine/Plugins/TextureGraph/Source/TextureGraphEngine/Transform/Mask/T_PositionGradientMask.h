...
{
public:
	DECLARE_EXPORTED_GLOBAL_SHADER(FSH_PositionGradientMask, UE_API);
...
{
public:
	DECLARE_EXPORTED_GLOBAL_SHADER(FSH_CombineDisplacementAndWorldPos, UE_API);
 ...
 * 
 */
class T_PositionGradientMask
{
public:
	UE_API T_PositionGradientMask();
	UE_API ~T_PositionGradientMask();
