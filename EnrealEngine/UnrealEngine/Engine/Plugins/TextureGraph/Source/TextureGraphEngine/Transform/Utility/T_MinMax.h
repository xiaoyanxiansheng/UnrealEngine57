...
{
public:
	DECLARE_EXPORTED_GLOBAL_SHADER(FSH_MinMaxDownsample, UE_API);
...
{
public:
	DECLARE_EXPORTED_GLOBAL_SHADER(CSH_MinMaxDownsample, UE_API);
...
/// Static functions
//////////////////////////////////////////////////////////////////////////=
	static UE_API TiledBlobPtr				Create(MixUpdateCyclePtr Cycle, TiledBlobPtr SourceTex, int32 TargetId, bool bUseMeshUVMask = false);
};
