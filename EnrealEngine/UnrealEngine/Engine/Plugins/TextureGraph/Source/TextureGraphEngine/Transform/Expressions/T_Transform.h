...
//////////////////////////////////////////////////////////////////////////
class FSH_TransformBlit : public FSH_Base
{
public:
	SHADER_USE_PARAMETER_STRUCT(FSH_TransformBlit, FSH_Base);
	DECLARE_EXPORTED_GLOBAL_SHADER(FSH_TransformBlit, UE_API);
...
public:
	...
	static UE_API TiledBlobPtr		Create(MixUpdateCyclePtr Cycle, BufferDescriptor DesiredOutputDesc, TiledBlobPtr Source,
