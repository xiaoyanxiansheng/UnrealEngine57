...
{
public:
	DECLARE_EXPORTED_GLOBAL_SHADER(CSH_MipMapDownsample, UE_API);
...
public:
	...
	static UE_API TiledBlobPtr				Create(MixUpdateCyclePtr Cycle, TiledBlobPtr SourceTex, int32 TargetId, int32 GenMipLevel = -1);
};
