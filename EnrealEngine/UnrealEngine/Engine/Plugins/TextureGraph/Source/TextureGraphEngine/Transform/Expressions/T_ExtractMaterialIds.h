...
//////////////////////////////////////////////////////////////////////////
class Job_ExtractMaterialIds : public Job
{
private:
...
public:
	UE_API Job_ExtractMaterialIds(int32 targetId, TiledBlobRef InSourceTexture, FMaterialIDCollection& MaterialIDInfoCollection, TArray<FMaterialIDMaskInfo>& InMaterialIDMaskInfo, int32& ActiveColorsCount, UObject* InErrorOwner = nullptr, uint16 priority = (uint16)E_Priority::kHigh, uint64 id = 0);
 ...
 * 
 */
class T_ExtractMaterialIds
{
public:
	UE_API T_ExtractMaterialIds();
	UE_API ~T_ExtractMaterialIds();
	...
	static UE_API TiledBlobPtr Create(MixUpdateCyclePtr InCycle, TiledBlobPtr MaterialIDTexture, FMaterialIDCollection& MaterialIDCollection, TArray<FMaterialIDMaskInfo>& InMaterialIDMaskInfo, int32& ActiveColorsCount, int InTargetId);
};
