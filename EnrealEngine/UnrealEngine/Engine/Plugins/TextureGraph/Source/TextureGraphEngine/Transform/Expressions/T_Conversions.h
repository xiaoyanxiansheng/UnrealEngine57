...
//////////////////////////////////////////////////////////////////////////
class FSH_NormalFromHeightMap : public FSH_Base
{
public:
	SHADER_USE_PARAMETER_STRUCT(FSH_NormalFromHeightMap, FSH_Base);
	DECLARE_EXPORTED_GLOBAL_SHADER(FSH_NormalFromHeightMap, UE_API);
...
public:
	...
	//////////////////////////////////////////////////////////////////////////
	///
	static UE_API TiledBlobPtr				CreateNormalFromHeightMap(MixUpdateCyclePtr InCycle, TiledBlobPtr HeightMapTexture, float Offset, float Strength, int InTargetId, BufferDescriptor DesiredOutputDesc);
};
