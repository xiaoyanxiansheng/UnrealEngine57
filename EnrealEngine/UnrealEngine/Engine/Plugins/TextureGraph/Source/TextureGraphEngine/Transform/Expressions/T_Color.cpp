...
IMPLEMENT_GLOBAL_SHADER(FSH_ColorCorrection, "/Plugin/TextureGraph/Expressions/Expression_ColorCorrection.usf", "FSH_ColorCorrection", SF_Pixel);
IMPLEMENT_GLOBAL_SHADER(FSH_Premult, "/Plugin/TextureGraph/Expressions/Expression_Premult.usf", "FSH_Premult", SF_Pixel);
