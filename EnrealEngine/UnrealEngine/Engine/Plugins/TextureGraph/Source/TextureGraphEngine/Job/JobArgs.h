...
public:
	...
	UE_API virtual bool					ForceNonTiledTransform() const;
...
//////////////////////////////////////////////////////////////////////////
class JobArg_Resource : public JobArg
{
protected:
...
//////////////////////////////////////////////////////////////////////////
class JobArg_Blob : public JobArg_Resource
{
protected:
	...
	UE_API TiledBlobPtr					GetRootBlob(JobArgBindInfo JobBindInfo) const;

public:
									UE_API JobArg_Blob(TiledBlobPtr blob, const ResourceBindInfo& BindInfo);
									UE_API JobArg_Blob(TiledBlobPtr BlobObj, const char* TargetName);

	UE_API virtual							~JobArg_Blob() override;
	UE_API virtual void					SetHandleTiles(bool bInCanHandleTiles);
	UE_API virtual bool					CanHandleTiles() const override;
	UE_API JobArg_Blob&					WithNotHandleTiles(); // equivalent to call  SetHandleTiles(false)


	UE_API virtual void					SetForceNonTiledTransform(bool bInForceNonTiledTransform);
	UE_API virtual bool					ForceNonTiledTransform() const override;

	UE_API JobArg_Blob&					WithDownsampled4To1();
	UE_API bool							IsDownsampled4To1() const;

	UE_API JobArg_Blob&					WithNeighborTiles();
	UE_API bool							IsNeighborTiles() const;

	UE_API JobArg_Blob&					WithArrayOfTiles();
	UE_API bool							IsArrayOfTiles() const;

	UE_API virtual AsyncJobArgResultPtr	Bind(JobArgBindInfo JobBindInfo) override;
	UE_API virtual AsyncJobArgResultPtr	Unbind(JobArgBindInfo JobBindInfo) override;

	UE_API virtual CHashPtr				Hash() const override;
	UE_API virtual CHashPtr				TileHash(uint32 TileX, uint32 TileY) const override;

	UE_API virtual bool					IsLateBound(uint32 TileX, uint32 TileY) const override;
	UE_API virtual bool					IsBlob() const override { return true; }

	UE_API virtual JobPtrW					GeneratingJob() const override;
	UE_API virtual const BufferDescriptor* GetDescriptor() const override;
...
class JobArg_String : public JobArg_SimpleType<FString>
{
public:
...
//////////////////////////////////////////////////////////////////////////
class RenderMesh;
class JobArg_Mesh : public JobArg
{
private:
...
class JobArg_Array : public JobArg_Resource
{
protected:
...
class JobArg_Struct: public JobArg_Resource
{
...
class JobArg_TileInfo : public JobArg_Struct<FTileInfo>
{
...
class JobArg_ForceTiling : public JobArg
{
protected:
public:
