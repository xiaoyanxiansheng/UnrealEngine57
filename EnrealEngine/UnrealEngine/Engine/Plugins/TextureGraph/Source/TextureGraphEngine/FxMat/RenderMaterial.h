...
class RenderMaterial : public BlobTransform
{
protected:
	bool							bCanHandleTiles = true;		/// Whether this material can handle tiles or not

public:
	UE_API explicit						RenderMaterial(FString Name);
	UE_API virtual							~RenderMaterial() override;
	...
	UE_API void							BlitTo(FRHICommandListImmediate& RHI, UTextureRenderTarget2D* Dst) const;
	...
	UE_API virtual ENamedThreads::Type		ExecutionThread() const override;
	...
	UE_API void							SetSourceTexture(const Tex* Texture) const;
	UE_API void							SetTexture(FName InName, std::shared_ptr<Tex> TexObj) const;
	UE_API void							SetArrayTexture(FName InName, const std::vector<std::shared_ptr<Tex>>& TexObj) const;
	UE_API void							BlitTo(FRHICommandListImmediate& RHI, Tex* Dst, const RenderMesh* MeshObj = nullptr, int32 TargetId = -1) const;
	//////////////////////////////////////////////////////////////////////////
	/// Inline functions
	//////////////////////////////////////////////////////////////////////////
