...
public:
	...
	using FEdGraphSchemaAction::PerformAction; // Prevent hiding of FVector2D deprecated function in base class
	...
	static UEdGraphNode* CreateExpressionNode(UEdGraph* ParentGraph, const UClass* ExpressionClass, UEdGraphPin* FromPin,  const UE::Slate::FDeprecateVector2DParameter& Location, bool bSelectNewNode = true);
	static UEdGraphNode* CreateExpressionNode(UEdGraph* ParentGraph, UTG_Expression* Expression, UEdGraphPin* FromPin, const UE::Slate::FDeprecateVector2DParameter& Location, bool bSelectNewNode = true);
};
