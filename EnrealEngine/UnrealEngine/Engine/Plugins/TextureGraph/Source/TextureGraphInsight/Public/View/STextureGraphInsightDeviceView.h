...
public:
	...
	UE_API void OnInspect(FItem item);
	...
	UE_API void OnDeviceBufferAdded(const RecordIDArray& rids);
	UE_API void OnDeviceBufferRemoved(const RecordIDArray& rids);
...
class STextureGraphInsightDeviceManagerView : public SCompoundWidget
{
	...
	UE_API void Reset(); // Rebuild the full ui of this widget, called by update
