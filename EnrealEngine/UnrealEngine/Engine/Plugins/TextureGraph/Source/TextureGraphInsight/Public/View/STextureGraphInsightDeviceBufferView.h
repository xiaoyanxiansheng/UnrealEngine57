...
class STextureGraphInsightDeviceBufferView : public SBorder, public FGCObject /// Need FGCObject to control garbage collection of objects
{
public:
	...
	UE_API void CreateWidgetBrush(UTexture* blobTexture);
	UE_API void MakeWidgetMaterial();
