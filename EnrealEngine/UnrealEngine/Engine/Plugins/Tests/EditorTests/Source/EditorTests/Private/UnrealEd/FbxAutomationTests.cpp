		...
		switch (TestPlan->Action)
		{
			...
			case EFBXTestPlanActionType::Reimport:
			{
				...
				if (GlobalImportedObjects[0]->IsA(UStaticMesh::StaticClass()))
				{
					...
					UFbxStaticMeshImportData* ImportData = Cast<UFbxStaticMeshImportData>(ReimportStaticMesh->GetAssetImportData());
			...
			case EFBXTestPlanActionType::ReimportLOD:
			{
				...
				if (GlobalImportedObjects[0]->IsA(UStaticMesh::StaticClass()))
				{
					...
					UFbxStaticMeshImportData* ImportData = Cast<UFbxStaticMeshImportData>(ExistingStaticMesh->GetAssetImportData());
