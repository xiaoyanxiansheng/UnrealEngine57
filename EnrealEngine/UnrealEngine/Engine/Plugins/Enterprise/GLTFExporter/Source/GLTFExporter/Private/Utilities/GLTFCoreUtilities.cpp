...
FGLTFVector3 FGLTFCoreUtilities::ConvertNormalDelta(const FVector3f& NormalDelta)
{
	return ConvertVector(NormalDelta);
}

FGLTFInt8Vector4 FGLTFCoreUtilities::ConvertNormalDelta(const FPackedNormal& NormalDelta)
{
	return { NormalDelta.Vector.X, NormalDelta.Vector.Z, NormalDelta.Vector.Y, 0 };
}

FGLTFInt16Vector4 FGLTFCoreUtilities::ConvertNormalDelta(const FPackedRGBA16N& NormalDelta)
{
	return { NormalDelta.X, NormalDelta.Z, NormalDelta.Y, 0 };
}
