...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Lidar Point Cloud")
	inline float GetEstimatedPointSpacing() const { return Octree.GetEstimatedPointSpacing(); }
	...
	template <typename T>
	void GetSelectedPointsAsCopies_Internal(TArray<FLidarPointCloudPoint, T>& SelectedPoints, FTransform Transform) const;
