...
public:
	...
	inline void AddPoint(const FVector& Location, const float& R, const float& G, const float& B, const float& A = 1.0f)
	{
...
private:
	...
	static TMap<FString, FLidarPointCloudFileIOHandler*> RegisteredHandlers;
