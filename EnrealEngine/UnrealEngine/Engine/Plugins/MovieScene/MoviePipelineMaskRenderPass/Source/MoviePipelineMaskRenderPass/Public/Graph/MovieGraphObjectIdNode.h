...
class UMovieGraphObjectIdNode final : public UMovieGraphImagePassBaseNode
{
	GENERATED_BODY()
...
public:
	...
	UE_API virtual bool GetAllowsShowFlagsCustomization() const override;
	UE_API virtual bool GetAllowsCompositing() const override;
	UE_API virtual bool GetForceLosslessCompression() const override;
	...
	UE_API virtual TArray<TPair<FName, UClass*>> GetHiddenProperties() const override;
#endif
	// ~UMovieGraphNode Interface
