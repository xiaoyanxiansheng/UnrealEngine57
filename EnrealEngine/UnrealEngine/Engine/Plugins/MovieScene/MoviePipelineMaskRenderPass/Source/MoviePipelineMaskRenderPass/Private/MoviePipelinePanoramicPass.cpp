...
FIntPoint UMoviePipelinePanoramicPass::GetPaneResolution(const FIntPoint& InSize) const
{
	...
	// Clamp them to a reasonable field of view to avoid spherical pole related singularities.
	HorizontalFoV = FMath::Clamp(HorizontalFoV, 1, 179);
	VerticalFoV = FMath::Clamp(VerticalFoV, 1, 179);
