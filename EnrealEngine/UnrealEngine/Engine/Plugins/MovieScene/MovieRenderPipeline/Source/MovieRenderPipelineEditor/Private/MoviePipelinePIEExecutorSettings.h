...
*/
UCLASS(MinimalAPI, BlueprintType, config = Editor, defaultconfig, meta = (DisplayName = "Movie Pipeline In Editor"))
class UMoviePipelinePIEExecutorSettings : public UDeveloperSettings
{
	GENERATED_BODY()
