...
#include UE_INLINE_GENERATED_CPP_BY_NAME(MovieGraphModifierNode)
...
FString UMovieGraphModifierNode::GetNodeInstanceName() const
{
	return ModifierName;
}
...
TArray<UMovieGraphModifierBase*> UMovieGraphModifierNode::GetAllModifiers() const
{
	PRAGMA_DISABLE_DEPRECATION_WARNINGS
	const TArray<UMovieGraphCollectionModifier*>& Modifiers = GetModifiers();
	PRAGMA_ENABLE_DEPRECATION_WARNINGS
	
	TArray<UMovieGraphModifierBase*> BaseModifiers;
	for (UMovieGraphCollectionModifier* CollectionModifier : Modifiers)
	{
		BaseModifiers.Add(Cast<UMovieGraphModifierBase>(CollectionModifier));
	}
...
TArray<FName> UMovieGraphModifierNode::GetAllCollections() const
{
	PRAGMA_DISABLE_DEPRECATION_WARNINGS
...
bool UMovieGraphModifierNode::SupportsCollections() const
{
	return true;
}
