...
protected:
	...
	UE_API virtual bool IsLastTemporalSample() const;
	...
	UE_API virtual void UpdateFrameMetrics();
	UE_API virtual bool IsFirstTemporalSample() const;
	UE_API virtual void ResetForEndOfOutputFrame();
	UE_API virtual float GetBlendedMotionBlurAmount();
	UE_API virtual int32 GetTemporalSampleCountFromConfig(UMovieGraphEvaluatedConfig* InConfig) const;
