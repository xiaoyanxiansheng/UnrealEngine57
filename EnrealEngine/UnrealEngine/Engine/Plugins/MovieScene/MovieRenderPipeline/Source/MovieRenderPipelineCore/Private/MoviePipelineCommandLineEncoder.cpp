...
void UMoviePipelineCommandLineEncoder::LaunchEncoder(const FEncoderParams& InParams)
{
	...
	FProcHandle ProcessHandle = FPlatformProcess::CreateProc(*ExecutableArg, *CommandLineArgs, bLaunchDetached, bLaunchHidden, bLaunchReallyHidden, nullptr, 0, nullptr, PipeWrite);
