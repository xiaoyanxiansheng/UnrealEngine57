...
#include UE_INLINE_GENERATED_CPP_BY_NAME(MovieGraphCommandLineEncoderNode)
...
void UMovieGraphCommandLineEncoderNode::LaunchEncoder(const FEncoderParams& InParams)
{
	...
	const FProcHandle ProcessHandle = FPlatformProcess::CreateProc(*ExecutableArg, *CommandToRun, bLaunchDetached, bLaunchHidden, bLaunchReallyHidden, nullptr, 0, nullptr, PipeWrite);
