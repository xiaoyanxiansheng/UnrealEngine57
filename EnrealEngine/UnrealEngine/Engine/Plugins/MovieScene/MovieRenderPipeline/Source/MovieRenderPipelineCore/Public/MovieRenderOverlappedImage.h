...
public:
	 ...
	 */
	UE_API void Init(FIntPoint InSize);
	 ...
	 */
	UE_API void AccumulateSinglePlane(const TArray64<float>& InRawData, FIntPoint InSize, FIntPoint InOffset,
 ...
 */
struct FImageOverlappedAccumulator : MoviePipeline::IMoviePipelineOverlappedAccumulator
{
public:
	/**
	 * Default constructor.
	 ...
	 */
	UE_API void InitMemory(FIntPoint InPlaneSize, int32 InNumChannels);
	 ...
	 */
	static UE_API void GenerateTileWeight(TArray64<float>& OutWeights, FIntPoint Size);
	 ...
	 */
	static UE_API void GetTileSubRect(FIntPoint & OutSubRectOffset, FIntPoint & OutSubRectSize, const TArray64<float>& Weights, const FIntPoint Size);
	 ...
	 */
	static UE_API void CheckTileSubRect(const TArray64<float>& Weights, const FIntPoint Size, FIntPoint SubRectOffset, FIntPoint SubRectSize);
#endif
	 ...
	 */
	UE_API void AccumulatePixelData(const FImagePixelData& InPixelData, FIntPoint InTileOffset, FVector2D InSubpixelOffset, const MoviePipeline::FTileWeight1D & WeightX, const MoviePipeline::FTileWeight1D & WeightY);
	 ...
	 */
	UE_API void FetchFullImageValue(float Rgba[4], int32 FullX, int32 FullY) const;
