...
#include UE_INLINE_GENERATED_CPP_BY_NAME(MovieGraphGlobalGameOverrides)
...
void UMovieGraphGlobalGameOverridesNode::ApplySettings(const bool bOverrideValues, UWorld* InWorld)
{
	...
	// user needing to customize these (or be aware of them) is very low.
	{
		...
		MOVIEPIPELINE_STORE_AND_OVERRIDE_CVAR_INT(NodeCDO->PreviousAllowSlateThrottling, TEXT("Slate.bAllowThrottling"), 0, bOverrideValues);
