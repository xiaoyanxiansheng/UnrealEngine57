...
void UMoviePipelineImageSequenceOutput_BMP::UpdateTelemetry(FMoviePipelineShotRenderTelemetry* InTelemetry) const
{
	InTelemetry->bUsesBMP = true;
}

void UMoviePipelineImageSequenceOutput_PNG::UpdateTelemetry(FMoviePipelineShotRenderTelemetry* InTelemetry) const
{
	InTelemetry->bUsesPNG = true;
}

void UMoviePipelineImageSequenceOutput_JPG::UpdateTelemetry(FMoviePipelineShotRenderTelemetry* InTelemetry) const
{
