...
public:
	...
	static UE_API UMovieScene* GetMovieScene(UMovieSceneSequence* Sequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API TArray<UMovieSceneTrack*> GetTracks(UMovieSceneSequence* Sequence);
	...
	static UE_API TArray<UMovieSceneTrack*> FindTracksByType(UMovieSceneSequence* Sequence, TSubclassOf<UMovieSceneTrack> TrackType);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod, DeterminesOutputType="TrackType"))
	static UE_API TArray<UMovieSceneTrack*> FindTracksByExactType(UMovieSceneSequence* Sequence, TSubclassOf<UMovieSceneTrack> TrackType);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod, DeterminesOutputType = "TrackType"))
	static UE_API UMovieSceneTrack* AddTrack(UMovieSceneSequence* Sequence, TSubclassOf<UMovieSceneTrack> TrackType);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API bool RemoveTrack(UMovieSceneSequence* Sequence, UMovieSceneTrack* Track);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API FFrameRate GetDisplayRate(UMovieSceneSequence* Sequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API void SetDisplayRate(UMovieSceneSequence* Sequence, FFrameRate DisplayRate);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API FFrameRate GetTickResolution(UMovieSceneSequence* Sequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API void SetTickResolution(UMovieSceneSequence* Sequence, FFrameRate TickResolution);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API void SetTickResolutionDirectly(UMovieSceneSequence* Sequence, FFrameRate TickResolution);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API FSequencerScriptingRange MakeRange(UMovieSceneSequence* Sequence, int32 StartFrame, int32 Duration);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API FSequencerScriptingRange MakeRangeSeconds(UMovieSceneSequence* Sequence, float StartTime, float Duration);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API FSequencerScriptingRange GetPlaybackRange(UMovieSceneSequence* Sequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API int32 GetPlaybackStart(UMovieSceneSequence* Sequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API float GetPlaybackStartSeconds(UMovieSceneSequence* Sequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API int32 GetPlaybackEnd(UMovieSceneSequence* Sequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API float GetPlaybackEndSeconds(UMovieSceneSequence* Sequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API void SetPlaybackStart(UMovieSceneSequence* Sequence, int32 StartFrame);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API void SetPlaybackStartSeconds(UMovieSceneSequence* Sequence, float StartTime);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API void SetPlaybackEnd(UMovieSceneSequence* Sequence, int32 EndFrame);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API void SetPlaybackEndSeconds(UMovieSceneSequence* Sequence, float EndTime);
	...
	static UE_API void SetViewRangeStart(UMovieSceneSequence* InSequence, double StartTimeInSeconds);
	...
	static UE_API double GetViewRangeStart(UMovieSceneSequence* InSequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod, DevelopmentOnly))
	static UE_API void SetViewRangeEnd(UMovieSceneSequence* InSequence, double EndTimeInSeconds);
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Sequencer|Sequence", meta = (ScriptMethod, DevelopmentOnly))
	static UE_API double GetViewRangeEnd(UMovieSceneSequence* InSequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod, DevelopmentOnly))
	static UE_API void SetWorkRangeStart(UMovieSceneSequence* InSequence, double StartTimeInSeconds);
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Sequencer|Sequence", meta = (ScriptMethod, DevelopmentOnly))
	static UE_API double GetWorkRangeStart(UMovieSceneSequence* InSequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod, DevelopmentOnly))
	static UE_API void SetWorkRangeEnd(UMovieSceneSequence* InSequence, double EndTimeInSeconds);
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Sequencer|Sequence", meta = (ScriptMethod, DevelopmentOnly))
	static UE_API double GetWorkRangeEnd(UMovieSceneSequence* InSequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API void SetEvaluationType(UMovieSceneSequence* InSequence, EMovieSceneEvaluationType InEvaluationType);
	...
	static UE_API EMovieSceneEvaluationType GetEvaluationType(UMovieSceneSequence* InSequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API void SetClockSource(UMovieSceneSequence* InSequence, EUpdateClockSource InClockSource);
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API EUpdateClockSource GetClockSource(UMovieSceneSequence* InSequence);
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API UMovieSceneClock* GetCustomClock(UMovieSceneSequence* InSequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API FMovieSceneBindingProxy FindBindingByName(UMovieSceneSequence* Sequence, FString Name);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API FMovieSceneBindingProxy FindBindingById(UMovieSceneSequence* Sequence, FGuid BindingId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API TArray<FMovieSceneBindingProxy> GetBindings(UMovieSceneSequence* Sequence);
	...
	*/
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API TArray<FMovieSceneBindingProxy> GetSpawnables(UMovieSceneSequence* Sequence);
	...
	*/
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API TArray<FMovieSceneBindingProxy> GetPossessables(UMovieSceneSequence* Sequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API FMovieSceneBindingProxy AddPossessable(UMovieSceneSequence* Sequence, UObject* ObjectToPossess);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API TArray<UObject*> LocateBoundObjects(UMovieSceneSequence* Sequence, const FMovieSceneBindingProxy& InBinding, UObject* Context);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API FMovieSceneObjectBindingID GetBindingID(UMovieSceneSequence* Sequence, const FMovieSceneBindingProxy& InBinding);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API FMovieSceneObjectBindingID GetPortableBindingID(UMovieSceneSequence* RootSequence, UMovieSceneSequence* DestinationSequence, const FMovieSceneBindingProxy& InBinding);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API FMovieSceneBindingProxy ResolveBindingID(UMovieSceneSequence* RootSequence, FMovieSceneObjectBindingID InObjectBindingID);
	...
	static UE_API TArray<UMovieSceneFolder*> GetRootFoldersInSequence(UMovieSceneSequence* Sequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API UMovieSceneFolder* AddRootFolderToSequence(UMovieSceneSequence* Sequence, FString NewFolderName);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API void RemoveRootFolderFromSequence(UMovieSceneSequence* Sequence, UMovieSceneFolder* Folder);
...
public:
	 ...
	 */
	static UE_API TArray<UMovieSceneTrack*> FilterTracks(TArrayView<UMovieSceneTrack* const> InTracks, UClass* DesiredClass, bool bExactMatch);
...
public:
	...
	static UE_API TArray<FMovieSceneMarkedFrame> GetMarkedFramesFromSequence(UMovieSceneSequence* Sequence, EMovieSceneTimeUnit TimeUnit = EMovieSceneTimeUnit::DisplayRate);
	...
	static UE_API int32 AddMarkedFrameToSequence(UMovieSceneSequence* Sequence, const FMovieSceneMarkedFrame& InMarkedFrame, EMovieSceneTimeUnit TimeUnit = EMovieSceneTimeUnit::DisplayRate);
	...
	static UE_API void SetMarkedFrameInSequence(UMovieSceneSequence* Sequence, int32 InMarkIndex, FFrameNumber InFrameNumber, EMovieSceneTimeUnit TimeUnit = EMovieSceneTimeUnit::DisplayRate);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API void DeleteMarkedFrame(UMovieSceneSequence* Sequence, int32 DeleteIndex);

	/*
	 * Delete all user marked frames
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API void DeleteMarkedFrames(UMovieSceneSequence* Sequence);

	/*
	 * Sort the marked frames in chronological order
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API void SortMarkedFrames(UMovieSceneSequence* Sequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API int32 FindMarkedFrameByLabel(UMovieSceneSequence* Sequence, const FString& InLabel);
	...
	static UE_API int32 FindMarkedFrameByFrameNumberInSequence(UMovieSceneSequence* Sequence, FFrameNumber InFrameNumber, EMovieSceneTimeUnit TimeUnit = EMovieSceneTimeUnit::DisplayRate);
	...
	static UE_API int32 FindNextMarkedFrameInSequence(UMovieSceneSequence* Sequence, FFrameNumber InFrameNumber, bool bForward, EMovieSceneTimeUnit TimeUnit = EMovieSceneTimeUnit::DisplayRate);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API void SetReadOnly(UMovieSceneSequence* Sequence, bool bInReadOnly);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API bool IsReadOnly(UMovieSceneSequence* Sequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API void SetPlaybackRangeLocked(UMovieSceneSequence* Sequence, bool bInLocked);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API bool IsPlaybackRangeLocked(UMovieSceneSequence* Sequence);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API void SetMarkedFramesLocked(UMovieSceneSequence* Sequence, bool bInLocked);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API bool AreMarkedFramesLocked(UMovieSceneSequence* Sequence);
};
