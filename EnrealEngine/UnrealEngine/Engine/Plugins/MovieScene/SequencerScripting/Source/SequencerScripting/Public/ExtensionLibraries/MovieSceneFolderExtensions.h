...
public:
	...
	static UE_API FName GetFolderName(UMovieSceneFolder* Folder);
	...
	static UE_API bool SetFolderName(UMovieSceneFolder* Folder, FName InFolderName);
	...
	static UE_API FColor GetFolderColor(UMovieSceneFolder* Folder);
	...
	static UE_API bool SetFolderColor(UMovieSceneFolder* Folder, FColor InFolderColor);
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API TArray<UMovieSceneFolder*> GetChildFolders(UMovieSceneFolder* Folder);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API bool AddChildFolder(UMovieSceneFolder* TargetFolder, UMovieSceneFolder* FolderToAdd);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API bool RemoveChildFolder(UMovieSceneFolder* TargetFolder, UMovieSceneFolder* FolderToRemove);
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API TArray<UMovieSceneTrack*> GetChildTracks(UMovieSceneFolder* Folder);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API bool AddChildTrack(UMovieSceneFolder* Folder, UMovieSceneTrack* InTrack);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API bool RemoveChildTrack(UMovieSceneFolder* Folder, UMovieSceneTrack* InTrack);
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API TArray<FMovieSceneBindingProxy> GetChildObjectBindings(UMovieSceneFolder* Folder);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API bool AddChildObjectBinding(UMovieSceneFolder* Folder, FMovieSceneBindingProxy InObjectBinding);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API bool RemoveChildObjectBinding(UMovieSceneFolder* Folder, const FMovieSceneBindingProxy InObjectBinding);
};
