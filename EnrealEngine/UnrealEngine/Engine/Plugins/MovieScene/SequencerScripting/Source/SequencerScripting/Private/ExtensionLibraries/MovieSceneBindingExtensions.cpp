...
bool UMovieSceneBindingExtensions::EqualEqual_MovieSceneBindingProxy(FMovieSceneBindingProxy A, FMovieSceneBindingProxy B)
{
	return A == B;
}

bool UMovieSceneBindingExtensions::NotEqual_MovieSceneBindingProxy(FMovieSceneBindingProxy A, FMovieSceneBindingProxy B)
{
	return A != B;
}
