...
public:
	...
	static UE_API void SetDisplayName(UMovieSceneTrack* Track, const FText& InName);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Track", meta=(ScriptMethod, DevelopmentOnly))
	static UE_API FText GetDisplayName(UMovieSceneTrack* Track);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Track", meta=(ScriptMethod, DevelopmentOnly))
	static UE_API void SetTrackRowDisplayName(UMovieSceneTrack* Track, const FText& InName, int32 RowIndex);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Track", meta=(ScriptMethod, DevelopmentOnly))
	static UE_API FText GetTrackRowDisplayName(UMovieSceneTrack* Track, int32 RowIndex);
	...
	static UE_API UMovieSceneSection* AddSection(UMovieSceneTrack* Track);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Track", meta=(ScriptMethod))
	static UE_API TArray<UMovieSceneSection*> GetSections(UMovieSceneTrack* Track);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Track", meta=(ScriptMethod))
	static UE_API void RemoveSection(UMovieSceneTrack* Track, UMovieSceneSection* Section);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Track", meta=(ScriptMethod, DevelopmentOnly))
	static UE_API int32 GetSortingOrder(UMovieSceneTrack* Track);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Track", meta=(ScriptMethod, DevelopmentOnly))
	static UE_API void SetSortingOrder(UMovieSceneTrack* Track, int32 SortingOrder);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Track", meta=(ScriptMethod, DevelopmentOnly))
	static UE_API FColor GetColorTint(UMovieSceneTrack* Track);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Track", meta=(ScriptMethod, DevelopmentOnly))
	static UE_API void SetColorTint(UMovieSceneTrack* Track, const FColor& ColorTint);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Track", meta=(ScriptMethod, DevelopmentOnly))
	static UE_API UMovieSceneSection* GetSectionToKey(UMovieSceneTrack* Track);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Track", meta=(ScriptMethod, DevelopmentOnly))
	static UE_API void SetSectionToKey(UMovieSceneTrack* Track, UMovieSceneSection* Section);
};
