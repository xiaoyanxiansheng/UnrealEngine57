...
public:
	...
	static UE_API bool IsValid(const FMovieSceneBindingProxy& InBinding);
	...
	static UE_API bool EqualEqual_MovieSceneBindingProxy(FMovieSceneBindingProxy A, FMovieSceneBindingProxy B);
	...
	static UE_API bool NotEqual_MovieSceneBindingProxy(FMovieSceneBindingProxy A, FMovieSceneBindingProxy B);
	...
	static UE_API FGuid GetId(const FMovieSceneBindingProxy& InBinding);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API FText GetDisplayName(const FMovieSceneBindingProxy& InBinding);
	...
	static UE_API void SetDisplayName(const FMovieSceneBindingProxy& InBinding, const FText& InDisplayName);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API FString GetName(const FMovieSceneBindingProxy& InBinding);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API void SetName(const FMovieSceneBindingProxy& InBinding, const FString& InName);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod, DevelopmentOnly))
	static UE_API int32 GetSortingOrder(const FMovieSceneBindingProxy& InBinding);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod, DevelopmentOnly))
	static UE_API void SetSortingOrder(const FMovieSceneBindingProxy& InBinding, int32 SortingOrder);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API TArray<UMovieSceneTrack*> GetTracks(const FMovieSceneBindingProxy& InBinding);
	...
	static UE_API TArray<UMovieSceneTrack*> FindTracksByType(const FMovieSceneBindingProxy& InBinding, TSubclassOf<UMovieSceneTrack> TrackType);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta=(ScriptMethod, DeterminesOutputType="TrackType"))
	static UE_API TArray<UMovieSceneTrack*> FindTracksByExactType(const FMovieSceneBindingProxy& InBinding, TSubclassOf<UMovieSceneTrack> TrackType);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API void RemoveTrack(const FMovieSceneBindingProxy& InBinding, UMovieSceneTrack* TrackToRemove);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API void Remove(const FMovieSceneBindingProxy& InBinding);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API UMovieSceneTrack* AddTrack(const FMovieSceneBindingProxy& InBinding, TSubclassOf<UMovieSceneTrack> TrackType);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API TArray<FMovieSceneBindingProxy> GetChildPossessables(const FMovieSceneBindingProxy& InBinding);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API UObject* GetObjectTemplate(const FMovieSceneBindingProxy& InBinding);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API UClass* GetPossessedObjectClass(const FMovieSceneBindingProxy& InBinding);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta=(ScriptMethod))
	static UE_API FMovieSceneBindingProxy GetParent(const FMovieSceneBindingProxy& InBinding);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API void SetParent(const FMovieSceneBindingProxy& InBinding, const FMovieSceneBindingProxy& InParentBinding);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API void MoveBindingContents(const FMovieSceneBindingProxy& SourceBindingId, const FMovieSceneBindingProxy& DestinationBindingId);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Sequence", meta = (ScriptMethod))
	static UE_API void SetSpawnableBindingID(const FMovieSceneBindingProxy& InBinding, const FMovieSceneObjectBindingID& SpawnableBindingID);
};
