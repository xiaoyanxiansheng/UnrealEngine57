...
FText FComposurePostMoveSettingsPropertyTrackEditor::GetDisplayName() const
{
	return LOCTEXT("ComposurePostMoveSettingsPropertyTrackEditor_DisplayName", "Composure Post Move Settings Property");
}
