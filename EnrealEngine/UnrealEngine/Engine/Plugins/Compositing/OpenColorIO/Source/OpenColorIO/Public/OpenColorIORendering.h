...
public:
	 ...
	 */
	static UE_API bool ApplyColorTransform(UWorld* InWorld, const FOpenColorIOColorConversionSettings& InSettings, UTexture* InTexture, UTextureRenderTarget2D* OutRenderTarget);
	 ...
	 */
	static UE_API FOpenColorIORenderPassResources GetRenderPassResources(const FOpenColorIOColorConversionSettings& InSettings, ERHIFeatureLevel::Type InFeatureLevel);
	 ...
	 */
	static UE_API void AddPass_RenderThread(
	...
	*/
	static UE_API void PrepareView(FSceneViewFamily& InViewFamily, FSceneView& InView);
	
	UE_DEPRECATED(5.6, "This constant is deprecated, please use UTextureRenderTarget::GetDefaultDisplayGamma() instead.")
	static UE_API float DefaultDisplayGamma;
};
