...
public:
	 ...
	 */
	OPENCOLORIO_API FOpenColorIOTransformResource();
	...
	OPENCOLORIO_API bool CacheShaders(const FOpenColorIOShaderMapId& InShaderMapId, EShaderPlatform InPlatform, bool bApplyCompletedShaderMapForRendering, bool bSynchronous);
	...
	OPENCOLORIO_API TSharedPtr<const FShaderParametersMetadata, ESPMode::ThreadSafe> GetShaderParamMetadata() const;
	...
	OPENCOLORIO_API void GetDependentShaderTypes(EShaderPlatform InPlatform, TArray<FShaderType*>& OutShaderTypes) const;
	...
	*/
	...
	OPENCOLORIO_API void SetupResource(
		ERHIFeatureLevel::Type InFeatureLevel,
		const FString& InShaderCodeHash,
		const FString& InShadercode,
		const FString& InRawConfigHash,
	...
	OPENCOLORIO_API bool IsSame(const FOpenColorIOShaderMapId& InId) const;
...
protected:
	 ...
	 */
	OPENCOLORIO_API void GetShaderMapIDsWithUnfinishedCompilation(TArray<int32>& OutShaderMapIds);
#endif // WITH_EDITOR
...
private:
	 ...
	 */
	OPENCOLORIO_API bool BeginCompileShaderMap(
		const FOpenColorIOShaderMapId& InShaderMapId,
		EShaderPlatform InPlatform, 
	...
	OPENCOLORIO_API void SetupShaderCompilationEnvironment(
		EShaderPlatform InPlatform,
