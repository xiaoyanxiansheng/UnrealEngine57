...
public:
	...
	{
		TSharedRef<const FShaderParametersMetadata> ShaderParamMetadata;

		FParameters(const TSharedRef<const FShaderParametersMetadata>& InShaderParamMetadata)
	...
	struct CompiledShaderInitializerType : FShaderCompiledShaderInitializerType
	{
		...
		: FShaderCompiledShaderInitializerType(InType, InParameters, InPermutationId, CompilerOutput, InOCIOShaderMapHash, nullptr, nullptr)
