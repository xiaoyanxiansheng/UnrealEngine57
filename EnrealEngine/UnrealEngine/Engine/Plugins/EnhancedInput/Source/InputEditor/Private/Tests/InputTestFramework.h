...
struct FInputTestHelper
{
	...
	static bool HasAppliedInputMappingContext(UControllablePlayer& Data, FName ContextName);
};
...
inline bool InputContextIsApplied(UControllablePlayer& Data, FName ContextName) { return FInputTestHelper::HasAppliedInputMappingContext(Data, ContextName); }
inline bool InputContextIsNotApplied(UControllablePlayer& Data, FName ContextName) { return !FInputTestHelper::HasAppliedInputMappingContext(Data, ContextName); }
