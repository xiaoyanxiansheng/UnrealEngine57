...
void FInputEditorModule::StartupModule()
{
	...
	PropertyModule.RegisterCustomPropertyTypeLayout(FInputMappingContextMappingData::StaticStruct()->GetFName(), FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FMappingContextKeyContainerCustomization::MakeInstance));
...
void FInputEditorModule::ShutdownModule()
{
	...
	FPropertyEditorModule& PropertyModule = FModuleManager::GetModuleChecked<FPropertyEditorModule>("PropertyEditor");
	PropertyModule.UnregisterCustomPropertyTypeLayout("InputMappingContextMappingData");
