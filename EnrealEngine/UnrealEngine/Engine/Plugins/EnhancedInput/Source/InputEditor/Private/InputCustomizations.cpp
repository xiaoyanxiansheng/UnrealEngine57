...
/////////////////////////////////////////////////////////////////////////////////////
// FMappingContextKeyContainerCustomization

TSharedRef<IPropertyTypeCustomization> FMappingContextKeyContainerCustomization::MakeInstance()
{
	return MakeShareable(new FMappingContextKeyContainerCustomization());
}

void FMappingContextKeyContainerCustomization::CustomizeHeader(
	TSharedRef<IPropertyHandle> PropertyHandle,
	FDetailWidgetRow& HeaderRow,
	IPropertyTypeCustomizationUtils& CustomizationUtils)
{
	MappingsArrayHandle = PropertyHandle->GetChildHandle(GET_MEMBER_NAME_CHECKED(FInputMappingContextMappingData, Mappings));
...
void FMappingContextKeyContainerCustomization::CustomizeChildren(
	TSharedRef<IPropertyHandle> PropertyHandle,
	IDetailChildrenBuilder& ChildBuilder,
	IPropertyTypeCustomizationUtils& CustomizationUtils)
{
	if (!ensure(MappingsArrayHandle.IsValid()))
	{
		return;
	}
	
	MappingsArrayHandle->MarkHiddenByCustomization();

	const TSharedRef<FActionMappingsNodeBuilderEx> ActionMappingsBuilder = MakeShareable(new FActionMappingsNodeBuilderEx(MappingsArrayHandle));
	ChildBuilder.AddCustomBuilder(ActionMappingsBuilder);
}
