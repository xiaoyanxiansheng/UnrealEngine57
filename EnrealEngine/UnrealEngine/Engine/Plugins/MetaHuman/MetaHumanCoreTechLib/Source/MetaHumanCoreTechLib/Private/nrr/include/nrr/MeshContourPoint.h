...
public:
    ...
    /**
     * @brief relative depth to contour line that is being used for the occlusion test.
     * If positive, then this contour point is closer to the camera compared to the point on the other contour.
     * If negative, then this contour point is further from the camera than the other contour point.
     */
    T occlusionDepthOffset = std::numeric_limits<T>::max();
};
