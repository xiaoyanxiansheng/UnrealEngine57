...
void FaceTrackingLandmarkData::swap(FaceTrackingLandmarkData& other) { std::swap(m, other.m); }

FaceTrackingLandmarkData& FaceTrackingLandmarkData::operator=(const FaceTrackingLandmarkData& other) { return *this = FaceTrackingLandmarkData(other); }
...
FaceTrackingLandmarkData FaceTrackingLandmarkData::Create(const float* PointsData, const float* ConfidenceData, int32_t NumPoints, int32_t Dim)
{
