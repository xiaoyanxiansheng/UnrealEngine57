...
class FMetaHumanPerformanceAudioTrackEditor
...
public:
	...
	{
		return MakeShareable(new FMetaHumanPerformanceAudioTrackEditor{ InOwningSequencer } );
	}
	...
	*/
	...
	FMetaHumanPerformanceAudioTrackEditor(TSharedRef<ISequencer> InSequencer);
