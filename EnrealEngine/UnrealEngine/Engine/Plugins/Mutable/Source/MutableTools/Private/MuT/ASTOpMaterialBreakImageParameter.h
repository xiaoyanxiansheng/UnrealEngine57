...
namespace UE::Mutable::Private
{
	...
	/** Parameter operation. */
	class ASTOpImageFromMaterialParameter final : public ASTOp
	{
	public:
	...
	public:
		...
		ASTOpImageFromMaterialParameter();
		ASTOpImageFromMaterialParameter(const ASTOpImageFromMaterialParameter&) = delete;
		~ASTOpImageFromMaterialParameter() override;
