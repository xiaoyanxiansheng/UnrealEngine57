...
class USkeletalMesh;
namespace UE::Mutable::Private { class FMeshBufferSet; }
...
namespace  MutableMeshBufferUtils
{
	 ...
	 */
	CUSTOMIZABLEOBJECT_API void SetupVertexPositionsBuffer(const int32& InCurrentVertexBuffer, UE::Mutable::Private::FMeshBufferSet& OutTargetVertexBuffers);
	 ...
	 * @param OutTargetVertexBuffers Mesh buffer to be set up. 
	 */
	CUSTOMIZABLEOBJECT_API void SetupTangentBuffer(const int32& InCurrentVertexBuffer, UE::Mutable::Private::FMeshBufferSet& OutTargetVertexBuffers);
	 ...
	 */
	CUSTOMIZABLEOBJECT_API void SetupTexCoordinatesBuffer(const int32& InCurrentVertexBuffer,const int32& InChannelCount, bool bHighPrecision, UE::Mutable::Private::FMeshBufferSet& OutTargetVertexBuffers, const int32* InTextureSemanticIndicesOverride = nullptr);
	...
	CUSTOMIZABLEOBJECT_API void SetupSkinBuffer(const int32& InCurrentVertexBuffer,const int32& MaxBoneIndexTypeSizeBytes, const int32& MaxBoneWeightTypeSizeBytes,
		const int32& MaxNumBonesPerVertex, UE::Mutable::Private::FMeshBufferSet& OutTargetVertexBuffers);
	 ...
	 * @param OutTargetVertexBuffers Mesh buffer to be set up. 
	 */
	CUSTOMIZABLEOBJECT_API void SetupVertexColorBuffer(const int32& InCurrentVertexBuffer, UE::Mutable::Private::FMeshBufferSet& OutTargetVertexBuffers);
	 ...
	 */
	CUSTOMIZABLEOBJECT_API void SetupIndexBuffer(UE::Mutable::Private::FMeshBufferSet& OutTargetIndexBuffers);
	...
	CUSTOMIZABLEOBJECT_API void SetupSkinWeightProfileBuffer(const int32& InCurrentVertexBuffer, const int32& MaxBoneIndexTypeSizeBytes,const int32& MaxBoneWeightTypeSizeBytes, const int32& MaxNumBonesPerVertex,
		const int32 SemanticsIndex, UE::Mutable::Private::FMeshBufferSet& OutTargetVertexBuffers);
