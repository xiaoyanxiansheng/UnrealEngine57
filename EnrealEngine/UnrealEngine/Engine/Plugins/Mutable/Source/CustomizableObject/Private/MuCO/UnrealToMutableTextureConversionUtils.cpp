...
EUnrealToMutableConversionError ConvertTextureUnrealSourceToMutable(UE::Mutable::Private::FImage* OutResult, FMutableSourceTextureData& Tex, uint8 MipmapsToSkip)
{
	...
	case ERawImageFormat::G8:
	{
		...
		OutResult->Init(SizeX, SizeY, LODs, UE::Mutable::Private::EImageFormat::L_UByte, UE::Mutable::Private::EInitializationType::NotInitialized);
	...
	case ERawImageFormat::BGRA8:
	{
		...
		if (bHasAlphaChannel)
		{
			...
			OutResult->Init(SizeX, SizeY, LODs, UE::Mutable::Private::EImageFormat::RGBA_UByte, UE::Mutable::Private::EInitializationType::NotInitialized);
            check(LODs == 1);
		...
		else
		{
			...
			OutResult->Init(SizeX, SizeY, LODs, UE::Mutable::Private::EImageFormat::RGB_UByte, UE::Mutable::Private::EInitializationType::NotInitialized);
			check(LODs == 1);
            uint8* DataDest = OutResult->GetLODData(0);
