 ...
 */
class SMutableCodeViewer : public SCompoundWidget
{
public:

	SLATE_BEGIN_ARGS(SMutableCodeViewer) {}

	SLATE_ARGUMENT(TSharedPtr<FUnrealMutableResourceProvider>, ExternalResourceProvider)
		
	SLATE_END_ARGS()

	void Construct(const FArguments& InArgs, UCustomizableObject& InObject, UCustomizableObjectInstance& InInstance, const TSharedPtr<UE::Mutable::Private::FModel>& InMutableModel);
...
private:
	TStrongObjectPtr<UCustomizableObject> Object;
	TStrongObjectPtr<UCustomizableObjectInstance> Instance;
	...
	UE::Mutable::Private::OP::ADDRESS SelectedOperationAddress = 0;

	/** Mutable parameters used in the preview. */
	TSharedPtr<UE::Mutable::Private::FParameters> PreviewParameters;
	...
	*/
	...
	{
		UE::Mutable::Private::OP::ADDRESS Parent=0;
		UE::Mutable::Private::OP::ADDRESS Child=0;
	...
	*/
	...
	TMap< UE::Mutable::Private::OP::ADDRESS, TSharedPtr<FMutableCodeTreeElement>> MainItemPerOp;
	...
	TMap< UE::Mutable::Private::OP::ADDRESS, TSharedPtr<FMutableCodeTreeElement>> ExpandedElements;
	...
	void GenerateElementRecursive( const int32& InStateIndex, UE::Mutable::Private::OP::ADDRESS InParentAddress, const UE::Mutable::Private::FProgram& InProgram);

	
	/** The addresses of the root operations. Cached when this object gets loaded on the Construct method of this slate */
	TArray<UE::Mutable::Private::OP::ADDRESS> RootNodeAddresses;
	...
	UE::Mutable::Private::OP::ADDRESS HighlightedOperation{};
	...
	const TArray<UE::Mutable::Private::EOpType> VeryExpensiveOperationTypes
	{
		UE::Mutable::Private::EOpType::ME_BINDSHAPE,
		UE::Mutable::Private::EOpType::ME_MASKCLIPMESH,
		UE::Mutable::Private::EOpType::ME_MASKCLIPUVMASK,
		UE::Mutable::Private::EOpType::ME_FORMAT,
		UE::Mutable::Private::EOpType::ME_MASKDIFF,
		UE::Mutable::Private::EOpType::ME_DIFFERENCE,
		UE::Mutable::Private::EOpType::ME_EXTRACTLAYOUTBLOCK,
		UE::Mutable::Private::EOpType::IM_MAKEGROWMAP,
	};

	/** Collection with all expensive to run operation types */
	const TArray<UE::Mutable::Private::EOpType> ExpensiveOperationTypes
	{
		UE::Mutable::Private::EOpType::IM_PIXELFORMAT,
		UE::Mutable::Private::EOpType::IM_SWIZZLE,
		UE::Mutable::Private::EOpType::ME_PROJECT,
		UE::Mutable::Private::EOpType::ME_TRANSFORMWITHMESH,
	};
	 ...
	 */
	EOperationComputationalCost GetOperationTypeComputationalCost(UE::Mutable::Private::EOpType OperationType) const;
	...
	UE::Mutable::Private::EOpType OperationTypeToSearch = UE::Mutable::Private::EOpType::NONE;
	...
	TArray< TPair< UE::Mutable::Private::EOpType,uint32>> ModelOperationTypes;
	...
	struct FElementsSearchCache
	{
		...
		TSet<UE::Mutable::Private::OP::ADDRESS> ProcessedAddresses;
		 ...
		 */
		void SetupRootBatch(const TArray<UE::Mutable::Private::OP::ADDRESS>& InRootNodeAddresses)
		{
		...
		*/
		void AddToFoundElements(const UE::Mutable::Private::OP::ADDRESS OpAddress,const int32 IndexAsChildOfInputAddress,
		 ...
		 */
		void CacheChildrenOfAddressIfNotProcessed(UE::Mutable::Private::OP::ADDRESS InParentAddress,
		                                          ...
		                                          TArray<FItemCacheKey>& OutFoundChildrenData)
		{
			if (!ProcessedAddresses.Contains(InParentAddress))
			{
				...
				uint32 ChildIndex = 0;
				UE::Mutable::Private::ForEachReference(InProgram, InParentAddress, [this, &InParentAddress, &ChildIndex,&OutFoundChildrenData]( UE::Mutable::Private::OP::ADDRESS ChildAddress)
				{
	 ...
	 */
	void GetOperationsOfType(const UE::Mutable::Private::EOpType& TargetOperationType,
...
public:
	 ...
	 * type of UE::Mutable::Private::EDataType::DT_Curve will try to locate operations that we know operate with constant curves.
	 * @param IndexOnConstantsArray The index of the constant on its constants array. If it is, for example, a constant mesh
	 * this value represents the index of the constant inside constantMeshes array on UE::Mutable::Private::program.
	 */
	void CacheAddressesRelatedWithConstantResource(const UE::Mutable::Private::EDataType ConstantDataType, const int32 IndexOnConstantsArray);
...
private:
	 ...
	 */
	void GetOperationsReferencingConstantResource(const UE::Mutable::Private::EDataType ConstantDataType,
	...
	bool IsConstantResourceUsedByOperation(const int32 IndexOnConstantsArray,
	                                       const UE::Mutable::Private::EDataType ConstantDataType, const UE::Mutable::Private::OP::ADDRESS OperationAddress,
	                                       const UE::Mutable::Private::FProgram& InProgram) const;
	...
	*/
	...
	TSharedPtr<UE::Mutable::Private::FModel> LastSearchedModel;
	...
	*/
	 ...
	 */
	void GetOperationsMatchingStringPattern(const FString& InStringPattern,const bool bIsRegularExpression, FElementsSearchCache& SearchPayload, const UE::Mutable::Private::FProgram& InProgram);
	...
	*/
	...
	struct FProcessedOperationsBuffer
	{
		...
		TArray<UE::Mutable::Private::OP::ADDRESS> ExpandedOriginalOperations;

		/** Array with the operation addresses of all duplicated expanded operations. */
		TArray<UE::Mutable::Private::OP::ADDRESS> ExpandedDuplicatedOperations;
	};
...
public:
	void PreviewMutableImage (TSharedPtr<const UE::Mutable::Private::FImage> InImagePtr);
	void PreviewMutableMesh (TSharedPtr<const UE::Mutable::Private::FMesh> InMeshPtr);
	void PreviewMutableLayout(TSharedPtr<const UE::Mutable::Private::FLayout> Layout);
	void PreviewMutableSkeleton(TSharedPtr<const UE::Mutable::Private::FSkeleton> Skeleton);
	void PreviewMutablePhysics(TSharedPtr<const UE::Mutable::Private::FPhysicsBody> Physics);
	void PreviewMutableString(const FString& InString);
	void PreviewMutableProjector(const UE::Mutable::Private::FProjector* Projector);
	void PreviewMutableMatrix(const FMatrix44f& Mat);
	void PreviewMutableShape(const UE::Mutable::Private::FShape* Shape);
...
{
public:
	FMutableOperationElement(UE::Mutable::Private::EOpType InOperationType,FText OperationTypeName,uint32 OperationTypeInstanceCount,FSlateColor OperationColor)
	{
		...
		// but added manually to the list of operation types (currently UE::Mutable::Private::OP_Type::None is an example of this)
...
public:
	UE::Mutable::Private::EOpType OperationType;
	...
	{
		return OperationType == UE::Mutable::Private::EOpType::NONE ? EVisibility::Collapsed : EVisibility::Visible;
	}
};
...
{
public:
	FMutableCodeTreeElement(int32 InIndexOnTree, const int32& InMutableStateIndex, const TSharedPtr<UE::Mutable::Private::FModel, ESPMode::ThreadSafe>& InModel, UE::Mutable::Private::OP::ADDRESS InOperation, const FString& InCaption, const FSlateColor InLabelColor, const TSharedPtr<FMutableCodeTreeElement>* InDuplicatedOf = nullptr);
...
public:
	...
	UE::Mutable::Private::OP::ADDRESS MutableOperation;
