...
public:
	SLATE_BEGIN_ARGS(SMutableMeshViewer) {}
		SLATE_ARGUMENT_DEFAULT(TSharedPtr<const UE::Mutable::Private::FMesh>, Mesh){nullptr};
	SLATE_END_ARGS()
	...
	void SetMesh(const TSharedPtr<const UE::Mutable::Private::FMesh>& InMesh);
...
private:
	...
	TSharedPtr<const UE::Mutable::Private::FMesh> MutableMesh = nullptr;
...
private:
	...
	*/
	void FillTargetBufferSetDataArray(const UE::Mutable::Private::FMeshBufferSet& InMuMeshBufferSetPtr,
