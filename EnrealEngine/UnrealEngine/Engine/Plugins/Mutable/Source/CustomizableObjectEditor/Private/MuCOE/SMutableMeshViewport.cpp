...
void SMutableMeshViewport::SetMesh(const TSharedPtr<const UE::Mutable::Private::FMesh>& InMesh)
{
...
TSharedRef<FEditorViewportClient> SMutableMeshViewport::MakeEditorViewportClient()
{
	...
	ViewportClient->SetCameraSpeedSettings(FEditorViewportCameraSpeedSettings(0.25f));
