...
class SMutableSkeletonViewer : public SCompoundWidget
{
	SLATE_BEGIN_ARGS(SMutableSkeletonViewer) {}
		SLATE_ARGUMENT_DEFAULT(TSharedPtr<const UE::Mutable::Private::FSkeleton>, Skeleton) { nullptr };
	SLATE_END_ARGS()
...
public:
	...
	void SetSkeleton(TSharedPtr<const UE::Mutable::Private::FSkeleton> InSkeleton);
