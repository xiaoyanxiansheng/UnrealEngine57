...
namespace Chaos::Internal
{
	// Command signature for handling synced command buffer
	DECLARE_DELEGATE_TwoParams(FClothingInteractorConfigCommand, Chaos::FClothingSimulationConfig*, int32)
	DECLARE_DELEGATE_OneParam(FClothingInteractorCommand, Chaos::FClothingSimulationCloth*)
PRAGMA_DISABLE_DEPRECATION_WARNINGS  // UE_DEPRECATED(5.7, "Use IClothingSimulationInterface instead.")
	DECLARE_DELEGATE_TwoParams(FClothingSimulationInteractorCommand, Chaos::FClothingSimulation*, const FClothingSimulationContextCommon*)
PRAGMA_ENABLE_DEPRECATION_WARNINGS 
}

using FChaosClothingInteractorConfigCommand UE_DEPRECATED(5.7, "For internal use only. Use Chaos::Internal version instead.") = TDelegate<void(Chaos::FClothingSimulationConfig*, int32)>;
using FChaosClothingInteractorCommand UE_DEPRECATED(5.7, "For internal use only. Use Chaos::Internal version instead.") = TDelegate<void(Chaos::FClothingSimulationCloth*)>;
PRAGMA_DISABLE_DEPRECATION_WARNINGS  // UE_DEPRECATED(5.7, "Use IClothingSimulationInterface instead.")
using FChaosClothingSimulationInteractorCommand UE_DEPRECATED(5.7, "For internal use only. Use Chaos::Internal version instead.") = TDelegate<void(Chaos::FClothingSimulation*, FClothingSimulationContextCommon*)>;
PRAGMA_ENABLE_DEPRECATION_WARNINGS
...
public:
	CHAOSCLOTH_API virtual void Sync(IClothingSimulationInterface* Simulation);
...
private:
	...
	TArray<Chaos::Internal::FClothingInteractorCommand> Commands;
	TArray<Chaos::Internal::FClothingInteractorConfigCommand> ConfigCommands;
};
...
public:
	...
	CHAOSCLOTH_API virtual void Sync(IClothingSimulationInterface* InSimulation, const IClothingSimulationContext* InContext) override;
...
private:
	...
	TArray<Chaos::Internal::FClothingSimulationInteractorCommand> Commands;
	TArray<Chaos::Internal::FClothingInteractorConfigCommand> ConfigCommands;
};
