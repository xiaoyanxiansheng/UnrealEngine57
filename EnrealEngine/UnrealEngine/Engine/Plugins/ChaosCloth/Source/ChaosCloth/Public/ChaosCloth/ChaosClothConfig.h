...
public:
	...
	*/
	...
	/**
	 * All vector properties in this section (e.g., Linear Velocity Scale, Max Linear Acceleration)
	 ...
	 */
	UPROPERTY(EditAnywhere, Category = "Animation Properties", meta = (InlineEditConditionToggle))
	 ...
	 * (the closest bone to the root on which the cloth section has been skinned, or the root itself if the cloth isn't skinned).
	 */
	UPROPERTY(EditAnywhere, Category = "Animation Properties", meta = (ClampMin = "0", EditCondition = "bEnableLinearVelocityClamping"))
	 ...
	 * (the closest bone to the root on which the cloth section has been skinned, or the root itself if the cloth isn't skinned).
	 */
	UPROPERTY(EditAnywhere, Category = "Animation Properties", meta = (ClampMin = "0", EditCondition = "bEnableLinearAccelerationClamping"))
	 ...
	 * (the closest bone to the root on which the cloth section has been skinned, or the root itself if the cloth isn't skinned).
	 */
	UPROPERTY(EditAnywhere, Category = "Animation Properties", meta = (ClampMin = "0", EditCondition = "bEnableAngularVelocityClamping"))
	 ...
	 * (the closest bone to the root on which the cloth section has been skinned, or the root itself if the cloth isn't skinned).
	 */
	UPROPERTY(EditAnywhere, Category = "Animation Properties", meta = (ClampMin = "0", EditCondition = "bEnableAngularAccelerationClamping"))
