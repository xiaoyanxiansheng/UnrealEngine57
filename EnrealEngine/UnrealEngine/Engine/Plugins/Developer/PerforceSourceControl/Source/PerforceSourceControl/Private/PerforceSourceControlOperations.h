...
class FPerforceGetProjectWorkspacesWorker final : public IPerforceSourceControlWorker
{
public:
	FPerforceGetProjectWorkspacesWorker(FPerforceSourceControlProvider& InSourceControlProvider)
		: IPerforceSourceControlWorker(InSourceControlProvider)
	{}
	virtual ~FPerforceGetProjectWorkspacesWorker() = default;
