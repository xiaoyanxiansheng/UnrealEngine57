...
#define UE_API RENDERDOCPLUGIN_API

UCLASS(MinimalAPI, config = Engine, defaultconfig, meta = (DisplayName = "RenderDoc"))
class URenderDocPluginSettings : public UDeveloperSettings
{
	GENERATED_BODY()
