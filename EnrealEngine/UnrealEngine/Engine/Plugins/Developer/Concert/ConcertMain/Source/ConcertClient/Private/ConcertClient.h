...
class FConcertClientServerDiscoveryThread;
...
private:
	...
	/** Ticker for interfacing with the discovery thread. */
	FTSTicker::FDelegateHandle DiscoveryTick;

	/** Unique pointer to the discovery thread runnable. */
	TUniquePtr<FConcertClientServerDiscoveryThread> ServerDiscoveryThread;
