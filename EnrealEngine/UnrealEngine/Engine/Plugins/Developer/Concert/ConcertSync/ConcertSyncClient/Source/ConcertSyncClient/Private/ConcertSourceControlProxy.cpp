...
bool FConcertSourceControlProxy::GetStateBranchAtIndex(int32 BranchIndex, FString& OutBranchName) const
{
	if (ActualProvider)
	{
		return ActualProvider->GetStateBranchAtIndex(BranchIndex, OutBranchName);
	}
	return false;
}
