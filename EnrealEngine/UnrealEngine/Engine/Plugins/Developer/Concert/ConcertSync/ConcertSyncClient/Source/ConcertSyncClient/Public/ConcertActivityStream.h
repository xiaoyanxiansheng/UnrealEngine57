...
public:
	 ...
	 */
	UE_API FConcertActivityStream(TWeakPtr<IConcertClient, ESPMode::ThreadSafe> InConcertClient, const FGuid& InAdminEndpointId, const FGuid& InSessionId, bool bInIncludeActivityDetails, uint32 InBufferSize = 1024);
	 ...
	 */
	UE_API bool Read(TArray<TSharedPtr<FConcertSessionActivity>>& InOutActivities, int32& OutReadCount, FText& OutErrorMsg);
...
private:
	...
	UE_API void Fetch(int64 ActivityCount);
