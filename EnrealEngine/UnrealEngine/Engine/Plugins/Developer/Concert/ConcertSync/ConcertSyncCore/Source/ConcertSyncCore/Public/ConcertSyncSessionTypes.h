...
public:
	 ...
	 */
	UE_API FText ToDisplayText(const FText InUserDisplayName, const bool InUseRichText = false) const;

protected:
	UE_API virtual FText CreateDisplayText(const bool InUseRichText) const;
	UE_API virtual FText CreateDisplayTextForUser(const FText InUserDisplayName, const bool InUseRichText) const;
};
...
struct FConcertSyncConnectionActivitySummary : public FConcertSyncActivitySummary
{
	...
	static UE_API FConcertSyncConnectionActivitySummary CreateSummaryForEvent(const FConcertSyncConnectionEvent& InEvent);
...
struct FConcertSyncLockActivitySummary : public FConcertSyncActivitySummary
{
	...
	static UE_API FConcertSyncLockActivitySummary CreateSummaryForEvent(const FConcertSyncLockEvent& InEvent);
...
struct FConcertSyncTransactionActivitySummary : public FConcertSyncActivitySummary
{
	...
	static UE_API FConcertSyncTransactionActivitySummary CreateSummaryForEvent(const FConcertSyncTransactionEvent& InEvent);
...
struct FConcertSyncPackageActivitySummary : public FConcertSyncActivitySummary
{
	...
	static UE_API FConcertSyncPackageActivitySummary CreateSummaryForEvent(const FConcertPackageInfo& InEvent);
