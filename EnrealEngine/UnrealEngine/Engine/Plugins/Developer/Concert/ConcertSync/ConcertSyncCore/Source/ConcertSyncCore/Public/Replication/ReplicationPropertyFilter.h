...
namespace UE::ConcertSyncCore
{
	 ...
	 *	}
	 */
	class FReplicationPropertyFilter
	{
	...
	public:
		...
		UE_API FReplicationPropertyFilter(const FConcertPropertySelection& PropertySelection);
		 ...
		 */
		UE_API bool ShouldSerializeProperty(const FArchiveSerializedPropertyChain* Chain, const FProperty& Property) const;
	};
}
