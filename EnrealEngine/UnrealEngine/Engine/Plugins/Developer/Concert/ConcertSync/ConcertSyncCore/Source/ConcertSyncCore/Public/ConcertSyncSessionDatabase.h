...
public:
	...
	UE_API FConcertSyncSessionDatabase();
	UE_API ~FConcertSyncSessionDatabase();
	...
	UE_API FConcertSyncSessionDatabase(FConcertSyncSessionDatabase&&);
	UE_API FConcertSyncSessionDatabase& operator=(FConcertSyncSessionDatabase&&);
	 ...
	 */
	UE_API bool Open(const FString& InSessionPath);
	 ...
	 * @return True if the database was opened, false otherwise.
	 */
	UE_API bool Open(const FString& InSessionPath, const ESQLiteDatabaseOpenMode InOpenMode);
	 ...
	 */
	UE_API bool Close(const bool InDeleteDatabase = false);
	 ...
	 */
	UE_API bool AddConnectionActivity(const FConcertSyncConnectionActivity& InConnectionActivity, int64& OutActivityId, int64& OutConnectionEventId);
	 ...
	 */
	UE_API bool AddLockActivity(const FConcertSyncLockActivity& InLockActivity, int64& OutActivityId, int64& OutLockEventId);
	 ...
	 */
	UE_API bool AddTransactionActivity(const FConcertSyncTransactionActivity& InTransactionActivity, int64& OutActivityId, int64& OutTransactionEventId);
	 ...
	 */
	UE_API bool AddPackageActivity(const FConcertSyncActivity& InPackageActivity, const FConcertPackageInfo& InPackageInfo, FConcertPackageDataStream& InPackageDataStream, int64& OutActivityId, int64& OutPackageEventId);
	 ...
	 * @return True if the lock activity was added, false otherwise.
	 */
	UE_API bool AddReplicationActivity(const FConcertSyncReplicationActivity& InReplicationActivity, int64& OutActivityId, int64& OutReplicationEventId);
	
	/**
	 * Iterates the given range, calls UpdateCallback on each element, and commits the update.
	 */
	UE_API bool SetActivities(const TSet<int64>& ActivityIds, TFunctionRef<void(FConcertSyncActivity&)> UpdateCallback);
	 ...
	 */
	UE_API bool SetConnectionActivity(const FConcertSyncConnectionActivity& InConnectionActivity);
	 ...
	 */
	UE_API bool SetLockActivity(const FConcertSyncLockActivity& InLockActivity);
	 ...
	 */
	UE_API bool SetTransactionActivity(const FConcertSyncTransactionActivity& InTransactionActivity, const bool bMetaDataOnly = false);
	 ...
	 */
	UE_API bool SetPackageActivity(const FConcertSyncActivity& InPackageActivity, FConcertSyncPackageEventData& InPackageActivityEvent, const bool bMetaDataOnly = false);
	 ...
	 * @return True if the transaction activity was set, false otherwise.
	 */
	UE_API bool SetReplicationActivity(const FConcertSyncReplicationActivity& InReplicationActivity);
	 ...
	 */
	UE_API bool GetActivity(const int64 InActivityId, FConcertSyncActivity& OutActivity) const;
	 ...
	 */
	UE_API bool GetConnectionActivity(const int64 InActivityId, FConcertSyncConnectionActivity& OutConnectionActivity) const;
	 ...
	 */
	UE_API bool GetLockActivity(const int64 InActivityId, FConcertSyncLockActivity& OutLockActivity) const;
	 ...
	 */
	UE_API bool GetTransactionActivity(const int64 InActivityId, FConcertSyncTransactionActivity& OutTransactionActivity) const;
	 ...
	 */
	UE_API bool GetPackageActivity(const int64 InActivityId, FConsumePackageActivityFunc PackageActivityFn) const;
	 ...
	 */
	UE_API bool GetReplicationActivity(const int64 InActivityId, FConcertSyncReplicationActivity& OutReplicationActivity) const;
	 ...
	 * @return True if the replication activity was found, false otherwise.
	 */
	UE_API bool GetReplicationActivityForEvent(const int64 InEventId, FConcertSyncReplicationActivity& OutReplicationActivity) const;
	 ...
	 * @return True if the activity was found, false otherwise.
	 */
	UE_API bool GetActivityEventType(const int64 InActivityId, EConcertSyncActivityEventType& OutEventType) const;
	 ...
	 * @return True if the activity was found, false otherwise.
	 */
	UE_API bool GetActivityForEvent(const int64 InEventId, const EConcertSyncActivityEventType InEventType, FConcertSyncActivity& OutActivity) const;
	 ...
	 * @return True if the connection activity was found, false otherwise.
	 */
	UE_API bool GetConnectionActivityForEvent(const int64 InConnectionEventId, FConcertSyncConnectionActivity& OutConnectionActivity) const;
	 ...
	 * @return True if the lock activity was found, false otherwise.
	 */
	UE_API bool GetLockActivityForEvent(const int64 InLockEventId, FConcertSyncLockActivity& OutLockActivity) const;
	 ...
	 * @return True if the transaction activity was found, false otherwise.
	 */
	UE_API bool GetTransactionActivityForEvent(const int64 InTransactionEventId, FConcertSyncTransactionActivity& OutTransactionActivity) const;
	 ...
	 * @return True if the package activity was found, false otherwise.
	 */
	UE_API bool GetPackageActivityForEvent(const int64 InPackageEventId, FIteratePackageActivityFunc PackageActivityFn) const;
	 ...
	 */
	UE_API bool EnumerateActivities(FIterateActivityFunc InCallback) const;
	 ...
	 */
	UE_API bool EnumerateConnectionActivities(TFunctionRef<bool(FConcertSyncConnectionActivity&&)> InCallback) const;
	 ...
	 */
	UE_API bool EnumerateLockActivities(TFunctionRef<bool(FConcertSyncLockActivity&&)> InCallback) const;
	 ...
	 */
	UE_API bool EnumerateTransactionActivities(TFunctionRef<bool(FConcertSyncTransactionActivity&&)> InCallback) const;
	 ...
	 */
	UE_API bool EnumeratePackageActivities(FIteratePackageActivityFunc InCallback) const;
	 ...
	 */
	UE_API bool EnumerateReplicationActivities(TFunctionRef<bool(FConcertSyncReplicationActivity&&)> InCallback) const;
	 ...
	 * @return True if the activities were enumerated without error, false otherwise.
	 */
	UE_API bool EnumerateActivitiesForEventType(const EConcertSyncActivityEventType InEventType, FIterateActivityFunc InCallback) const;
	 ...
	 * @return True if the activities were enumerated without error, false otherwise.
	 */
	UE_API bool EnumerateActivitiesInRange(const int64 InFirstActivityId, const int64 InMaxNumActivities, FIterateActivityFunc InCallback) const;
	 ...
	 * @return True if the activities were enumerated without error, false otherwise.
	 */
	UE_API bool EnumerateActivityIdsAndEventTypes(TFunctionRef<bool(int64, EConcertSyncActivityEventType)> InCallback) const;
	 ...
	 * @return True if the activities were enumerated without error, false otherwise.
	 */
	UE_API bool EnumerateActivityIdsAndEventTypesInRange(const int64 InFirstActivityId, const int64 InMaxNumActivities, TFunctionRef<bool(int64, EConcertSyncActivityEventType)> InCallback) const;
	 ...
	 * @return True if the activities were enumerated without error, false otherwise.
	 */
	UE_API bool EnumerateActivityIdsWithEventTypesAndFlagsInRange(const int64 InFirstActivityId, const int64 InMaxNumActivities, TFunctionRef<bool(int64, EConcertSyncActivityEventType, EConcertSyncActivityFlags)> InCallback) const;
	 ...
	 */
	UE_API bool GetActivityMaxId(int64& OutActivityId) const;
	 ...
	 */
	UE_API bool SetEndpoint(const FGuid& InEndpointId, const FConcertSyncEndpointData& InEndpointData);
	 ...
	 */
	UE_API bool GetEndpoint(const FGuid& InEndpointId, FConcertSyncEndpointData& OutEndpointData) const;
	 ...
	 */
	UE_API bool EnumerateEndpoints(TFunctionRef<bool(FConcertSyncEndpointIdAndData&&)> InCallback) const;
	 ...
	 */
	UE_API bool EnumerateEndpointIds(TFunctionRef<bool(FGuid)> InCallback) const;
	 ...
	 */
	UE_API bool GetConnectionEvent(const int64 InConnectionEventId, FConcertSyncConnectionEvent& OutConnectionEvent) const;
	 ...
	 */
	UE_API bool GetLockEvent(const int64 InLockEventId, FConcertSyncLockEvent& OutLockEvent) const;
	 ...
	 */
	UE_API bool GetTransactionEvent(const int64 InTransactionEventId, FConcertSyncTransactionEvent& OutTransactionEvent, const bool InMetaDataOnly = false) const;
	 ...
	 */
	UE_API bool GetReplicationEvent(const int64 InReplicationEventId, FConcertSyncReplicationEvent& OutReplicationEvent) const;
	 ...
	 */
	UE_API bool GetTransactionMaxEventId(int64& OutTransactionEventId) const;
	 ...
	 */
	UE_API bool IsLiveTransactionEvent(const int64 InTransactionEventId, bool& OutIsLive) const;
	 ...
	 */
	UE_API bool GetLiveTransactionEventIds(TArray<int64>& OutTransactionEventIds) const;
	 ...
	 * @return True if the live transaction event IDs were resolved, false otherwise.
	 */
	UE_API bool GetLiveTransactionEventIdsForPackage(const FName InPackageName, TArray<int64>& OutTransactionEventIds) const;
	 ...
	 */
	UE_API bool PackageHasLiveTransactions(const FName InPackageName, bool& OutHasLiveTransaction) const;
	 ...
	 */
	UE_API bool EnumerateLiveTransactionEventIdsForPackage(const FName InPackageName, TFunctionRef<bool(int64)> InCallback) const;
	 ...
	 */
	UE_API bool EnumeratePackageNamesWithLiveTransactions(TFunctionRef<bool(FName)> InCallback) const;
	 ...
	 */
	UE_API bool AddDummyPackageEvent(const FName InPackageName, int64& OutPackageEventId);
	 ...
	 */
	UE_API bool GetPackageEventMetaData(const int64 InPackageEventId, int64& OuptPackageRevision, FConcertPackageInfo& OutPackageInfo) const;
	 ...
	 * @return True if the package event was found, false otherwise
	 */
	UE_API bool GetPackageHeadEventFromName(const FName InPackageName, int64& OutPackageEventId);
	 ...
	 * @return True if the package event was found, false otherwise.
	 */
	UE_API bool GetPackageEvent(const int64 InPackageEventId, const TFunctionRef<void(FConcertSyncPackageEventData&)>& PackageEventFn) const;
	 ...
	 */
	UE_API bool EnumeratePackageNamesWithHeadRevision(TFunctionRef<bool(FName)> InCallback, bool IgnorePersisted) const;
	 ...
	 * @return True if the package data was enumerated without error, false otherwise.
	 */
	UE_API bool EnumerateHeadRevisionPackageData(TFunctionRef<bool(const FConcertPackageInfo&, FConcertPackageDataStream&)> InCallback) const;
	 ...
	 */
	UE_API bool GetPackageInfoForRevision(const FName InPackageName, FConcertPackageInfo& OutPackageInfo, const int64* InPackageRevision = nullptr) const;
	 ...
	 * @return True if package data could be found for the given revision, false otherwise.
	 */
	UE_API bool GetPackageDataForRevision(const FName InPackageName, const TFunctionRef<void(const FConcertPackageInfo&, FConcertPackageDataStream&)>& InCallback, const int64* InPackageRevision = nullptr) const;
	 ...
	 * @return True if package data could be found for the given revision, false otherwise.
	 */
	UE_API TOptional<int64> GetPackageSizeForRevision(const FName InPackageName, const int64* InPackageRevision = nullptr) const;
	 ...
	 */
	UE_API bool GetPackageHeadRevision(const FName InPackageName, int64& OutRevision) const;
	 ...
	 */
	UE_API bool IsHeadRevisionPackageEvent(const int64 InPackageEventId, bool& OutIsHeadRevision) const;
	 ...
	 */
	UE_API bool GetReplicationMaxEventIdByClientAndType(const FGuid& EndpointId, EConcertSyncReplicationActivityType ActivityType, int64& OutReplicationEventId) const;
	 ...
	 */
	UE_API bool AddPersistEventForHeadRevision(FName InPackageName, int64& OutPersistEventId);
	 ...
	 */
	UE_API bool UpdateTransactionEvent(const int64 InTransactionEventId, const FConcertSyncTransactionEvent& InTransactionEvent);
	 ...
	 */
	UE_API bool UpdatePackageEvent(const int64 InPackageEventId, FConcertSyncPackageEventData& PackageEvent);

	/**
	 * Check Asynchronous Tasks Status
	 */
	UE_API void UpdateAsynchronousTasks();

	/**
	 * Flush any ongoing asynchronous tasks.
	 */
	UE_API void FlushAsynchronousTasks();

	/**
	 * Has all asynchronous package tasks completed.
	 */
	UE_API bool HasWritePackageTasksCompleted() const;
...
private:
	...
	UE_API bool HandleRequestPackageRequest(const FName InPackageName, const int64* InPackageRevision, FProcessPackageRequest HandleFunc) const;

	/** Helper functions that for getting a package revision for an optional package revision argument */
	UE_API TOptional<int64> GetSpecifiedOrHeadPackageRevision(FName InPackageName, const int64* InPackageRevision) const;
	 ...
	 **/
	UE_API void ScheduleAsyncWrite(const FName& InPackageName, const FString& InDstPackageBlobPathname, FConcertPackageDataStream& InPackageDataStream);
	 ...
	 */
	UE_API bool SetActivityIgnoredState(const int64 InActivityId, const bool InIsIgnored);
	 ...
	 */
	UE_API bool AddConnectionEvent(const FConcertSyncConnectionEvent& InConnectionEvent, int64& OutConnectionEventId);
	 ...
	 */
	UE_API bool SetConnectionEvent(const int64 InConnectionEventId, const FConcertSyncConnectionEvent& InConnectionEvent);
	 ...
	 */
	UE_API bool AddLockEvent(const FConcertSyncLockEvent& InLockEvent, int64& OutLockEventId);
	 ...
	 */
	UE_API bool SetLockEvent(const int64 InLockEventId, const FConcertSyncLockEvent& InLockEvent);
	 ...
	 */
	UE_API bool AddTransactionEvent(const FConcertSyncTransactionEvent& InTransactionEvent, int64& OutTransactionEventId);
	 ...
	 */
	UE_API bool SetTransactionEvent(const int64 InTransactionEventId, const FConcertSyncTransactionEvent& InTransactionEvent, const bool bMetaDataOnly = false);
	 ...
	 * @return True if the live transaction event IDs were enumerated without error, false otherwise.
	 */
	UE_API bool EnumerateLiveTransactionEventIdsForPackage(const int64 InPackageNameId, TFunctionRef<bool(int64)> InCallback) const;
	 ...
	 * @return True if the package event was added, false otherwise.
	 */
	UE_API bool AddPackageEvent(const FConcertPackageInfo& InPackageInfo, FConcertPackageDataStream& InPackageDataStream, int64& OutPackageEventId);
	 ...
	 */
	UE_API bool SetPackageEvent(const int64 InPackageEventId, int64 PackageRevision, const FConcertPackageInfo& PackageInfo, FConcertPackageDataStream* InPackageDataStream);
	 ...
	 */
	UE_API bool AddReplicationEvent(const FConcertSyncReplicationEvent& InReplicationEvent, int64& OutReplicationEventId);
	 ...
	 */
	UE_API bool SetReplicationEvent(const int64 InReplicationEventId, const FConcertSyncReplicationEvent& InReplicationEvent);
	 ...
	 */
	UE_API bool GetPackageMaxEventId(int64& OutPackageEventId) const;
	 ...
	 */
	UE_API bool GetObjectPathName(const int64 InObjectNameId, FName& OutObjectPathName) const;
	 ...
	 */
	UE_API bool GetObjectNameId(const FName InObjectPathName, int64& OutObjectNameId) const;
	 ...
	 * @return True if the object name ID name was resolved, false otherwise.
	 */
	UE_API bool EnsureObjectNameId(const FName InObjectPathName, int64& OutObjectNameId);
	 ...
	 */
	UE_API bool GetPackageName(const int64 InPackageNameId, FName& OutPackageName) const;
	 ...
	 */
	UE_API bool GetPackageNameId(const FName InPackageName, int64& OutPackageNameId) const;
	 ...
	 * @return True if the package name ID name was resolved, false otherwise.
	 */
	UE_API bool EnsurePackageNameId(const FName InPackageName, int64& OutPackageNameId);
	 ...
	 */
	UE_API bool MapResourceNamesForLock(const int64 InLockEventId, const TArray<FName>& InResourceNames);
	 ...
	 */
	UE_API bool MapPackageNamesForTransaction(const int64 InTransactionEventId, const FConcertTransactionFinalizedEvent& InTransactionEvent);
	 ...
	 */
	UE_API bool MapObjectNamesForTransaction(const int64 InTransactionEventId, const FConcertTransactionFinalizedEvent& InTransactionEvent);
	 ...
	 */
	UE_API bool SaveTransaction(const FString& InTransactionFilename, const FStructOnScope& InTransaction) const;
	 ...
	 */
	UE_API bool LoadTransaction(const FString& InTransactionFilename, FStructOnScope& OutTransaction) const;
	 ...
	 */
	UE_API bool SavePackage(const FString& InDstPackageBlobPathname, const FConcertPackageInfo& InPackageInfo, FConcertPackageDataStream& InPackageDataStream);
	 ...
	 */
	UE_API bool LoadPackage(const FString& InPackageBlobFilename, const TFunctionRef<void(FConcertPackageDataStream&)>& PackageDataStreamFn) const;
