...
namespace UE::ConcertSyncCore
{
	...
	public:
		...
		UE_API bool DependsOnNode(FActivityNodeID NodeId, TOptional<EActivityDependencyReason> WithReason = {}, TOptional<EDependencyStrength> WithStrength = {}) const; 
		UE_API bool DependsOnActivity(int64 InActivityId, const FActivityDependencyGraph& Graph, TOptional<EActivityDependencyReason> WithReason = {}, TOptional<EDependencyStrength> WithStrength = {}) const;
		...
		UE_API bool AffectsActivity(int64 InActivityId, const FActivityDependencyGraph& Graph) const;
