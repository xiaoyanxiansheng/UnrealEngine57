...
namespace UE::ConcertSyncTests
{
	...
	IMPLEMENT_SIMPLE_AUTOMATION_TEST(FConcertDependencyGraphApiTest, "VirtualProduction.Concert.History.GraphApi.DependencyGraphApi", EAutomationTestFlags::EditorContext | EAutomationTestFlags::SmokeFilter)
	...
	/** Ensures that the dependency graph API functions as intended, i.e. you add, connect and query nodes. */
	IMPLEMENT_SIMPLE_AUTOMATION_TEST(FDisallowCyclesInGraph, "VirtualProduction.Concert.History.GraphApi.DisallowCyclesInGraph", EAutomationTestFlags::EditorContext | EAutomationTestFlags::SmokeFilter)
