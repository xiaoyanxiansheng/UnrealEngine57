...
namespace UE::ConcertSyncTests::Replication::Frequency
{
	...
	IMPLEMENT_CUSTOM_SIMPLE_AUTOMATION_TEST(FReceiveAfterSpecifiedFrequencyInterval, FSendReceiveObjectWithFrequencyTest, "VirtualProduction.Concert.Replication.Frequency.SendingClientRespectsFrequency", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter);
	...
	/*IMPLEMENT_CUSTOM_SIMPLE_AUTOMATION_TEST(FSimulateAt30FPS, FSendReceiveObjectWithFrequencyTest, "VirtualProduction.Concert.Replication.Frequency.SimulateAt30FPS", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter);
