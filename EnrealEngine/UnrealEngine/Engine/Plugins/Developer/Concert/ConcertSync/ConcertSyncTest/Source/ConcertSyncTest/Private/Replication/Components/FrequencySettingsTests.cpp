...
namespace UE::ConcertSyncTests
{
	...
	IMPLEMENT_SIMPLE_AUTOMATION_TEST(FFrequencySettingsLessEqual, "VirtualProduction.Concert.Replication.Components.FrequencySettingsLessEqual", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter);
	...
	IMPLEMENT_SIMPLE_AUTOMATION_TEST(FAutoBindingPropertySettingsTest, "VirtualProduction.Concert.Replication.Components.AutoBindingPropertySettingsTest", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter);
