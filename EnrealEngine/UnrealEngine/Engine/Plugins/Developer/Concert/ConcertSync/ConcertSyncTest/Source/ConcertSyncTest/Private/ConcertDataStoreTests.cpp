...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FConcertDataStoreValueVersioning, "VirtualProduction.Concert.DataStore.ValueVersioning", ConcertDataStoreTestFlags)
...
IMPLEMENT_CUSTOM_SIMPLE_AUTOMATION_TEST(FConcertDataStoreClientServerCommonOperations, UE::ConcertSyncTests::DatastoreTests::FConcertDataStoreClientServerTest, "VirtualProduction.Concert.DataStore.ClientServer.CommonOperations", ConcertDataStoreTestFlags)
...
IMPLEMENT_CUSTOM_SIMPLE_AUTOMATION_TEST(FConcertDataStoreClientServerKeyNotFound, UE::ConcertSyncTests::DatastoreTests::FConcertDataStoreClientServerTest, "VirtualProduction.Concert.DataStore.ClientServer.KeyNotFound", ConcertDataStoreTestFlags)
...
IMPLEMENT_CUSTOM_SIMPLE_AUTOMATION_TEST(FConcertDataStoreClientServerTypeMismatch, UE::ConcertSyncTests::DatastoreTests::FConcertDataStoreClientServerTest, "VirtualProduction.Concert.DataStore.ClientServer.TypeMismatch", ConcertDataStoreTestFlags)
...
IMPLEMENT_CUSTOM_SIMPLE_AUTOMATION_TEST(FConcertDataStoreClientServerCompareExchangeOptimization, UE::ConcertSyncTests::DatastoreTests::FConcertDataStoreClientServerTest, "VirtualProduction.Concert.DataStore.ClientServer.CompareExchangeOptimization", ConcertDataStoreTestFlags)
...
IMPLEMENT_CUSTOM_SIMPLE_AUTOMATION_TEST(FConcertDataStoreClientServerClientCache, UE::ConcertSyncTests::DatastoreTests::FConcertDataStoreClientServerTest, "VirtualProduction.Concert.DataStore.ClientServer.ClientCache", ConcertDataStoreTestFlags)
...
IMPLEMENT_CUSTOM_SIMPLE_AUTOMATION_TEST(FConcertDataStoreClientServerChangeNotification, UE::ConcertSyncTests::DatastoreTests::FConcertDataStoreClientServerTest, "VirtualProduction.Concert.DataStore.ClientServer.ChangeNotification", ConcertDataStoreTestFlags)
...
IMPLEMENT_CUSTOM_SIMPLE_AUTOMATION_TEST(FConcertDataStoreClientServerChangeNotificationHandler, UE::ConcertSyncTests::DatastoreTests::FConcertDataStoreClientServerTest, "VirtualProduction.Concert.DataStore.ClientServer.ChangeNotificationHandler", ConcertDataStoreTestFlags)
...
IMPLEMENT_CUSTOM_SIMPLE_AUTOMATION_TEST(FConcertDataStoreClientServerBlockingApi, UE::ConcertSyncTests::DatastoreTests::FConcertDataStoreClientServerTest, "VirtualProduction.Concert.DataStore.ClientServer.BlockingAPI", ConcertDataStoreTestFlags)
...
IMPLEMENT_CUSTOM_SIMPLE_AUTOMATION_TEST(FConcertDataStoreClientServerContinuationApi, UE::ConcertSyncTests::DatastoreTests::FConcertDataStoreClientServerTest, "VirtualProduction.Concert.DataStore.ClientServer.ContinuationAPI", ConcertDataStoreTestFlags)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FConcertDataStoreClientPrivateStore, "VirtualProduction.Concert.DataStore.ClientPrivateStore", ConcertDataStoreTestFlags)
