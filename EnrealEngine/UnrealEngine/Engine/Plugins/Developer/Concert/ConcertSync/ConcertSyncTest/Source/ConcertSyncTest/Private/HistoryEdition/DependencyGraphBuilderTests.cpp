...
namespace UE::ConcertSyncTests::RenameEditAndDeleteMapsFlowTest
{
	 ...
	 *	8 -> 5 (PackageRemoval)
	 */
	IMPLEMENT_SIMPLE_AUTOMATION_TEST(FRenameEditAndDeleteMapsFlowTest, "VirtualProduction.Concert.History.BuildGraph.RenameEditAndDeleteMapsFlow", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
namespace UE::ConcertSyncTests::DeletingAndRecreatingActorIsHardDependency
{
	 ...
	 */
	IMPLEMENT_SIMPLE_AUTOMATION_TEST(FDeletingAndRecreatingActorIsHardDependency, "VirtualProduction.Concert.History.BuildGraph.DeletingAndRecreatingActorIsHardDependency", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
namespace UE::ConcertSyncTests::IndirectPackageDependencyTest
{
	 ...
	 */
	IMPLEMENT_SIMPLE_AUTOMATION_TEST(FIndirectPackageDependencyTest, "VirtualProduction.Concert.History.BuildGraph.IndirectPackageDependencyTest", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
namespace UE::ConcertSyncTests::PackageEditedDependencyTest
{
	 ...
	 *  13 -> 12
	 */
	IMPLEMENT_SIMPLE_AUTOMATION_TEST(FPackageEditedDependencyTest, "VirtualProduction.Concert.History.BuildGraph.PackageEditedDependencyTest", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
namespace UE::ConcertSyncTests::RenamingDependencyEdgeCases
{
	 ...
	 *  9 Rename Bar to Foo
	 */
	IMPLEMENT_SIMPLE_AUTOMATION_TEST(FRenamingDependencyEdgeCaseTests, "VirtualProduction.Concert.History.BuildGraph.RenamingDependencyEdgeCaseTests", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
namespace UE::ConcertSyncTests::TransactionDependencyEdgeCases
{
	...
	IMPLEMENT_SIMPLE_AUTOMATION_TEST(FTransactionDependencyEdgeCaseTests, "VirtualProduction.Concert.History.BuildGraph.TransactionDependencyEdgeCaseTests", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
