...
{
	IMPLEMENT_SIMPLE_AUTOMATION_TEST(FTopDownUseCase, "VirtualProduction.Concert.History.Analysis.TopDownUseCase", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
	 ...
	 */
	IMPLEMENT_SIMPLE_AUTOMATION_TEST(FTopDownDiamond, "VirtualProduction.Concert.History.Analysis.TopDownDiamond", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
