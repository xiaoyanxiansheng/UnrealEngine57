...
namespace UE::ConcertSyncTests::ChangeStreamUtils
{
	 ...
	 */
	IMPLEMENT_SIMPLE_AUTOMATION_TEST(FSimpleDiffChangesTest, "VirtualProduction.Concert.Replication.Components.DiffChangesSimple", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter);
