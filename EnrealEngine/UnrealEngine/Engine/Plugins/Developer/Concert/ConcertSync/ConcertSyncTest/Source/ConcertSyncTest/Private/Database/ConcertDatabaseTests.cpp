...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FConcertSessionDatabaseTest, "VirtualProduction.Concert.Database.SessionDatabase", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
