...
namespace UE::ConcertSyncTests::AnalysisTests
{
	 ...
	 */
	IMPLEMENT_SIMPLE_AUTOMATION_TEST(FBottomUpUseCase, "VirtualProduction.Concert.History.Analysis.BottomUpUseCase", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
	 ...
	 */
	IMPLEMENT_SIMPLE_AUTOMATION_TEST(FBottomUpDiamond, "VirtualProduction.Concert.History.Analysis.BottomUpDiamond", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
