...
class FTraceSourceFilteringTestBase : public FAutomationTestBase
{
public:		
	...
	SOURCEFILTERINGTRACE_API virtual bool RunTest(const FString& Parameters) override;
...
protected:
	...
	SOURCEFILTERINGTRACE_API FFilterSet& AddFilterSet(EFilterSetMode InMode);
...
private:
	SOURCEFILTERINGTRACE_API void Init();
	SOURCEFILTERINGTRACE_API void TickFiltering();
	SOURCEFILTERINGTRACE_API void ManualTick();
	SOURCEFILTERINGTRACE_API bool CompareExpectedResults();
	SOURCEFILTERINGTRACE_API void Cleanup();
	SOURCEFILTERINGTRACE_API void Reset();
protected:
