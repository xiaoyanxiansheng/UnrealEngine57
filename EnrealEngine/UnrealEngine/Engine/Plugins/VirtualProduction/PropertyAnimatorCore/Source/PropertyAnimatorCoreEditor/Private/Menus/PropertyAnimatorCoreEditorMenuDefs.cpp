...
FPropertyAnimatorCoreEditorMenuContext::FPropertyAnimatorCoreEditorMenuContext(const TSet<UObject*>& InObjects, const TArray<FPropertyAnimatorCoreData>& InProperties)
{
