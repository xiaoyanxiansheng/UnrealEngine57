...
#include "Customization/RivermaxMediaPropertyCustomization.h"
...
private:
	...
	void RegisterCustomizations()
	{
		...
		PropertyModule.RegisterCustomPropertyTypeLayout(TEXT("RivermaxStream"), FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FRivermaxStreamCustomization::MakeInstance));
		PropertyModule.RegisterCustomPropertyTypeLayout(TEXT("RivermaxVideoStream"), FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FRivermaxStreamCustomization::MakeInstance));
		PropertyModule.RegisterCustomPropertyTypeLayout(TEXT("RivermaxAncStream"), FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FRivermaxStreamCustomization::MakeInstance));
	...
	void UnregisterCustomizations()
	{
		...
		if (PropertyModule)
		{
			...
			PropertyModule->UnregisterCustomPropertyTypeLayout(TEXT("RivermaxStream"));
			PropertyModule->UnregisterCustomPropertyTypeLayout(TEXT("RivermaxVideoStream"));
			PropertyModule->UnregisterCustomPropertyTypeLayout(TEXT("RivermaxAncStream"));
			PropertyModule->NotifyCustomizationModuleChanged();
		}
	}
