...
#include "OpenXRPlatformRHI.h" // Needed to get openxr_platform.h with the correct #defines set
...
{
#if PLATFORM_WINDOWS
	OutExtensions.Add(XR_KHR_WIN32_CONVERT_PERFORMANCE_COUNTER_TIME_EXTENSION_NAME);
#endif
