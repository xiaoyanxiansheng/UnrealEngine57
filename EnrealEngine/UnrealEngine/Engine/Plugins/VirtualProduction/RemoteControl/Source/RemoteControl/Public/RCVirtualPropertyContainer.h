...
/** 
 * Describes a category into which properties can be placed.
 */
USTRUCT()
...
public:
	...
	/**
	 * Returns whether this container contains the given property.
	 */
	bool HasVirtualProperty(const URCVirtualPropertyBase* InVirtualProperty) const;
...
public:
	...
	UPROPERTY()
	TArray<FRCVirtualPropertyCategory> Categories;
