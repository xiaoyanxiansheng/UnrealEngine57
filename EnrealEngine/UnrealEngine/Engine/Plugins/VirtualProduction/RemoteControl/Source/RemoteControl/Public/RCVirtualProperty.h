...
public:
	...
	virtual void InitPropertyBagPropertyDescription(FPropertyBagPropertyDesc& InOutPropertyDesc) {}
	...
	*/
	...
	/** Get raw Enum value from Virtual Property */
	UFUNCTION(BlueprintCallable, Category = "Remote Control Behaviour")
	bool GetValueEnum(uint8& OutByte) const;
	...
	*/
	...
	virtual void UpdateEntityUsage(const URemoteControlPreset* InPreset, TMap<FGuid, TSet<UObject*>>& InEntityToBehavior) const {}
