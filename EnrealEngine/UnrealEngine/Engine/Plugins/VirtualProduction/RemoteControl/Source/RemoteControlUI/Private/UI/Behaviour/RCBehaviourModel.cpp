...
const FLazyName FRCBehaviourModel::BehaviorModelName = "BehaviorModel";
...
int32 FRCBehaviourModel::RemoveModel()
{
	URCBehaviour* Behavior = GetBehaviour();
	...
	URCController* Controller = Behavior->ControllerWeakPtr.Get();
	...
	return Controller->RemoveBehaviour(Behavior) ? 1 : 0;
}
