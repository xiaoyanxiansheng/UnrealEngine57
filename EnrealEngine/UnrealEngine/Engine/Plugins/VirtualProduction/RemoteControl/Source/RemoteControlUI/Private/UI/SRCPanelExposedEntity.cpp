...
TSharedPtr<SWidget> SRCPanelExposedEntity::GetContextMenu()
{
	...
	MenuBuilder.AddMenuEntry(FRemoteControlCommands::Get().SelectSource, NAME_None, TAttribute<FText>(), TAttribute<FText>(), FSlateIcon(FAppStyle::GetAppStyleSetName(), TEXT("Icons.SelectInViewport")));
