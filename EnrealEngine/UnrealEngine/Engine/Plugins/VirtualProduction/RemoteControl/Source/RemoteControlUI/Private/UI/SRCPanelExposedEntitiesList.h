...
public:
	...
	/** Update the In Use flag on entities. */
...
private:
	...
	/** Selects the source of the currently selected entity. */
	void SelectSource_Execute();

	void UpdateEntityUsage_Execute();
...
private:
	...
	/** If true, the entity list will have its in use flag updated next frame. */
	bool bUpdateEntityUsage;
