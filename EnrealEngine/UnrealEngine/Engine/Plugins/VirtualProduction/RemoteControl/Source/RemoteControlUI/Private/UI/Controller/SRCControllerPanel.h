...
{
	static const FLazyName CategoryName;
	static const FLazyName InitialDescriptionName;
	static const FString CategoryMeta;
...
public:
	...
	static UE::RemoteControl::UI::Private::FRCControllerPropertyInfo GetPropertyInfoForCustomType(const FName& InType);
	...
	/** Checks to make sure selected items are duplicatable */
	...
	/** Checks to make sure selected items are copyable. */
	...
	/** Get the currently selected controller models. */
...
private:
	...
	/** Builds a menu containing the list of all possible structs on which to base a Controller. */
	void GetControllerMenuStructContentWidget(FMenuBuilder& InMenuBuilder) const;

	/** Builds a menu containing the list of all possible enums on which to base a Controller. */
	void GetControllerMenuEnumContentWidget(FMenuBuilder& InMenuBuilder) const;

	TSharedRef<SWidget> GetMultiControllerSwitchWidget();

	/** Handles click event for Add Controller button */
	void OnAddControllerClicked(const EPropertyBagPropertyType InValueType, const UE::RemoteControl::UI::Private::FRCControllerPropertyInfo InControllerPropertyInfo) const;
	void OnAddControllerClicked(const EPropertyBagPropertyType InValueType, const UE::RemoteControl::UI::Private::FRCControllerPropertyInfo InControllerPropertyInfo, TSubclassOf<URCController> InControllerClass) const;

	/** Handles adding a new category */
	void OnAddCategoryClicked() const;

	/** Handles selection of controller type in submenus. */
	void OnAddControllerSelected(TSharedPtr<UE::RemoteControl::UI::Private::FRCControllerPropertyInfo> InControllerPropertyInfo) const;
