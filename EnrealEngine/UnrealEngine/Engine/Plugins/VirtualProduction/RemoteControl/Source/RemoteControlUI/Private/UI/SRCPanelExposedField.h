...
private:
	...
	/** Creates a widget which says whether this field is bound to a controller. */
	TSharedRef<SWidget> CreateInUseWidget();

	/** Returns the number of behaviors bound to this field. */
