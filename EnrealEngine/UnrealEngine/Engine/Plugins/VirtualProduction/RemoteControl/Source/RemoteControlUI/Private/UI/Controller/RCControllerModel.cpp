...
const FLazyName FRCControllerModel::ControllerModelName = "ControllerModel";
...
int32 FRCControllerModel::RemoveModel()
{
	URCVirtualPropertyBase* Controller = GetVirtualProperty();
	...
	if (Preset->RemoveController(GetPropertyName()))
	{
		return 1;
	}
