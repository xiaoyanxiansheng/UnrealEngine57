...
public:
	...
	FCustomTypeFilterData(EEntityTypeCategories::Type InEntityTypeCategory, FFieldClass* InEntityType, FText InFilterDisplayName, const FName& InCustomTypeName = NAME_None)
		: Class(nullptr)
	...
	FCustomTypeFilterData(EEntityTypeCategories::Type InEntityTypeCategory, FFieldClass* InEntityType, FText InEntityTypeDisplayName, TSharedPtr<FFilterCategory> InCategory, const FName& InCustomTypeName = NAME_None)
		: Class(nullptr)
		, EntityType(InEntityType)
		, EntityTypeCategory(InEntityTypeCategory)
		, FilterDisplayName(InEntityTypeDisplayName)
		, Color(FLinearColor::White)
		, CustomTypeName(InCustomTypeName)
		, AssetTypeActions(nullptr)
	{
