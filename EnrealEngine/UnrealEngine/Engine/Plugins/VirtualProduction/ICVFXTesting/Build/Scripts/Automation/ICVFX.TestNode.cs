...
namespace ICVFXTest
{
	public class ICVFXTestConfig : UnrealTestConfiguration
	{
		...
		/// <summary>
		/// Should run fullscreen
		/// </summary>
		[AutoParamWithNames(false, "ICVFXTest.Fullscreen")]
		public bool Fullscreen;

		/// <summary>
		/// Should run offscreen
		/// </summary>
		[AutoParamWithNames(false, "ICVFXTest.Offscreen")]
		public bool Offscreen;

		/// <summary>
		/// Window X location
		/// </summary>
		[AutoParamWithNames(0, "ICVFXTest.WndLocX")]
		public int WndLocX;

		/// <summary>
		/// Window Y location
		/// </summary>
		[AutoParamWithNames(0, "ICVFXTest.WndLocY")]
		public int WndLocY;

		/// <summary>
		/// Window X size (width)
		/// </summary>
		[AutoParamWithNames(1920, "ICVFXTest.WndResX")]
		public int WndResX;

		/// <summary>
		/// Window Y size (height)
		/// </summary>
		[AutoParamWithNames(1080, "ICVFXTest.WndResY")]
		public int WndResY;
		...
		/// Report type
		/// </summary>
		[AutoParamWithNames("ICVFXTest.SummaryReportType")]
		public string SummaryReportType;
		...
		/// <summary>
		/// Force file name to use for a trace file. If not specified, the default one will be generated.
		/// </summary>
		[AutoParamWithNames("ICVFXTest.TraceFileName")]
