...
public class LiveLinkVRPN : ModuleRules
{
	...
	public void AddThirdPartyDependencies(ReadOnlyTargetRules Target)
	{
		...
		string ArchDir = Target.Platform.IsInGroup(UnrealPlatformGroup.Windows) ? Target.Architecture.WindowsLibDir : "";
		PublicAdditionalLibraries.Add(Path.Combine(PathLib, Target.Platform.ToString(), ArchDir, "Release", "vrpn.lib"));
		PublicAdditionalLibraries.Add(Path.Combine(PathLib, Target.Platform.ToString(), ArchDir, "Release", "quat.lib"));
