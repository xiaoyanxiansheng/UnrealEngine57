...
class UStormSyncArchiveFactory : public UFactory, public FReimportHandler
{
	GENERATED_BODY()
public:
	...
	virtual void SetReimportPaths(UObject* InObject, const TArray<FString>& InNewReimportPaths) override;
