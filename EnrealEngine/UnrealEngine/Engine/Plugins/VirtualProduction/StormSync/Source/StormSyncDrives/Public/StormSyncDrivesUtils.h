...
public:
	...
	static bool ValidateMountPoint(const FStormSyncMountPointConfig& InMountPoint, FText& ErrorText, EStormSyncDriveErrorCode* OutErrorCode = nullptr);

	/** Checks validity for a mount point */
	static bool ValidateRootPath(const FString& InRootPath, FText& ErrorText, EStormSyncDriveErrorCode* OutErrorCode = nullptr);

	/** Checks validity for a mount directory */
	static bool ValidateDirectory(const FDirectoryPath& InDirectory, FText& ErrorText, EStormSyncDriveErrorCode* OutErrorCode = nullptr);
