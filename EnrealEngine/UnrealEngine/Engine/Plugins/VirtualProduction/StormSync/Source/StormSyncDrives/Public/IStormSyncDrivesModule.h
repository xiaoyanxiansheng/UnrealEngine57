...
public:
	 ...
	 * @param OutError optional enum for further details on the operation's error if any
	 * @returns true if we were able to register the mount point
	 */
	virtual bool RegisterMountPoint(const FStormSyncMountPointConfig& InMountPoint, FText& ErrorText, EStormSyncDriveErrorCode* OutError = nullptr) = 0;
