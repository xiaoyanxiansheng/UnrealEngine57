...
public:
	...
	virtual FName RegisterViewportToolbar() const override;
	...
	TSharedPtr<SAvaLevelViewportGuide> AddGuide(EOrientation InOrientation, float InOffsetFraction, bool bInSaveGuides = true); /** 0 = left/top. 1 = right/bottom/ */
...
private:
	...
	static void AddVisualizerEntries(UToolMenu* InMenu);
