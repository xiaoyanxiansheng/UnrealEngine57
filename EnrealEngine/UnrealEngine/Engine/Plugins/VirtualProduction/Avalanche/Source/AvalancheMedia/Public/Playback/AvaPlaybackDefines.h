...
namespace UE::AvaMedia::Playback
{
	/**
	 * Playback manager needs a channel name as a key.
	 * The default key for a preview channel that may not have a defined broadcast channel.
	 */
	static inline const FLazyName DefaultPreviewChannelName = FLazyName(TEXT("_Preview"));
}