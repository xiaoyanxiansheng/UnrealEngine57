...
enum class EAvaPlayableRCUpdateFlags : uint8
{
	...
	/**
	 *  The controller values are to be considered as events and will only apply to the event controllers.
	 *  Non-event controllers and entity values are ignored during the execution of this update.
	 */
