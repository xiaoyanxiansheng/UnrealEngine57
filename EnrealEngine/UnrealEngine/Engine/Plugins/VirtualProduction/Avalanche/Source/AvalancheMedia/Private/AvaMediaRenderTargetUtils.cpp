...
namespace UE::AvaMediaRenderTargetUtils
{
	...
	FIntPoint GetRenderTargetSizeSafe(const UTextureRenderTarget2D* InRenderTarget)
	{
		return InRenderTarget ? FIntPoint(InRenderTarget->SizeX, InRenderTarget->SizeY) : FIntPoint(0,0);
	}
