...
public:
	...
	virtual void SetParentMaterial(UMaterialInterface* InMaterial) override { Super::SetParentMaterial(InMaterial); }
	virtual UMaterialInterface* GetParentMaterial() override { return Super::GetParentMaterial(); }
