...
public:
	...
	virtual void SetParentMaterial(UMaterialInterface* InMaterial) override { FAvaParametricMaterialHandle::SetParentMaterial(InMaterial); }
	virtual UMaterialInterface* GetParentMaterial() override { return FAvaParametricMaterialHandle::GetParentMaterial(); }
