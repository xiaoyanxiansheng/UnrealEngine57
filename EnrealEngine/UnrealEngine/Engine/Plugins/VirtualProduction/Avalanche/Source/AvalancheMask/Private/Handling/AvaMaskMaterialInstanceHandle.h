...
public:
	...
	virtual void SetParentMaterial(UMaterialInterface* InMaterial) override { FAvaMaterialInstanceHandle::SetParentMaterial(InMaterial); }
	virtual UMaterialInterface* GetParentMaterial() override { return FAvaMaterialInstanceHandle::GetParentMaterial(); }
