...
protected:
	...
	// mesh material type
	UPROPERTY(EditInstanceOnly, Category="Material", meta=(NoResetToDefault, DisplayName="Material Type", DisplayAfter="bUsePrimaryMaterialEverywhere", EditCondition="bMeshVisible && !bUsesPrimaryMaterialParams", EditConditionHides, AllowPrivateAccess = "true"))
	EMaterialType MaterialType;

	// mesh material
	UPROPERTY(EditInstanceOnly, Category="Material", meta=(NoResetToDefault, DisplayName="Material", DisplayAfter="MaterialType", EditCondition="bMeshVisible && !bUsesPrimaryMaterialParams && MaterialType != EMaterialType::Parametric", EditConditionHides, AllowPrivateAccess = "true"))
	TObjectPtr<UMaterialInterface> Material;

	// parametric material settings
	UPROPERTY(EditInstanceOnly, Category="Material", meta=(NoResetToDefault, DisplayName="Material", DisplayAfter="Material", EditCondition="bMeshVisible && !bUsesPrimaryMaterialParams && MaterialType == EMaterialType::Parametric", EditConditionHides, AllowPrivateAccess = "true"))
	FAvaShapeParametricMaterial ParametricMaterial;

	// mesh uses same uv params as primary
	UPROPERTY(EditInstanceOnly, Category="Material", meta=(NoResetToDefault, DisplayAfter="ParametricMaterial", EditCondition="bMeshVisible && MeshIndex != 0", EditConditionHides, AllowPrivateAccess = "true"))
	bool bOverridePrimaryUVParams;

	// mesh material UV params
	UPROPERTY(EditInstanceOnly, Category="Material", meta=(NoResetToDefault, DisplayName="UV Params", DisplayAfter="bOverridePrimaryUVParams", EditCondition="bMeshVisible && bOverridePrimaryUVParams", EditConditionHides, AllowPrivateAccess = "true"))
