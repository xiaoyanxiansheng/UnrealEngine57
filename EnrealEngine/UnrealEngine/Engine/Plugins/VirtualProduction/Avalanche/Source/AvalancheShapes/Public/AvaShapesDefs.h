...
{
	// uvs are stretched to fit the shape size
	Stretch		UMETA(DisplayName="Stretch to Fit"),
	// uvs are uniform to not cause any distortion
	Uniform		UMETA(DisplayName="Preserve Ratio"),
};
