...
protected:
	...
	UPROPERTY(EditInstanceOnly, BlueprintReadWrite, Setter, Getter, Category="Shape", meta=(ClampMin="0.0", ClampMax="1.0",DisplayName="Inner Size", AllowPrivateAccess="true"))
	float InnerSize;
