...
public:
	...
	/**
	 * Adds the given sequences to the sequence provider
	 * @param InSequences the sequences to add, if valid and not already in the list.
	 * @return the number of sequences that were successfully added.
	 */
	virtual uint32 AddSequences(TConstArrayView<UAvaSequence*> InSequences) = 0;
