...
void FAvaEditorCommands::RegisterToolsCommands()
{
	...
	FUICommandInfo::MakeCommandInfo(AsShared()
		, TickerTool
		, TEXT("TickerTool")
		, LOCTEXT("TickerTool", "Ticker")
		, LOCTEXT("TickerTool_Tooltip", "Create a Motion Design Ticker actor in the viewport.")
		, FSlateIconFinder::FindIconForClass(AActor::StaticClass())
		, EUserInterfaceActionType::ToggleButton
		, FInputChord()
	);
