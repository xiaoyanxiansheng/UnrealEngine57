	...
	: FSlateStyleSet(TEXT("AvaEditor"))
{
	...
	Set("AvaEditor.ConeTool",         new IMAGE_BRUSH("Icons/ToolboxIcons/cone",          Icon16));
	Set("AvaEditor.PlaneTool",        new IMAGE_BRUSH("Icons/ToolboxIcons/plane",         Icon16));
	Set("AvaEditor.CycloramaTool",    new IMAGE_BRUSH("Icons/ToolboxIcons/roundedsquare", Icon16));
