...
public:
	...
	DECLARE_MULTICAST_DELEGATE_OneParam(FOnAvaSequencerCreated, TSharedRef<IAvaSequencer>);
	FOnAvaSequencerCreated& OnSequencerCreated() { return OnSequencerCreatedDelegate; }
...
private:
	...
	FOnAvaSequencerCreated OnSequencerCreatedDelegate;
};
