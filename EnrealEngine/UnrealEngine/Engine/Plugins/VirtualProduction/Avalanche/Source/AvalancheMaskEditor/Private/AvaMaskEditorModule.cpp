...
void FAvalancheMaskEditorModule::StartupModule()
{
	...
	{
		EditorModule->OnGetMediaPlateMaterialAssetPaths().AddRaw(this, &FAvalancheMaskEditorModule::OnGetMediaPlateMaterialAssetPaths);
	}
...
void FAvalancheMaskEditorModule::ShutdownModule()
{
	...
	if (FMediaPlateEditorModule* EditorModule = FModuleManager::GetModulePtr<FMediaPlateEditorModule>("MediaPlateEditor"))
	{
		EditorModule->OnGetMediaPlateMaterialAssetPaths().RemoveAll(this);
	}
...
void FAvalancheMaskEditorModule::OnGetMediaPlateMaterialAssetPaths(TArray<FName>& OutAssetPaths)
{
	// Add package path(s) to media plate material variations for mask modifier. 
	OutAssetPaths.AddUnique(FName("/Avalanche/MaskResources/MediaPlate"));
}
