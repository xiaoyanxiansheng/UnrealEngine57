...
public:
	...
	/** Called when the scene object has been created */
	virtual void OnSceneObjectCreated(UObject* InSceneObject) {}

	/** Called when the scene object has been changed/replaced*/
	...
	/** Opportunity for an extension to add to the create scene options menu */
	virtual void ExtendCreateSceneOptions(UToolMenu* InMenu) {}
