...
BEGIN_DEFINE_SPEC(AvalancheModifiersRadialArrange, "Avalanche.Modifiers.RadialArrange",
	...
	UActorModifierRadialArrangeModifier* RadialArrangeModifier;
...
void AvalancheModifiersRadialArrange::Define()
{
	BeforeEach([this]
	{
		...
		const FName ModifierName = ModifierTestUtils->GetModifierName(UActorModifierRadialArrangeModifier::StaticClass());
		...
		RadialArrangeModifier = Cast<UActorModifierRadialArrangeModifier>(ModifierSubsystem->InsertModifier(ModifierStack, InsertOp));
