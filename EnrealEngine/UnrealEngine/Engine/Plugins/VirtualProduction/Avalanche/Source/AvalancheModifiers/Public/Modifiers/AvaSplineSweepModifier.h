...
public:
	static constexpr int32 MaxSampleCount = 200;
...
protected:
	...
	UPROPERTY(EditInstanceOnly, Setter="SetSplineActorWeak", Getter="GetSplineActorWeak", Category="SplineSweep", meta=(FilterActorByComponentClass="/Script/Engine.SplineComponent", AllowPrivateAccess="true"))
	...
	UPROPERTY(EditInstanceOnly, Setter="SetSteps", Getter="GetSteps", Category="SplineSweep", meta=(ClampMin="3", ClampMax="200", AllowPrivateAccess="true"))
	int32 Steps = 64;

	/** Sample range offset of the spline, for closed loop spline range can wrap around */
	UPROPERTY(EditInstanceOnly, Setter="SetProgressOffset", Getter="GetProgressOffset", Category="SplineSweep", meta=(AllowPrivateAccess="true"))
