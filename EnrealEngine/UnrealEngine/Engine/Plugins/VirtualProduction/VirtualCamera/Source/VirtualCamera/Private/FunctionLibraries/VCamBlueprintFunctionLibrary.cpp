...
void UVCamBlueprintFunctionLibrary::SetCameraOverscan(UCineCameraComponent* InCameraComponent, const FVector4f& InAsymmetricOverscan, bool bScaleResolution)
{
	if (InCameraComponent)
	{
		InCameraComponent->AsymmetricOverscan = InAsymmetricOverscan;
		InCameraComponent->bScaleResolutionWithOverscan = bScaleResolution;
	}
}

void UVCamBlueprintFunctionLibrary::ClearCameraOverscan(UCineCameraComponent* InCameraComponent)
{
	if (InCameraComponent)
	{
		InCameraComponent->AsymmetricOverscan = FVector4f::Zero();
		InCameraComponent->bScaleResolutionWithOverscan = false;
	}
}
