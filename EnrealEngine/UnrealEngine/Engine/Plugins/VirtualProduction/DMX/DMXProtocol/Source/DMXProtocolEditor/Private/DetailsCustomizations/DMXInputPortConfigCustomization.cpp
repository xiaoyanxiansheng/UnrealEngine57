...
{
	// Mimic a Edit Condition Toggle - Doing it directly via Meta Specifiers is not possible. -
	// The Edit Condition Toggle property wouldn't get properly serialized when being a Config property.
	...
	PropertyRow.CustomWidget()
		...
		[
			...
			// Edit Condition Toggle Checkbox
			+ SHorizontalBox::Slot()
			.HAlign(HAlign_Left)
			.VAlign(VAlign_Fill)
			.AutoWidth()
