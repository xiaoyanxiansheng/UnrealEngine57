...
public:
	...
	static FName GetUserNamePropertyName() { return GET_MEMBER_NAME_CHECKED(UDMXControlConsoleFaderGroupController, UserName); }
	static FName GetFaderGroupsPropertyName() { return GET_MEMBER_NAME_CHECKED(UDMXControlConsoleFaderGroupController, FaderGroups); }
	static FName GetElementControllersPropertyName() { return GET_MEMBER_NAME_CHECKED(UDMXControlConsoleFaderGroupController, ElementControllers); }
	static FName GetEditorColorPropertyName() { return GET_MEMBER_NAME_CHECKED(UDMXControlConsoleFaderGroupController, EditorColor); }
