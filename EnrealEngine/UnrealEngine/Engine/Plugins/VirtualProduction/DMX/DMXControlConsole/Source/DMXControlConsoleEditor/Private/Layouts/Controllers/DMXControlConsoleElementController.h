...
public:
	...
	static FName GetUserNamePropertyName() { return GET_MEMBER_NAME_CHECKED(UDMXControlConsoleElementController, UserName); }
	static FName GetValuePropertyName() { return GET_MEMBER_NAME_CHECKED(UDMXControlConsoleElementController, Value); }
	static FName GetMinValuePropertyName() { return GET_MEMBER_NAME_CHECKED(UDMXControlConsoleElementController, MinValue); }
	static FName GetMaxValuePropertyName() { return GET_MEMBER_NAME_CHECKED(UDMXControlConsoleElementController, MaxValue); }
	static FName GetElementsPropertyName() { return GET_MEMBER_NAME_CHECKED(UDMXControlConsoleElementController, Elements); }
	static FName GetFloatOscillatorClassPropertyName() { return GET_MEMBER_NAME_CHECKED(UDMXControlConsoleElementController, FloatOscillatorClass); }
	static FName GetFloatOscillatorPropertyName() { return GET_MEMBER_NAME_CHECKED(UDMXControlConsoleElementController, FloatOscillator); }
