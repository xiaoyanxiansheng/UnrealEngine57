...
public:
	...
	const TSharedPtr<SDMXPixelMappingComponentBox>& GetComponentBox() const { return ComponentBox; }
	const TSharedPtr<SDMXPixelMappingComponentLabel>& GetComponentLabel() const { return ComponentLabel; }
