...
struct FDMXCachedFunctionChannelInfo
{
	...
	bool NeedsInitialization() const { return bNeedsInitialization; }
	...
	EDMXFixtureSignalFormat GetSignalFormat() const { return SignalFormat; }

	bool ShouldUseLSBMode() const { return bLSBMode; }
