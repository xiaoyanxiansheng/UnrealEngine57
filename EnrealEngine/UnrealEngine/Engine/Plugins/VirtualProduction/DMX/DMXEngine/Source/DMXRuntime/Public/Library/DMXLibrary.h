...
public:
	 ...
	 */
	UDMXMVRGeneralSceneDescription* GetLazyGeneralSceneDescription() const { return GeneralSceneDescription; }

	/** Returns the Entity that was last added to the Library */
	TWeakObjectPtr<UDMXEntity> GetLastAddedEntity() const { return LastAddedEntity; }
