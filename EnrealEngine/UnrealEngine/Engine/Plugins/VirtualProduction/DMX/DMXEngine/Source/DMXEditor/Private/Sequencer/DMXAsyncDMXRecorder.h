...
public:
	...
	int32 GetLocalUniverseID() const { return LocalUniverseID; }

	const TWeakObjectPtr<UDMXEntityFixturePatch> GetFixturePatch() const { return FixturePatch; }

	const FName& GetAttributeName() const { return AttributeName; }

	bool IsCellChannel() const { return bCellChannel; }
