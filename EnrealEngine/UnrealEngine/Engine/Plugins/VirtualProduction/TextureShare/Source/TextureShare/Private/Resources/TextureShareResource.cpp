...
//////////////////////////////////////////////////////////////////////////////////////////////
void FTextureShareResource::InitRHI(FRHICommandListBase& RHICmdList)
{
	FTextureRHIRef NewTextureRHI;
	switch (CoreObject->GetObjectDesc_RenderThread().ProcessDesc.DeviceType)
	{
	case ETextureShareDeviceType::D3D12:
		InitDynamicRHI_D3D12(RHICmdList, NewTextureRHI);
		break;

	default:
		InitDynamicRHI_Default(RHICmdList, NewTextureRHI);
		break;
	};
...
void FTextureShareResource::InitDynamicRHI_Default(FRHICommandListBase& RHICmdList, FTextureRHIRef& OutTextureRHI)
{
