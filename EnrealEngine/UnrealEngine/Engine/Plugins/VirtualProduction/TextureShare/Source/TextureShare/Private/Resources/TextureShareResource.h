...
protected:
	void InitDynamicRHI_Default(FRHICommandListBase& RHICmdList, FTextureRHIRef& OutTextureRHI);
	void InitDynamicRHI_D3D12(FRHICommandListBase& RHICmdList, FTextureRHIRef& OutTextureRHI);
