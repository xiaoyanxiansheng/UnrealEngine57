...
FText UTakeRecorderLevelSequenceSource::GetAddSourceDisplayTextImpl() const
{
    return NSLOCTEXT("UTakeRecorderLevelSequenceSource", "TakeRecorderDisplayName", "Level Sequence");
}
