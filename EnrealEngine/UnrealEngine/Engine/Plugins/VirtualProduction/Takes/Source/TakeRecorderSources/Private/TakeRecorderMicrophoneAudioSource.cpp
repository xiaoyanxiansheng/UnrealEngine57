...
void UTakeRecorderMicrophoneAudioSource::DoAudioSetup()
{
	UTakeRecorderMicrophoneAudioManager* AudioInputManager = GetAudioInputManager();
	if (!bHaveDoneAudioSetup && AudioInputManager != nullptr)
	{
		AudioInputManager->EnumerateAudioDevices(true);
