...
class FMovieScene3DTransformTrackRecorderFactory : public IMovieSceneTrackRecorderFactory
{
public:
...
public:
	...
	UE_API void PostProcessAnimationData(class UMovieSceneAnimationTrackRecorder* AnimTrackRecorder);
private:
	UE_API bool ResolveTransformToRecord(FTransform& TransformToRecord);
	UE_API bool ShouldAddNewKey(const FTransform& TransformToRecord);
	UE_API void SetUpDefaultTransform();
private:
	/** Track to record to */
