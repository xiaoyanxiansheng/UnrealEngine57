...
public:
	...
	UE_API UTakeRecorderSource(const FObjectInitializer& ObjInit);
...
public:
	...
	*/
	UE_API virtual TArray<UTakeRecorderSource*> PreRecording(ULevelSequence* InSequence, FMovieSceneSequenceID InSequenceID, ULevelSequence* InRootSequence, FManifestSerializer* InManifestSerializer);
...
private:
	...
	UE_API virtual const FSlateBrush* GetDisplayIconImpl() const;
