...
public:
	...
	UE_API void UpdateCachedValues();
private:
	UE_API int32 NumberOfPropertiesRecordedOnThis() const;
	UE_API int32 NumberOfComponentsRecordedOnThis() const;

	/** This is called by the children to let the parent know that the number of recorded properties has changed*/
	UE_API void ChildChanged();
