...
static FAutoConsoleVariableRef  CVarSaveTakesWithNoError(TEXT("Takes.SaveTakesWithNoErrorFlag"), bSaveTakesWithNoErrorFlag, TEXT("For DrySquash only."));
...
void SaveAsset(UObject* InObject)
{
	...
	{
		UE_LOG(LogTakesCore, Log, TEXT("Failed to save %s."), *PackageName);
	}
}
