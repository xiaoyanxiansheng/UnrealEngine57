...
if sys.platform.startswith('win'):
    ...
    from .switchboard_ctypes import (CREDENTIALW, CredDeleteW, CredFree, CredReadW, CredWriteW,
    ...
    class CredentialStoreWindows(CredentialStoreGeneric):
        ...
        def set(
            ...
            if not val:
                CredDeleteW(target_name, CRED_TYPE_GENERIC)
                return
            ...
            CredWriteW(ctypes.byref(cred), 0)
