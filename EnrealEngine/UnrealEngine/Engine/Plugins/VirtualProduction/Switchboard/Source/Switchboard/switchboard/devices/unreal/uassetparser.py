...
class UassetParser(object):
    ...
    def _readUassetSummary(self):
        ...
        if s.FileVersionUE5 >= EUnrealEngineObjectUE5Version.IMPORT_TYPE_HIERARCHIES:
            s.ImportTypeHierarchiesCount, s.ImportTypeHierarchiesOffset \
                = struct.unpack('<2i', self.f.read(2*4))
