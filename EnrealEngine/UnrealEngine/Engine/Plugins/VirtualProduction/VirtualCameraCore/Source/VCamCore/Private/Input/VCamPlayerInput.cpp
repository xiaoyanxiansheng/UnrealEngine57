...
namespace UE::VCamCore
{
	...
	static FString ToString(const FInputKeyEventArgs& Params)
	{
	...
	static void LogInput(FVCamInputDeviceConfig InputDeviceSettings, const FInputKeyEventArgs& Params, bool bIsFilteredOut)
	{
...
bool UVCamPlayerInput::InputKey(const FInputKeyEventArgs& Params)
{
