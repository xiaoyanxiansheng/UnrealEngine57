...
public:
	...
	virtual void SetToolbarCustomizations(const TArray<FName>& InCustomizations) {}

	/** Get all the customizations object active on this widget */
	virtual void GetToolbarCustomizations(TArray<UOperatorStackEditorStackCustomization*>& OutCustomizations) {}
