...
namespace UE::LevelSnapshots::Private
{
	...
	/** Gets the actor class from the original actor soft path */
	TOptional<TNonNullPtr<UClass>> GetActorClass(const FSoftObjectPath& OriginalActorPath, FWorldSnapshotData& WorldData, bool bWarnIfNotFound = true);
