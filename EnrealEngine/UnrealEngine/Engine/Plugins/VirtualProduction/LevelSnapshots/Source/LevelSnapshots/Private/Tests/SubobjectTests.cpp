	...
	bool FSkippedSubobjectsDoNotDiff::RunTest(const FString& Parameters)
	{
		...
		FSnapshotTestRunner()
			...
			.AccessSnapshot([&](ULevelSnapshot* Snapshot)
			{
				...
				TestTrue(TEXT("ObjectSet contains null"), ActorB_Snapshot->ObjectSet.Num() == 1 && *ActorB_Snapshot->ObjectSet.FindArbitraryElement() == nullptr);
				...
				TestTrue(TEXT("WeakObjectPtrSet contains null"), ActorB_Snapshot->WeakObjectPtrSet.Num() == 1 && *ActorB_Snapshot->WeakObjectPtrSet.FindArbitraryElement() == nullptr);
