...
TOptional<TNonNullPtr<UClass>> ULevelSnapshot::GetActorClass(const FSoftObjectPath& OriginalActorPath)
{
	return UE::LevelSnapshots::Private::GetActorClass(OriginalActorPath, SerializedData);
}
