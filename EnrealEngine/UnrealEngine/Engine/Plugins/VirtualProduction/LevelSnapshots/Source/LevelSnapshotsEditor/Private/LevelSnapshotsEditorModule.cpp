...
void FLevelSnapshotsEditorModule::RegisterTabSpawner()
{
	...
	FGlobalTabmanager::Get()->RegisterDefaultTabWindowSize(LevelSnapshotsEditor::LevelSnapshotsTabName, FVector2D(1240, 600));
...
{
	FGlobalTabmanager::Get()->UnregisterDefaultTabWindowSize(LevelSnapshotsEditor::LevelSnapshotsTabName);
