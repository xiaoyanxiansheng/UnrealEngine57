...
UClass* UPropertyBlueprintFunctionLibrary::GetActorClassFromDeletedParams(const FIsDeletedActorValidParams& Params)
{
	return ensure(Params.ClassGetter) ? Params.ClassGetter(Params.SavedActorPath) : nullptr;
}
