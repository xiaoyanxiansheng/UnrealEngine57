...
protected:
	/** Overwrite this, called when the extension is created */
	virtual void OnExtensionInitialized() {}
	
	/** Overwrite this, called when the modifier is enabled */
	virtual void OnExtensionEnabled(EActorModifierCoreEnableReason InReason) {}

	/** Overwrite this, called when the modifier is disabled */
	virtual void OnExtensionDisabled(EActorModifierCoreDisableReason InReason) {}
	...
	/** Get the modifier actor level */
	ACTORMODIFIERCORE_API ULevel* GetModifierLevel() const;
