...
class FSchematicGraphTag : public TSharedFromThis<FSchematicGraphTag>
{
public:
	
	SCHEMATICGRAPHELEMENT_BODY_BASE(FSchematicGraphTag)

	ANIMATIONEDITORWIDGETS_API FSchematicGraphTag();

	ANIMATIONEDITORWIDGETS_API const FSchematicGraphNode* GetNode() const;
...
class FSchematicGraphGroupTag : public FSchematicGraphTag
{
public:
	...
	ANIMATIONEDITORWIDGETS_API virtual ESchematicGraphVisibility::Type GetVisibility() const override;
	ANIMATIONEDITORWIDGETS_API virtual FText GetLabel() const override;
};
