...
#include UE_INLINE_GENERATED_CPP_BY_NAME(EditorInteractiveGizmoSubsystem)
...
void UEditorInteractiveGizmoSubsystem::RegisterBuiltinEditorGizmoTypes()
{
	...
	RegisterTransformGizmoBuilder(NewObject<UEditorTransformGizmoBuilder>());
...
void UEditorInteractiveGizmoSubsystem::RegisterTransformGizmoBuilder(UInteractiveGizmoBuilder* InTransformGizmoBuilder)
{
	TransformGizmoBuilder = InTransformGizmoBuilder;
}
