...
public:
	...
	UE_API UEditorInteractiveGizmoRegistry();
	...
	*/
	 ...
	 */
	UE_API void ClearEditorGizmoTypes();
	 ...
	 */
	UE_API void GetQualifiedEditorGizmoBuilders(EEditorGizmoCategory InGizmoCategory, const FToolBuilderState& InToolBuilderState, TArray<UInteractiveGizmoBuilder*>& FoundBuilders);
