...
public:
	...
	virtual void OnMouseButtonDown(FVector2D InitialPosition, const FGeometry& MyGeometry, const FPointerEvent& MouseEvent) override;
...
private:
	...
	double InitialTime;
	ETimeSliderPlaybackStatus NextPlayerStatus;
};