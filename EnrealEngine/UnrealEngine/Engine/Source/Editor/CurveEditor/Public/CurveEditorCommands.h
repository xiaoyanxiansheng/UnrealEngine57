...
UE_DECLARE_TCOMMANDS(class FCurveEditorCommands, CURVEEDITOR_API)
...
public:
	...
	TSharedPtr<FUICommandInfo> SetUserTangentsVisibility;
...
public:
	CURVEEDITOR_API virtual void RegisterCommands() override;
};
