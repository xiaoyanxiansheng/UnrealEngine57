...
#include UE_INLINE_GENERATED_CPP_BY_NAME(SplineGeneratorPanel)
...
void USplineGeneratorBase::Reset()
{
	...
	if (SelectedSplineComponent.IsValid())
	{
		...
		FComponentVisualizer::NotifyPropertiesModified(SelectedSplineComponent.Get(), SplineProperties);
