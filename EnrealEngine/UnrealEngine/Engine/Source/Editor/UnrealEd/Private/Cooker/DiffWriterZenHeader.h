...
private:
	bool TryInitializeFromZenStore(FAccumulatorGlobals& Globals);
	bool TryInitializeFromMemory(FAccumulatorGlobals& Globals);
...
public:
	...
	FDiffWriterZenHeader(FAccumulatorGlobals& InGlobals, const FDiffOutputRecorder& InDiffOutputRecorder,
...
private:
	...
	const FDiffOutputRecorder& DiffOutputRecorder;
