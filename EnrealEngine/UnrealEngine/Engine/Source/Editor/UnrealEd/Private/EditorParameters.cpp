...
UDEditorParameterCollectionParameterValue::UDEditorParameterCollectionParameterValue(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}
...
static UDEditorParameterValue* CreateParameter_Scalar(UObject* Owner, const FMaterialParameterMetadata& Meta)
{
	...
	if (Meta.Value.Type == EMaterialParameterType::Scalar)
	{
		...
		Parameter->Enumeration = Meta.ScalarEnumeration;
		Parameter->EnumerationIndex = Meta.ScalarEnumerationIndex;
...
static UDEditorParameterValue* CreateParameter_ParameterCollection(UObject* Owner, const FMaterialParameterMetadata& Meta)
{
	UDEditorParameterCollectionParameterValue* Parameter = NewObject<UDEditorParameterCollectionParameterValue>(Owner);
	if (Meta.Value.Type == EMaterialParameterType::ParameterCollection)
	{
		Parameter->ParameterValue = Meta.Value.ParameterCollection;
	}
	return Parameter;
}
	...
	const FMaterialParameterMetadata& Meta)
{
	...
	case EMaterialParameterType::ParameterCollection: Parameter = CreateParameter_ParameterCollection(Owner, Meta); break;
