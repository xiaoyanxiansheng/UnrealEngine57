...
#include UE_INLINE_GENERATED_CPP_BY_NAME(MaterialGraph)
...
UMaterialGraphNode* UMaterialGraph::AddExpression(UMaterialExpression* Expression, bool bUserInvoked)
{
	...
	if (Expression)
	{
		...
		else if (Expression->IsA(UMaterialExpressionOperator::StaticClass()))
		{
			Node = InitExpressionNewNode<UMaterialGraphNode_Operator>(this, Expression, false);
		}
