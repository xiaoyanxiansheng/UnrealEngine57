...
#include UE_INLINE_GENERATED_CPP_BY_NAME(CookCommandlet)
...
#else
	AutoRTFM::ForTheRuntime::SetAutoRTFMRuntime(AutoRTFM::ForTheRuntime::EAutoRTFMEnabledState::AutoRTFM_Disabled);
#endif
