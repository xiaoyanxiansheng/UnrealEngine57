...
public:
	...
	bool AreCacheOperationsAllowed() const
	{
		return bCacheOperationsAllowed;
	}
...
private:
	...
	/**
	 * This value is false for FPendingPackages that were not able to query the cache (e.g. because
	 * they were created too early in EngineStartup) and therefore are not allowed to write
	 * the cache either.
	 */
	bool bCacheOperationsAllowed = true;
};
