...
namespace FbxMeshUtils
{
	namespace Private
	{
		...
		UFbxStaticMeshImportData* SetupFbxImportOptions(UStaticMesh* BaseStaticMesh, UnFbx::FBXImportOptions* ImportOptions)
		{
			...
			UFbxStaticMeshImportData* ImportData = Cast<UFbxStaticMeshImportData>(BaseStaticMesh->GetAssetImportData());
			...
			ImportOptions->StaticMeshLODGroup = BaseStaticMesh->GetLODGroup();
