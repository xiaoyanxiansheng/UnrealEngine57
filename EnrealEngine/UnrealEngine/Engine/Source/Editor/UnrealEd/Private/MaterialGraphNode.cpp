...
#include UE_INLINE_GENERATED_CPP_BY_NAME(MaterialGraphNode)
...
void UMaterialGraphNode::GetNodeContextMenuActions(UToolMenu* Menu, UGraphNodeContextMenuContext* Context) const
{
	...
	if (Context->Node)
	{
		...
		{
			FToolMenuSection& Section = Menu->AddSection("MaterialSchemaNodeNavigation", LOCTEXT("NodeNavigationMenuHeader", "Navigation"));
