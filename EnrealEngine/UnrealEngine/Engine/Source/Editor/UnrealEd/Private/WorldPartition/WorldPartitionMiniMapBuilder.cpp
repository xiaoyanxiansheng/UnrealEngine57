...
#include UE_INLINE_GENERATED_CPP_BY_NAME(WorldPartitionMiniMapBuilder)

DEFINE_LOG_CATEGORY_STATIC(LogWorldPartitionMiniMapBuilder, All, All);

UWorldPartitionMiniMapBuilder::FOnWarmupTickDelegate UWorldPartitionMiniMapBuilder::OnWarmupTick;
