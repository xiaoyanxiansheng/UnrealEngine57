...
{
	if (DoesSharedInstanceExist() && OnRequestClose(InCloseReason))
	{
...
FReply FAssetEditorToolkit::OnViewportDrop(const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent)
{
