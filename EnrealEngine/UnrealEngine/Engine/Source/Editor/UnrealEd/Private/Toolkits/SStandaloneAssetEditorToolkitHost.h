...
private:
	...
	/** Create the main menu bar, either generated by the toolkit host or by the MainFrame module. */
	TSharedRef<SWidget> CreateMenuBar(struct FToolMenuContext& ToolMenuContext) const;
