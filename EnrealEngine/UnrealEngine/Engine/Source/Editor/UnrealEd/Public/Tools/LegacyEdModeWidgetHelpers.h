...
public:
	...
	struct FPropertyWidgetInfo
	{
		...
		/**
		 * Returns the appropriate color, and transform of the widget in local space
		 */
	...
	/** If the value of a UPROPERTY's edit widget's transform or translation is stored on the property in local space (defaults true) */
	static UNREALED_API const FName MD_WidgetLocalSpace;
...
protected:
	...
	/** Indicates the property being edited is a transform */
