...
UE_DECLARE_TCOMMANDS(class FEditorViewportCommands, UNREALED_API)
...
public:
	...
	TSharedPtr< FUICommandInfo > GeometryInspectionClayMode;
	TSharedPtr< FUICommandInfo > GeometryInspectionZebraHorizontalMode;
	TSharedPtr< FUICommandInfo > GeometryInspectionZebraVerticalMode;
	TSharedPtr< FUICommandInfo > GeometryInspectionFrontBackFaceMode;
	TSharedPtr< FUICommandInfo > GeometryInspectionRandomColorMode;
	TSharedPtr< FUICommandInfo > GeometryInspectionShowWireframe;
	...
	TSharedPtr< FUICommandInfo > FocusAndClipViewportToSelection;
	TSharedPtr< FUICommandInfo > FocusOutlinerToSelection;
	TSharedPtr< FUICommandInfo > FocusOutlinerToContextFolder;
	
	TSharedPtr<FUICommandInfo> UseOrthographicClippingPlanes;
	TSharedPtr<FUICommandInfo> DismissOrthographicClippingPlanes;
