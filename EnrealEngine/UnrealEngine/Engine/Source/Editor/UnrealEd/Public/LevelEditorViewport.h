...
public:
	...
	UNREALED_API virtual const FEditorViewportCameraSpeedSettings& GetCameraSpeedSettings() const override;
	UNREALED_API virtual void SetCameraSpeedSettings(const FEditorViewportCameraSpeedSettings& InCameraSpeedSettings) override;
