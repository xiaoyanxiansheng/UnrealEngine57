...
DECLARE_MULTICAST_DELEGATE_OneParam(FOnMostRecentProjectSettingChanged, bool /** bInShouldUseMostRecentProject */)
...
class UEditorSettings : public UObject
{
	...
	UE_DEPRECATED(5.7, "Use Load At Startup setting")
	UPROPERTY(meta = (DeprecatedProperty, DeprecatedMessage="Use Load At Startup setting"))
	...
	FOnMostRecentProjectSettingChanged& OnMostRecentProjectSettingChanged() { return OnMostRecentProjectSettingChangedDelegate; }
...
private:
	FOnMostRecentProjectSettingChanged OnMostRecentProjectSettingChangedDelegate;
};
