...
public:
	...
	/**
	 * Manage (rename/move/delete) localized variants alongside their source asset
	 */
	UPROPERTY(EditAnywhere, DisplayName = "Manage Localized Variants Alongside Source Asset", config, Category = Internationalization, meta = (ToolTip = "If the project uses Localization, localized variants of assets will be moved/renamed/deleted alongside their source asset."))
