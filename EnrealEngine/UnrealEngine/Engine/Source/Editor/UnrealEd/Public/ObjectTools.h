...
namespace ObjectTools
{
	...
	*/
	 ...
	 */
	UNREALED_API FString GetDefaultTooltipForFunction(const UFunction* Function, bool bIncludeTarget = true);

	/**
	 * Gets the non-specific tooltip for the given UFunction parameter.
	 * @param Function the function to parse the param tooltip from
	 * @param ParamName the name of the parameter
	 * @return the tooltip as a string
	 */
	UNREALED_API FString GetDefaultTooltipForFunctionParam(const UFunction* Function, const FString& ParamName);

	/**
	 * Gets the non-specific tooltip for the given UFunction's return value.
	 * @param Function the function to parse the param tooltip from
	 * @return the tooltip as a string
	 */
	UNREALED_API FString GetDefaultTooltipForFunctionReturn(const UFunction* Function);
}
...
namespace ThumbnailTools
{
	 ...
	 * @param	OutThumbnail			if non-NULL, the FObjectThumbnail that will receive the thumbnail data. This would also force a synchronization with the RenderThread
	 */
