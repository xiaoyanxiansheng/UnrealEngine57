...
struct FEditorDelegates
{
	...
	/** delegate for an editor process is generating a large set of actors */
	DECLARE_MULTICAST_DELEGATE_OneParam(FOnWorldGenerationProcess, UWorld*);
	...
	/** Called when an editor process is about to generate a large set of actors */
	static UNREALED_API FOnWorldGenerationProcess OnPreWorldGenerationProcess;
	/** Called when an editor process is done generating a large set of actors */
	static UNREALED_API FOnWorldGenerationProcess OnPostWorldGenerationProcess;
};
