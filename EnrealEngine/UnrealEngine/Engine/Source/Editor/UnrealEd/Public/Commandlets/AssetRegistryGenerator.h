...
private:
	...
	*/
	...
	/**
	 * If InState records PackageName is generated, return the name of the Generator and the property flags of the Generator's
	 * AssetRegistry dependency upon the generated package, otherwise return NAME_None and EDependencyProperty::None.
	 */
