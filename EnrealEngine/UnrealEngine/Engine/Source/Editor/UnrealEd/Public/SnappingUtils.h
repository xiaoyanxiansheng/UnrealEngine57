...
public:
	 ...
	 */
	static UNREALED_API TOptional<FVector> GetDeltaToNearestActor( FVector& DragDelta, const UWorld* InWorld );
	...
	/**
	 * Adjusts the given scale value for percentage based scaling, if enabled
	 * The input should be 0-100, and the output will be adjusted to be 0-1
	 *
	 * @param InOutScale	The scale value to adjust
	 */
	static UNREALED_API void AdjustPercentageBasedScale( FVector& InOutScale );
