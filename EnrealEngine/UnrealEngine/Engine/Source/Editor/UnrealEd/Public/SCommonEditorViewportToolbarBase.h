...
UCLASS(MinimalAPI)
class UCommonViewportToolbarBaseMenuContext : public UUnrealEdViewportToolbarContext
{
	GENERATED_BODY()
...
public:
	...
	UE_API virtual TSharedPtr<IPreviewProfileController> GetPreviewProfileController() const override;
};
...
protected:
	...
	UE_API TSharedRef<SWidget> MakeAssetViewerProfileComboBox();
...
private:
	...
	UE_API TSharedRef<SWidget> BuildComboMenu();
};
...
public:
	...
	const TSharedPtr<IPreviewProfileController>& GetPreviewProfileController() const { return PreviewProfileController; }
