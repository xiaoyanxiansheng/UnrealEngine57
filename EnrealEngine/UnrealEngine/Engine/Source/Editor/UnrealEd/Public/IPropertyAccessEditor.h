...
DECLARE_DELEGATE_RetVal(bool, FOnCanUseCustomGenerateMenu);
...
struct FPropertyBindingWidgetArgs
{
	...
	/** Delegate called to see if the custom generate menu delegated can be used */
	FOnCanUseCustomGenerateMenu OnCanUseCustomGenerateMenu;

	/** Delegate called to generate an alternative/custom version of the menu */
	FOnGetContent OnGenerateMenu;
