...
protected:
	...
	/** Should the asset registry have been scanned before iterating packages */
	bool bRequireAssetRegistryLoadedBeforeIteration;
	...
	UE_DEPRECATED(5.6, "KeepPackageGUIDOnSave is no longer supported, because package save no longer records arbitrary guids but instead records a hash of the package's bytes - PackageSavedHash.")
