...
struct FPreviewPlatformInfo
{
	...
	:	PreviewFeatureLevel(ERHIFeatureLevel::Num)
	...
	FText GetFriendlyName() const { return PreviewShaderPlatformFriendlyName; }
...
{
	UNREALED_API void AddReferencingAsset(const UObject* InReferencingAsset, FAssetData::ECreationFlags InCreationFlags = FAssetData::ECreationFlags::None, EAssetReferenceFilterProperties InProperties = EAssetReferenceFilterProperties::None);
	...
	UNREALED_API void AddReferencingAssets(TConstArrayView<UObject*> InReferencingAssets, FAssetData::ECreationFlags InCreationFlags = FAssetData::ECreationFlags::None, EAssetReferenceFilterProperties InProperties = EAssetReferenceFilterProperties::None);
	...
	UNREALED_API void AddReferencingAssetsFromPropertyHandle(const TSharedPtr<class IPropertyHandle>& PropertyHandle, FAssetData::ECreationFlags InCreationFlags = FAssetData::ECreationFlags::None);
...
public:
	...
	DECLARE_TS_MULTICAST_DELEGATE_OneParam( FBlueprintPreCompileEvent, UBlueprint* );
	...
	DECLARE_TS_MULTICAST_DELEGATE( FBlueprintCompiledEvent );
	...
	DECLARE_TS_MULTICAST_DELEGATE(FBlueprintReinstanced);
...
private:
	...
	/** Delegate callback when doing a seamless transition to a new world */
	void OnSeamlessTravelTransition(UWorld* InWorld);
...
public:
	...
	/** Return the current active shader platform friendly name in the editor*/
	UNREALED_API FText GetActiveShaderPlatformFriendlyName() const;
...
protected:
	...
	/** Function pair used to save and restore the global Shader Platform */
	UE_DEPRECATED(5.7, "LoadEditorFeatureLevel is deprecated, please use LoadEditorShaderPlatformPreview")
	UNREALED_API void LoadEditorFeatureLevel();
	UE_DEPRECATED(5.7, "SaveEditorFeatureLevel is deprecated, please use LoadEditorShaderPlatformPreview")
	UNREALED_API void SaveEditorFeatureLevel();

	UNREALED_API void LoadEditorShaderPlatformPreview();
	UNREALED_API void SaveEditorShaderPlatformPreview();
...
public:
	 ...
	 */
	static UE_API bool SplitActorLabel(FString& InOutLabel, int32& OutIdx);
	 ...
	 */
	static UE_API void SetActorLabelUnique(AActor* Actor, const FString& NewActorLabel, const FCachedActorLabels* InExistingActorLabels = nullptr);
	 ...
	 */
	static UE_API void RenameExistingActor(AActor* Actor, const FString& NewActorLabel, bool bMakeUnique = false);
