...
class UEditorPerformanceSettings : public UDeveloperSettings
{
	...
	bool bEnableEditorPeformanceTool = true;

	/** Whether to enable Editor Perf Warnings */
	UPROPERTY(EditAnywhere, config, Category = EditorPerformanceTool, meta = (DisplayName = "Enable Notifications", ConfigRestartRequired = false, EditCondition = "bEnableEditorPeformanceTool"))
	bool bEnableNotifications = false;

	/** Specific measurements to notify */
	UPROPERTY(EditAnywhere, config, Category = EditorPerformanceTool, meta = (ConfigRestartRequired = false, EditCondition = "bEnableEditorPeformanceTool"))
	TArray<FName> NotifyList;

	/** Specific measurements to notify */
	UPROPERTY(config, meta = (DisplayName = "Notification List", ConfigRestartRequired = false))
	TArray<FName> NotificationList_DEPRECATED;
	...
	UPROPERTY(EditAnywhere, config, Category = EditorPerformanceTool, meta = (DisplayName = "Experimental Features", ConfigRestartRequired = true, EditCondition = "bEnableEditorPeformanceTool"))
