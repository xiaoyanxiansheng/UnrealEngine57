...
struct FViewportConfigOptions
{
	...
	UPROPERTY(config)
	int32 CameraSpeedSetting_DEPRECATED;
...
public:
	...
	UNREALED_API void SetCameraSpeedSettings(FName InContext, const FEditorViewportCameraSpeedSettings& SpeedSettings, int32 InViewportIndex);
	UE_DEPRECATED(5.7, "Use SetCameraSpeedSettings instead")
