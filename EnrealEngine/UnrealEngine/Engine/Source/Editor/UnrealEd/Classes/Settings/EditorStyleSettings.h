...
public:
	...
	UPROPERTY(EditAnywhere, config, Category=UserInterface, AdvancedDisplay, meta = (ConfigRestartRequired = true))
	...
	/** Scale the size of the global asset picker */
	UPROPERTY(EditAnywhere, config, Category = UserInterface, meta = (DisplayName = "Scale Asset Picker Widget Size", ClampMin = "0.75", ClampMax = "3.0", UIMin = "0.75", UIMax = "3.0"))
	float AssetPickerSizeScale = 1.0f;
