...
public:
	...
	UE_API FString ToJson() const;
	UE_API TSharedPtr<FJsonObject> ToJsonObject() const;
	static UE_API FReviewCommentContext FromJson(const FString& Json);
	static UE_API FReviewCommentContext FromJson(const TSharedPtr<FJsonObject>& JsonObject);
};
...
public:
	...
	static UE_API FReviewTopic FromString(const FString& ReviewTopic);
...
public:	
	...
	UE_API FString ToJson() const;
	UE_API TSharedPtr<FJsonObject> ToJsonObject() const;
	static UE_API FReviewComment FromJson(const FString& Json);
	static UE_API FReviewComment FromJson(const TSharedPtr<FJsonObject>& JsonObject);
};
