...
public:
	 ...
	 */
	static UE_API FString GetAssetNamespace(const FAssetData& InAssetData);
	 ...
	 */
	static UE_API FString GetObjectNamespace(const UObject* InObject);
	 ...
	 */
	static UE_API FString GetObjectNamespace(const FSoftObjectPath& InObjectPath);
	 ...
	 */
	static UE_API void GetPropertyValueNamespaces(const FProperty* InProperty, const void* InContainer, TSet<FString>& OutNamespaces);
	 ...
	 */
	static UE_API void GetSharedGlobalImports(TSet<FString>& OutNamespaces);
	...
	static UE_API void GetDefaultImportsForBlueprint(const UBlueprint* InBlueprint, TSet<FString>& OutNamespaces);
	 ...
	 */
	static UE_API void GetDefaultImportsForObject(const UObject* InObject, TSet<FString>& OutNamespaces);
	 ...
	 */
	static UE_API void SetDefaultBlueprintNamespaceType(EDefaultBlueprintNamespaceType InType);

	/** @return The default Blueprint namespace type objects/assets should use. Currently used for debugging/testing. */
	static UE_API EDefaultBlueprintNamespaceType GetDefaultBlueprintNamespaceType();
	...
	static UE_API FOnDefaultBlueprintNamespaceTypeChanged& OnDefaultBlueprintNamespaceTypeChanged();

	/**
	 * Refresh the Blueprint editor environment to align with current namespace editor feature settings.
	 */
	static UE_API void RefreshBlueprintEditorFeatures();
	 ...
	 */
	static UE_API void ConvertPackagePathToNamespacePath(const FString& InPackagePath, FString& OutNamespacePath);
};
