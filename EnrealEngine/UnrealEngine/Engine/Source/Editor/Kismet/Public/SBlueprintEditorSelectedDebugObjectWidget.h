...
public:
	...
	UE_API void Construct(const FArguments& InArgs, TSharedPtr<FBlueprintEditor> InBlueprintEditor);
...
private:
	...
	UE_API TSharedPtr<FBlueprintDebugObjectInstance> GetDebugObjectInstance() const;
	...
	UE_API void DebugObjectSelectionChanged(TSharedPtr<FBlueprintDebugObjectInstance> NewSelection, ESelectInfo::Type SelectInfo);
	...
	UE_API TSharedRef<SWidget> OnGetActiveDetailSlotContent(bool bChangedToHighDetail);
	...
	UE_API void FillDebugObjectInstance(TSharedPtr<FBlueprintDebugObjectInstance> Instance);

	/** Called to create a widget for each debug object item */
	UE_API TSharedRef<SWidget> CreateDebugObjectItemWidget(TSharedPtr<FBlueprintDebugObjectInstance> InItem);
