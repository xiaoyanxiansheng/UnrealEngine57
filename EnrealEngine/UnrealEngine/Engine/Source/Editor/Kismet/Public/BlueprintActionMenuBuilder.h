...
public:
	 ...
	 */
	UE_API FBlueprintActionMenuBuilder(EConfigFlags Flags = EConfigFlags::DefaultConfig);
	...
	UE_API FBlueprintActionMenuBuilder(TWeakPtr<FBlueprintEditor> BlueprintEditorPtr);
	 ...
	 */
	UE_API void AddMenuSection(FBlueprintActionFilter const& Filter, FText const& Heading = FText::GetEmpty(), int32 MenuOrder = 0, uint32 const Flags = 0);
