...
class FFBlueprintEditorSCSEditorUICustomization;
 ...
 */
class IUserDefinedEnumEditor : public FAssetEditorToolkit
{
};
 ...
 * Enum editor public interface
 */
class IUserDefinedStructureEditor : public FAssetEditorToolkit
{
};
...
public:
	...
	UE_API virtual void PasteNodesHere(class UEdGraph* Graph, const FVector2D& Location) UE_SLATE_DEPRECATED_VECTOR_VIRTUAL_FUNCTION { PasteNodesHere(Graph, UE::Slate::CastToVector2f(Location)); };
...
public:
	...
	UE_DEPRECATED(5.7, "Please use AddCustomization instead.")
	virtual void SetSubobjectEditorUICustomization(TSharedPtr<ISCSEditorUICustomization> InSCSEditorUICustomization);

	/** Adds the SCS editor UI customization to the array of customizations to be invoked */
	virtual void AddCustomization(TSharedPtr<ISCSEditorUICustomization> InSCSEditorUICustomization);

	/** Removes the SCS editor UI customization from the array of customizations to be invoked */
	virtual void RemoveCustomization(TSharedPtr<ISCSEditorUICustomization> InSCSEditorUICustomization);
...
private:
	...
	TSharedPtr<FFBlueprintEditorSCSEditorUICustomization> SCSEditorUICustomization;
