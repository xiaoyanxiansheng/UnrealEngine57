...
public:
	...
	/** Recursively visits outer categories and constructs a path name: Outermost.Outer.ThisCategoryName. 
	    Intended for debugging. Halts as soon as a non-category is visited. */
