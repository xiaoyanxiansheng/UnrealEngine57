...
public:
	...
	virtual const FEditorViewportCameraSpeedSettings& GetCameraSpeedSettings() const override;
	virtual void SetCameraSpeedSettings(const FEditorViewportCameraSpeedSettings& NewCameraSpeedSettings) override;
