...
void FBlueprintEditorModule::StartupModule()
{
	...
	SCSEditorUICustomization = FFBlueprintEditorSCSEditorUICustomization::GetInstance();
...
TSharedRef<IBlueprintEditor> FBlueprintEditorModule::CreateBlueprintEditor(const EToolkitMode::Type Mode, const TSharedPtr< IToolkitHost >& InitToolkitHost, const TArray< UBlueprint* >& BlueprintsToEdit, bool bShouldOpenInDefaultsMode)
{
	...
	NewBlueprintEditor->InitBlueprintEditor(Mode, InitToolkitHost, BlueprintsToEdit, bShouldOpenInDefaultsMode, SCSEditorUICustomization);
...
{
	AddCustomization(InSCSEditorUICustomization);
...
void FBlueprintEditorModule::AddCustomization(TSharedPtr<ISCSEditorUICustomization> InSCSEditorUICustomization)
{
	if (SCSEditorUICustomization)
	{
		SCSEditorUICustomization->AddCustomization(InSCSEditorUICustomization);
	}
}

void FBlueprintEditorModule::RemoveCustomization(TSharedPtr<ISCSEditorUICustomization> InSCSEditorUICustomization)
{
	if (SCSEditorUICustomization)
	{
		SCSEditorUICustomization->RemoveCustomization(InSCSEditorUICustomization);
	}
}
