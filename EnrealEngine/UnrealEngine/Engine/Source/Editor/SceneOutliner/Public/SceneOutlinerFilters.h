...
public:
	...
	UE_API void InitFilter(TSharedPtr<FSceneOutlinerFilters> InFilters);

	/** Add menu for this filter */
	UE_API void AddMenu(FMenuBuilder& InMenuBuilder);
...
private:
	UE_API void ApplyFilter(bool bActive);
	UE_API void ToggleFilterActive();
