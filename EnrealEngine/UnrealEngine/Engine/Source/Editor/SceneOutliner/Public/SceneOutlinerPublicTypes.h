...
public:
	...
	FSceneOutlinerInitializationOptions()
		...
		, PrimaryColumnName(FSceneOutlinerBuiltInColumnTypes::Label())
	{}
};
...
struct FSceneOutlinerVisibilityCache
{
	...
	UE_API bool RecurseChildren(const ISceneOutlinerTreeItem& Item) const;

	UE_API bool GetVisibility(const ISceneOutlinerTreeItem& Item) const;
};
