...
FVector2f SWorldTileItem::GetPosition2f() const
{
	return UE::Slate::CastToVector2f(TileModel->GetLevelPosition2D());
}
...
{
	FVector2f LevelSize = UE::Slate::CastToVector2f(TileModel->GetLevelSize2D());
	FVector2f LevelPos = GetPosition2f();
...
FVector2f SWorldTileItem::GetDesiredSizeForMarquee2f() const
{
	...
	return SNodePanel::SNode::GetDesiredSizeForMarquee2f();
}
