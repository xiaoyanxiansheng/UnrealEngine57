...
*/
class SSubobjectBlueprintEditor final : public SSubobjectEditor
{
public:
...
protected:
	...
	UE_API virtual void OnAttachToDropAction(FSubobjectEditorTreeNodePtrType DroppedOn, const TArray<FSubobjectEditorTreeNodePtrType>& DroppedNodePtrs);
    UE_API virtual void OnDetachFromDropAction(const TArray<FSubobjectEditorTreeNodePtrType>& DroppedNodePtrs);
    UE_API virtual void OnMakeNewRootDropAction(FSubobjectEditorTreeNodePtrType DroppedNodePtr);
    UE_API virtual void PostDragDropAction(bool bRegenerateTreeNodes);

    /** Builds a context menu pop up for dropping a child node onto the scene root node */
    UE_API virtual TSharedPtr<SWidget> BuildSceneRootDropActionMenu(FSubobjectEditorTreeNodePtrType DroppedOntoNodePtr, FSubobjectEditorTreeNodePtrType DroppedNodePtr);
	...
	UE_API virtual FSubobjectEditorTreeNodePtrType GetSceneRootNode() const override;
public:
	UE_API virtual FSubobjectEditorTreeNodePtrType FindSlateNodeForObject(const UObject* InObject, bool bIncludeAttachmentComponents = true) const override;
