 ...
 */
class FTypedElementViewportInteractionCustomization : public FTypedElementAssetEditorToolkitHostMixin
{
public:
	virtual ~FTypedElementViewportInteractionCustomization() = default;

	//~ See UTypedElementViewportInteraction for API docs
	UE_API virtual bool GetGizmoPivotLocation(const TTypedElement<ITypedElementWorldInterface>& InElementWorldHandle, const UE::Widget::EWidgetMode InWidgetMode, FVector& OutPivotLocation);
	UE_API virtual void PreGizmoManipulationStarted(TArrayView<const FTypedElementHandle> InElementHandles, const UE::Widget::EWidgetMode InWidgetMode);
	UE_API virtual void GizmoManipulationStarted(const TTypedElement<ITypedElementWorldInterface>& InElementWorldHandle, const UE::Widget::EWidgetMode InWidgetMode);
	UE_API virtual void GizmoManipulationDeltaUpdate(const TTypedElement<ITypedElementWorldInterface>& InElementWorldHandle, const UE::Widget::EWidgetMode InWidgetMode, const EAxisList::Type InDragAxis, const FInputDeviceState& InInputState, const FTransform& InDeltaTransform, const FVector& InPivotLocation);
	UE_API virtual void GizmoManipulationStopped(const TTypedElement<ITypedElementWorldInterface>& InElementWorldHandle, const UE::Widget::EWidgetMode InWidgetMode, const ETypedElementViewportInteractionGizmoManipulationType InManipulationType);
	UE_API virtual void PostGizmoManipulationStopped(TArrayView<const FTypedElementHandle> InElementHandles, const UE::Widget::EWidgetMode InWidgetMode);
	UE_API virtual void MirrorElement(const TTypedElement<ITypedElementWorldInterface>& InElementWorldHandle, const FVector& InMirrorScale, const FVector& InPivotLocation);
	UE_API virtual bool GetFocusBounds(const TTypedElement<ITypedElementWorldInterface>& InElementWorldHandle, FBoxSphereBounds& OutBounds);
	UE_API virtual bool GetScaleForGizmo(const TTypedElement<ITypedElementWorldInterface>& InElementWorldHandle, FVector& OutScale);
};
...
public:
	...
	bool GetScaleForGizmo(FVector& OutScale) const { return ViewportInteractionCustomization->GetScaleForGizmo(ElementWorldHandle, OutScale); }
...
class UTypedElementViewportInteraction : public UObject, public TTypedElementInterfaceCustomizationRegistry<FTypedElementViewportInteractionCustomization>
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UE_API void BeginGizmoManipulation(FTypedElementListConstRef InElementsToMove, const UE::Widget::EWidgetMode InWidgetMode);

	/**
	 * Notify that the gizmo has manipulated the transform of the given set of elements.
	 * @note This list should have been pre-normalized via UTypedElementSelectionSet::GetNormalizedSelection or UTypedElementSelectionSet::GetNormalizedElementList, or FLevelEditorViewportClient::GetElementsToManipulate.
	 */
	UE_API void UpdateGizmoManipulation(FTypedElementListConstRef InElementsToMove, const UE::Widget::EWidgetMode InWidgetMode, const EAxisList::Type InDragAxis, const FInputDeviceState& InInputState, const FTransform& InDeltaTransform);
	
	/**
	 * Notify that the gizmo has finished manipulating the transform of the given set of elements.
	 * @note This list should have been pre-normalized via UTypedElementSelectionSet::GetNormalizedSelection or UTypedElementSelectionSet::GetNormalizedElementList, or FLevelEditorViewportClient::GetElementsToManipulate.
	 */
	UE_API void EndGizmoManipulation(FTypedElementListConstRef InElementsToMove, const UE::Widget::EWidgetMode InWidgetMode, const ETypedElementViewportInteractionGizmoManipulationType InManipulationType);
	 ...
	 */
	UE_API void ApplyDeltaToElement(const FTypedElementHandle& InElementHandle, const UE::Widget::EWidgetMode InWidgetMode, const EAxisList::Type InDragAxis, const FInputDeviceState& InInputState, const FTransform& InDeltaTransform);

	/**
	 * Apply the given mirror scale to the specified element.
	 */
	UE_API void MirrorElement(const FTypedElementHandle& InElementHandle, const FVector& InMirrorScale);

	/**
	 *	Calculate the bounds of all elements in the list, to be focused on in the viewport
	 *	@note This list should have been pre-normalized via UTypedElementSelectionSet::GetNormalizedSelection or UTypedElementSelectionSet::GetNormalizedElementList, or FLevelEditorViewportClient::GetElementsToManipulate.
	 */
	UE_API bool GetFocusBounds(FTypedElementListConstRef InElements, FBoxSphereBounds& OutBox);

	/**
	 *	Calculate the combined, signed scale of all elements in the list, to be used for scale delta modifications (before applying). If there are multiple objects of differing scale, return the total bounds.
	 *	@note This list should have been pre-normalized via UTypedElementSelectionSet::GetNormalizedSelection or UTypedElementSelectionSet::GetNormalizedElementList, or FLevelEditorViewportClient::GetElementsToManipulate.
	 */
	UE_API bool GetScaleForGizmo(FTypedElementListConstRef InElements, FVector& OutScale);
private:
	/**
	 * Attempt to resolve the selection interface and viewport interaction customization for the given element, if any.
	 */
	UE_API FTypedElementViewportInteractionElement ResolveViewportInteractionElement(const FTypedElementHandle& InElementHandle) const;
};
