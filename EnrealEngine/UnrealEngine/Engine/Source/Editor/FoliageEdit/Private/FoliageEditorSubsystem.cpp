...
void UFoliageEditorSubsystem::OnActorMoved(AActor* InActor)
{
	...
	// Both MoveInstancesForMovedComponent and MoveInstancesForMovedOwnedActors early-out when FLevelUtils::IsApplyingLevelTransform() returns true, doing no work.
	// Add the same check here to avoid expensive TActorIterator operations.
