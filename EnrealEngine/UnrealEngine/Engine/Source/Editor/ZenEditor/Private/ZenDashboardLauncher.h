...
public:
	...
	static const TSharedPtr<FZenDashboardLauncher>& Get()
	{
		if (!Instance)
		{
...
private:
	 ...
	 */
	UE_API void BuildZenDashboard(const FString& Path, const FString& LaunchParameters, StartZenDashboardCallback Callback);

private:
	/** The process handler of ZenDashboard. */
	FProcHandle ZenDashboardHandle;

	static UE_API TSharedPtr<FZenDashboardLauncher> Instance;
};
