...
void FVirtualTextureConversionWorker::DoConvert()
{
	...
	SlowTask.EnterProgressFrame();
	{
		...
		// Update expression previews for any open materials.
		UAssetEditorSubsystem* AssetEditorSubsystem = GEditor->GetEditorSubsystem<UAssetEditorSubsystem>();
		for (UMaterial* Mat : ModifiedMaterials)
		{
			if (IAssetEditorInstance* FoundAssetEditor = AssetEditorSubsystem->FindEditorForAsset(Mat, false))
			{
