...
bool FContentBrowserItemData::GetItemAssetAccessSpecifier(EAssetAccessSpecifier& OutAssetAccessSpecifier) const
{
	if (UContentBrowserDataSource* ItemDataSource = GetOwnerDataSource())
	{
		return ItemDataSource->GetItemAssetAccessSpecifier(*this, OutAssetAccessSpecifier);
	}

	return false;
}

bool FContentBrowserItemData::CanModifyItemAssetAccessSpecifier() const
{
	if (UContentBrowserDataSource* ItemDataSource = GetOwnerDataSource())
	{
		return ItemDataSource->CanModifyItemAssetAccessSpecifier(*this);
	}
