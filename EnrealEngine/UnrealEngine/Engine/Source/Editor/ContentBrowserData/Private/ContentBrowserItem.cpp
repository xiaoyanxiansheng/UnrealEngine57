...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ContentBrowserItem)
...
bool FContentBrowserItem::GetItemAssetAccessSpecifier(EAssetAccessSpecifier& OutAssetAccessSpecifier) const
{
	const FContentBrowserItemData* PrimaryItemData = GetPrimaryInternalItem();
	return PrimaryItemData
		? PrimaryItemData->GetItemAssetAccessSpecifier(OutAssetAccessSpecifier)
		: false;
}

bool FContentBrowserItem::CanModifyItemAssetAccessSpecifier() const
{
	const FContentBrowserItemData* PrimaryItemData = GetPrimaryInternalItem();
	return PrimaryItemData
		? PrimaryItemData->CanModifyItemAssetAccessSpecifier()
		: false;
}
