...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ContentBrowserDataSource)
...
void UContentBrowserDataSource::EnumerateItemsAtUserProvidedPath(const FStringView InPath, const EContentBrowserItemTypeFilter InItemTypeFilter, TFunctionRef<bool(FContentBrowserItemData&&)> InCallback)
{
}

void UContentBrowserDataSource::EnumerateItemsAtUserProvidedPath(const FStringView InPath, const EContentBrowserItemTypeFilter InItemTypeFilter, const TGetOrEnumerateSink<FContentBrowserItemData>& InSink)
{
	EnumerateItemsAtUserProvidedPath(InPath, InItemTypeFilter, [&InSink](FContentBrowserItemData&& Item) { return InSink.ProduceItem(MoveTemp(Item)); });
}
...
bool UContentBrowserDataSource::GetItemAssetAccessSpecifier(const FContentBrowserItemData& InItem, EAssetAccessSpecifier& OutAssetAccessSpecifier)
{
	return false;
}

bool UContentBrowserDataSource::CanModifyItemAssetAccessSpecifier(const FContentBrowserItemData& InItem)
{
	return false;
}
