...
namespace ContentBrowserItemAttributes
{
	...
	/**
	 * Attribute key that can be used to query the item's brush to use for an open folder in an asset tree.
	 * Type: Brush name (as FName).
	 */
	const FName ItemAssetTreeFolderOpenBrush = "ItemAssetTreeFolderOpenBrush";

	/**
	 * Attribute key that can be used to query the item's brush to use for a closed folder in an asset tree.
	 * Type: Brush name (as FName).
	 */
	const FName ItemAssetTreeFolderClosedBrush = "ItemAssetTreeFolderClosedBrush";

	/**
	 * Attribute key that can be used to query the item's brush to use for a folder in a list view.
	 * Type: Brush name (as FName).
	 */
	const FName ItemListViewFolderBrush = "ItemListViewFolderBrush";
}
...
class UContentBrowserDataSource : public UObject, public IModularFeature
{
	GENERATED_BODY()

public:
	//~ UObject interface
	UE_API virtual void BeginDestroy() override final;

	/**
	 * Get the name used when registering data source modular feature instances for use with the Content Browser Data Subsystem.
	 */
	static UE_API FName GetModularFeatureTypeName();
	 ...
	 */
	UE_API void SetDataSink(IContentBrowserItemDataSink* InDataSink);
	 ...
	 */
	UE_API bool IsVirtualPathUnderMountRoot(const FName InPath) const;
	 ...
	 */
	UE_API virtual void CompileFilter(const FName InPath, const FContentBrowserDataFilter& InFilter, FContentBrowserDataCompiledFilter& OutCompiledFilter);
	 ...
	 */
	UE_API virtual void EnumerateItemsMatchingFilter(const FContentBrowserDataCompiledFilter& InFilter, TFunctionRef<bool(FContentBrowserItemData&&)> InCallback);
	UE_API virtual void EnumerateItemsMatchingFilter(const FContentBrowserDataCompiledFilter& InFilter, const TGetOrEnumerateSink<FContentBrowserItemData>& InSink);
	 ...
	 * @param InSink Parameter provided to receive output as either a callback or an array.
	 */
	UE_API virtual void EnumerateItemsAtPath(const FName InPath, const EContentBrowserItemTypeFilter InItemTypeFilter, TFunctionRef<bool(FContentBrowserItemData&&)> InCallback);
	UE_API virtual void EnumerateItemsAtPath(const FName InPath, const EContentBrowserItemTypeFilter InItemTypeFilter, const TGetOrEnumerateSink<FContentBrowserItemData>& InSink);
	 ...
	 * @param InCallback The function to invoke for each matching item (return true to continue enumeration).
	 */
	UE_API virtual bool EnumerateItemsAtPaths(const TArrayView<FContentBrowserItemPath> InPaths, const EContentBrowserItemTypeFilter InItemTypeFilter, TFunctionRef<bool(FContentBrowserItemData&&)> InCallback);

	/**
	 * Enumerate items at the given user provided path, optionally filtering by type, and invoking the callback for each matching item.
	 * The user provided path can be any path format the data source supports other than a virtual path. The data source will deduce the path type.
	 * @note This function *must not* block waiting on content discovery! It should use the current state as known at this point in time.
	 *
	 * @param InPath The user provided path to find items for.
	 * @param InItemTypeFilter The types of items we want to find.
	 * @param InCallback The function to invoke for each matching item (return true to continue enumeration).
	 * @param InSink Parameter provided to receive output as either a callback or an array.
	 */
	UE_API virtual void EnumerateItemsAtUserProvidedPath(const FStringView InPath, const EContentBrowserItemTypeFilter InItemTypeFilter, TFunctionRef<bool(FContentBrowserItemData&&)> InCallback);
	UE_API virtual void EnumerateItemsAtUserProvidedPath(const FStringView InPath, const EContentBrowserItemTypeFilter InItemTypeFilter, const TGetOrEnumerateSink<FContentBrowserItemData>& InSink);
	 ...
	 * @param InCallback The function to invoke for each matching item (return true to continue enumeration).
	 */
	UE_API virtual bool EnumerateItemsForObjects(const TArrayView<UObject*> InObjects, TFunctionRef<bool(FContentBrowserItemData&&)> InCallback);
	 ...
	 */
	UE_API virtual TArray<FContentBrowserItemPath> GetAliasesForPath(const FSoftObjectPath& InInternalPath) const;

	UE_DEPRECATED(5.1, "FNames containing full asset paths are deprecated. Use FSoftObjectPath instead.")
	UE_API TArray<FContentBrowserItemPath> GetAliasesForPath(FName InInternalPath) const;
	 ...
	 */
	UE_API virtual bool IsDiscoveringItems(FText* OutStatus = nullptr);
	 ...
	 */
	UE_API virtual bool PrioritizeSearchPath(const FName InPath);
	 ...
	 */
	UE_API virtual bool IsFolderVisible(const FName Path, const EContentBrowserIsFolderVisibleFlags Flags, const FContentBrowserFolderContentsFilter& ContentsFilter);
	 ...
	 */
	UE_API virtual bool CanCreateFolder(const FName InPath, FText* OutErrorMsg);
	 ...
	 */
	UE_API virtual bool CreateFolder(const FName InPath, const TSharedPtr<IContentBrowserHideFolderIfEmptyFilter>& HideFolderIfEmptyFilter, FContentBrowserItemDataTemporaryContext& OutPendingItem);
	 ...
	 */
	UE_API virtual bool DoesItemPassFilter(const FContentBrowserItemData& InItem, const FContentBrowserDataCompiledFilter& InFilter);
	 ...
	 */
	UE_API virtual bool ConvertItemForFilter(FContentBrowserItemData& Item, const FContentBrowserDataCompiledFilter& InFilter);
	 ...
	 */
	UE_API virtual bool GetItemAttribute(const FContentBrowserItemData& InItem, const bool InIncludeMetaData, const FName InAttributeKey, FContentBrowserItemDataAttributeValue& OutAttributeValue);
	 ...
	 */
	UE_API virtual bool GetItemAttributes(const FContentBrowserItemData& InItem, const bool InIncludeMetaData, FContentBrowserItemDataAttributeValues& OutAttributeValues);
	 ...
	 */
	UE_API virtual bool GetItemPhysicalPath(const FContentBrowserItemData& InItem, FString& OutDiskPath);
	 ...
	 */
	UE_API virtual bool GetItemAssetAccessSpecifier(const FContentBrowserItemData& InItem, EAssetAccessSpecifier& OutAssetAccessSpecifier);
	 ...
	 */
	UE_API virtual bool CanModifyItemAssetAccessSpecifier(const FContentBrowserItemData& InItem);
	 ...
	 */
	UE_API virtual bool IsItemDirty(const FContentBrowserItemData& InItem);
	 ...
	 */
	UE_API virtual bool CanEditItem(const FContentBrowserItemData& InItem, FText* OutErrorMsg);
	 ...
	 */
	UE_API virtual bool EditItem(const FContentBrowserItemData& InItem);
	 ...
	 */
	UE_API virtual bool BulkEditItems(TArrayView<const FContentBrowserItemData> InItems);
     ...
     */
    UE_API virtual bool CanViewItem(const FContentBrowserItemData& InItem, FText* OutErrorMsg);
     ...
     */
    UE_API virtual bool ViewItem(const FContentBrowserItemData& InItem);
     ...
     */
    UE_API virtual bool BulkViewItems(TArrayView<const FContentBrowserItemData> InItems);
	 ...
	 */
	UE_API virtual bool CanPreviewItem(const FContentBrowserItemData& InItem, FText* OutErrorMsg);
	 ...
	 */
	UE_API virtual bool PreviewItem(const FContentBrowserItemData& InItem);
	 ...
	 */
	UE_API virtual bool BulkPreviewItems(TArrayView<const FContentBrowserItemData> InItems);
	 ...
	 */
	UE_API virtual bool CanDuplicateItem(const FContentBrowserItemData& InItem, FText* OutErrorMsg);
	 ...
	 */
	UE_API virtual bool DuplicateItem(const FContentBrowserItemData& InItem, FContentBrowserItemDataTemporaryContext& OutPendingItem);
	 ...
	 */
	UE_API virtual bool BulkDuplicateItems(TArrayView<const FContentBrowserItemData> InItems, TArray<FContentBrowserItemData>& OutNewItems);
	 ...
	 */
	UE_API virtual bool CanSaveItem(const FContentBrowserItemData& InItem, const EContentBrowserItemSaveFlags InSaveFlags, FText* OutErrorMsg);
	 ...
	 */
	UE_API virtual bool SaveItem(const FContentBrowserItemData& InItem, const EContentBrowserItemSaveFlags InSaveFlags);
	 ...
	 */
	UE_API virtual bool BulkSaveItems(TArrayView<const FContentBrowserItemData> InItems, const EContentBrowserItemSaveFlags InSaveFlags);
	 ...
	 */
	UE_API virtual bool CanDeleteItem(const FContentBrowserItemData& InItem, FText* OutErrorMsg);
	 ...
	 */
	UE_API virtual bool DeleteItem(const FContentBrowserItemData& InItem);
	 ...
	 */
	UE_API virtual bool BulkDeleteItems(TArrayView<const FContentBrowserItemData> InItems);
	...
	*/
	UE_API virtual bool PrivatizeItem(const FContentBrowserItemData& InItem, const EAssetAccessSpecifier InAssetAccessSpecifier = EAssetAccessSpecifier::Private);
	...
	*/
	UE_API virtual bool BulkPrivatizeItems(TArrayView<const FContentBrowserItemData> InItems, const EAssetAccessSpecifier InAssetAccessSpecifier = EAssetAccessSpecifier::Private);
	 ...
	 */
	UE_API virtual bool CanRenameItem(const FContentBrowserItemData& InItem, const FString* InNewName, const IContentBrowserHideFolderIfEmptyFilter* HideFolderIfEmptyFilter, FText* OutErrorMsg);
	 ...
	 */
	UE_API virtual bool RenameItem(const FContentBrowserItemData& InItem, const FString& InNewName, FContentBrowserItemData& OutNewItem);
	 ...
	 */
	UE_API virtual bool CanCopyItem(const FContentBrowserItemData& InItem, const FName InDestPath, FText* OutErrorMsg);
	 ...
	 */
	UE_API virtual bool CopyItem(const FContentBrowserItemData& InItem, const FName InDestPath);
	 ...
	 */
	UE_API virtual bool BulkCopyItems(TArrayView<const FContentBrowserItemData> InItems, const FName InDestPath);
	 ...
	 */
	UE_API virtual bool CanMoveItem(const FContentBrowserItemData& InItem, const FName InDestPath, FText* OutErrorMsg);
	 ...
	 */
	UE_API virtual bool MoveItem(const FContentBrowserItemData& InItem, const FName InDestPath);
	 ...
	 */
	UE_API virtual bool BulkMoveItems(TArrayView<const FContentBrowserItemData> InItems, const FName InDestPath);
	 ...
	 */
	UE_API virtual bool AppendItemReference(const FContentBrowserItemData& InItem, FString& InOutStr);
	 ...
	 */
	UE_API virtual bool AppendItemObjectPath(const FContentBrowserItemData& InItem, FString& InOutStr);
	 ...
	 * @return True if package name were appended, false otherwise.
	 */
	UE_API virtual bool AppendItemPackageName(const FContentBrowserItemData& InItem, FString& InOutStr);
	 ...
	 */
	UE_API virtual bool UpdateThumbnail(const FContentBrowserItemData& InItem, FAssetThumbnail& InThumbnail);
	 ...
	 */
	UE_API virtual TSharedPtr<FDragDropOperation> CreateCustomDragOperation(TArrayView<const FContentBrowserItemData> InItems);
	 ...
	 */
	UE_API virtual bool HandleDragEnterItem(const FContentBrowserItemData& InItem, const FDragDropEvent& InDragDropEvent);
	 ...
	 * @return True if this data source can handle the drag event (even if it won't because it's invalid), or false to allow another data source (or the default handler) to deal with it instead.
	 */
	UE_API virtual bool HandleDragOverItem(const FContentBrowserItemData& InItem, const FDragDropEvent& InDragDropEvent);
	 ...
	 * @return True if this data source can handle the drag event (even if it won't because it's invalid), or false to allow another data source (or the default handler) to deal with it instead.
	 */
	UE_API virtual bool HandleDragLeaveItem(const FContentBrowserItemData& InItem, const FDragDropEvent& InDragDropEvent);
	 ...
	 */
	UE_API virtual bool HandleDragDropOnItem(const FContentBrowserItemData& InItem, const FDragDropEvent& InDragDropEvent);
	 ...
	 */
	UE_API virtual bool TryGetCollectionId(const FContentBrowserItemData& InItem, FSoftObjectPath& OutCollectionId);
	 ...
	 */
	UE_API virtual bool Legacy_TryGetPackagePath(const FContentBrowserItemData& InItem, FName& OutPackagePath);
	 ...
	 */
	UE_API virtual bool Legacy_TryGetAssetData(const FContentBrowserItemData& InItem, FAssetData& OutAssetData);
	 ...
	 */
	UE_API virtual bool Legacy_TryConvertPackagePathToVirtualPath(const FName InPackagePath, FName& OutPath);
	 ...
	 */
	UE_API virtual bool Legacy_TryConvertAssetDataToVirtualPath(const FAssetData& InAssetData, const bool InUseFolderPaths, FName& OutPath);
	 ...
	 */
	UE_API virtual void BuildRootPathVirtualTree();
	 ...
	 */
	UE_API FContentBrowserItemData CreateVirtualFolderItem(const FName InFolderPath);
	 ...
	 */
	UE_API virtual bool TryConvertVirtualPathToInternal(const FName InPath, FName& OutInternalPath);
	 ...
	 */
	UE_API virtual bool TryConvertInternalPathToVirtual(const FName InInternalPath, FName& OutPath);

	/**
	 * Tell the data source to remove any cached data for the filter compilation that might not be needed any more.
	 */
	UE_API virtual void RemoveUnusedCachedFilterData(const FContentBrowserDataFilterCacheIDOwner& IDOwner, TArrayView<const FName> InVirtualPathsInUse, const FContentBrowserDataFilter& DataFilter);

	/**
	 * Tell the data source to remove the cached data for the filter compilation for this specific owner. 
	 */
	UE_API virtual void ClearCachedFilterData(const FContentBrowserDataFilterCacheIDOwner& IDOwner);
...
protected:
	 ...
	 */
	UE_API void QueueItemDataUpdate(FContentBrowserItemDataUpdate&& InUpdate);
	...
	UE_API void NotifyItemDataRefreshed();

	/**
	 * Adds internal root path to virtual path tree
	 */
	UE_API void RootPathAdded(const FStringView InInternalPath);

	/**
	 * Removes internal root path from virtual path tree
	 */
	UE_API void RootPathRemoved(const FStringView InInternalPath);
