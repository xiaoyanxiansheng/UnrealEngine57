...
public:
	 ...
	 */
	UE_API explicit FContentBrowserItem(FContentBrowserItemData&& InItem);
	UE_API explicit FContentBrowserItem(const FContentBrowserItemData& InItem);
	UE_API explicit FContentBrowserItem(TArrayView<const FContentBrowserItemData> InItems);
	 ...
	 */
	UE_API void Append(const FContentBrowserItem& InOther);
	 ...
	 */
	UE_API bool TryAppend(const FContentBrowserItem& InOther, FText* OutError = nullptr);

	/**
	 * Append the given item to this one, asserting if the combination isn't possible.
	 */
	UE_API void Append(const FContentBrowserItemData& InOther);

	/**
	 * Attempt to append the given item to this one, providing error information if the combination isn't possible.
	 * @return True if the combination was possible, false otherwise.
	 */
	UE_API bool TryAppend(const FContentBrowserItemData& InOther, FText* OutError = nullptr);

	/**
	 * Remove the given item from this one, asserting if the removal wasn't possible.
	 */
	UE_API void Remove(const FContentBrowserItem& InOther);
	 ...
	 */
	UE_API bool TryRemove(const FContentBrowserItem& InOther, FText* OutError = nullptr);

	/**
	 * Remove the given item from this one, asserting if the removal wasn't possible.
	 */
	UE_API void Remove(const FContentBrowserItemData& InOther);

	/**
	 * Attempt to remove the given item from this one, providing error information if the removal wasn't possible.
	 * @return True if the removal was possible, false otherwise.
	 */
	UE_API bool TryRemove(const FContentBrowserItemData& InOther, FText* OutError = nullptr);
	 ...
	 */
	UE_API FContentBrowserItemData TryRemove(const FContentBrowserMinimalItemData& InKey, FText* OutError = nullptr);

	/**
	 * Get the array of internal items that comprise this composite item.
	 */
	UE_API FItemDataArrayView GetInternalItems() const;

	/**
	 * Get the primary internal item from this composite item, if any.
	 */
	UE_API const FContentBrowserItemData* GetPrimaryInternalItem() const;
	 ...
	 */
	UE_API bool IsDisplayOnlyFolder() const;

	/**
	 * Get the flags denoting basic state information for this item instance.
	 */
	UE_API EContentBrowserItemFlags GetItemFlags() const;
	 ...
	 */
	UE_API EContentBrowserItemFlags GetItemType() const;
	 ...
	 */
	UE_API EContentBrowserItemFlags GetItemCategory() const;
	 ...
	 */
	UE_API bool GetItemAssetAccessSpecifier(EAssetAccessSpecifier& OutAssetAccessSpecifier) const;
	 ...
	 */
	UE_API bool CanModifyItemAssetAccessSpecifier() const;
	 ...
	 */
	UE_API FContentBrowserItemDataAttributeValue GetItemAttribute(const FName InAttributeKey, const bool InIncludeMetaData = false) const;
	 ...
	 */
	UE_API FContentBrowserItemDataAttributeValues GetItemAttributes(const bool InIncludeMetaData = false) const;
	 ...
	 */
	UE_API bool GetItemPhysicalPath(FString& OutDiskPath) const;
	 ...
	 */
	UE_API bool CanPreview(FText* OutErrorMsg = nullptr) const;
	 ...
	 */
	UE_API bool CanDuplicate(FText* OutErrorMsg = nullptr) const;
	 ...
	 */
	UE_API FContentBrowserItemDataTemporaryContext Duplicate() const;
	 ...
	 */
	UE_API bool CanSave(const EContentBrowserItemSaveFlags InSaveFlags, FText* OutErrorMsg = nullptr) const;
	 ...
	 */
	UE_API bool Save(const EContentBrowserItemSaveFlags InSaveFlags) const;
	 ...
	 */
	UE_API bool CanDelete(FText* OutErrorMsg = nullptr) const;

	/**
	 * Attempt to delete this item.
	 * @return True if the item was deleted, false otherwise.
	 */
	UE_API bool Delete() const;
	 ...
	 */
	UE_API bool CanRename(const FString* InNewName, FText* OutErrorMsg = nullptr) const;
	 ...
	 * @return True if the item can be renamed, false otherwise.
	 */
	UE_API bool CanRename(const FString* InNewName, const IContentBrowserHideFolderIfEmptyFilter* HideFolderIfEmptyFilter, FText* OutErrorMsg = nullptr) const;
	 ...
	 */
	UE_API bool Rename(const FString& InNewName, FContentBrowserItem* OutNewItem = nullptr) const;
	 ...
	 */
	UE_API bool CanCopy(const FName InDestPath, FText* OutErrorMsg = nullptr) const;
	 ...
	 */
	UE_API bool Copy(const FName InDestPath) const;
	 ...
	 */
	UE_API bool CanMove(const FName InDestPath, FText* OutErrorMsg = nullptr) const;
	 ...
	 */
	UE_API bool Move(const FName InDestPath) const;
	 ...
	 */
	UE_API bool AppendItemReference(FString& InOutStr) const;
	 ...
	 * @return True if references were appended, false otherwise.
	 */
	UE_API bool AppendItemObjectPath(FString& InOutStr) const;
	 ...
	 * @return True if references were appended, false otherwise.
	 */
	UE_API bool AppendItemPackageName(FString& InOutStr) const;
	 ...
	 */
	UE_API bool UpdateThumbnail(FAssetThumbnail& InThumbnail) const;
	 ...
	 */
	UE_API bool TryGetCollectionId(FSoftObjectPath& OutCollectionId) const;
	 ...
	 */
	UE_API bool Legacy_TryGetPackagePath(FName& OutPackagePath) const;
	 ...
	 */
	UE_API bool Legacy_TryGetAssetData(FAssetData& OutAssetData) const;

	/**
	 * Creates a ContentBrowserItemPath, potentially looking up internal paths.
	 * @return The Item Path.
	 */
	UE_API FContentBrowserItemPath GetItemPath() const;
...
public:
	...
	static UE_API bool IsFolder(const FContentBrowserItem& Item);

	UFUNCTION(BlueprintPure, Category="ContentBrowser", meta=(ScriptMethod))
	static UE_API bool IsFile(const FContentBrowserItem& Item);

	UFUNCTION(BlueprintPure, Category="ContentBrowser", meta=(ScriptMethod))
	static UE_API FName GetVirtualPath(const FContentBrowserItem& Item);

	UFUNCTION(BlueprintPure, Category="ContentBrowser", meta=(ScriptMethod))
	static UE_API FText GetDisplayName(const FContentBrowserItem& Item);
};
...
public:
	 ...
	 */
	UE_API void AppendContext(FContentBrowserItemDataTemporaryContext&& InContext);

	/**
	 * Get the data representing the temporary item instance.
	 */
	UE_API const FContentBrowserItem& GetItem() const;
	 ...
	 */
	UE_API bool ValidateItem(const FString& InProposedName, FText* OutErrorMsg = nullptr) const;

	/**
	 * Invoke the delegate used to finalize the creation of the temporary item, and return the real item.
	 */
	UE_API FContentBrowserItem FinalizeItem(const FString& InProposedName, FText* OutErrorMsg = nullptr) const;
...
public:
	 ...
	 */
	UE_API explicit FContentBrowserItemKey(const FContentBrowserItem& InItem);
	UE_API explicit FContentBrowserItemKey(const FContentBrowserItemData& InItemData);
	
	/**
	 * Construct this key from the given item type, virtual path, and data source.
	 */
	UE_API FContentBrowserItemKey(EContentBrowserItemFlags InItemType, FName InPath, const UContentBrowserDataSource* InDataSource);
...
protected:
	 ...
	 */
	UE_API void Initialize(const FContentBrowserItemData& InItemData);
...
public:
	 ...
	 */
	UE_API explicit FContentBrowserItemUpdate(const FContentBrowserItemDataUpdate& InItemDataUpdate);

	/**
	 * Get the value denoting the types of updates that can be emitted for an item.
	 */
	UE_API EContentBrowserItemUpdateType GetUpdateType() const;

	/**
	 * Get the item data for the update.
	 */
	UE_API const FContentBrowserItem& GetItemData() const;

	/**
	 * Get the previous virtual path (UpdateType == Moved).
	 */
	UE_API FName GetPreviousVirtualPath() const;
