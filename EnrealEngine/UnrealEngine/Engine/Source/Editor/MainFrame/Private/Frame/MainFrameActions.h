...
public:
	...
	TSharedPtr< FUICommandInfo > OpenCurrentProjectDirectory;
...
public:
	...
	/** Return the window used for the Open and New project Browser */
	static TSharedRef<SWindow> CreateProjectBrowserWindow(bool bAllowProjectOpening, bool bAllowProjectCreate);
	...
	/** Opens up the project directory */
	static void OpenCurrentProjectDirectory();
