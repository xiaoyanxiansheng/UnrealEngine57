...
void FMainFrameCommands::RegisterCommands()
{
	...
	UI_COMMAND(OpenCurrentProjectDirectory, "Open Current Project Directory", "Opens the current project's directory in explorer.", EUserInterfaceActionType::Button, FInputChord());
	ActionList->MapAction(OpenCurrentProjectDirectory, FExecuteAction::CreateStatic(&FMainFrameActionCallbacks::OpenCurrentProjectDirectory), DefaultExecuteAction);
...
void FMainFrameActionCallbacks::NewProject( bool bAllowProjectOpening, bool bAllowProjectCreate )
{
	...
	TSharedRef<SWindow> NewProjectWindow = CreateProjectBrowserWindow(bAllowProjectOpening, bAllowProjectCreate);
...
void FMainFrameActionCallbacks::OpenCurrentProjectDirectory()
{
	FString ProjectDirectory = FPaths::ConvertRelativePathToFull(FPaths::ProjectDir());
	FPlatformProcess::ExploreFolder(*ProjectDirectory);
}
...
TSharedRef<SWindow> FMainFrameActionCallbacks::CreateProjectBrowserWindow(bool bAllowProjectOpening, bool bAllowProjectCreate)
{
	FText Title;
