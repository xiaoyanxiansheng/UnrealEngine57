...
private:
	...
	FName CurrentlyEnteredLayoutName;

	FName CurrentlyEnteredLayoutDescription;
...
FSaveLayoutDialogParams::FSaveLayoutDialogParams(const FString& InDefaultDirectory, const FString& InFileExtension, const TArray<FName>& InLayoutNames, const TArray<FName>& InLayoutDescriptions)
			...
			[
				...
				[
					...
					[
						...
						.Text(FText::FromString(CurrentlyEnteredLayoutName.ToString()))
					...
					[
						SNew(SEditableTextBox)
						.Text(FText::FromString(CurrentlyEnteredLayoutDescription.ToString()))
...
{
	CurrentlyEnteredLayoutName = FName(InText.ToString());
	UpdateInputValidity();
...
{
	CurrentlyEnteredLayoutDescription = FName(InText.ToString());
