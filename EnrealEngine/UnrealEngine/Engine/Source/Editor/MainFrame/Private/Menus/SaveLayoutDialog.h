...
public:
	 ...
	 */
	FSaveLayoutDialogParams(const FString& InDefaultDirectory, const FString& InFileExtension, const TArray<FName>& LayoutNames = TArray<FName>(),
		const TArray<FName>& LayoutDescriptions = TArray<FName>());
