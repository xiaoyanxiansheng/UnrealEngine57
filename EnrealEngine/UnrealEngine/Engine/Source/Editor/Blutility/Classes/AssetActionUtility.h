...
class UAssetActionUtility : public UEditorUtilityObject, public IEditorUtilityExtension
{
	GENERATED_BODY()
...
public:
	...
	UE_API UClass* GetSupportedClass() const;
	...
	UE_API bool IsActionForBlueprints() const;
