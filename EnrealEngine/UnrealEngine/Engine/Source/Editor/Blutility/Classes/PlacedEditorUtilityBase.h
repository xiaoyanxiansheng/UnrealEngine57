...
class ADEPRECATED_PlacedEditorUtilityBase : public AActor
{
	...
	// AActor interface
	UE_API virtual void TickActor(float DeltaSeconds, ELevelTick TickType, FActorTickFunction& ThisTickFunction) override;
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Development|Editor")
	UE_API bool GetLevelViewportCameraInfo(FVector& CameraLocation, FRotator& CameraRotation);
	...
	*/
	...
	UE_API void SetLevelViewportCameraInfo(FVector CameraLocation, FRotator CameraRotation);
