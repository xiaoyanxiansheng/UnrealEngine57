...
void FEditorUtilityWidgetSettingsCustomization::CustomizeDetails(IDetailLayoutBuilder& DetailLayout)
{
	...
	TSharedPtr<IPropertyHandle> UIComponentsProperty = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UWidgetEditingProjectSettings, bEnableUIComponentsProperty), UWidgetEditingProjectSettings::StaticClass());
	UIComponentsProperty->MarkHiddenByCustomization();
}
