...
public:
	...
	UE_API bool GetEditorLanguage(FString& OutEditorLanguage) const;
	UE_API void SetEditorLanguage(const FString& InEditorLanguage);
	UE_API bool GetEditorLocale(FString& OutEditorLocale) const;
	UE_API void SetEditorLocale(const FString& InEditorLocale);
	UE_API bool GetPreviewGameLanguage(FString& OutPreviewGameLanguage) const;
	UE_API void SetPreviewGameLanguage(const FString& InPreviewGameLanguage);
	UE_API bool ShouldUseLocalizedNumericInput() const;
	UE_API void SetShouldUseLocalizedNumericInput(const bool Value);
	UE_API bool ShouldUseLocalizedPropertyNames() const;
	UE_API void SetShouldUseLocalizedPropertyNames(const bool Value);
	UE_API bool ShouldUseLocalizedNodeAndPinNames() const;
	UE_API void SetShouldUseLocalizedNodeAndPinNames(const bool Value);

	UE_API int32 GetTimezoneValue() const;
