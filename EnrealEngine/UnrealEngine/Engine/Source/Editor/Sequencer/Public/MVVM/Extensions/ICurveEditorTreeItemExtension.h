...
public:
	...
	UE_SEQUENCER_DECLARE_VIEW_MODEL_TYPE_ID_API(UE_API, ICurveEditorTreeItemExtension)
 ...
 */
class FCurveEditorTreeItemExtensionShim : public ICurveEditorTreeItemExtension
{
public:
