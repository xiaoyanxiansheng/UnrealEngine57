...
public:
	...
	virtual void AddFindPropertyChangedHandler(FFindAnimatablePropertyChangedHandler&& Handler) override;
...
private:
	...
	TOptional<FOnAnimatablePropertyChanged> FindPropertySetter(const UStruct& PropertyStructure, FAnimatedPropertyKey PropertyKey, const FProperty& Property) const;
...
private:
	...
	/** Array of delegates that are called before any other method to attempt to retrieve a property changed handler */
	TArray<FFindAnimatablePropertyChangedHandler> FindPropertyChangedHandlers;
