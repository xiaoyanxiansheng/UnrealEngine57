...
class FSequencerTextFilterExpression_BindingName : public FSequencerTextFilterExpressionContext
{
public:
	FSequencerTextFilterExpression_BindingName(ISequencerTrackFilters& InFilterInterface);
