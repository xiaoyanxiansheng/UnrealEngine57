...
class FSequencerTextFilterExpression_Group : public FSequencerTextFilterExpressionContext
{
public:
	FSequencerTextFilterExpression_Group(ISequencerTrackFilters& InFilterInterface);
