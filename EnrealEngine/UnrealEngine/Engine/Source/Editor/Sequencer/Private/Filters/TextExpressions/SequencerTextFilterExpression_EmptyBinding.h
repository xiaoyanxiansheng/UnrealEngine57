...
class FSequencerTextFilterExpression_EmptyBinding : public FSequencerTextFilterExpressionContext
{
public:
	FSequencerTextFilterExpression_EmptyBinding(ISequencerTrackFilters& InFilterInterface);
