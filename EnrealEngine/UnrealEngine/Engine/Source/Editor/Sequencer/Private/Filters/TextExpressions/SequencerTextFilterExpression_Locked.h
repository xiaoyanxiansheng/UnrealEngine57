...
class FSequencerTextFilterExpression_Locked : public FSequencerTextFilterExpressionContext
{
public:
	FSequencerTextFilterExpression_Locked(ISequencerTrackFilters& InFilterInterface);
