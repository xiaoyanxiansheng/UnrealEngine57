...
class FSequencerTextFilterExpression_Unbound : public FSequencerTextFilterExpressionContext
{
public:
	FSequencerTextFilterExpression_Unbound(ISequencerTrackFilters& InFilterInterface);
