...
class FSequencerTextFilterExpression_Modified : public FSequencerTextFilterExpressionContext
{
public:
	FSequencerTextFilterExpression_Modified(ISequencerTrackFilters& InFilterInterface);
