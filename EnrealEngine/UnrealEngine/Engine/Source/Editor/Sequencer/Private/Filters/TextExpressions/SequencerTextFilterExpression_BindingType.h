...
class FSequencerTextFilterExpression_BindingType : public FSequencerTextFilterExpressionContext
{
public:
	FSequencerTextFilterExpression_BindingType(ISequencerTrackFilters& InFilterInterface);
