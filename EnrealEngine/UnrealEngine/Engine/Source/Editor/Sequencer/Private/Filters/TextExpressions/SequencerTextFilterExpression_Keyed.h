...
class FSequencerTextFilterExpression_Keyed : public FSequencerTextFilterExpressionContext
{
public:
	FSequencerTextFilterExpression_Keyed(ISequencerTrackFilters& InFilterInterface);
