...
class FSequencerTextFilterExpression_ObjectClass : public FSequencerTextFilterExpressionContext
{
public:
	FSequencerTextFilterExpression_ObjectClass(ISequencerTrackFilters& InFilterInterface);
