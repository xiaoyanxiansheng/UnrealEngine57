...
class FSequencerTextFilterExpression_Name : public FSequencerTextFilterExpressionContext
{
public:
	FSequencerTextFilterExpression_Name(ISequencerTrackFilters& InFilterInterface);
