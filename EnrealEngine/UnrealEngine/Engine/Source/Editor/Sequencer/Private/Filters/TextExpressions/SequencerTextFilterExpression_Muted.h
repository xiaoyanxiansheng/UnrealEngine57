...
class FSequencerTextFilterExpression_Muted : public FSequencerTextFilterExpressionContext
{
public:
	FSequencerTextFilterExpression_Muted(ISequencerTrackFilters& InFilterInterface);
