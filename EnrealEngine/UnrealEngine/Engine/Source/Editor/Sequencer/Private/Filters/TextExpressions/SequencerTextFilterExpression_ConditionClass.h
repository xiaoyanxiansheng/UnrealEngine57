...
class FSequencerTextFilterExpression_ConditionClass : public FSequencerTextFilterExpressionContext
{
public:
	FSequencerTextFilterExpression_ConditionClass(ISequencerTrackFilters& InFilterInterface);
