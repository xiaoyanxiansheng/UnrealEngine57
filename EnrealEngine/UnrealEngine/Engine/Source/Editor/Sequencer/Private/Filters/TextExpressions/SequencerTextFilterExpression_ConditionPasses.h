...
class FSequencerTextFilterExpression_ConditionPasses : public FSequencerTextFilterExpressionContext
{
public:
	FSequencerTextFilterExpression_ConditionPasses(ISequencerTrackFilters& InFilterInterface);
