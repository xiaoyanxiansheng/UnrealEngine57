...
class FSequencerTextFilterExpression_Condition : public FSequencerTextFilterExpressionContext
{
public:
	FSequencerTextFilterExpression_Condition(ISequencerTrackFilters& InFilterInterface);
