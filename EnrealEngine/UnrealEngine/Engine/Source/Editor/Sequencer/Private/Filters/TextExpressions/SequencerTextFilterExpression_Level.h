...
class FSequencerTextFilterExpression_Level : public FSequencerTextFilterExpressionContext
{
public:
	FSequencerTextFilterExpression_Level(ISequencerTrackFilters& InFilterInterface);
