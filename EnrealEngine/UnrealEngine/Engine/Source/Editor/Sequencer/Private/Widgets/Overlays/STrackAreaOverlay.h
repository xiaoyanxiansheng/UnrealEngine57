...
{
/** Widget that overlay the track area. It overlays descendant FViewModels implementing ITrackAreaOverlayExtension to draw itself. */
class STrackAreaOverlay : public SCompoundWidget
{
public:

	SLATE_BEGIN_ARGS(STrackAreaOverlay){}
	SLATE_END_ARGS()
