...
UE_DEFINE_TCOMMANDS(FSequencerCommands)
...
void FSequencerCommands::RegisterCommands()
{
	...
	UI_COMMAND( ToggleLoopCuts, "Loop Cuts", "When enabled, the sequence considers looping as a jump/cut. When disabled, the sequence considers looping to be seamless.", EUserInterfaceActionType::ToggleButton, FInputChord());
