...
namespace UE::Editor::LevelEditor::Private
{
	void OnPostEngineInit()
	{
		if (GEditor)
		{
			...
			{
				FText DeprecationMessage = NSLOCTEXT("UnrealEditor", "LevelViewportToolbarPanelExtensionDeprecationMessage", "Please extend the \"LevelEditor.ViewportToolbar\" Tool Menus menu instead.");
			
				PanelExtensionSubsystem->MarkDeprecatedExtension("LevelViewportToolBar.LeftExtension", DeprecationMessage);
				PanelExtensionSubsystem->MarkDeprecatedExtension("LevelViewportToolBar.MiddleExtension", DeprecationMessage);
				PanelExtensionSubsystem->MarkDeprecatedExtension("LevelViewportToolBar.RightExtension", DeprecationMessage);
				PanelExtensionSubsystem->MarkDeprecatedExtension("LevelViewportToolBar.RightmostExtension", DeprecationMessage);
			}
		}
	}
}
...
void FLevelEditorModule::StartupModule()
{
	...
	FCoreDelegates::OnPostEngineInit.AddStatic(&UE::Editor::LevelEditor::Private::OnPostEngineInit);
}
...
void FLevelEditorModule::BindGlobalLevelEditorCommands()
{
	...
	ActionList.MapAction(
		...
		FCanExecuteAction::CreateStatic( &FLevelEditorActionCallbacks::CanShowSelectedActors )
		);
	...
	ActionList.MapAction(
		...
		FCanExecuteAction::CreateStatic( &FLevelEditorActionCallbacks::CanHideSelectedActors )
		);
		
	ActionList.MapAction(
		Commands.ToggleSelectedVisibility,
		FExecuteAction::CreateStatic( &FLevelEditorActionCallbacks::ExecuteExecCommand, FString( TEXT("ACTOR TOGGLE SELECTED VISIBILITY") ) ),
		FCanExecuteAction::CreateStatic( &FLevelEditorActionCallbacks::CanToggleSelectedActorsVisibility )
		);

	ActionList.MapAction(
		Commands.ShowSelectedHierarchy,
		FExecuteAction::CreateStatic( &FLevelEditorActionCallbacks::ExecuteExecCommand, FString( TEXT("ACTOR UNHIDE SELECTED HIERARCHY") ) ),
		FCanExecuteAction::CreateStatic( &FLevelEditorActionCallbacks::CanShowSelectedActors )
		);

	ActionList.MapAction(
		Commands.HideSelectedHierarchy,
		FExecuteAction::CreateStatic( &FLevelEditorActionCallbacks::ExecuteExecCommand, FString( TEXT("ACTOR HIDE SELECTED HIERARCHY") ) ),
		FCanExecuteAction::CreateStatic( &FLevelEditorActionCallbacks::CanHideSelectedActors )
		);

	ActionList.MapAction(
		Commands.ToggleSelectedHierarchyVisibility,
		FExecuteAction::CreateStatic( &FLevelEditorActionCallbacks::ExecuteExecCommand, FString( TEXT("ACTOR TOGGLE SELECTED VISIBILITY HIERARCHY") ) ),
		FCanExecuteAction::CreateStatic( &FLevelEditorActionCallbacks::CanToggleSelectedActorsVisibility )
		);
	...
	ActionList.MapAction(
		Commands.ShowSelectedHierarchyStartup,
		FExecuteAction::CreateStatic( &FLevelEditorActionCallbacks::ExecuteExecCommand, FString( TEXT("ACTOR UNHIDE SELECTED STARTUP HIERARCHY") ) )
		);
		
	ActionList.MapAction(
        Commands.HideSelectedHierarchyStartup,
        FExecuteAction::CreateStatic( &FLevelEditorActionCallbacks::ExecuteExecCommand, FString( TEXT("ACTOR HIDE SELECTED STARTUP HIERARCHY") ) )
        );
