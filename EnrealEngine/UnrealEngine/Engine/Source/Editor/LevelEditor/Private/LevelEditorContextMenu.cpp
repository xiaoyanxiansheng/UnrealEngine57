...
{
	{
		FToolMenuSection& Section = Menu->AddSection("VisibilitySelected", LOCTEXT("VisibilitySelectedHeader", "Selection"));
		Section.AddMenuEntry(FLevelEditorCommands::Get().ToggleSelectedVisibility);
		Section.AddMenuEntry(FLevelEditorCommands::Get().HideSelected);
		Section.AddMenuEntry(FLevelEditorCommands::Get().ShowSelected);
		Section.AddMenuEntry(FLevelEditorCommands::Get().ToggleSelectedHierarchyVisibility);
		Section.AddMenuEntry(FLevelEditorCommands::Get().HideSelectedHierarchy);
		Section.AddMenuEntry(FLevelEditorCommands::Get().ShowSelectedHierarchy);
	}

	{
		FToolMenuSection& Section = Menu->AddSection("VisibilityAll", LOCTEXT("VisibilityAllHeader", "World"));
		Section.AddMenuEntry(FLevelEditorCommands::Get().ShowSelectedOnly);
		Section.AddMenuEntry(FLevelEditorCommands::Get().ShowAll);
	}

	{
		FToolMenuSection& Section = Menu->AddSection("VisibilityStartup", LOCTEXT("VisibilityStartupHeader", "Startup"));
		...
		Section.AddMenuEntry(FLevelEditorCommands::Get().ShowSelectedHierarchyStartup);
		Section.AddMenuEntry(FLevelEditorCommands::Get().HideSelectedHierarchyStartup);
	}
}
