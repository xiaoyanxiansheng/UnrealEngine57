...
{
public:
	static UE_API const FName LevelEditorViewport;
	static UE_API const FName LevelEditorViewport_Clone1;
	static UE_API const FName LevelEditorViewport_Clone2;
	static UE_API const FName LevelEditorViewport_Clone3;
	static UE_API const FName LevelEditorViewport_Clone4;
	static UE_API const FName LevelEditorToolBox;
	static UE_API const FName LevelEditorSelectionDetails;
	static UE_API const FName LevelEditorSelectionDetails2;
	static UE_API const FName LevelEditorSelectionDetails3;
	static UE_API const FName LevelEditorSelectionDetails4;
	static UE_API const FName PlacementBrowser;
	static UE_API const FName LevelEditorBuildAndSubmit;
	static UE_API const FName LevelEditorSceneOutliner;
	static UE_API const FName LevelEditorSceneOutliner2;
	static UE_API const FName LevelEditorSceneOutliner3;
	static UE_API const FName LevelEditorSceneOutliner4;
	static UE_API const FName LevelEditorStatsViewer;
	static UE_API const FName LevelEditorLayerBrowser;
	static UE_API const FName LevelEditorDataLayerBrowser;
	static UE_API const FName Sequencer;
	static UE_API const FName SequencerGraphEditor;
	static UE_API const FName WorldSettings;
	static UE_API const FName WorldBrowserComposition;
	static UE_API const FName WorldBrowserPartitionEditor;
	static UE_API const FName WorldBrowserHierarchy;
	static UE_API const FName WorldBrowserDetails;
	static UE_API const FName LevelEditorHierarchicalLODOutliner;
	static UE_API const FName OutputLog;
	static UE_API const FName LevelEditorEnvironmentLightingViewer;
};
