...
void FPhysicsAssetEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND(CreateBodies, "Create Bodies/Constraints", "Creates bodies and/or constraints for the selected bones using the current generation settings (see the Tools tab)", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(CreateBodyWithBox, "Create Bodies with Box", "Create bodies with the Box primitive type (and optionally create constraints) for the selected bones using current generation settings (see the Tools tab)", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(CreateBodyWithSphere, "Create Bodies with Sphere", "Create bodies with the Sphere primitive type (and optionally create constraints) for the selected bones using current generation settings (see the Tools tab)", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(CreateBodyWithSphyl, "Create Bodies with Capsule", "Create bodies with the Capsule primitive type (and optionally create constraints) for the selected bones using current generation settings (see the Tools tab)", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(CreateBodyWithTaperedCapsule, "Create Bodies with Tapered Capsule (Clothing Only)", "Create bodies with the Tapered Capsule primitive type (and optionally create constraints) for the selected bones using current generation settings (see the Tools tab)", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(CreateBodyShouldCreateConstraints, "Create Constraints", "Create constraints between any newly created bodies and the bodies on adjacent bones for each of the selected bones", EUserInterfaceActionType::ToggleButton, FInputChord());
	UI_COMMAND(CreateOrRegenerateBodies, "Create/Regenerate Bodies", "Creates bodies and/or constraints (if none exist) or Regenerates bodies (if they do exist) for each of the selected bones using the current generation settings (see the Tools tab)", EUserInterfaceActionType::Button, FInputChord());
	...
	UI_COMMAND(HideCenterOfMassForKinematicBodies, "Hide Kinematic Bodies", "Hide CoM position and mass value for Kinematic Bodies", EUserInterfaceActionType::ToggleButton, FInputChord());
	...
	UI_COMMAND(ImportMLLevelSet, "Import MLLevelset Data", "Import MLLevelset Physical Asset", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(GenerateSkinnedTriangleMesh, "Generate Skinned Triangle Mesh", "Generate a Skinned Triangle Mesh primitive from the current preview skeletal mesh.", EUserInterfaceActionType::Button, FInputChord());
	...
	UI_COMMAND(HighlightOverlappingBodies, "Highlight Overlapping Bodies", "Draw colliding bodies that are currently overlapping each other in red (only supports Box, Capsule and Sphere primitive types in Edit mode)", EUserInterfaceActionType::ToggleButton, FInputChord(EModifierKey::Control, EKeys::C));
	...
	UI_COMMAND(ShowCrossConstraints, "Show Cross Constraints", "Display cross constraints in the tree view. Constraints are used to control how bodies can move in relation to one another. Cross constraints connect bodies that are attached to bones that are not adjacent (parent/child) in the skeleton.", EUserInterfaceActionType::ToggleButton, FInputChord());
	UI_COMMAND(ShowParentChildConstraints, "Show Parent-Child Constraints", "Display Parent-Child constraints in the tree view. Constraints are used to control how bodies can move in relation to one another. Parent-Child constraints connect bodies that are attached to bones that are adjacent (parent/child) in the skeleton.", EUserInterfaceActionType::ToggleButton, FInputChord());
