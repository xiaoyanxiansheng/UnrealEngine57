...
public:
	...
	TSharedPtr<FUICommandInfo> CreateBodies;
	TSharedPtr<FUICommandInfo> CreateBodyWithSphere;
	TSharedPtr<FUICommandInfo> CreateBodyWithSphyl;
	TSharedPtr<FUICommandInfo> CreateBodyWithBox;
	TSharedPtr<FUICommandInfo> CreateBodyWithTaperedCapsule;
	TSharedPtr<FUICommandInfo> CreateBodyShouldCreateConstraints;
	TSharedPtr<FUICommandInfo> CreateOrRegenerateBodies;
	...
	TSharedPtr<FUICommandInfo> HighlightOverlappingBodies;
	TSharedPtr<FUICommandInfo> DrawBodyMass;
	TSharedPtr<FUICommandInfo> DrawCenterOfMass;
	TSharedPtr<FUICommandInfo> HideCenterOfMassForKinematicBodies;
	...
	TSharedPtr<FUICommandInfo> ImportMLLevelSet; 
	TSharedPtr<FUICommandInfo> GenerateSkinnedTriangleMesh;
	...
	TSharedPtr<FUICommandInfo> ShowCrossConstraints;
	TSharedPtr<FUICommandInfo> ShowParentChildConstraints;
