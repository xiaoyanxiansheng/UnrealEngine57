...
public:
	...
	bool CanOpenParentTree() const;
	bool CanOpenSubtree() const;
	...
	TOptional<FBehaviorTreeNodeDebugContext> GetDebugContextForNode(const UBTNode* Node) const;
...
private:
	...
	double RewindDebuggerTimestamp;
	...
	/** Return StepId of the step at that TimeStamp. */
	int32 FindDebuggerStepForTimeStamp(double Timestamp) const;
	...
	void UpdateCurrentStep(int32 PrevStepIdx, int32 NewStepIdx, bool bSwitchAsset = true);
