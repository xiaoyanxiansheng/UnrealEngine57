...
namespace SoundWaveDetailsUtils
{
	...
	{
		FSoundBaseDetailsUtils::SortSoundCategories(AllCategoryMap, SoundWaveDetailsUtils::CategoryOrder);
	}
} // namespace SoundWaveDetailsUtils

TSharedRef<IDetailCustomization> FSoundWaveDetails::MakeInstance()
{
	return MakeShared<FSoundWaveDetails>();
}

void FSoundWaveDetails::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
	DetailBuilder.SortCategories(SoundWaveDetailsUtils::SortCategories);
