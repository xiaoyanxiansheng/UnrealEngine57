...
void FIntervalStructCustomization<NumericType>::SetValue(NumericType NewValue, EIntervalField Field, EPropertyValueSetFlags::Type Flags)
{
	...
	// This is to guard out 2 cases
	// a). SSpinBox flushes out any attempted uncommited value during destruction, and Custom Widgets was destructed before IPropertyTypeCustomization(see FDetailPropertyRow)
