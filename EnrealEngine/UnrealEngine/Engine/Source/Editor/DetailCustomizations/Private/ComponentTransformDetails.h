...
private:
	...
	void OnCopyToText(TSharedPtr<IPropertyHandle> PropertyHandle, FString& Text, const TOptional<FGuid>& InOperationId, ETransformField::Type InTransformField);

	void CopyToText(FString& Text, ETransformField::Type InTransformField);
