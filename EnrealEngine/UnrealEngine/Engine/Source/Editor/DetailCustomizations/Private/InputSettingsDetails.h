...
namespace InputSettingsDetails
{
	...
	struct FMappingSet
	{
		...
		FName GetAxisMappingName() const;
	};
}
...
private:
	...
	void OnDeprecationCheckboxChanged(ECheckBoxState NewState, const FName MappingName);
	ECheckBoxState GetActionMappingCheckBoxState(const FName MappingName) const;
	class UInputSettings* GetInputSettings() const;
...
private:
	...
	void OnDeprecationCheckboxChanged(ECheckBoxState NewState, const FName MappingName);
	ECheckBoxState GetAxisMappingCheckBoxState(const FName MappingName) const;
	class UInputSettings* GetInputSettings() const;
