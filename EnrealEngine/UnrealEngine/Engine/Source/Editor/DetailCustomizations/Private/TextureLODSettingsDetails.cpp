...
TSharedRef<SWidget> FTextureLODGroupLayout::MakeMipGenSettingsComboWidget(TSharedPtr<TextureMipGenSettings> InItem)
{
	...
	const FString& MipGenSettingsName = TextureGroupEnum->GetMetaData(TEXT("DisplayName"), TextureGroupEnum->GetIndexByValue(*InItem.Get()));
...
{
	UEnum* TextureGroupEnum = StaticEnum<TextureMipGenSettings>();
	const FString& MipGenSettingsName = TextureGroupEnum->GetMetaData(TEXT("DisplayName"), TextureGroupEnum->GetIndexByValue(LodGroup->MipGenSettings));
