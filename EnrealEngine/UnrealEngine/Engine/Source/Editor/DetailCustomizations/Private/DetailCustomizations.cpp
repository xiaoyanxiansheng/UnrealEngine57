...
void FDetailCustomizationsModule::RegisterObjectCustomizations()
{
	...
	RegisterCustomClassLayout("SoundCue", FOnGetDetailCustomizationInstance::CreateStatic(&FSoundCueDetails::MakeInstance));
	...
	RegisterCustomClassLayout("MaterialParameterCollection", FOnGetDetailCustomizationInstance::CreateStatic(&FMaterialParameterCollectionDetails::MakeInstance));
