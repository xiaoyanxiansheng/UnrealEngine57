...
static const FLazyName NAME_AllowAnyActor = FLazyName("AllowAnyActor");
static const FLazyName NAME_AllowedClasses = FLazyName("AllowedClasses");
static const FLazyName NAME_DisallowedClasses = FLazyName("DisallowedClasses");
static const FLazyName NAME_UseComponentPicker = FLazyName("UseComponentPicker");
