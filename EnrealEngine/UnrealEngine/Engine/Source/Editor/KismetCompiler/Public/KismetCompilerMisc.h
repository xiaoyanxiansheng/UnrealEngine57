...
protected:
	...
	UE_API virtual FBPTerminal* RegisterLiteral(FKismetFunctionContext& Context, UEdGraphPin* Net);
public:
	...
	UE_API virtual void RegisterNets(FKismetFunctionContext& Context, UEdGraphNode* Node);
	 ...
	 */
	static UE_API void SanitizeName(FString& Name);
};
