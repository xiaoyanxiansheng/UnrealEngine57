...
{
public:
	UE_API UMovieSceneUserThumbnailSettings(const FObjectInitializer& Initializer);
	...
	static UE_API void AddReferencedObjects(UObject* InThis, FReferenceCollector& InCollector);

private:
	FOnForceRedraw OnForceRedrawEvent;
};

UCLASS(MinimalAPI, config=EditorSettings, BlueprintType)
class UMovieSceneUserImportFBXSettings : public UObject
{
public:
	UE_API UMovieSceneUserImportFBXSettings(const FObjectInitializer& Initializer);
...
UCLASS(MinimalAPI, BlueprintType,config = EditorSettings)
class UMovieSceneUserImportFBXControlRigSettings : public UObject
{
public:
	UE_API UMovieSceneUserImportFBXControlRigSettings(const FObjectInitializer& Initializer);
...
public:
	...
	UE_API void LoadControlMappingsFromPreset(bool bMetaHumanPreset);
};
...
{
public:
	UE_API UMovieSceneUserExportFBXControlRigSettings(const FObjectInitializer& Initializer);
