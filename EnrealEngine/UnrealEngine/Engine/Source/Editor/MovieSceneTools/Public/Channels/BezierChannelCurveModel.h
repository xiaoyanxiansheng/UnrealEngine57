...
protected:
	...
	/**
	 * Updates all dependent systems after a change has been made to owning object.
	 * Calls MarkAsChanged, dirties the package, and FCurveModel::OnCurvesModified.
	 */
	void OnPostOwnerChanged(TNotNull<UMovieSceneSignedObject*> InSignedOwner);
