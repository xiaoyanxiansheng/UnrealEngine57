...
void STimeRange::Construct( const STimeRange::FArguments& InArgs, TSharedRef<ITimeSliderController> InTimeSliderController )
{
	...
	PlaybackRangeStartColor = InArgs._PlaybackRangeStartColor;
	PlaybackRangeEndColor = InArgs._PlaybackRangeEndColor;
	...
	[
		...
		[
			...
			[
				...
				.Padding(0.f)
				.BorderImage(nullptr)
				.ForegroundColor(PlaybackRangeStartColor)
				[
					PlaybackRangeStart
				]
			]
		...
		[
			...
			[
				...
				.Padding(0.f)
				.BorderImage(nullptr)
				.ForegroundColor(PlaybackRangeEndColor)
				[
					PlaybackRangeEnd
				]
			]
