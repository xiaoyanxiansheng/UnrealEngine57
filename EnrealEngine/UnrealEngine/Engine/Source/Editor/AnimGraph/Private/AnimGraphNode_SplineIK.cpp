...
#include UE_INLINE_GENERATED_CPP_BY_NAME(AnimGraphNode_SplineIK)

#define LOCTEXT_NAMESPACE "A3Nodes"

void UAnimGraphNode_SplineIK::Serialize(FArchive& Ar)
{
	...
	if (Ar.IsLoading())
	{
		...
		if (CustomVersion < FFortniteMainBranchObjectVersion::ChangeDefaultAlphaBlendType)
		{
			...
			Node.TwistBlend.SetBlendOption(EAlphaBlendOption::Linear);
		}
	}
