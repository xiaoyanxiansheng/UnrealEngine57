...
#include UE_INLINE_GENERATED_CPP_BY_NAME(AnimGraphNode_SkeletalControlBase)
...
void UAnimGraphNode_SkeletalControlBase::Serialize(FArchive& Ar)
{
	...
	if (Ar.IsLoading())
	{
		...
		if (CustomVersion < FFortniteMainBranchObjectVersion::ChangeDefaultAlphaBlendType)
		{
			...
			FAnimNode_SkeletalControlBase* SkeletalControlBase = static_cast<FAnimNode_SkeletalControlBase*>(GetFNode());
			SkeletalControlBase->AlphaBoolBlend.BlendOption = EAlphaBlendOption::Linear;
		}
	}
