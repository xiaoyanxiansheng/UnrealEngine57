...
#include UE_INLINE_GENERATED_CPP_BY_NAME(AnimGraphNode_TwoWayBlend)
...
void UAnimGraphNode_TwoWayBlend::Serialize(FArchive& Ar)
{
	...
	if (Ar.IsLoading())
	{
		...
		if (CustomVersion < FFortniteMainBranchObjectVersion::ChangeDefaultAlphaBlendType)
		{
			...
			BlendNode.AlphaBoolBlend.BlendOption = EAlphaBlendOption::Linear;
		}
	}
