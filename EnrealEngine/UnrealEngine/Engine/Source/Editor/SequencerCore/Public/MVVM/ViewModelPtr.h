...
struct TViewModelPtr : TViewModelConversions<T>
{
	...
	TViewModelPtr(TYPE_OF_NULLPTR)
	{}

	/** Assignment from a nullptr */
	TViewModelPtr& operator=(TYPE_OF_NULLPTR)
	{
...
public:
	...
	friend bool operator==(const TViewModelPtr<T>& A, TYPE_OF_NULLPTR B)
	{
...
struct TWeakViewModelPtr : TWeakViewModelConversions<T>
{
	...
	TWeakViewModelPtr(TYPE_OF_NULLPTR)
	{}
