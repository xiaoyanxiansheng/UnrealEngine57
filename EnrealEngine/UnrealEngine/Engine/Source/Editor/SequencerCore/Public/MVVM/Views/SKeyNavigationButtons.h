...
public:
	...
	UE_API void Construct(const FArguments& InArgs, const TSharedPtr<FViewModel>& InModel);

	UE_API FReply OnPreviousKeyClicked();
	UE_API FReply OnNextKeyClicked();
	UE_API FReply OnAddKeyClicked();
