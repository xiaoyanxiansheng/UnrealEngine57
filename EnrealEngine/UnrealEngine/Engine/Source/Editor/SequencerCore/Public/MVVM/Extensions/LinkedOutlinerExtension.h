...
public:
	...
	UE_SEQUENCER_DECLARE_VIEW_MODEL_TYPE_ID_API(UE_API, FLinkedOutlinerExtension);

	UE_API FLinkedOutlinerExtension();

	UE_API TViewModelPtr<IOutlinerExtension> GetLinkedOutlinerItem() const;

	UE_API void SetLinkedOutlinerItem(const TViewModelPtr<IOutlinerExtension>& InOutlinerItem);
 ...
 */
class FLinkedOutlinerComputedSizingShim
{
public:
