...
public:
	...
	FORCEINLINE TSelectionSetIteratorState<KeyType> begin() const { return TSelectionSetIteratorState<KeyType>(SelectionSet.begin(), SelectionSet.end()); }
	FORCEINLINE TSelectionSetIteratorState<KeyType> end() const   { return TSelectionSetIteratorState<KeyType>(SelectionSet.end(), SelectionSet.end());   }
