...
#define LOCTEXT_NAMESPACE "SLockColumnWidget"
...
{
	SetToolTipText(LOCTEXT("LockTooltip", "Lock this track and disable editing.\n\n"
...
void SLockColumnWidget::SetIsActive(const bool bInIsActive)
{
	...
	const FScopedTransaction Transaction(LOCTEXT("SetNodeLocked", "Set Node Locked"));
