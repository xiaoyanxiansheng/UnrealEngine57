...
#define UE_API CONFIGEDITOR_API
...
*/
class FConfigPropertyConfigFileStateCustomColumn : public IPropertyTableCustomColumn
{
public:
	FConfigPropertyConfigFileStateCustomColumn(){}

	/** Begin IPropertyTableCustomColumn interface */
	UE_API virtual bool Supports(const TSharedRef< IPropertyTableColumn >& Column, const TSharedRef< IPropertyTableUtilities >& Utilities) const override;
	UE_API virtual TSharedPtr< SWidget > CreateColumnLabel(const TSharedRef< IPropertyTableColumn >& Column, const TSharedRef< IPropertyTableUtilities >& Utilities, const FName& Style) const override;
	UE_API virtual TSharedPtr< IPropertyTableCellPresenter > CreateCellPresenter(const TSharedRef< IPropertyTableCell >& Cell, const TSharedRef< IPropertyTableUtilities >& Utilities, const FName& Style) const override;
