...
class UK2Node_EditablePinBase : public UK2Node
{
	...
	// UK2Node interface
	virtual bool ShouldShowNodeProperties() const override { return bIsEditable; }
	 ...
	 */
	virtual bool CanCreateUserDefinedPin(const FEdGraphPinType& InPinType, EEdGraphPinDirection InDesiredDirection, FText& OutErrorMessage) { return false; }
