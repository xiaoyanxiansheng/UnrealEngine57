...
struct FEdGraphSchemaAction_K2NewNode : public FEdGraphSchemaAction
{
	...
	static UE_API UEdGraphNode* CreateNode(UEdGraph* ParentGraph, TArrayView<UEdGraphPin*> FromPins, const FVector2D Location, UK2Node* NodeTemplate, EK2NewNodeFlags Options);
	static UE_API UEdGraphNode* CreateNode(UEdGraph* ParentGraph, TArrayView<UEdGraphPin*> FromPins, const FVector2D Location, TFunctionRef<UK2Node*(UEdGraph*)> ConstructionFn, TFunctionRef<void(UK2Node*)> InitializerFn, EK2NewNodeFlags Options);
};
...
struct FEdGraphSchemaAction_K2AssignDelegate : public FEdGraphSchemaAction_K2NewNode
{
	...
	static UE_API UEdGraphNode* AssignDelegate(class UK2Node* NodeTemplate, class UEdGraph* ParentGraph, UEdGraphPin* FromPin, const FVector2D Location, bool bSelectNewNode);
};
...
public:
	...
	// FEdGraphSchemaAction interface
	UE_API virtual void MovePersistentItemToCategory(const FText& NewCategoryName) override;
	...
	UE_API UBlueprint* GetSourceBlueprint() const;
};
...
struct FEdGraphSchemaAction_K2Graph : public FEdGraphSchemaAction
{
	...
	UE_API UFunction* GetFunction() const;
	UE_API UBlueprint* GetSourceBlueprint() const;
};
