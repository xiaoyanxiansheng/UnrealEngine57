...
public:
	 ...
	 */
	static UE_API UBlueprintDelegateNodeSpawner* Create(TSubclassOf<UK2Node_BaseMCDelegate> NodeClass, FMulticastDelegateProperty const* const Property, UObject* Outer = nullptr);
	 ...
	 */
	UE_API FMulticastDelegateProperty const* GetDelegateProperty() const;
};
