...
#include UE_INLINE_GENERATED_CPP_BY_NAME(K2Node_InputAxisKeyEvent)
...
void UK2Node_InputAxisKeyEvent::ExpandNode(FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
	...
	if (GetBlueprint()->ShouldAutomaticallyRegisterInputOnConstruction())
	{
