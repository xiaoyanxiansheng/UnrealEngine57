...
struct FSkeletonTreeBuilderOutput
{
	 ...
	 */
	UE_API void Add(const TSharedPtr<class ISkeletonTreeItem>& InItem, const FName& InParentName, TArrayView<const FName> InParentTypes, bool bAddToHead = false);
	 ...
	 * @param	bAddToHead		Whether to add the item to the start or end of the parent's children array
	 */
	UE_API void Add(const TSharedPtr<class ISkeletonTreeItem>& InItem, const FName& InParentName, const FName& InParentType, bool bAddToHead = false);
	 ...
	 */
	UE_API TSharedPtr<class ISkeletonTreeItem> Find(const FName& InName, TArrayView<const FName> InTypes) const;
	 ...
	 * @return the item found, or an invalid ptr if it was not found.
	 */
	UE_API TSharedPtr<class ISkeletonTreeItem> Find(const FName& InName, const FName& InType) const;
