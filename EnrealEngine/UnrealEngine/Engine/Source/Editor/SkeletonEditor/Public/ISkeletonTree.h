...
public:
	struct Columns
	{
		static SKELETONEDITOR_API const FName Name;
		static SKELETONEDITOR_API const FName Retargeting;
		static SKELETONEDITOR_API const FName BlendProfile;
		static SKELETONEDITOR_API const FName DebugVisualization;
	};
