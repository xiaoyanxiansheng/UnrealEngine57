...
{
	TWeakObjectPtr<UClothingAssetBase> ClothingAsset;
};
...
DECLARE_DELEGATE_ThreeParams(FOnClothAssetSelectionChanged, TWeakObjectPtr<UClothingAssetBase>, int32, int32);
...
public:
	...
	TWeakObjectPtr<UClothingAssetBase> GetSelectedAsset() const;
...
protected:
	...
	void SetSelectedAsset(TWeakObjectPtr<UClothingAssetBase> InSelectedAsset);
	...
	TWeakObjectPtr<UClothingAssetBase> SelectedAsset;
	int32 SelectedLod;
	int32 SelectedMask;
