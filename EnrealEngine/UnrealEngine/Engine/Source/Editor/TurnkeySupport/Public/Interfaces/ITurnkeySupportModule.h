...
public:
	...
	/**
	 * Make a Platforms menu in the given MenuSection at the specified InsertPosition
	 */
	virtual void MakeTurnkeyMenu(FToolMenuSection& MenuSection, const FToolMenuInsert& InsertPosition) const = 0;
