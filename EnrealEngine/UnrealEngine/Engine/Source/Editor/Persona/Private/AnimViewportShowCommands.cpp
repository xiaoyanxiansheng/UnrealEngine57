...
void FAnimViewportShowCommands::RegisterCommands()
{
	...
	UI_COMMAND( ShowNaniteFallback, "Nanite Fallback", "Show the preview mesh's Nanite fallback", EUserInterfaceActionType::ToggleButton, FInputChord(EModifierKey::Control, EKeys::N) );
