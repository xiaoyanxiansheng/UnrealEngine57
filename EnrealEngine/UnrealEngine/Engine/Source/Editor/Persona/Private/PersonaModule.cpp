...
TSharedRef<class FWorkflowTabFactory> FPersonaModule::CreateAdvancedPreviewSceneTabFactory(const TSharedRef<class FWorkflowCentricApplication>& InHostingApp, const TSharedRef<IPersonaPreviewScene>& InPreviewScene, const FPersonaAdvancedPreviewSceneTabSettings& DetailCustomizationSettings) const
{
	return MakeShareable(new FAdvancedPreviewSceneTabSummoner(InHostingApp, InPreviewScene, DetailCustomizationSettings));
}
...
TSharedRef<SWidget> FPersonaModule::CreateAttributePicker(
...
{
	return SNew(SAnimAttributePicker, InSkeleton)
		.OnAttributesPicked(InOnAttributesPicked)
		.bEnableMultiSelect(bEnableMultiSelect)
		.bCanShowOtherSkeletonAttributes(bCanShowOtherSkeletonAttributes);
}
