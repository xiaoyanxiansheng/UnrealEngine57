...
FPreviewSceneDescriptionCustomization::FPreviewSceneDescriptionCustomization(const FString& InSkeletonName, const TSharedRef<class IPersonaToolkit>& InPersonaToolkit, const FPersonaAdvancedPreviewSceneTabSettings& InDetailCustomizationSettings)
	: FPreviewSceneDescriptionCustomization(InSkeletonName, InPersonaToolkit)
{
	DetailCustomizationSettings = InDetailCustomizationSettings;
}
...
void FPreviewSceneDescriptionCustomization::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
	...
	//
	{
		...
		IDetailCategoryBuilder& AnimCategory = DetailBuilder.EditCategory("Animation", LOCTEXT("AnimationLabel", "Animation"));
	...
	//
	{
		...
		DetailBuilder.EditCategory("Mesh", LOCTEXT("MeshLabel", "Mesh"))
	...
	{
		DetailBuilder.EditCategory("Animation Blueprint", LOCTEXT("AnimationBlueprintLabel", "Animation Blueprint"))
	...
	//
	{
		...
		DetailBuilder.EditCategory("Additional Meshes", LOCTEXT("AdditionalMeshesLabel", "Additional Meshes"))
		...
		if (AdditionalMeshesAsset.IsValid())
		{
			...
			IDetailPropertyRow* PropertyRow = DetailBuilder.EditCategory("Additional Meshes", LOCTEXT("AdditionalMeshesLabel", "Additional Meshes"))
	...
	if (DetailCustomizationSettings.bHideMeshCategory)
	{
		DetailBuilder.HideCategory("Mesh");
	}

	if (DetailCustomizationSettings.bHideAdditionalMeshesCategory)
	{
		DetailBuilder.HideCategory("Additional Meshes");
	}

	if (DetailCustomizationSettings.bHideAnimationCategory)
	{
		DetailBuilder.HideCategory("Animation");
	}

	if (DetailCustomizationSettings.bHidePhysicsCategory)
	{
		DetailBuilder.HideCategory("Physics");
	}

	if (DetailCustomizationSettings.bHideAnimationBlueprintCategory)
	{
