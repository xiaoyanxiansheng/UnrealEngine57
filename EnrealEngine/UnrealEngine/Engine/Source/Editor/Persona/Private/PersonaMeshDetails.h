...
private:
	...
	void OnAttributePreChangePreventPostEditChange(int32 LODIndex, FName LODInfoPropertyName);
	void OnAttributeChangedPreventPostEditChange(const int32 LODIndex, const FName LODInfoPropertyName, const bool bForceComponentRefresh);
	void PreventAttributePostEditChange(TSharedPtr<IPropertyHandle> AttributeHandle, const int32 LODIndex, const FName PropertyName, const bool bForceComponentRefresh);
...
private:
	TArray<TUniquePtr<FScopedSkeletalMeshPostEditChange>> ChangeScopes;
