...
void SBoneTreeMenu::RebuildBoneList(const FName& SelectedBone)
{
	...
	if (bShowNone)
	{
		TSharedRef<FBoneNameInfo> NoneBoneInfo = MakeShared<FBoneNameInfo>(NAME_None);
		SkeletonTreeInfo.Add(NoneBoneInfo);
		SkeletonTreeInfoFlat.Add(NoneBoneInfo);
	}
