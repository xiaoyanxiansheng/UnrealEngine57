...
public:
	...
	FAdvancedPreviewSceneTabSummoner(TSharedPtr<class FAssetEditorToolkit> InHostingApp, const TSharedRef<class IPersonaPreviewScene>& InPreviewScene, const FPersonaAdvancedPreviewSceneTabSettings& InDetailCustomizationSettings);
...
private:
	TWeakPtr<class IPersonaPreviewScene> PreviewScene;
	FPersonaAdvancedPreviewSceneTabSettings DetailCustomizationSettings;
};
