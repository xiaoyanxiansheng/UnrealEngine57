...
struct FPoseWatchManagerDragDropOp : public FCompositeDragDropOp
{
	DRAG_DROP_OPERATOR_TYPE(FPoseWatchManagerDragDropOp, FCompositeDragDropOp);

	UE_API FPoseWatchManagerDragDropOp();
...
private:
	...
	UE_API EVisibility GetOverrideVisibility() const;
	UE_API EVisibility GetDefaultVisibility() const;
