...
public:
	...
	FPreviewSceneDescriptionCustomization(const FString& InSkeletonName, const TSharedRef<class IPersonaToolkit>& InPersonaToolkit, const FPersonaAdvancedPreviewSceneTabSettings& InDetailCustomizationSettings);
