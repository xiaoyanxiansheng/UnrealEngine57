...
// Called by the attribute picker to indicate the attributes chosen by the user
DECLARE_DELEGATE_OneParam(FOnAttributesPicked, const TConstArrayView<FAnimationAttributeIdentifier>);