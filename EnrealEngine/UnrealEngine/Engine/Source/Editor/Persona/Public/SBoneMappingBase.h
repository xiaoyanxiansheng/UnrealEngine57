...
public:
	...
	*/
	UE_API TSharedRef<ITableRow> GenerateBoneMappingRow(TSharedPtr<FDisplayedBoneMappingInfo> InInfo, const TSharedRef<STableViewBase>& OwnerTable);

	/**
	* Handler for the delete of retarget source
	*/
	UE_API void RefreshBoneMappingList();
private:
	...
	*/
	...
	UE_API void OnBoneMappingChanged( FName NodeName, FName BoneName );
	UE_API FName GetBoneMapping( FName NodeName );
