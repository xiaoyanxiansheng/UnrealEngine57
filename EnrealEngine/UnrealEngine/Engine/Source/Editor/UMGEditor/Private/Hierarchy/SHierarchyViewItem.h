...
#include "Hierarchy/IHierarchyViewItem.h"

class FHierarchyModel : public IHierarchyModel, public TSharedFromThis < FHierarchyModel >
{
public:
	...
	virtual bool CanControlVisibility() const override { return false; }
	virtual void SetIsVisible(bool IsVisible) { }

	virtual bool CanControlLockedInDesigner() const override { return false; }
	virtual bool IsLockedInDesigner() const override { return false; }
 ...
 */
class SHierarchyViewItem : public IHierarchyViewItem< FHierarchyModel >
{
public:
...
private:
	...
	virtual bool ShouldAppearHovered() const override;
	...
	/** Toggles lock status */
	virtual void ToggleLockedInDesigner(const bool bRecursive) override;
