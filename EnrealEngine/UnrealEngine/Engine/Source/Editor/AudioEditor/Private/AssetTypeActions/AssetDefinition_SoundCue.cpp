...
#include UE_INLINE_GENERATED_CPP_BY_NAME(AssetDefinition_SoundCue)
...
namespace MenuExtension_SoundCue
{
	...
	static FDelayedAutoRegisterHelper DelayedAutoRegister(EDelayedRegisterRunPhase::EndOfEngineInit, []{ 
		UToolMenus::RegisterStartupCallback(FSimpleMulticastDelegate::FDelegate::CreateLambda([]()
		{
			...
			{
				const UAssetDefinition* AssetDefinition = UAssetDefinitionRegistry::Get()->GetAssetDefinitionForClass(USoundCue::StaticClass());
