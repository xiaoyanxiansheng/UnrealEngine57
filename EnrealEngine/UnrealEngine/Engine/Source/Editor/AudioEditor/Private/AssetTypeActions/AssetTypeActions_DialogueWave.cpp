...
void FAssetTypeActions_DialogueWave::GetActions(const TArray<UObject*>& InObjects, FToolMenuSection& Section)
{
	...
	Section.AddMenuEntry(
		"DialogWave_PlaySound",
		LOCTEXT("DialogWave_PlaySound", "Play"),
		LOCTEXT("DialogWave_PlaySoundTooltip", "Plays the selected dialog wave."),
	...
	Section.AddMenuEntry(
		"DialogWave_StopSound",
		LOCTEXT("DialogWave_Stop", "Stop"),
		LOCTEXT("DialogWave_StopTooltip", "Stops the selected dialog wave(s)."),
