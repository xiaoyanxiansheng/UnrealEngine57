...
public:
	...
	/** Sorts the array of nodes either by a custom sort function, or by using the default one (::SortPredicate) */
	static void SortNodes(TArray<TSharedPtr<FStructViewerNode>>& Nodes, const TSharedPtr<IPropertyHandle>& PropertyHandle = { });
