...
#include UE_INLINE_GENERATED_CPP_BY_NAME(VREditorInteractor)
	...
	TArray<UClass*>* ObjectsInFrontOfGizmo /*= nullptr */, const bool bEvenIfBlocked /*= false */, const float LaserLengthOverride /*= 0.0f */ )
{
	...
	{
		for (TActorIterator<AVREditorFloatingUI> UIActorIt( WorldInteraction->GetWorld(), AVREditorFloatingUI::StaticClass() ); UIActorIt; ++UIActorIt)
		{
