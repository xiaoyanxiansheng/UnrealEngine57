...
private:
	...
	/**
	 * Invoked during the tick of the graph editor. 
	 * Can be used for custom layout code / node UI relevant code
	 */
	FOnGraphEditorTickDelegate OnTickDelegate;
...
public:
	...
	virtual void SetOnTick(FOnGraphEditorTickDelegate InOnTickDelegate) override;
