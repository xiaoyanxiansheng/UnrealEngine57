...
UE_DEFINE_TCOMMANDS(FGraphEditorCommandsImpl)
...
void FGraphEditorCommandsImpl::RegisterCommands()
{
	...
	UI_COMMAND( OpenInNewTab, "Open in New Tab", "Opens this function, macro or collapsed graph in a new tab.", EUserInterfaceActionType::Button, FInputChord() )
