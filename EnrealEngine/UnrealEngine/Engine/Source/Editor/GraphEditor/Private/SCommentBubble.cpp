...
{
	return FVector2D(GetOffset2f());
}

FVector2f SCommentBubble::GetOffset2f() const
{
	return FVector2f( 0.f, -GetDesiredSize().Y );
}
...
{
	return FVector2D(GetSize2f());
}

FVector2f SCommentBubble::GetSize2f() const
{
