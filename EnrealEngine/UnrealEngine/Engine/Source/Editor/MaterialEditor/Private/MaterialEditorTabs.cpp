...
const FName FMaterialEditorTabs::MaterialOverviewTabId(TEXT("MaterialEditor_MaterialExpressionOverview"));


const FName FMaterialInstanceEditorTabs::PreviewTabId( TEXT( "MaterialInstanceEditor_Preview" ) );
const FName FMaterialInstanceEditorTabs::PropertiesTabId( TEXT( "MaterialInstanceEditor_MaterialProperties" ) );
const FName FMaterialInstanceEditorTabs::LayerPropertiesTabId(TEXT("MaterialInstanceEditor_MaterialLayerProperties"));
const FName FMaterialInstanceEditorTabs::PreviewSettingsTabId(TEXT("MaterialInstanceEditor_PreviewSettings"));
const FName FMaterialInstanceEditorTabs::AssetBrowserTabId(TEXT("MaterialInstanceEditor_AssetBrowser"));
const FName FMaterialInstanceEditorTabs::SubstrateTabId(TEXT("MaterialInstanceEditor_Substrate"));
