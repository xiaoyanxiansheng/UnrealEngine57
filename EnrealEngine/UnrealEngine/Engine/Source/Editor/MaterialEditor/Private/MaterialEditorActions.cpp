...
UE_DEFINE_TCOMMANDS(FMaterialEditorCommands)
...
void FMaterialEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND( FixupMismatchedSamplers, "Fixup mismatched samplers", "Automatically fixes all texture samplers with the wrong type for their texture.", EUserInterfaceActionType::Button, FInputChord());
