...
void FShaderPlatformSettings::AllocateMaterialResources()
{
	...
	for (int32 QualityLevelIndex = 0; QualityLevelIndex < EMaterialQualityLevel::Num; QualityLevelIndex++)
	{
		...
		Data.MaterialResourcesStats->SetMaterial(Material, MaterialInstance, PlatformShaderID, (EMaterialQualityLevel::Type)QualityLevelIndex);
		...
		for (int32 i = 0; i < DerivedMaterialInstances.Num(); ++i)
		{
			...
			Data2.MaterialResourcesStats->SetMaterial(DerivedMaterialInstances[i]->GetBaseMaterial(), DerivedMaterialInstances[i], PlatformShaderID, (EMaterialQualityLevel::Type)QualityLevelIndex);
...
void FMaterialStats::ExtractHLSLCode()
{
	...
	FString FullSource;
	if (MaterialInterface != nullptr && MaterialInterface->GetMaterialResource(GMaxRHIShaderPlatform)->GetMaterialExpressionSource(FullSource))
	{
