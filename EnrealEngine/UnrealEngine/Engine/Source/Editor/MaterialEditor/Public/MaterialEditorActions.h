...
UE_DECLARE_TCOMMANDS(class FMaterialEditorCommands, MATERIALEDITOR_API)
...
public:
	...
	/** Fixes up broken sampler nodes */
	TSharedPtr<FUICommandInfo> FixupMismatchedSamplers;
	 ...
	 * Initialize commands
	 */
	MATERIALEDITOR_API virtual void RegisterCommands() override;
