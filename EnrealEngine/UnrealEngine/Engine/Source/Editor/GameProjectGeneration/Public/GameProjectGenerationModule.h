...
public:
	...
	/** Creates the project browser widget */
	virtual TSharedRef<class SWidget> CreateProjectBrowser(bool bInShowHeaderBar = true, bool bInAllowScrolling = true);
...
public:
	...
	virtual bool CreateProject(const FProjectInformation& InProjectInfo, FText& OutFailReason, FText& OutFailLog, TArray<FString>* OutCreatedFiles = nullptr);
	...
	virtual bool OpenProject(const FString& InProjectFile, FText& OutFailReason);
