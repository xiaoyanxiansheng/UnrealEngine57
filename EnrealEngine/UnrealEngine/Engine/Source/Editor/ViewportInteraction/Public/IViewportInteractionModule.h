 ...
 */
class UE_DEPRECATED(5.7, "The ViewportInteraction module is being deprecated alongside VR Editor mode.") IViewportInteractionModule : public IModuleInterface
{
