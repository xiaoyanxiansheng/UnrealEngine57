...
public:
	...
	UE_API FEditorConfig();

	UE_API void SetParent(TSharedPtr<FEditorConfig> InConfig);

	UE_API bool LoadFromString(FStringView Content);
	UE_API bool LoadFromFile(FStringView FilePath);
	UE_API bool SaveToString(FString& OutResult) const;
	...
	UE_API bool TryGetRootStruct(const UStruct* Class, void* OutValue, EPropertyFilter Filter = EPropertyFilter::MetadataOnly) const;
	UE_API bool TryGetRootUObject(const UClass* Class, UObject* OutValue, EPropertyFilter Filter = EPropertyFilter::MetadataOnly) const;
	...
	UE_API void SetRootStruct(const UStruct* Class, const void* Instance, EPropertyFilter Filter = EPropertyFilter::MetadataOnly);
	UE_API void SetRootUObject(const UClass* Class, const UObject* Instance, EPropertyFilter Filter = EPropertyFilter::MetadataOnly);

	UE_API bool HasOverride(FStringView Key) const;
...
private:
	...
	static UE_API void ReadUObject(const TSharedPtr<FJsonObject>& JsonObject, const UClass* Class, UObject* Instance, EPropertyFilter Filter);
	static UE_API void ReadStruct(const TSharedPtr<FJsonObject>& JsonObject, const UStruct* Struct, void* Instance, UObject* Owner, EPropertyFilter Filter);
	static UE_API void ReadValue(const TSharedPtr<FJsonValue>& JsonValue, const FProperty* Property, void* DataPtr, UObject* Owner);
	
	static UE_API TSharedPtr<FJsonObject> WriteStruct(const UStruct* Struct, const void* Instance, const void* Defaults, EPropertyFilter Filter);
	static UE_API TSharedPtr<FJsonObject> WriteUObject(const UClass* Class, const UObject* Instance, EPropertyFilter Filter);
	static UE_API TSharedPtr<FJsonValue> WriteArray(const FArrayProperty* ArrayProperty, const void* DataPtr);
	static UE_API TSharedPtr<FJsonValue> WriteSet(const FSetProperty* Property, const void* DataPtr);
	static UE_API TSharedPtr<FJsonValue> WriteMap(const FMapProperty* Property, const void* DataPtr);
	static UE_API TSharedPtr<FJsonValue> WriteValue(const FProperty* Property, const void* DataPtr, const void* Defaults);

	UE_API bool SaveToFile(FStringView FilePath) const;
