...
/** Called to get ContentBrowserItemData attribute values. */
UE_EXPERIMENTAL(5.7, "FGetItemDataAttribute is experimental while a newer system is in active development.")
DECLARE_DELEGATE_RetVal_FourParams(bool, FGetItemDataAttribute, const FContentBrowserItemData& /*InItem*/, const bool /*InIncludeMetaData*/, const FName /*InAttributeKey*/, FContentBrowserItemDataAttributeValue& /*OutAttributeValue*/);
...
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnFavoritesChanged, const FContentBrowserItemPath& /*ItemPath*/, bool /* bAdded */)
