...
private:
	...
	TSharedPtr<SWidget> GetFolderContextMenu(TArrayView<const FContentBrowserItem> SelectedItems, FContentBrowserMenuExtender_SelectedPaths InMenuExtender, FOnCreateNewFolder InOnCreateNewFolder);
	static TArray<FString> GetInternalPaths(TArrayView<const FContentBrowserItem> SelectedItems);
