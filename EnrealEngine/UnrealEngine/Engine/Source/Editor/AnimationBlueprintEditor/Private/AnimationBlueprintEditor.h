...
private:
	...
	void OnCreateSelfTransition();
	FAnimNode_StateMachine* GetSelectedStateInstance(int32& OutSelectedState) const;
	bool CanSetActiveState() const;
	void OnSetActiveState();
	void OnReverseTransition();
