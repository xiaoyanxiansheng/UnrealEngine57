...
bool FSourceControlWindowsModule::CanShowSnapshotHistoryTab() const
{
	...
	return (SourceControlModule.IsEnabled() && SourceControlModule.GetProvider().IsAvailable() && SourceControlModule.GetProvider().GetName() == SourceControlProviders::GetUrcProviderName());
}
