...
private:
	...
	FSourceControlChangelistStatePtr GetCurrentChangelistState() const;
	...
	bool CanDeleteChangelist() const;
	bool CanDeleteChangelist(FText* OutFailureMessage) const;
	void OnEditChangelist();
	void OnSubmitChangelist();
	FText GetCanSubmitChangelistToolTip() const;
	bool CanSubmitChangelist() const;
	bool CanSubmitChangelist(FText* OutFailureMessage) const;
	void OnValidateChangelist();
	bool CanValidateChangelist() const;
