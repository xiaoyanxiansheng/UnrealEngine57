...
class ULandscapeEditorObject : public UObject
{
	...
	UPROPERTY(Category="Tool Settings", EditAnywhere, NonTransactional, meta=(ShowForTools="Flatten,Smooth,Erosion,HydraErosion,Ramp", ShowForTargetTypes="Heightmap"))
	...
	// The current gizmo actor. Only the gizmo location is revealed to the user interface
	UPROPERTY(Category="Tool Settings", EditAnywhere, NonTransactional, Transient, meta=(ShowForTools="ImportExport,CopyPaste"))
...
public:
	...
	UPROPERTY(NonTransactional)
	bool bCanHaveLayersContent_DEPRECATED = true;
	...
	UPROPERTY(Category = "Target Layers", EditAnywhere)
	bool bTargetDisplayOrdersAscending;
