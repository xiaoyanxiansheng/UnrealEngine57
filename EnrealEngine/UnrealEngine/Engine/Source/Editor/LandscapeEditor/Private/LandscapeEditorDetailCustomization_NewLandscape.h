...
class FLandscapeEditorArrayBuilder_NewTargetLayer : public FDetailArrayBuilder
{
public:
	FLandscapeEditorArrayBuilder_NewTargetLayer(TSharedRef<IPropertyHandle> InBaseProperty)
...
private:
	static FReply ShowAutoFillTargetLayerDialog();
	static FReply HandleAutoFillTargetLayers(const bool bCreateAssetForEmptyLayers);
	static bool HasWeightmapTargetLayers();
};
