...
{
	// Give tests access to private members
...
protected:
	...
	// Current Gizmo customization (Import, Copy tools)
	static bool IsResetGizmoButtonShown(TSharedPtr<IPropertyHandle> InProperty = nullptr);
	static void ResetGizmoToOrigin(TSharedPtr<IPropertyHandle> InProperty = nullptr);
};
