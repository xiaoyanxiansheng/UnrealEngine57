...
void FStaticMeshEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND(SetShowRayTracingFallback, "Ray Tracing Fallback", "Toggles the display of the ray tracing fallback mesh.", EUserInterfaceActionType::ToggleButton, FInputChord());
