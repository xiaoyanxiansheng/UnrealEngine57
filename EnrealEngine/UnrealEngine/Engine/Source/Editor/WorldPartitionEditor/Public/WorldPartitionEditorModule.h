...
public:
	...
	*/
	...
	virtual bool GetRequireExplicitHLODLayerPartitionAssignation() const override;
	virtual void SetRequireExplicitHLODLayerPartitionAssignation(bool bInRequireExplicitHLODLayerPartitionAssignation) override;
...
private:
	...
	bool bRequireExplicitHLODLayerPartitionAssignation;
};
