...
void SDataLayerBrowser::Construct(const FArguments& InArgs)
{
	...
	InitOptions.ColumnMap.Add(FSceneOutlinerBuiltInColumnTypes::Label(), FSceneOutlinerColumnInfo(ESceneOutlinerColumnVisibility::Visible, 2, FCreateSceneOutlinerColumn(), false, TOptional<float>(), FSceneOutlinerBuiltInColumnTypes::Label_Localized()));
	...
	InitOptions.ColumnMap.Add("ID Name", FSceneOutlinerColumnInfo(ESceneOutlinerColumnVisibility::Invisible, 20, FCreateSceneOutlinerColumn::CreateStatic(&FTextInfoColumn::CreateTextInfoColumn, FName("ID Name"), InternalNameInfoText, LOCTEXT("DataLayerIDNameToolTip", "ID Name")), true, TOptional<float>(), LOCTEXT("DataLayerIDName", "ID Name")));
	InitOptions.ColumnMap.Add("Initial State", FSceneOutlinerColumnInfo(ESceneOutlinerColumnVisibility::Invisible, 20, FCreateSceneOutlinerColumn::CreateStatic(&FTextInfoColumn::CreateTextInfoColumn, FName("Initial State"), InternalInitialRuntimeStateInfoText, LOCTEXT("DataLayerInitialRuntimeStateToolTip", "Initial Runtime State")), true, TOptional<float>(), LOCTEXT("DataLayerInitialState", "Initial State")));
	...
	InitOptions.ColumnMap.Add("Streaming Priority", FSceneOutlinerColumnInfo(ESceneOutlinerColumnVisibility::Invisible, 20, FCreateSceneOutlinerColumn::CreateStatic(&FTextInfoColumn::CreateTextInfoColumn, FName("Streaming Priority"), InternalStreamingPriorityInfoText, LOCTEXT("DataLayerStreamingPriorityToolTip", "Streaming Priority")), true, TOptional<float>(), LOCTEXT("DataLayerStreamingPriority", "Streaming Priority")));
