...
public:
	...
	*/
	static UE_API USubobjectDataSubsystem* Get();
	...
	*/
	UE_API void GatherSubobjectData(UObject* Context, TArray<FSubobjectDataHandle>& OutArray);
	...
	using FSubobjectDataAdapterFilter = TFunction<bool(const FSubobjectData&)>;
	/** */
	UE_EXPERIMENTAL(5.7, "Experimental adapter to adjust behavior of SubobjectData")
	UE_API FSubobjectDataAdapterHandle RegisterSubobjectDataAdapter(FSubobjectDataAdapterFilter InFilter, TUniquePtr<FSubobjectDataAdapterBase> InDataAdapter);
	UE_EXPERIMENTAL(5.7, "Experimental adapter to adjust behavior of SubobjectData")
	UE_API void UnregisterSubobjectDataAdapter(FSubobjectDataAdapterHandle Handle);
	UE_EXPERIMENTAL(5.7, "Experimental adapter to adjust behavior of SubobjectData")
	const FSubobjectDataAdapterBase* FindDataAdapter(const FSubobjectData& SubobjectData) const;

	using FSubobjectSubsystemAdapterFilter = TFunction<bool(const TInstancedStruct<FSubobjectDataSubsystemContextDataBase>& ContextData)>;
	/** */
	UE_EXPERIMENTAL(5.7, "Experimental adapter to adjust behavior of SubobjectDataSubsystem")
	UE_API FSubobjectDataSubsystemAdapterHandle RegisterSubsystemAdapter(FSubobjectSubsystemAdapterFilter InFilter, TUniquePtr<FSubobjectDataSubsystemAdapterBase> InAdapter);
	UE_EXPERIMENTAL(5.7, "Experimental adapter to adjust behavior of SubobjectDataSubsystem")
	UE_API void UnregisterSubsystemAdapter(FSubobjectDataSubsystemAdapterHandle Handle);
private:
	const FSubobjectDataSubsystemAdapterBase* FindSubsystemAdapter(const TInstancedStruct<FSubobjectDataSubsystemContextDataBase>& ContextObject) const;
public:
	...
	*/
	...
	UE_API void K2_GatherSubobjectDataForBlueprint(UBlueprint* Context, TArray<FSubobjectDataHandle>& OutArray);
	...
	*/
	...
	UE_API void K2_GatherSubobjectDataForInstance(AActor* Context, TArray<FSubobjectDataHandle>& OutArray);
	...
	*/
	...
	UE_API bool K2_FindSubobjectDataFromHandle(const FSubobjectDataHandle& Handle, FSubobjectData& OutData) const;
	...
	*/
	...
	UE_API FSubobjectDataHandle FindHandleForObject(const FSubobjectDataHandle& Context, const UObject* ObjectToFind, UBlueprint* BPContext = nullptr) const;
	...
	static UE_API UClass* CreateNewCPPComponent(TSubclassOf<UActorComponent> ComponentClass, const FString& NewClassPath, const FString& NewClassName);
	...
	static UE_API UClass* CreateNewBPComponent(TSubclassOf<UActorComponent> ComponentClass, const FString& NewClassPath, const FString& NewClassName);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SubobjectDataSubsystem")
	UE_API FSubobjectDataHandle AddNewSubobject(const FAddNewSubobjectParams& Params, FText& FailReason);
	...
	*/
	...
	UE_API int32 DeleteSubobjects(const FSubobjectDataHandle& ContextHandle, const TArray<FSubobjectDataHandle>& SubobjectsToDelete, UBlueprint* BPContext = nullptr);
	...
	*/
	...
	UE_API int32 K2_DeleteSubobjectsFromInstance(const FSubobjectDataHandle& ContextHandle, const TArray<FSubobjectDataHandle>& SubobjectsToDelete);
	...
	* @return 	The number of subobjects successfully deleted
	*/
	UE_API int32 DeleteSubobjects(const FSubobjectDataHandle& ContextHandle, const TArray<FSubobjectDataHandle>& SubobjectsToDelete, FSubobjectDataHandle& OutComponentToSelect, UBlueprint* BPContext = nullptr, bool bForce = false);
	...
	*/
	...
	UE_API int32 DeleteSubobject(const FSubobjectDataHandle& ContextHandle, const FSubobjectDataHandle& SubobjectToDelete, UBlueprint* BPContext = nullptr);
	...
	*/
	...
	UE_API int32 K2_DeleteSubobjectFromInstance(const FSubobjectDataHandle& ContextHandle, const FSubobjectDataHandle& SubobjectToDelete);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SubobjectDataSubsystem")
	UE_API bool RenameSubobject(const FSubobjectDataHandle& Handle, const FText& InNewName);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SubobjectDataSubsystem")
	UE_API bool ChangeSubobjectClass(const FSubobjectDataHandle& Handle, const UClass* NewClass);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SubobjectDataSubsystem")
    UE_API bool ReparentSubobject(const FReparentSubobjectParams& Params, const FSubobjectDataHandle& ToReparentHandle);

	UFUNCTION(BlueprintCallable, Category = "SubobjectDataSubsystem")
	UE_API bool MakeNewSceneRoot(const FSubobjectDataHandle& Context, const FSubobjectDataHandle& NewSceneRoot, UBlueprint* BPContext);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SubobjectDataSubsystem")
	UE_API bool ReparentSubobjects(const FReparentSubobjectParams& Params, const TArray<FSubobjectDataHandle>& HandlesToMove);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SubobjectDataSubsystem")
	UE_API bool DetachSubobject(const FSubobjectDataHandle& OwnerHandle, const FSubobjectDataHandle& ChildToRemove);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SubobjectDataSubsystem")
    UE_API bool AttachSubobject(const FSubobjectDataHandle& OwnerHandle, const FSubobjectDataHandle& ChildToAddHandle);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SubobjectDataSubsystem")
	UE_API bool IsValidRename(const FSubobjectDataHandle& Handle, const FText& InNewText, FText& OutErrorMessage) const;
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SubobjectDataSubsystem")
	UE_API bool CanCopySubobjects(const TArray<FSubobjectDataHandle>& Handles) const;

	UFUNCTION(BlueprintCallable, Category = "SubobjectDataSubsystem")
	UE_API void CopySubobjects(const TArray<FSubobjectDataHandle>& Handles, UBlueprint* BpContext);

	UFUNCTION(BlueprintCallable, Category = "SubobjectDataSubsystem")
	UE_API bool CanPasteSubobjects(const FSubobjectDataHandle& RootHandle, UBlueprint* BPContext = nullptr) const;
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SubobjectDataSubsystem")
	UE_API void PasteSubobjects(const FSubobjectDataHandle& PasteToContext, const TArray<FSubobjectDataHandle>& NewParentHandles, UBlueprint* BpContext, TArray<FSubobjectDataHandle>& OutPastedHandles);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SubobjectDataSubsystem")
	UE_API void DuplicateSubobjects(const FSubobjectDataHandle& Context, const TArray<FSubobjectDataHandle>& SubobjectsToDup, UBlueprint* BpContext, TArray<FSubobjectDataHandle>& OutNewSubobjects);
	
	UE_API FScopedTransaction* BeginTransaction(const TArray<FSubobjectDataHandle>& Handles, const FText& Description, UBlueprint* Blueprint);
	...
	*/
	UE_API FSubobjectDataHandle FindSceneRootForSubobject(const FSubobjectDataHandle& InHandle) const;

	UFUNCTION(BlueprintCallable, Category = "SubobjectDataSubsystem")
	static UE_API void RenameSubobjectMemberVariable(UBlueprint* BPContext, const FSubobjectDataHandle& InHandle, const FName NewName);
	...
	*/
	static UE_API FSubobjectDataHandle GetActorRootHandle(const FSubobjectDataHandle& StartingHandle);
...
private:
	...
	*/
	UE_API FSubobjectDataHandle FindOrCreateAttachParentForComponent(UActorComponent* InActorComponent, const FSubobjectDataHandle& ActorRootHandle, TArray<FSubobjectDataHandle>& ExistingHandles);

	/**
	* Recursively search for an attachment parent that matches the given InActorComponent on the blueprint
	*/
	UE_API FSubobjectDataHandle FindAttachParentForInheritedComponent(UActorComponent* InActorComponent, const FSubobjectDataHandle& ActorRootHandle, UBlueprint* BP);

	/**
	 * Find all child subobject data related to the given root context.
	 * Populates the OutVisited set with all data. 
	 */
	UE_API void FindAllSubobjectData(FSubobjectData* RootContext, TSet<FSubobjectData*>& OutVisited) const;
	
	/**
	 * Creates an invalid SubobjectData and associates a handle
	 * The SubobjectData can be initialized using the Initialize() function
	 */
	UE_API FSubobjectDataHandle CreateSubobjectData();
	/**
	 ...
	 */
	UE_API FSubobjectDataHandle CreateSubobjectData(UObject* Context, const FSubobjectDataHandle& ParentHandle = FSubobjectDataHandle::InvalidHandle, bool bIsInheritedSCS = false);
	 ...
	 */
	UE_API FSubobjectDataHandle FactoryCreateSubobjectDataWithParent(UObject* Context, const FSubobjectDataHandle& ParentHandle, bool bIsInheritedSCS = false);
	 ...
	 */
	UE_API FSubobjectDataHandle FactoryCreateInheritedBpSubobject(UObject* Context, const FSubobjectDataHandle& ParentHandle, bool bIsInherited, TArray<FSubobjectDataHandle>& OutArray);
	
	/** Find the parent that this new subobject should attach to */
	UE_API FSubobjectDataHandle FindParentForNewSubobject(const UObject* NewSubobject, const FSubobjectDataHandle& SelectedParent);

	FOnNewSubobjectAdded OnNewSubobjectAdded_Delegate;

	struct FSubobjectDataAdapterEntry
	{
		TUniquePtr<FSubobjectDataAdapterBase> Adapter;
		FSubobjectDataAdapterHandle Handle;
		FSubobjectDataAdapterFilter Filter;
	};
	uint64 DataAdapterHandleIndex = 0;
	TArray<FSubobjectDataAdapterEntry> DataAdapters;

	struct FSubsystemAdapterEntry
	{
		TUniquePtr<FSubobjectDataSubsystemAdapterBase> Adapter;
		FSubobjectDataSubsystemAdapterHandle Handle;
		FSubobjectSubsystemAdapterFilter Filter;
	};
	uint64 SubsystemAdapterHandleIndex = 0;
	TArray<FSubsystemAdapterEntry> SubsystemAdapters;
