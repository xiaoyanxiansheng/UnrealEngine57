...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category="Subobject Data")
    static UE_API void GetData(const FSubobjectDataHandle& DataHandle, FSubobjectData& OutData);
	...
	*/
	...
	static UE_API const UObject* GetObject(const FSubobjectData& Data, bool bEvenIfPendingKill = false);

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="Subobject Data")
	static UE_API const UObject* GetAssociatedObject(const FSubobjectData& Data);

	UFUNCTION(BlueprintCallable, Category="Subobject Data")
	static UE_API const UObject* GetObjectForBlueprint(const FSubobjectData& Data, UBlueprint* Blueprint);
