...
void FTextureEditorToolkit::PopulateQuickInfo( )
{
	...
	ETextureStreamingMethod StreamingMethod = Texture->GetTextureStreamingMethod();
	FText Method;
	switch(StreamingMethod)
	{
		default:
		case TSM_Invalid:
			Method = NSLOCTEXT("TextureEditor", "QuickInfo_MethodInvalidStreamed", "Invalid");
			break;
		case TSM_NotStreamed:
			Method = NSLOCTEXT("TextureEditor", "QuickInfo_MethodNotStreamed", "Not Streamed");
			break;
		case TSM_Streamed:
			Method = NSLOCTEXT("TextureEditor", "QuickInfo_MethodStreamed", "Streamed");
			break;
		case TSM_VirtualStreamed:
			Method = NSLOCTEXT("TextureEditor", "QuickInfo_MethodVirtualStreamed", "Virtual Streamed");
			break;
	}
...
void FTextureEditorToolkit::FillToolbar(FToolBarBuilder& ToolbarBuilder)
{
	...
	bool bCanRecompress = CanRecompressTexture(GetTexture());
	bool bIsAtlas = (Atlas != nullptr);
	
	if ( bCanRecompress && ! bIsAtlas )
	{
