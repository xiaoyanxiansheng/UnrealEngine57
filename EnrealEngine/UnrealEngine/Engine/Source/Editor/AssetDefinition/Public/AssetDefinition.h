...
struct EAssetCategoryPaths
{
	...
	// top level assets.
	static UE_API FAssetCategoryPath Basic;
	
	static UE_API FAssetCategoryPath Animation;
	static UE_API FAssetCategoryPath Audio;
	static UE_API FAssetCategoryPath Blueprint;
	static UE_API FAssetCategoryPath Cinematics;
	static UE_API FAssetCategoryPath Foliage;
	static UE_API FAssetCategoryPath FX;
	static UE_API FAssetCategoryPath Gameplay;
	static UE_API FAssetCategoryPath AI;
	static UE_API FAssetCategoryPath Input;
	static UE_API FAssetCategoryPath Material;
	static UE_API FAssetCategoryPath Media;
	static UE_API FAssetCategoryPath Misc;
	static UE_API FAssetCategoryPath Physics;
	static UE_API FAssetCategoryPath Texture;
	static UE_API FAssetCategoryPath UI;
	static UE_API FAssetCategoryPath World;
};
...
public:
	UE_API UAssetDefinition();

	//Begin UObject
	UE_API virtual void PostCDOContruct() override;
	//End UObject
...
public:
	...
	UE_API virtual TConstArrayView<FAssetCategoryPath> GetAssetCategories() const;
...
protected:
	UE_API virtual void BuildFilters(TArray<FAssetFilterData>& OutFilters) const;
...
public:
	 ...
	 */
	UE_API virtual EAssetCommandResult GetSourceFiles(const FAssetSourceFilesArgs& InArgs, TFunctionRef<bool(const FAssetSourceFilesResult& InSourceFile)> SourceFileFunc) const;
	...
	UE_API virtual EAssetCommandResult GetSourceFiles(const FAssetData& InAsset, TFunctionRef<void(const FAssetImportInfo& AssetImportData)> SourceFileFunc) const;
	...
	/** Get the basic status info on assets like the Dirty and SourceControl one */
	UE_API virtual void GetAssetStatusInfo(const TSharedPtr<IAssetStatusInfoProvider>& InAssetStatusInfoProvider, TArray<FAssetDisplayInfo>& OutStatusInfo) const;
...
protected:
	UE_API virtual bool CanRegisterStatically() const;
