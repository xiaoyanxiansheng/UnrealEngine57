...
public:
	...
	/** Delegate handling copying a property handle to text. The default property handle impl for copying will be used if the delegate is not bound
	 * or returns false for a property */
	virtual TSharedPtr<FOnCopyToText> OnCopyToText() const override { return CopyToTextDelegate; }
...
private:
	...
	/** Delegate handling copying a property to text. The default property handle copy will be used if not provided */
	TSharedPtr<FOnCopyToText> CopyToTextDelegate;
