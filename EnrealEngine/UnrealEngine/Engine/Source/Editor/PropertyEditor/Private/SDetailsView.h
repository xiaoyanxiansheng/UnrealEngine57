...
public:
	...
	*/
	 ...
	 */
	virtual bool ResetToDefaultSection() override;

private:
	/** Minimal struct to hold section information. Note that the Name is the key, so is not present here. */
	struct FSection
	{
		FText DisplayName;
		int32 Order = 0;
...
private:
	...
	/** Get all sections, keyed by name for the objects currently selected in the view. */
	TMap<FName, FSection> GetAllSections() const;
