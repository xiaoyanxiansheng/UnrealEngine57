...
public:
	...
	virtual void NotifyStartedChangingProperties(const FPropertyChangedEvent& PropertyChangedEvent)
	{
		if (Generator != nullptr)
		{
			Generator->OnNotifyStartedChangingProperties().Broadcast(PropertyChangedEvent);
		}
	}
