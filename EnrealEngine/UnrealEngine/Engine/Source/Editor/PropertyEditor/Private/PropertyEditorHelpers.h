...
namespace PropertyEditorHelpers
{
	...
	*/
	...
	/**
	 * Attempts to find the class with the given object path.
	 * @param ClassPath  The asset path of the class to find or load (eg: /Game/Blueprints/BP_Example.BP_Example_C)
	 * 
	 * @return nullptr if the class could not be found, or if the path doesn't correspond to a class object
	 */
