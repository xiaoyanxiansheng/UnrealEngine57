...
public:
	...
	*/
	 ...
	 */
	virtual void SetRootExpansionStates(const bool bExpand, const bool bRecurse) override;
	...
	/**
	 * Resets the selected sections to the default 'All' section.
	 * Base class returns false as sections selection is not application to all detail views.
	 * 
	 * @return whether the operation succeeded.
	 */
	virtual bool ResetToDefaultSection() override { return false; }
...
protected:
	...
	UStruct* GetExpansionStruct(const TSharedRef<FPropertyNode>& StartNode);
...
protected:
	...
	/** Used to refresh the tree when the language changes */
	FDelegateHandle OnCultureChangedDelegate;
