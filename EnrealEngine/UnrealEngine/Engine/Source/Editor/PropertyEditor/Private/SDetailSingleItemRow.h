...
private:
	 ...
	 */
	bool CanPasteFromText(const FString& InTag, const FString& InText, const bool bIncludeEditCondition = true) const;

	/**
	 * Delegate handling pasting an optionally tagged text snippet
	 */
	void OnPasteFromText(const FString& InTag, const FString& InText, const TOptional<FGuid>& InOperationId, const bool bIncludeEditCondition);

	/**
	 * Handle pasting an optionally tagged text snippet
	 */
	bool PasteFromText(const FString& InTag, const FString& InText, const bool bIncludeEditCondition = true);
...
private:
	...
	/** Delegate handling copying to a text snippet */
