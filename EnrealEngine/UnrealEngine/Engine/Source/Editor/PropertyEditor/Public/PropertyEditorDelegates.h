...
/** Delegate to be called before a container item changes */
using FCanPropertyItemChangeRetType = TValueOrError<bool, FText>;
DECLARE_DELEGATE_RetVal_TwoParams(FCanPropertyItemChangeRetType, FCanPropertyItemChange, EPropertyChangeType::Type, int32 /* Index */);

/** Delegate to be called when a change is blocked on a property */
DECLARE_MULTICAST_DELEGATE_TwoParams(FPropertyChangeBlocked, const FProperty*, FText /* ErrorMessage */);
