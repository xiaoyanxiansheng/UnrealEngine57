...
public:
	...
	*/
	...
	/** @return true if a custom copy text is bound on this row */
	bool IsCopyToTextBound() const
	{
		return OnCopyToTextDelegate.IsValid() && OnCopyToTextDelegate.Pin()->IsBoundToObject(this);
	}
...
public:
	...
	/** Optional Delegate for copying text on this row (default property handle copy used if unbound) */
	TWeakPtr<FOnCopyToText> OnCopyToTextDelegate;
