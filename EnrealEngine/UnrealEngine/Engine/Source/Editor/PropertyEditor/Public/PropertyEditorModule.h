...
public:
	 ...
	 * @param InOrder		The order in which this section should be displayed. Lower values are displayed first.
	 */
	FPropertySection(FName InName, FText InDisplayName, const int32 InOrder = 0) : 
		Name(InName),
	...
	/** Get the (sort) order of this section, where the default is 0. */
	virtual int32 GetOrder() const { return Order; }
...
public:
	...
	/**
	 * Find or add a section of the given name.
	 * Optionally, you can specify an order for the section to be displayed in. Lower values are displayed first.
	 * Note that the default "All" section will always be displayed last.
	 */
	TSharedRef<FPropertySection> FindOrAddSection(FName SectionName, FText DisplayName, const int32 Order = 0);
...
public:
	 ...
	 * @param Order			The order in which this section should be displayed. Lower values are displayed first. The default "All" section will always be displayed last.
	 * @return				A new section, or the existing one. 
	 */
	virtual TSharedRef<FPropertySection> FindOrCreateSection(FName ClassName, FName SectionName, FText DisplayName, const int32 Order = 0);
