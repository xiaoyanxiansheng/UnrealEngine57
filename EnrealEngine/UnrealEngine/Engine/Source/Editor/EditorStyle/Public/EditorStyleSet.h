...
public:
	...
	*/
	...
	static UE_API void ResetToDefault();


protected:

	static UE_API void SetStyle( const TSharedRef< class ISlateStyle >& NewStyle );

private:

	/** Singleton instance of the slate style */
	static UE_API TSharedPtr< class ISlateStyle > Instance;
};
