...
#endif
#if MAX_PRODUCT_YEAR_NUMBER <= 2025 // Deprecated in 2025, removed in 2026
		, NOTIFY_CUI_MENUS_UPDATED, NOTIFY_CUI_MENUS_PRE_SAVE, NOTIFY_CUI_MENUS_POST_SAVE, NOTIFY_RENDER_PREEVAL_FRAMEINFO
#endif
