...
#define LM_NUM_SH_COEFFICIENTS 9
	...
	*/
	inline FString CreateChannelNameWithLMExecutableHash(const FGuid& Guid, const int32 Version, const FSHAHash& LMExecutableHash, const FString& Extension)
	{
	...
	inline FString CreateChannelName(const FGuid& Guid, const int32 Version, const FString& Extension)
	{
	 ...
	 * @return Standard channel name
	 */
	inline FString CreateChannelNameWithLMExecutableHash(const FSHAHash& Hash, const int32 Version, const FSHAHash& LMExecutableHash, const FString& Extension)
	{
