...
namespace UnrealBuildTool
{
	...
	public class LinuxTargetRules
	{
		...
		/// </summary>
		[CommandLine("-NoStripSymbols")]
		[XmlConfigFile(Category = "BuildConfiguration", Name = "bDisableStripSymbols")]
		public bool bDisableStripSymbols = false;
...
#pragma warning disable CS1591
		...
		public bool bDisableStripSymbols => Inner.bDisableStripSymbols;
#pragma warning restore CS1591
	...
	class LinuxPlatform : UEBuildPlatform
	{
		...
		public override UEToolChain CreateToolChain(ReadOnlyTargetRules Target)
		{
			...
			if (Target.LinuxPlatform.bDisableStripSymbols)
			{
				Options |= ClangToolChainOptions.DisableStripSymbols;
			}
			if (Target.LinuxPlatform.bEnableLibFuzzer)
			{
			...
			LinuxToolChain toolChain = new LinuxToolChain(Target.Architecture, SDK, Options, Logger);
