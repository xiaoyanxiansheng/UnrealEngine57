...
#pragma warning disable CS1591
		...
		public bool bEnableConstInitUObject => Inner.bEnableConstInitUObject;
		...
		public bool bDefineForceInlineHintToInline => Inner.bDefineForceInlineHintToInline;
		...
		public DebugInfoMode DebugInfoNoInlineLineTables => Inner.DebugInfoNoInlineLineTables;
		public IReadOnlySet<string> DebugInfoInlineLineTablesModules => Inner.DebugInfoInlineLineTablesModules;
		public IReadOnlySet<string> DebugInfoInlineLineTablesPlugins => Inner.DebugInfoInlineLineTablesPlugins;
		
		public DebugInfoMode DebugInfoSimpleTemplateNames => Inner.DebugInfoSimpleTemplateNames;
		public IReadOnlySet<string> DebugInfoSimpleTemplateNamesModules => Inner.DebugInfoSimpleTemplateNamesModules;
		public IReadOnlySet<string> DebugInfoSimpleTemplateNamesPlugins => Inner.DebugInfoSimpleTemplateNamesPlugins;
		...
		public string? CacheSalt => Inner.CacheSalt;
		...
		public bool bThinLTODistributed => Inner.bThinLTODistributed;
		...
		public bool bIdenticalCodeFolding => Inner.bIdenticalCodeFolding;
		...
		public bool bCheckDelegateLifetime => Inner.bCheckDelegateLifetime;

		public IReadOnlySet<string> MergeAdditionalCommonModules => Inner.MergeAdditionalCommonModules;
		...
		public IReadOnlyList<string> MergePluginsExcluded => Inner.MergePluginsExcluded;
		...
		public bool MergeOnlyGameFeatures => Inner.bMergeOnlyGameFeatures;

		public bool bReportModuleMergingData => Inner.bReportModuleMergingData;
		...
		public ReadOnlyAdditionalProperties AdditionalProperties => Inner.AdditionalProperties;
...
#pragma warning restore C1591
		...
		/// <summary>
		/// Report merged modules structure to the target so that the game may use this information.
		/// </summary>
		public virtual void ReportMergedModules(Dictionary<string, IEnumerable<ModuleRules>> ModuleGroups, Dictionary<string, Dictionary<string, List<string>>> RootPluginUsage)
			=> Inner.ReportMergedModules(ModuleGroups, RootPluginUsage);
