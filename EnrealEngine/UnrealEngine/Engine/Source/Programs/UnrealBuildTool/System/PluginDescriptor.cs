...
namespace UnrealBuildTool
{
	...
	public class PluginDescriptor
	{
		...
		public bool IsModuleCompiledInConfiguration(string Name, UnrealTargetPlatform Platform, UnrealTargetConfiguration Configuration, string TargetName, TargetType TargetType, bool bBuildDeveloperTools, bool bBuildRequiresCookedData, UnrealArchitectures? Architectures, [NotNullWhen(false)] out string? invalidReason)
		{
			...
			{
				if (!ModuleInfo.IsCompiledInConfiguration(Platform, Configuration, TargetName, TargetType, bBuildDeveloperTools, bBuildRequiresCookedData, Architectures, out string? InvalidReason))
				{
