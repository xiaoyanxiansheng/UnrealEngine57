...
namespace UnrealBuildTool
{
	...
	class LinkEnvironment
	{
		...
		/// </summary>
		public List<FileReference> Libraries = [];
		...
		/// </summary>
		public List<DirectoryReference> SystemLibraryPaths = [];

		/// <summary>
		/// A list of libraries to exclude from linking.
		/// </summary>
		public List<string> ExcludedLibraries = [];

		/// <summary>
		/// Paths to add as search paths for runtime libraries
		/// </summary>
		public List<string> RuntimeLibraryPaths = [];
		...
		/// </summary>
		public Dictionary<string, HashSet<UnrealArch>> DependenciesToSkipPerArchitecture = [];
		...
		/// </summary>
		public List<FileItem> DefaultResourceFiles = [];

		/// <summary>
		/// Resource files which should be compiled into every binary
		/// </summary>
		public List<FileItem> CommonResourceFiles = [];
		...
		/// </summary>
		public List<FileItem> DebuggerVisualizerFiles = [];
		...
		/// </summary>
		public List<ReceiptProperty> AdditionalProperties = [];

		/// <summary>
		/// List of all of the runtime dependencies.
		/// </summary>
		public List<ModuleRules.RuntimeDependency> RuntimeDependencies = [];
