...
namespace UnrealBuildTool
{
	...
	public class RulesCompiler
	{
		...
		/// </summary>
		private static object EngineRulesAssemblyLock = new();
		...
		/// </summary>
		private static ConcurrentDictionary<FileReference, Lazy<RulesAssembly>> LoadedAssemblyMap = new();
		...
		public static RulesAssembly CreateEngineRulesAssembly(bool bUsePrecompiled, bool bSkipCompile, bool bForceCompile, ILogger Logger)
		{
			lock (EngineRulesAssemblyLock)
			{
				if (EngineRulesAssembly == null)
				{
					...
					using GlobalSingleInstanceMutex _ = new(GlobalSingleInstanceMutex.GetUniqueMutexForPath("UnrealBuildTool_CreateTargetRulesAssembly", Unreal.EngineDirectory), true);
					{
		...
		public static RulesAssembly CreateProjectRulesAssembly(FileReference ProjectFileName, bool bUsePrecompiled, bool bSkipCompile, bool bForceCompile, ILogger Logger)
		{
			...
			{
				// Prevent multiple conflicting processes building rules assembly at the same time
				using GlobalSingleInstanceMutex _ = new(GlobalSingleInstanceMutex.GetUniqueMutexForPath("UnrealBuildTool_CreateTargetRulesAssembly", ProjectFileName), true);
		...
		public static RulesAssembly CreatePluginRulesAssembly(FileReference PluginFileName, bool bSkipCompile, bool bForceCompile, RulesAssembly Parent, bool bBuildPluginAsLocal, bool bContainsEngineModules, ILogger Logger)
		{
			...
			{
				// Prevent multiple conflicting processes building rules assembly at the same time
				using GlobalSingleInstanceMutex _ = new(GlobalSingleInstanceMutex.GetUniqueMutexForPath("UnrealBuildTool_CreateTargetRulesAssembly", PluginFileName), true);
		...
		{
			using var _ = Timeline.ScopeEvent("CreateRulesAssemly");
