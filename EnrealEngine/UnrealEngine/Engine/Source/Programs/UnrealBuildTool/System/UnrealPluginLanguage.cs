...
namespace UnrealBuildTool
{
	 ...
	 * 	
	 * 	<!-- optional additional interfaces that GameApplication can implement in GameApplication.java (must start with a comma and list interfaces using commas) -->
	 * 	<gameApplicationImplementsAdditions> </gameApplicationImplementsAdditions>
	 * 	
