...
namespace UnrealGameSync
{
	...
	public static class ConfigUtils
	{
		...
		{
			return ReadProjectConfigFileAsync(perforce, projectInfo.ClientRootPath, projectInfo.ClientFileName, projectInfo.ProjectIdentifier, projectInfo.CacheFolder, localConfigFiles, logger, cancellationToken);
		}
