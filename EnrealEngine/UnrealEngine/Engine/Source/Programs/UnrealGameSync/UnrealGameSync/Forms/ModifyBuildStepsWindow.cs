...
{
	partial class ModifyBuildStepsWindow : ThemedForm
	{
		...
		private void BuildStepList_DrawColumnHeader(object sender, DrawListViewColumnHeaderEventArgs e)
		{
			...
			{
				TextRenderer.DrawText(e.Graphics, e.Header.Text, BuildStepList.Font, e.Bounds, Theme.TextColor, TextFormatFlags.Left | TextFormatFlags.VerticalCenter);
			}
		}
		...
		private void BuildStepList_DrawSubItem(object sender, DrawListViewSubItemEventArgs e)
		{
			...
			else
			{
				...
				if (BuildStepList.SelectedItems.Contains(e.Item))
				{
