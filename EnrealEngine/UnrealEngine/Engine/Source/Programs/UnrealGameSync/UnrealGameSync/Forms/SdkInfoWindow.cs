...
{
	public partial class SdkInfoWindow : ThemedForm
	{
		...
		private void SdkListView_DrawSubItem(object sender, DrawListViewSubItemEventArgs e)
		{
			...
			{
				TextRenderer.DrawText(e.Graphics, e.SubItem.Text, SdkListView.Font, e.Bounds, Theme.TextColor, TextFormatFlags.EndEllipsis | TextFormatFlags.SingleLine | TextFormatFlags.Left | TextFormatFlags.VerticalCenter | TextFormatFlags.NoPrefix);
			}
			else
			{
