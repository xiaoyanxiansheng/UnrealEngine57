...
{
	partial class ConnectWindow : ThemedForm
	{
		...
		private void UpdateEnabledControls()
		{
			...
			ServerAndPortLabel.ForeColor = ServerAndPortLabel.Enabled ? activeTextColor : inactiveTextColor;
			ServerAndPortTextBox.ForeColor = ServerAndPortTextBox.Enabled ? activeTextColor : inactiveTextColor;
			UserNameLabel.ForeColor = UserNameLabel.Enabled ? activeTextColor : inactiveTextColor;
			UserNameTextBox.ForeColor = UserNameTextBox.Enabled ? activeTextColor : inactiveTextColor;
		}
