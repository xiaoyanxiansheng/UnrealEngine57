...
namespace UnrealGameSync
{
	...
	static class UgsHandler
	{
		...
		[UriHandler]
		public static UriResult RunCustomTool(string toolName, string args)
		{
			using (MemoryStream inputDataStream = new MemoryStream())
			{
				using (BinaryWriter writer = new BinaryWriter(inputDataStream))
				...
				AutomationRequestInput input = new AutomationRequestInput(AutomationRequestType.RunCustomTool, inputDataStream.GetBuffer());
