...
TSharedRef<SWidget> FSwitchboardListenerMainWindow::CreateOutputLog()
{
	...
	OutputLogCreationParams.DefaultCategorySelection.Emplace(LogSwitchboard.GetCategoryName(), true);
	OutputLogCreationParams.DefaultCategorySelection.Emplace(LogSwitchboardProtocol.GetCategoryName(), false);
