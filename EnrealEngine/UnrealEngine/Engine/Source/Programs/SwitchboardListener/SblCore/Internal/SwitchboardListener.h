...
#if PLATFORM_WINDOWS
	using FFlipModeMonitorSessionId = uint8;
	static constexpr FFlipModeMonitorSessionId InvalidFlipModeSessionId = FFlipModeMonitorSessionId(-1);
	static constexpr FFlipModeMonitorSessionId MaxFlipModeMonitorSessions = 16;
	void HarvestExistingFlipModeSessions();
	bool EnsureFlipModeSessionAvailable(FFlipModeMonitorSessionId SessionId, bool* bOutStoppedSession = nullptr);
	FFlipModeMonitorSessionId AllocFlipModeMonitorSessionId();
	void FreeFlipModeMonitorSessionId(FFlipModeMonitorSessionId SessionId);
	FString MakeFlipModeMonitorSessionName(FFlipModeMonitorSessionId SessionId);
...
#if PLATFORM_WINDOWS
	TBitArray<> RunningFlipModeSessions;
#endif
