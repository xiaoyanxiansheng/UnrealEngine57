...
namespace Jupiter.Implementation
{
	public class MemoryCachedContentIdStore : IContentIdStore
	{
		...
		{
			return _actualContentIdStore.GetContentIdMappingsAsync(ns, identifier, cancellationToken);
		}
		...
		{
			Task actualPutTask = _actualContentIdStore.PutAsync(ns, contentId, blobIdentifiers, contentWeight, cancellationToken);
			AddCacheEntry(ns, contentId, blobIdentifiers);
