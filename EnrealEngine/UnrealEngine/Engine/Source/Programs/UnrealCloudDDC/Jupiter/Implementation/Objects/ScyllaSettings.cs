...
public class ScyllaSettings : IValidatableObject
{
	...
	/// <summary>
	/// Can be used to disable the cleanup of unused namespaces and buckets
	/// </summary>
	public bool CleanupOldTrackedState { get; set; } = true;

	/// <summary>
	/// When enabled uses a more consistent read level for content ids which solves intermittent issues as the cost of worse performance
	/// </summary>
	public bool UseConsistentContentIdResolve { get; set; } = false;
