...
namespace CSVTools
{
	...
	{
		private static string VersionString = "3.68";
	...
	public class GraphGenerator
	{
		...
		// TODO: this would be better if merged the best points first, ie the ones where the error value is close to zero
		// Also, the approach of using only the current pass points error to compound. Ideally we want it to be computed from the original points
