...
#define EG_IDENTITY_GETUNIQUEPLAYERID_TAG IDENTITY_TAG "[getuniqueplayerid]"

#define IDENTITY_TEST_CASE(x, ...) ONLINESUBSYSTEM_TEST_CASE(x, IDENTITY_TAG __VA_ARGS__)

IDENTITY_TEST_CASE("Verify calling Identity GetUniquePlayerId with valid inputs returns the expected result(Success Case)", EG_IDENTITY_GETUNIQUEPLAYERID_TAG)
{
