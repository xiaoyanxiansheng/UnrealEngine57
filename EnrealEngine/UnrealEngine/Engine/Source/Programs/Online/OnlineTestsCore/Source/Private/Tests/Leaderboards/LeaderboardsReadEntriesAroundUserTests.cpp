...
LEADERBOARDS_TEST_CASE("Verify that ReadEntriesAroundUser succeeds and returns entries for the given board", "[MultiAccount]")
{
	...
	LeaderboardsFixture_NUsers(MoveTemp(GetLoginPipeline({ AccountIdA, AccountIdB })), AccountIds, 2)
		.EmplaceAsyncLambda([&](const FAsyncLambdaResult& Promise, const IOnlineServicesPtr& Services) { ReadEntriesAroundUser_2UsersFixture(Promise, Services, "Stat_Use_Set", AccountIdB, AccountIdA, Offset, Limit, LeaderboardEntries); })
		...
		.EmplaceAsyncLambda([&](const FAsyncLambdaResult& Promise, const IOnlineServicesPtr& Services) { ReadEntriesAroundUser_2UsersFixture(Promise, Services, "Stat_Use_Smallest", AccountIdA, AccountIdB, -1, 2, LeaderboardEntries); })
...
LEADERBOARDS_TEST_CASE("Verify ReadEntriesAroundUser returns a fail message if the local user is not logged in", "[MultiAccount]")
{
	...
	LeaderboardsFixture_NUsers(MoveTemp(GetLoginPipeline({ AccountId })), AccountIds, 1)
		.EmplaceAsyncLambda([&](const FAsyncLambdaResult& Promise, const IOnlineServicesPtr& Services) { ReadEntriesAroundUserFixture(Promise, Services, "Stat_Use_Set", LocalUserInvalid, AccountId, offset, limit, UE::Online::Errors::InvalidUser(), LeaderboardEntries); });
...
LEADERBOARDS_TEST_CASE("Verify ReadEntriesAroundUser returns a fail message if the given UserId is invalid", "[MultiAccount]")
{
	...
	LeaderboardsFixture_NUsers(MoveTemp(GetLoginPipeline({ LocalUser })), AccountIds, 1)
		.EmplaceAsyncLambda([&](const FAsyncLambdaResult& Promise, const IOnlineServicesPtr& Services) { ReadEntriesAroundUserFixture(Promise, Services, "Stat_Use_Set", LocalUser, AccountIdInvalid, offset, limit, UE::Online::Errors::InvalidUser(), LeaderboardEntries); });
...
LEADERBOARDS_TEST_CASE("Verify ReadEntriesAround User returns entries centered around the correct position when the given Offset is positive", "[MultiAccount]")
{
	...
	LeaderboardsFixture_NUsers(MoveTemp(GetLoginPipeline({ LocalUser, OtherPlayerB, UserPlayer, OtherPlayerC, OtherPlayerD })), AccountIds, 5)
		.EmplaceAsyncLambda([&](const FAsyncLambdaResult& Promise, const IOnlineServicesPtr& Services) { ReadEntriesAroundUser_5UsersFixture(Promise, Services, "Stat_Use_Set", { LocalUser, OtherPlayerB, UserPlayer, OtherPlayerC, OtherPlayerD }, offset, limit, LeaderboardEntries); })
		.EmplaceLambda([&](const IOnlineServicesPtr& Services) { CheckEntries_2UsersRanks_Stat_Use_Set(LeaderboardEntries, OtherPlayerC, OtherPlayerD); });
...
LEADERBOARDS_TEST_CASE("Verify ReadEntriesAroundUser returns expected valid entries if the given Limit exceeds the number of existing entries before the center entry", "[MultiAccount]")
{
	...
	LeaderboardsFixture_NUsers(MoveTemp(GetLoginPipeline({ AccountId, LocalUser })), AccountIds, 2)
		.EmplaceAsyncLambda([&](const FAsyncLambdaResult& Promise, const IOnlineServicesPtr& Services) { ReadEntriesAroundUser_2UsersFixture(Promise, Services, "Stat_Use_Set", LocalUser, AccountId, offset, limit, LeaderboardEntries); })
		.EmplaceLambda([&](const IOnlineServicesPtr& Services) { CheckEntries_2Users_Stat_Use_Set(LeaderboardEntries, AccountId, LocalUser); });
...
LEADERBOARDS_TEST_CASE("Verify ReadEntriesAroundUser returns expected valid entries if the given Limit exceeds the number of existing entries after the center entry", "[MultiAccount]")
{
	...
	LeaderboardsFixture_NUsers(MoveTemp(GetLoginPipeline({ LocalUser, AccountId })), AccountIds, 2)
		.EmplaceAsyncLambda([&](const FAsyncLambdaResult& Promise, const IOnlineServicesPtr& Services) { ReadEntriesAroundUser_2UsersFixture(Promise, Services, "Stat_Use_Smallest", LocalUser, AccountId, offset, limit, LeaderboardEntries); })
		.EmplaceLambda([&](const IOnlineServicesPtr& Services) { CheckEntries_1User_Stat_Use_Smallest(LeaderboardEntries, AccountId); });
...
LEADERBOARDS_TEST_CASE("Verify ReadEntriesAroundUser returns error message if given a Limit of 0", "[MultiAccount]")
{
	...
	LeaderboardsFixture_NUsers(MoveTemp(GetLoginPipeline({ LocalUser, AccountId })), AccountIds, 2)
		.EmplaceAsyncLambda([&](const FAsyncLambdaResult& Promise, const IOnlineServicesPtr& Services) {ReadEntriesAroundUserFixture(Promise, Services, "Stat_Use_Set", LocalUser, AccountId, offset, limit, UE::Online::Errors::InvalidParams(), LeaderboardEntries); });
...
LEADERBOARDS_TEST_CASE("Verify ReadEntriesAroundUser returns expected valid entries if  given the Offset=-1 and Limit=2", "[MultiAccount]")
{
	...
	LeaderboardsFixture_NUsers(MoveTemp(GetLoginPipeline({ OtherPlayerA, OtherPlayerB, UserPlayer, OtherPlayerC, OtherPlayerD })), AccountIds, 5)
		.EmplaceAsyncLambda([&](const FAsyncLambdaResult& Promise, const IOnlineServicesPtr& Services) { ReadEntriesAroundUser_5UsersFixture(Promise, Services, "Stat_Use_Set", { OtherPlayerA, OtherPlayerB, UserPlayer, OtherPlayerC, OtherPlayerD }, offset, limit, LeaderboardEntries); })
		.EmplaceLambda([&](const IOnlineServicesPtr& Services) { CheckEntries_2UsersRanks_Stat_Use_Set_Index_Moved_Up(LeaderboardEntries, UserPlayer, OtherPlayerC); });
