...
#define TITLE_FILE_GET_ENUMERATED_SKIP_EOS_PLATFORM_FAULT_TAG "[getenumeratedfiles][skip_eos_platform_fault]"
...
TITLE_FILE_TEST_CASE("GetEnumeratedFiles - Invalid state", TITLE_FILE_GET_ENUMERATED_SKIP_EOS_PLATFORM_FAULT_TAG)
{
	FAccountId AccountId;
	FTestPipeline& Pipe = GetLoginPipeline({ AccountId });
