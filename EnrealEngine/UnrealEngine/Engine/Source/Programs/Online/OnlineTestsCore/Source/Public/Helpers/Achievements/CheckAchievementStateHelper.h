...
namespace UE::Online
{
	inline void CheckAchievementState_Fixture(const FAsyncLambdaResult& Promise, const IOnlineServicesPtr& Services, const FAccountId& AccountId, const FString& AchievementId, float AchievementProgress)
	{
