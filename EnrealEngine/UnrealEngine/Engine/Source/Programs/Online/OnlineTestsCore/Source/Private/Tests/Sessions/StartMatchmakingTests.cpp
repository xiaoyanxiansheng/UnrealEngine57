...
#define EG_SESSIONS_STARTMATCHMAKING_SKIP_TAG SESSIONS_TAG "[startmatchmaking][startmatchmakingskip]"
...
SESSIONS_TEST_CASE("If I call StartMatchmaking with valid data, the operation will end with NotImplemented error for EOS and NULL", EG_SESSIONS_STARTMATCHMAKING_SKIP_TAG)
{
	FAccountId AccountId;
