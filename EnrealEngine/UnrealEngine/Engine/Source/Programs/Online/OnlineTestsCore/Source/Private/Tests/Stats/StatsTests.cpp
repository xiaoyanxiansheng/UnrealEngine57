...
FTestPipeline&& StatsFixture_1User_With_InitialRandomStats(const OnlineTestBase& InOnlineTestBase, FAccountId& AccountId)
{
	return InOnlineTestBase.GetLoginPipeline({ AccountId })
		.EmplaceAsyncLambda([&AccountId](FAsyncLambdaResult Promise, const IOnlineServicesPtr& Services) {
...
void QueryStats_Fixture(FAsyncLambdaResult Promise, const IOnlineServicesPtr& Services, const FAccountId& LocalAccountId, const FAccountId& TargetAccountId, const TArray<FString>& StatNames, TMap<FString, FStatValue>& OutStats)
{
...
STATS_TEST_CASE("UpdateStats modify method work as expected", "[tmpExcludedStats]")
{
	...
	StatsFixture_1User_With_InitialRandomStats(*this, AccountId)
		.EmplaceAsyncLambda([&AccountId, &InitialStats](FAsyncLambdaResult Promise, const IOnlineServicesPtr& Services) {
		...
		.EmplaceAsyncLambda([&AccountId, &InitialStats, &Expected_Stat_Use_Set](FAsyncLambdaResult Promise, const IOnlineServicesPtr& Services) {
		...
		.EmplaceAsyncLambda([&AccountId, &UpdatedStats](FAsyncLambdaResult Promise, const IOnlineServicesPtr& Services) {
		...
		.EmplaceLambda([&AccountId, &InitialStats, &UpdatedStats, &Expected_Stat_Use_Set](const IOnlineServicesPtr& Services) {
		...
		.EmplaceLambda([&InitialStats, &UpdatedStats](const IOnlineServicesPtr& Services) {
...
STATS_TEST_CASE("ResetStats works or not implemented", "[tmpExcludedStats]")
{
	...
	StatsFixture_1User_With_InitialRandomStats(*this, AccountId)
		.EmplaceAsyncLambda([&AccountId, &UserStats](FAsyncLambdaResult Promise, const IOnlineServicesPtr& Services) {
		...
		.EmplaceLambda([&UserStats](const IOnlineServicesPtr& Services) {
		...
		.EmplaceAsyncLambda([&AccountId, &ImplementedStatsReset](FAsyncLambdaResult Promise, const IOnlineServicesPtr& Services) {
		...
		.EmplaceAsyncLambda([&AccountId, &UserStats, &ImplementedStatsReset](FAsyncLambdaResult Promise, const IOnlineServicesPtr& Services) {
		...
		.EmplaceLambda([&UserStats, &ImplementedStatsReset](const IOnlineServicesPtr& Services) {
			if (!ImplementedStatsReset)
			{
				return;
			}
...
void BatchQueryStats_Fixture(FAsyncLambdaResult Promise, const IOnlineServicesPtr& Services, const FAccountId& LocalAccountId, const TArray<FAccountId>& AccountIds, TArray<FUserStats>& OutUsersStats)
{
...
STATS_TEST_CASE("BatchUpdateAndQuery with 2 users", "[MultiAccount]")
{
	...
	GetLoginPipeline({ AccountIdA, AccountIdB })
		.EmplaceAsyncLambda([&AccountIdA, &Expected_Stat_Use_Set_A](FAsyncLambdaResult Promise, const IOnlineServicesPtr& Services) {
			TArray<FUserStats> UpdateUsersStats{
		...
		.EmplaceAsyncLambda([&AccountIdB, &Expected_Stat_Use_Set_B](FAsyncLambdaResult Promise, const IOnlineServicesPtr& Services) {
			TArray<FUserStats> UpdateUsersStats{
		...
		.EmplaceAsyncLambda([&AccountIdA, &AccountIdB, &UpdatedUsersStats](FAsyncLambdaResult Promise, const IOnlineServicesPtr& Services) {
			BatchQueryStats_Fixture(MoveTemp(Promise), Services, AccountIdA, { AccountIdA, AccountIdB }, UpdatedUsersStats);
		})
		.EmplaceLambda([&AccountIdA, &AccountIdB, &UpdatedUsersStats, &Expected_Stat_Use_Set_A, &Expected_Stat_Use_Set_B](const IOnlineServicesPtr& Services) {
