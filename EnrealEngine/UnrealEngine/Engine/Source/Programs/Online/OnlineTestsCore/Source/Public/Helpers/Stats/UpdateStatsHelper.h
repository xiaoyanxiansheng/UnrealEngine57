...
inline void UpdateStats_Fixture(FAsyncLambdaResult Promise, const IOnlineServicesPtr& Services, const FAccountId& AccountId,  const TArray<FUserStats>& UpdateUsersStats)
{
