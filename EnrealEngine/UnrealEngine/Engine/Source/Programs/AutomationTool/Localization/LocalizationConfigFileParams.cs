...
namespace EpicGames.Localization
{
	...
	public class GatherTextFromMetaDataParams
	{
		...
		public static GatherTextFromMetaDataParams CreateDefault(string localizationTargetRootDirectory, LocalizationTargetDescriptorLoadingPolicy localizationPolicy)
		{
			GatherTextFromMetaDataParams gatherTextFromMetaData = new GatherTextFromMetaDataParams();

			gatherTextFromMetaData.IncludePathFilters.Add(Path.Combine(localizationTargetRootDirectory, "Source",  "*"));

			if (localizationPolicy == LocalizationTargetDescriptorLoadingPolicy.PropertyNames)
			{
				gatherTextFromMetaData.InputKeys.Add("DisplayName");
				gatherTextFromMetaData.OutputKeys.Add("\"{FieldPath}\"");
				gatherTextFromMetaData.OutputNamespaces.Add("UObjectDisplayNames");
			}

			if (localizationPolicy == LocalizationTargetDescriptorLoadingPolicy.ToolTips)
			{
				gatherTextFromMetaData.InputKeys.Add("ToolTip");
				gatherTextFromMetaData.InputKeys.Add("ShortTooltip");
				gatherTextFromMetaData.OutputKeys.Add("\"{FieldPath}\"");
				gatherTextFromMetaData.OutputKeys.Add("\"{FieldPath}\"");
				gatherTextFromMetaData.OutputNamespaces.Add("UObjectToolTips");
				gatherTextFromMetaData.OutputNamespaces.Add("UObjectShortToolTips");
			}

			gatherTextFromMetaData.bShouldGatherFromEditorOnlyData = true;
			return gatherTextFromMetaData;
		}
	}
