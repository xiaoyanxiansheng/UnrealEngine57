...
namespace EpicGames.Localization
{
	public class LocalizationConfigFileBuilder
	{
		...
		public void AddGatherTextFromMetadataSection(GatherTextFromMetaDataParams gatherTextParams)
		{
			LocalizationConfigFileSection configSection = _configFile.FindOrAddSection($"GatherTextStep{_gatherTextStepCount}");
			++_gatherTextStepCount;
			...
			configSection.AddValues("ModulesToPreload", gatherTextParams.ModulesToPreload.ToArray());
			configSection.AddValues("IncludePathFilters", gatherTextParams.IncludePathFilters.ToArray());
			configSection.AddValues("ExcludePathFilters", gatherTextParams.ExcludePathFilters.ToArray());

			configSection.AddValues("FieldTypesToInclude", gatherTextParams.FieldTypesToInclude.ToArray());
			configSection.AddValues("FieldOwnerTypesToInclude", gatherTextParams.FieldOwnerTypesToInclude.ToArray());
			
			configSection.AddValues("InputKeys", gatherTextParams.InputKeys.ToArray());
			configSection.AddValues("OutputKeys", gatherTextParams.OutputKeys.ToArray());

			configSection.AddValues("InputNamespaces", gatherTextParams.InputNamespaceses.ToArray());
			configSection.AddValues("OutputNamespaces", gatherTextParams.OutputNamespaces.ToArray());
