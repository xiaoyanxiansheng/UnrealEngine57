...
namespace Gauntlet
{
	public class AndroidBuild : IBuild
	{
		...
		public bool UseAFSWithoutToken { get; protected set; }

		public bool UsesPublicLogs { get; protected set; }

		public AndroidBuild(UnrealTargetConfiguration InConfig, string InAndroidPackageName, string InApkPath, Dictionary<string, string> InFilesToInstall, BuildFlags InFlags, bool InIs32Bit, bool bInUsesExternalFilesDir, bool bInUsesPublicLogs, bool bInUseAFSWithoutToken = false)
		{
			...
			UseAFSWithoutToken = bInUseAFSWithoutToken;
		}
