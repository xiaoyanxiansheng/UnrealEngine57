...
namespace Gauntlet
{
	...
	public class GauntletCommandLine
	{
		...
		public static readonly Regex CommandlineOptionRegex = new Regex(@"-(?<option>-?[\w\d.:!\[\]\/\\?-]+)(=(?<value>(""(?:(?:\\""|[^""])+)"")|(?:\S+)))?", RegexOptions.Compiled);
		...
		public void AddRawCommandline(string InRawCommandline, bool bOverrideExistingValues = true)
		{
			...
			MatchCollection Matches = CommandlineOptionRegex.Matches(InRawCommandline);
	...
	/// <summary>
	/// Delegate for role device pre-configuration
	/// </summary>
	public delegate void PreConfigureDeviceHandler(ITargetDevice Device, UnrealSessionRole Role);
	...
	public class UnrealTestRole
	{
		...
		/// <summary>
		/// Allows for individual roles to configure their associated Target device before build installation
		/// </summary>
		public PreConfigureDeviceHandler PreConfigureDevice;

		/// <summary>
		/// Allows for individual roles to configure their associated Target device after build installation and AppInstall creation
		/// </summary>
	...
	public class UnrealTestConfiguration : IConfigOption<UnrealAppConfig>
	{
		...
		/// <summary>
		/// Whether ensures should be ignored from report
		/// </summary>
		[AutoParam(false)]
		public bool IgnoreEnsures { get; set; }
		...
		/// <summary>
		/// Apply a tag filter, restricting tests to run
		/// </summary>
		[AutoParam]
