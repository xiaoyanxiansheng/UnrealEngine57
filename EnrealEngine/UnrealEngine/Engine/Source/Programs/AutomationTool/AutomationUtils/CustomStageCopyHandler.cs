...
public abstract class CustomStageCopyHandler
{
	...
	public virtual void Init(ConfigHierarchy InPlatformEngineConfig)
	{
		PlatformEngineConfig = InPlatformEngineConfig;
	}

	private static Dictionary<string, Type> HandlerRegistry = null;

	/// <summary>
	/// Platform engine config hierarchy for the platform being staged.
	/// </summary>
	protected ConfigHierarchy PlatformEngineConfig = null;
}
