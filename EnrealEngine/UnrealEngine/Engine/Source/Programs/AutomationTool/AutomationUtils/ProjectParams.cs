...
namespace AutomationTool
{
	...
	[ParamHelp("snapshot", "Imports the most recently published project snapshot (if cooking, this forces the use of -forcerecook=false)", ParamType = typeof(bool))]
	...
	public class ProjectParams
	{
		...
		public ProjectParams(ProjectParams InParams)
		{
			...
			this.DLCSkipNamedPak = InParams.DLCSkipNamedPak;
			...
			this.StageOnlyCookedLocalizationForGameFeatures = InParams.StageOnlyCookedLocalizationForGameFeatures;
			...
			this.SkipCookingErrorSummary = InParams.SkipCookingErrorSummary;
			...
			this.ApplyIoStoreOnDemand = InParams.ApplyIoStoreOnDemand;
			this.CreateDefaultOnDemandPakRule = InParams.CreateDefaultOnDemandPakRule;
			this.GenerateOptionalPakForNonChunkedBuild = InParams.GenerateOptionalPakForNonChunkedBuild;
			this.GenerateOnDemandPakForNonChunkedBuild = InParams.GenerateOnDemandPakForNonChunkedBuild;
		...
		public ProjectParams(			
			...
			bool? SkipCookingErrorSummary = null,
			...
			bool? DLCSkipNamedPak = null,
			bool? StageOnlyCookedLocalizationForGameFeatures = null,
			...
			string Upload = null,
			bool? CreateDefaultOnDemandPakRule = null,
			bool? GenerateOptionalPakForNonChunkedBuild = null,
			bool? GenerateOnDemandPakForNonChunkedBuild = null,
			...
			)
		{
			...
			this.DLCSkipNamedPak = GetParamValueIfNotSpecified(Command, DLCSkipNamedPak, this.DLCSkipNamedPak, "DLCSkipNamedPak");
			...
			this.StageOnlyCookedLocalizationForGameFeatures = GetParamValueIfNotSpecified(Command, StageOnlyCookedLocalizationForGameFeatures, this.StageOnlyCookedLocalizationForGameFeatures, "StageOnlyCookedLocalizationForGameFeatures");
			...
			this.SkipCookingErrorSummary = GetParamValueIfNotSpecified(Command, SkipCookingErrorSummary, this.SkipCookingErrorSummary, "SkipCookingErrorSummary");
			...
			this.CreateDefaultOnDemandPakRule = GetParamValueIfNotSpecified(Command, CreateDefaultOnDemandPakRule, false, "CreateDefaultOnDemandPakRule") || this.ApplyIoStoreOnDemand;

			this.GenerateOptionalPakForNonChunkedBuild = GetParamValueIfNotSpecified(Command, GenerateOptionalPakForNonChunkedBuild, false, "GenerateOptionalPakForNonChunkedBuild");
			this.GenerateOnDemandPakForNonChunkedBuild = GetParamValueIfNotSpecified(Command, GenerateOnDemandPakForNonChunkedBuild, false, "GenerateOnDemandPakForNonChunkedBuild");
		...
		/// </summary>
		[Help("StageTagMappingConfigFiles", "Include all tag mapping ini files when staging")]
		public bool StageTagMappingConfigFiles;
		...
		/// </summary>
		public bool DLCSkipNamedPak = false;

		/// <summary>
		/// When true only the GameFeaturePlugins that are cooked will have thier GameFeaturePlugin data staged.
		/// This check is performed by looking for a cooked GameFeatureData asset within the GameFeaturePlugin expected folder.
		/// </summary>
		public bool StageOnlyCookedLocalizationForGameFeatures = false;
		...
		[Help("SkipCookingErrorSummary", "Skips error summary when cooking")]
		public bool SkipCookingErrorSummary;
		...
		[Help("createdefaultondemandpakrule", "Creates a default pakfile rule for OnDemand data if no other such rule exists. The default rule will include all bulkdata types.")]
		public bool CreateDefaultOnDemandPakRule { get; }

		[Help("GenerateOptionalPakForNonChunkedBuild", "When true non chunked builds will attempt to generate an optional pak for optional bulk data.")]
		public bool GenerateOptionalPakForNonChunkedBuild { get; }

		[Help("GenerateOnDemandPakForNonChunkedBuild", "When true non chunked builds will attempt to generate an OnDemand pak. Will also force ApplyIoStoreOnDemand to true")]
		public bool GenerateOnDemandPakForNonChunkedBuild { get; }
		...
		public virtual void ValidateAndLog()
		{
			...
			if (!bLogged)
			{
				...
				Logger.LogDebug("SkipCookingErrorSummary={SkipCookingErrorSummary}", SkipCookingErrorSummary);
