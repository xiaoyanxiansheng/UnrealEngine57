...
namespace EpicGames.MCP.Automation
{
	...
	public abstract class BuildPatchToolBase
	{
		...
		public class BinaryDeltaOptimizeOptions
		{
			...
			/// </summary>
			public string CloudDir;
			// Byte window size for patch matching. Match spans smaller than this will not be found. Min 1kb, defaults to 8kb.
			public int ScanWindowSize=0;
		}
	...
	public abstract class CloudStorageBase
	{
		...
		/// <param name="bGzip">If true, the data to be uploaded will be gzipped, and the appropraite Content-Encoding value set on the uploaded file in S3.</param>
		...
		abstract public PostFileResult PostFile(string Container, string Identifier, byte[] Contents, string ContentType = null, bool bGzip = false, bool bOverwrite = true, bool bMakePublic = false, bool bQuiet = false, IDictionary<string, object> Metadata = null);
		...
		/// <param name="Metadata">If not null, key-value pairs of metadata to be applied to the object.</param>
		/// <returns>A PostFileResult indicating whether the call was successful, and the URL to the uploaded file.</returns>
		abstract public Task<PostFileResult> PostFileAsync(string Container, string Identifier, byte[] Contents, string ContentType = null, bool bGzip = false, bool bOverwrite = true, bool bMakePublic = false, bool bQuiet = false, IDictionary<string, object> Metadata = null);
		...
		/// <param name="Metadata">If not null, key-value pairs of metadata to be applied to the object.</param>
		/// <returns>A PostFileResult indicating whether the call was successful, and the URL to the uploaded file.</returns>
		abstract public PostFileResult PostFile(string Container, string Identifier, string SourceFilePath, string ContentType = null, bool bGzip = false, bool bOverwrite = true, bool bMakePublic = false, bool bQuiet = false, IDictionary<string, object> Metadata = null);
		...
		/// <param name="Metadata">If not null, key-value pairs of metadata to be applied to the object.</param>
		/// <returns>A PostFileResult indicating whether the call was successful, and the URL to the uploaded file.</returns>
		abstract public Task<PostFileResult> PostFileAsync(string Container, string Identifier, string SourceFilePath, string ContentType = null, bool bGzip = false, bool bOverwrite = true, bool bMakePublic = false, bool bQuiet = false, IDictionary<string, object> Metadata = null);
		...
		/// <param name="Metadata">If not null, key-value pairs of metadata to be applied to the object.</param>
		/// <returns>A PostFileResult indicating whether the call was successful, and the URL to the uploaded file.</returns>
		public PostFileResult PostMultipartFile(string Container, string Identifier, string SourceFilePath, int NumConcurrentConnections, decimal PartSizeMegabytes = 5.0m, string ContentType = null, bool bGzip = false, bool bOverwrite = true, bool bMakePublic = false, bool bQuiet = false, IDictionary<string, object> Metadata = null)
		{
			return PostMultipartFileAsync(Container, Identifier, SourceFilePath, NumConcurrentConnections, PartSizeMegabytes, ContentType, bGzip, bOverwrite, bMakePublic, bQuiet, Metadata).Result;
		}
		...
		/// <param name="Metadata">If not null, key-value pairs of metadata to be applied to the object.</param>
		/// <returns>A PostFileResult indicating whether the call was successful, and the URL to the uploaded file.</returns>
		abstract public Task<PostFileResult> PostMultipartFileAsync(string Container, string Identifier, string SourceFilePath, int NumConcurrentConnections, decimal PartSizeMegabytes = 5.0m, string ContentType = null, bool bGzip = false, bool bOverwrite = true, bool bMakePublic = false, bool bQuiet = false, IDictionary<string, object> Metadata = null);
