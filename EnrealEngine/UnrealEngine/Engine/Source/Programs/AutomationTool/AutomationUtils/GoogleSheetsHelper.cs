...
namespace SheetsHelper
{
	...
	public class SpreadSheetWrapper
	{
        ...
        public SheetWrapper GetSheetByName(string Title)
		{
			...
			var Sheet = SourceSpreadsheet.Sheets.FirstOrDefault(S => S.Properties.Title == Title);
		...
		public bool SheetExists(string Title)
		{
			Refresh();
		...
		public void DeleteSheet(string Title)
		{
			...
			Sheet Sheet = SourceSpreadsheet.Sheets.FirstOrDefault(S => S.Properties.Title == Title);

			if (Sheet != null)
			{
				var Request = new Request();
				Request.DeleteSheet = new DeleteSheetRequest();
				Request.DeleteSheet.SheetId = Sheet.Properties.SheetId;
	...
	public class SheetWrapper
	{
		...
		public void Refresh()
		{
			...
			SourceSheet = Response.Sheets.FirstOrDefault(S => S.Properties.SheetId == SheetID);
		}
		...
		public void SetRow(List<IList<object>> Fields)
		{
			ValueRange EntryRange = new ValueRange();
			EntryRange.MajorDimension = "ROWS";
			EntryRange.Values = Fields;
			EntryRange.Range = "A1";
