...
#pragma warning restore CS1591
	...
	public class BgScriptSchema
	{
		...
		static XmlSchemaType CreateDiagnosticType(ScriptSchemaStandardType standardType)
		{
			...
			propertyType.Attributes.Add(CreateSchemaAttribute("If", ScriptSchemaStandardType.BalancedString, XmlSchemaUse.Optional));
			propertyType.Attributes.Add(CreateSchemaAttribute("ReportOnExecution", ScriptSchemaStandardType.Boolean, XmlSchemaUse.Optional));
			propertyType.Attributes.Add(CreateSchemaAttribute("ReportOnNodes", ScriptSchemaStandardType.NameList, XmlSchemaUse.Optional));
			return propertyType;
		}
