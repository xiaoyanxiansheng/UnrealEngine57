...
namespace AutomationScripts
{
	...
	public partial class Project : CommandUtils
	{
		...
		{
			IProcessResult CustomResult = null;
			foreach (CustomStagingHandler PackagingHandler in SC.CustomStagingHandlers)
			{
				CustomResult = PackagingHandler.TryRunClient(ClientRunFlags, ClientApp, ClientCmdLine, Params, SC);
			...
			if (CustomResult == null)
			{
				CustomResult = SC.CustomDeployment?.RunClient(ClientRunFlags, ClientApp, ClientCmdLine, Params, SC);
			}
