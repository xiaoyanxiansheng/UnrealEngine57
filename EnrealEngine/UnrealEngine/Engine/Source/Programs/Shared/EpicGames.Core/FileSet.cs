...
namespace EpicGames.Core
{
	...
	public abstract class FileSet : IEnumerable<FileReference>
	{
		...
		{
			Dictionary<FileReference, FileReference> targetToSourceFile = [];
	...
	{
		readonly Dictionary<string, FileReference> _files = [];
		readonly Dictionary<string, FileSetFromFiles> _subTrees = [];
