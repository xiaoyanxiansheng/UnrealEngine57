...
#pragma warning restore CA1069 // Enums values should not be duplicated
	...
	class DefaultLogger : ILogger, IDisposable
	{
		...
		public DefaultLogger()
		{
			...
			bool bJsonStdOut = Environment.CommandLine.Contains("JsonStdOut", StringComparison.InvariantCulture);
			string? envVar = Environment.GetEnvironmentVariable("UE_LOG_JSON_TO_STDOUT");
			if(bJsonStdOut || envVar != null && Int32.TryParse(envVar, out int value) && value != 0)
			{
