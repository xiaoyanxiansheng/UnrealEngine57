...
namespace EpicGames.Core
{
	...
	public class DirectoryReference : FileSystemReference, IEquatable<DirectoryReference>, IComparable<DirectoryReference>
	{
		...
		public static DirectoryReference Combine(DirectoryReference baseDirectory, params string[] fragments) => new(CombineStrings(baseDirectory, fragments), Sanitize.None);
		...
		public static DirectoryReference? FromString(string? directoryName) => String.IsNullOrEmpty(directoryName) ? null : new(directoryName);
