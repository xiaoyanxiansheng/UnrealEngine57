...
namespace EpicGames.Core
{
	...
	/// <summary>
	/// Extra flags for verse classes and structures
	/// 
	/// Keep these flags in sync with VVMVerseClassFlags.h
	/// </summary>
	[Flags]
	public enum EVerseClassFlags : uint
	{
		None = 0x00000000,
		NativeBound = 0x00000001,
		UniversallyAccessible = 0x00000002,   // The class is accessible from any Verse path, and is in a package with a public scope.
		Concrete = 0x00000004,                // The class can be instantiated without explicitly setting any properties
		Module = 0x00000008,                  // This class represents a Verse module
		UHTNative = 0x00000010,               // This class was created by UHT
		Tuple = 0x00000020,                   // This class represents a tuple
		EpicInternal = 0x00000040,            // This class is epic_internal
		HasInstancedSemantics = 0x00000080,   // This class is using explicit instanced reference semantics (backcompat)
		FinalSuper = 0x00000100,              // This class has a <final_super> attribute
		Castable = 0x00000200,                // This class has a <castable> attribute
		EpicInternalConstructor = 0x00000400, // This class' has a <castable> attribute's constructor is epic_internal
		Persistable = 0x00000800u,            // This class has a <persistable> attribute
		Parametric = 0x00001000u,             // This class definition is local to a function, i.e. is parametric
		VNIEpicInternal = 0x00002000u,        // Similar to EpicInternal, but the version of the flag previously generated by VNI

		// @TODO: this should be a per-function flag; a class flag is not granular enough
		ErrInoperable = 0x40000000, // One or more of the class's functions contain mis-linked (malformed) bytecode
		ErrIncomplete = 0x80000000, // The class layout is malformed (missing super, illformed data-member, etc.)

		Err = (ErrIncomplete | ErrInoperable)
	};
}
