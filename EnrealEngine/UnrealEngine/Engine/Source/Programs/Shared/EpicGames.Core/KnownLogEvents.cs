...
#pragma warning disable CA1707 // Identifiers should not contain underscores
	...
	public static class KnownLogEvents
	{
		...
		/// <summary>
		/// Generic timeout message emmitted by UBA
		/// </summary>
		public static EventId Systemic_UbaCacheResponseTimeout { get; } = new EventId(770);
		...
		/// World Leak Error
		/// </summary>
		public static EventId WorldLeak { get; } = new EventId(900);
