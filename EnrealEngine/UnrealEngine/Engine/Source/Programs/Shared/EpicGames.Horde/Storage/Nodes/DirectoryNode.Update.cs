...
namespace EpicGames.Horde.Storage.Nodes
{
	...
	public static class DirectoryNodeUpdateExtensions
	{
		...
		/// </summary>
		public static async Task<IHashedBlobRef<DirectoryNode>> AddFilesAsync(this IBlobWriter writer, DirectoryReference baseDir, ChunkingOptions? options = null, IProgress<IUpdateStats>? progress = null, CancellationToken cancellationToken = default)
		{
		...
		/// Writes a tree of files to a storage writer
		/// </summary>
		public static async Task<IHashedBlobRef<DirectoryNode>> AddFilesAsync(this IBlobWriter writer, DirectoryInfo baseDir, IReadOnlyList<FileInfo> files, ChunkingOptions? options = null, IProgress<IUpdateStats>? progress = null, CancellationToken cancellationToken = default)
		{
			DirectoryNode outputNode = new DirectoryNode();
		...
		/// Writes a tree of files to a storage writer
		/// </summary>
		public static async Task<IHashedBlobRef<DirectoryNode>> AddFilesAsync(this IBlobWriter writer, DirectoryReference baseDir, IReadOnlyList<FileReference> files, ChunkingOptions? options = null, IProgress<IUpdateStats>? progress = null, CancellationToken cancellationToken = default)
		{
			DirectoryNode outputNode = new DirectoryNode();
			await outputNode.AddFilesAsync(baseDir, files, writer, options, progress, cancellationToken);
			return await writer.WriteBlobAsync(outputNode, cancellationToken: cancellationToken);
