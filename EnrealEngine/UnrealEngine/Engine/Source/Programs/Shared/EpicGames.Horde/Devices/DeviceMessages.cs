...
namespace EpicGames.Horde.Devices
{
	...
	/// <summary>
	/// Device tags request object
	/// </summary>
	public class DeviceTagsRequest
	{
		/// <summary>
		/// Only devices with these tags will be considered for reservation
		/// </summary>
		public List<string>? RequiredTags { get; set; }

		/// <summary>
		/// Devices with these tags will be preferred over devices without them, but are not explicitly required
		/// </summary>
		public List<string>? PreferredTags { get; set; }

		/// <summary>
		/// Devices with these tags will be considered, but only as a last resort
		/// </summary>
		public List<string>? UndesiredTags { get; set; }

		/// <summary>
		/// Devices with these tags will not be considered for reservation
		/// </summary>
		public List<string>? BlockedTags { get; set; }

		/// <summary>
		/// Returns any duplicate tag entries
		/// </summary>
		public HashSet<string> GetDuplicateEntries() 
		{
			List<List<string>?> tagSets = new List<List<string>?>() { RequiredTags, PreferredTags, UndesiredTags, BlockedTags };
			HashSet<string> seenTags = new HashSet<string>();
			HashSet<string> duplicateTags = new HashSet<string>();

			foreach (List<string>? set in tagSets)
			{
				if (set == null)
				{
					continue;
	...
	public class DeviceReservationRequest
	{
		...
		/// <summary>
		/// Desired device tags for this device
		/// </summary>
		public DeviceTagsRequest? Tags { get; set; } = null;
	}
	...
	public class LegacyCreateReservationRequest
	{
		...
		/// <summary>
		/// Desired metadata of the device
		/// </summary>
		public DeviceTagsRequest? Tags { get; set; } = null;
	}
