...
namespace EpicGames.Horde.Compute.Clients
{
	...
	public sealed class LocalComputeClient : IComputeClient, IAsyncDisposable
	{
		...
		/// <inheritdoc/>
		public Task<IComputeLease?> TryAssignWorkerAsync(ClusterId? clusterId, Requirements? requirements, string? requestId, ConnectionMetadataRequest? connection, bool? useUbaCache, ILogger logger, CancellationToken cancellationToken)
		{
