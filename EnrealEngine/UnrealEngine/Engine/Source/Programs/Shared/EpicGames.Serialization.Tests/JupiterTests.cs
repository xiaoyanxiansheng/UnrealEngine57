...
namespace EpicGames.Serialization.Tests
{
	...
	public class JupiterTests
	{
		...
		public void BuildObject()
		{
			...
			List<CbField> buildActionFields = [.. o];
			...
			List<CbField> constantsFields = [.. buildActionFields[1]];
			...
			List<CbField> inputsFields = [.. buildActionFields[2]];
		...
		public void ReferenceOutput()
		{
			...
			List<CbField> payloadFields = [.. payloads];
		...
		public void WriteArray()
		{
			...
			List<CbField> fields = [.. o];
			Assert.AreEqual(1, fields.Count);
			CbField? needs = o["needs"];
			List<CbField> blobList = [.. needs!.AsArray()];
