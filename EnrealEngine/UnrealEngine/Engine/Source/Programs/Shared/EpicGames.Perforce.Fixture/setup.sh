...
export P4CLIENT=generate-fixture-data-main
...
# Create alternative release stream
p4 stream -i << EOF
Stream: //Foo/Release
Owner:  test.user
Name:   Release
...
export P4CLIENT=generate-fixture-data-release
export CLIENT_ROOT=/tmp/${P4CLIENT}
p4 client -i << EOF
Client: ${P4CLIENT}
Root: ${CLIENT_ROOT}
...
# Changelist #10
p4 populate -d "Populate from CL 5" //Foo/Main/...@5 //Foo/Release/...
p4 sync

# Changelist #11
p4 edit main.cpp
echo "This is change main.cpp #2 in //Foo/Release" > $CLIENT_ROOT/main.cpp
echo "This is change release.cpp #1 in //Foo/Release" > $CLIENT_ROOT/release.cpp && p4 add $CLIENT_ROOT/release.cpp
p4 submit -d "Improvements to //Foo/Release"
