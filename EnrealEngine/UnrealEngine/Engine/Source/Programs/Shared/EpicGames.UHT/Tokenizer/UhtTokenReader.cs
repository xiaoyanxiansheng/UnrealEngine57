...
namespace EpicGames.UHT.Tokenizer
{
	...
	public class UhtTokenList
	{
		...
		/// <summary>
		/// Return the last token list entry
		/// </summary>
		public UhtTokenList Last
		{
			get 
			{
				UhtTokenList last = this;
		...
		/// <summary>
		/// Remap the last identifier
		/// </summary>
		/// <param name="config">Configuration containing remapping information</param>
		public void RedirectTypeIdentifier(IUhtConfig config)
		{
			UhtTokenList last = Last;
			UhtToken scratch = last.Token;
			config.RedirectTypeIdentifier(ref scratch);
			last.Token = scratch;
		}
