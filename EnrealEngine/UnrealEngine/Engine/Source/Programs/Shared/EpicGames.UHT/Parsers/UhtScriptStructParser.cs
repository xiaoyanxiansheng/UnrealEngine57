...
namespace EpicGames.UHT.Parsers
{
	...
	public static class UhtScriptStructParser
	{
		...
		{
			UhtScriptStruct scriptStruct = new(parentScope.HeaderFile, parentScope.HeaderParser.GetNamespace(), parentScope.ScopeType, keywordToken.InputLine);
			{
...

				{
					...
					scriptStruct.DefineScope |= compilerDirective.GetDefaultDefineScopes();
