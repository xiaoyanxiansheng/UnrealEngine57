...
namespace EpicGames.UHT.Types
{
	...
	public class UhtEnumProperty : UhtProperty
	{
		...
		{
			UnderlyingProperty?.AppendMetaDataDecl(builder, context, name, GetNameSuffix(nameSuffix, "_Underlying"), tabs);
		...
		public override StringBuilder AppendConstInitMemberDecl(StringBuilder builder, IUhtPropertyMemberContext context, string name, string nameSuffix, int tabs)
		{
			if (UnderlyingProperty != null)
			{
				builder.AppendConstInitMemberDecl(UnderlyingProperty, context, name, GetNameSuffix(nameSuffix, "_Underlying"), tabs);
			}
		...
		public override StringBuilder AppendMemberDef(StringBuilder builder, IUhtPropertyMemberContext context, string name, string nameSuffix, string? offset, int tabs)
		{
			if (Enum.CppForm == UhtEnumCppForm.EnumClass)
			{
				...
				AppendMemberDefRef(builder, context, Enum, Exporters.CodeGen.UhtSingletonType.Registered);
		...
		public override StringBuilder AppendConstInitMemberDef(StringBuilder builder, IUhtPropertyMemberContext context, string name, string nameSuffix, Action<StringBuilder>? outerFunc, string? offset, int tabs)
		{
			if (Enum.CppForm == UhtEnumCppForm.EnumClass)
			{
				if (UnderlyingProperty != null)
				{
					builder.AppendConstInitMemberDef(UnderlyingProperty, context, name, GetNameSuffix(nameSuffix, "_Underlying"), (builder) => {
						builder.AppendConstInitMemberPtr(this, context, name, nameSuffix, tabs, "");
					}, "0", tabs);
				}
				AppendConstInitMemberDefStart(builder, context, name, nameSuffix, outerFunc, offset, tabs);
				builder.AppendConstInitMemberPtr(UnderlyingProperty, context, name, GetNameSuffix(nameSuffix, "_Underlying"), tabs, ", ");
				if (UnderlyingProperty == null)
				{
					builder.Append("0, ");
				}
				...
				AppendMemberDefRef(builder, context, Enum, Exporters.CodeGen.UhtSingletonType.ConstInit);
