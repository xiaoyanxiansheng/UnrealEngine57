...
namespace EpicGames.UHT.Types
{
	...
	public enum UhtEngineType
	{
		...
		/// <summary>
		/// Type is a sparse delegate (UhtFunction)
		/// </summary>
		SparseDelegate,
	...
	public static class UhtEngineTypeExtensions
	{
		...
		public static string LowercaseText(this UhtEngineType engineType)
		{
			switch (engineType)
			{
				...
				case UhtEngineType.SparseDelegate: return "sparse delegate";
				case UhtEngineType.Property: return "property";
				default:
					throw new UhtIceException("Invalid engine extended type");
			}
		...
		public static string CapitalizedText(this UhtEngineType engineType)
		{
			switch (engineType)
			{
				...
				case UhtEngineType.Function: return "Function";
				case UhtEngineType.Delegate: return "Delegate";
				case UhtEngineType.SparseDelegate: return "SparseDelegate";
				case UhtEngineType.Property: return "Property";
				default:
					throw new UhtIceException("Invalid engine extended type");
			}
		...
		public static UhtFindOptions FindOptions(this UhtEngineType engineType)
		{
			switch (engineType)
			{
				...
				case UhtEngineType.SparseDelegate: return UhtFindOptions.DelegateFunction;
	...
	public enum UhtDefineScope
	{
		...
		/// <summary>
		/// Exists inside of a WITH_VERSE_BPVM block
		/// </summary>
		VerseBPVM = 1 << 3,
	...
	public static class UhtDefineScopeExtensions
	{
		...
		public static UhtCompilerDirective GetCompilerDirective(this UhtDefineScope defineScope, UhtDefineScopeNames defineScopeNames)
		{
			switch (defineScope)
			{
				...
				case UhtDefineScope.VerseBPVM:
					return UhtCompilerDirective.WithVerseBPVM;
	...
	public abstract class UhtType : IUhtMessageSite, IUhtMessageLineNumber
	{
		...
		/// <summary>
		/// The name of the engine's class for this type i.e. Class, Function
		/// </summary>
		public abstract string EngineClassName { get; }

		/// <summary>
		/// The name of the engine's class for this type for linking with registration functions. 
		/// i.e. EngineClassName may be VerseStruct, but EngineLinkClassName may be ScriptStruct
		/// </summary>
		public virtual string EngineLinkClassName => EngineClassName;

		/// <summary>
		/// Return the runtime type of this object in the engine after parsing, when the Session
		/// has references to such types available.
		/// </summary>
		public abstract UhtClass? EngineClass { get; }
