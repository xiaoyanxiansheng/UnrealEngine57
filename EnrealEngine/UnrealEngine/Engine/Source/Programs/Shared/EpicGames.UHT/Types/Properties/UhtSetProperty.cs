...
namespace EpicGames.UHT.Types
{
	...
	public class UhtSetProperty : UhtContainerBaseProperty
	{
		...
		{
			ValueProperty.AppendMetaDataDecl(builder, context, name, GetNameSuffix(nameSuffix, "_ElementProp"), tabs);
		...
		{
			builder.AppendConstInitMemberDecl(ValueProperty, context, name, GetNameSuffix(nameSuffix, "_ElementProp"), tabs);
		...
		{
			builder.AppendConstInitMemberDef(ValueProperty, context, name, GetNameSuffix(nameSuffix, "_ElementProp"), 
			...
			ValueProperty.AppendConstInitMemberPtr(builder, context, name, GetNameSuffix(nameSuffix, "_ElementProp"), tabs).Append(", ");
			builder.Append("sizeof(").AppendPropertyText(ValueProperty, UhtPropertyTextType.Generic).Append("), ");
			builder.Append("alignof(").AppendPropertyText(ValueProperty, UhtPropertyTextType.Generic).Append("), ");
