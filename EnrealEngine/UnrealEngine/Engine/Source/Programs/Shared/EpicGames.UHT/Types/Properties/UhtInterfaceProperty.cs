...
namespace EpicGames.UHT.Types
{
	...
	public class UhtInterfaceProperty : UhtProperty
	{
		...
		public override void CollectReferencesInternal(IUhtReferenceCollector collector, bool addForwardDeclarations, bool isTemplateProperty)
		{
			...
			collector.AddCrossModuleReference(InterfaceClass, UhtSingletonType.Unregistered);
		...
		public override StringBuilder AppendMemberDef(StringBuilder builder, IUhtPropertyMemberContext context, string name, string nameSuffix, string? offset, int tabs)
		{
			...
			AppendMemberDefRef(builder, context, InterfaceClass.AlternateObject ?? InterfaceClass, Exporters.CodeGen.UhtSingletonType.Unregistered);
		...
		public override StringBuilder AppendConstInitMemberDef(StringBuilder builder, IUhtPropertyMemberContext context, string name, string nameSuffix, Action<StringBuilder>? outerFunc, string? offset, int tabs)
		{
			...
			AppendMemberDefRef(builder, context, InterfaceClass.AlternateObject ?? InterfaceClass, Exporters.CodeGen.UhtSingletonType.ConstInit);
