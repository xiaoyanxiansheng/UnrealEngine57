	...
	GTEST_TEST(AllTraits, GeometryCollection_RigidBodies_ClusterTest_UnionClusterCollisions)
	{
		...
		for (int Frame = 0; Frame < 50; Frame++)
		{
			...
			else
			{
				...
				FVector ActualRelativeChildOffsets0 = GlobalTransform1[0].GetRelativeTransform(RootTransform).GetTranslation();
				FVector ActualRelativeChildOffsets1 = GlobalTransform1[1].GetRelativeTransform(RootTransform).GetTranslation();
				FVector ActualRelativeChildOffsets2 = GlobalTransform2[0].GetRelativeTransform(RootTransform).GetTranslation();
				FVector ActualRelativeChildOffsets3 = GlobalTransform2[1].GetRelativeTransform(RootTransform).GetTranslation();
				EXPECT_TRUE(RelativeChildOffsets[0].Equals(ActualRelativeChildOffsets0));
				EXPECT_TRUE(RelativeChildOffsets[1].Equals(ActualRelativeChildOffsets1));
				EXPECT_TRUE(RelativeChildOffsets[2].Equals(ActualRelativeChildOffsets2));
				EXPECT_TRUE(RelativeChildOffsets[3].Equals(ActualRelativeChildOffsets3));
			}
