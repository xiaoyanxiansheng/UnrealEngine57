...
namespace uba
{
	...
	public:
		...
		static bool Encrypt(Logger& logger, CryptoKey key, u8* data, u32 size, Guid& inOutInitVector);
		static bool Decrypt(Logger& logger, CryptoKey key, u8* data, u32 size, Guid& inOutInitVector);
	};
