...
namespace uba
{
	...
	public:
		...
		// Set priority of connection
		virtual void SetPriority(void* connection) = 0;
		...
		// Set internal buffer sizes for send and recv
		virtual void SetSendBufferSize(void* connection, u32 bytes) = 0;
		virtual void SetRecvBufferSize(void* connection, u32 bytes) = 0;
