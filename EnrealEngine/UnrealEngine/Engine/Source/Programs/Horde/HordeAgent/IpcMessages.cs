...
namespace HordeAgent
{
	...
	/// </summary>
	/// <param name="CpuCount">Maximum number of logical CPU cores workloads should use</param>
	/// <param name="CpuMultiplier">CPU core multiplier applied to CPU core count setting</param>
