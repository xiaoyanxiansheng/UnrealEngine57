...
namespace HordeServer.Agents.Enrollment
{
	...
	public class EnrollmentController : HordeControllerBase
	{
		...
		/// Constructor
		/// </summary>
		public EnrollmentController(EnrollmentService registrationService, IOptionsSnapshot<ComputeConfig> computeConfig)
		{
		...
		{
			if (!_computeConfig.Value.Authorize(AgentAclAction.CreateAgent, User))
			{
