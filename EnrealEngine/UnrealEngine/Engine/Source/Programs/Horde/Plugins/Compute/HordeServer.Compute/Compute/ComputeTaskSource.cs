...
namespace HordeServer.Compute
{
	...
	public class UbaComputeResource(string cacheEndpoint, string cacheSessionKey, bool writeAccess)
	{
		/// <inheritdoc cref="UbaConfig.CacheEndpoint" />
		public string CacheEndpoint { get; } = cacheEndpoint;
		
		/// <inheritdoc cref="UbaConfig.CacheSessionKey" />
		public string CacheSessionKey { get; } = cacheSessionKey;
		
		/// <inheritdoc cref="UbaConfig.WriteAccess" />
	...
	public class ComputeResource
	{
		...
		/// <inheritdoc cref="UbaComputeResource" />
		public UbaComputeResource? Uba { get; set;  }
