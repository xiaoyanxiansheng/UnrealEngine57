...
namespace HordeServer.Utilities
{
	...
	public static class HordeClaims
	{
		...
		/// <summary>
		/// Role for dedicated agents
		/// </summary>
		public static AclClaimConfig AgentDedicatedRoleClaim { get; } = new AclClaimConfig(HordeClaimTypes.Role, "agent");
		
		/// <summary>
		/// Role for workstation agents
		/// </summary>
		public static AclClaimConfig AgentWorkstationRoleClaim { get; } = new AclClaimConfig(HordeClaimTypes.Role, "agent-workstation");
