...
const IssueQuarantineModal: React.FC<{ onClose: () => void }> = ({ onClose }) => {
...
const IssueForceCloseModal: React.FC<{ onClose: () => void }> = ({ onClose }) => {
