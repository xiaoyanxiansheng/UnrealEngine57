...
import { divProperties, mergeStyleSets, MessageBar, MessageBarType, Separator, Spinner, SpinnerSize, Stack, Text } from '@fluentui/react';
...
export const Breadcrumbs: React.FC<{ items: BreadcrumbItem[], title?: string, suppressHome?: boolean, spinner?: boolean }> = observer((({ items: itemsIn, title, suppressHome, spinner }) => {
   ...
   return (<Stack>
      ...
      <Stack>
         ...
         {!alert &&
            <div style={{margin: "auto", position: "absolute", width: "fit-content", left: 0, right: 0}}>
               <ErrorBar/>
            </div>
         }
      </Stack>
