...
import { DetailsList, DetailsListLayoutMode, IColumn, SelectionMode, Stack, Text, TooltipHost } from "@fluentui/react";
...
const ServerPanel: React.FC = observer(() => {
   ...
   const columns = [
      { key: 'column_cluster', name: 'Cluster', fieldName: 'cluster', minWidth: 140, maxWidth: 140, isResizable: false },
      { key: 'column_numleases', name: 'Leases', fieldName: 'numLeases', minWidth: 100, maxWidth: 100, isResizable: false },
      { key: 'column_status', name: 'Status', fieldName: 'status', minWidth: 120, maxWidth: 120, isResizable: false },
      { key: 'column_server', name: 'Server', fieldName: 'serverAndPort', minWidth: 330, maxWidth: 330, isResizable: false },
      { key: 'column_detail', name: 'Detail', fieldName: 'detail', minWidth: 200, maxWidth: 200, isResizable: false, isMultiline: true },
   ];
   ...
   const renderItem = (item: any, index?: number, column?: IColumn) => {
      ...
      return <TooltipHost content={column?.fieldName === "detail" ? item[column?.fieldName] : ''} styles={{ root: { display: 'inline-block' } }}>
