...
const AuditLogPanel: React.FC<{ agentId?: string, deviceId?: string, jobId?: string, issueId?: string, templateAudit?: TemplateAudit }> = observer(({ agentId, deviceId, jobId, issueId, templateAudit }) => {
