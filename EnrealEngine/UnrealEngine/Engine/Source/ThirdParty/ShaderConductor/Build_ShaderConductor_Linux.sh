...
( cat <<_EOF_
  ...
  set(TOOLCHAIN_LIB64_PATH "\${LINUX_MULTIARCH_ROOT}/\${ARCHITECTURE_TRIPLE}/lib64")
  
  include_directories("\${LINUX_MULTIARCH_ROOT}/\$ENV{ARCH}/include")
  include_directories("\${LINUX_MULTIARCH_ROOT}/\$ENV{ARCH}/include/c++/v1")

  set(CMAKE_LINKER_FLAGS "-static-libstdc++ -fuse-ld=lld \${TOOLCHAIN_LIB64_PATH}/libc++.a \${TOOLCHAIN_LIB64_PATH}/libc++abi.a -lpthread")
