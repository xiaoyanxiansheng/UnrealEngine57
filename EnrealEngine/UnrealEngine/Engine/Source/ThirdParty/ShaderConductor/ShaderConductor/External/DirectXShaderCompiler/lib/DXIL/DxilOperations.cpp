...
Function *OP::GetOpFunc(OpCode opCode, Type *pOverloadType) {
  ...
  // UE Change Begin: Disable assertion until constant evaluation of intrinsics with LitFloat arguments is fixed
  #if 0
  ...
  #endif
  // UE Change End: Disable assertion until constant evaluation of intrinsics with LitFloat arguments is fixed
