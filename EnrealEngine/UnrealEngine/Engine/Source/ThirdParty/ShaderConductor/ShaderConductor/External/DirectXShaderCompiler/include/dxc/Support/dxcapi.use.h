...
public:
  ...
  HRESULT Initialize() {
    ...
    #ifdef _WIN32
    return InitializeInternal("dxcompiler.dll", "DxcCreateInstance");
    #elif __APPLE__
    return InitializeInternal("libdxcompiler.dylib", "DxcCreateInstance");
    #else
    return InitializeInternal("libdxcompiler.so", "DxcCreateInstance");
    #endif
