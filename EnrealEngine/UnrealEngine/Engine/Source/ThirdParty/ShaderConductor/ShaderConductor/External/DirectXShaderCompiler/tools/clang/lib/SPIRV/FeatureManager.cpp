...
FeatureManager::FeatureManager(DiagnosticsEngine &de,
  ...
  // UE Change Begin: Do not automatically add it if an extension list is provided.
  if (isTargetEnvSpirv1p4OrAbove() && opts.allowedExtensions.empty()) {
  // UE Change End: Do not automatically add it if an extension list is provided.
