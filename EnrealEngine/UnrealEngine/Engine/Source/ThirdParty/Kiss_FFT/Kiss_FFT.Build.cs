...
public class Kiss_FFT : ModuleRules
{
	public Kiss_FFT(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		if (Target.Platform == UnrealTargetPlatform.Win64)
		{
			...
			{
				LibDir = Kiss_FFTPath + "/lib/" + Target.Architecture.WindowsLibDir + "/VS" + Target.WindowsPlatform.GetVisualStudioCompilerVersionName() + "/Debug/";
			}
			else
			{
				LibDir = Kiss_FFTPath + "/lib/" + Target.Architecture.WindowsLibDir + "/VS" + Target.WindowsPlatform.GetVisualStudioCompilerVersionName() + "/Release/";
			}
