...
public class libstrophe : ModuleRules
{
	...
	public libstrophe(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		{
			string PlatformSubdir = Target.Architecture == UnrealArch.Arm64 ? "WinArm64" : "Win64/VS" + Target.WindowsPlatform.GetVisualStudioCompilerVersionName();
			PublicAdditionalLibraries.Add(Path.Combine(StropheLibRootPath, PlatformSubdir, ConfigName, "strophe.lib"));
		}
