	...
	public SpeedTree(ReadOnlyTargetRules Target) : base(Target)
	{
			...
			Target.bCompileSpeedTree)
		{
			...
			else if (Target.Platform == UnrealTargetPlatform.Win64 && Target.Architecture == UnrealArch.Arm64)
			{
				if (Target.Configuration == UnrealTargetConfiguration.Debug && Target.bDebugBuildsActuallyUseDebugCRT)
				{
					PublicAdditionalLibraries.Add(SpeedTreePath + "Lib/Windows/VC143.arm64/SpeedTreeCore_Windows_v7.0_VC143_MTDLLarm64_Static_d.lib");
				}
				else
				{
					PublicAdditionalLibraries.Add(SpeedTreePath + "Lib/Windows/VC143.arm64/SpeedTreeCore_Windows_v7.0_VC143_MTDLLarm64_Static.lib");
				}
			}
