...
pushd hlslcc\projects
	...
	msbuild hlslcc.sln /target:Clean,hlslcc_lib /p:Platform=arm64;Configuration="Debug"
	msbuild hlslcc.sln /target:Clean,hlslcc_lib /p:Platform=arm64;Configuration="Release"
	popd
