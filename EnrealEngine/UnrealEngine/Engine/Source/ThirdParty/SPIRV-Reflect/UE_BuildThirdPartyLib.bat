...
echo %cd%
	...
	msbuild SPIRV-Reflect.sln /target:Clean,SPIRV-Reflect /p:Platform=ARM64;Configuration="Debug"
	msbuild SPIRV-Reflect.sln /target:Clean,SPIRV-Reflect /p:Platform=ARM64;Configuration="Release"
	popd
