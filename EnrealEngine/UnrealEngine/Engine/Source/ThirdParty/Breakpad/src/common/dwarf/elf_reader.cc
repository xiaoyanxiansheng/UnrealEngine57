...
class ElfSectionReader {
 public:
  ElfSectionReader(const char *cname, const string &path, OSHandle fd,
...
#endif
    contents_aligned_ = CreateOSMapping(NULL, size_aligned_, prot_flags, flags, fd, offset_aligned);
