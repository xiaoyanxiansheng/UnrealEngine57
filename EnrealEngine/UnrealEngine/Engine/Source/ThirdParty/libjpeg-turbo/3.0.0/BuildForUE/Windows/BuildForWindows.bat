...
call "%ENGINE_ROOT%\Build\BatchFiles\RunUAT.bat" BuildCMakeLib -TargetPlatform=Win64 -TargetArchitecture=arm64 -TargetLib=libjpeg-turbo -TargetLibVersion=3.0.0 -TargetConfigs=Release -LibOutputPath=lib -CMakeGenerator=VS2019 -MakeTarget=turbojpeg-static -CMakeAdditionalArguments="-DREQUIRE_SIMD=ON" -SkipCreateChangelist || exit /b
