...
// enable modifications only for clang-cl.exe targeting MSVC x64 build
#if !defined PNG_EPICGAMES_MODIFICATION_ENABLE && defined(__clang__) && defined(_MSC_VER) && defined(__x86_64__)
