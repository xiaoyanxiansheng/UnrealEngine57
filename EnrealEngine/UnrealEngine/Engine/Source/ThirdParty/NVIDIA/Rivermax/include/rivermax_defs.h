...
#ifndef __export
#if defined(RMAX_LINK_STATIC) || !defined(_MSC_VER)
#define __export
...
#define RMX_VERSION_MINOR  71
#define RMX_VERSION_PATCH  30
...
#define rmx_input_get_next_chunk                             rmx_input_get_next_chunk_v2
