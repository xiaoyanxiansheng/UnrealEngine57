...
set UE_BUILD_PATH="%CD%\Build_WinArm64"
...
mkdir "%UE_BUILD_PATH%"
cd "%UE_BUILD_PATH%"
"%_vsinstall%\Common7\IDE\CommonExtensions\Microsoft\CMake\CMake\bin\cmake.exe" -G "Visual Studio 17 2022" -A arm64 "%PATH_TO_CMAKE_FILE%"
...
xcopy /y/s/i "%UE_BUILD_PATH%\EtcLib\Release" lib\WinArm64\Release
xcopy /y/s/i "%UE_BUILD_PATH%\EtcLib\Debug" lib\WinArm64\Debug
