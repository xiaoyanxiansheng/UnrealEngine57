...
struct UE_DEPRECATED(5.7, "FScopedDeclarations has been moved into internal module HlslParser and is no longer supported as public interface.") FScopedDeclarations
{
...
UE_DEPRECATED(5.7, "RemoveUnusedOutputs() has been moved into internal module HlslParser and is no longer supported as public interface.")
inline bool RemoveUnusedOutputs(...)
{
	return false; // dummy
}

UE_DEPRECATED(5.7, "RemoveUnusedInputs() has been moved into internal module HlslParser and is no longer supported as public interface.")
inline bool RemoveUnusedInputs(...)
{
	return false; // dummy
}

// Shader input/output parameter storage classes. Naming adopted from SPIR-V nomenclature.
enum class UE_DEPRECATED(5.7, "EShaderParameterStorageClass has been moved into internal module HlslParser and is no longer supported as public interface.") EShaderParameterStorageClass
{
	Input,
	Output,
};
...
UE_DEPRECATED(5.7, "FindEntryPointParameters() has been moved into internal module HlslParser and is no longer supported as public interface.")
inline bool FindEntryPointParameters(...)
{
	return false; //dummy
}
