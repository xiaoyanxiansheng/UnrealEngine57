...
public:
	...
	// Executes metal-pack for 'SDK' on the local or remote machine, depending on configuration
    bool ExecMetalPack(EAppleSDKType SDK, const TCHAR* Parameters, int32* OutReturnCode, FString* OutStdOut, FString* OutStdErr) const;
	bool ExecMetalStrip(EAppleSDKType SDK, const TCHAR* Parameters, int32* OutReturnCode, FString* OutStdOut, FString* OutStdErr) const;
	...
	// The name of metal-pack
    static FString MetalPackBinary;
	// The name of metal-strip
	static FString MetalStripBinary;
...
private:
	...
	// The command string to invoke 'metal-pack'
    FString MetalPackBinaryCommand[AppleSDKCount];
	// The command string to invoke 'metal-strip'
	FString MetalStripBinaryCommand[AppleSDKCount];
