...
{
	UE_LOG(LogAutomationDriver, Error, TEXT("Parallel execution of multiple action sequences is not supported"));
}

void FAutomationDriverLogging::CannotUnpinActionSequenceIfNotPinned()
{
	UE_LOG(LogAutomationDriver, Error, TEXT("Cannot unpin action sequence if it's not pinned"));
}

void FAutomationDriverLogging::CannotUnpinActionSequenceIfExecuting()
{
	UE_LOG(LogAutomationDriver, Error, TEXT("Cannot unpin action sequence if it's still executing"));
}
