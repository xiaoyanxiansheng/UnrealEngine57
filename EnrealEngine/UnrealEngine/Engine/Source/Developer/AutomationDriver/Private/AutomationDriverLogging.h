...
public:
	...
	static void CannotExecuteMultipleActionSequencesInParallel();

	static void CannotUnpinActionSequenceIfNotPinned();

	static void CannotUnpinActionSequenceIfExecuting();
};
