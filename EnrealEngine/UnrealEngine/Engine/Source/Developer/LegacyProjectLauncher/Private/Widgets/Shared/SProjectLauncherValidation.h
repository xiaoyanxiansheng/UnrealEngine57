...
public:
	...
	void Construct( const FArguments& InArgs)
	{
		...
		VertBox->AddSlot().AutoHeight()
			[
				MakeValidationMessage(TEXT("Icons.Error"), ELauncherProfileValidationErrors::UnversionedAndIncremental)
			];
		...
		VertBox->AddSlot().AutoHeight()
			[
				MakeValidationMessage(TEXT("Icons.Error"), ELauncherProfileValidationErrors::ZenPakStreamingRequiresDeployAndLaunch)
			];
