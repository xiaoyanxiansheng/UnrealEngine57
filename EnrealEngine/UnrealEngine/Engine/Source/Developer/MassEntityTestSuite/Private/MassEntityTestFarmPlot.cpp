...
void AMassEntityTestFarmPlot::BeginPlay()
{
	...
	PerFrameSystems.Last()->CallInitialize(this, EntityManager.AsShared());
	...
	for (UMassProcessor* Processor : PerSecondSystems)
	{
		Processor->CallInitialize(this, EntityManager.AsShared());
	}
