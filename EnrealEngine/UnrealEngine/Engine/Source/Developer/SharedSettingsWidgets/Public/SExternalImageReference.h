...
public:
	...
	UE_API void Construct(const FArguments& InArgs, const FString& InBaseFilename, const FString& InOverrideFilename);

protected:
	/** Delegate handler for when an image is picked */
	UE_API bool HandleExternalImagePicked(const FString& InChosenImage, const FString& InTargetImage);
