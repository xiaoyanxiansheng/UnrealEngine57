...
public:
	...
	static UE_API TSharedRef<ITableCellValueGetter> GetDefaultValueGetter();
	...
	UE_API const TOptional<FTableCellValue> GetValue(const FBaseTreeNode& InNode) const;
	UE_API uint64 GetValueId(const FBaseTreeNode& InNode) const;

	//////////////////////////////////////////////////
	// Value Formatter

	static UE_API TSharedRef<ITableCellValueFormatter> GetDefaultValueFormatter();
	...
	UE_API FText GetValueAsText(const FBaseTreeNode& InNode) const;
	UE_API FText GetValueAsTooltipText(const FBaseTreeNode& InNode) const;
	UE_API FText GetValueAsGroupingText(const FBaseTreeNode& InNode) const;

	UE_API FText CopyValue(const FBaseTreeNode& InNode) const;
	UE_API FText CopyTooltip(const FBaseTreeNode& InNode) const;

	UE_API FString GetValueAsSerializableString(const FBaseTreeNode& InNode) const;
