...
struct FStructUtilsTest_BitSetComparison : FAITestBase
{
	virtual bool InstantTest() override
	{
		...
		FTestStructBitSet CollectionEmpty;
		AITEST_NOT_EQUAL("Empty bitset is not equal to non-empty", CollectionEmpty, CollectionNone);

		FTestStructBitSet CollectionEmptied = CollectionNone;
		CollectionEmptied.RemoveBit(2);
		CollectionEmptied.RemoveBit(77);
		AITEST_EQUAL("Empty bitset is equal to an emptied one", CollectionEmpty, CollectionEmptied);
