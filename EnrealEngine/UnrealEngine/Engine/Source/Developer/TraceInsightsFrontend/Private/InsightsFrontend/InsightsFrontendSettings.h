...
{
public:
	FInsightsFrontendSettings(bool bInIsDefault = false)
		: bIsEditing(false)
	...
	void LoadFromConfig()
	{
		if (!FConfigContext::ReadIntoGConfig().Load(TEXT("UnrealInsightsFrontendSettings"), SettingsIni))
		{
			return;
		}
	...
	const FInsightsFrontendSettings& GetDefaults() const
	{
		return Defaults;
	}
...
private:
	...
	static FInsightsFrontendSettings Defaults;
