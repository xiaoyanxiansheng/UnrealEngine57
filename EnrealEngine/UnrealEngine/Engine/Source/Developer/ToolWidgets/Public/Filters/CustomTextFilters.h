...
#define LOCTEXT_NAMESPACE "CustomTextFilters"
...
public:
	...
	{
		return FText::Format(LOCTEXT("CustomTextFiltersTooltip", "Filter by string \"{0}\""), TextFilter->GetRawFilterText()); // The tooltip will display the filter string
	}
