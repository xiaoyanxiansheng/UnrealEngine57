...
public:
	...
	/**
	 * @return The bool indicating whether or not the widget we were initialized from reports as supporting invalidation
	 */
	virtual bool GetWidgetSupportsInvalidation() const = 0;

	/**
	 * @return The bool indicating whether or not the widget we were initialized from reports as recursively supporting invalidation
	 */
	virtual bool GetSupportsInvalidationRecursive() const = 0;
...
public:
	...
	virtual bool GetWidgetSupportsInvalidation() const override;
	virtual bool GetSupportsInvalidationRecursive() const override;
...
private:
	...
	/** Did the widget support invalidation at the point it was passed to Initialize */
	bool bCachedSupportsInvalidation;
	
	/** Did the widget recursively support invalidation at the point it was passed to Initialize */
	bool bCachedSupportsInvalidationRecursive;
...
public:
	...
	/** Does the widget supports invalidation? */
	static bool GetWidgetSupportsInvalidation(const TSharedPtr<const SWidget>& InWidget);

	/** Does this widget and all its children support invalidation? */
	static bool GetWidgetSupportsInvalidationRecursive(const TSharedPtr<const SWidget>& InWidget);
