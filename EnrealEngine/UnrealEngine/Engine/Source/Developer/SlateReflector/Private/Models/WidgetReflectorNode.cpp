...
bool FLiveWidgetReflectorNode::GetWidgetSupportsInvalidation() const
{
	return FWidgetReflectorNodeUtils::GetWidgetSupportsInvalidation(Widget.Pin());
}

bool FLiveWidgetReflectorNode::GetSupportsInvalidationRecursive() const
{
	return FWidgetReflectorNodeUtils::GetWidgetSupportsInvalidationRecursive(Widget.Pin());
}
...
FSnapshotWidgetReflectorNode::FSnapshotWidgetReflectorNode(const FArrangedWidget& InArrangedWidget)
	...
	, bCachedSupportsInvalidation(FWidgetReflectorNodeUtils::GetWidgetSupportsInvalidation(InArrangedWidget.Widget))
	, bCachedSupportsInvalidationRecursive(FWidgetReflectorNodeUtils::GetWidgetSupportsInvalidationRecursive(InArrangedWidget.Widget))
...
bool FSnapshotWidgetReflectorNode::GetWidgetSupportsInvalidation() const
{
	return bCachedSupportsInvalidation;
}

bool FSnapshotWidgetReflectorNode::GetSupportsInvalidationRecursive() const
{
	return bCachedSupportsInvalidationRecursive;
}
...
TSharedRef<FJsonValue> FSnapshotWidgetReflectorNode::ToJson(const TSharedRef<FSnapshotWidgetReflectorNode>& RootSnapshotNode)
{
	...
	RootJsonObject->SetBoolField(TEXT("SupportsInvalidation"), RootSnapshotNode->bCachedSupportsInvalidation);
	RootJsonObject->SetBoolField(TEXT("SupportsInvalidationRecursive"), RootSnapshotNode->bCachedSupportsInvalidationRecursive);
...
TSharedRef<FSnapshotWidgetReflectorNode> FSnapshotWidgetReflectorNode::FromJson(const TSharedRef<FJsonValue>& RootJsonValue)
{
	...
	RootSnapshotNode->bCachedSupportsInvalidation = RootJsonObject->GetBoolField(TEXT("SupportsInvalidation"));
	RootSnapshotNode->bCachedSupportsInvalidationRecursive = RootJsonObject->GetBoolField(TEXT("SupportsInvalidationRecursive"));
...
bool FWidgetReflectorNodeUtils::GetWidgetSupportsInvalidation(const TSharedPtr<const SWidget>& InWidget)
{
#if UE_SLATE_WITH_DYNAMIC_INVALIDATION
	return InWidget.IsValid() ? InWidget->SupportsInvalidation() : false;
#else
	return false;
#endif
}

bool FWidgetReflectorNodeUtils::GetWidgetSupportsInvalidationRecursive(const TSharedPtr<const SWidget>& InWidget)
{
#if UE_SLATE_WITH_DYNAMIC_INVALIDATION
	return InWidget.IsValid() ? InWidget->SupportsInvalidationRecursive() : false;
#else
	return false;
#endif
}
