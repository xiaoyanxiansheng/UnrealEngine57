...
private:
	...
	FText GetSupportsInvalidation() const
	{
		return (WidgetInfo->GetWidgetSupportsInvalidation()) ? TrueText : FalseText;
	}
	
	FText GetSupportsInvalidationRecursive() const
	{
		return (WidgetInfo->GetSupportsInvalidationRecursive()) ? TrueText : FalseText;
	}
