...
public:
    ...
    TSharedPtr<IPropertyHandle> ShippingMacEntitlements;
    TSharedPtr<IPropertyHandle> PremadeIOSEntitlements;
    TSharedPtr<IPropertyHandle> ShippingIOSEntitlements;
	
private:
	static void RestoreDefault(const FStringView& SubFolder, const TCHAR* Filename, TSharedPtr<IPropertyHandle> Property);
};
