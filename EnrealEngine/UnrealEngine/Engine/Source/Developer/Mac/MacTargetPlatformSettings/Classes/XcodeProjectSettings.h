...
public:
	 ...
	 */
	UPROPERTY(EditAnywhere, config, Category="Entitlements", meta = (EditCondition="bUseModernXcode", DisplayName = "Mac: Entitlements"))
	FFilePath PremadeMacEntitlements;
	
	/**
	 * The premade entitlement file used for shipping Mac builds
	 */
	UPROPERTY(EditAnywhere, config, Category="Entitlements", meta = (EditCondition="bUseModernXcode", DisplayName = "Mac:  Entitlements (Shipping config override)"))
	FFilePath ShippingSpecificMacEntitlements;
	
	/**
	 * The premade entitlement file used for development IOS builds
	 */
	UPROPERTY(EditAnywhere, config, Category="Entitlements", meta = (EditCondition="bUseModernXcode", DisplayName = "IOS: Entitlements"))
	FFilePath PremadeIOSEntitlements;
	
	/**
	 * The premade entitlement file used for shipping IOS builds
	 */
	UPROPERTY(EditAnywhere, config, Category="Entitlements", meta = (EditCondition="bUseModernXcode", DisplayName = "IOS: Entitlements (Shipping config override)"))
	FFilePath ShippingSpecificIOSEntitlements;
