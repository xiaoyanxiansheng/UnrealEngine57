...
public:
	...
	virtual FOnLauncherProfilePostProcessAutomatedTestCommandLine& OnPostProcessAutomatedTestCommandLine( ) override
	{
		return PostProcessAutomatedTestCommandLine;
	}
...
private:
	...
	// Holds a delegate to be involked to modify the command line for an automated test before launching
	FOnLauncherProfilePostProcessAutomatedTestCommandLine PostProcessAutomatedTestCommandLine;
