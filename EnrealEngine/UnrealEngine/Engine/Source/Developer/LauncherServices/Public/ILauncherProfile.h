...
public:
	...
	*/
	 ...
	 */
	virtual void AddCustomError( const FString& UniqueId, const FText& Text ) = 0;
	 ...
	 * @param UniqueId Unique identifier for this error
	 */
	virtual bool HasCustomError( const FString& UniqueId ) const = 0;
	 ...
	 */
	virtual FText GetCustomErrorText( const FString& UniqueId ) const = 0;
	 ...
	 */
	virtual TArray<FString> GetAllCustomErrors() const = 0;
	 ...
	 */
	virtual void AddCustomWarning( const FString& UniqueId, const FText& Text ) = 0;
	 ...
	 * @param UniqueId Unique identifier for this warning
	 */
	virtual bool HasCustomWarning( const FString& UniqueId ) const = 0;
	 ...
	 */
	virtual FText GetCustomWarningText( const FString& UniqueId ) const = 0;
	 ...
	 */
	virtual TArray<FString> GetAllCustomWarnings() const = 0;


	/**
	 * Refreshes the custom warnings and errors. Resets the lists and triggers the OnValidation callback.
	 */
	virtual void RefreshCustomWarningsAndErrors() = 0;
...
public:
	...
	*/
	 ...
	 */
	virtual ILauncherProfileAutomatedTestRef FindOrAddAutomatedTest( const TCHAR* InternalName ) = 0;
