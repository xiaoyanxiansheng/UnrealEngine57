...
private:
	...
	virtual int64 MemoryForGenerateMeshCardRepresentation(uint64_t IndexCount);
	...
	virtual void CalcBoneVertInfos(USkeletalMesh* SkeletalMesh, TArray<FBoneVertInfo>& Infos, bool bOnlyDominant, int32 LodIndex = 0) override;
