...
void FMeshUtilities::CalcBoneVertInfos(USkeletalMesh* SkeletalMesh, TArray<FBoneVertInfo>& Infos, bool bOnlyDominant, int32 LodIndex/* = 0*/)
{
	FMeshUtilitiesEngine::CalcBoneVertInfos(SkeletalMesh, Infos, bOnlyDominant, LodIndex);
}
...
public:
	...
	bool GenerateRenderingMeshes(FMeshUtilities& MeshUtilities, FStaticMeshRenderData& OutRenderData)
	{
		...
		int32 ImportVersion = StaticMesh->GetImportVersion();
...
public:
	...
	bool GenerateSkeletalRenderMesh(SkeletalMeshBuildData& BuildData)
	{
		...
		TArray<int32>	WedgeInfluenceIndices; // TODO: Reserve
		TMap<uint32, uint32> VertexIndexToInfluenceIndexMap; // TODO: Reserve
