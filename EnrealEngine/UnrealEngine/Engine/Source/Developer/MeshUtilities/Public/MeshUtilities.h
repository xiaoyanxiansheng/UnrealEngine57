...
struct FMeshDataForDerivedDataTask
{
	...
	TConstArrayView<FSignedDistanceFieldBuildPartData> Parts;
	TConstArrayView<FNaniteAssemblyNode> Nodes;
...
public:
	...
	virtual int64 MemoryForGenerateMeshCardRepresentation(uint64_t IndexCount) = 0;
	 ...
	 */
	virtual void CalcBoneVertInfos( USkeletalMesh* SkeletalMesh, TArray<FBoneVertInfo>& Infos, bool bOnlyDominant, int32 LodIndex = 0) = 0;
