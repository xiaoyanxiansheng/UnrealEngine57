...
public:
	...
	UE_API bool UpdateSize(const float InWidth, const float InHeight);
	...
	UE_API double RestrictEndTime(const double InEndTime) const;
	UE_API double RestrictDuration(const double InStartTime, const double InEndTime) const;

	//////////////////////////////////////////////////
	// Scrolling

	UE_API bool ScrollAtTime(const double Time);
	UE_API bool CenterOnTimeInterval(const double Time, const double Duration);

	UE_API void GetHorizontalScrollLimits(double& OutMinT, double& OutMaxT);
	UE_API bool EnforceHorizontalScrollLimits(const double U);

	//////////////////////////////////////////////////
	// Zooming

	UE_API bool ZoomOnTimeInterval(const double Time, const double Duration);
	UE_API bool RelativeZoomWithFixedX(const float Delta, const float X);
	UE_API bool ZoomWithFixedX(const double NewScaleX, const float X);
	UE_API bool SetScaleX(const double NewScaleX);
	...
	UE_API bool OnUserScrolled(TSharedPtr<SScrollBar> ScrollBar, float ScrollOffset);
	UE_API void UpdateScrollBar(TSharedPtr<SScrollBar> ScrollBar) const;

	UE_API bool OnUserScrolledY(TSharedPtr<SScrollBar> ScrollBar, float ScrollOffset);
	UE_API void UpdateScrollBarY(TSharedPtr<SScrollBar> ScrollBar) const;
