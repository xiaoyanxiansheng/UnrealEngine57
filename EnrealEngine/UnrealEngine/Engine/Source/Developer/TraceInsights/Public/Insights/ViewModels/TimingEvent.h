...
{
	INSIGHTS_DECLARE_RTTI(FTimingEvent, ITimingEvent, UE_API)
...
public:
	...
	static UE_API uint32 ComputeEventColor(uint32 Id);
	static UE_API uint32 ComputeEventColor(const TCHAR* Str);
...
{
	INSIGHTS_DECLARE_RTTI(FAcceptNoneTimingEventFilter, ITimingEventFilter, UE_API)
...
{
	INSIGHTS_DECLARE_RTTI(FAcceptAllTimingEventFilter, ITimingEventFilter, UE_API)
...
{
	INSIGHTS_DECLARE_RTTI(FAggregatedTimingEventFilter, ITimingEventFilter, UE_API)
...
{
	INSIGHTS_DECLARE_RTTI(FAllAggregatedTimingEventFilter, FAggregatedTimingEventFilter, UE_API)
...
{
	INSIGHTS_DECLARE_RTTI(FAnyAggregatedTimingEventFilter, FAggregatedTimingEventFilter, UE_API)
...
{
	INSIGHTS_DECLARE_RTTI(FTimingEventFilter, ITimingEventFilter, UE_API)
...
public:
	...
	UE_API virtual bool FilterTrack(const FBaseTimingTrack& InTrack) const override;
	virtual bool FilterEvent(const ITimingEvent& InEvent) const override { return true; }
	virtual bool FilterEvent(double InEventStartTime, double InEventEndTime, uint32 InEventDepth, const TCHAR* InEventName, uint64 InEventType = 0, uint32 InEventColor = 0) const override { return true; }
	virtual uint32 GetChangeNumber() const override { return ChangeNumber; }
...
{
	INSIGHTS_DECLARE_RTTI(FTimingEventFilterByMinDuration, FTimingEventFilter, UE_API)
...
{
	INSIGHTS_DECLARE_RTTI(FTimingEventFilterByMaxDuration, FTimingEventFilter, UE_API)
...
class FTimingEventFilterByEventType : public FTimingEventFilter
{
	INSIGHTS_DECLARE_RTTI(FTimingEventFilterByEventType, FTimingEventFilter, UE_API)
...
{
	INSIGHTS_DECLARE_RTTI(FTimingEventFilterByFrameIndex, FTimingEventFilter, UE_API)
