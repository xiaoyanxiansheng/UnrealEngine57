...
private:
	...
	FText GetStreamTypeText() const { return StreamTypeText; }
	...
	EVisibility IsVisibleUriText() const { return UriText.IsEmpty() ? EVisibility::Collapsed : EVisibility::Visible; }
