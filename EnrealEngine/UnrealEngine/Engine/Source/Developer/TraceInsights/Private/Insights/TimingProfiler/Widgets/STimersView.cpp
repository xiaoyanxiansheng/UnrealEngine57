...
public:
	...
	virtual void RegisterCommands() override
	{
		...
		UI_COMMAND(Command_GenerateNewColor,
			"Generate New Color",
			"Generates a new random color for the selected timers.",
			EUserInterfaceActionType::Button,
			FInputChord());

		UI_COMMAND(Command_EditColor,
			"Edit Color...",
			"Changes color for the selected timers.",
			EUserInterfaceActionType::Button,
			FInputChord());

		UI_COMMAND(Command_FindFirstInstance,
			"First Instance",
			"Navigates to and selects the first timing event instance for the selected timer.",
			EUserInterfaceActionType::Button,
			FInputChord());

		UI_COMMAND(Command_FindPreviousInstance,
			"Previous Instance",
			"Navigates to and selects the previous timing event instance for the selected timer.",
			EUserInterfaceActionType::Button,
			FInputChord());

		UI_COMMAND(Command_FindNextInstance,
			"Next Instance",
			"Navigates to and selects the next timing event instance for the selected timer.",
			EUserInterfaceActionType::Button,
			FInputChord());

		UI_COMMAND(Command_FindLastInstance,
			"Last Instance",
			"Navigates to and selects the last timing event instance for the selected timer.",
			EUserInterfaceActionType::Button,
			FInputChord());
		...
		UI_COMMAND(Command_FindFirstInstanceInSelection,
			"First Instance in Selection",
			"Navigates to and selects the first timing event instance for the selected timer, in the selected time range.",
			EUserInterfaceActionType::Button,
			FInputChord());

		UI_COMMAND(Command_FindPreviousInstanceInSelection,
			"Previous Instance in Selection",
			"Navigates to and selects the previous timing event instance for the selected timer, in the selected time range.",
			EUserInterfaceActionType::Button,
			FInputChord());

		UI_COMMAND(Command_FindNextInstanceInSelection,
			"Next Instance in Selection",
			"Navigates to and selects the next timing event instance for the selected timer, in the selected time range.",
			EUserInterfaceActionType::Button,
			FInputChord());

		UI_COMMAND(Command_FindLastInstanceInSelection,
			"Last Instance in Selection",
			"Navigates to and selects the last timing event instance for the selected timer, in the selected time range.",
			EUserInterfaceActionType::Button,
			FInputChord());
	...
	TSharedPtr<FUICommandInfo> Command_GenerateNewColor;
	TSharedPtr<FUICommandInfo> Command_EditColor;
	TSharedPtr<FUICommandInfo> Command_FindFirstInstance;
	TSharedPtr<FUICommandInfo> Command_FindPreviousInstance;
	TSharedPtr<FUICommandInfo> Command_FindNextInstance;
	TSharedPtr<FUICommandInfo> Command_FindLastInstance;
	TSharedPtr<FUICommandInfo> Command_FindMaxInstance;
	TSharedPtr<FUICommandInfo> Command_FindMinInstance;
	TSharedPtr<FUICommandInfo> Command_FindFirstInstanceInSelection;
	TSharedPtr<FUICommandInfo> Command_FindPreviousInstanceInSelection;
	TSharedPtr<FUICommandInfo> Command_FindNextInstanceInSelection;
	TSharedPtr<FUICommandInfo> Command_FindLastInstanceInSelection;
...
void STimersView::InitCommandList()
{
	...
	CommandList->MapAction(FTimersViewCommands::Get().Command_GenerateNewColor, FExecuteAction::CreateSP(this, &STimersView::ContextMenu_GenerateNewColor_Execute), FCanExecuteAction::CreateSP(this, &STimersView::ContextMenu_GenerateNewColor_CanExecute));
	CommandList->MapAction(FTimersViewCommands::Get().Command_EditColor, FExecuteAction::CreateSP(this, &STimersView::ContextMenu_EditColor_Execute), FCanExecuteAction::CreateSP(this, &STimersView::ContextMenu_EditColor_CanExecute));
	CommandList->MapAction(FTimersViewCommands::Get().Command_FindFirstInstance, FExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstance_Execute, ESelectEventType::First), FCanExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstance_CanExecute));
	CommandList->MapAction(FTimersViewCommands::Get().Command_FindPreviousInstance, FExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstance_Execute, ESelectEventType::Previous), FCanExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstance_CanExecute));
	CommandList->MapAction(FTimersViewCommands::Get().Command_FindNextInstance, FExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstance_Execute, ESelectEventType::Next), FCanExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstance_CanExecute));
	CommandList->MapAction(FTimersViewCommands::Get().Command_FindLastInstance, FExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstance_Execute, ESelectEventType::Last), FCanExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstance_CanExecute));
	CommandList->MapAction(FTimersViewCommands::Get().Command_FindMaxInstance, FExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstance_Execute, ESelectEventType::Max), FCanExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstance_CanExecute));
	CommandList->MapAction(FTimersViewCommands::Get().Command_FindMinInstance, FExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstance_Execute, ESelectEventType::Min), FCanExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstance_CanExecute));
	CommandList->MapAction(FTimersViewCommands::Get().Command_FindFirstInstanceInSelection, FExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstanceInSelection_Execute, ESelectEventType::First), FCanExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstanceInSelection_CanExecute));
	CommandList->MapAction(FTimersViewCommands::Get().Command_FindPreviousInstanceInSelection, FExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstanceInSelection_Execute, ESelectEventType::Previous), FCanExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstanceInSelection_CanExecute));
	CommandList->MapAction(FTimersViewCommands::Get().Command_FindNextInstanceInSelection, FExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstanceInSelection_Execute, ESelectEventType::Next), FCanExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstanceInSelection_CanExecute));
	CommandList->MapAction(FTimersViewCommands::Get().Command_FindLastInstanceInSelection, FExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstanceInSelection_Execute, ESelectEventType::Last), FCanExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstanceInSelection_CanExecute));
	CommandList->MapAction(FTimersViewCommands::Get().Command_FindMaxInstanceInSelection, FExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstanceInSelection_Execute, ESelectEventType::Max), FCanExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstanceInSelection_CanExecute));
	CommandList->MapAction(FTimersViewCommands::Get().Command_FindMinInstanceInSelection, FExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstanceInSelection_Execute, ESelectEventType::Min), FCanExecuteAction::CreateSP(this, &STimersView::ContextMenu_FindInstanceInSelection_CanExecute));
}
...
void STimersView::Construct(const FArguments& InArgs)
{
	...
	[
		...
		[
			...
			[
				...
				// Filter by type (Verse Sampling)
				+ SHorizontalBox::Slot()
				.Padding(4.0f, 0.0f, 4.0f, 0.0f)
				.AutoWidth()
				.VAlign(VAlign_Center)
				[
					GetToggleButtonForTimerType(ETimerNodeType::VerseSampling)
				]

				// Filter by type (CPU Scope)
				+ SHorizontalBox::Slot()
				.Padding(4.0f, 0.0f, 4.0f, 0.0f)
				.AutoWidth()
				.VAlign(VAlign_Center)
				...
				// Filter by type (CPU Sampling)
				+ SHorizontalBox::Slot()
				.Padding(4.0f, 0.0f, 4.0f, 0.0f)
				.AutoWidth()
				.VAlign(VAlign_Center)
				[
					GetToggleButtonForTimerType(ETimerNodeType::CpuSampling)
				]
	...
	if (Session.IsValid())
	{
		TraceServices::IAnalysisSession& EditableSession = *const_cast<TraceServices::IAnalysisSession*>(Session.Get());
		TraceServices::IEditableTimingProfilerProvider* TimingProfilerProvider = TraceServices::EditTimingProfilerProvider(EditableSession);
		if (TimingProfilerProvider)
		{
			TraceServices::FAnalysisSessionEditScope SessionEditScope(EditableSession);

			FInsightsSettings& Settings = FInsightsManager::Get()->GetSettings();
			TimingProfilerProvider->SetRatioOfThreadsToUse(Settings.GetThreadRatio());
		}
	}
}
...
TSharedPtr<SWidget> STimersView::TreeView_GetMenuContent()
{
	...
	MenuBuilder.BeginSection("TimerOptions", LOCTEXT("ContextMenu_Section_TimerOptions", "Timer Options"));
	{
		...
		MenuBuilder.AddMenuEntry
		(
			FTimersViewCommands::Get().Command_GenerateNewColor,
			NAME_None,
			TAttribute<FText>(),
			TAttribute<FText>(),
		...
		MenuBuilder.AddMenuEntry
		(
			FTimersViewCommands::Get().Command_EditColor,
			NAME_None,
			TAttribute<FText>(),
			TAttribute<FText>(),
	...
	MenuBuilder.BeginSection("Misc", LOCTEXT("ContextMenu_Section_Misc", "Miscellaneous"));
	{
		MenuBuilder.AddSubMenu
		(
			LOCTEXT("ContextMenu_Settings_SubMenu", "Settings"),
			LOCTEXT("ContextMenu_Settings_SubMenu_Desc", "Options to adjust timer-related settings."),
			FNewMenuDelegate::CreateSP(this, &STimersView::TreeView_BuildSettingsMenu),
			false,
...
void STimersView::TreeView_FindMenu(FMenuBuilder& MenuBuilder)
{
	...
	MenuBuilder.AddMenuEntry
	(
		FTimersViewCommands::Get().Command_FindFirstInstance,
		NAME_None,
		TAttribute<FText>(),
		TAttribute<FText>(),
		FSlateIcon(FInsightsStyle::Get().GetStyleSetName(), "Icons.FindFirst")
	);

	MenuBuilder.AddMenuEntry
	(
		FTimersViewCommands::Get().Command_FindPreviousInstance,
		NAME_None,
		TAttribute<FText>(),
		TAttribute<FText>(),
		FSlateIcon(FInsightsStyle::Get().GetStyleSetName(), "Icons.FindPrevious")
	);

	MenuBuilder.AddMenuEntry
	(
		FTimersViewCommands::Get().Command_FindNextInstance,
		NAME_None,
		TAttribute<FText>(),
		TAttribute<FText>(),
		FSlateIcon(FInsightsStyle::Get().GetStyleSetName(), "Icons.FindNext")
	);

	MenuBuilder.AddMenuEntry
	(
		FTimersViewCommands::Get().Command_FindLastInstance,
		NAME_None,
		TAttribute<FText>(),
		TAttribute<FText>(),
		FSlateIcon(FInsightsStyle::Get().GetStyleSetName(), "Icons.FindLast")
	);
	...
	MenuBuilder.AddMenuEntry
	(
		FTimersViewCommands::Get().Command_FindFirstInstanceInSelection,
		NAME_None,
		TAttribute<FText>(),
		TAttribute<FText>(),
		FSlateIcon(FInsightsStyle::Get().GetStyleSetName(), "Icons.FindFirst")
	...
	MenuBuilder.AddMenuEntry
	(
		FTimersViewCommands::Get().Command_FindPreviousInstanceInSelection,
		NAME_None,
		TAttribute<FText>(),
		TAttribute<FText>(),
		FSlateIcon(FInsightsStyle::Get().GetStyleSetName(), "Icons.FindPrevious")
	...
	MenuBuilder.AddMenuEntry
	(
		FTimersViewCommands::Get().Command_FindNextInstanceInSelection,
		NAME_None,
		TAttribute<FText>(),
		TAttribute<FText>(),
		FSlateIcon(FInsightsStyle::Get().GetStyleSetName(), "Icons.FindNext")
	...
	MenuBuilder.AddMenuEntry
	(
		FTimersViewCommands::Get().Command_FindLastInstanceInSelection,
		NAME_None,
		TAttribute<FText>(),
		TAttribute<FText>(),
		FSlateIcon(FInsightsStyle::Get().GetStyleSetName(), "Icons.FindLast")
...
void STimersView::TreeView_BuildSettingsMenu(FMenuBuilder& MenuBuilder)
{
	MenuBuilder.SetSearchable(false);

	MenuBuilder.BeginSection("Settings");
	{
		MenuBuilder.AddEditableText
		(
			LOCTEXT("ThreadsAggregation", "Number of Threads"),
			LOCTEXT("ThreadsAggregation_Tooltip",
				"Number of threads being used for Aggregation.\n"
				"Using higher values may cause systems to freeze.\n"
				"This value is persistent to the UnrealInsightsSettings.ini file."),
			FSlateIcon(),
			TAttribute<FText>::Create(TAttribute<FText>::FGetter::CreateRaw(this, &STimersView::GetThreadRatio)),
			FOnTextCommitted::CreateLambda([this](const FText& NewValue, ETextCommit::Type)
			{
				double Ratio = FCString::Atof(*NewValue.ToString());
				OnThreadRatioCommited(Ratio);
			})
		);

		FUIAction Action_SetSourceFilesSearchPath
		(
			FExecuteAction::CreateSP(this, &STimersView::SetSourceFileSearchPaths_Execute),
			FCanExecuteAction::CreateLambda([]() { return true; })
		);

		MenuBuilder.AddMenuEntry
		(
			LOCTEXT("SetSourceFilesSearchPath_Fmt", "Source File Path"),
			TAttribute<FText>::CreateSP(this, &STimersView::SetSourceFileSearchPaths_GetTooltip),
			FSlateIcon(),
			Action_SetSourceFilesSearchPath,
			NAME_None,
			EUserInterfaceActionType::Button
		);
	}
	...
	for (FTimerNodePtr& GroupPtr : FilteredGroupNodes)
	{
		...
		for (const FBaseTreeNodePtr& ChildPtr : GroupChildren)
		{
			...
			if (NodeAggregatedStats.InstanceCount > 0)
			{
				...
				AggregatedStats.AverageInstanceCount += NodeAggregatedStats.AverageInstanceCount;
				AggregatedStats.AverageInclusiveTime += NodeAggregatedStats.AverageInclusiveTime;
				AggregatedStats.AverageExclusiveTime += NodeAggregatedStats.AverageExclusiveTime;
...
TSharedRef<SWidget> STimersView::GetToggleButtonForTimerType(const ETimerNodeType NodeType)
{
	return SNew(SCheckBox)
		.Visibility_Lambda([this, NodeType]()
			{
				return static_cast<uint32>(NodeType) < static_cast<uint32>(ETimerNodeType::InvalidOrMax) &&
					bTimerTypeIsEnabled[static_cast<uint32>(NodeType)] ? EVisibility::Visible : EVisibility::Collapsed;
			})
		.Style(FAppStyle::Get(), "ToggleButtonCheckbox")
...
double STimersView::GetMinimumThreadRatio() const
{
	return 1.0f / (double)GThreadPool->GetNumThreads();
}

////////////////////////////////////////////////////////////////////////////////////////////////////

FText STimersView::GetThreadRatio() const
{
	if (Session.IsValid())
	{
		...
		if (TimingProfilerProvider)
		{
			...
			return FText::AsNumber((int)(TimingProfilerProvider->GetRatioOfThreadsToUse() * GThreadPool->GetNumThreads()));
		}
	}
	return FText::AsNumber((int)(0.75 * GThreadPool->GetNumThreads()));
}

////////////////////////////////////////////////////////////////////////////////////////////////////

void STimersView::OnThreadRatioCommited(double InNewValue)
{
	double ClampedNewValue = FMath::Clamp(
		InNewValue / GThreadPool->GetNumThreads(),
		GetMinimumThreadRatio(),
		1.0);
	...
	if (Session.IsValid())
	{
		...
		{
			TraceServices::FAnalysisSessionEditScope SessionEditScope(EditableSession);
			TimingProfilerProvider->SetRatioOfThreadsToUse(ClampedNewValue);
		}
	}

	FInsightsSettings& Settings = FInsightsManager::Get()->GetSettings();
	Settings.SetAndSaveThreadRatio(ClampedNewValue);
}
...
void STimersView::Tick(const FGeometry& AllottedGeometry, const double InCurrentTime, const float InDeltaTime)
{
	...
	if (Session.IsValid())
	{
		if (const TraceServices::ITimingProfilerProvider* TimingProfilerProvider = TraceServices::ReadTimingProfilerProvider(*Session.Get()))
		{
			...
			bTimerTypeIsEnabled[static_cast<int>(ETimerNodeType::GpuScope)] = TimingProfilerProvider->HasGpuTiming();
			bTimerTypeIsEnabled[static_cast<int>(ETimerNodeType::VerseSampling)] = TimingProfilerProvider->HasVerseTiming();
			bTimerTypeIsEnabled[static_cast<int>(ETimerNodeType::CpuScope)] = TimingProfilerProvider->HasCpuTiming();
		}
		else
		{
			bTimerTypeIsEnabled[static_cast<int>(ETimerNodeType::GpuScope)] = false;
			bTimerTypeIsEnabled[static_cast<int>(ETimerNodeType::VerseSampling)] = false;
			bTimerTypeIsEnabled[static_cast<int>(ETimerNodeType::CpuScope)] = false;
		}
		...
		if (const TraceServices::IStackSamplesProvider* StackSamplesProvider = TraceServices::ReadStackSamplesProvider(*Session.Get()))
		{
			...
			bTimerTypeIsEnabled[static_cast<int>(ETimerNodeType::CpuSampling)] = (StackSamplesProvider->GetTimelineCount() > 0);
		}
		else
		{
			bTimerTypeIsEnabled[static_cast<int>(ETimerNodeType::CpuSampling)] = false;
		}
	}
	else
	{
		...
		if (TimerCount != PreviousNodeCount)
		{
			...
			for (uint32 TimerIndex = PreviousNodeCount; TimerIndex < TimerCount; ++TimerIndex)
			{
				...
				const ETimerNodeType Type =
					Timer.Type == TraceServices::ETimingProfilerTimerType::GpuScope ? ETimerNodeType::GpuScope :
					Timer.Type == TraceServices::ETimingProfilerTimerType::VerseSampling ? ETimerNodeType::VerseSampling :
					Timer.Type == TraceServices::ETimingProfilerTimerType::CpuScope ? ETimerNodeType::CpuScope :
					Timer.Type == TraceServices::ETimingProfilerTimerType::CpuSampling ? ETimerNodeType::CpuSampling :
				...
				if (ProfilerWindow.IsValid() && ProfilerWindow->GetTimerColor(Timer.Id, ColorOverride))
				{
...
void STimersView::OpenSourceFileInIDE(FTimerNodePtr InNode) const
{
	...
	FString Path;
	ISourceCodeAccessModule& SourceCodeAccessModule = FModuleManager::LoadModuleChecked<ISourceCodeAccessModule>("SourceCodeAccess");
	if (FInsightsManager::Get()->GetSourceFilePathHelper().GetUsableFilePath(File, Path))
	{
		ISourceCodeAccessor& SourceCodeAccessor = SourceCodeAccessModule.GetAccessor();
		SourceCodeAccessor.OpenFileAtLine(Path, Line);
	}
	else
	{
		SourceCodeAccessModule.OnOpenFileFailed().Broadcast(Path);
	}
}

////////////////////////////////////////////////////////////////////////////////////////////////////
// Generate and Edit Colors
////////////////////////////////////////////////////////////////////////////////////////////////////

bool STimersView::ContextMenu_GenerateNewColor_CanExecute() const
{
	return AreSelectedTimerNodesValid();
}

////////////////////////////////////////////////////////////////////////////////////////////////////

void STimersView::ContextMenu_GenerateNewColor_Execute() const
{
	const TArray<FTimerNodePtr> SelectedNodes = TreeView->GetSelectedItems();
	for (const FTimerNodePtr& SelectedNode : SelectedNodes)
	{
		if (SelectedNode->Is<FTimerNode>())
		{
			FTimerNode& TimerNode = SelectedNode->As<FTimerNode>();
			SetRandomColorToNode(TimerNode);
		}
	}
};
...
void STimersView::SetColorToNode(FTimerNode& TimerNode, FLinearColor CustomColor) const
{
	TimerNode.SetColor(CustomColor);
	if (FTimingProfilerManager::Get().IsValid())
	{
		TSharedPtr<STimingProfilerWindow> ProfilerWindow = FTimingProfilerManager::Get()->GetProfilerWindow();
		if (ProfilerWindow.IsValid())
		{
			ProfilerWindow->SetTimerColor(TimerNode.GetTimerId(), CustomColor);
		}
	}
}
...
void STimersView::SetRandomColorToNode(FTimerNode& TimerNode) const
{
	...
	FLinearColor CustomColor = FLinearColor::MakeFromHSV8(H, S, V);
	CustomColor.A = 1.0f;
...
bool STimersView::ContextMenu_EditColor_CanExecute() const
{
	return AreSelectedTimerNodesValid();
}
...
void STimersView::ContextMenu_EditColor_Execute()
{
	...
	for (const FTimerNodePtr& SelectedNode : SelectedNodes)
	{
		...
		{
			FTimerNode& TimerNode = SelectedNode->As<FTimerNode>();
			EditableColorValue = TimerNode.GetColor();
			break;
		}
	}
	...
	FColorPickerArgs PickerArgs;
	{
		...
		PickerArgs.OnColorCommitted = FOnLinearColorValueChanged::CreateSP(this, &STimersView::SetEditableColor);
		PickerArgs.OnColorPickerCancelled = FOnColorPickerCancelled::CreateSP(this, &STimersView::ColorPickerCancelled);
...
FLinearColor STimersView::GetEditableColor() const
{
...
void STimersView::SetEditableColor(FLinearColor NewColor)
{
	...
	for (const FTimerNodePtr& SelectedNode : SelectedNodes)
	{
		...
		{
			FTimerNode& TimerNode = SelectedNode->As<FTimerNode>();
			SetColorToNode(TimerNode, EditableColorValue);
		}
	}
}
...
void STimersView::ColorPickerCancelled(FLinearColor OriginalColor)
{
...
void STimersView::ContextMenu_FindInstance_Execute(ESelectEventType EventType) const
{
	FTimerNodePtr SelectedNode = GetSingleSelectedTimerNode();
	if (!SelectedNode.IsValid())
	{
	...
	TimingView->SelectEventInstance(SelectedNode->GetTimerId(), EventType, false);
}
...
void STimersView::ContextMenu_FindInstanceInSelection_Execute(ESelectEventType EventType) const
{
	FTimerNodePtr SelectedNode = GetSingleSelectedTimerNode();
	if (!SelectedNode.IsValid() || SelectedNode->GetType() == ETimerNodeType::Group)
	{
	...
	TimingView->SelectEventInstance(SelectedNode->GetTimerId(), EventType, true);
}
...
void STimersView::SaveSettings()
{
	...
	Settings.SetTimersViewShowGpuTimers(static_cast<int32>(bTimerTypeIsVisible[static_cast<int32>(ETimerNodeType::GpuScope)]));
	Settings.SetTimersViewShowVerseSamplingTimers(static_cast<int32>(bTimerTypeIsVisible[static_cast<int32>(ETimerNodeType::VerseSampling)]));
	Settings.SetTimersViewShowCpuTimers(static_cast<int32>(bTimerTypeIsVisible[static_cast<int32>(ETimerNodeType::CpuScope)]));
	Settings.SetTimersViewShowCpuSamplingTimers(static_cast<int32>(bTimerTypeIsVisible[static_cast<int32>(ETimerNodeType::CpuSampling)]));
...
void STimersView::LoadSettings()
{
	...
	bTimerTypeIsVisible[static_cast<int32>(ETimerNodeType::GpuScope)] = Settings.GetTimersViewShowGpuTimers();
	bTimerTypeIsVisible[static_cast<int32>(ETimerNodeType::VerseSampling)] = Settings.GetTimersViewShowVerseSamplingTimers();
	bTimerTypeIsVisible[static_cast<int32>(ETimerNodeType::CpuScope)] = Settings.GetTimersViewShowCpuTimers();
	bTimerTypeIsVisible[static_cast<int32>(ETimerNodeType::CpuSampling)] = Settings.GetTimersViewShowCpuSamplingTimers();
...
bool STimersView::AreSelectedTimerNodesValid() const
{
	const TArray<FTimerNodePtr> SelectedNodes = TreeView->GetSelectedItems();
	for (const FTimerNodePtr& SelectedNode : SelectedNodes)
	{
...
FText STimersView::SetSourceFileSearchPaths_GetTooltip() const
{
	const FString& CurrentPath = FInsightsManager::Get()->GetSourceFilePathHelper().GetLocalRootDirectoryPath();
	return FText::Format(LOCTEXT("CurrentPathFmt", "Current path: {0}"), CurrentPath.Len() > 0 ? FText::FromString(CurrentPath) : LOCTEXT("None", "None"));
}

////////////////////////////////////////////////////////////////////////////////////////////////////

void STimersView::SetSourceFileSearchPaths_Execute()
{
	if (IDesktopPlatform* DesktopPlatform = FDesktopPlatformModule::Get())
	{
		...
		const FString& CurrentPath = FInsightsManager::Get()->GetSourceFilePathHelper().GetLocalRootDirectoryPath();
		const FString Title = LOCTEXT("SetSourceFileSeachPaths", "Select repository root folder...").ToString();
		...
		if (bHasSelected)
		{
			FInsightsManager::Get()->GetSourceFilePathHelper().SetUserDefinedPath(SelectedPath);
		}
	}
}
