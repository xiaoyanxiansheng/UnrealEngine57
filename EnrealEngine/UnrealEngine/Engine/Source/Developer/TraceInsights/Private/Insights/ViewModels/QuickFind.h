...
private:
	...
	// OnFindMaxEvent
public:
	/** The event to execute when the user selects the "Find Max" option. */
	DECLARE_MULTICAST_DELEGATE(FOnFindMaxEvent);
	FOnFindMaxEvent& GetOnFindMaxEvent() { return OnFindMaxEvent; }

private:
	FOnFindMaxEvent OnFindMaxEvent;

	////////////////////////////////////////////////////////////////////////////////////////////////////
	// OnFindMinEvent
public:
	/** The event to execute when the user selects the "Find Min" option. */
	DECLARE_MULTICAST_DELEGATE(FOnFindMinEvent);
	FOnFindMinEvent& GetOnFindMinEvent() { return OnFindMinEvent; }

private:
	FOnFindMinEvent OnFindMinEvent;	
