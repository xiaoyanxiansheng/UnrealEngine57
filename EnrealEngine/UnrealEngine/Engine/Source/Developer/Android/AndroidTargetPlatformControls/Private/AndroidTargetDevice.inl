...
inline bool FAndroidTargetDevice::PowerOn()
{
	...
	{
		return bool{UE::HAL::FProcess{{.Uri = *FPaths::Combine(AndroidHomeDirectory, TEXT("emulator"), TEXT("emulator")), .Arguments = *(TEXT("-avd ") + DeviceId.RightChop(4)), .bDetached = true, .bHidden = true}}};
	}
