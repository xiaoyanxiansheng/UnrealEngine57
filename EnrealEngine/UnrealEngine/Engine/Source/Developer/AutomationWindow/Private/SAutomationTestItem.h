...
protected:
	...
	*/
	...
	/**
	 * Returns whether of not test tags can be edited on test.
	*/
	EVisibility CanEditTags_GetVisibility() const;

	/**
	* Open Test Tags editor.
	* 
	* @return Editor reply result.
	*/
	FReply OnEditTestTagsClicked();
