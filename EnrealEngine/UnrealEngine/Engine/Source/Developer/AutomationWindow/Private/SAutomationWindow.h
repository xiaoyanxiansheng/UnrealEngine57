...
private:
	...
	*/
	...
	/** Handle selected tests tag editing. */
	void HandleEditTagsButtonClicked() const;
	/** Whether the edit tags button is enabled. */
	bool IsEditTagsButtonEnabled() const;
...
private:
	...
	/** The automation tag filter - filters tests based on tag expression. */
	...
	/** Holds a pointer to the tag filter widget. */
	TSharedPtr<SAutomationTestTagFilter> TagFilter;
};
