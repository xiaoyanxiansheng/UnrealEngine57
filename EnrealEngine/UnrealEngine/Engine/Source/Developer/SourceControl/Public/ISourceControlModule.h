...
DECLARE_DELEGATE_FourParams(FSourceControlPreSubmitChangelistValidationDelegate, FSourceControlChangelistPtr /*Changelist*/, EDataValidationResult& /*Result*/, TArray<FText>& /*ValidationErrors*/, TArray<FText>& /*ValidationWarnings*/);
DECLARE_DELEGATE_FourParams(FSourceControlPreSubmitFilesValidationDelegate, TArray<FSourceControlStateRef>& /*States*/, EDataValidationResult& /*Result*/, TArray<FText>& /*ValidationErrors*/, TArray<FText>& /*ValidationWarnings*/);
...
public:
	 ...
	 */
	UE_DEPRECATED(5.7, "Use RegisterPreSubmitChangelistValidation instead.")
	virtual void RegisterPreSubmitDataValidation(const FSourceControlPreSubmitDataValidationDelegate& PreSubmitDataValidationDelegate) { RegisterPreSubmitChangelistValidation(PreSubmitDataValidationDelegate); };

	/**
	 * Register a delegate to be called to validate asset changes by changelist before submitting changes
	 */
	virtual void RegisterPreSubmitChangelistValidation(const FSourceControlPreSubmitChangelistValidationDelegate& PreSubmitChangelistValidationDelegate) = 0;

	/**
	 * Register a delegate to be called to validate asset changes by files before submitting changes
	 */
	virtual void RegisterPreSubmitFilesValidation(const FSourceControlPreSubmitFilesValidationDelegate& PreSubmitFilesValidationDelegate) = 0;

	/**
	 * Unregister a delegate called before submitting changes
	 */
	UE_DEPRECATED(5.7, "Use UnregisterPreSubmitChangelistValidation instead.")
	virtual void UnregisterPreSubmitDataValidation() { UnregisterPreSubmitChangelistValidation(); };

	/**
	 * Unregister a delegate called before submitting changes
	 */
	virtual void UnregisterPreSubmitChangelistValidation() = 0;

	/**
	 * Unregister a delegate called before submitting changes
	 */
	virtual void UnregisterPreSubmitFilesValidation() = 0;

	/**
	 * Gets currently registered delegates for pre-submit data validation
	 */
	UE_DEPRECATED(5.7, "Use GetRegisteredPreSubmitChangelistValidation instead.")
	virtual FSourceControlPreSubmitDataValidationDelegate GetRegisteredPreSubmitDataValidation() { return GetRegisteredPreSubmitChangelistValidation(); };

	/**
	 * Gets currently registered delegates for pre-submit changelist validation
	 */
	virtual FSourceControlPreSubmitChangelistValidationDelegate GetRegisteredPreSubmitChangelistValidation() = 0;

	/**
	 * Gets currently registered delegates for pre-submit files validation
	 */
	virtual FSourceControlPreSubmitFilesValidationDelegate GetRegisteredPreSubmitFilesValidation() = 0;
