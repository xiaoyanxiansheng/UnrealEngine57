...
public:
	...
	virtual void RegisterPreSubmitChangelistValidation(const FSourceControlPreSubmitChangelistValidationDelegate& PreSubmitChangelistValidationDelegate) override;
	virtual void UnregisterPreSubmitChangelistValidation() override;
	virtual void RegisterPreSubmitFilesValidation(const FSourceControlPreSubmitFilesValidationDelegate& PreSubmitFilesValidationDelegate) override;
	virtual void UnregisterPreSubmitFilesValidation() override;
	virtual FSourceControlPreSubmitChangelistValidationDelegate GetRegisteredPreSubmitChangelistValidation() override;
	virtual FSourceControlPreSubmitFilesValidationDelegate GetRegisteredPreSubmitFilesValidation() override;
...
private:
	...
	/** To call when doing pre-submit changelist validation */
	FSourceControlPreSubmitChangelistValidationDelegate OnSourceControlPreSubmitChangelistValidation;

	/** To call when doing pre-submit files validation */
	FSourceControlPreSubmitFilesValidationDelegate OnSourceControlPreSubmitFilesValidation;
