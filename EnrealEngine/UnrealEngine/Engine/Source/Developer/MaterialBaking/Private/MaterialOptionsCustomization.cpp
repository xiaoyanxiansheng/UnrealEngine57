...
static const TArray<EMaterialProperty> DisabledProperties = { MP_Refraction, MP_FrontMaterial };
...
{	
	...
	PropertyRestriction->AddHiddenValue(GET_ENUMERATOR_NAME_CHECKED(EMaterialProperty, MP_WorldPositionOffset).ToString());
}
