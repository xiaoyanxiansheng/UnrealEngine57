...
struct FTextureBuildSettings
{
	...
	*/
	...
	// If NAME_None, this encodes with the first non-versioned astcenc (4.2.0).
	// This must not include "." since it's mixed in to the ddc key
	FName AstcEncVersion;
	...
	* ETextureEncodeEffort, ETextureUniversalTiling. */	
	...
	FTextureBuildSettings()
		...
		, ChromaticAdaptationMethod(1 /*UE::Color::DEFAULT_CHROMATIC_ADAPTATION_METHOD*/)
	...
	bool GetTextureExpectsAlphaInPixelFormat(bool bTopMipAlphaDetected) const
	{
