...
TSharedRef<SWidget> FIOSTargetSettingsCustomization::OnGetShaderVersionContent()
{
	...
	UEnum* Enum = FindObjectChecked<UEnum>(nullptr, TEXT("/Script/IOSRuntimeSettings.EIOSMetalShaderStandard"), EFindObjectFlags::ExactClass);
...
TSharedRef<SWidget> FIOSTargetSettingsCustomization::OnGetMinVersionContent()
{
	...
	UEnum* Enum = FindObjectChecked<UEnum>(nullptr, TEXT("/Script/IOSRuntimeSettings.EIOSVersion"), EFindObjectFlags::ExactClass);
