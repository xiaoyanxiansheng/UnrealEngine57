...
static FVector4 GAndroidPortraitSafezone(-1.0f, -1.0f, -1.0f, -1.0f), GAndroidLandscapeSafezone(-1.0f, -1.0f, -1.0f, -1.0f), *GAndroidLastSafezone = nullptr;
#if USE_ANDROID_JNI
void JNICALL UE::Jni::FGameActivity::nativeSetWindowInfo(JNIEnv* jenv, jobject thiz, jboolean bIsPortrait, jint DepthBufferPreference, jint PropagateAlpha)
{
...
void JNICALL UE::Jni::FGameActivity::nativeSetSurfaceViewInfo(JNIEnv* jenv, jobject thiz, jint width, jint height)
{
...
void JNICALL UE::Jni::FGameActivity::nativeSetSafezoneInfo(JNIEnv* jenv, jobject thiz, jboolean bIsPortrait, jfloat left, jfloat top, jfloat right, jfloat bottom)
{
	FVector4 NewSafezone(left, top, right, bottom);
	FVector4& TargetSafezone = bIsPortrait ? GAndroidPortraitSafezone : GAndroidLandscapeSafezone;
	bool SafezoneUpdated = TargetSafezone != NewSafezone || GAndroidLastSafezone != &TargetSafezone;
	GAndroidLastSafezone = &TargetSafezone;
	TargetSafezone = NewSafezone;
