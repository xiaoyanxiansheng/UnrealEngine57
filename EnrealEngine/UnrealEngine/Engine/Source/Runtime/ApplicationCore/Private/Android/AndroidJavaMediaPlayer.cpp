...
jint JNICALL UE::Jni::FMediaPlayer14::nativeReadAt(JNIEnv* jenv, jobject thiz, jlong Identifier, jlong Position, Nio::FByteBuffer* Buffer, jint Offset, jint Count)
{
...
FJavaAndroidMediaPlayer::FJavaAndroidMediaPlayer(bool swizzlePixels, bool vulkanRenderer, bool needTrackInfo, bool forceBitmapRenderLegacy)
	: TClassObject{swizzlePixels, vulkanRenderer, needTrackInfo}
	...
	, GetVideoLastMediaFrameDataMethod(GetClassMethod("getVideoLastMediaFrameData", "()Lcom/epicgames/unreal/BitmapRenderer$FrameData;"))
{
	...
	BRSelection = forceBitmapRenderLegacy ? BitmapRendererSelection::Legacy : BitmapRendererSelection::Unknown;
