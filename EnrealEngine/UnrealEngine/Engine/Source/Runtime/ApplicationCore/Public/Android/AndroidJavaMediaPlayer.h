...
namespace UE::Jni::Nio
{
	struct FByteBuffer: Java::Lang::FObject
	{
		static constexpr FAnsiStringView ClassName = "java/nio/ByteBuffer";
	};
}

namespace UE::Jni
{
	struct FMediaPlayer14: Java::Lang::FObject
	{
		static constexpr FAnsiStringView ClassName = "com/epicgames/unreal/MediaPlayer14";
		
		inline static TConstructor<FMediaPlayer14, jboolean, jboolean, jboolean> New;

		static jint JNICALL nativeReadAt(JNIEnv* env, jobject thiz, jlong Identifier, jlong Position, Nio::FByteBuffer* Buffer, jint Offset, jint Count);
		...
		{
			UE_JNI_NATIVE_METHOD(nativeReadAt)
		};
	};
	
	template struct TInitialize<FMediaPlayer14>;
}

// Wrapper for com/epicgames/unreal/MediaPlayer*.java.
class FJavaAndroidMediaPlayer : public UE::Jni::TClassObject<UE::Jni::FMediaPlayer14>
{
public:
	struct FAudioTrack
	{
...
public:
	FJavaAndroidMediaPlayer(bool swizzlePixels, bool vulkanRenderer, bool needTrackInfo, bool forceBitmapRenderLegacy = false);
