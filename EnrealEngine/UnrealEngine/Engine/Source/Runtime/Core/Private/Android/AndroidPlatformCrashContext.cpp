...
#if USE_ANDROID_JNI
void JNICALL UE::Jni::FGameActivity::nativeCrashContextSetStringKey(JNIEnv* jenv, jobject thiz, jstring JavaKey, jstring JavaValue)
{
	FString Key, Value;
...
void JNICALL UE::Jni::FGameActivity::nativeCrashContextSetBooleanKey(JNIEnv* jenv, jobject thiz, jstring JavaKey, jboolean JavaValue)
{
	FString Key;
	Key = FJavaHelper::FStringFromParam(jenv, JavaKey);
...
void JNICALL UE::Jni::FGameActivity::nativeCrashContextSetIntegerKey(JNIEnv* jenv, jobject thiz, jstring JavaKey, jint JavaValue)
{
	FString Key;
	Key = FJavaHelper::FStringFromParam(jenv, JavaKey);
...
void JNICALL UE::Jni::FGameActivity::nativeCrashContextSetFloatKey(JNIEnv* jenv, jobject thiz, jstring JavaKey, jfloat JavaValue)
{
	FString Key;
	Key = FJavaHelper::FStringFromParam(jenv, JavaKey);
...
void JNICALL UE::Jni::FGameActivity::nativeCrashContextSetDoubleKey(JNIEnv* jenv, jobject thiz, jstring JavaKey, jdouble JavaValue)
{
	FString Key;
	Key = FJavaHelper::FStringFromParam(jenv, JavaKey);
