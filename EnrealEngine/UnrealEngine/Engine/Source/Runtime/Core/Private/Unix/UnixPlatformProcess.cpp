...
bool FUnixPlatformProcess::GetPerFrameProcessorUsage(uint32 ProcessId, float& ProcessUsageFraction, float& IdleUsageFraction)
{
	...
	{
		UE_CLOG(!bProcStatPrintHasHappened, LogUtilization, Verbose, TEXT("Failed to open /proc/stat."));
	...
	{
		UE_CLOG(!bProcStatParsePrintHappened, LogUtilization, Verbose, TEXT("Failed to get the first line of /proc/stat."));
	...
	if (Result != 8)
	{
		UE_CLOG(!bProcStatGetLinePrintHappened, LogUtilization, Verbose, TEXT("Failed to parse the first line of /proc/stat."));
	...
	{
		UE_CLOG(!bProcPIDPrintHappened, LogUtilization, Verbose, TEXT("Could not open /proc/%d/stat to read PID usage."), ProcessId);
	...
	{
		UE_CLOG(!bProcPIDParsePrintHappened, LogUtilization, Verbose, TEXT("Could not get the first line of the PID stats file."));
