...
public:
	...
	UFUNCTION()
	GAMEPLAYTASKS_API void OnRep_SimulatedTasks();
	...
	*	activity into consideration*/
	...
	inline FGameplayResourceSet GetCurrentlyUsedResources() const { return CurrentlyClaimedResources; }
...
private:
	...
	inline bool CanProcessEvents() const { return !bInEventProcessingInProgress && (EventLockCounter == 0); }
	...
	/** Previously replicated tasks that run on simulated proxies */
	TArray<TWeakObjectPtr<UGameplayTask>> PreviousOnRepSimulatedTasks;
