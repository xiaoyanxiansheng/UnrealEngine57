...
bool UBlueprintGameplayTagLibrary::HasAnyMatchingGameplayTags(TScriptInterface<IGameplayTagAssetInterface> TagContainerInterface, const FGameplayTagContainer& OtherContainer)
{
	if (IGameplayTagAssetInterface* Interface = TagContainerInterface.GetInterface())
	{
		return Interface->HasAnyMatchingGameplayTags(OtherContainer);
	}
	return false;
}
