...
struct FGameplayTagNode
{
	 ...
	 */
	inline TArray< TSharedPtr<FGameplayTagNode> >& GetChildTagNodes() { return ChildTags; }
	 ...
	 * @return Reference to the array of the children nodes of this node
	 */
	inline const TArray< TSharedPtr<FGameplayTagNode> >& GetChildTagNodes() const { return ChildTags; }
	 ...
	 */
	inline TSharedPtr<FGameplayTagNode> GetParentTagNode() const { return ParentNode; }
...
public:
	 ...
	 */
	inline TSharedPtr<FGameplayTagNode> FindTagNode(const FGameplayTag& GameplayTag) const
	{
	 ...
	 * @return A shared pointer to the FGameplayTagNode found, or NULL if not found.
	 */
	inline TSharedPtr<FGameplayTagNode> FindTagNode(FName TagName) const
	{
