...
public:
	...
	/** Used at creation to define whether the current relative offset should be used instead of the provided one. */
	UPROPERTY(EditAnywhere, Transient, Category="Offset", meta = (DisplayPriority=0))
	bool bUseCurrentOffset = true;
...
public:
	...
	// UObject interface
	CONSTRAINTS_API virtual bool CanEditChange(const FProperty* InProperty) const override;
