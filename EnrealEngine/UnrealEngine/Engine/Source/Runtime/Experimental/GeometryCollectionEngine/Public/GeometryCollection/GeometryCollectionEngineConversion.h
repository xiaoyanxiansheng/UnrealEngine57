...
public:
	...
	*  @param InCollection: Geometry collection to convert to a skeletal mesh
	*  @param OutSkeletalMesh : skeletal mesh asset to export to
	*  @param OutSkeleton : Skeleton asset to export the bone hierarchy to
	*/
