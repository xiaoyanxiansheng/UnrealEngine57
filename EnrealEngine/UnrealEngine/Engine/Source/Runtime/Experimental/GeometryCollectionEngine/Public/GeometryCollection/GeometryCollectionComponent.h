...
inline FArchive& operator<<(FArchive& Ar, FGeometryCollectionActivatedCluster& ActivatedCluster)
{
...
public:
	...
	GEOMETRYCOLLECTIONENGINE_API virtual void OnComponentDestroyed(bool bDestroyingHierarchy) override;
...
public:
	...
	GEOMETRYCOLLECTIONENGINE_API virtual FMaterialRelevance GetMaterialRelevance(EShaderPlatform InShaderPlatform) const override;
	...
	*/
	...
	UFUNCTION(BlueprintCallable, CallInEditor, Category = "ChaosPhysics")
	...
	inline const UGeometryCollection* GetRestCollection() const { return RestCollection; }

	inline FGeometryCollectionEdit EditRestCollection(GeometryCollection::EEditUpdate EditUpdate = GeometryCollection::EEditUpdate::RestPhysicsDynamic, bool bShapeIsUnchanged = false) { return FGeometryCollectionEdit(this, EditUpdate, bShapeIsUnchanged); }
#if WITH_EDITOR
	inline FScopedColorEdit EditBoneSelection(bool bForceUpdate = false) { return FScopedColorEdit(this, bForceUpdate); }
...
#define COPY_ON_WRITE_ATTRIBUTES \
	...
	*/
	...
	inline const TArray<int32>& GetSelectedBones() const { return SelectedBones; }
	inline const TArray<int32>& GetHighlightedBones() const { return HighlightedBones; }
#endif
	...
	bool IsForceBrokenForCustomRenderer() const { return bForceBrokenForCustomRenderer; }
