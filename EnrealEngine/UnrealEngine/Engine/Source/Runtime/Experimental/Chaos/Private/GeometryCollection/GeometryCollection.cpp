...
const FName FGeometryCollection::InnerRadiusAttribute("InnerRadius");
const FName FGeometryCollection::OuterRadiusAttribute("OuterRadius");
const FName FGeometryCollection::FaceStartAttribute("FaceStart");
const FName FGeometryCollection::FaceCountAttribute("FaceCount");
const FName FGeometryCollection::FaceIndicesAttribute("Indices");
const FName FGeometryCollection::FaceVisibleAttribute("Visible");
const FName FGeometryCollection::MaterialIndexAttribute("MaterialIndex");
const FName FGeometryCollection::MaterialIDAttribute("MaterialID");
const FName FGeometryCollection::VertexPositionAttribute("Vertex");
const FName FGeometryCollection::VertexNormalAttribute("Normal");
const FName FGeometryCollection::VertexTangentUAttribute("TangentU");
const FName FGeometryCollection::VertexTangentVAttribute("TangentV");
const FName FGeometryCollection::VertexBoneMapAttribute("BoneMap");
...
void FGeometryCollection::DefineGeometrySchema(FManagedArrayCollection& InCollection)
{
	...
	InCollection.AddAttribute<bool>("Internal", FGeometryCollection::FacesGroup);
