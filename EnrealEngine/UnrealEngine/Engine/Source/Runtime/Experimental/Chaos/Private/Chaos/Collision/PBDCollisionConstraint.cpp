...
namespace Chaos
{
	...
	Chaos::FVec3f FPBDCollisionConstraint::GetNetLinearImpulse() const
	{
		FVec3f TotalNetImpulse = FVec3f(0, 0, 0);
		for (const FManifoldPointResult& ManifoldPoint : ManifoldPointResults)
		{
			TotalNetImpulse += ManifoldPoint.NetImpulse;
		}
		return TotalNetImpulse;
	}
