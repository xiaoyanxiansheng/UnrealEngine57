...
namespace Chaos
{
	...
	const Filter::FShapeFilterData FPerShapeData::GetShapeFilterData() const
	{
		return DownCast([](const auto& ShapeInstance) -> const auto { return ShapeInstance.GetShapeFilterData(); });
	}

	void FPerShapeData::SetShapeFilterData(const Filter::FShapeFilterData& InShapeFilter)
	{
		return DownCast([&InShapeFilter](auto& ShapeInstance) { ShapeInstance.SetShapeFilterData(InShapeFilter); });
	}

	const Filter::FInstanceData FPerShapeData::GetFilterInstanceData() const
	{
		return DownCast([](const auto& ShapeInstance) -> const auto { return ShapeInstance.GetFilterInstanceData(); });
	}

	void FPerShapeData::SetFilterInstanceData(const Filter::FInstanceData& InInstanceData)
	{
		return DownCast([&InInstanceData](auto& ShapeInstance) { ShapeInstance.SetFilterInstanceData(InInstanceData); });
	}

	const Filter::FCombinedShapeFilterData FPerShapeData::GetCombinedShapeFilterData() const
	{
		return DownCast([](const auto& ShapeInstance) -> const auto { return ShapeInstance.GetCombinedShapeFilterData(); });
	}

	void FPerShapeData::SetCombinedShapeFilterData(const Filter::FCombinedShapeFilterData& InShapeCombinedFilter)
	{
		return DownCast([&InShapeCombinedFilter](auto& ShapeInstance) { ShapeInstance.SetCombinedShapeFilterData(InShapeCombinedFilter); });
	}
	...
	const Filter::FShapeFilterData FShapeInstanceProxy::GetShapeFilterData() const
	{
		return CollisionData.Read().GetShapeFilterData();
	}

	void FShapeInstanceProxy::SetShapeFilterData(const Filter::FShapeFilterData& InShapeFilter)
	{
		CollisionData.Modify(true, DirtyFlags, Proxy, ShapeIdx, [InShapeFilter](FCollisionData& Data) { Data.SetShapeFilterData(InShapeFilter); });
	}

	const Filter::FInstanceData FShapeInstanceProxy::GetFilterInstanceData() const
	{
		return CollisionData.Read().GetFilterInstanceData();
	}

	void FShapeInstanceProxy::SetFilterInstanceData(const Filter::FInstanceData& InInstanceData)
	{
		CollisionData.Modify(true, DirtyFlags, Proxy, ShapeIdx, [InInstanceData](FCollisionData& Data) { Data.SetFilterInstanceData(InInstanceData); });
	}

	const Filter::FCombinedShapeFilterData FShapeInstanceProxy::GetCombinedShapeFilterData() const
	{
		return CollisionData.Read().GetCombinedShapeFilterData();
	}

	void FShapeInstanceProxy::SetCombinedShapeFilterData(const Filter::FCombinedShapeFilterData& InShapeCombinedFilter)
	{
		CollisionData.Modify(true, DirtyFlags, Proxy, ShapeIdx, [InShapeCombinedFilter](FCollisionData& Data) { Data.SetCombinedShapeFilterData(InShapeCombinedFilter); });
	}
	...
	const Filter::FShapeFilterData FShapeInstance::GetShapeFilterData() const
	{
		return CollisionData.GetShapeFilterData();
	}

	void FShapeInstance::SetShapeFilterData(const Filter::FShapeFilterData& InShapeFilter)
	{
		CollisionData.SetShapeFilterData(InShapeFilter);
	}

	const Filter::FInstanceData FShapeInstance::GetFilterInstanceData() const
	{
		return CollisionData.GetFilterInstanceData();
	}

	void FShapeInstance::SetFilterInstanceData(const Filter::FInstanceData& InInstanceData)
	{
		CollisionData.SetFilterInstanceData(InInstanceData);
	}

	const Filter::FCombinedShapeFilterData FShapeInstance::GetCombinedShapeFilterData() const
	{
		return CollisionData.GetCombinedShapeFilterData();
	}

	void FShapeInstance::SetCombinedShapeFilterData(const Filter::FCombinedShapeFilterData& InCombinedShapeFilter)
	{
		CollisionData.SetCombinedShapeFilterData(InCombinedShapeFilter);
	}
