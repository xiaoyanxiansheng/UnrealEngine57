...
public:
	...
	* @param SrcName - The name of the attribute being copied from
	* @param DestName - The name of the attribute being copied to
	* @param SrcGroup - The group that manages the attribute being copied from 
	* @param DstGroup - The group that manages the attribute being copied to
	*/
...
protected:
	...
	* @param InCollection - The collection we are ordering our group against. 
	* @param SrcGroup - The group that manages the attribute in the input collection
	* @param DstGroup - The group that manages the attribute in the output collection
	*/
