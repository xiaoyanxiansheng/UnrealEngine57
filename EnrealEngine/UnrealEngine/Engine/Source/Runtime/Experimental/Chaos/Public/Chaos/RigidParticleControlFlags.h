...
namespace Chaos
{
	...
	*/
	...
	public:
		...
		bool GetPartialIslandSleepAllowed() const { return Flags.bPartialIslandSleepAllowed; }
		FRigidParticleControlFlags& SetPartialIslandSleepAllowed(const bool bEnabled) { Flags.bPartialIslandSleepAllowed = bEnabled; return *this; }
	...
	private:
		struct FFlags
		{
			...
			FStorage bPartialIslandSleepAllowed : 1;
