...
namespace Chaos
{
	...
	*/
	...
	public:
		...
		// Can this constraint connect sleeping and active particles for partial island sleeping?
		virtual bool SupportsPartialIslandSleeping() const { return false; }

		virtual bool IsSleeping() const { return false; }
		virtual void SetIsSleeping(const bool bInIsSleeping) {}

		// Total net linear impulse applied by the velocity-based dynamics (VBD) solver (velocity iterations only).
		virtual FVec3f GetNetLinearImpulse() const { return FVec3f(0); }
