	...
	namespace Private
	{
		...
		*/
		...
		public:
			...
			{
				return (L.NumPositionIterations == R.NumPositionIterations) && (L.NumVelocityIterations == R.NumVelocityIterations) && (L.NumProjectionIterations == R.NumProjectionIterations);
			}
