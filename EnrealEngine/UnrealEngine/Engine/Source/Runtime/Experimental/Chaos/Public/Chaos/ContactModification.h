...
namespace Chaos
{
	...
	public:
		...
		*/
		...
		/**
		* @return true if this contact is an initial contact, i.e., the pair of shapes in the contact were not touching last frame.
		*/
		CHAOS_API bool GetIsInitialContact() const;

		/**
		* Set whether this contact is considered an initial contact. This controls how the contact behaves with regard to the initial
		* overlap depenetration system.
		*/
		...
		*/
		...
		/*
		* Whether this contact was generated from a CCD hit. Even if CCD is enabled for the bodies,
		* the hit may be a non-CCD contact if they are moving slowly.
		* NOTE: You can disable CCD in a MidPhase Modifier, but it is too late to do that here.
		*/
