...
namespace Chaos::Softs
{
	...
	private:
		...
		UE_CHAOS_DECLARE_INDEXED_PROPERTYCOLLECTION_NAME(SelfCollisionSphereRadius, float);
		UE_CHAOS_DECLARE_INDEXED_PROPERTYCOLLECTION_NAME(SelfCollisionSphereStiffness, float);
	};
}
#endif
