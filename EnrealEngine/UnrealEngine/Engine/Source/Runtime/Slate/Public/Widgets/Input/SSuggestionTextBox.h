...
public:
	...
	SLATE_BEGIN_ARGS(SSuggestionTextBox)
		...
		, _CommitOnSuggestionSelected(false)
		, _ErrorReporting()
	...
	{ }
		...
		/** Whether to commit text that was selected from the suggestions list. */
		SLATE_ATTRIBUTE(bool, CommitOnSuggestionSelected)
...
private:
	...
	// Trigger commit text event as soon as suggestion was selected.
	bool CommitsOnSuggestionSelected;
