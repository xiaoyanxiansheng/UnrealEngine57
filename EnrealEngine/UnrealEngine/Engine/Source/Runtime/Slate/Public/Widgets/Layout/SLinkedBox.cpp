...
{
	const uint32 CurrentDrawId = FSlateApplication::Get().GetCurrentDrawId();

	if (SlateApplicationDrawIdLastCached == CurrentDrawId)
	{
	...
	SlateApplicationDrawIdLastCached = CurrentDrawId;
