...
public:
	...
	/** @return True if this tab is currently locked */
...
private:
	/** Set whether the TabName should be hidden and not take up space for this Tab */
	SLATE_API void SetIsTabNameHidden(bool bInIsTabNameHidden);
	...
	/** Do the removal of the tab but doesn't emit tab close events */
	void RemoveTabFromParent_Internal();
	...
	/** If true the TabName will be hidden and not take up space for this tab */
	bool bIsTabNameHidden = false;
protected:
