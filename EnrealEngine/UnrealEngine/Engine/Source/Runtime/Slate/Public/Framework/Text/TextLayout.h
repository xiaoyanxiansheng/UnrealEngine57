...
public:
	...
	friend inline uint32 GetTypeHash(const FTextLocation& InSubject)
	{
...
public:
	...
	inline const TArray< FTextLayout::FLineView >& GetLineViews() const { return LineViews; }
	inline const TArray< FTextLayout::FLineModel >& GetLineModels() const { return LineModels; }
	...
	inline float GetWrappingWidth() const { return WrappingWidth; }
	SLATE_API void SetWrappingWidth( float Value );

	inline ETextWrappingPolicy GetWrappingPolicy() const { return WrappingPolicy; }
	SLATE_API void SetWrappingPolicy(ETextWrappingPolicy Value);

	inline float GetLineHeightPercentage() const { return LineHeightPercentage; }
	SLATE_API void SetLineHeightPercentage( float Value );

	inline bool GetApplyLineHeightToBottomLine() const { return ApplyLineHeightToBottomLine; }
	SLATE_API void SetApplyLineHeightToBottomLine( bool Value );

	inline ETextJustify::Type GetJustification() const { return Justification; }
	...
	inline ETextTransformPolicy GetTransformPolicy() const { return TransformPolicy; }
	SLATE_API void SetTransformPolicy(ETextTransformPolicy Value);

	inline float GetScale() const { return Scale; }
	SLATE_API void SetScale( float Value );

	inline ETextShapingMethod GetTextShapingMethod() const { return TextShapingMethod; }
	SLATE_API void SetTextShapingMethod( const ETextShapingMethod InTextShapingMethod );

	inline ETextFlowDirection GetTextFlowDirection() const { return TextFlowDirection; }
	...
	inline FMargin GetMargin() const { return Margin; }
