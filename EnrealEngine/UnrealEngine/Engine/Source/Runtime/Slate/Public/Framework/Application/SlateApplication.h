...
public:
	...
	/** @return Whether we disable the last drag on a new drag enter event to prevent double drag conflicts. */
...
private:
	...
	/** Are we disabling the last drag on a new drag enter event to prevent double drag conflicts?  */
