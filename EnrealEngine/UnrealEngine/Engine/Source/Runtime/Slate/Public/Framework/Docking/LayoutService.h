...
struct FLayoutSaveRestore
{
	...
	/**
	 * Write the desired value into the desired section of a named config file.
	...
	UE_DEPRECATED(5.7, "SaveSectionToConfig using FText value is deprecated. Please use the SaveSectionToConfig function using FString.")
