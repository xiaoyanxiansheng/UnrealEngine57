...
public:
	...
	inline int32 GetUserIndex() const { return UserIndex; }
	inline int32 GetVirtualUserIndex() const { return VirtualUserIndex; }
...
public:
	...
	inline int32 GetUserIndex() const { return UserIndex; }
	inline FPlatformUserId GetPlatformUserId() const { return PlatformUser; }
	inline bool IsVirtualUser() const { return !Cursor.IsValid(); }
...
SLATE_SCOPE:
	...
	inline bool HasValidFocusPath() const { return WeakFocusPath.IsValid(); }
	inline const FWeakWidgetPath& GetWeakFocusPath() const { return WeakFocusPath; }
	
	inline TSharedRef<FWidgetPath> GetFocusPath() const
	{
...
private:
	...
	/** Whether we need to call QueryCursor because bCanDrawCursor was enabled */
	bool bNeedQueryForVisibleCursor = true;
