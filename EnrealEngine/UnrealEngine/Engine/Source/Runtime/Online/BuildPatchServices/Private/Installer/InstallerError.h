...
namespace BuildPatchServices
{
	...
	namespace InitializationErrorCodes
	{
		...
		static const TCHAR* InvalidInstallToMemory = TEXT("08");
		static const TCHAR* InvalidMemoryConstructionConfig = TEXT("09");
	}
	 ...
	 */
	FString EnumToString(const EBuildPatchInstallError& ErrorType);
}
