...
void FNullHttpRequest::SetPriority(EHttpRequestPriority InPriority)
{
}

EHttpRequestPriority FNullHttpRequest::GetPriority() const
{
	return EHttpRequestPriority::Normal;
}
