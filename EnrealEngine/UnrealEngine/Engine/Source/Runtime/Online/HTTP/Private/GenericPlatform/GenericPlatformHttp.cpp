...
public:
	...
	HTTP_API virtual void SetPriority(EHttpRequestPriority InPriority) override {}
	HTTP_API virtual EHttpRequestPriority GetPriority() const override { return EHttpRequestPriority::Normal; }
