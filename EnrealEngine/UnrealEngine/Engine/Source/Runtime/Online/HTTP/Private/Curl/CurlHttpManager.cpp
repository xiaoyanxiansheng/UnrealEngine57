...
TAutoConsoleVariable<bool> CVarHttpCurlReuseConnectionEnabled(
...
void FCurlHttpManager::FCurlRequestOptions::Log()
{
	...
	UE_LOG(LogInit, Log, TEXT(" - CVarHttpCurlReuseConnectionEnabled = %s  - Libcurl will %sreuse connections"),
		CVarHttpCurlReuseConnectionEnabled.GetValueOnAnyThread() ? TEXT("true") : TEXT("false"),
		CVarHttpCurlReuseConnectionEnabled.GetValueOnAnyThread() ? TEXT("") : TEXT("NOT ")
		);
