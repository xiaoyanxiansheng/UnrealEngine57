...
/**
 * Enumerates priority to decide how the request will be queued when max concurrent limit reached
 * The priority will be compared through value, so it's important to keep the order from low to high
 */
...
namespace HttpRequestOptions
{
	...
	static const FName RequestMode("RequestMode");
...
public:
	...
	*/
	 ...
	 *
	 * @param InHttpRequestPriority - The priority to set
	 */
