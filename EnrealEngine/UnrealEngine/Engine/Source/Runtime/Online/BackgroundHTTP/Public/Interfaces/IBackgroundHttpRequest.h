 ...
 * @param Request Background Http Request for which the metrics were calculated
 * @param BackgroundHttpRequestMetricsExtended struct containing all the metrics
 */
DECLARE_DELEGATE_TwoParams(FBackgroundHttpRequestMetricsExtendedDelegate, FBackgroundHttpRequestPtr /* Request */, FBackgroundHttpRequestMetricsExtended /* All the metrics on the request */);
...
public:
	...
	*/
	 ...
	 */
	UE_DEPRECATED(5.7, "IBackgroundHttpRequest::OnRequestMetrics is deprecated, please use IBackgroundHttpRequest::OnRequestMetricsExtended instead.")
	 ...
	 */
	UE_DEPRECATED(5.7, "IBackgroundHttpRequest::SetMetrics is deprecated, please use IBackgroundHttpRequest::SetMetricsExtended instead.")
