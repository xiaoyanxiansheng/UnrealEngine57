...
struct FInstallManagerBundleReport;
...
public:
	...
	static INSTALLBUNDLEMANAGER_API FInstallBundleManagerAllDownloadsCompleted AllDownloadsCompletedDelegate; // Called when all content downloads completed
