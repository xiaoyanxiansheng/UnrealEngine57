...
DECLARE_DELEGATE_FourParams(FInstallBundleRequestStartedDelegate, const FName& /*BundleName*/, const FString& /*ManifestName*/, const FString& /*ManifestPath*/, const FString& /*ManifestVersion*/);
DECLARE_DELEGATE_TwoParams(FInstallBundleRequestCompletedDelegate, const FName& /*BundleName*/, const FBundleRequestCompleteInfo& /*AnalyticInfo*/);
...
public:
	...
	virtual bool SupportsReportingDelegate() const { return false; }
	virtual void SetReportingDelegate(FInstallBundleReportingDelegate Delegate) {}
	
	virtual bool SupportsBundleRequestEventDelegates() const { return false; }
