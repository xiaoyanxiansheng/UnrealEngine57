	...
	EDepthDrawingMode DepthDrawingMode)
{
		...
		[&View, DrawRenderState, DepthDrawingMode](FRHICommandList& RHICmdList)
	{
		...
		if (!View.Family->EngineShowFlags.CompositeEditorPrimitives)
		{
			...
			View.BatchedViewElements.Draw(RHICmdList, DrawRenderState, View.FeatureLevel, View, false, 1.0f, EBlendModeFilter::All, View.GetStereoPassInstanceFactor());
			...
			// Draw the view's batched simple elements(lines, sprites, etc).
			View.TopBatchedViewElements.Draw(RHICmdList, DrawRenderState, View.FeatureLevel, View, false, 1.0f, EBlendModeFilter::All, View.GetStereoPassInstanceFactor());
		}
	});
}
