	...
	FLumenScreenSpaceBentNormalParameters& ScreenSpaceBentNormalParameters)
{
	...
	ReSTIRParameters.DownsampledSceneDepth = FrameTemporaries.DownsampledSceneDepth2x2.CreateSharedRT(GraphBuilder, DownsampledSceneDepthDesc, ReservoirViewExtent, TEXT("Lumen.ReSTIRGather.DownsampledSceneDepth"));
	...
	ReSTIRParameters.DownsampledWorldNormal = FrameTemporaries.DownsampledWorldNormal2x2.CreateSharedRT(GraphBuilder, DownsampledWorldNormalDesc, ReservoirViewExtent, TEXT("Lumen.ReSTIRGather.DownsampledWorldNormal"));
	...
	if (GLumenReSTIRGatherShortRangeAmbientOcclusion != 0 && ViewFamily.EngineShowFlags.LumenShortRangeAmbientOcclusion)
	{
		...
		ScreenSpaceBentNormalParameters = ComputeScreenSpaceShortRangeAO(GraphBuilder, Scene, View, FrameTemporaries, SceneTextures, LightingChannelsTexture, BlueNoise, FVector2f(MaxScreenTraceFraction), 1.0f, ComputePassFlags);
	}
