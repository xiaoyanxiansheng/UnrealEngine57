...
BEGIN_SHADER_PARAMETER_STRUCT(FEyeAdaptationParameters, )
	...
	SHADER_PARAMETER(FVector2f, EV100ToExposureCompensationCurveLUTScaleBias)
	SHADER_PARAMETER_TEXTURE(Texture2D, ExposureCompensationCurveLUT)
	SHADER_PARAMETER_SAMPLER(SamplerState, ExposureCompensationCurveSampler)
