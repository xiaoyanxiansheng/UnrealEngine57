	...
	TArray<FPSOPrecacheData>& PSOInitializers)
{
	...
	// Collect PSOs for all possible default material combinations
	{
		...
		CollectPSOInitializersInternal<true>(VertexFactoryData, Material, MeshFillMode, MeshCullMode, PT_TriangleList, PSOInitializers);
		CollectPSOInitializersInternal<false>(VertexFactoryData, Material, MeshFillMode, MeshCullMode, PT_TriangleList, PSOInitializers);
	}
	{
