...
namespace Audio
{
	...
	public:
		...
		inline void SetFrequency(const float InFrequency)
		{
		...
		inline float ProcessAudioSample(const float InputSample)
		{
	...
	public:
		...
		inline void ProcessAudio(float* InputFrame, float* OutputFrame)
		{			
