...
struct FWrapLayer
{
	...
	static void CmdBeginRenderingKHR(VkResult Result, VkCommandBuffer CommandBuffer, const VkRenderingInfo* RenderingInfo) VULKAN_LAYER_BODY
	static void CmdEndRenderingKHR(VkResult Result, VkCommandBuffer CommandBuffer) VULKAN_LAYER_BODY
	...
	static void CreateShadersEXT(VkResult Result, VkDevice Device, uint32_t CreateInfoCount, const VkShaderCreateInfoEXT* CreateInfos, const VkAllocationCallbacks* Allocator, VkShaderEXT* Shaders) VULKAN_LAYER_BODY
	static void DestroyShaderEXT(VkResult Result, VkDevice Device, VkShaderEXT Shader, const VkAllocationCallbacks* Allocator) VULKAN_LAYER_BODY
	static void GetShaderBinaryDataEXT(VkResult Result, VkDevice Device, VkShaderEXT Shader, size_t* DataSize, void* Data) VULKAN_LAYER_BODY
	static void CmdBindShadersEXT(VkResult Result, VkCommandBuffer CommandBuffer, uint32_t StageCount, const VkShaderStageFlagBits* Stages, const VkShaderEXT* Shaders) VULKAN_LAYER_BODY
	static void CmdBindVertexBuffers2EXT(VkResult Result, VkCommandBuffer CommandBuffer, uint32_t FirstBinding, uint32_t BindingCount, const VkBuffer* Buffers, const VkDeviceSize* Offsets, const VkDeviceSize* Sizes, const VkDeviceSize* Strides) VULKAN_LAYER_BODY
	static void CmdSetCullModeEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkCullModeFlags CullMode) VULKAN_LAYER_BODY
	static void CmdSetColorBlendEnableEXT(VkResult Result, VkCommandBuffer CommandBuffer, uint32_t FirstAttachment, uint32_t AttachmentCount, const VkBool32* ColorBlendEnables) VULKAN_LAYER_BODY
	static void CmdSetColorBlendEquationEXT(VkResult Result, VkCommandBuffer CommandBuffer, uint32_t FirstAttachment, uint32_t AttachmentCount, const VkColorBlendEquationEXT* ColorBlendEquations) VULKAN_LAYER_BODY
	static void CmdSetColorWriteMaskEXT(VkResult Result, VkCommandBuffer CommandBuffer, uint32_t FirstAttachment, uint32_t AttachmentCount, const VkColorComponentFlags* ColorWriteMasks) VULKAN_LAYER_BODY
	static void CmdSetFrontFaceEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkFrontFace FrontFace) VULKAN_LAYER_BODY
	static void CmdSetPolygonModeEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkPolygonMode PolygonMode) VULKAN_LAYER_BODY
	static void CmdSetPrimitiveTopologyEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkPrimitiveTopology PrimitiveTopology) VULKAN_LAYER_BODY
	static void CmdSetRasterizationSamplesEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkSampleCountFlagBits RasterizationSamples) VULKAN_LAYER_BODY
	static void CmdSetScissorWithCountEXT(VkResult Result, VkCommandBuffer CommandBuffer, uint32_t ScissorCount, const VkRect2D* Scissors) VULKAN_LAYER_BODY
	static void CmdSetStencilOpEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkStencilFaceFlags FaceMask, VkStencilOp FailOp, VkStencilOp passOp, VkStencilOp depthFailOp, VkCompareOp compareOp) VULKAN_LAYER_BODY
	static void CmdSetStencilTestEnableEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkBool32 StencilTestEnable) VULKAN_LAYER_BODY
	static void CmdSetVertexInputEXT(VkResult Result, VkCommandBuffer CommandBuffer, uint32_t VertexBindingDescriptionCount, const VkVertexInputBindingDescription2EXT* pVertexBindingDescriptions, uint32_t vertexAttributeDescriptionCount, const VkVertexInputAttributeDescription2EXT* pVertexAttributeDescriptions) VULKAN_LAYER_BODY
	static void CmdSetViewportWithCountEXT(VkResult Result, VkCommandBuffer CommandBuffer, uint32_t ViewportCount, const VkViewport* pViewports) VULKAN_LAYER_BODY
	static void CmdSetDepthBiasEnableEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkBool32 DepthBiasEnable) VULKAN_LAYER_BODY
	static void CmdSetDepthBoundsTestEnableEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkBool32 DepthBoundsTestEnable) VULKAN_LAYER_BODY
	static void CmdSetDepthClampEnableEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkBool32 DepthClampEnable) VULKAN_LAYER_BODY
	static void CmdSetDepthCompareOpEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkCompareOp DepthCompareOp) VULKAN_LAYER_BODY
	static void CmdSetDepthTestEnableEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkBool32 DepthTestEnable) VULKAN_LAYER_BODY
	static void CmdSetDepthWriteEnableEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkBool32 DepthWriteEnable) VULKAN_LAYER_BODY
	static void CmdSetRasterizerDiscardEnableEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkBool32 RasterizerDiscardEnable) VULKAN_LAYER_BODY
	static void CmdSetPrimitiveRestartEnableEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkBool32 PrimitiveRestartEnable) VULKAN_LAYER_BODY
	static void CmdSetLogicOpEnableEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkBool32 LogicOpEnable) VULKAN_LAYER_BODY
	static void CmdSetAlphaToCoverageEnableEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkBool32 AlphaToCoverageEnable) VULKAN_LAYER_BODY
	static void CmdSetAlphaToOneEnableEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkBool32 AlphaToOneEnable) VULKAN_LAYER_BODY

	static void CopyMemoryToImageEXT(VkResult Result, VkDevice Device, const VkCopyMemoryToImageInfo* CopyMemoryToImageInfo) VULKAN_LAYER_BODY
	static void TransitionImageLayoutEXT(VkResult Result, VkDevice Device, uint32_t TransitionCount, const VkHostImageLayoutTransitionInfo* Transitions) VULKAN_LAYER_BODY
};
...
namespace VulkanRHI
{
	...
	static FORCEINLINE_DEBUGGABLE void vkCmdBeginRenderingKHR(VkCommandBuffer CommandBuffer, const VkRenderingInfo* RenderingInfo)
	{
		FWrapLayer::CmdBeginRenderingKHR(VK_RESULT_MAX_ENUM, CommandBuffer, RenderingInfo);
		VULKANAPINAMESPACE::vkCmdBeginRenderingKHR(CommandBuffer, RenderingInfo);
		FWrapLayer::CmdBeginRenderingKHR(VK_SUCCESS, CommandBuffer, RenderingInfo);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdEndRenderingKHR(VkCommandBuffer CommandBuffer)
	{
		FWrapLayer::CmdEndRenderingKHR(VK_RESULT_MAX_ENUM, CommandBuffer);
		VULKANAPINAMESPACE::vkCmdEndRenderingKHR(CommandBuffer);
		FWrapLayer::CmdEndRenderingKHR(VK_SUCCESS, CommandBuffer);
	}
	...
	static FORCEINLINE_DEBUGGABLE VkResult vkCreateShadersEXT(VkDevice Device, uint32_t CreateInfoCount, const VkShaderCreateInfoEXT* CreateInfos, const VkAllocationCallbacks* Allocator, VkShaderEXT* Shaders)
	{
		FWrapLayer::CreateShadersEXT(VK_RESULT_MAX_ENUM, Device, CreateInfoCount, CreateInfos, Allocator, Shaders);
		const VkResult Result = VULKANAPINAMESPACE::vkCreateShadersEXT(Device, CreateInfoCount, CreateInfos, Allocator, Shaders);
		FWrapLayer::CreateShadersEXT(Result, Device, CreateInfoCount, CreateInfos, Allocator, Shaders);
		return Result;
	}

	static FORCEINLINE_DEBUGGABLE void vkDestroyShaderEXT(VkDevice Device, VkShaderEXT Shader, const VkAllocationCallbacks* Allocator)
	{
		FWrapLayer::DestroyShaderEXT(VK_RESULT_MAX_ENUM, Device, Shader, Allocator);
		VULKANAPINAMESPACE::vkDestroyShaderEXT(Device, Shader, Allocator);
		FWrapLayer::DestroyShaderEXT(VK_SUCCESS, Device, Shader, Allocator);
	}

	static FORCEINLINE_DEBUGGABLE VkResult vkGetShaderBinaryDataEXT(VkDevice Device, VkShaderEXT Shader, size_t* DataSize, void* Data)
	{
		FWrapLayer::GetShaderBinaryDataEXT(VK_RESULT_MAX_ENUM, Device, Shader, DataSize, Data);
		const VkResult Result = VULKANAPINAMESPACE::vkGetShaderBinaryDataEXT(Device, Shader, DataSize, Data);
		FWrapLayer::GetShaderBinaryDataEXT(Result, Device, Shader, DataSize, Data);
		return Result;
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdBindShadersEXT(VkCommandBuffer CommandBuffer, uint32_t StageCount, const VkShaderStageFlagBits* Stages, const VkShaderEXT* Shaders)
	{
		FWrapLayer::CmdBindShadersEXT(VK_RESULT_MAX_ENUM, CommandBuffer, StageCount, Stages, Shaders);
		VULKANAPINAMESPACE::vkCmdBindShadersEXT(CommandBuffer, StageCount, Stages, Shaders);
		FWrapLayer::CmdBindShadersEXT(VK_SUCCESS, CommandBuffer, StageCount, Stages, Shaders);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdBindVertexBuffers2EXT(VkCommandBuffer CommandBuffer, uint32_t FirstBinding, uint32_t BindingCount, const VkBuffer* Buffers, const VkDeviceSize* Offsets, const VkDeviceSize* Sizes, const VkDeviceSize* Strides)
	{
		FWrapLayer::CmdBindVertexBuffers2EXT(VK_RESULT_MAX_ENUM, CommandBuffer, FirstBinding, BindingCount, Buffers, Offsets, Sizes, Strides);
		VULKANAPINAMESPACE::vkCmdBindVertexBuffers2EXT(CommandBuffer, FirstBinding, BindingCount, Buffers, Offsets, Sizes, Strides);
		FWrapLayer::CmdBindVertexBuffers2EXT(VK_SUCCESS, CommandBuffer, FirstBinding, BindingCount, Buffers, Offsets, Sizes, Strides);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetCullModeEXT(VkCommandBuffer CommandBuffer, VkCullModeFlags CullMode)
	{
		FWrapLayer::CmdSetCullModeEXT(VK_RESULT_MAX_ENUM, CommandBuffer, CullMode);
		VULKANAPINAMESPACE::vkCmdSetCullModeEXT(CommandBuffer, CullMode);
		FWrapLayer::CmdSetCullModeEXT(VK_SUCCESS, CommandBuffer, CullMode);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetColorBlendEnableEXT(VkCommandBuffer CommandBuffer, uint32_t FirstAttachment, uint32_t AttachmentCount, const VkBool32* ColorBlendEnables)
	{
		FWrapLayer::CmdSetColorBlendEnableEXT(VK_RESULT_MAX_ENUM, CommandBuffer, FirstAttachment, AttachmentCount, ColorBlendEnables);
		VULKANAPINAMESPACE::vkCmdSetColorBlendEnableEXT(CommandBuffer, FirstAttachment, AttachmentCount, ColorBlendEnables);
		FWrapLayer::CmdSetColorBlendEnableEXT(VK_SUCCESS, CommandBuffer, FirstAttachment, AttachmentCount, ColorBlendEnables);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetColorBlendEquationEXT(VkCommandBuffer CommandBuffer, uint32_t FirstAttachment, uint32_t AttachmentCount, const VkColorBlendEquationEXT* ColorBlendEquations)
	{
		FWrapLayer::CmdSetColorBlendEquationEXT(VK_RESULT_MAX_ENUM, CommandBuffer, FirstAttachment, AttachmentCount, ColorBlendEquations);
		VULKANAPINAMESPACE::vkCmdSetColorBlendEquationEXT(CommandBuffer, FirstAttachment, AttachmentCount, ColorBlendEquations);
		FWrapLayer::CmdSetColorBlendEquationEXT(VK_SUCCESS, CommandBuffer, FirstAttachment, AttachmentCount, ColorBlendEquations);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetColorWriteMaskEXT(VkCommandBuffer CommandBuffer, uint32_t FirstAttachment, uint32_t AttachmentCount, const VkColorComponentFlags* ColorWriteMasks)
	{
		FWrapLayer::CmdSetColorWriteMaskEXT(VK_RESULT_MAX_ENUM, CommandBuffer, FirstAttachment, AttachmentCount, ColorWriteMasks);
		VULKANAPINAMESPACE::vkCmdSetColorWriteMaskEXT(CommandBuffer, FirstAttachment, AttachmentCount, ColorWriteMasks);
		FWrapLayer::CmdSetColorWriteMaskEXT(VK_SUCCESS, CommandBuffer, FirstAttachment, AttachmentCount, ColorWriteMasks);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetFrontFaceEXT(VkCommandBuffer CommandBuffer, VkFrontFace FrontFace)
	{
		FWrapLayer::CmdSetFrontFaceEXT(VK_RESULT_MAX_ENUM, CommandBuffer, FrontFace);
		VULKANAPINAMESPACE::vkCmdSetFrontFaceEXT(CommandBuffer, FrontFace);
		FWrapLayer::CmdSetFrontFaceEXT(VK_SUCCESS, CommandBuffer, FrontFace);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetPolygonModeEXT(VkCommandBuffer CommandBuffer, VkPolygonMode PolygonMode)
	{
		FWrapLayer::CmdSetPolygonModeEXT(VK_RESULT_MAX_ENUM, CommandBuffer, PolygonMode);
		VULKANAPINAMESPACE::vkCmdSetPolygonModeEXT(CommandBuffer, PolygonMode);
		FWrapLayer::CmdSetPolygonModeEXT(VK_SUCCESS, CommandBuffer, PolygonMode);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetPrimitiveTopologyEXT(VkCommandBuffer CommandBuffer, VkPrimitiveTopology PrimitiveTopology)
	{
		FWrapLayer::CmdSetPrimitiveTopologyEXT(VK_RESULT_MAX_ENUM, CommandBuffer, PrimitiveTopology);
		VULKANAPINAMESPACE::vkCmdSetPrimitiveTopologyEXT(CommandBuffer, PrimitiveTopology);
		FWrapLayer::CmdSetPrimitiveTopologyEXT(VK_SUCCESS, CommandBuffer, PrimitiveTopology);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetRasterizationSamplesEXT(VkCommandBuffer CommandBuffer, VkSampleCountFlagBits RasterizationSamples)
	{
		FWrapLayer::CmdSetRasterizationSamplesEXT(VK_RESULT_MAX_ENUM, CommandBuffer, RasterizationSamples);
		VULKANAPINAMESPACE::vkCmdSetRasterizationSamplesEXT(CommandBuffer, RasterizationSamples);
		FWrapLayer::CmdSetRasterizationSamplesEXT(VK_SUCCESS, CommandBuffer, RasterizationSamples);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetScissorWithCountEXT(VkCommandBuffer CommandBuffer, uint32_t ScissorCount, const VkRect2D* Scissors)
	{
		FWrapLayer::CmdSetScissorWithCountEXT(VK_RESULT_MAX_ENUM, CommandBuffer, ScissorCount, Scissors);
		VULKANAPINAMESPACE::vkCmdSetScissorWithCountEXT(CommandBuffer, ScissorCount, Scissors);
		FWrapLayer::CmdSetScissorWithCountEXT(VK_SUCCESS, CommandBuffer, ScissorCount, Scissors);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetStencilOpEXT(VkCommandBuffer CommandBuffer, VkStencilFaceFlags FaceMask, VkStencilOp FailOp, VkStencilOp PassOp, VkStencilOp DepthFailOp, VkCompareOp CompareOp)
	{
		FWrapLayer::CmdSetStencilOpEXT(VK_RESULT_MAX_ENUM, CommandBuffer, FaceMask, FailOp, PassOp, DepthFailOp, CompareOp);
		VULKANAPINAMESPACE::vkCmdSetStencilOpEXT(CommandBuffer, FaceMask, FailOp, PassOp, DepthFailOp, CompareOp);
		FWrapLayer::CmdSetStencilOpEXT(VK_SUCCESS, CommandBuffer, FaceMask, FailOp, PassOp, DepthFailOp, CompareOp);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetStencilTestEnableEXT(VkCommandBuffer CommandBuffer, VkBool32 StencilTestEnable)
	{
		FWrapLayer::CmdSetStencilTestEnableEXT(VK_RESULT_MAX_ENUM, CommandBuffer, StencilTestEnable);
		VULKANAPINAMESPACE::vkCmdSetStencilTestEnableEXT(CommandBuffer, StencilTestEnable);
		FWrapLayer::CmdSetStencilTestEnableEXT(VK_SUCCESS, CommandBuffer, StencilTestEnable);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetVertexInputEXT(VkCommandBuffer CommandBuffer, uint32_t VertexBindingDescriptionCount, const VkVertexInputBindingDescription2EXT* VertexBindingDescriptions, uint32_t VertexAttributeDescriptionCount, const VkVertexInputAttributeDescription2EXT* VertexAttributeDescriptions)
	{
		FWrapLayer::CmdSetVertexInputEXT(VK_RESULT_MAX_ENUM, CommandBuffer, VertexBindingDescriptionCount, VertexBindingDescriptions, VertexAttributeDescriptionCount, VertexAttributeDescriptions);
		VULKANAPINAMESPACE::vkCmdSetVertexInputEXT(CommandBuffer, VertexBindingDescriptionCount, VertexBindingDescriptions, VertexAttributeDescriptionCount, VertexAttributeDescriptions);
		FWrapLayer::CmdSetVertexInputEXT(VK_SUCCESS, CommandBuffer, VertexBindingDescriptionCount, VertexBindingDescriptions, VertexAttributeDescriptionCount, VertexAttributeDescriptions);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetViewportWithCountEXT(VkCommandBuffer CommandBuffer, uint32_t ViewportCount, const VkViewport* Viewports)
	{
		FWrapLayer::CmdSetViewportWithCountEXT(VK_RESULT_MAX_ENUM, CommandBuffer, ViewportCount, Viewports);
		VULKANAPINAMESPACE::vkCmdSetViewportWithCountEXT(CommandBuffer, ViewportCount, Viewports);
		FWrapLayer::CmdSetViewportWithCountEXT(VK_SUCCESS, CommandBuffer, ViewportCount, Viewports);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetDepthBiasEnableEXT(VkCommandBuffer CommandBuffer, VkBool32 DepthBiasEnable)
	{
		FWrapLayer::CmdSetDepthBiasEnableEXT(VK_RESULT_MAX_ENUM, CommandBuffer, DepthBiasEnable);
		VULKANAPINAMESPACE::vkCmdSetDepthBiasEnableEXT(CommandBuffer, DepthBiasEnable);
		FWrapLayer::CmdSetDepthBiasEnableEXT(VK_SUCCESS, CommandBuffer, DepthBiasEnable);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetDepthBoundsTestEnableEXT(VkCommandBuffer CommandBuffer, VkBool32 DepthBoundsTestEnable)
	{
		FWrapLayer::CmdSetDepthBoundsTestEnableEXT(VK_RESULT_MAX_ENUM, CommandBuffer, DepthBoundsTestEnable);
		VULKANAPINAMESPACE::vkCmdSetDepthBoundsTestEnableEXT(CommandBuffer, DepthBoundsTestEnable);
		FWrapLayer::CmdSetDepthBoundsTestEnableEXT(VK_SUCCESS, CommandBuffer, DepthBoundsTestEnable);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetDepthClampEnableEXT(VkCommandBuffer CommandBuffer, VkBool32 DepthClampEnable)
	{
		FWrapLayer::CmdSetDepthClampEnableEXT(VK_RESULT_MAX_ENUM, CommandBuffer, DepthClampEnable);
		VULKANAPINAMESPACE::vkCmdSetDepthClampEnableEXT(CommandBuffer, DepthClampEnable);
		FWrapLayer::CmdSetDepthClampEnableEXT(VK_SUCCESS, CommandBuffer, DepthClampEnable);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetDepthCompareOpEXT(VkCommandBuffer CommandBuffer, VkCompareOp DepthCompareOp)
	{
		FWrapLayer::CmdSetDepthCompareOpEXT(VK_RESULT_MAX_ENUM, CommandBuffer, DepthCompareOp);
		VULKANAPINAMESPACE::vkCmdSetDepthCompareOpEXT(CommandBuffer, DepthCompareOp);
		FWrapLayer::CmdSetDepthCompareOpEXT(VK_SUCCESS, CommandBuffer, DepthCompareOp);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetDepthTestEnableEXT(VkCommandBuffer CommandBuffer, VkBool32 DepthTestEnable)
	{
		FWrapLayer::CmdSetDepthTestEnableEXT(VK_RESULT_MAX_ENUM, CommandBuffer, DepthTestEnable);
		VULKANAPINAMESPACE::vkCmdSetDepthTestEnableEXT(CommandBuffer, DepthTestEnable);
		FWrapLayer::CmdSetDepthTestEnableEXT(VK_SUCCESS, CommandBuffer, DepthTestEnable);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetDepthWriteEnableEXT(VkCommandBuffer CommandBuffer, VkBool32 DepthWriteEnable)
	{
		FWrapLayer::CmdSetDepthWriteEnableEXT(VK_RESULT_MAX_ENUM, CommandBuffer, DepthWriteEnable);
		VULKANAPINAMESPACE::vkCmdSetDepthWriteEnableEXT(CommandBuffer, DepthWriteEnable);
		FWrapLayer::CmdSetDepthWriteEnableEXT(VK_SUCCESS, CommandBuffer, DepthWriteEnable);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetRasterizerDiscardEnableEXT(VkCommandBuffer CommandBuffer, VkBool32 RasterizerDiscardEnable)
	{
		FWrapLayer::CmdSetRasterizerDiscardEnableEXT(VK_RESULT_MAX_ENUM, CommandBuffer, RasterizerDiscardEnable);
		VULKANAPINAMESPACE::vkCmdSetRasterizerDiscardEnableEXT(CommandBuffer, RasterizerDiscardEnable);
		FWrapLayer::CmdSetRasterizerDiscardEnableEXT(VK_SUCCESS, CommandBuffer, RasterizerDiscardEnable);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetPrimitiveRestartEnableEXT(VkCommandBuffer CommandBuffer, VkBool32 PrimitiveRestartEnable)
	{
		FWrapLayer::CmdSetPrimitiveRestartEnableEXT(VK_RESULT_MAX_ENUM, CommandBuffer, PrimitiveRestartEnable);
		VULKANAPINAMESPACE::vkCmdSetPrimitiveRestartEnableEXT(CommandBuffer, PrimitiveRestartEnable);
		FWrapLayer::CmdSetPrimitiveRestartEnableEXT(VK_SUCCESS, CommandBuffer, PrimitiveRestartEnable);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetLogicOpEnableEXT(VkCommandBuffer CommandBuffer, VkBool32 LogicOpEnable)
	{
		FWrapLayer::CmdSetLogicOpEnableEXT(VK_RESULT_MAX_ENUM, CommandBuffer, LogicOpEnable);
		VULKANAPINAMESPACE::vkCmdSetLogicOpEnableEXT(CommandBuffer, LogicOpEnable);
		FWrapLayer::CmdSetLogicOpEnableEXT(VK_SUCCESS, CommandBuffer, LogicOpEnable);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetAlphaToCoverageEnableEXT(VkCommandBuffer CommandBuffer, VkBool32 AlphaToCoverageEnable)
	{
		FWrapLayer::CmdSetAlphaToCoverageEnableEXT(VK_RESULT_MAX_ENUM, CommandBuffer, AlphaToCoverageEnable);
		VULKANAPINAMESPACE::vkCmdSetAlphaToCoverageEnableEXT(CommandBuffer, AlphaToCoverageEnable);
		FWrapLayer::CmdSetAlphaToCoverageEnableEXT(VK_SUCCESS, CommandBuffer, AlphaToCoverageEnable);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetAlphaToOneEnableEXT(VkCommandBuffer CommandBuffer, VkBool32 AlphaToOneEnable)
	{
		FWrapLayer::CmdSetAlphaToOneEnableEXT(VK_RESULT_MAX_ENUM, CommandBuffer, AlphaToOneEnable);
		VULKANAPINAMESPACE::vkCmdSetAlphaToOneEnableEXT(CommandBuffer, AlphaToOneEnable);
		FWrapLayer::CmdSetAlphaToOneEnableEXT(VK_SUCCESS, CommandBuffer, AlphaToOneEnable);
	}

	static FORCEINLINE_DEBUGGABLE VkResult vkCopyMemoryToImageEXT(VkDevice Device, const VkCopyMemoryToImageInfo* CopyMemoryToImageInfo)
	{
		FWrapLayer::CopyMemoryToImageEXT(VK_RESULT_MAX_ENUM, Device, CopyMemoryToImageInfo);
		const VkResult Result = VULKANAPINAMESPACE::vkCopyMemoryToImageEXT(Device, CopyMemoryToImageInfo);
		FWrapLayer::CopyMemoryToImageEXT(Result, Device, CopyMemoryToImageInfo);
		return Result;
	}

	static FORCEINLINE_DEBUGGABLE VkResult vkTransitionImageLayoutEXT(VkDevice Device, uint32_t TransitionCount, const VkHostImageLayoutTransitionInfo* Transitions)
	{
		FWrapLayer::TransitionImageLayoutEXT(VK_RESULT_MAX_ENUM, Device, TransitionCount, Transitions);
		const VkResult Result = VULKANAPINAMESPACE::vkTransitionImageLayoutEXT(Device, TransitionCount, Transitions);
		FWrapLayer::TransitionImageLayoutEXT(Result, Device, TransitionCount, Transitions);
		return Result;
	}
