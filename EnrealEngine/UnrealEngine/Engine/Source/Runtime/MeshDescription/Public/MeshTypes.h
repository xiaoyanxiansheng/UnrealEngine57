...
struct FVertexID : public FElementID
{
	...
	inline friend uint32 GetTypeHash( const FVertexID& Other )
	{
...
struct FVertexInstanceID : public FElementID
{
	...
	inline friend uint32 GetTypeHash( const FVertexInstanceID& Other )
	{
		return GetTypeHash( Other.IDValue );
	}
...
struct FEdgeID : public FElementID
{
	...
	inline friend uint32 GetTypeHash( const FEdgeID& Other )
	{
		return GetTypeHash( Other.IDValue );
	}
...
struct FUVID : public FElementID
{
	...
	inline friend uint32 GetTypeHash( const FUVID& Other )
	{
		return GetTypeHash( Other.IDValue );
	}
};
...
struct FTriangleID : public FElementID
{
	...
	inline friend uint32 GetTypeHash(const FTriangleID& Other)
	{
		return GetTypeHash(Other.IDValue);
	}
...
struct FPolygonGroupID : public FElementID
{
	...
	inline friend uint32 GetTypeHash( const FPolygonGroupID& Other )
	{
		return GetTypeHash( Other.IDValue );
	}
...
struct FPolygonID : public FElementID
{
	...
	inline friend uint32 GetTypeHash( const FPolygonID& Other )
	{
		return GetTypeHash( Other.IDValue );
	}
