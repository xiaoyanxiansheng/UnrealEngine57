...
public:
	...
	inline ElementIDType Add() { return ElementIDType( Container.Add( ElementType() ) ); }

	/** Add the provided element at the next available index, and return the new ID */
	inline ElementIDType Add( typename TTypeTraits<ElementType>::ConstInitType Element ) { return ElementIDType( Container.Add( Element ) ); }

	/** Add the provided element at the next available index, and return the ID */
	inline ElementIDType Add( ElementType&& Element ) { return ElementIDType( Container.Add( Forward<ElementType>( Element ) ) ); }
	...
	inline ElementType& Insert( const ElementIDType ID, typename TTypeTraits<ElementType>::ConstInitType Element )
	{
	...
	inline int32 GetArraySize() const { return Container.GetMaxIndex(); }
	...
	/** Serializer */
	inline friend FArchive& operator<<( FArchive& Ar, TMeshElementArray& Array )
	{
	...
	public:
		...
		explicit inline TElementIDs( const TSparseArray<ElementType>& InArray )
			: Array( InArray )
		{}
		...
		public:
			...
			explicit inline TConstIterator( typename TSparseArray<ElementType>::TConstIterator&& It )
	...
	TElementIDs inline GetElementIDs() const { return TElementIDs( Container ); }
};
