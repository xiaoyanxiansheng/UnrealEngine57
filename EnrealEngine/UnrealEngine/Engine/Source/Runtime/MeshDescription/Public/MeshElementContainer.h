...
public:
	...
	inline FAttributesSetBase& GetAttributes() { return Attributes; }
	inline const FAttributesSetBase& GetAttributes() const { return Attributes; }
	...
	{
	public:
		explicit inline FElementIDs(const TBitArray<>& InArray)
			: Array(InArray)
		{}
		...
		{
		public:
			explicit inline FConstIterator(TConstSetBitIterator<>&& It)
			...
			friend inline bool operator==(const FConstIterator& Lhs, const FConstIterator& Rhs)
			{
		...
		inline FConstIterator CreateConstIterator() const
		{
			return FConstIterator(TConstSetBitIterator<>(Array));
		}

	public:
		inline FConstIterator begin() const
		{
			return FConstIterator(TConstSetBitIterator<>(Array));
		}

		inline FConstIterator end() const
		{
	...
	FElementIDs inline GetElementIDs() const { return FElementIDs(BitArray); }
...
public:
	...
	/** Accessor for attributes */
	inline TAttributesSet<ElementIDType>& GetAttributes() { return static_cast<TAttributesSet<ElementIDType>&>(Attributes); }
	inline const TAttributesSet<ElementIDType>& GetAttributes() const { return static_cast<const TAttributesSet<ElementIDType>&>(Attributes); }
	...
	{
	public:
		explicit inline TElementIDs(const TBitArray<>& InArray)
			: Array(InArray)
		{}
		...
		{
		public:
			explicit inline TConstIterator(TConstSetBitIterator<>&& It)
				: Iterator(MoveTemp(It))
			{}
			...
			inline ElementIDType operator*() const
			{
				return ElementIDType{Iterator ? Iterator.GetIndex() : INDEX_NONE};
			}

			friend inline bool operator==(const TConstIterator& Lhs, const TConstIterator& Rhs)
			{
				return Lhs.Iterator == Rhs.Iterator;
			}
		...
		inline TConstIterator CreateConstIterator() const
		{
	...
	/** Return iterable proxy object from container */
	TElementIDs inline GetElementIDs() const { return TElementIDs(BitArray); }
};
...
public:
	...
	inline const FMeshElementContainer& Get(const int32 Index = 0) const { return Channels[Index]; }
	inline const FMeshElementContainer& operator[](const int32 Index) const { return Channels[Index]; }
	inline const FMeshElementContainer& operator*() const { return Channels[0]; }
	inline const FMeshElementContainer* operator->() const { return &Channels[0]; }
	inline FMeshElementContainer& Get(const int32 Index = 0) { return Channels[Index]; }
	inline FMeshElementContainer& operator[](const int32 Index) { return Channels[Index]; }
	inline FMeshElementContainer& operator*() { return Channels[0]; }
	inline FMeshElementContainer* operator->() { return &Channels[0]; }
