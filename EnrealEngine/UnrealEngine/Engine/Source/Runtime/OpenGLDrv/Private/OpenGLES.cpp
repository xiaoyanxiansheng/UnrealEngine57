...
bool FOpenGLES::bSupportsShaderFramebufferFetchProgrammableBlending = false;
...
void FOpenGLES::ProcessExtensions(const FString& ExtensionsString)
{
	...
	bSupportsShaderFramebufferFetchProgrammableBlending = bSupportsShaderFramebufferFetch;
