...
static TAutoConsoleVariable<bool> CVarDynamicMeshComponent_AllowCollisionAsyncBuildInEditor(
	...
	false,
	TEXT("If enabled, we allow async build of dynamic mesh component collision in (non-PIE) Editor. Otherwise, async collision build will only happen in game worlds (PIE/runtime).")
);
