...
private:
	// Typically the mesh pool is used from the game thread, but 
	// in case it is not, we protect pool access w/ this critical section
	mutable FCriticalSection PoolAccessCs;
};
