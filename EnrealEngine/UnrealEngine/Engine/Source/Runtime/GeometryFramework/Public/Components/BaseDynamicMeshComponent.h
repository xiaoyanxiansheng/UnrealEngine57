...
public:
	...
	//===============================================================================================================
	// Two-Sided rendering support. When enabled, triangles will be rendered whether they are facing the camera or not
public:
	GEOMETRYFRAMEWORK_API virtual void SetTwoSided(bool bEnable);
	virtual bool GetTwoSided() const { return bTwoSided; }
...
public:
	...
	GEOMETRYFRAMEWORK_API virtual FMaterialRelevance GetMaterialRelevance(EShaderPlatform InShaderPlatform) const override;
