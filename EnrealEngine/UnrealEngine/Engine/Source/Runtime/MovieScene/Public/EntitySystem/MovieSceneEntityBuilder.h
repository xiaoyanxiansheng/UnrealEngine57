...
struct FEntityBuilderImplBase : public IEntityBuilder
{
	/**
...
struct TEntityBuilderImpl<TIntegerSequence<int, Indices...>, T...> : FEntityBuilderImplBase
{
	...
	using FEntityBuilderImplBase::CreateEntity;
