...
struct TCustomPropertyAccessorFunctions
	: TCustomPropertyAccessorFunctionsImpl<PropertyTraits, TGetPublicPropertyMetaDataT<PropertyTraits>>
{
};
 ...
 * the property value from a UObject*. See TPropertyTraits for an example. TRuntimePropertyTraits shows
...
struct TSetPropertyValuesImpl<PropertyTraits, TPropertyMetaData<MetaDataTypes...>>
{
	...
	explicit TSetPropertyValuesImpl(const PropertyTraits* InTraits, const ICustomPropertyRegistration* InCustomProperties)
		: Traits(InTraits)
	 ...
	 *     .Dispatch_PerEntity<TSetPropertyValues<PropertyType>>(...);
	 */
	void ForEachEntity(UObject* InObject, uint16 PropertyOffset, typename TCallTraits<MetaDataTypes>::ParamType... MetaData, InParamType ValueToSet) const;
	 ...
	 *     .Dispatch_PerEntity<TSetPropertyValues<PropertyType>>(...);
	 */
	void ForEachEntity(UObject* InObject, const TSharedPtr<FTrackInstancePropertyBindings>& PropertyBindings, typename TCallTraits<MetaDataTypes>::ParamType... MetaData, InParamType ValueToSet) const;
...
private:
	...
	const ICustomPropertyRegistration* CustomProperties;
...
struct TSetPropertyValues : TSetPropertyValuesImpl<PropertyTraits, typename PropertyTraits::MetaDataType>
{
	...
	explicit TSetPropertyValues(const PropertyTraits* InTraits, const ICustomPropertyRegistration* InCustomProperties)
		: TSetPropertyValuesImpl<PropertyTraits, typename PropertyTraits::MetaDataType>(InTraits, InCustomProperties)
	{}
};
...
struct TGetPropertyValuesImpl<PropertyTraits, TPropertyMetaData<MetaDataTypes...>>
{
	...
	explicit TGetPropertyValuesImpl(const PropertyTraits* InTraits, const ICustomPropertyRegistration* InCustomProperties)
		: Traits(InTraits)
		, CustomProperties(InCustomProperties)
	{
		if (CustomProperties)
...
{
	explicit TGetPropertyValues(const PropertyTraits* InTraits, const ICustomPropertyRegistration* InCustomProperties)
		: TGetPropertyValuesImpl<PropertyTraits, typename PropertyTraits::MetaDataType>(InTraits, InCustomProperties)
	{}
};
...
struct TSetCompositePropertyValuesImpl<PropertyTraits, TPropertyMetaData<MetaDataTypes...>, CompositeTypes...>
{
	...
	explicit TSetCompositePropertyValuesImpl(const PropertyTraits* InTraits, const ICustomPropertyRegistration* InCustomProperties)
		: Traits(InTraits)
		, CustomProperties(InCustomProperties)
	{
		if (CustomProperties)
