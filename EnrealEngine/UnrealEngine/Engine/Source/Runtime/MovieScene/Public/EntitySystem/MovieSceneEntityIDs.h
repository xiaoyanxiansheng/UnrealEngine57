...
struct FComponentMask
{
	...
	inline FComponentMask& CombineWithBitwiseOR(const FComponentMask& Other, EBitwiseOperatorFlags InFlags)
	{
		Bits.CombineWithBitwiseOR(Other.Bits, InFlags);
		return *this;
	}

	inline FComponentMask& CombineWithBitwiseXOR(const FComponentMask& Other, EBitwiseOperatorFlags InFlags)
	{
		Bits.CombineWithBitwiseXOR(Other.Bits, InFlags);
		return *this;
	}
	
	inline FComponentMask& CombineWithBitwiseAND(const FComponentMask& Other, EBitwiseOperatorFlags InFlags)
	{
		Bits.CombineWithBitwiseAND(Other.Bits, InFlags);
		return *this;
	}

	inline static FComponentMask BitwiseAND(const FComponentMask& A, const FComponentMask& B, EBitwiseOperatorFlags InFlags)
	{
	...
	inline static FComponentMask BitwiseOR(const FComponentMask& A, const FComponentMask& B, EBitwiseOperatorFlags InFlags)
	{
		FComponentMask Result;
	...
	inline static FComponentMask BitwiseXOR(const FComponentMask& A, const FComponentMask& B, EBitwiseOperatorFlags InFlags)
	{
		FComponentMask Result;
	...
	inline static FComponentMask BitwiseNOT(const FComponentMask& A)
	{
	...
	inline int32 Find(bool bValue) const
	{
		return Bits.Find(bValue);
	}

	inline int32 NumComponents() const
	{
		return Bits.CountSetBits();
	}

	inline void PadToNum(int32 Num, bool bPadValue)
	{
