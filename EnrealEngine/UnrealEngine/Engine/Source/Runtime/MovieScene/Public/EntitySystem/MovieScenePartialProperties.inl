...
void TSetPartialPropertyValuesImpl<PropertyTraits, TPropertyMetaData<MetaDataTypes...>, TIntegerSequence<int, CompositeIndices...>, CompositeTypes...>::ForEachAllocation(
	...
	TReadOptional<CompositeTypes>... InCompositeComponents) const
{
	// ----------------------------------------------------------------------------------------------------------------------------
...
template<typename PropertyTraits, typename ...MetaDataTypes, int ...CompositeIndices, typename ...CompositeTypes>
void TSetPartialPropertyValuesImpl<PropertyTraits, TPropertyMetaData<MetaDataTypes...>, TIntegerSequence<int, CompositeIndices...>, CompositeTypes...>::ForEachCustom(
	const FEntityAllocation* Allocation,
	UObject* const* Objects,
	const FCustomPropertyIndex* Custom,
	const MetaDataTypes*... InMetaData,
	const CompositeTypes*... InCompositeComponents) const
{
	const int32 Num = Allocation->Num();
	...
	for (int32 Index = 0; Index < Num; ++Index)
	{
		...
		StorageType Storage{};
		Traits->GetObjectPropertyValue(Objects[Index], InMetaData[Index]..., CustomAccessors[PropertyIndex.Value], Storage);

		PatchCompositeValue(CompositeDefinitions, &Storage, InCompositeComponents ? &InCompositeComponents[Index] : nullptr...);

		Traits->SetObjectPropertyValue(Objects[Index], InMetaData[Index]..., CustomAccessors[PropertyIndex.Value], Storage);
	}
}


template<typename PropertyTraits, typename ...MetaDataTypes, int ...CompositeIndices, typename ...CompositeTypes>
void TSetPartialPropertyValuesImpl<PropertyTraits, TPropertyMetaData<MetaDataTypes...>, TIntegerSequence<int, CompositeIndices...>, CompositeTypes...>::ForEachFast(
	const FEntityAllocation* Allocation,
	UObject* const* Objects,
	const uint16* Fast,
	const MetaDataTypes*... InMetaData,
	const CompositeTypes*... InCompositeComponents) const
{
	...
	for (int32 Index = 0; Index < Num; ++Index)
	{
		...
		StorageType Storage{};
		Traits->GetObjectPropertyValue(Objects[Index], InMetaData[Index]..., PropertyOffset, Storage);

		PatchCompositeValue(CompositeDefinitions, &Storage, InCompositeComponents ? &InCompositeComponents[Index] : nullptr...);

		Traits->SetObjectPropertyValue(Objects[Index], InMetaData[Index]..., PropertyOffset, Storage);
	}
}


template<typename PropertyTraits, typename ...MetaDataTypes, int ...CompositeIndices, typename ...CompositeTypes>
void TSetPartialPropertyValuesImpl<PropertyTraits, TPropertyMetaData<MetaDataTypes...>, TIntegerSequence<int, CompositeIndices...>, CompositeTypes...>::ForEachSlow(
	const FEntityAllocation* Allocation,
	UObject* const* Objects,
	const TSharedPtr<FTrackInstancePropertyBindings>* Slow,
	const MetaDataTypes*... InMetaData,
	const CompositeTypes*... InCompositeComponents) const
{
	const int32 Num = Allocation->Num();
	...
	for (int32 Index = 0; Index < Num; ++Index)
	{
		...
		StorageType Storage{};
		Traits->GetObjectPropertyValue(Objects[Index], InMetaData[Index]..., Bindings, Storage);

		PatchCompositeValue(CompositeDefinitions, &Storage, InCompositeComponents ? &InCompositeComponents[Index] : nullptr...);

		Traits->SetObjectPropertyValue(Objects[Index], InMetaData[Index]..., Bindings, Storage);
	}
}
