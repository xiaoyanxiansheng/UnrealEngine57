...
struct TComponentPtr
{
	...
	inline TArrayView<T> AsArray(int32 Num) const
	{
	...
	inline TArrayView<T> Slice(int32 StartIndex, int32 Num) const
	{
	...
	inline ValueType operator[](int32 Index) const
	{
...
struct FReadErased
{
	...
	inline const void* AsPtr() const
	{
		return ComponentPtr;
	}
	inline const void* operator[](int32 Index) const
	{
		return ComponentPtr + Sizeof*Index;
	}
	inline const void* ComponentAtIndex(int32 Index) const
	{
		return ComponentPtr + Sizeof*Index;
	}
	inline bool IsValid() const
...
struct FWriteErased
{
	...
	FWriteErased(const FComponentHeader* InHeader, int32 ComponentOffset = 0)
		...
		, Sizeof(InHeader->Sizeof)
	{}
	inline void* AsPtr() const
	{
		return ComponentPtr;
	}
	inline void* operator[](int32 Index) const
	{
		return ComponentPtr + Sizeof*Index;
	}
	inline bool IsValid() const
