...
public:
	 ...
	 */
	inline bool operator==(const FMovieSceneSectionGroup& Other) const
	{
	 ...
	 */
	inline TArray<TWeakObjectPtr<UMovieSceneSection> >::RangedForIteratorType      begin() { return Sections.begin(); }
	inline TArray<TWeakObjectPtr<UMovieSceneSection> >::RangedForConstIteratorType begin() const { return Sections.begin(); }
	inline TArray<TWeakObjectPtr<UMovieSceneSection> >::RangedForIteratorType      end() { return Sections.end(); }
	inline TArray<TWeakObjectPtr<UMovieSceneSection> >::RangedForConstIteratorType end() const { return Sections.end(); }
};
...
private:
	 ...
	 * Not intended for direct use.
	 */
	inline bool operator==(const UMovieSceneNodeGroup& Other) const
	{
...
public:
	 ...
	 * STL-like iterators to enable range-based for loop support.
	 */
	inline auto begin()	{ return NodeGroups.begin(); }
	inline auto begin()	const { return NodeGroups.begin(); }
	inline auto end()	{ return NodeGroups.end(); }
	inline auto end()	const { return NodeGroups.end(); }
#endif
};
...
public:
	...
	UE_DEPRECATED(5.7, "Getting non-const access to GetBindings is no longer allowed. Please use const GetBindings()")
	 ...
	 */
	MOVIESCENE_API FText GetObjectDisplayName(const FGuid& ObjectId) const;
	...
	*/
	 ...
	 */
	UE_DEPRECATED(5.7, "GetSoloNodes is now deprecated. Use FindDecoration")
	 ...
	 */
	UE_DEPRECATED(5.7, "GetMuteNodes is now deprecated. Use FindDecoration")
