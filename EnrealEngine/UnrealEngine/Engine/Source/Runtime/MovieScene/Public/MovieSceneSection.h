...
struct FMovieSceneTimecodeSource
{
	...
	inline bool operator==(const FMovieSceneTimecodeSource& Other) const
	{
...
public:
	...
	{
		const bool bHasChanged = NewRange != SectionRange.Value; 
		if (IsReadOnly() || !bHasChanged)
		{
			return;
		}
	...
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Section")
	void SetPreRollFrames(int32 InPreRollFrames) { PreRollFrames = InPreRollFrames; }
	UFUNCTION(BlueprintPure, Category = "Sequencer|Section")
	...
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Section")
	void SetPostRollFrames(int32 InPostRollFrames) { PostRollFrames = InPostRollFrames; }
	UFUNCTION(BlueprintPure, Category = "Sequencer|Section")
