...
public:
	...
	inline bool operator<(const FMovieSceneSpawnable& RHS) const { return Guid < RHS.Guid; }
	inline friend bool operator<(const FGuid& InGuid, const FMovieSceneSpawnable& RHS) { return InGuid < RHS.GetGuid(); }
