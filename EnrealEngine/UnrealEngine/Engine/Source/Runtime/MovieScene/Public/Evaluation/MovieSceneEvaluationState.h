...
struct FMovieSceneEvaluationState : public UE::MovieScene::IPlaybackCapability
{
	...
	*/
	 ...
	 * @param InSequenceID		The sequence ID to lookup
	 */
	inline FMovieSceneObjectCache* FindObjectCache(FMovieSceneSequenceIDRef SequenceID)
	{
	 ...
	 * @param InSequenceID		The sequence ID to lookup
	 */
	inline const FMovieSceneObjectCache* FindObjectCache(FMovieSceneSequenceIDRef SequenceID) const
	{
	 ...
	 * @param InSequenceID		The sequence ID to lookup
	 */
	inline FMovieSceneObjectCache& GetObjectCache(FMovieSceneSequenceIDRef SequenceID)
	{
