...
public:
	 ...
	 */
	inline const FGuid& GetObjectBindingID() const
	{
	 ...
	 */
	inline TArrayView<FMovieSceneEvalTemplatePtr> GetChildTemplates()
	{
	 ...
	 * Get this track's child templates
	 */
	inline TArrayView<const FMovieSceneEvalTemplatePtr> GetChildTemplates() const
	{
	 ...
	 */
	inline const FMovieSceneEvalTemplate& GetChildTemplate(int32 TemplateIndex) const
	{
	 ...
	 */
	inline bool HasChildTemplate(int32 TemplateIndex) const
	{
...
public:
	 ...
	 * @param Player				The player that is responsible for playing back this template
	 */
	inline void OnBeginEvaluation(FPersistentEvaluationData& PersistentData, IMovieScenePlayer& Player) const
	{
