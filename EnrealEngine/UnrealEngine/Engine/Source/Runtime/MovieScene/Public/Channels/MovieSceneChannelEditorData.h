...
struct FMovieSceneChannelMetaData
{
	...
	bool bInvertValue;
	/** Whether this channel can preserve the ratio to its grouped channels when editing */
	bool bCanPreserveRatio;
	/** Determines whether preserve ratio is enabled or not, not saved */
	mutable bool bPreserveRatio;
