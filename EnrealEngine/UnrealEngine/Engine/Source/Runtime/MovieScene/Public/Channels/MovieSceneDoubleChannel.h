...
struct FMovieSceneDoubleChannel : public FMovieSceneChannel
{
	 ...
	 */
	inline TMovieSceneChannelData<FMovieSceneDoubleValue> GetData()
	{
	 ...
	 */
	inline TMovieSceneChannelData<const FMovieSceneDoubleValue> GetData() const
	{
	 ...
	 */
	inline TArrayView<const FMovieSceneDoubleValue> GetValues() const
	{
		return Values;
	}
...
public:
	 ...
	 */
	inline void SetDefault(double InDefaultValue)
	{
	 ...
	 */
	inline TOptional<double> GetDefault() const
	{
