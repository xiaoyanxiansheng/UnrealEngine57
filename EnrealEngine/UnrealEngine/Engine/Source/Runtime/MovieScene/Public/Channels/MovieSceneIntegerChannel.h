...
struct FMovieSceneIntegerChannel : public FMovieSceneChannel
{
	 ...
	 */
	inline TMovieSceneChannelData<int32> GetData()
	{
	 ...
	 */
	inline TMovieSceneChannelData<const int32> GetData() const
	{
	 ...
	 */
	inline TArrayView<const int32> GetValues() const
	{
		return Values;
	}
	 ...
	 */
	inline void Set(TArray<FFrameNumber> InTimes, TArray<int32> InValues)
	{
	 ...
	 */
	inline void AddKeys(const TArray<FFrameNumber>& InTimes, const TArray<int32>& InValues)
	{
		check(InTimes.Num() == InValues.Num());
...
public:
	 ...
	 */
	inline void SetDefault(int32 InDefaultValue)
	{
	 ...
	 */
	inline TOptional<int32> GetDefault() const
	{
