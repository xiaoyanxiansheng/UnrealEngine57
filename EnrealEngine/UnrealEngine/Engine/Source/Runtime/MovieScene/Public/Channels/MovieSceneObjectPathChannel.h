...
struct FMovieSceneObjectPathChannel : public FMovieSceneChannel
{
	...
	inline void SetPropertyClass(UClass* InPropertyClass)
	{
	 ...
	 */
	inline TMovieSceneChannelData<FMovieSceneObjectPathChannelKeyValue> GetData()
	{
	 ...
	 */
	inline TMovieSceneChannelData<const FMovieSceneObjectPathChannelKeyValue> GetData() const
	{
...
public:
	 ...
	 */
	inline void SetDefault(UObject* InDefaultValue)
	{
	 ...
	 */
	inline const FMovieSceneObjectPathChannelKeyValue& GetDefault() const
	{
		return DefaultValue;
	}
...
inline bool GetChannelDefault(const FMovieSceneObjectPathChannel* Channel, FMovieSceneObjectPathChannelKeyValue& OutDefaultValue)
{
...
inline bool EvaluateChannel(const FMovieSceneObjectPathChannel* InChannel, FFrameTime InTime, FMovieSceneObjectPathChannelKeyValue& OutValue)
{
	...
	if (InChannel->Evaluate(InTime, Object))
	{
		OutValue = Object;
		return true;
	}
