...
struct FMovieSceneChannelTraitsTransform
{
	ValueType Offset = {};
	ValueType Scale = {};
	ValueType Pivot = {};
...
namespace MovieScene
{
	 ...
	 */
	template<typename ChannelType, typename ValueType>
	typename TEnableIf<TGetMovieSceneChannelTraits<ChannelType>::SupportsDefaults>::Type SetChannelDefault(ChannelType* Channel, ValueType&& DefaultValue)
	{
	...
	*/
	template<typename ChannelType>
	typename TEnableIf<TGetMovieSceneChannelTraits<ChannelType>::SupportsDefaults>::Type RemoveChannelDefault(ChannelType* Channel)
	{
	...
	*/
	template<typename ChannelType, typename ValueType>
	typename TEnableIf<TGetMovieSceneChannelTraits<ChannelType>::SupportsDefaults, bool>::Type GetChannelDefault(ChannelType* Channel, ValueType& OutDefaultValue)
	{
