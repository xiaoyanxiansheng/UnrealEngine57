...
struct FMovieSceneByteChannel : public FMovieSceneChannel
{
	 ...
	 */
	inline TMovieSceneChannelData<uint8> GetData()
	{
	 ...
	 */
	inline TMovieSceneChannelData<const uint8> GetData() const
	{
	 ...
	 */
	inline TArrayView<const uint8> GetValues() const
	{
		return Values;
	}
	 ...
	 */
	inline void AddKeys(const TArray<FFrameNumber>& InTimes, const TArray<uint8>& InValues)
	{
...
public:
	 ...
	 */
	inline void SetDefault(uint8 InDefaultValue)
	{
	 ...
	 */
	inline TOptional<uint8> GetDefault() const
	{
