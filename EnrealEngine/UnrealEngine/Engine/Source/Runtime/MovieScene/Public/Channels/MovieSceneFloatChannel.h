...
struct FMovieSceneFloatChannel : public FMovieSceneChannel
{
	 ...
	 */
	inline TMovieSceneChannelData<FMovieSceneFloatValue> GetData()
	{
	 ...
	 */
	inline TMovieSceneChannelData<const FMovieSceneFloatValue> GetData() const
	{
	 ...
	 */
	inline TArrayView<const FMovieSceneFloatValue> GetValues() const
	{
		return Values;
	}
...
public:
	 ...
	 */
	inline void SetDefault(float InDefaultValue)
	{
	 ...
	 */
	inline TOptional<float> GetDefault() const
	{
