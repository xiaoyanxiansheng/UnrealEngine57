...
public:
	...
	*/
	...
	inline bool operator<(const FMovieScenePossessable& RHS) const { return Guid < RHS.Guid; }
	inline friend bool operator<(const FGuid& InGuid, const FMovieScenePossessable& RHS) { return InGuid < RHS.GetGuid(); }
	inline bool operator<(const FGuid& InGuid) const { return Guid < InGuid; }
