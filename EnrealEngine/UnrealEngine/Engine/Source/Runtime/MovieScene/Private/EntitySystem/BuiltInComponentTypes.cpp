...
FBuiltInComponentTypes::FBuiltInComponentTypes()
{
	...
	ComponentRegistry->NewComponentType(&VariantPropertyTypeIndex,TEXT("Variant Property Type Index"));
	...
	// Text channel relationships
	{
		...
		ComponentRegistry->Factories.DefineMutuallyInclusiveComponent(TextChannel, EvalTime);
