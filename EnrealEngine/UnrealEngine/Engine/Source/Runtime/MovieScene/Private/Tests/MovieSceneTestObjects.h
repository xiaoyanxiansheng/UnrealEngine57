...
struct FTestMovieSceneStruct
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Interp, Category="Test")
	ETestMovieSceneEnum Enum = ETestMovieSceneEnum::One;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Interp, Category="Test")
	FVector Vector = FVector::ZeroVector;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Interp, Category="Test")
	TArray<int32> MultipleIntegers;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Interp, Category="Test")
	TArray<FVector> MultipleVectors;
};
...
class UTestMovieSceneObject : public UObject
{
	GENERATED_BODY()
};
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Interp, Category="Test")
	ETestMovieSceneEnum TestEnum = ETestMovieSceneEnum::One;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Interp, Category="Test")
	int32 TestInt32 = 0;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Interp, Category="Test")
	TObjectPtr<UTestMovieSceneObject> TestObject;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Interp, Category="Test")
	FInstancedStruct SingleInstancedStruct;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Interp, Category="Test")
	TArray<FInstancedStruct> MultipleInstancedStructs;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, BlueprintSetter="SetTestSetterFloat", Interp, Category="Test")
	float TestSetterFloat = 0;

public:

	int32 NumSetTestSetterFloatCalls = 0;
...
public:
	...
	{
		TestSetterFloat = InValue;
		++NumSetTestSetterFloatCalls;
	}
};
