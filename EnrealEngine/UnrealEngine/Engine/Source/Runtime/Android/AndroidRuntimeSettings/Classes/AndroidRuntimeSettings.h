...
/** Rounded edge safe zone preferences */
UENUM()
...
public:
	...
	// Enables limiting safe zone away from rounded edges on Android 12+
	UPROPERTY(GlobalConfig, EditAnywhere, Category = "APK Packaging", Meta = (DisplayName = "Limit safe zone to screen rounded edges."))
	TEnumAsByte<EAndroidRoundedEdgeSafeZoneDirection::Type> RoundedEdgeSafeZone;
...
private:
	...
	UE_API void HandlesRGBHWSupport();
	UE_API void HandleMetaQuestSupport();
	UE_API void RemoveExtraApplicationTag(FString TagToRemove);
	
	// End of UObject interface
	UE_API void EnsureValidGPUArch();
#endif
};
