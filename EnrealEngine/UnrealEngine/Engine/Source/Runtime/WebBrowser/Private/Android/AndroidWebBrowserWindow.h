...
private:
	 ...
	 * @param bMobileJSReturnInDict Whether to pass a UObject wrapper function's return value in a dictionary with the property's name or not.
	 */
	FAndroidWebBrowserWindow(FString Url, TOptional<FString> ContentsToLoad, bool bShowErrorMessage, bool bThumbMouseButtonNavigation, bool bUseTransparency, bool bJSBindingToLoweringEnabled, const FString& InUserAgentApplication, bool bMobileJSReturnInDict);
