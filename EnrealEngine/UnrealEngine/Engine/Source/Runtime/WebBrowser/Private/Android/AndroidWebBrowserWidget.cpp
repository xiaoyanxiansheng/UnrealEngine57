...
#include "AndroidJniWebViewControl.h"
			...
			ENQUEUE_RENDER_COMMAND(WriteAndroidWebBrowser)(
				[Params = WriteWebBrowserParams](FRHICommandListImmediate& RHICmdList)
				{
					...
					if (VideoTexture == nullptr)
					{
						...
						if (VideoTexture == nullptr)
						{
							UE_LOG(LogAndroid, Warning, TEXT("CreateTexture failed!"));
							return;
						}
		...
		else
		{
			...
			ENQUEUE_RENDER_COMMAND(WriteAndroidWebBrowser)(
				[Params = WriteWebBrowserParams](FRHICommandListImmediate& RHICmdList)
				{
					...
					FRHITexture* Texture = Params.NewTextureSamplePtr->InitializeTexture(RHICmdList);
...
jbyteArray SAndroidWebBrowserWidget::HandleShouldInterceptRequest(jstring JUrl)
{
	...
	else
	{
		...
		FAppEventManager::GameThreadTicker Ticker;
...
void JNICALL UE::Jni::FWebViewControl::FloatingCloseButtonPressed(JNIEnv* JEnv, jobject Client)
{
...
UE::Jni::Java::Lang::TArray<jbyte>* JNICALL UE::Jni::FWebViewControl::FViewClient::shouldInterceptRequestImpl(JNIEnv* JEnv, jobject Client, jstring JUrl)
{
	TSharedPtr<SAndroidWebBrowserWidget> Widget = SAndroidWebBrowserWidget::GetWidgetPtr(JEnv, Client);
	if (Widget.IsValid())
	{
		return reinterpret_cast<Java::Lang::TArray<jbyte>*>(Widget->HandleShouldInterceptRequest(JUrl));
	}
	else
	{
		return nullptr;
...
jboolean JNICALL UE::Jni::FWebViewControl::FViewClient::shouldOverrideUrlLoading(JNIEnv* JEnv, jobject Client, Android::WebKit::FWebView* /* ignore */, jstring JUrl)
{
	TSharedPtr<SAndroidWebBrowserWidget> Widget = SAndroidWebBrowserWidget::GetWidgetPtr(JEnv, Client);
	if (Widget.IsValid())
	{
...
void JNICALL UE::Jni::FWebViewControl::FViewClient::onPageLoad(JNIEnv* JEnv, jobject Client, jstring JUrl, jboolean bIsLoading, jint HistorySize, jint HistoryPosition)
{
	TSharedPtr<SAndroidWebBrowserWidget> Widget = SAndroidWebBrowserWidget::GetWidgetPtr(JEnv, Client);
	if (Widget.IsValid())
	{
...
void JNICALL UE::Jni::FWebViewControl::FViewClient::onReceivedError(JNIEnv* JEnv, jobject Client, Android::WebKit::FWebView* /* ignore */, jint ErrorCode, jstring Description, jstring JUrl)
{
	TSharedPtr<SAndroidWebBrowserWidget> Widget = SAndroidWebBrowserWidget::GetWidgetPtr(JEnv, Client);
	if (Widget.IsValid())
	{
...
jboolean JNICALL UE::Jni::FWebViewControl::FChromeClient::onJsAlert(JNIEnv* JEnv, jobject Client, Android::WebKit::FWebView* /* ignore */, jstring JUrl, jstring Message, Android::WebKit::FJsResult* Result)
{
	TSharedPtr<SAndroidWebBrowserWidget> Widget = SAndroidWebBrowserWidget::GetWidgetPtr(JEnv, Client);
	if (Widget.IsValid())
	{
...
jboolean JNICALL UE::Jni::FWebViewControl::FChromeClient::onJsBeforeUnload(JNIEnv* JEnv, jobject Client, Android::WebKit::FWebView* /* ignore */, jstring JUrl, jstring Message, Android::WebKit::FJsResult* Result)
{
	TSharedPtr<SAndroidWebBrowserWidget> Widget = SAndroidWebBrowserWidget::GetWidgetPtr(JEnv, Client);
	if (Widget.IsValid())
	{
...
jboolean JNICALL UE::Jni::FWebViewControl::FChromeClient::onJsConfirm(JNIEnv* JEnv, jobject Client, Android::WebKit::FWebView* /* ignore */, jstring JUrl, jstring Message, Android::WebKit::FJsResult* Result)
{
	TSharedPtr<SAndroidWebBrowserWidget> Widget = SAndroidWebBrowserWidget::GetWidgetPtr(JEnv, Client);
	if (Widget.IsValid())
	{
...
jboolean JNICALL UE::Jni::FWebViewControl::FChromeClient::onJsPrompt(JNIEnv* JEnv, jobject Client, Android::WebKit::FWebView* /* ignore */, jstring JUrl, jstring Message, jstring DefaultValue, Android::WebKit::FJsPromptResult* Result)
{
	TSharedPtr<SAndroidWebBrowserWidget> Widget = SAndroidWebBrowserWidget::GetWidgetPtr(JEnv, Client);
	if (Widget.IsValid())
	{
...
void JNICALL UE::Jni::FWebViewControl::FChromeClient::onReceivedTitle(JNIEnv* JEnv, jobject Client, Android::WebKit::FWebView* /* ignore */, jstring Title)
{
	TSharedPtr<SAndroidWebBrowserWidget> Widget = SAndroidWebBrowserWidget::GetWidgetPtr(JEnv, Client);
	if (Widget.IsValid())
	{
