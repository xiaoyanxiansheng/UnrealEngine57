...
DECLARE_LOG_CATEGORY_EXTERN(LogMobileJSScripting, Log, All);
...
public:
	...
	FMobileJSScripting(bool bJSBindingToLoweringEnabled, bool bInjectJSOnPageStarted, bool bDefaultJSReturnInDict);
