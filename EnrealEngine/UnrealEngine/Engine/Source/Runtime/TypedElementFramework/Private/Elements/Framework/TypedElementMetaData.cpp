...
namespace UE::Editor::DataStorage
{
	...
	bool FMetaDataBase::IsEmpty() const
	{
		return ImmutableData.IsEmpty() && MutableData.IsEmpty();
	}
	...
	bool FColumnMetaData::IsEmpty() const
	{
		return FMetaDataBase::IsEmpty() && ColumnType == nullptr;
	}
