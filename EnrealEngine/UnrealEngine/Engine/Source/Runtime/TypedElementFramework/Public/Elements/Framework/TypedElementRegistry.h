...
public:
	 ...
	 */
	inline FTypedHandleTypeId GetRegisteredElementTypeId(const FName InElementTypeName) const
	{
	 ...
	 */
	inline FName GetRegisteredElementTypeName(const FTypedHandleTypeId InElementTypeId) const
	{
	 ...
	 */
	inline void RegisterElementType(const FName InElementTypeName, bool bSupportScriptHandles)
	{
	...
	inline void RegisterElementType(const FName InElementTypeName)
	{
	...
	inline void RegisterElementInterface(const FName InElementTypeName, UObject* InElementInterface, const bool InAllowOverride = false)
	{
	 ...
	 */
	template <typename BaseInterfaceType>
	inline BaseInterfaceType* GetElementInterface(const FTypedHandleTypeId InElementTypeId) const
	{
	 ...
	 */
	template <typename BaseInterfaceType>
	inline BaseInterfaceType* GetElementInterface(const FTypedElementHandle& InElementHandle) const
	{
	 ...
	 * Get the element interface supported by the given handle, or null if there is no support for this interface.
	 */
	inline UObject* GetElementInterface(const FTypedElementHandle& InElementHandle, const TSubclassOf<UInterface> InBaseInterfaceType) const
	{
	...
	inline UObject* GetElementInterface(const FScriptTypedElementHandle& InElementHandle, const TSubclassOf<UInterface> InBaseInterfaceType) const
	{
		return GetElementInterfaceImpl(InElementHandle.GetId().GetTypeId(), InBaseInterfaceType);
	}
	 ...
	 */
	inline FTypedElementOwner CreateElement(const FName InElementTypeName, const FTypedHandleElementId InElementId)
	{
	...
	inline TTypedElementOwner<ElementDataType> CreateElement(const FName InElementTypeName)
	{
	 ...
	 */
	inline void DestroyElement(FTypedElementOwner& InOutElementOwner)
	{
	 ...
	 */
	template <typename ElementDataType>
	inline void DestroyElement(TTypedElementOwner<ElementDataType>& InOutElementOwner)
	{
	 ...
	 */
	inline FTypedElement GetElement(const FTypedElementId& InElementId, const TSubclassOf<UInterface>& InBaseInterfaceType) const
	{
	 ...
	 */
	template <typename BaseInterfaceType>
	inline TTypedElement<BaseInterfaceType> GetElement(const FTypedElementId& InElementId) const
	{
	 ...
	 */
	inline FTypedElement GetElement(const FTypedElementHandle& InElementHandle, const TSubclassOf<UInterface>& InBaseInterfaceType) const
	{
		FTypedElement Element;
	 ...
	 */
	template <typename BaseInterfaceType>
	inline TTypedElement<BaseInterfaceType> GetElement(const FTypedElementHandle& InElementHandle) const
	{
		TTypedElement<BaseInterfaceType> Element;
	 ...
	 */
	inline FTypedElementListRef CreateElementList()
	{
	 ...
	 */
	inline FScriptTypedElementListRef CreateScriptElementList()
	{
	 ...
	 */
	template <typename ElementDataType>
	inline FTypedElementListRef CreateElementList(const TArray<TTypedElementOwner<ElementDataType>>& InElementOwners)
	{
	 ...
	 */
	inline FScriptTypedElementHandle CreateScriptHandle(const FTypedElementId& InElementId)
	{
	...
	inline void Private_GetElementImpl(const FTypedElementHandle& InElementHandle, const TSubclassOf<UInterface>& InBaseInterfaceType, FTypedElement& OutElement) const
	{
...
private:
	...
	void AddRegisteredElementType(TUniquePtr<FRegisteredElementType>&& InRegisteredElementType)
	{
		...
		{
			UE::TWriteScopeLock RegisteredElementTypesLock(RegisteredElementTypesRW);
	...
	{
		UE::TReadScopeLock RegisteredElementTypesLock(RegisteredElementTypesRW);
	...
	inline void IncrementDisableElementDestructionOnGCCount()
	{
	...
	inline void DecrementDisableElementDestructionOnGCCount()
	{
		checkf(DisableElementDestructionOnGCCount != 0, TEXT("DisableElementDestructionOnGCCount underflow!"));
		--DisableElementDestructionOnGCCount;
	}

	mutable FTransactionallySafeRWLock RegisteredElementTypesRW;
