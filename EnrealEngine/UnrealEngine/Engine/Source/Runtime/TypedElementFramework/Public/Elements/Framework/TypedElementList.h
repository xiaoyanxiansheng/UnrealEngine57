...
inline void GetElement(const UTypedElementRegistry* InRegistry, const HandleType& InElementHandle, TTypedElement<BaseInterfaceType>& OutElement)
{
...
template <typename BaseInterfaceType, class HandleType>
inline TTypedElement<BaseInterfaceType> GetElement(const UTypedElementRegistry* InRegistry, const HandleType& InElementHandle)
{
...
public:
	 ...
	 */
	inline HandleType operator[](const int32 InIndex) const
	{
	 ...
	 * @note Use IsValidIndex to test for validity.
	 */
	inline HandleType GetElementHandleAt(const int32 InIndex) const
	{
	...
	inline TTypedElement<BaseInterfaceType> GetElementAt(const int32 InIndex) const
	{
	 ...
	 */
	template <typename BaseInterfaceType>
	inline void GetElementAt(const int32 InIndex, TTypedElement<BaseInterfaceType>& OutElement) const
	{
	 ...
	 */
	template <typename BaseInterfaceType>
	inline TTypedElement<BaseInterfaceType> GetElement(const HandleType& InElementHandle) const
	{
	 ...
	 */
	template <typename BaseInterfaceType>
	inline void GetElement(const HandleType& InElementHandle, TTypedElement<BaseInterfaceType>& OutElement) const
	{
	 ...
	 */
	inline bool IsValidIndex(const int32 InIndex) const
	{
	 ...
	 */
	inline void Reserve(const int32 InSize)
	{
	 ...
	 */
	inline void Empty(const int32 InSlack = 0)
	{
	 ...
	 */
	inline bool Contains(const FTypedElementId& InElementId) const
	{
	 ...
	 */
	inline bool Contains(const HandleType& InElementHandle) const
	{
	...
	inline bool Contains(const TTypedElementOwner<ElementDataType>& InElementOwner)
	{
	 ...
	 */
	inline bool Add(const HandleType& InElementHandle)
	{
	 ...
	 * @return True if the element handle was added, false if it is already in the list.
	 */
	inline bool Add(HandleType&& InElementHandle)
	{
	 ...
	 */
	template <typename ElementDataType>
	inline bool Add(const TTypedElementOwner<ElementDataType>& InElementOwner)
	{
	 ...
	 */
	template <typename ElementDataType>
	inline void Append(const TArray<TTypedElementOwner<ElementDataType>>& InElementOwners)
	{
	 ...
	 */
	inline bool Remove(const FTypedElementId& InElementId)
	{
	 ...
	 */
	inline bool Remove(const HandleType& InElementHandle)
	{
	 ...
	 */
	template <typename ElementDataType>
	inline bool Remove(const TTypedElementOwner<ElementDataType>& InElementOwner)
	{
	 ...
	 */
	inline int32 RemoveAll(TFunctionRef<bool(const HandleType&)> InPredicate)
	{
