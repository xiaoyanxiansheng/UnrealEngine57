...
public:
	 ...
	 */
	inline FTypedHandleTypeId GetTypeId() const
	{
		return TypeId;
	}
	 ...
	 */
	inline FTypedHandleElementId GetElementId() const
	{
		return ElementId;
	}
	 ...
	 */
	inline FTypedHandleCombinedId GetCombinedId() const
	{
		return CombinedId;
	}

	inline friend bool operator==(const FTypedElementId& InLHS, const FTypedElementId& InRHS)
	{
	...
	inline void Private_InitializeNoRef(const FTypedHandleTypeId InTypeId, const FTypedHandleElementId InElementId)
	{
		TypeId = InTypeId;
