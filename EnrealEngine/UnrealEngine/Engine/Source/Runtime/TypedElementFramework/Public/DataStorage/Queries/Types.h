...
namespace UE::Editor::DataStorage
{
	...
	struct FQueryResult final
	{
		enum class ECompletion
		{
			...
			Unavailable,
			/** 
			 * The provided callback is not compatible with the query. This can be due to missing columns in the selection or the access
			 * to a column is more restricted than the callback requests.
			 */
			Incompatible,
