...
public:
	...
	{
		UE::TWriteScopeLock ScopeLock(Lock);
	...
	{
		UE::TWriteScopeLock ScopeLockA(Other.Lock);
		UE::TWriteScopeLock ScopeLockB(Lock);
...
{
	return InstancedSkinnedMeshCache.Get<TObjectIterator<UInstancedSkinnedMeshComponent>>(InTransformProvider,
		[](UInstancedSkinnedMeshComponent* Component) { return 1; },
		[](UInstancedSkinnedMeshComponent* Component, int32) { return Component->GetTransformProvider(); });
}
