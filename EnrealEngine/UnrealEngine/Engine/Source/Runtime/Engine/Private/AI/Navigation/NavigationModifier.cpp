...
FString LexToString(ENavigationShapeType::Type Type)
{
	switch (Type)
	{
	case ENavigationShapeType::Unknown: return TEXT("Unknown");
	case ENavigationShapeType::Cylinder: return TEXT("Cylinder");
	case ENavigationShapeType::Box: return TEXT("Box");
	case ENavigationShapeType::Convex: return TEXT("Convex");
	case ENavigationShapeType::InstancedConvex: return TEXT("InstancedConvex");
	default:
		checkNoEntry();
		return FString();
	}
...
FString LexToString(ENavigationAreaMode::Type Type)
{
	switch (Type)
	{
	case ENavigationAreaMode::Apply: return TEXT("Apply");
	case ENavigationAreaMode::Replace: return TEXT("Replace");
	case ENavigationAreaMode::ApplyInLowPass: return TEXT("ApplyInLowPass");
	case ENavigationAreaMode::ReplaceInLowPass: return TEXT("ReplaceInLowPass");
	default:
		checkNoEntry();
		return FString();
	}
