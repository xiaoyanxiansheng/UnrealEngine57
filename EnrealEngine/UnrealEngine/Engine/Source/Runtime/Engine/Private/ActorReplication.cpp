...
void AActor::AddReplicatedSubObject(UObject* SubObject, ELifetimeCondition NetCondition)
{
	...
	{
		UE::Net::FReplicationSystemUtil::StartReplicatingActorSubObject(this, SubObject, NetCondition);
	}
}
...
void AActor::RemoveReplicatedSubObject(UObject* SubObject)
{
	...
	{
		UE::Net::FReplicationSystemUtil::StopReplicatingActorSubObject(this, SubObject);
	}
}
...
void AActor::AddActorComponentReplicatedSubObject(UActorComponent* OwnerComponent, UObject* SubObject, ELifetimeCondition NetCondition)
{
	...
	if (ComponentInfo)
	{
		...
		{
			UE::Net::FReplicationSystemUtil::StartReplicatingActorComponentSubObject(OwnerComponent, SubObject, NetCondition);
		}
	}
	else
	{
...
void AActor::RemoveActorComponentReplicatedSubObject(UActorComponent* OwnerComponent, UObject* SubObject)
{
	...
	if (bWasRemoved && HasAuthority())
	{
		UE::Net::FReplicationSystemUtil::StopReplicatingActorComponentSubObject(OwnerComponent, SubObject);
	}
}
...
void AActor::FillReplicationParams(const FFillReplicationParamsContext& Context, FActorReplicationParams& OutParams)
{
	OutParams = FActorReplicationParams();
}
...
void AActor::UpdateOwningNetConnection()
{
	...
	UObjectReplicationBridge* ObjectReplicationBridge = (ReplicationSystem ? ReplicationSystem->GetReplicationBridge() : nullptr);
