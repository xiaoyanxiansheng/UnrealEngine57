...
bool UParticleModuleCollisionGPU::IsValidForLODLevel(UParticleLODLevel* LODLevel, FString& OutErrorString)
{
	...
	const FMaterialResource* MaterialResource = Material->GetMaterialResource(World ? GetFeatureLevelShaderPlatform_Checked(World->GetFeatureLevel()) : GMaxRHIShaderPlatform);
	if (MaterialResource)
	{
