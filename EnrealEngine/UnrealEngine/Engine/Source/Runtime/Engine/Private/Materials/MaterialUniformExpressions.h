...
public:
	...
	int32 GetMaterialCacheTagIndex() const { return MaterialCacheTagIndex; }
	...
	void SetMaterialCacheTagIndex(uint32 InMaterialCacheTagIndex) { MaterialCacheTagIndex = InMaterialCacheTagIndex; }
...
public:
	...
	{
		TextureCollectionTypePrefixIndex = InPrefix;
	}

	int32 GetTextureCollectionTypePrefixIndex() const
	{
		return TextureCollectionTypePrefixIndex;
	}

	bool IsVirtualCollection() const
	{
		return bIsVirtualCollection;
	}
...
public:
	FMaterialUniformExpressionTextureCollectionParameter(const FMaterialParameterInfo& InParameterInfo, int32 InTextureCollectionIndex, int32 InTextureCollectionTypePrefixIndex, bool bIsVirtualCollection);
