...
void UAudioComponent::PlayInternal(const PlayInternalRequestData& InPlayRequestData, USoundBase* InSoundOverride)
{
...
#if WITH_EDITORONLY_DATA
	NewActiveSound.bIsDryPreviewPlayback = bIsDryPreviewPlayback;
#endif //WITH_EDITORONLY_DATA
	...
	const FString* EventLogID = &Audio::Trace::EventLog::ID::PlayRequestAudioComponent;
#else
...
#if UE_AUDIO_PROFILERTRACE_ENABLED
	const FString* EventLogID = &Audio::Trace::EventLog::ID::StopRequestAudioComponent;
#else
	const FString* EventLogID = nullptr;
#endif // UE_AUDIO_PROFILERTRACE_ENABLED
