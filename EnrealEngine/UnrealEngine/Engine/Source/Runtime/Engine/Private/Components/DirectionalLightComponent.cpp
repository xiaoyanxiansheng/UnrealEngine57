...
void UDirectionalLightComponent::SetEnableLightShaftOcclusion(bool bNewValue)
{
	...
	{
		bEnableLightShaftOcclusion = bNewValue;
		UpdateProxy([bEnableLightShaftOcclusion = (bool)bEnableLightShaftOcclusion](FLightSceneProxy* Proxy)
			{
				FDirectionalLightSceneProxy* DirectionalLightSceneProxy = (FDirectionalLightSceneProxy*)Proxy;
				DirectionalLightSceneProxy->bEnableLightShaftOcclusion = bEnableLightShaftOcclusion;
			});
	}
}
...
void UDirectionalLightComponent::SetLightShaftOverrideDirection(FVector NewValue)
{
	...
	{
		LightShaftOverrideDirection = NewValue;
		UpdateProxy([LightShaftOverrideDirection = LightShaftOverrideDirection](FLightSceneProxy* Proxy)
			{
				FDirectionalLightSceneProxy* DirectionalLightSceneProxy = (FDirectionalLightSceneProxy*)Proxy;
				DirectionalLightSceneProxy->LightShaftOverrideDirection = LightShaftOverrideDirection;
			});
	}
}
...
void UDirectionalLightComponent::SetLightSourceAngle(float NewValue)
{
	...
	{
		LightSourceAngle = NewValue;
		UpdateProxy([LightSourceAngle = LightSourceAngle](FLightSceneProxy* Proxy)
			{
				FDirectionalLightSceneProxy* DirectionalLightSceneProxy = (FDirectionalLightSceneProxy*)Proxy;
				DirectionalLightSceneProxy->LightSourceAngle = LightSourceAngle;
			});
	}
}
...
void UDirectionalLightComponent::SetLightSourceSoftAngle(float NewValue)
{
	...
	{
		LightSourceSoftAngle = NewValue;
		UpdateProxy([LightSourceSoftAngle = LightSourceSoftAngle](FLightSceneProxy* Proxy)
			{
				FDirectionalLightSceneProxy* DirectionalLightSceneProxy = (FDirectionalLightSceneProxy*)Proxy;
				DirectionalLightSceneProxy->LightSourceSoftAngle = LightSourceSoftAngle;
			});
	}
}
...
void UDirectionalLightComponent::SetShadowSourceAngleFactor(float NewValue)
{
	...
	{
		ShadowSourceAngleFactor = NewValue;
		UpdateProxy([ShadowSourceAngleFactor = ShadowSourceAngleFactor](FLightSceneProxy* Proxy)
			{
				FDirectionalLightSceneProxy* DirectionalLightSceneProxy = (FDirectionalLightSceneProxy*)Proxy;
				DirectionalLightSceneProxy->ShadowSourceAngleFactor = ShadowSourceAngleFactor;
			});
	}
}
...
void UDirectionalLightComponent::SetAtmosphereSunDiskColorScale(FLinearColor NewValue)
{
	...
	{
		AtmosphereSunDiskColorScale = NewValue;
		UpdateProxy([AtmosphereSunDiskColorScale = AtmosphereSunDiskColorScale](FLightSceneProxy* Proxy)
			{
				FDirectionalLightSceneProxy* DirectionalLightSceneProxy = (FDirectionalLightSceneProxy*)Proxy;
				DirectionalLightSceneProxy->SetAtmosphereSunDiskColorScale(AtmosphereSunDiskColorScale);
			});
	}
}
