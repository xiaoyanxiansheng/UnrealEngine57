	...
	for (UMaterialInterface* MaterialInterface : UsedMaterials)
	{
		if (MaterialInterface)
		{
			...
			else
			{
				...
				VtxElements.Add(FVertexElement(3, 0, VET_Half2, 4, 4));
				VtxElements.Add(FVertexElement(3, 0, VET_Half2, 5, 4));
				VtxElements.Add(FVertexElement(3, 0, VET_Half2, 6, 4));
				VtxElements.Add(FVertexElement(3, 0, VET_Half2, 7, 4));
				VtxElements.Add(FVertexElement(3, 0, VET_Half2, 15, 4));
