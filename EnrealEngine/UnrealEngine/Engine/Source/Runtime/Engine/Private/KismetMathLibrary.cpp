...
FOrientedBox UKismetMathLibrary::MakeOrientedBox(FVector Origin, FRotator Orientation, FVector Extent)
{
	FOrientedBox ToRet;
	ToRet.Center = Origin;
	GetAxes(Orientation, ToRet.AxisX, ToRet.AxisY, ToRet.AxisZ);
	ToRet.ExtentX = Extent.X;
	ToRet.ExtentY = Extent.Y;
	ToRet.ExtentZ = Extent.Z;
	return ToRet;
}
