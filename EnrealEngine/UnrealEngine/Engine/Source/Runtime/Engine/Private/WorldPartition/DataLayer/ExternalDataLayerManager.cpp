...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ExternalDataLayerManager)
...
bool UExternalDataLayerManager::IsExternalDataLayerInjected(const UExternalDataLayerAsset* InExternalDataLayerAsset) const
{
	...
	if (GetTypedOuter<UWorld>()->IsGameWorld())
	{
		...
		URuntimeHashExternalStreamingObjectBase* ExternalStreamingObject = ExternalStreamingObjectPtr ? ExternalStreamingObjectPtr->Get() : nullptr;
		if (ExternalStreamingObject)
		{
...
URuntimeHashExternalStreamingObjectBase* UExternalDataLayerManager::GetExternalStreamingObjectForDataLayerAsset(const UExternalDataLayerAsset* InAsset) const
{
	return ExternalStreamingObjects.FindRef(InAsset);
}
...
URuntimeHashExternalStreamingObjectBase* UExternalDataLayerManager::CreateExternalStreamingObjectUsingStreamingGeneration(const UExternalDataLayerAsset* InExternalDataLayerAsset)
{
	...
	ExternalStreamingObject->SetPackagePathToCreate(GetExternalStreamingObjectPackagePath(InExternalDataLayerAsset));
