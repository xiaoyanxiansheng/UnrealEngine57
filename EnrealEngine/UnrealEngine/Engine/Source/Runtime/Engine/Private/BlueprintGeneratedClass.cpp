...
void UBlueprintGeneratedClass::Link(FArchive& Ar, bool bRelinkExistingProperties)
{
	...
	// If our parent class needs dynamic instancing, this class should also inherit that trait.
	bNeedsDynamicSubobjectInstancing = bSupportsDynamicInstancedReference || GetSuperClass()->ShouldUseDynamicSubobjectInstancing();
}
