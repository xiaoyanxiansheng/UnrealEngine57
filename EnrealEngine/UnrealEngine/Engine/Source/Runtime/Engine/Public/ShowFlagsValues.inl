...
SHOWFLAG_ALWAYS_ACCESSIBLE(DisableOcclusionQueries, SFG_Hidden, NSLOCTEXT("UnrealEd", "DisableOcclusionQueries", "Disable Hardware Occlusion Queries"))
...
SHOWFLAG_FIXED_IN_SHIPPING(0, VisualizeLWCComplexity, SFG_Hidden, NSLOCTEXT("UnrealEd", "VisualizeLWCComplexity", "Visualize Material LWC Function Usage"))

SHOWFLAG_FIXED_IN_SHIPPING(0, VisualizeShadowCasters, SFG_Hidden, NSLOCTEXT("UnrealEd", "VisualizeShadowCasters", "Visualize VSM Shadow Casters"))
...
SHOWFLAG_ALWAYS_ACCESSIBLE(StereoMotionVectors, SFG_Hidden, NSLOCTEXT("UnrealEd", "MotionVectorsSF", "Render Stereo Motion Vectors for OpenXR"))

/** Geometry Inspection modes. */
SHOWFLAG_FIXED_IN_SHIPPING(0, Clay, SFG_Hidden, NSLOCTEXT("UnrealEd", "Clay", "Clay"))
SHOWFLAG_FIXED_IN_SHIPPING(0, Zebra, SFG_Hidden, NSLOCTEXT("UnrealEd", "Zebra", "Zebra"))
SHOWFLAG_FIXED_IN_SHIPPING(0, FrontBackFace, SFG_Hidden, NSLOCTEXT("UnrealEd", "FrontBackFace", "Front/Back Face"))
SHOWFLAG_FIXED_IN_SHIPPING(0, RandomColor, SFG_Hidden, NSLOCTEXT("UnrealEd", "RandomColor", "RandomColor"))
