...
public:
	 ...
	 */
	inline AActor* GetActorChecked() const
	{
		check(CurrentActor);
...
protected:
	 ...
	 * @return	true
	 */
	inline bool IsActorSuitable(const AActor* Actor) const
	{
	 ...
	 */
	inline bool CanIterateLevel(const ULevel* Level) const
	{
...
public:
	...
	*/
	 ...
	 */
	inline bool IsEditorDataStripped() const
	{
