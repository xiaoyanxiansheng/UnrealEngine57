...
struct FNavigationModifier
{
	...
	inline bool HasMetaAreas() const { return !!bHasMetaAreas; }
...
ENGINE_API FString LexToString(ENavigationAreaMode::Type Type);
...
struct FAreaNavModifier : public FNavigationModifier
{
	...
	inline const FBox& GetBounds() const { return Bounds; }
	inline ENavigationShapeType::Type GetShapeType() const { return ShapeType; }
	inline ENavigationAreaMode::Type GetApplyMode() const { return ApplyMode; }
	inline bool IsLowAreaModifier() const { return bIsLowAreaModifier; }
	inline bool ShouldExpandTopByCellHeight() const { return bExpandTopByCellHeight; }
	inline bool ShouldIncludeAgentHeight() const { return bIncludeAgentHeight; }
	inline void SetExpandTopByCellHeight(bool bExpand) { bExpandTopByCellHeight = bExpand; }
	inline FAreaNavModifier& SetIncludeAgentHeight(bool bInclude) { bIncludeAgentHeight = bInclude; return *this; }
	inline const TSubclassOf<UNavAreaBase> GetAreaClass() const { return TSubclassOf<UNavAreaBase>(AreaClassOb.Get()); }
	inline const TSubclassOf<UNavAreaBase> GetAreaClassToReplace() const { return TSubclassOf<UNavAreaBase>(ReplaceAreaClassOb.Get()); }
...
struct FSimpleLinkNavModifier : public FNavigationModifier
{
	...
	inline bool HasFallDownLinks() const { return !!bHasFallDownLinks; }
...
struct FCustomLinkNavModifier : public FNavigationModifier
{
	...
	inline const TSubclassOf<UNavLinkDefinition> GetNavLinkClass() const { return TSubclassOf<UNavLinkDefinition>(LinkDefinitionClassOb.Get()); }
...
struct FCompositeNavModifier : public FNavigationModifier
{
	...
	inline const TArray<FAreaNavModifier>& GetAreas() const { return Areas; }
	inline const TArray<FSimpleLinkNavModifier>& GetSimpleLinks() const { return SimpleLinks; }
	inline const TArray<FCustomLinkNavModifier>& GetCustomLinks() const { return CustomLinks; }
	
	inline bool HasLinks() const { return (SimpleLinks.Num() > 0) || (CustomLinks.Num() > 0); }
	inline bool HasPotentialLinks() const { return bHasPotentialLinks; }
	inline bool HasAgentHeightAdjust() const { return bAdjustHeight; }
	inline bool HasAreas() const { return Areas.Num() > 0; }
	inline bool HasLowAreaModifiers() const { return bHasLowAreaModifiers; }
	inline bool IsPerInstanceModifier() const { return bIsPerInstanceModifier; }
	inline bool GetFillCollisionUnderneathForNavmesh() const { return bFillCollisionUnderneathForNavmesh; }
	inline void SetFillCollisionUnderneathForNavmesh(bool bValue) { bFillCollisionUnderneathForNavmesh = bValue; }
	inline bool GetMaskFillCollisionUnderneathForNavmesh() const { return bMaskFillCollisionUnderneathForNavmesh; }
	inline void SetMaskFillCollisionUnderneathForNavmesh(bool bValue) { bMaskFillCollisionUnderneathForNavmesh = bValue; }
	inline bool GetRasterizeAsFilledConvexVolume() const { return bRasterizeAsFilledConvexVolume; }
	inline void SetRasterizeAsFilledConvexVolume(bool bValue) { bRasterizeAsFilledConvexVolume = bValue; }
	inline ENavigationDataResolution GetNavMeshResolution() const { return bEnableNavMeshResolutions ? NavMeshResolution : ENavigationDataResolution::Invalid; }
	inline void SetNavMeshResolution(ENavigationDataResolution Resolution) { NavMeshResolution = Resolution; }
	inline void ReserveForAdditionalAreas(int32 AdditionalElementsCount) { Areas.Reserve(Areas.Num() + AdditionalElementsCount); }
