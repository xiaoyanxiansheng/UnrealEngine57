...
namespace UE::Anim
{
static constexpr EAlphaBlendOption DefaultBlendOption = EAlphaBlendOption::HermiteCubic;
}
...
#if WITH_EDITORONLY_DATA
template<> struct TStructOpsTypeTraits<FAlphaBlendArgs> : public TStructOpsTypeTraitsBase2<FAlphaBlendArgs>
{
	enum
	{
		WithSerializer = true,
...
template<> struct TStructOpsTypeTraits<FAlphaBlend> : public TStructOpsTypeTraitsBase2<FAlphaBlend>
{
	enum
	{
		WithSerializer = true,
