...
class UMaterialInstanceDynamic : public UMaterialInstance
{
	...
	*/
	 ...
	 */
	UE_DEPRECATED(5.7, "Please use CopyScalarAndVectorParameters with EShaderPlatform argument and not ERHIFeatureLevel::Type")
	ENGINE_API void CopyScalarAndVectorParameters(const UMaterialInterface& SourceMaterialToCopyFrom, ERHIFeatureLevel::Type InFeatureLevel);
	ENGINE_API void CopyScalarAndVectorParameters(const UMaterialInterface& SourceMaterialToCopyFrom, EShaderPlatform ShaderPlatform);
