...
public:
	...
	virtual bool IsDependent(UMaterialFunctionInterface* OtherFunction)
	...
	virtual void GetDependentFunctions(TArray<UMaterialFunctionInterface*>& DependentFunctions) const
...
public:
	...
	ENGINE_API bool OverrideNamedParameterCollectionParameter(const FHashedMaterialParameterInfo& ParameterInfo, class UMaterialParameterCollection*& OutValue);
