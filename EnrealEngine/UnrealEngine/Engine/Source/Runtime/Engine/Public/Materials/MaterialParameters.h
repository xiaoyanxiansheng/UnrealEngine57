...
struct FMaterialParameterInfo
{
	...
	friend inline bool operator==(const FMaterialParameterInfo& Lhs, const FMaterialParameterInfo& Rhs)
	{
	...
	friend inline uint32 GetTypeHash(const FMaterialParameterInfo& Value)
	{
...
public:
	...
	inline FName GetName() const { return ScriptNameToName(Name); }
	...
	friend inline bool operator==(const FMemoryImageMaterialParameterInfo& Lhs, const FMemoryImageMaterialParameterInfo& Rhs)
	{
	...
	friend inline bool operator==(const FMaterialParameterInfo& Lhs, const FMemoryImageMaterialParameterInfo& Rhs)
	{
	...
	friend inline bool operator==(const FMemoryImageMaterialParameterInfo& Lhs, const FMaterialParameterInfo& Rhs)
	{
		return Lhs.Name == Rhs.Name && Lhs.Index == Rhs.Index && Lhs.Association == Rhs.Association;
	}
	...
	friend inline uint32 GetTypeHash(const FMemoryImageMaterialParameterInfo& Value)
	{
		return HashCombine(HashCombine(GetTypeHash(Value.Name), Value.Index), (uint32)Value.Association);
	}
};

inline FMaterialParameterInfo::FMaterialParameterInfo(const struct FMemoryImageMaterialParameterInfo& Rhs)
...
struct FMaterialParameterValue
{
	...
	FMaterialParameterValue(const TObjectPtr<UMaterialParameterCollection>& InValue) : Type(EMaterialParameterType::ParameterCollection) { ParameterCollection = InValue; }
	...
	FMaterialParameterValue(const UMaterialParameterCollection* InValue) : Type(EMaterialParameterType::ParameterCollection) { ParameterCollection = const_cast<UMaterialParameterCollection*>(InValue); }
	...
	friend inline bool operator==(const FMaterialParameterValue& Lhs, const FMaterialParameterValue& Rhs)
	{
		...
		case EMaterialParameterType::ParameterCollection: return Lhs.ParameterCollection == Rhs.ParameterCollection;
...
struct FMaterialParameterMetadata
{
	...
	/** Enumeration object for scalar values to use in the UI */
	TSoftObjectPtr<UObject> ScalarEnumeration;

	/** Index into material instance enumeration objects for scalar values to use in the UI */
	int32 ScalarEnumerationIndex = INDEX_NONE;
