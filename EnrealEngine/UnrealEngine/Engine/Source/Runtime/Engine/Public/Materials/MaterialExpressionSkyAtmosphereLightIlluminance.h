...
UCLASS()
class UMaterialExpressionSkyAtmosphereLightIlluminance : public UMaterialExpressionExternalCodeBase
{
	GENERATED_BODY()
...
UCLASS()
class UMaterialExpressionSkyAtmosphereAerialPerspective : public UMaterialExpressionExternalCodeBase
{
	GENERATED_BODY()
...
UCLASS()
class UMaterialExpressionSkyAtmosphereDistantLightScatteredLuminance : public UMaterialExpressionExternalCodeBase
{
	GENERATED_BODY()
