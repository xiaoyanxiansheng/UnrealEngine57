...
template <typename ParameterType, typename ExpressionType>
bool UpdateParameterSet(TArray<FParameterCollectionParameterValue>& Parameters, UMaterial* ParentMaterial)
{
	return MaterialInstance_Private::UpdateParameterSet_WithCachedData<FParameterCollectionParameterValue, ExpressionType>(EMaterialParameterType::ParameterCollection, Parameters, ParentMaterial);
}
