...
class UMaterialExpressionPerInstanceCustomData : public UMaterialExpressionExternalCodeBase
{
	GENERATED_BODY()
...
UCLASS(collapsecategories, hidecategories=Object)
class UMaterialExpressionPerInstanceCustomData3Vector : public UMaterialExpressionExternalCodeBase
{
	GENERATED_BODY()
