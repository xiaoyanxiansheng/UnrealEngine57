...
public:
	inline FPrimitiveUniformShaderParametersBuilder& Defaults()
	{
		...
		Parameters.MaterialCacheDescriptor		    = 0;
...
#undef PRIMITIVE_UNIFORM_BUILDER_METHOD
	...
	inline const FPrimitiveUniformShaderParameters& Build()
	{
		...
		Parameters.Flags |= bHasRayTracingRepresentation ? PRIMITIVE_SCENE_DATA_FLAG_HAS_RAY_TRACING_REPRESENTATION : 0u;
	...
	#endif
		Parameters.VisibilityFlags |= bVisibleInMainPass ? PRIMITIVE_VISIBILITY_FLAG_VISIBLE_IN_MAIN_PASS : 0u;
...
private:
	...
	uint32 bHasRayTracingRepresentation : 1;
