...
template<>
inline void BlendTransform<ETransformBlendMode::Overwrite>(const FTransform& Source, FTransform& Dest, const float BlendWeight)
{
...
template<>
inline void BlendTransform<ETransformBlendMode::Accumulate>(const FTransform& Source, FTransform& Dest, const float BlendWeight)
{
	const ScalarRegister VBlendWeight(BlendWeight);
...
public:
	...
	**/
	...
	static ENGINE_API void UpdateDesiredBoneWeight(
...
public:
	...
	static inline bool IsFullWeight(float Weight) { return FAnimWeight::IsFullWeight(Weight); }
	static inline bool HasWeight(float Weight) { return FAnimWeight::IsRelevant(Weight); }
