...
struct FStreamableRenderResourceState
{
	...
	inline FStreamableRenderResourceState(const FStreamableRenderResourceState& Other)
		: Data(Other.Data)
	{
	}
	inline void operator=(const FStreamableRenderResourceState& Other)
	{
		Data = Other.Data;
	}
	...
	inline int32 LODCountToAssetFirstLODIdx(int32 InLODCount) const
	{
	...
	inline bool IsValidForStreamingRequest() const
	{
	...
	/** Validate that everything is valid and makes sense for a streaming requests. */
	inline bool StreamIn(int32 InLODCount)
	{
	...
	inline bool StreamOut(int32 InLODCount)
	{
