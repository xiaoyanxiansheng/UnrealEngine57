...
public:
	...
	inline ETickState GetNextTickState() const { return NextTickState; }
	inline ETickThread GetNextTickThread() const { return NextTickThread; }
...
protected:
	...
	inline void AdvanceTo(ETickState InState, ETickThread InThread)
	{
