...
public:
	...
	inline const int32 IsEmpty() const { return ArrayView.IsEmpty(); }

	/**
	 * DO NOT USE DIRECTLY
	 * STL-like iterators to enable range-based for loop support.
	 */
	inline T** begin() const { return ArrayView.begin(); }
	inline T** end() const { return ArrayView.end(); }
...
private:
	...
	TComponentTypeCache<UInstancedSkinnedMeshComponent, UTransformProviderData> InstancedSkinnedMeshCache;
