...
private:
	...
	void AddVisualizationMode(
		...
		TArray<FVisualizationDataLegendEntry>&& LegendEntries = TArray<FVisualizationDataLegendEntry>()
	);
...
private:
	...
	/** Current visualization mode name set from command console */
	FString CurrentConsoleVisualizationMode;
