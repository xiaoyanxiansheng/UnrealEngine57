...
template<> inline FBodyInstance* FPhysicsUserData_Chaos::Get(void* UserData)
{
	return Get<FBodyInstance, EType::BodyInstance>(UserData);
}

template<> inline UPhysicalMaterial* FPhysicsUserData_Chaos::Get(void* UserData)
{
	return Get<UPhysicalMaterial, EType::PhysicalMaterial>(UserData);
}

template<> inline FPhysScene* FPhysicsUserData_Chaos::Get(void* UserData)
{
	return Get<FPhysScene, EType::PhysScene>(UserData);
}

template<> inline FConstraintInstanceBase* FPhysicsUserData_Chaos::Get(void* UserData)
{
