...
public:
	 ...
	 */
	inline bool IsOutOfDate(const UEdGraphNode* InOwningNode) const
	{
	 ...
	 */
	inline bool IsOutOfDate(const UEdGraphSchema* InSchema) const
	{
	 ...
	 * @param InOwningNode		Node that owns this title
	 */
	inline void SetCachedText(FText const& InText, const UEdGraphNode* InOwningNode) const
	{
	 ...
	 * @param InSchema			Schema to use for checking if externally made out of date
	 */
	inline void SetCachedText(FText const& InText, const UEdGraphSchema* InSchema) const
	{
		UpdateCacheIternal(InText);
	...
	/** */
	inline FText& GetCachedText() const
	{
		return CachedText;
	}
...
private:
	...
	inline void UpdateCacheIternal(FText const& InText) const
	{
...
public:
	 ...
	 * @param InOwningNode		Node that owns this title
	 */
	inline bool IsTitleCached(ENodeTitleType::Type InTitleType, const UEdGraphNode* InOwningNode) const
	{
	 ...
	 * @param InOwningNode		Node that owns this title
	 */
	inline void SetCachedTitle(ENodeTitleType::Type InTitleType, FText const& InText, const UEdGraphNode* InOwningNode) const
	{
		CachedNodeTitles[InTitleType].SetCachedText(InText, InOwningNode);
	}

	/** */
	inline FText& GetCachedTitle(ENodeTitleType::Type TitleType) const
	{
	...
	/** */
	inline FText& operator[](ENodeTitleType::Type TitleIndex) const
	{
...
public:
	 ...
	 * @param InOwningNode		Node that owns this title
	 */
	inline bool IsTooltipCached(const UEdGraphNode* InOwningNode) const
	{
	 ...
	 * @param InOwningNode		Node that owns this title
	 */
	inline void SetCachedTooltip(FText const& InText, const UEdGraphNode* InOwningNode) const
	{
		const UEdGraphSchema* NullSchema = nullptr;
	...
	/** */
	inline FText GetCachedTooltip() const
	{
