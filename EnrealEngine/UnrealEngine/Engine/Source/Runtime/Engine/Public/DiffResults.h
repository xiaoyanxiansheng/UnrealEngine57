...
namespace EDiffType
{
	...
	enum Type
	{
		...
		// User defined custom diff. Allows user to override property diffing and panel widgets
		CUSTOM_OBJECT
	};
...
struct FDiffSingleResult
{
	...
	inline bool IsRealDifference() const 
	{
		switch (Diff)
		{
...
inline bool operator==( const FDiffSingleResult& LHS, const FDiffSingleResult& RHS )
{
