...
public:
	...
	*/
	...
	inline bool HasPrimsToDraw() const
	{
	 ...
	 */
	inline uint32 GetAllocatedSize( void ) const
	{
...
private:
	 ...
	 */
	ENGINE_API void DrawPointElements(FRHICommandList& RHICmdList, const FMatrix& Transform, const uint32 ViewportSizeX, const uint32 ViewportSizeY, const FVector& CameraX, const FVector& CameraY, const uint32 NumInstances) const;
