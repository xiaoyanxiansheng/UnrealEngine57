...
public:
	 ...
	 */
	inline void SetBeamTrailUniformBuffer( FParticleBeamTrailUniformBufferRef InSpriteUniformBuffer )
	{
	 ...
	 */
	inline FParticleBeamTrailUniformBufferRef GetBeamTrailUniformBuffer()
	{
