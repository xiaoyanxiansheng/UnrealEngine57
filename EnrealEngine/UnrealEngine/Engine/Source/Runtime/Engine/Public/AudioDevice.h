...
public:
	...
	*/
	...
	UE_DEPRECATED(5.7, "With PCM audio caching removed, this hueristic is no longer used.")
	 ...
	 */
	UE_DEPRECATED(5.7, "Most of these arguments are no longer used, replace calls with the caller's value for bForceFullDecompression")
	...
	*/
	 ...
	 * Adds an active sound to the audio device
	 */
	UE_DEPRECATED(5.7, "Use AddNewActiveSound which accepts a TSharedRef<>")
...
protected:
	...
	UE_DEPRECATED(5.7, "NotifySubsystemsSetOwner is deprecated. Use ActiveSound.GetOwnerKey instead.")
...
public:
	...
	*/
	...
	UE_DEPRECATED(5.7, "Realtime decpmpression is available on all platforms")
...
private:
	 ...
	 * loop system.
	 */
	void AddNewActiveSoundInternal(TSharedRef<FActiveSound> InActiveSound, TArray<FAudioParameter>&& InDefaultParams, FAudioVirtualLoop* InVirtualLoopToRetrigger = nullptr);
	...
	*/
	...
	/** Notify Audio Insights that an active sound is still alive and playing. */
	void SendSoundIsAlivePingTraceMessage(const FActiveSound& InActiveSound) const;
#endif // UE_AUDIO_PROFILERTRACE_ENABLED
...
public:
	 ...
	 */
	template <typename TSubsystemClass>
	static inline TSubsystemClass* GetSubsystem(const FAudioDeviceHandle& InHandle)
	{
		if (InHandle.IsValid())
		{
...
public:
	...
	UE_DEPRECATED(5.7, "bDisableAudioCaching has no effect and will be removed in 5.8")
