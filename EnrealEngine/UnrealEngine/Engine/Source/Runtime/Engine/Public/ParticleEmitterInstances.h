...
public:
	...
	inline void SetFakeBurstWhenSpawningSupressed(bool bInFakeBurstsWhenSpawningSupressed)
	{
	 ...
	 */
	UE_DEPRECATED(5.7, "Please use GatherMaterialRelevance with EShaderPlatform argument and not ERHIFeatureLevel::Type")
	...
	ENGINE_API virtual void GatherMaterialRelevance( FMaterialRelevance* OutMaterialRelevance, const UParticleLODLevel* LODLevel, EShaderPlatform InShaderPlatform ) const;
...
struct FScopeCycleCounterEmitter : public FCycleCounter
{
	...
	*/
	template<class T>
	inline FScopeCycleCounterEmitter(const T *Object)
	{
		if (Object)
		{
	...
	*/
	template<class T>
	inline FScopeCycleCounterEmitter(const T *Object, TStatId OtherStat)
	{
	...
	*/
	inline ~FScopeCycleCounterEmitter()
	{
		Stop();
	}
};
...
{
	inline FScopeCycleCounterEmitter(const FParticleEmitterInstance *Object)
	{
	}
	inline FScopeCycleCounterEmitter(const FParticleEmitterInstance *Object, TStatId OtherStat)
	{
	}
};
#endif
...
struct FParticleMeshEmitterInstance : public FParticleEmitterInstance
{
	...
	ENGINE_API virtual void GatherMaterialRelevance(FMaterialRelevance* OutMaterialRelevance, const UParticleLODLevel* LODLevel, EShaderPlatform InShaderPlatform) const override;

	/**
	 * Gets the materials applied to each section of a mesh.
	 */
	UE_DEPRECATED(5.7, "Please use GatherMaterialRelevance without ERHIFeatureLevel::Type")
