...
public:
	...
	{ 
		...
		const bool bIsStaticInstance = !bDynamicRayTracingInstances && !bDynamicRayTracingGeometry;
...
protected:
...
#if RHI_RAYTRACING
	ENGINE_API virtual void GetRayTracingWPOConfig(bool& bOutHasRayTracingRepresentation, bool& bOutDynamicRayTracingGeometry) const;
	ENGINE_API virtual bool ShouldEvaluateWPOInRayTracing(FVector ViewCenter) const;
	...
	bool bDynamicRayTracingInstances : 1;
	bool bDynamicRayTracingGeometry : 1;
	bool bCreateDynamicRayTracingGeometries : 1;
