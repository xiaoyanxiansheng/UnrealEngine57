...
struct FScreenshotRequest
{
	 ...
	 * @param bHdrScreenshot		If true, the screenshot is saved as .exr rather than .png
	 * @param InViewRect			If non-empty, within the viewport extent, and bInShowUI=false, only this view rect will be included in the screenshot
	 */
	...
	/**
	 * @return The view rect for the next screenshot
	 */
	static FIntRect GetViewRect() { return ViewRect; }
...
private:
	...
	static ENGINE_API FIntRect ViewRect;
};
