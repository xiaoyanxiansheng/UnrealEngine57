...
public:
	 ...
	 */
	inline bool HasPassedChallenge(const TSharedPtr<const FInternetAddr>& Address, bool& bOutRestartedHandshake) const
	{
	 ...
	 */
	inline void GetChallengeSequence(int32& OutServerSequence, int32& OutClientSequence) const
	{
	 ...
	 */
	inline bool DoesRestartedHandshakeMatch(StatelessConnectHandlerComponent& NetConnComponent) const
	{
	 ...
	 */
	inline void ResetChallengeData()
	{
