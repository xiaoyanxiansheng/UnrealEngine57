...
public:
	...
	inline EParticleVertexFactoryType GetParticleFactoryType() const
	{
...
public:
	 ...
	 */
	inline void SetSpriteUniformBuffer( const FParticleSpriteUniformBufferRef& InSpriteUniformBuffer )
	{
	 ...
	 */
	inline FRHIUniformBuffer* GetSpriteUniformBuffer()
	{
