...
public:
	...
	void SetInside(bool bNewInside) { bInside = bNewInside; }
	void SetOutside(bool bNewOutside) { bOutside = bNewOutside; }
	bool GetInside() const { return bInside; }
	bool GetOutside() const { return bOutside; }
};
