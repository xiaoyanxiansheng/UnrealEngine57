...
#if WITH_EDITOR
	ENGINE_API virtual void InitializeEditorResources(FRHICommandListBase& RHICmdList, IVirtualTexture* InVirtualTexture);
#endif
...
public:
	...
	inline FLinearColor GetClearColor()
	{
		return ClearColor;
	}
...
protected:
	...
	inline void Resize(FRHICommandListBase& RHICmdList, int32 NewSizeX, int32 NewSizeY, bool bAutoGenerateMips)
	{
