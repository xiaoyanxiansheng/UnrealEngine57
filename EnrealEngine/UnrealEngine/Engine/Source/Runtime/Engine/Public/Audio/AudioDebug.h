...
namespace Audio
{
	...
	inline bool MatchesLogFilter(const TCHAR* InName) { return false; } // Off for shipping.
#else
	ENGINE_API bool MatchesLogFilter(const TCHAR* InName);
#endif // UE_BUILD_SHIPPING
	
	inline bool MatchesLogFilter(const FName& InName)
	{
#if UE_BUILD_SHIPPING
...
namespace Audio
{
	...
	public:
		...
		ENGINE_API bool IsMuteOrSoloActive() const;
