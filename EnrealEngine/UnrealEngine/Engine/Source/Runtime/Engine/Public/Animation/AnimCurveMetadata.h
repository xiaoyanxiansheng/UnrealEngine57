...
public:
	 ...
	 */
	virtual bool GetCurveMetaDataMaterial(FName CurveName) const = 0;
	 ...
	 * @return	true if the flag has been set
	 */
	virtual bool GetCurveMetaDataMorphTarget(FName CurveName) const = 0;
...
public:
	...
	virtual bool GetCurveMetaDataMaterial(FName CurveName) const override;
	virtual bool GetCurveMetaDataMorphTarget(FName CurveName) const override;
