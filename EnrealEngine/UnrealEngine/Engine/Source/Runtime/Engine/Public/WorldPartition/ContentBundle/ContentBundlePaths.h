...
namespace ContentBundlePaths
{
	...
	inline constexpr FStringView ContentBundleAssetRegistryTagString = TEXTVIEW("ContentBundleGuids");	
	...
	ENGINE_API bool BuildContentBundleActorsRootPath(const FString& InContenBundleMountPoint, const FGuid& InContentBundleGuid,  FString& OutContainerPackagePath);
