...
class UWorldPartitionLevelStreamingDynamic : public ULevelStreamingDynamic
{
	...
	UE_DEPRECATED(5.7, "LoadInEditor() is no longer supported and will be removed in a future version.")
	...
	UE_DEPRECATED(5.7, "UnloadFromEditor() is no longer supported and will be removed in a future version.")
