...
#include "HLODOnlyLevelInstanceActor.generated.h"

UCLASS(MinimalAPI, HideCategories=(Rendering, Replication, Collision, Physics, Navigation, Networking, Input, Actor, LevelInstance, HLOD, WorldPartition, Cooking, DataLayers))
class AWorldPartitionHLODOnlyLevelInstance : public AActor, public ILevelInstanceInterface
{
	GENERATED_BODY()

public:
	ENGINE_API AWorldPartitionHLODOnlyLevelInstance(const FObjectInitializer& ObjectInitializer);
	...
	ENGINE_API virtual bool HasStandaloneHLOD() const override;
#endif // WITH_EDITOR
