...
public:
	 ...
	 */
	inline void SetStyles(EGraphAxisStyle::Type NewAxisStyle, EGraphDataStyle::Type NewDataStyle) { AxisStyle = NewAxisStyle; DataStyle = NewDataStyle; }

	/** Set the color of the axes.
	 * @param NewAxesColor The colour to set the axes to.
	*/
	inline void SetAxesColor(FLinearColor NewAxesColor) { AxesColor = NewAxesColor; }
	 ...
	 */
	inline void SetNotchesPerAxis(int NewNumXNotches, int NewNumYNotches) { NumXNotches = NewNumXNotches; NumYNotches = NewNumYNotches; }
