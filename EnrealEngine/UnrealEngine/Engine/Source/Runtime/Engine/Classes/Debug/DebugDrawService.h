...
class UDebugDrawService : public UBlueprintFunctionLibrary
{
	...
	static ENGINE_API void Draw(const FEngineShowFlags Flags, UCanvas* Canvas, APlayerController* PlayerController = nullptr);

	/** Initialize a debug canvas object then calls above draw. If CanvasObject is null it will find/create it for you */
	static ENGINE_API void Draw(const FEngineShowFlags Flags, FViewport* Viewport, FSceneView* View, FCanvas* Canvas, UCanvas* CanvasObject = nullptr, APlayerController* PlayerController = nullptr);
private:
