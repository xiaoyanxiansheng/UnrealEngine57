...
struct FCurveAttributes
{
	...
	{
		return Left.bHasPreExtrapolation == Right.bHasPreExtrapolation
			&& Left.bHasPostExtrapolation == Right.bHasPostExtrapolation
			&& (!Left.bHasPreExtrapolation || Left.PreExtrapolation == Right.PreExtrapolation)
			&& (!Left.bHasPostExtrapolation || Left.PostExtrapolation == Right.PostExtrapolation);
	}
	friend bool operator!=(const FCurveAttributes& Left, const FCurveAttributes& Right) { return !(Left == Right); }
