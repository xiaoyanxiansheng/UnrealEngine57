...
public:
	 ...
	 *  
	 * @param Index				The index at which to replace the handle
	 * @param HandleToReplace	The key handle to set at the index. Fails if this handle already is in the table.
	 */
