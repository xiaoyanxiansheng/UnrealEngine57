...
public:
	...
	inline class APlayerState* GetPauserPlayerState() const { return PauserPlayerState; }
	inline virtual void SetPauserPlayerState(class APlayerState* PlayerState) { PauserPlayerState = PlayerState; }
