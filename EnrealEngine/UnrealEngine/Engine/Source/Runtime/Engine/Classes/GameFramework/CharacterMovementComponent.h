...
public:
	...
	inline float GetServerLastTransformUpdateTimeStamp() const { return ServerLastTransformUpdateTimeStamp;  }
...
public:
	...
	inline float GetWalkableFloorAngle() const { return WalkableFloorAngle; }
	...
	inline float GetWalkableFloorZ() const { return WalkableFloorZ; }
...
inline ACharacter* UCharacterMovementComponent::GetCharacterOwner() const
{
	return CharacterOwner;
}

inline bool UCharacterMovementComponent::IsWalking() const
{
	return IsMovingOnGround();
}

inline uint32 UCharacterMovementComponent::PackYawAndPitchTo32(const float Yaw, const float Pitch)
{
...
public:
	...
	ENGINE_API virtual void Serialize(FArchive& Archive);
