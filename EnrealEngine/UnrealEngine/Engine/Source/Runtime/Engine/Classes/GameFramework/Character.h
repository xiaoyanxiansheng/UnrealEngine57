...
public:
	...
	template <class T>
	inline T* GetCharacterMovement() const
	{
		return CastChecked<T>(CharacterMovement, ECastCheckedType::NullAllowed);
	}
	inline UCharacterMovementComponent* GetCharacterMovement() const { return CharacterMovement; }
...
public:
	...
	inline uint8 GetReplicatedMovementMode() const { return ReplicatedMovementMode; }
...
public:
	...
	inline const FRepRootMotionMontage& GetRepRootMotion() const { return RepRootMotion; }
