...
public:	
	...
	// Subtitles need to be able to grab the UDialogueSoundWaveProxy to for localized text and duration.
	ENGINE_API const UDialogueSoundWaveProxy* GetContextualDialogueSoundWaveProxy() const;
