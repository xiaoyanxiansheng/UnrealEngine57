...
public:
	...
	inline int32 GetFrameIndex() const
	{
		return CurrentFrameIndex;
	}

	inline int32 GetNumFramesInWave() const
	{
		return NumFramesInWave;
	}

	inline int32 GetNumFramesInLoop() const
	{
		return LoopEndFrameIndex - LoopStartFrameIndex;
	}

	inline int32 GetLoopStartFrameIndex() const
	{
		return LoopStartFrameIndex;
	}

	inline int32 GetLoopEndFrameIndex() const
	{
