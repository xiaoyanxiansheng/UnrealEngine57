...
#if WITH_EDITOR
	/**
	 * Apply the switched to internal values if they exists.
	 *
	 * @param	Switches	The switches to apply to internal properties.
	 *
	 * @return	True if all values were properly applied.
	 */
	static ENGINE_API bool ApplyCommandLineSwitches( UObject* Object, const TArray<FString>& Switches );
#endif //  WITH_EDITOR
