...
struct FNavigationRelevantData : public TSharedFromThis<FNavigationRelevantData, ESPMode::ThreadSafe>
{
	...
	*	Mind that this flag can go back to 'true' if related data gets cleared out. */
	...
	inline bool HasGeometry() const { return VoxelData.Num() || CollisionData.Num(); }
	inline bool HasModifiers() const { return !Modifiers.IsEmpty(); }
	inline bool HasDynamicModifiers() const { return Modifiers.IsDynamic(); }
	inline bool IsPendingLazyGeometryGathering() const { return bPendingLazyGeometryGathering; }
	inline bool IsPendingLazyModifiersGathering() const { return bPendingLazyModifiersGathering; }
	inline bool IsPendingChildLazyModifiersGathering() const { return bPendingChildLazyModifiersGathering; }
	inline bool NeedAnyPendingLazyModifiersGathering() const { return bPendingLazyModifiersGathering || bPendingChildLazyModifiersGathering; }
	inline bool SupportsGatheringGeometrySlices() const { return bSupportsGatheringGeometrySlices; }
	 ...
	 */
	inline bool ShouldSkipDirtyAreaOnAddOrRemove() const { return bShouldSkipDirtyAreaOnAddOrRemove; }

	inline bool IsEmpty() const { return !HasGeometry() && !HasModifiers(); }
	inline SIZE_T GetAllocatedSize() const { return CollisionData.GetAllocatedSize() + VoxelData.GetAllocatedSize() + Modifiers.GetAllocatedSize(); }
	inline SIZE_T GetGeometryAllocatedSize() const { return CollisionData.GetAllocatedSize() + VoxelData.GetAllocatedSize(); }
