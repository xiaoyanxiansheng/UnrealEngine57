...
public:
	...
	virtual void ResizeNode(const FVector2D& NewSize) UE_SLATE_DEPRECATED_VECTOR_VIRTUAL_FUNCTION {}
	...
	*/
	...
	// snapping
	ENGINE_API bool IsSnappedToAny(const TSet<TObjectPtr<UObject>>& NodeSet ) const;
	ENGINE_API UEdGraphNode* GetRootSnappedParent(const TSet<TObjectPtr<UObject>>& NodeSet) const;
	// snapping
protected:
#if WITH_EDITORONLY_DATA
