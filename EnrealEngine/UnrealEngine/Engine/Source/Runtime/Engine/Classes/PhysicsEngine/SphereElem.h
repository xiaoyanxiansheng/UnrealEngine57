...
struct FKSphereElem : public FKShapeElem
{
	...
	FVector::FReal GetVolume(const FVector& Scale) const { return GetScaledVolume(Scale); }

	FVector::FReal GetScaledVolume(const FVector& Scale) const { return 1.3333f * UE_PI * FMath::Pow(Radius * Scale.GetAbsMin(), 3); }
