...
class UPhysicsAsset : public UObject, public IInterface_PreviewMeshProvider, public IInterface_AssetUserData
{
...
private:
	...
	// Asset User Data
public:
	ENGINE_API void AddAssetUserData(UAssetUserData* InUserData) override;
	ENGINE_API void RemoveUserDataOfClass(TSubclassOf<UAssetUserData> InUserDataClass) override;
	ENGINE_API UAssetUserData* GetAssetUserDataOfClass(TSubclassOf<UAssetUserData> InUserDataClass) override;
	ENGINE_API const TArray<UAssetUserData*>* GetAssetUserDataArray() const override;

private:
	UPROPERTY(EditAnywhere, AdvancedDisplay, Instanced, Category = UserData)
