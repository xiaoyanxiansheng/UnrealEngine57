...
#else // #if WITH_EDITOR
	inline FIntPoint GetImportedSize() const
	{
		return ImportedSize;
	}
...
public:
	...
	This function is not correct and should not be used. */
	inline int32 GetMinTextureResidentMipCount() const
	{
	...
	*/
	...
	/**
	 * Returns true if this virtual texture requires that it's physical pool is never split by the r.VT.PageTableSupportType=2 setting.
