...
public:
	...
	ENGINE_API virtual bool	IsNetGUIDAuthority() const;
	...
	ENGINE_API virtual FNetworkGUID	AssignNewNetGUID_Server( UObject* Object );
	ENGINE_API virtual FNetworkGUID	AssignNewNetGUIDFromPath_Server( const FString& PathName, UObject* ObjOuter, UClass* ObjClass );
	...
	static FNetworkGUID GetNetworkGUIDFromRemoteObjectId(const FRemoteObjectId RemoteObjectId, const bool bIsStatic);
	static FRemoteObjectId GetRemoteObjectIdFromNetworkGUID(const FNetworkGUID NetGuid);
#endif
