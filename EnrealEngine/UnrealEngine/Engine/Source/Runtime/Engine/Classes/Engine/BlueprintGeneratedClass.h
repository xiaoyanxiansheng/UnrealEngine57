...
public:
	...
	{
		// check(!RawPointer);
		// We don't want to check here because partially loaded blueprint classes may not be cleaned up properly. Re-enable if you are looking for specific ubergraph issues
	}
};
