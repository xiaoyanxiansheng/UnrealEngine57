...
private:
	...
	/** True if this request ever started loading from disk. bLoadCompleted may be set without a load starting if cancels or errors occur during download. */
	bool bLoadStarted;
...
{
	// Default priority for all async loads
	static inline constexpr TAsyncLoadPriority DefaultAsyncLoadPriority		= UE::StreamableManager::Private::DefaultAsyncLoadPriority;
	// Priority to try and load immediately
	static inline constexpr TAsyncLoadPriority AsyncLoadHighPriority		= UE::StreamableManager::Private::AsyncLoadHighPriority;

	static inline constexpr FStreamableDownloadPriority DownloadVeryLowPriority		= UE::StreamableManager::Private::DownloadVeryLowPriority;
	static inline constexpr FStreamableDownloadPriority DownloadLowPriority			= UE::StreamableManager::Private::DownloadLowPriority;
	static inline constexpr FStreamableDownloadPriority DownloadDefaultPriority		= UE::StreamableManager::Private::DownloadDefaultPriority;
	static inline constexpr FStreamableDownloadPriority DownloadHighPriority		= UE::StreamableManager::Private::DownloadHighPriority;
	static inline constexpr FStreamableDownloadPriority DownloadVeryHighPriority	= UE::StreamableManager::Private::DownloadVeryHighPriority;
