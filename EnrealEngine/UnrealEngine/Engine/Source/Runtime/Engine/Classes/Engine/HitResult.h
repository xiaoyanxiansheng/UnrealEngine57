...
struct FHitResult
{
	...
	inline void Reset(float InTime = 1.f, bool bPreserveTraceData = true)
	{
	...
	inline FActorInstanceHandle GetHitObjectHandle() const
	{
		return HitObjectHandle;
	}

	inline bool HasValidHitObjectHandle() const
	{
