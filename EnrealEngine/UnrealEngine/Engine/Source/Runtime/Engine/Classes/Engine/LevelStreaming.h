...
private:
	/** Used to get the CurrentState from an async task while it can be modified by the gamethread */
	mutable FTransactionallySafeRWLock CurrentStateLock;
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
	...
	ECurrentState GetCurrentState() const { return (ECurrentState)GetLevelStreamingState(); }
PRAGMA_ENABLE_DEPRECATION_WARNINGS

	ENGINE_API ELevelStreamingState GetLevelStreamingState() const;
