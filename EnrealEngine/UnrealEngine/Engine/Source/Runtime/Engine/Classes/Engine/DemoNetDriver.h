...
public:
	...
	ENGINE_API virtual void NotifyActorDestroyed(AActor* ThisActor, bool IsSeamlessTravel=false, EChannelCloseReason CloseReason = EChannelCloseReason::Destroyed) override;
