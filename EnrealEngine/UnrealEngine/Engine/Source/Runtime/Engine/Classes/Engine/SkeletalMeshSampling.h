...
struct FSkeletalMeshSamplingInfo
{
	...
	inline const FSkeletalMeshSamplingLODBuiltData& GetWholeMeshLODBuiltData(int32 LODIndex)const
	{
		return BuiltData.WholeMeshBuiltData[LODIndex];
	}

	inline int32 IndexOfRegion(FName RegionName)const
	{
	...
	inline const FSkeletalMeshSamplingRegion& GetRegion(int32 RegionIdx) const
	{
		return Regions[RegionIdx]; 
	}

	inline const FSkeletalMeshSamplingRegion* GetRegion(FName RegionName) const
	{
	...
	inline const FSkeletalMeshSamplingBuiltData& GetBuiltData()const
	{
		return BuiltData;
	}

	inline const FSkeletalMeshSamplingRegionBuiltData& GetRegionBuiltData(int32 RegionIndex)const
	{
		return BuiltData.RegionBuiltData[RegionIndex];
	}

	inline const FSkeletalMeshSamplingRegionBuiltData* GetRegionBuiltData(FName RegionName)const
	{
		int32 RegionIndex = IndexOfRegion(RegionName);
		if (RegionIndex != INDEX_NONE)
		{
