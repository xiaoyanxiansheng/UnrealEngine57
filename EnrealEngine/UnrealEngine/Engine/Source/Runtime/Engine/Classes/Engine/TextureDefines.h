...
enum TextureGroup : int
{
	...
	TEXTUREGROUP_Project33 UMETA(DisplayName="ini:Project Group 33"),
	TEXTUREGROUP_Project34 UMETA(DisplayName="ini:Project Group 34"),
	TEXTUREGROUP_Project35 UMETA(DisplayName="ini:Project Group 35"),
	TEXTUREGROUP_Project36 UMETA(DisplayName="ini:Project Group 36"),
	TEXTUREGROUP_Project37 UMETA(DisplayName="ini:Project Group 37"),
	TEXTUREGROUP_Project38 UMETA(DisplayName="ini:Project Group 38"),
	TEXTUREGROUP_Project39 UMETA(DisplayName="ini:Project Group 39"),
	TEXTUREGROUP_Project40 UMETA(DisplayName="ini:Project Group 40"),
	TEXTUREGROUP_Project41 UMETA(DisplayName="ini:Project Group 41"),
	TEXTUREGROUP_Project42 UMETA(DisplayName="ini:Project Group 42"),
	TEXTUREGROUP_Project43 UMETA(DisplayName="ini:Project Group 43"),
	TEXTUREGROUP_Project44 UMETA(DisplayName="ini:Project Group 44"),
	TEXTUREGROUP_Project45 UMETA(DisplayName="ini:Project Group 45"),
	TEXTUREGROUP_Project46 UMETA(DisplayName="ini:Project Group 46"),
	TEXTUREGROUP_Project47 UMETA(DisplayName="ini:Project Group 47"),
	TEXTUREGROUP_Project48 UMETA(DisplayName="ini:Project Group 48"),
	TEXTUREGROUP_MAX,
};
...
enum TextureCompressionSettings : int
{
	...
	TC_Masks					UMETA(DisplayName = "Masks (no sRGB)", ToolTip = "Same compression as Default"),
	TC_Grayscale				UMETA(DisplayName = "Grayscale (G8/16) from source R", ToolTip = "If SRGB is set, becomes uncompressed RGBA8; prefer BC4"),
	...
	TC_HDR						UMETA(DisplayName = "HDR (RGBA16F, no sRGB)", ToolTip = "Prefer HDR Compressed"),
	TC_EditorIcon				UMETA(DisplayName = "Uncompressed (RGBA8)", ToolTip = "Very high memory use; prefer BC7 or Default instead"),
	...
	TC_HDR_Compressed			UMETA(DisplayName = "HDR Compressed (BC6H)"),
	TC_BC7						UMETA(DisplayName = "BC7 Compressed (BC7)", ToolTip = "High quality compressed texture, same size as BC3"),
...
{
	TSM_Invalid = 0,   // Unknown / not set
	TSM_NotStreamed,   // not streamed (fully resident all the time)
	TSM_Streamed,      // traditional whole-mip streaming
	TSM_VirtualStreamed  // virtual texture (VT)
};
...
inline bool IsHDR(ETextureSourceFormat Format)
{
	return (Format == TSF_BGRE8 || Format == TSF_RGBA16F || Format == TSF_RGBA32F || Format == TSF_R16F || Format == TSF_R32F);
}

inline bool IsHDR(TextureCompressionSettings CompressionSettings)
{
...
inline bool IsUncompressed(TextureCompressionSettings CompressionSettings)
{
...
inline bool ShouldUseGreyScaleEditorVisualization(TextureCompressionSettings CompressionSettings)
{
