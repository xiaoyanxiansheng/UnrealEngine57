...
public:
	ENGINE_API ALevelBounds(const FObjectInitializer& ObjectInitializer);
...
protected:
	/** FTickableGameObject interface, this ticks only in the editor regardless of viewport 'Realtime' option */
...
#else
	// This never actually ticks as it starts disabled
