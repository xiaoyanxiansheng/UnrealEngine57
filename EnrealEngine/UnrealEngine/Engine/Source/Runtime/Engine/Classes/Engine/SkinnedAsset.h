...
DECLARE_LOG_CATEGORY_EXTERN(LogSkinnedAsset, Log, All)
...
public:
	...
	virtual bool HasHalfEdgeBuffer(int32 LODIndex) const
	...
	*/
	...
	virtual bool HasCompileDependencies() const { return false; }
	virtual bool HasAnyDependenciesCompiling() const { return false; }
	virtual TArray<USkinnedAsset*> GetSkinnedAssetDependencies() const { return {}; }
#endif // WITH_EDITOR
...
protected:
#if WITH_EDITORONLY_DATA
	ENGINE_API virtual void UpdateMaterialUVChannelData(FMeshUVChannelInfo& UVChannelData, int32 MaterialIndex);
#endif
