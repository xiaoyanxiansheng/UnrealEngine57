...
public:
	...
	virtual void Serialize(FArchive& Archive)
	{
		...
		{
			Archive << ServerTimeStamp;
			Archive << ServerTimeBeginningForcedUpdates;
			Archive << ServerTimeLastForcedUpdate;
			
			bool bTempTriggeringForcedUpdates = bTriggeringForcedUpdates;
			Archive << bTempTriggeringForcedUpdates;
			bTriggeringForcedUpdates = bTempTriggeringForcedUpdates;

			bool bTempForcedUpdateDurationExceeded = bForcedUpdateDurationExceeded;
			Archive << bTempForcedUpdateDurationExceeded;
			bForcedUpdateDurationExceeded = bTempForcedUpdateDurationExceeded;

			bool bTempLastRequestNeedsForcedUpdates = bLastRequestNeedsForcedUpdates;
			Archive << bTempLastRequestNeedsForcedUpdates;
			bLastRequestNeedsForcedUpdates = bTempLastRequestNeedsForcedUpdates;
		}
	}
};
