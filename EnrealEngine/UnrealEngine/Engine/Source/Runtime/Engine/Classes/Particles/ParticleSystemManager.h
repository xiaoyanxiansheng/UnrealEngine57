...
private:
	...
	struct FTickList
	{
		...
		void Reset();
		inline int32 Num()const { return TickList.Num(); }
		inline int32& operator[](const int32 Index) { return TickList[Index]; }
		inline TArray<int32>& Get() { return TickList; }
	};
...
public:
	...
	inline static FParticleSystemWorldManager* Get(UWorld* World)
	{
	...
	inline FPSCTickData& GetTickData(int32 Handle) { return PSCTickData[Handle]; }
	inline UParticleSystemComponent* GetManagedComponent(int32 Handle) { return ManagedPSCs[Handle]; }
...
private:
	...
	inline void FlushAsyncTicks(const FGraphEventRef& TickGroupCompletionGraphEvent);
	inline void QueueAsyncTick(int32 Handle, const FGraphEventRef& TickGroupCompletionGraphEvent);
