...
private:
	...
	/**
	 * Checks if the given action/axis binding name is deprecated. If it is, then log a warning.
	 * 
	 * @param BindingName The name of the 
	 */
	ENGINE_API static void LogDeprecatedBindingWarning(const FName BindingName);
