...
struct FPaintedVertex
{
	...
	inline friend FArchive& operator<<(FArchive& Ar, FPaintedVertex& PaintedVertex)
	{
...
public:
	...
	/** Number of tiles allocated to the material cache textures, may be modified by tag properties */
	UPROPERTY(EditAnywhere, Experimental, BlueprintReadWrite, Category = "Material Cache")
	FIntPoint MaterialCacheTileCount = FIntPoint(8, 8);
...
//~ End UPrimitiveComponent Interface.
	...
	*/
	...
	UE_DEPRECATED(5.7, "Please use SupportsDitheredLODTransitions with EShaderPlatform argument and not ERHIFeatureLevel::Type")
	...
	ENGINE_API virtual bool SupportsDitheredLODTransitions(EShaderPlatform ShaderPlatform);
	...
	inline bool IsReverseCulling() const { return bReverseCulling; }
	inline bool IsDisallowNanite() const { return bDisallowNanite; }
	inline bool IsForceDisableNanite() const { return bForceDisableNanite; }
	inline bool IsForceNaniteForMasked() const { return bForceNaniteForMasked; }
	inline int32 GetForcedLodModel() const { return ForcedLodModel; }
	inline bool GetOverrideMinLOD() const { return bOverrideMinLOD; }
	inline int32 GetMinLOD() const { return MinLOD; }
	inline bool GetForceNaniteForMasked() const { return bForceNaniteForMasked; }

#if WITH_EDITORONLY_DATA
	bool IsDisplayNaniteFallbackMesh() const { return bDisplayNaniteFallbackMesh; }
#endif

	ENGINE_API void UpdateMaterialCacheTextures();
	ENGINE_API void ReleaseMaterialCacheTextures();
	ENGINE_API UMaterialCacheVirtualTexture* GetMaterialCacheVirtualTexture(FGuid TagGuid) const;
