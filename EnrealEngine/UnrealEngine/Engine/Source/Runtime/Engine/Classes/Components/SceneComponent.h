...
public:
	...
	/** 
	 * Set the required detail level of this component.
...
public:
	...
	inline const FRotationConversionCache& GetRelativeRotationCache() const { return RelativeRotationCache; }
...
#if WITH_EDITOR
	UE_DEPRECATED(5.7, "IsTemporarilyHiddenInEditor is now deprecated.")
	bool IsTemporarilyHiddenInEditor(const bool bIncludeParent) const
	{
...
public:
	...
	inline void SetComponentToWorld(const FTransform& NewComponentToWorld)
	{
	 ...
	 */
	inline const FTransform& GetComponentToWorld() const 
	{ 
...
protected:
	...
	inline FTransform CalcNewComponentToWorld(const FTransform& NewRelativeTransform, const USceneComponent* Parent = nullptr, FName SocketName = NAME_None) const
	{
...
public:
	...
	inline bool IsQueryCollisionEnabled() const
	{
		return CollisionEnabledHasQuery(GetCollisionEnabled());
	}

	/** Utility to see if there is any physics collision enabled on this component. */
	inline bool IsPhysicsCollisionEnabled() const
	{
...
inline const TArray<TObjectPtr<USceneComponent>>& USceneComponent::GetAttachChildren() const
{
	return AttachChildren;
}

inline USceneComponent* USceneComponent::GetAttachParent() const
{
	return AttachParent;
}

inline FName USceneComponent::GetAttachSocketName() const
{
	return AttachSocketName;
}

inline void USceneComponent::ConditionalUpdateComponentToWorld()
{
...
inline bool USceneComponent::MoveComponent(const FVector& Delta, const FQuat& NewRotation, bool bSweep, FHitResult* Hit, EMoveComponentFlags MoveFlags, ETeleportType Teleport)
{
	return MoveComponentImpl(Delta, NewRotation, bSweep, Hit, MoveFlags, Teleport);
}

inline void USceneComponent::SetRelativeLocation(FVector NewLocation, bool bSweep, FHitResult* OutSweepHitResult, ETeleportType Teleport)
{
...
inline void USceneComponent::SetRelativeRotation(const FQuat& NewRotation, bool bSweep, FHitResult* OutSweepHitResult, ETeleportType Teleport)
{
	SetRelativeLocationAndRotation(GetRelativeLocation(), NewRotation, bSweep, OutSweepHitResult, Teleport);
}

inline void USceneComponent::AddRelativeLocation(FVector DeltaLocation, bool bSweep, FHitResult* OutSweepHitResult, ETeleportType Teleport)
{
...
inline void USceneComponent::AddRelativeRotation(FRotator DeltaRotation, bool bSweep, FHitResult* OutSweepHitResult, ETeleportType Teleport)
{
...
inline FScopedMovementUpdate* USceneComponent::GetCurrentScopedMovement() const
{
...
inline bool USceneComponent::IsDeferringMovementUpdates() const
{
	if (ScopedMovementStack.Num() > 0)
	{
...
inline bool USceneComponent::HasGroupedMovementUpdates() const
{
	if (ScopedMovementStack.Num() > 0)
	{
...
inline bool USceneComponent::GetShouldUpdatePhysicsVolume() const
{
