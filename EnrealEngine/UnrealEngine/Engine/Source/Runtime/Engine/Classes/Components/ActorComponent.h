...
inline EUpdateTransformFlags SkipPhysicsToEnum(bool bSkipPhysics){ return bSkipPhysics ? EUpdateTransformFlags::SkipPhysicsUpdate : EUpdateTransformFlags::None; }
...
#if WITH_EDITOR
	/**
	 * Creates an uninitialized component descriptor from this component. Meant to be called on the class CDO.
	 */
	ENGINE_API virtual TUniquePtr<class FWorldPartitionComponentDesc> CreateClassComponentDesc() const;

public:
	/**
	 * Creates an initialized component descriptor from this component.
	 */
	ENGINE_API TUniquePtr<class FWorldPartitionComponentDesc> CreateComponentDesc() const;

	/**
	 * Creates an uninitialized component descriptor from a specific class.
	 */
	static ENGINE_API TUniquePtr<class FWorldPartitionComponentDesc> StaticCreateClassComponentDesc(const TSubclassOf<UActorComponent>& ComponentClass);
#endif
...
public:
	...
	*/
	...
	UE_DEPRECATED(5.7, "This is being deprecated as part of iris beta. Override OnReplicationStartedForIris instead.")
...
private:
	...
	//ENGINE_API static void StartReplicatingForIris(UActorComponent* ActorComponent);
	//ENGINE_API static void StopReplicatingForIris(UActorComponent* ActorComponent);
...
public:
	...
	*/
	...
	inline bool IsReadyForEarlyEndOfFrameUpdate() const
	{
		return bReadyForEarlyEndOfFrameUpdate;
	}
	...
	inline bool IsPreRegistering() const
	{
	...
	inline bool IsPreUnregistering() const
	{
	...
	/** Check whether the component class allows reregistration during ReregisterAllComponents */
	inline bool AllowReregistration() const { return bAllowReregistration; }
...
inline bool UActorComponent::CanEverAffectNavigation() const
{
	return bCanEverAffectNavigation;
}

inline bool UActorComponent::IsNetSimulating() const
{
	return GetIsReplicated() && GetOwnerRole() != ROLE_Authority;
}

inline ENetMode UActorComponent::GetNetMode() const
{
...
inline bool UActorComponent::IsNetMode(ENetMode Mode) const
{
#if UE_EDITOR
...
inline void UActorComponent::ClearNeedEndOfFrameUpdate()
{
