...
public:
	...
	*/
	...
	inline	const USkinnedMeshComponent* GetBaseComponent()const
	{
...
public:
	 ...
	 * 
	 */
	virtual void RefreshBoneTransforms(FActorComponentTickFunction* TickFunction = nullptr) PURE_VIRTUAL(USkinnedMeshComponent::RefreshBoneTransforms, );
