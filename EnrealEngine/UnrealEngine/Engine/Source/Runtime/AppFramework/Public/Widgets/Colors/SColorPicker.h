...
private:
	...
	// Callback for start of eye dropper interactions.
	APPFRAMEWORK_API void HandleEyeDropperButtonBegin();
...
private:
	...
	/** The brush used as Color wheel as a TAttribute */
	TAttribute<const FSlateBrush*> ColorWheelBrush;
...
private:
	...
	/** The Color Wheel widget embedded in this picker */
