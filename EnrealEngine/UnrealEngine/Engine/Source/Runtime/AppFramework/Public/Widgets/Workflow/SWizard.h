...
public:
	...
	SLATE_SUPPORTS_SLOT_WITH_ARGS(FWizardPage)
		...
		/** Holds a flag indicating whether the previous and next buttons can be shown (default = true) */
		SLATE_ARGUMENT(bool, ShowHistoryButtons)
...
public:
	...
	/** Get the widget to focus on activation */
	APPFRAMEWORK_API TSharedPtr<SWidget> GetWidgetToFocusOnActivate();
...
private:
	...
	bool bShowHistoryButtons;

	TSharedPtr<SWidget> FinishButton;
