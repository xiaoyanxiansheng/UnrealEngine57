...
public:
	...
	inline FName GetObservedMessageType() const { return MessageType; }
	inline FAIRequestID GetObservedMessageID() const { return MessageID; }
	inline bool IsObservingMessageID() const { return bFilterByID; }
...
public:
	...
	inline AAIController* GetAIOwner() const { return AIOwner; }
...
inline UBlackboardComponent* UBrainComponent::GetBlackboardComponent()
{
	return BlackboardComp;
}

inline const UBlackboardComponent* UBrainComponent::GetBlackboardComponent() const
{
	return BlackboardComp;
}
