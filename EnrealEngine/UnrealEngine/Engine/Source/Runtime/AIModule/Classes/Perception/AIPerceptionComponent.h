...
struct FActorPerceptionInfo
{
	...
	*/
	inline FVector GetStimulusLocation(const FAISenseID Sense) const
	{
	...
	*/
	inline FVector GetReceiverLocation(const FAISenseID Sense) const
	{
	...
	*/
	inline bool HasKnownStimulusOfSense(const FAISenseID Sense) const
	{
	...
	*/
	inline bool IsSenseActive(const FAISenseID Sense) const
	{
...
public:
	...
	inline FPerceptionChannelAllowList GetPerceptionFilter() const { return PerceptionFilter; }

	AIMODULE_API FGenericTeamId GetTeamIdentifier() const;
	inline FPerceptionListenerID GetListenerId() const { return PerceptionListenerId; }

	AIMODULE_API FVector GetActorLocation(const AActor& Actor) const;
	inline const FActorPerceptionInfo* GetActorInfo(const AActor& Actor) const { return PerceptualData.Find(&Actor); }
	inline FActorPerceptionContainer::TIterator GetPerceptualDataIterator() { return FActorPerceptionContainer::TIterator(PerceptualData); }
	inline FActorPerceptionContainer::TConstIterator GetPerceptualDataConstIterator() const { return FActorPerceptionContainer::TConstIterator(PerceptualData); }
	...
	inline FAISenseID GetDominantSenseID() const { return DominantSenseID; }
