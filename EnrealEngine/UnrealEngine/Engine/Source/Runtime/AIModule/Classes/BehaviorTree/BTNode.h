...
inline UBehaviorTree* UBTNode::GetTreeAsset() const
{
	return TreeAsset;
}

inline UBTCompositeNode* UBTNode::GetParentNode() const
{
	return ParentNode;
}
...
inline uint16 UBTNode::GetExecutionIndex() const
{
	return ExecutionIndex;
}

inline uint16 UBTNode::GetMemoryOffset() const
{
	return MemoryOffset;
}

inline uint8 UBTNode::GetTreeDepth() const
{
	return TreeDepth;
}

inline void UBTNode::MarkInjectedNode()
{
	bIsInjected = true;
}

inline bool UBTNode::IsInjected() const
{
	return bIsInjected;
}

inline void UBTNode::ForceInstancing(bool bEnable)
{
...
inline bool UBTNode::HasInstance() const
{
	return bCreateNodeInstance;
}

inline bool UBTNode::IsInstanced() const
{
	return bIsInstanced;
}
