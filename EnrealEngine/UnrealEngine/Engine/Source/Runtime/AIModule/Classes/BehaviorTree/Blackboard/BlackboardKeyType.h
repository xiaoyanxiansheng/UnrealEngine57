...
inline uint16 UBlackboardKeyType::GetValueSize() const
{
	return ValueSize;
}

inline EBlackboardKeyOperation::Type UBlackboardKeyType::GetTestOperation() const
{
	return SupportedOp; 
}

inline bool UBlackboardKeyType::HasInstance() const
{
	return bCreateKeyInstance;
}

inline bool UBlackboardKeyType::IsInstanced() const
{
	return bIsInstanced;
}
