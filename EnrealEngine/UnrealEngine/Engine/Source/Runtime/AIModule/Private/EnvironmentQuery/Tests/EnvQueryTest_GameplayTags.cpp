...
void UEnvQueryTest_GameplayTags::RunTest(FEnvQueryInstance& QueryInstance) const
{
	...
	for (FEnvQueryInstance::ItemIterator It(this, QueryInstance); It; ++It)
	{
		...
		const IGameplayTagAssetInterface* GameplayTagAssetInterface = Cast<const IGameplayTagAssetInterface>(ItemActor);
		if (bSearchComponentsForTags && GameplayTagAssetInterface == nullptr)
		{
			GameplayTagAssetInterface = ItemActor->FindComponentByInterface<const IGameplayTagAssetInterface>();
		}
