...
void AEQSTestingPawn::AddReferencedObjects(UObject* InThis, FReferenceCollector& Collector)
{
	const AEQSTestingPawn* This = CastChecked<AEQSTestingPawn>(InThis);
	if (This->QueryInstance)
	{
		Collector.AddPropertyReferencesWithStructARO(FEnvQueryInstance::StaticStruct(), This->QueryInstance.Get(), This);
	}
