...
public:
	...
	UE_API UClass* GetPlaneComponentClass(void) const;
	/** @see PointComponentClass */
	UE_API UClass* GetPointComponentClass(void) const;
	/** @see FaceComponentClass */
	UE_API UClass* GetFaceComponentClass(void) const;
	/** @see ImageComponentClass */
	UE_API UClass* GetImageComponentClass(void) const;
	/** @see QRCodeComponentClass */
	UE_API UClass* GetQRCodeComponentClass(void) const;
	/** @see PoseComponentClass */
	UE_API UClass* GetPoseComponentClass(void) const;
	/** @see EnvironmentProbeComponentClass */
	UE_API UClass* GetEnvironmentProbeComponentClass(void) const;
	/** @see ObjectComponentClass */
	UE_API UClass* GetObjectComponentClass(void) const;
	/** @see MeshComponentClass */
	UE_API UClass* GetMeshComponentClass(void) const;
	/** @see GeoAnchorComponentClass */
	UE_API UClass* GetGeoAnchorComponentClass(void) const;
