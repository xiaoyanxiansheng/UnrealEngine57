...
private:
	 ...
	 */
	UE_API void OnTrackableAdded(UARTrackedGeometry* Added);
	/**
	 * Routes the notification to the proper delegate set
	 *
	 * @param Updated the updated ar trackable
	 */
	UE_API void OnTrackableUpdated(UARTrackedGeometry* Updated);
	/**
	 * Routes the notification to the proper delegate set
	 *
	 * @param Removed the removed ar trackable
	 */
	UE_API void OnTrackableRemoved(UARTrackedGeometry* Removed);
};
