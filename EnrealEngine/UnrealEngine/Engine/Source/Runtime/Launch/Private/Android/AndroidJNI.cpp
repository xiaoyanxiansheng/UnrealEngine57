...
#include "Android/AndroidJniNativeCalls.h"
...
if (Id == 0) \
{ \
	if (!bIsOptional) { Env->ExceptionDescribe(); checkf(Id != 0, TEXT("Failed to find " #Id)); } \
	Env->ExceptionClear(); \
}
#endif
...
void FJavaWrapper::FindClassesAndMethods(JNIEnv* Env)
{
	...
	GameActivityClassID = UE::Jni::Class<UE::Jni::FGameActivity>;
...
void FJavaWrapper::FindGooglePlayBillingMethods(JNIEnv* Env)
{
	...
	JavaStringClass = UE::Jni::Class<UE::Jni::Java::Lang::FString>;
...
UE::Jni::FGameActivity* UE::Jni::FGameActivity::Get()
{
	return reinterpret_cast<FGameActivity*>(FJavaWrapper::GameActivityThis);
}

void JNICALL UE::Jni::FGameActivity::nativeHandleNewIntentData(JNIEnv* jenv, jobject thiz, jstring JavaIntent)
{
	FAndroidMisc::HandleNewIntentUri(FJavaHelper::FStringFromParam(jenv, JavaIntent));
}

void JNICALL UE::Jni::FNativeCalls::WebViewVisible(JNIEnv* jenv, jclass clazz, jboolean bShown)
{
...
void JNICALL UE::Jni::FGameActivity::nativeVirtualKeyboardVisible(JNIEnv* jenv, jobject thiz, jboolean bShown)
{
...
void JNICALL UE::Jni::FGameActivity::nativeVirtualKeyboardShown(JNIEnv* jenv, jobject thiz, jint left, jint top, jint right, jint bottom)
{
...
static void nativeVirtualKeyboardResult(JNIEnv* jenv, jobject thiz, jboolean update, jstring contents, ETextEntryType textEntryType)
{
	...
	if (update == JNI_TRUE)
	{
		if (VirtualKeyboardWidget.IsValid())
		{
			...
			if (FTaskGraphInterface::IsRunning())
			{
				FFunctionGraphTask::CreateAndDispatchWhenReady([Contents=Contents, textEntryType=textEntryType]()
				{
					TSharedPtr<IVirtualKeyboardEntry> LockedKeyboardWidget(VirtualKeyboardWidget.Pin());
					if (LockedKeyboardWidget.IsValid())
					{
						LockedKeyboardWidget->SetTextFromVirtualKeyboard(FText::FromString(Contents), textEntryType);
					}
...
//This function is declared in the Java-defined class, GameActivity.java: "public native void nativeVirtualKeyboardResult(bool update, String contents);"
void JNICALL UE::Jni::FGameActivity::nativeVirtualKeyboardResult(JNIEnv* jenv, jobject thiz, jboolean update, jstring contents)
{
	::nativeVirtualKeyboardResult(jenv, thiz, update, contents, ETextEntryType::TextEntryAccepted);
}
void JNICALL UE::Jni::FGameActivity::nativeVirtualKeyboardDismissed(JNIEnv* jenv, jobject thiz, jboolean update, jstring contents)
{
	::nativeVirtualKeyboardResult(jenv, thiz, update, contents, ETextEntryType::TextEntryCanceled);
}
...
void JNICALL UE::Jni::FGameActivity::nativeVirtualKeyboardChanged(JNIEnv* jenv, jobject thiz, jstring contents)
{
	if (VirtualKeyboardWidget.IsValid())
	{
		FString Contents = FJavaHelper::FStringFromParam(jenv, contents);
...
void JNICALL UE::Jni::FGameActivity::nativeVirtualKeyboardSendKey(JNIEnv* jenv, jobject thiz, jint keyCode)
{
	if (FTaskGraphInterface::IsRunning())
	{
		// Dispatch when ready to delay the submit when the text is being changed by another task (e.g UE::Jni::FGameActivity::nativeVirtualKeyboardChanged)
...
void JNICALL UE::Jni::FGameActivity::nativeVirtualKeyboardSendSelection(JNIEnv* jenv, jobject thiz, jint selStart, jint selEnd)
{
...
JNIEXPORT jint JNI_OnLoad(JavaVM* InJavaVM, void* InReserved)
{
	...
	GJavaVM = InJavaVM;
	FAndroidApplication::InitializeJavaEnv();
...
void JNICALL UE::Jni::FGameActivity::nativeSetObbFilePaths(JNIEnv* jenv, jobject thiz, jstring OBBMainFilePath, jstring OBBPatchFilePath, jstring OBBOverflow1FilePath, jstring OBBOverflow2FilePath)
{
...
void JNICALL UE::Jni::FGameActivity::nativeSetGlobalActivity(JNIEnv* jenv, jobject thiz, jboolean bUseExternalFilesDir, jboolean bPublicLogFiles, jstring internalFilePath, jstring externalFilePath, jboolean bOBBinAPK, jstring APKFilename)
{
	...
	if (FJavaWrapper::GameActivityThis != nullptr)
	{
		...
		FJavaWrapper::GameActivityThis = nullptr;
	}
...
jboolean JNICALL UE::Jni::FGameActivity::nativeIsShippingBuild(JNIEnv* LocalJNIEnv, jobject LocalThiz)
{
#if UE_BUILD_SHIPPING
	return JNI_TRUE;
#else
...
void JNICALL UE::Jni::FGameActivity::nativeOnActivityResult(JNIEnv* jenv, jobject thiz, FGameActivity* activity, jint requestCode, jint resultCode, Android::Content::FIntent* data)
{
	FJavaWrapper::OnActivityResultDelegate.Broadcast(jenv, thiz, activity, requestCode, resultCode, data);
}

void JNICALL UE::Jni::FGameActivity::nativeHandleSensorEvents(JNIEnv* jenv, jobject thiz, Java::Lang::TArray<jfloat>* tilt, Java::Lang::TArray<jfloat>* rotation_rate, Java::Lang::TArray<jfloat>* gravity, Java::Lang::TArray<jfloat>* acceleration)
{
...
void JNICALL UE::Jni::FNativeCalls::CallNativeToEmbedded(JNIEnv* jenv, jclass clazz, jstring InID, jint Priority, jstring InSubsystem, jstring InCommand, Java::Lang::TArray<jstring>* InParams, jstring InRoutingFunction)
{
#if BUILD_EMBEDDED_APP
...
void JNICALL UE::Jni::FNativeCalls::SetNamedObject(JNIEnv* jenv, jclass clazz, jstring InName, jobject InObj)
{
	auto Name = FJavaHelper::FStringFromParam(jenv, InName);
	FEmbeddedDelegates::SetNamedObject(Name, (void*)InObj);
}

void JNICALL UE::Jni::FNativeCalls::KeepAwake(JNIEnv* jenv, jclass clazz, jstring InRequester, jboolean bIsForRendering)
{
	auto Requester = FJavaHelper::FStringFromParam(jenv, InRequester);
	FEmbeddedCommunication::KeepAwake(*Requester, bIsForRendering);
}

void JNICALL UE::Jni::FNativeCalls::AllowSleep(JNIEnv* jenv, jclass clazz, jstring InRequester)
{
	auto Requester = FJavaHelper::FStringFromParam(jenv, InRequester);
...
void JNICALL UE::Jni::FNativeCalls::UELogError(JNIEnv* jenv, jclass clazz, jstring InString)
{
...
void JNICALL UE::Jni::FNativeCalls::UELogWarning(JNIEnv* jenv, jclass clazz, jstring InString)
{
	const auto chars = jenv->GetStringUTFChars(InString, 0);
#if BUILD_EMBEDDED_APP
...
void JNICALL UE::Jni::FNativeCalls::UELogLog(JNIEnv* jenv, jclass clazz, jstring InString)
{
	const auto chars = jenv->GetStringUTFChars(InString, 0);
#if BUILD_EMBEDDED_APP
...
void JNICALL UE::Jni::FNativeCalls::UELogVerbose(JNIEnv* jenv, jclass clazz, jstring InString)
{
	const auto chars = jenv->GetStringUTFChars(InString, 0);
#if BUILD_EMBEDDED_APP
...
{
#if BUILD_EMBEDDED_APP
	ReplyMethod = FJavaWrapper::FindMethod(Env, GameActivityClassID, "AndroidThunkJava_OnNativeToEmbeddedReply", "(Ljava/lang/Object;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", false);
...
void JNICALL UE::Jni::FNativeCalls::ForwardNotification(JNIEnv* jenv, jclass clazz, jstring payload)
{
	//
}

void JNICALL UE::Jni::FNativeCalls::RouteServiceIntent(JNIEnv* jenv, jclass clazz, jstring InAction, jstring InPayload)
{
	// call to OnSafetyNetAttestationResultDelegate on game thread
	if (FTaskGraphInterface::IsRunning())
	{
...
void JNICALL UE::Jni::FGameActivity::nativeOnThermalStatusChangedListener(JNIEnv* jenv, jobject thiz, jint Status)
{
...
void JNICALL UE::Jni::FGameActivity::nativeOnTrimMemory(JNIEnv* jenv, jobject thiz, jint MemoryTrimValue)
{
	OnTrimMessage(MemoryTrimValue);
}
