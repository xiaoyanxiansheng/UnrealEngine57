...
void JNICALL UE::Jni::FGameActivity::nativeResumeMainInit(JNIEnv* jenv, jobject thiz)
{
...
static void ActivateApp_EventThread()
{
	...
	FAppEventManager::GetInstance()->SetAppIsActive(bAppIsActive_EventThread);
...
jint JNICALL UE::Jni::FGameActivity::nativeGetCPUFamily(JNIEnv* jenv, jobject thiz)
{
	return (jint)android_getCpuFamily();
}

jboolean JNICALL UE::Jni::FGameActivity::nativeSupportsNEON(JNIEnv* jenv, jobject thiz)
{
...
void JNICALL UE::Jni::FGameActivity::nativeOnOrientationChanged(JNIEnv* jenv, jobject thiz, jint orientation)
{
...
void JNICALL UE::Jni::FGameActivity::nativeConsoleCommand(JNIEnv* jenv, jobject thiz, jstring commandString)
{
...
void JNICALL UE::Jni::FGameActivity::nativeInitHMDs(JNIEnv* jenv, jobject thiz)
{
...
void JNICALL UE::Jni::FGameActivity::nativeSetAndroidVersionInformation(JNIEnv* jenv, jobject thiz, jstring androidVersion, jint targetSDKversion, jstring phoneMake, jstring phoneModel, jstring phoneBuildNumber, jstring osLanguage, jstring productName)
{
...
void JNICALL UE::Jni::FGameActivity::nativeOnInitialDownloadStarted(JNIEnv* jenv, jobject thiz)
{
...
void JNICALL UE::Jni::FGameActivity::nativeOnInitialDownloadCompleted(JNIEnv* jenv, jobject thiz)
{
	bIgnorePauseOnDownloaderStart = false;
}
...
void JNICALL UE::Jni::FNativeCalls::HandleCustomTouchEvent(JNIEnv* jenv, jclass clazz, jint deviceId, jint pointerId, jint action, jint soucre, jfloat x, jfloat y)
{
...
void JNICALL UE::Jni::FNativeCalls::AllowJavaBackButtonEvent(JNIEnv* jenv, jclass clazz, jboolean allow)
{
...
void JNICALL UE::Jni::Asis::FAsisGameActivity::nativeSetCommandline(JNIEnv* jenv, jclass clazz, jstring commandline)
{
	auto UECommandLine = FJavaHelper::FStringFromParam(jenv, commandline);
	GAndroidCommandLine = UECommandLine;
}

void JNICALL UE::Jni::Asis::FAsisGameActivity::nativeMain(JNIEnv* jenv, jclass clazz, jstring projectModule)
{
	...
	STANDALONE_DEBUG_LOGf(LogAndroid, TEXT("UE::Jni::Asis::FAsisGameActivity::nativeMain : use current!, requesting ProjectModule: %s"), *projectModuleName);
...
void JNICALL UE::Jni::Asis::FAsisGameActivity::nativeAppCommand(JNIEnv* jenv, jclass clazz, jint cmd)
{
