...
// Override this to define the compiled log level of LogNetFastTArray and reduce the amount of logs generated with each FastArray implementation
#ifndef UE_FAST_ARRAY_COMPILE_LOG_LEVEL
	#define UE_FAST_ARRAY_COMPILE_LOG_LEVEL All
#endif

// Runtime log level must be <= compiled log level
#ifndef UE_FAST_ARRAY_RUNTIME_LOG_LEVEL
...
struct FFastArraySerializerItem
{
	 ...
	 * NOTE: intentionally not virtual; invoked via templated code, @see FExampleItemEntry
	 */
	inline FString GetDebugString() { return FString(TEXT("")); }
};
...
struct FFastArraySerializer
{
	 ...
	 * NOTE: intentionally not virtual; invoked via templated code, @see FExampleItemEntry
	 */
	inline void PreReplicatedRemove(const TArrayView<int32>& RemovedIndices, int32 FinalSize) { }
	 ...
	 * NOTE: intentionally not virtual; invoked via templated code, @see FExampleItemEntry
	 */
	inline void PostReplicatedAdd(const TArrayView<int32>& AddedIndices, int32 FinalSize) { }
	 ...
	 * NOTE: intentionally not virtual; invoked via templated code, @see FExampleItemEntry
	 */
	inline void PostReplicatedChange(const TArrayView<int32>& ChangedIndices, int32 FinalSize) { }
