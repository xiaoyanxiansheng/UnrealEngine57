...
enum class ENetRefHandleError : uint32
{
	...
	BlockedByMustBeMapped, // An object is blocked due to MustBeMapped references not resolving fast enough
	BlockedByCreationParents, // An object is blocked waiting on creation parents that do not exist yet on the client.
};
