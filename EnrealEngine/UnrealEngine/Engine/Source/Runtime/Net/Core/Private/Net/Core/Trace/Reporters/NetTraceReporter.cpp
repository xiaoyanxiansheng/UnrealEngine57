...
UE_TRACE_EVENT_BEGIN(NetTrace, ObjectExistsEvent, NoSync)	
	UE_TRACE_EVENT_FIELD(uint64, TypeId)
	UE_TRACE_EVENT_FIELD(uint64, ObjectId)
	UE_TRACE_EVENT_FIELD(uint32, OwnerId)
	UE_TRACE_EVENT_FIELD(uint32, NameId)
...
UE_TRACE_EVENT_BEGIN(NetTrace, ObjectPolledEvent, NoSync)
	UE_TRACE_EVENT_FIELD(uint64, ObjectId)
...
UE_TRACE_EVENT_BEGIN(NetTrace, SubObjectEvent, NoSync)
