...
public:
	...
	DECLARE_MULTICAST_DELEGATE_OneParam(FBeginWidgetPrepass, const SWidget* /*Widget*/);
	static SLATECORE_API FBeginWidgetPrepass BeginWidgetPrepass;

	/** Called after a widget finishes its prepass. */
	DECLARE_MULTICAST_DELEGATE_OneParam(FEndWidgetPrepass, const SWidget* /*Widget*/);
