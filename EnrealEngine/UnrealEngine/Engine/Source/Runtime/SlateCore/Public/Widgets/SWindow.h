...
public:
	...
	void SetAcceptsInput(bool bEnabled) { bAcceptsInput = bEnabled; }
...
struct FScopedSwitchWorldHack
{
	inline FScopedSwitchWorldHack(const FWidgetPath& WidgetPath) { }
	inline FScopedSwitchWorldHack(TSharedPtr<SWindow> InWindow) { }
	inline ~FScopedSwitchWorldHack() { }
};
