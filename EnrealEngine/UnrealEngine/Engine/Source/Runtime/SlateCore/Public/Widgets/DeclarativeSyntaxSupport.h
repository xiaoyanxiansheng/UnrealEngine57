...
#define SLATE_PRIVATE_ATTRIBUTE_FUNCTION( AttrType, AttrName ) \
		...
		{ \
			_##AttrName.BindStatic( InFunc, Vars... ); \
			return static_cast<WidgetArgsType*>(this)->Me(); \
		} \
		\
		...
		{ \
			_##AttrName.BindLambda(InFunctor); \
			return static_cast<WidgetArgsType*>(this)->Me(); \
		} \
		\
		...
		{ \
			_##AttrName.BindRaw( InUserObject, InFunc, Vars... ); \
			return static_cast<WidgetArgsType*>(this)->Me(); \
		} \
		\
		...
		{ \
			_##AttrName.Bind( InUserObjectRef, InFunc, Vars... ); \
			return static_cast<WidgetArgsType*>(this)->Me(); \
		} \
		\
		/* Bind attribute with delegate to a shared pointer-based class method.  Slate mostly uses shared pointers so we use an overload for this type of binding. */ \
		...
		{ \
			_##AttrName.Bind( InUserObject, InFunc, Vars... ); \
			return static_cast<WidgetArgsType*>(this)->Me(); \
		} \
		\
		...
		{ \
			_##AttrName.BindUObject( InUserObject, InFunc, Vars... ); \
			return static_cast<WidgetArgsType*>(this)->Me(); \
		} \
...
#define SLATE_EVENT( DelegateName, EventName ) \
		...
		{ \
			_##EventName.BindStatic( InFunc, Vars... ); \
			return static_cast<WidgetArgsType*>(this)->Me(); \
		} \
		\
		...
		{ \
			_##EventName.BindLambda( Forward<FunctorType>(InFunctor), Vars... ); \
			return static_cast<WidgetArgsType*>(this)->Me(); \
		} \
		\
		...
		{ \
			_##EventName.BindRaw( InUserObject, InFunc, Vars... ); \
			return static_cast<WidgetArgsType*>(this)->Me(); \
		} \
		template< class UserClass, typename... VarTypes >	\
		...
		{ \
			_##EventName.BindSP( InUserObjectRef, InFunc, Vars... ); \
			return static_cast<WidgetArgsType*>(this)->Me(); \
		} \
		template< class UserClass, typename... VarTypes >	\
		...
		{ \
			_##EventName.BindSP( InUserObject, InFunc, Vars... ); \
			return static_cast<WidgetArgsType*>(this)->Me(); \
		} \
		template< class UserClass, typename... VarTypes >	\
		...
		{ \
			_##EventName.BindUObject( InUserObject, InFunc, Vars... ); \
			return static_cast<WidgetArgsType*>(this)->Me(); \
		} \
		template< class UserClass, typename... VarTypes >	\
...
struct TSlateDecl
{
		...
		: _RequiredArgs(InRequiredArgs)
	{
		...
		_Widget->bSupportsInvalidation = TWidgetTypeTraits<WidgetType>::SupportsInvalidation();
#endif
	}
