...
public:
	 ...
	 */
	inline UE::Slate::FDeprecateVector2DResult GetSize() const
	{
		return UE::Slate::FDeprecateVector2DResult(GetSize2f());
	}
	inline FVector2f GetSize2f() const
	{
	 ...
	 */
	inline UE::Slate::FDeprecateVector2DResult GetCenter() const
	{
		return UE::Slate::FDeprecateVector2DResult(GetCenter2f());
	}
	inline FVector2f GetCenter2f() const
	{
	 ...
	 */
	inline UE::Slate::FDeprecateVector2DResult GetTopLeft() const
	{
		return UE::Slate::FDeprecateVector2DResult(GetTopLeft2f());
	}
	inline FVector2f GetTopLeft2f() const
	{
	 ...
	 */
	inline UE::Slate::FDeprecateVector2DResult GetTopRight() const
	{
		return UE::Slate::FDeprecateVector2DResult(GetTopRight2f());
	}
	inline FVector2f GetTopRight2f() const
	{
	 ...
	 */
	inline UE::Slate::FDeprecateVector2DResult GetBottomRight() const
	{
		return UE::Slate::FDeprecateVector2DResult(GetBottomRight2f());
	}
	inline FVector2f GetBottomRight2f() const
	{
	 ...
	 */
	inline UE::Slate::FDeprecateVector2DResult GetBottomLeft() const
	{
		return UE::Slate::FDeprecateVector2DResult(GetBottomLeft2f());
	}
	inline FVector2f GetBottomLeft2f() const
	{
	 ...
	 */
	inline FSlateRect InsetBy(const struct FMargin& InsetAmount) const
	{
	 ...
	 */
	inline FSlateRect ExtendBy(const FMargin& ExtendAmount) const
	{
	 ...
	 */
	inline FSlateRect OffsetBy( const UE::Slate::FDeprecateVector2DParameter& OffsetAmount ) const
	{
	 ...
	 */
	inline FSlateRect ScaleBy(float ScaleBy) const
	{
	 ...
	 */
	inline FSlateRect Expand( const FSlateRect& Other ) const
	{
	 ...
	 */
	inline FSlateRect IntersectionWith(const FSlateRect& Other) const
	{
		bool bOverlapping;
	 ...
	 */
	inline bool ContainsPoint( const UE::Slate::FDeprecateVector2DParameter& Point ) const
	{
	...
	inline static bool IsRectangleContained( const FSlateRect& A, const FSlateRect& B )
	{
	...
	*/
	...
	friend inline uint32 GetTypeHash(const FSlateRect& Key)
	{
		uint32 Hash = 0;
