...
public:
	...
	/**  */
	inline bool GetShouldIntersectParent() const
	{
		return bIntersect;
	}

	/**  */
	inline void SetShouldIntersectParent(bool bValue)
	{
		bIntersect = bValue;
	}

	/**  */
	inline bool GetAlwaysClip() const
	{
		return bAlwaysClip;
	}

	/**  */
	inline void SetAlwaysClip(bool bValue)
	{
		bAlwaysClip = bValue;
	}
...
private:
	...
	friend inline uint32 GetTypeHash(const FSlateClippingZone& Zone)
	{
...
public:
	...
	inline void SetDebuggingStateIndex(int32 InStateIndex) const
	{
	...
	inline bool GetAlwaysClip() const { return EnumHasAllFlags(Flags, EClippingFlags::AlwaysClip); }
	 ...
	 */
	inline EClippingMethod GetClippingMethod() const
	{
