...
public:
	...
	inline SizeType RemoveSingle(const ElementType& Item, bool bAllowShrinking)
	{
	...
	inline SizeType RemoveSingleSwap(const ElementType& Item, bool bAllowShrinking)
	{
	...
	inline void RemoveAt(SizeType Index, SizeType NumToRemove, bool bAllowShrinking)
	{
	...
	inline void RemoveAtSwap(SizeType Index, SizeType NumToRemove, bool bAllowShrinking)
	{
