...
public:
	...
	*/
	...
	{
		NavigationMethodStruct = InNavigationMethodStruct;
	}
	...
	{
		NavigationRoutingPolicy = InNavigationRoutingPolicy;
	}

	EWidgetNavigationRoutingPolicy GetNavigationRoutingPolicy() const
	{
		return NavigationRoutingPolicy;
	}
...
private:
	...
	EWidgetNavigationRoutingPolicy NavigationRoutingPolicy = EWidgetNavigationRoutingPolicy::Default;
