...
public:
	...
	[[nodiscard]] inline FPaintArgs WithNewParent(const SWidget* PaintParent) const
	{
	...
	[[nodiscard]] inline FPaintArgs WithNewHitTestGrid(FHittestGrid& NewHitTestGrid) const
	{
