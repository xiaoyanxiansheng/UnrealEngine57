...
namespace InvalidationList
{
	...
	{
		using SlateInvalidationWidgetType = std::conditional_t<std::is_const_v<TSlateInvalidationWidgetList>, const typename TSlateInvalidationWidgetList::InvalidationWidgetType, typename TSlateInvalidationWidgetList::InvalidationWidgetType>;
