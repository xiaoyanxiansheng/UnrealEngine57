...
TSharedRef<ISlateStyle> FStarshipCoreStyle::Create()
{
	...
	// Common icons
	{
		...
		Style->Set("Icons.Error.Red.Outlined", new IMAGE_BRUSH_SVG("Starship/Common/alert-triangle-red-outlined", Icon16x16));
		...
		Style->Set("Icons.Export", new IMAGE_BRUSH_SVG("Starship/Common/export", Icon16x16));
		...
		Style->Set("Icons.TagCollection", new IMAGE_BRUSH_SVG("Starship/Common/TagCollection_16", Icon16x16));
		...
		// Material Graph Node Icons
		Style->Set("Icons.Preview", new IMAGE_BRUSH_SVG("Starship/Common/preview-default", Icon10x10));
		Style->Set("Icons.DropDown", new IMAGE_BRUSH_SVG("Starship/Common/caret-down", Icon10x10));
	...
	// SScrollBorder defaults...
	{
		...
		Style->Set("ScrollBorderNoShadow", FScrollBorderStyle()
			.SetTopShadowBrush(FSlateNoResource())
			.SetBottomShadowBrush(FSlateNoResource())
		);
	}
...
void FStarshipCoreStyle::SetupButtonStyles(TSharedRef<FStyle>& Style)
{
		...
		.SetPressedPadding(FMargin(2.f, 2.0f, 2.f, 0.0f));
	{
		...
		const FTextBlockStyle& NormalText = Style->GetWidgetStyle<FTextBlockStyle>("NormalText");
		const FTextBlockStyle ButtonText = FTextBlockStyle(NormalText).SetOverflowPolicy(ETextOverflowPolicy::Ellipsis);
		...
		Style->Set("PrimaryButtonText", FTextBlockStyle(ButtonText).SetFont(FStyleFonts::Get().NormalBold));
		...
		Style->Set("DialogButtonText", ButtonText);


		//@todo Recolor - Rename to simple button text
		Style->Set("SmallButtonText", FTextBlockStyle(ButtonText));
...
void FStarshipCoreStyle::SetupDockingStyles(TSharedRef<FStyle>& Style)
{
	...
	FDockTabStyle MinorTabStyle =
		...
		.SetColorOverlayTabBrush(FSlateColorBrush(FStyleColors::Foreground))
	...
	const FButtonStyle OpenTabInWindowButton = FButtonStyle()
		.SetNormal(IMAGE_BRUSH_SVG("Starship/Docking/OpenTabInWindow", Icon12x12, FStyleColors::Foreground))
		.SetPressed(IMAGE_BRUSH_SVG("Starship/Docking/OpenTabInWindow", Icon12x12, FStyleColors::Foreground))
		.SetHovered(IMAGE_BRUSH_SVG("Starship/Docking/OpenTabInWindow", Icon12x12, FStyleColors::ForegroundHover));

	Style->Set("Docking.OpenTabInWindow.Button", OpenTabInWindowButton);
}
...
void FStarshipCoreStyle::SetupMultiboxStyles(TSharedRef<FStyle>& Style)
{
	...
	// ToolBar
	{
		...
		// Callout Toolbar - Used to "call out" the toolbar button with text
		{
			...
			FToolBarStyle SlimToolbarStyleWidth100 = SlimToolbarStyle;
			SlimToolbarStyleWidth100.SetButtonTextMaxWidth(100);
			SlimToolbarStyleWidth100.SetButtonTextMinWidth(100);

			Style->Set("CalloutToolbar-Width100", SlimToolbarStyleWidth100);
