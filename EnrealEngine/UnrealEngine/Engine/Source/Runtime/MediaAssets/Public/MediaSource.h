...
public:
	...
	/** Gets a string that sums up the media source's description for UI purposes */
	virtual FString GetDescriptionString() const { return GetUrl(); }
	 ...
	 */
	MEDIAASSETS_API virtual void GetDetailsPanelInfoElements(TArray<FInfoElement>& OutInfoElements) const;
#endif // WITH_EDITOR
