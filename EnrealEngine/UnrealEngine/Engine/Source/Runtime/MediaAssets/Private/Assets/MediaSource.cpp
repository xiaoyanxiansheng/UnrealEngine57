...
void UMediaSource::GetDetailsPanelInfoElements(TArray<FInfoElement>& OutInfoElements) const
{
	OutInfoElements.Add(FInfoElement(
		NSLOCTEXT("MediaSource", "MediaConfigurationHeader", "Media Configuration"),
		NSLOCTEXT("MediaSource", "UrlLabel", "Url"),
		FText::FromString(GetUrl())));
}
#endif // WITH_EDITOR
