...
class FD3D11Buffer;
class FD3D11Texture;
class FD3D11UnorderedAccessView;
class FRHIBuffer;
class FRHITexture;
...
public:
	...
	/** Accessors. */
	inline int32 GetNumActiveTargets() const { return NumActiveTargets; }
	inline ID3D11RenderTargetView* GetRenderTargetView(int32 TargetIndex) { return RenderTargetViews[TargetIndex]; }
