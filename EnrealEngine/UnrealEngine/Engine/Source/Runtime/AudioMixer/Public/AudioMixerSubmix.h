...
namespace Audio
{
	...
	public:
		...
		// Return the owners path name 
		const FString& GetPathName() const { return SubmixPathName; }
...
#if UE_AUDIO_PROFILERTRACE_ENABLED
		// The path name of this submix (the owning USoundSubmix)
		FString SubmixPathName;
#endif // UE_AUDIO_PROFILERTRACE_ENABLED
