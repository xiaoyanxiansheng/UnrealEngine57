...
public:
	...
	/**
	 * When this function returns true, this behavior allows the Input Router to interrupt capturing and pass it on to a different Behavior with a higher priority.
	 */
	UE_EXPERIMENTAL(5.7, "Capture stealing is experimental behavior. Its implementation may change in the future.")
	INTERACTIVETOOLSFRAMEWORK_API virtual bool AllowsCaptureStealing();

	/**
	 * Call to set the default capture stealing attribute.
	 */
	UE_EXPERIMENTAL(5.7, "Capture stealing is experimental behavior. Its implementation may change in the future.")
	INTERACTIVETOOLSFRAMEWORK_API void SetAllowsCaptureStealing(TAttribute<bool> InAllowsCaptureStealing);
...
protected:
	...
	UE_EXPERIMENTAL(5.7, "Capture stealing is experimental behavior. Its implementation may change in the future.")
	/** value returned by AllowsCaptureStealing*/
	TAttribute<bool> CaptureStealing;
};
