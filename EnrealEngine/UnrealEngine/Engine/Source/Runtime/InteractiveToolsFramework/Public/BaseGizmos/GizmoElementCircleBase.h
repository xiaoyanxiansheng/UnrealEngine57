...
public:
	...
	// Multiplier applied to the circle radius when hovering
	INTERACTIVETOOLSFRAMEWORK_API virtual void SetHoverRadiusMultiplier(double InHoverRadiusMultiplier);
	INTERACTIVETOOLSFRAMEWORK_API virtual double GetHoverRadiusMultiplier() const;

	// Multiplier applied to the circle radius when interacting
	INTERACTIVETOOLSFRAMEWORK_API virtual void SetInteractRadiusMultiplier(double InInteractRadiusMultiplier);
	INTERACTIVETOOLSFRAMEWORK_API virtual double GetInteractRadiusMultiplier() const;

	// Multiplier applied to the circle radius when selected
	INTERACTIVETOOLSFRAMEWORK_API virtual void SetSelectRadiusMultiplier(double InSelectRadiusMultiplier);
	INTERACTIVETOOLSFRAMEWORK_API virtual double GetSelectRadiusMultiplier() const;

	// Multiplier applied to the circle radius when subdued
	INTERACTIVETOOLSFRAMEWORK_API virtual void SetSubdueRadiusMultiplier(double InSubdueRadiusMultiplier);
	INTERACTIVETOOLSFRAMEWORK_API virtual double GetSubdueRadiusMultiplier() const;
...
protected:
	...
	// Optional radius multipliers to apply when hovering, interacting, selected or subdued.
	UPROPERTY()
	FGizmoPerStateValueDouble RadiusMultiplier;
...
protected:
	...
	// Returns the current radius based on the current interaction state.
	INTERACTIVETOOLSFRAMEWORK_API double GetCurrentRadius() const;
