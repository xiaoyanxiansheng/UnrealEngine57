...
public:
	...
	// Multiplier applied to line thickness when selected
	INTERACTIVETOOLSFRAMEWORK_API virtual void SetSelectLineThicknessMultiplier(float InSelectLineThicknessMultiplier);
	INTERACTIVETOOLSFRAMEWORK_API virtual float GetSelectLineThicknessMultiplier() const;

	// Multiplier applied to line thickness when subdued
	INTERACTIVETOOLSFRAMEWORK_API virtual void SetSubdueLineThicknessMultiplier(float InSubdueLineThicknessMultiplier);
	INTERACTIVETOOLSFRAMEWORK_API virtual float GetSubdueLineThicknessMultiplier() const;
	...
	// Set line render state Select line color attribute. 
	//  @param InColor - Select line color to be set
	//  @param InOverridesChildState - when true, this Select line color will override the line color of all child elements.
	INTERACTIVETOOLSFRAMEWORK_API virtual void SetSelectLineColor(FLinearColor InColor, bool InOverridesChildState = false);

	// Get line render state interact line color attribute's value. 
	INTERACTIVETOOLSFRAMEWORK_API virtual FLinearColor GetSelectLineColor() const;

	// Returns true if line render state interact line color attribute has been set. 
	INTERACTIVETOOLSFRAMEWORK_API virtual bool HasSelectLineColor() const;

	// Get line render state interact line color attribute's override setting. 
	INTERACTIVETOOLSFRAMEWORK_API virtual bool DoesSelectLineColorOverrideChildState() const;

	// Clear line render state interact line color attribute.
	INTERACTIVETOOLSFRAMEWORK_API virtual void ClearSelectLineColor();

	// Set line render state subdue line color attribute. 
	//  @param InColor - subdue line color to be set
	//  @param InOverridesChildState - when true, this subdue line color will override the line color of all child elements.
	INTERACTIVETOOLSFRAMEWORK_API virtual void SetSubdueLineColor(FLinearColor InColor, bool InOverridesChildState = false);

	// Get line render state interact line color attribute's value. 
	INTERACTIVETOOLSFRAMEWORK_API virtual FLinearColor GetSubdueLineColor() const;

	// Returns true if line render state interact line color attribute has been set. 
	INTERACTIVETOOLSFRAMEWORK_API virtual bool HasSubdueLineColor() const;

	// Get line render state interact line color attribute's override setting. 
	INTERACTIVETOOLSFRAMEWORK_API virtual bool DoesSubdueLineColorOverrideChildState() const;

	// Clear line render state interact line color attribute.
	INTERACTIVETOOLSFRAMEWORK_API virtual void ClearSubdueLineColor();
