...
public:
	...
	{
		InternalDrawDirectionalArrow(TransformP((FVector)A), TransformP((FVector)B), TransformN(InNormal), LineColor, ArrowHeadSize, LineThickness, bDepthTested);
	}
	...
	{
		InternalDrawDirectionalArrow(TransformP((FVector)A), TransformP((FVector)B), TransformN(InNormal), Color, ArrowHeadSize, LineThickness, bDepthTested);
	}
	...
	{
		InternalDrawDirectionalArrow(TransformP((FVector)A), TransformP((FVector)B), TransformN(InNormal), Color, InArrowHeadSize, LineThicknessIn, bDepthTested);
	}
	...
	{
		InternalDrawDirectionalArrow(TransformP((FVector)A), TransformP((FVector)B), TransformN(InNormal), Color, InArrowHeadSize, LineThicknessIn, bDepthTestedIn);
	}
	...
	{
		InternalDrawGrid(Center, Normal, Size, Color, LineThicknessIn, bDepthTestedIn);
	}
	...
	{
		InternalDrawGrid(Center, Normal, Up, Side, Size, Color, LineThicknessIn, bDepthTestedIn);
	}
...
protected:
	...
	// actually does the arrow drawing; assumes A and B are already transformed
	INTERACTIVETOOLSFRAMEWORK_API virtual void InternalDrawDirectionalArrow(const FVector& A, const FVector& B, const FVector& InNormal, const FLinearColor& Color, const float InHeadSize, float LineThickness, bool bDepthTested);
	...
	INTERACTIVETOOLSFRAMEWORK_API virtual void InternalDrawGrid(const FVector& Center, const FVector& Normal, const FVector& Size, const FLinearColor& Color, float LineThickness, bool bDepthTested);
	// actually does the grid drawing
	INTERACTIVETOOLSFRAMEWORK_API virtual void InternalDrawGrid(const FVector& Center, const FVector& Normal, const FVector& Up, const FVector& Side, const FVector& Size, const FLinearColor& Color, float LineThickness, bool bDepthTested);
