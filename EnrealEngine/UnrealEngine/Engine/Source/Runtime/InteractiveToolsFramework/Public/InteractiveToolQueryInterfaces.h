...
#include "InteractiveTool.h" // EToolShutdownType, EToolShutdownReason
...
public:
	...
	enum class UE_DEPRECATED(5.7, "EShutdownReason has moved to InteractiveTool.h (under the name EToolShutdownReason).") EShutdownReason
	{
	 ...
	 */
	UE_DEPRECATED(5.7, "Prefer the GetPreferredShutdownType variant which uses EToolShutdownReason.")
	...
	{
		if (ShutdownReason == EToolShutdownReason::SwitchTool)
		{
			// todo: remove this special case when removing the deprecated variant of GetPreferredShutdownType.
			PRAGMA_DISABLE_DEPRECATION_WARNINGS
			return GetPreferredShutdownType(EShutdownReason::SwitchTool, StandardShutdownType);
			PRAGMA_ENABLE_DEPRECATION_WARNINGS
		}
