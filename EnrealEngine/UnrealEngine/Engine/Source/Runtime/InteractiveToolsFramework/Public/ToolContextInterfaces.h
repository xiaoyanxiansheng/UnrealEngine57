...
private:
	...
	TSharedPtr<SWidget> CursorOverrideWidget;
...
public:
	...
	{
		bIsCursorOverridden = true;
		CursorOverrideShape = EMouseCursor::Custom;
		CursorOverrideWidget = InCursorOverrideWidget;
	}

	/** Clears the custom widget, if any, resets the shape to Default and resets the overridden flag. */
