...
bool UInputBehavior::AllowsCaptureStealing()
{
	return CaptureStealing.IsSet() ? CaptureStealing.Get() : false;
}

void UInputBehavior::SetAllowsCaptureStealing(TAttribute<bool> InAllowsCaptureStealing)
{
	CaptureStealing = InAllowsCaptureStealing;
}
