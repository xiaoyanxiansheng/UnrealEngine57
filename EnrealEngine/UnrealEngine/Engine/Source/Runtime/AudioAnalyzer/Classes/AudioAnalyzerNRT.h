...
class UAudioAnalyzerNRT : public UAudioAnalyzerAssetBase
{
	...
	public:
		...
		AUDIOANALYZER_API void SetSound(USoundWave* InSound);
#endif
		...
		UPROPERTY(BlueprintAssignable, Category="Audio Analyzer")
		FOnAudioAnalyzerNRTAnalysisComplete OnAnalysisComplete;
#endif
