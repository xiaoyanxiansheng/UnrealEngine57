...
public:
	...
	FMetalAccelerationStructure* CreateAccelerationStructure(uint32 Size);
	void ReleaseAccelerationStructure(FMetalAccelerationStructure* AccelerationStructure);
#endif
