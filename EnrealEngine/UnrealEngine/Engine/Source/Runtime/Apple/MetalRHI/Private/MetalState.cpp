...
static MTL::BlendOperation TranslateBlendOp(EBlendOperation BlendOp)
{
	switch(BlendOp)
	{
		...
		case BO_ReverseSubtract:	return MTL::BlendOperationReverseSubtract;
...
static EBlendOperation TranslateBlendOp(MTL::BlendOperation BlendOp)
{
	switch(BlendOp)
	{
		...
		case MTL::BlendOperationReverseSubtract: 	return BO_ReverseSubtract;
	...
	: Device(MetalDevice)
{
	...
	{
		BindlessHandle = BindlessDescriptorManager->AllocateDescriptor(State);
	}
#endif
}
