...
DECLARE_LLM_MEMORY_STAT(TEXT("Metal AccelerationStructures"), STAT_MetalAccelerationStructuresLLM, STATGROUP_LLMPlatform);
...
const FLLMTagInfoMetal ELLMTagNamesMetal[] =
{
	...
	{ TEXT("Metal Acceleration Structures"),	GET_STATFNAME(STAT_MetalAccelerationStructuresLLM),	GET_STATFNAME(STAT_EngineSummaryLLM) },		// ELLMTagMetal::AccelerationStructures	
};
