...
UE_INTERNAL PHYSICSCORE_API FCollisionFilterData C2UFilterData(const FChaosFilterData& FilterData);
UE_INTERNAL PHYSICSCORE_API FChaosFilterData U2CFilterData(const FCollisionFilterData& FilterData);

UE_INTERNAL PHYSICSCORE_API FCollisionFilterData ToUnrealFilterData(const FChaosFilterData& FilterData);
