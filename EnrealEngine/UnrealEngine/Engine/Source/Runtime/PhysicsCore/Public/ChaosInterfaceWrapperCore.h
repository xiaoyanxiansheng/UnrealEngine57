...
UE_DEPRECATED(5.7, "Use GetCombinedShapeFilterData instead")  extern PHYSICSCORE_API FCollisionFilterData GetQueryFilterData(const Chaos::FPerShapeData& Shape);
UE_DEPRECATED(5.7, "Use GetCombinedShapeFilterData instead")  extern PHYSICSCORE_API FCollisionFilterData GetSimulationFilterData(const Chaos::FPerShapeData& Shape);
extern PHYSICSCORE_API Chaos::Filter::FShapeFilterData GetShapeFilterData(const Chaos::FPerShapeData& Shape);
extern PHYSICSCORE_API Chaos::Filter::FInstanceData GetFilterInstanceData(const Chaos::FPerShapeData& Shape);
extern PHYSICSCORE_API Chaos::Filter::FCombinedShapeFilterData GetCombinedShapeFilterData(const Chaos::FPerShapeData& Shape);


PHYSICSCORE_API ECollisionShapeType GetImplicitType(const Chaos::FImplicitObject& InGeometry);

inline ECollisionShapeType GetType(const Chaos::FImplicitObject& InGeometry)
{
