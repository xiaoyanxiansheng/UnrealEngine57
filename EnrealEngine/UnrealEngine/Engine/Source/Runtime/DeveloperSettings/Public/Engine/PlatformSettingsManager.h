...
public:
	...
	inline TPlatformSettingsClass* GetSettingsForPlatform() const
	{
	...
	template <typename TPlatformSettingsClass>
	inline TArray<TObjectPtr<UPlatformSettings>> GetAllPlatformSettings() const
	{
	...
	template <typename TPlatformSettingsClass>
	inline TPlatformSettingsClass* GetSettingsForPlatform(FName TargetIniPlatformName) const
	{
