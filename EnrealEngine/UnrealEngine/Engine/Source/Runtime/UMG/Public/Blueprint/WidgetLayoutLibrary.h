...
public:
	...
	static UMG_API bool ProjectWorldLocationToWidgetPosition(const APlayerController* PlayerController, FVector WorldLocation, FVector2D& ScreenPosition, bool bPlayerViewportRelative);
	 ...
	 */
	static UMG_API bool ProjectWorldLocationToWidgetPositionWithDistance(const APlayerController* PlayerController, FVector WorldLocation, FVector& ScreenPosition, bool bPlayerViewportRelative);
	...
	static UMG_API FVector2D GetViewportSize(const UObject* WorldContextObject);
	...
	static UMG_API FGeometry GetViewportWidgetGeometry(const UObject* WorldContextObject);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Viewport", meta=( WorldContext="WorldContextObject" ))
	static UMG_API FVector2D GetMousePositionOnViewport(const UObject* WorldContextObject);
	...
	static UMG_API bool GetMousePositionScaledByDPI(const APlayerController* Player, double& LocationX, double& LocationY);	// LWC_TODO: Temp stand in for native calls with FVector2D components.
	...
	*/
	...
	static UMG_API void RemoveAllWidgets(const UObject* WorldContextObject);
};
