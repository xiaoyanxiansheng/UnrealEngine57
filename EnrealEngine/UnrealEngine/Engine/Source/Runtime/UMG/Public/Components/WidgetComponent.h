...
public:
	...
	*/
	...
	/** To be called when a SlateUser enters this world space widget. */
	UMG_API void OnWorldUserEntered(int32 SlateUserIndex);
...
private: 
	...
	/** The Slate user ids of the users which have entered our world-space widget (and thus could've gotten focus). */
	TSet<int32> UsersEnteredWorldWidget;
	...
	/** When using World space, this will reset all the users focused on the active widget.  */
	UMG_API void ResetWorldUserFocusOnWidget();
