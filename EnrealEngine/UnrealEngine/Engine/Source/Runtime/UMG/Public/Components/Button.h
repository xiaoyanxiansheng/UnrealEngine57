...
protected:
	...
	UMG_API void SlateHandleOnReceivedFocus();
	UMG_API void SlateHandleOnLostFocus();

	// Drag and Drop
	UMG_API FReply SlateHandleDragDetected(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent);
	UMG_API void SlateHandleDragEnter(const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent);
	UMG_API void SlateHandleDragLeave(const FDragDropEvent& DragDropEvent);
	UMG_API FReply SlateHandleDragOver(const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent);
	UMG_API FReply SlateHandleDrop(const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent);
	// End Drag and Drop
