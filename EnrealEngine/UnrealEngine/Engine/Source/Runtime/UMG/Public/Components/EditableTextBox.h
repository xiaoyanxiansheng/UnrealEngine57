...
public:
	...
	/** The style */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Getter, Setter, Category=Appearance, meta=(DisplayName="Style", ShowOnlyInnerProperties))
...
public:
	...
	*/
	...
	UMG_API void SetWidgetStyle(const FEditableTextBoxStyle& InStyle);

	UMG_API const FEditableTextBoxStyle& GetWidgetStyle() const;
