...
public:
	...
	inline const FVector& GetLocation() const { return ViewLocation; }

	/** @return The transform's rotation */
	inline const FRotator& GetRotation() const { return ViewRotation; }

	/** @return The look at point for orbiting */
	inline const FVector& GetLookAt() const { return LookAt; }
