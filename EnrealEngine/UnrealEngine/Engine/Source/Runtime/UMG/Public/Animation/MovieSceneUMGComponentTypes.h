...
UMG_API void UnpackChannelsFromOperational(const FIntermediateMargin& In, const FProperty& Property, FUnpackedChannelValues& OutUnpackedValues);
UMG_API void UnpackChannelsFromOperational(const FIntermediateWidgetTransform& In, const FProperty& Property, FUnpackedChannelValues& OutUnpackedValues);
