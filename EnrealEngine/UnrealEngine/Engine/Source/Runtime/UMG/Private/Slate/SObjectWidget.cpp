...
SLATE_IMPLEMENT_WIDGET(SObjectWidget)
void SObjectWidget::PrivateRegisterAttributes(FSlateAttributeInitializer& AttributeInitializer)
{
}
...
{
#if SLATE_VERBOSE_NAMED_EVENTS && !WITH_EDITOR
