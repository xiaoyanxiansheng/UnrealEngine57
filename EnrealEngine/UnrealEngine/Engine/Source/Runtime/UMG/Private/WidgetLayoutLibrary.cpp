...
bool UWidgetLayoutLibrary::ProjectWorldLocationToWidgetPosition(const APlayerController* PlayerController, FVector WorldLocation, FVector2D& ViewportPosition, bool bPlayerViewportRelative)
{
...
bool UWidgetLayoutLibrary::ProjectWorldLocationToWidgetPositionWithDistance(const APlayerController* PlayerController, FVector WorldLocation, FVector& ViewportPosition, bool bPlayerViewportRelative)
{	
	if ( PlayerController )
	{
...
FVector2D UWidgetLayoutLibrary::GetMousePositionOnViewport(const UObject* WorldContextObject)
{
	if ( FSlateApplication::IsInitialized() )
	{
...
bool UWidgetLayoutLibrary::GetMousePositionScaledByDPI(const APlayerController* Player, float& LocationX, float& LocationY)
{
...
bool UWidgetLayoutLibrary::GetMousePositionScaledByDPI(const APlayerController* Player, double& LocationX, double& LocationY)
{
...
FVector2D UWidgetLayoutLibrary::GetViewportSize(const UObject* WorldContextObject)
{
...
FGeometry UWidgetLayoutLibrary::GetViewportWidgetGeometry(const UObject* WorldContextObject)
{
	UWorld* World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::LogAndReturnNull);
	if ( World && World->IsGameWorld() )
	{
...
void UWidgetLayoutLibrary::RemoveAllWidgets(const UObject* WorldContextObject)
{
	UWorld* World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::LogAndReturnNull);
	if ( World && World->IsGameWorld() )
	{
