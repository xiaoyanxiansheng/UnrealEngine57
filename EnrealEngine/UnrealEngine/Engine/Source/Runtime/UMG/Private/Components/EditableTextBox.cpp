...
void UEditableTextBox::SetWidgetStyle(const FEditableTextBoxStyle& InStyle)
{
	WidgetStyle = InStyle;
	if (MyEditableTextBlock.IsValid())
	{
		MyEditableTextBlock->SetStyle(&InStyle);
	}
}

const FEditableTextBoxStyle& UEditableTextBox::GetWidgetStyle() const
{
	return WidgetStyle;
}
