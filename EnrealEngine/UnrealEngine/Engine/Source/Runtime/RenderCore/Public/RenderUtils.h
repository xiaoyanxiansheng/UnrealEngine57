...
namespace Substrate
{
	...
	UE_DEPRECATED(5.7, "Plase use IsGlintEnabled(EShaderPlatform InPlatform)")
	...
	UE_DEPRECATED(5.7, "Plase use IsAdvancedVisualizationEnabled(EShaderPlatform InPlatform)")
