...
struct FRDGUploadData : public TArrayView<InElementType, int32>
{
	...
	inline int32 GetTotalSize() const { return this->Num() * this->GetTypeSize(); }
};
...
inline FRDGBufferRef CreateStructuredBuffer_Impl(
	FRDGBuilder& GraphBuilder,
	const TCHAR* Name,
 ...
 */
template <typename ElementType, typename AllocatorType>
inline FRDGBufferRef CreateByteAddressBuffer(
	FRDGBuilder& GraphBuilder,
	const TCHAR* Name,
	TArray<ElementType, AllocatorType>&& InitialData)
{
 ...
 */
template <typename ArrayType>
inline FRDGBufferRef CreateByteAddressBuffer_Impl(
	FRDGBuilder& GraphBuilder,
	const TCHAR* Name,
	TRDGBufferArrayCallback<ArrayType>&& ArrayCallback)
{
...
template <typename ElementType>
inline FRDGBufferRef CreateUploadBuffer(
	FRDGBuilder& GraphBuilder,
	const TCHAR* Name,
	uint32 BytesPerElement,
	uint32 NumElements,
 ...
 */
template <typename ElementType, typename AllocatorType>
inline FRDGBufferRef CreateStructuredUploadBuffer(
	FRDGBuilder& GraphBuilder,
	const TCHAR* Name,
	const TArray<ElementType, AllocatorType> &InitialData,
	ERDGInitialDataFlags InitialDataFlags = ERDGInitialDataFlags::None)
 ...
 */
template <typename ElementType, typename AllocatorType>
inline FRDGBufferRef CreateByteAddressUploadBuffer(
	FRDGBuilder& GraphBuilder,
	const TCHAR* Name,
	const TArray<ElementType, AllocatorType> &InitialData,
	ERDGInitialDataFlags InitialDataFlags = ERDGInitialDataFlags::None)
 ...
 */
template <typename ArrayType>
inline FRDGBufferRef CreateByteAddressUploadBuffer_Impl(
	FRDGBuilder& GraphBuilder,
	const TCHAR* Name,
	TRDGBufferArrayCallback<ArrayType>&& ArrayCallback)
{
...
inline void AddPass(FRDGBuilder& GraphBuilder, FRDGEventName&& Name, ExecuteLambdaType&& ExecuteLambda)
{
	GraphBuilder.AddPass(MoveTemp(Name), ERDGPassFlags::None, MoveTemp(ExecuteLambda));
}

template <typename ExecuteLambdaType>
inline void AddPassIfDebug(FRDGBuilder& GraphBuilder, FRDGEventName&& Name, ExecuteLambdaType&& ExecuteLambda)
{
...
inline void AddDispatchToRHIThreadPass(FRDGBuilder& GraphBuilder)
{
