...
public:
	 ...
	 */
	inline FRHIVertexShader*   GetVertexShader() const   { return VertexShader; }
	inline FRHIMeshShader*     GetMeshShader() const   { return MeshShader; }
	inline FRHIAmplificationShader*   GetAmplificationShader() const   { return AmplificationShader; }
	inline FRHIPixelShader*    GetPixelShader() const    { return PixelShader; }
	inline FRHIGeometryShader* GetGeometryShader() const { return GeometryShader; }

	/**
	* Get the RHI vertex declaration.
	*/
	inline FRHIVertexDeclaration* GetVertexDeclaration() const { return VertexDeclaration; }
...
public:
	 ...
	 * Get the RHI shader for the given frequency.
	 */
	inline FRHIVertexShader*   GetVertexShader() const   { return Key.GetVertexShader(); }
	inline FRHIMeshShader*     GetMeshShader() const     { return Key.GetMeshShader(); }
	inline FRHIAmplificationShader* GetAmplificationShader() const { return Key.GetAmplificationShader(); }
	inline FRHIPixelShader*    GetPixelShader() const    { return Key.GetPixelShader(); }
	inline FRHIGeometryShader* GetGeometryShader() const { return Key.GetGeometryShader(); }

	/**
	* Get the RHI vertex declaration.
	*/
	inline FRHIVertexDeclaration* GetVertexDeclaration() const { return Key.GetVertexDeclaration(); }
