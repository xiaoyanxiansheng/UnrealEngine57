...
inline const TCHAR* GetRenderQueryTypeName(ERenderQueryType QueryType)
{
	switch (QueryType)
	{
	default: checkNoEntry(); // fallthrough
	case RQT_Undefined:		return TEXT("Undefined");
	case RQT_Occlusion:		return TEXT("GPUOcclusion");
	case RQT_AbsoluteTime:	return TEXT("GPUAbsoluteTime");
	}
}
