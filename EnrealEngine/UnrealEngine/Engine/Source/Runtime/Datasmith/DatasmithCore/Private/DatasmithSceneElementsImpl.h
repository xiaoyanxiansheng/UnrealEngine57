...
class FDatasmithSceneImpl : public FDatasmithElementImpl< IDatasmithScene >
PRAGMA_ENABLE_DEPRECATION_WARNINGS
{
public:
	UE_API explicit FDatasmithSceneImpl(const TCHAR* InName);

	UE_API virtual void Reset() override;

	UE_API virtual const TCHAR* GetHost() const override;
	UE_API virtual void SetHost(const TCHAR* InHostname) override;
	...
	UE_API virtual TSharedPtr< IDatasmithMeshElement > GetMesh(int32 InIndex) override;
	UE_API virtual const TSharedPtr< IDatasmithMeshElement >& GetMesh(int32 InIndex) const override;
	virtual void RemoveMesh(const TSharedPtr< IDatasmithMeshElement >& InMesh) override { Meshes.Remove(InMesh); }
	UE_API virtual void RemoveMeshAt(int32 InIndex) override;
	virtual void EmptyMeshes() override { Meshes.Empty(); }

PRAGMA_DISABLE_DEPRECATION_WARNINGS
	UE_DEPRECATED(5.5, "The experimental Cloth importer is no longer supported.")
	UE_API virtual void AddCloth(const TSharedPtr< IDatasmithClothElement >& InElement) override;
	UE_DEPRECATED(5.5, "The experimental Cloth importer is no longer supported.")
	UE_API virtual int32 GetClothesCount() const override;
	UE_DEPRECATED(5.5, "The experimental Cloth importer is no longer supported.")
	UE_API virtual TSharedPtr< IDatasmithClothElement > GetCloth(int32 InIndex) override;
	UE_DEPRECATED(5.5, "The experimental Cloth importer is no longer supported.")
	UE_API virtual const TSharedPtr< IDatasmithClothElement >& GetCloth(int32 InIndex) const override;
	UE_DEPRECATED(5.5, "The experimental Cloth importer is no longer supported.")
	UE_API virtual void RemoveCloth(const TSharedPtr< IDatasmithClothElement >& InElement) override;
	UE_DEPRECATED(5.5, "The experimental Cloth importer is no longer supported.")
	UE_API virtual void RemoveClothAt(int32 InIndex) override;
	UE_DEPRECATED(5.5, "The experimental Cloth importer is no longer supported.")
	UE_API virtual void EmptyClothes() override;
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UE_API virtual TSharedPtr< IDatasmithActorElement > GetActor(int32 InIndex) override;
	UE_API virtual const TSharedPtr< IDatasmithActorElement >& GetActor(int32 InIndex) const override;
	UE_API virtual void RemoveActor(const TSharedPtr< IDatasmithActorElement >& InActor, EDatasmithActorRemovalRule RemoveRule) override;
	UE_API virtual void RemoveActorAt(int32 InIndex, EDatasmithActorRemovalRule RemoveRule) override;
	...
	UE_API virtual TSharedPtr< IDatasmithBaseMaterialElement > GetMaterial(int32 InIndex) override;
	UE_API virtual const TSharedPtr< IDatasmithBaseMaterialElement >& GetMaterial(int32 InIndex) const override;
	...
	UE_API virtual void RemoveMaterialAt(int32 InIndex) override;
	...
	UE_API virtual TSharedPtr< IDatasmithTextureElement > GetTexture(int32 InIndex) override;
	UE_API virtual const TSharedPtr< IDatasmithTextureElement >& GetTexture(int32 InIndex) const override;
	virtual void RemoveTexture(const TSharedPtr< IDatasmithTextureElement >& InTexture) override { Textures.Remove(InTexture); }
	UE_API virtual void RemoveTextureAt(int32 InIndex) override;
	...
	UE_API virtual TSharedPtr< IDatasmithMetaDataElement > GetMetaData(int32 InIndex) override;
	UE_API virtual const TSharedPtr< IDatasmithMetaDataElement >& GetMetaData(int32 InIndex) const override;
	UE_API virtual TSharedPtr< IDatasmithMetaDataElement > GetMetaData(const TSharedPtr<IDatasmithElement>& Element) override;
	UE_API virtual const TSharedPtr< IDatasmithMetaDataElement >& GetMetaData(const TSharedPtr<IDatasmithElement>& Element) const override;
	UE_API virtual void RemoveMetaData( const TSharedPtr<IDatasmithMetaDataElement>& Element ) override;
	UE_API virtual void RemoveMetaDataAt(int32 InIndex) override;
	...
	UE_API virtual TSharedPtr< IDatasmithLevelSequenceElement > GetLevelSequence(int32 InIndex) override;
	UE_API virtual const TSharedPtr< IDatasmithLevelSequenceElement >& GetLevelSequence(int32 InIndex) const override;
	...
	UE_API virtual void RemoveLevelSequenceAt(int32 InIndex) override;
	...
	UE_API virtual TSharedPtr< IDatasmithLevelVariantSetsElement > GetLevelVariantSets(int32 InIndex) override;
	UE_API virtual const TSharedPtr< IDatasmithLevelVariantSetsElement >& GetLevelVariantSets(int32 InIndex) const override;
	...
	UE_API virtual void RemoveLevelVariantSetsAt(int32 InIndex) override;

	UE_API virtual void AttachActor(const TSharedPtr< IDatasmithActorElement >& NewParent, const TSharedPtr< IDatasmithActorElement >& Child, EDatasmithActorAttachmentRule AttachmentRule) override;
	UE_API virtual void AttachActorToSceneRoot(const TSharedPtr< IDatasmithActorElement >& Child, EDatasmithActorAttachmentRule AttachmentRule) override;
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UE_API TMap< TSharedPtr< IDatasmithElement >, TSharedPtr< IDatasmithMetaDataElement> >& GetElementToMetaDataCache() const;
};
