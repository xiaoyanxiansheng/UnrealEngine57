...
public:
	...
	explicit consteval UObjectBaseUtility(UE::CodeGen::ConstInit::FObjectParams InParams)
	: UObjectBase(InParams)
	{
	}
#endif
	 ...
	 *
	 * @return the refcount of the object.
	 */
	UE_FORCEINLINE_HINT int32 GetRefCount() const
	{
		return GUObjectArray.IndexToObject(InternalIndex)->GetRefCount();
	}
	 ...
	 * @return				true if any of the passed in flags are set, false otherwise  (including no flags passed in).
	 */
	inline void SetInternalFlags(EInternalObjectFlags FlagsToSet) const
	{
	 ...
	 * @return				true if any of the passed in flags are set, false otherwise  (including no flags passed in).
	 */
	inline void ClearInternalFlags(EInternalObjectFlags FlagsToClear) const
	{
		FUObjectItem* ObjectItem = GUObjectArray.IndexToObject(InternalIndex);
	 ...
	 * @return				true if any of the passed in flags are set, false otherwise  (including no flags passed in).
	 */
	inline bool AtomicallyClearInternalFlags(EInternalObjectFlags FlagsToClear) const
	{
		FUObjectItem* ObjectItem = GUObjectArray.IndexToObject(InternalIndex);
...
private:
	...
	static UE_FORCEINLINE_HINT bool IsChildOfWorkaround(const ClassType* ObjClass, const ClassType* TestCls)
	{
...
public:
	 ...
	 *
	 * @param	SomeBase	The base class to check against, UClass* assignable. Cannot be null.
	 */
...
inline bool IsPossiblyAllocatedUObjectPointer(UObject* Ptr)
{
 ...
 * @return Name of the object.
*/
inline FName GetFNameSafe(const UObjectBaseUtility* Object)
{
	if (Object == nullptr)
	{
		return NAME_None;
...
*/
inline FString GetPathNameSafe(const UObjectBaseUtility* Object)
{
	if (Object == nullptr)
	{
		return TEXT("None");
...
*/
inline FString GetFullNameSafe(const UObjectBaseUtility* Object)
{
...
public:
	 ...
	 */
	inline FScopeCycleCounterUObject(const UObjectBaseUtility *Object)
	{
		UE_AUTORTFM_OPEN
		{
			if (Object)
	 ...
	 */
	inline FScopeCycleCounterUObject(const UObjectBaseUtility *Object, TStatId OtherStat)
	{
		UE_AUTORTFM_OPEN
		{
			if (Object)
	 ...
	 */
	inline ~FScopeCycleCounterUObject()
	{
...
public:
	UE_FORCEINLINE_HINT  FScopeCycleCounterUObject(const UObject* InStatObject, TStatId OtherStat = TStatId())
	{
