...
public:
	...
	COREUOBJECT_API static bool ConvertPathToProperties(UClass* ObjectClass, FStringView InPropertyPath, TArray<FProperty*>& OutProperties);
private:
...
{
public:
	UE_FORCEINLINE_HINT /* implicit */ FMemberId(EMemberlessId Memberless) : Index(0), MemberlessId((uint32)Memberless) {}
	UE_FORCEINLINE_HINT explicit FMemberId(uint32 Idx) : Index(Idx), MemberlessId(0) {}
