...
public:
	...
	consteval FEnumProperty(
		UE::CodeGen::ConstInit::FPropertyParams InBaseParams,
		FNumericProperty* InUnderlyingProperty,
		int32 InUnderlyingSize,
		UEnum* InEnum
	)
		: Super(InBaseParams.SetElementSize(InUnderlyingSize))
		, UnderlyingProp(InUnderlyingProperty)
		, Enum(InEnum)
	{
	}
#endif
	 ...
	 */
	inline void SetEnum(UEnum* InEnum)
	{
