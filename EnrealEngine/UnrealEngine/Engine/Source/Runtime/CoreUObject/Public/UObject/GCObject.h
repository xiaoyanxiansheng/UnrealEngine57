...
public:
	...
	DECLARE_TS_MULTICAST_DELEGATE_OneParam(FGCObjectAddedDelegate, FGCObject*);
 ...
 *
 * Note: FGCObject instances are not trivially relocatable, and are therefore not
 * suited for being stored in Unreal container types by value.
...
inline FGCObject::FGCObject(EFlags Flags)
