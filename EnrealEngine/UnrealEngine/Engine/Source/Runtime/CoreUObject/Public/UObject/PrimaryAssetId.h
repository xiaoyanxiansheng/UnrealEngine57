...
private:
	...
	UPROPERTY(EditAnywhere, SaveGame, BlueprintReadWrite, Category = PrimaryAssetType, meta=(AllowPrivateAccess))
	FName Name;
};
...
struct FPrimaryAssetId
{
	...
	inline friend FArchive& operator<<(FArchive& Ar, FPrimaryAssetId& Other)
	{
