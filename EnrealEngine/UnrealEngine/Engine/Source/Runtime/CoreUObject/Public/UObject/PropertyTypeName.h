...
private:
	[[nodiscard]] UE_REWRITE friend auto begin(const FPropertyTypeNameBuilder& Builder) { return Builder.Nodes.begin(); }
	[[nodiscard]] UE_REWRITE friend auto end(const FPropertyTypeNameBuilder& Builder) { return Builder.Nodes.end(); }
