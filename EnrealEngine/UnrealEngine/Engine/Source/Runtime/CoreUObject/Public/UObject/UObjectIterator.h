...
{
	return InternalExclusionFlags | EInternalObjectFlags::Unreachable | EInternalObjectFlags::AutoRTFMConstructionAborted | EInternalObjectFlags::PendingConstruction | UE::GetAsyncLoadingInternalFlagsExclusion()
#if UE_WITH_REMOTE_OBJECT_HANDLE
		| EInternalObjectFlags::Remote
#endif
		;
}
...
public:
	...
	*/
	...
	UE_FORCEINLINE_HINT bool operator==(const TObjectIterator& Rhs) const { return Index == Rhs.Index; }
	UE_FORCEINLINE_HINT bool operator!=(const TObjectIterator& Rhs) const { return Index != Rhs.Index; }
