...
public:
	...
	// Used to protect LinkerLoad from multithreaded access
...
public:
	...
	UE_FORCEINLINE_HINT static int32 GetHashBucket(FName Object)
	{
...
private:
	...
	/** Whether we already serialized import type hierarchies.																*/
	bool					bHasSerializedImportTypeHierarchies : 1;
...
private:
	...
	UE_FORCEINLINE_HINT bool ShouldReportProgress() const
	{
...
private:
	 ...
	 */
	inline virtual bool Precache(int64 PrecacheOffset, int64 PrecacheSize) override
	{
#if WITH_EDITOR
	...
	inline virtual void Seek(int64 InPos) override
	{
#if WITH_EDITOR
	...
	inline virtual int64 Tell() override
	{
#if WITH_EDITOR
	...
	inline virtual int64 TotalSize() override
	{
#if WITH_EDITOR
	...
	inline virtual void Serialize(void* V, int64 Length) override
	{
#if WITH_EDITOR
...
private:
	...
	/**
	 * Serializes the import type hierarchy map.
	 */
#if WITH_EDITORONLY_DATA
	FLinkerLoad::ELinkerStatus SerializeImportTypeHierarchies();
#endif
