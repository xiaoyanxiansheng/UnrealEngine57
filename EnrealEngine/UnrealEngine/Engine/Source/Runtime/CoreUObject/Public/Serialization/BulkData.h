...
enum EBulkDataFlags : uint32
{
	...
	BULKDATA_PayloadInSeparateFile = 1 << 8,
	BULKDATA_PayloadInSeperateFile UE_DEPRECATED(5.7, "This flag has been renamed to BULKDATA_PayloadInSeparateFile") = BULKDATA_PayloadInSeparateFile,
	/** DEPRECATED */
...
public:
	...
	* @return true if BULKDATA_PayloadInSeparateFile is set
	*/
	bool IsInSeparateFile() const
	{
		return	(GetBulkDataFlags() & BULKDATA_PayloadInSeparateFile) != 0;
	}
