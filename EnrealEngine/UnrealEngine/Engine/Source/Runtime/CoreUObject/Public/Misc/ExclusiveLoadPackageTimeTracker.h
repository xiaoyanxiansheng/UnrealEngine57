...
public:
	...
	UE_FORCEINLINE_HINT static void PushLoadPackage(FName PackageName)
	{
	...
	UE_FORCEINLINE_HINT static void PopLoadPackage(UPackage* LoadedPackage)
	{
#if WITH_LOADPACKAGE_TIME_TRACKER
	...
	/** Starts a time for the specified package name. */
	inline static bool PushPostLoad(UObject* PostLoadObject)
	{
#if WITH_LOADPACKAGE_TIME_TRACKER
	...
	UE_FORCEINLINE_HINT static void PopPostLoad(UObject* PostLoadObject)
	{
#if WITH_LOADPACKAGE_TIME_TRACKER
	...
	inline static void PushEndLoad()
	{
#if WITH_LOADPACKAGE_TIME_TRACKER
	...
	UE_FORCEINLINE_HINT static void PopEndLoad()
	{
#if WITH_LOADPACKAGE_TIME_TRACKER
	...
	UE_FORCEINLINE_HINT static void DumpReport(const TArray<FString>& Args)
	{
#if WITH_LOADPACKAGE_TIME_TRACKER
	...
	/** Resets the data. */
	UE_FORCEINLINE_HINT static void ResetReport()
	{
#if WITH_LOADPACKAGE_TIME_TRACKER
	...
	inline static double GetExclusiveLoadTime(FName PackageName)
	{
#if WITH_LOADPACKAGE_TIME_TRACKER
	...
	inline static double GetInclusiveLoadTime(FName PackageName)
	{
#if WITH_LOADPACKAGE_TIME_TRACKER
