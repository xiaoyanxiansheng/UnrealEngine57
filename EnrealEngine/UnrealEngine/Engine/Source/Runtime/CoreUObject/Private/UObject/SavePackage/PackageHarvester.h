...
private:
	...
	private:
		...
		bool bPreviousSavingOptionalObject;
	};
...
private:
	...
	void HarvestExport(UObject* InObject, UE::SavePackageUtilities::FObjectStatus& ObjectStatus);
	void TryHarvestImport(TObjectPtr<UObject> InObject, UE::SavePackageUtilities::FObjectStatus& ObjectStatus);
	void HarvestImport(TObjectPtr<UObject> InObject, UE::SavePackageUtilities::FObjectStatus& ObjectStatus);
	...
	void SetInstigatorFromProcessingStack(UE::SavePackageUtilities::FObjectStatus& ObjectStatus,
	...
	void HarvestImportTypeHierarchyNames(const UObject* Import);
#endif
