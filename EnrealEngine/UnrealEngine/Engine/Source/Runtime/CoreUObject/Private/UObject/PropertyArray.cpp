								...
								case EOverriddenPropertyOperation::Remove:
									{
										...
										{
											UE_LOG(LogOverridableObject, VeryVerbose, TEXT("Unable to save deleted item %s"), *SubNode.GetNodeID().ToDebugString());
										}
										break;
									}
								case EOverriddenPropertyOperation::Add:
									{
 										...
 										if (Index != INDEX_NONE)
										{
											...
											if (!bFilterExternalObjects || !InnerObjectProperty->GetObjectPropertyValue(ArrayHelper.GetElementPtr(Index))->IsPackageExternal())
											{
										...
										{
											UE_LOG(LogOverridableObject, VeryVerbose, TEXT("Unable to save added item %s"), *SubNode.GetNodeID().ToDebugString());
										}
										break;
									}
								default:
