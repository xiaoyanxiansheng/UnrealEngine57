 ...
 * To avoid diamond inheritance, this class specifies the base class for the interface it is implementing (either
 * FBasePackageWriter for IPackageWriter or FBaseCookedPackageWriter for ICookedPackageWriter) by template. Subclasses
 * should derive from one of
 *     TPackageWriterToSharedBuffer<FBasePackageWriter>
 *     TPackageWriterToSharedBuffer<FBaseCookedPackageWriter>.
 */
template <typename BaseClass>
class TPackageWriterToSharedBuffer : public BaseClass
{
public:
...
class FPackageWriterToRecord : public TPackageWriterToSharedBuffer<FBasePackageWriter>
{
public:
