	...
	: public UDeveloperSettings
{
	...
	inline FString GetReleaseIniSection() const { return TEXT("Analytics"); }
	inline FString GetDebugIniSection() const { return TEXT("AnalyticsDebug"); }
	inline FString GetTestIniSection() const { return TEXT("AnalyticsTest"); }
	inline FString GetDevelopmentIniSection() const { return TEXT("AnalyticsDevelopment"); }
	inline FString GetIniName() const { return FString::Printf(TEXT("%sDefaultEngine.ini"), *FPaths::SourceConfigDir()); }
