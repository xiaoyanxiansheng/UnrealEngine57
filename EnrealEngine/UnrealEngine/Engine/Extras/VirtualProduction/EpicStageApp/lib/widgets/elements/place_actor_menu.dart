  ...
  Widget build(BuildContext context) {
    ...
    return DropDownListMenu(
      ...
      children: [
        ...
        ListMenuSimpleItem(
          title: AppLocalizations.of(context)!.actorNameColorCorrectRegion,
          iconPath: 'packages/epic_common/assets/icons/color_correct_region.svg',
          onTap: () {
            actorCreator.createColorCorrectionRegion(actorCreationSettings);
            _closeMenu(context);
          },
        ),
        ListMenuSimpleItem(
...
class _RecentlyPlacedMenuItem extends StatelessWidget {
  ...
  String? get _iconPath {
    ...
    switch (actorData.type) {
      ...
      case RecentlyPlacedActorType.colorCorrectRegion:
        return 'packages/epic_common/assets/icons/color_correct_region.svg';
  ...
  String _getActorName(BuildContext context) {
    ...
    switch (actorData.type) {
      ...
      case RecentlyPlacedActorType.colorCorrectRegion:
        return AppLocalizations.of(context)!.actorNameColorCorrectRegion;
    }
  }
  ...
  void _createActor(BuildContext context) {
    ...
    if (actorData.templatePath != null) {
      ...
      switch (actorData.type) {
        ...
        case RecentlyPlacedActorType.colorCorrectRegion:
          actorCreator.createColorCorrectionRegion(actorSettings);
          break;
