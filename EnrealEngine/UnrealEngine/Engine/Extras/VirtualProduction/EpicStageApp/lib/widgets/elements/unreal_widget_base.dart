...
mixin UnrealWidgetStateMixin<WidgetType extends UnrealWidget, PropertyType> on State<WidgetType> {
  ...
  /// Returns the number of times the tracked properties have changed.
  int get trackedPropertyChangeCount => _singlePropertyController.trackedPropertyChangeCount;
