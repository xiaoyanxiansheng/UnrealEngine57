...
class StageMapState extends State<StageMap> with PreviewRenderConsumer, GuardedRefreshState {
          ...
          return PreferenceBuilder(
            ...
            builder: (BuildContext context, bool bIsInTransformMode) {
              ...
              for (MapEntry<String, _MapActorData> actorPair in _mapActorDataByPath.entries) {
                ...
                if ((stageMapSettings.bShowOnlySelectedPins.getValue() || widget.bShowOnlySelectedPins) &&
                    !selectedActorSettings.isActorSelected(actorPair.key)) {
                  continue;
                }
                          ...
                          child: Container(
                            ...
                            child: Wrap(
                              ...
                              children: [
                                ...
                                const _ShowOnlySelectedPinsToggle(),
  ...
  void initState() {
    ...
    _settingSubscriptions.addAll([
      ...
      stageMapSettings.bShowOnlySelectedPins.listen((_) => guardedRefresh()),
    ]);
...
/// Unique widget that lets the user toggle the mode that only shows selected pins
class _ShowOnlySelectedPinsToggle extends StatelessWidget {
  const _ShowOnlySelectedPinsToggle({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return PreferenceBuilder(
      preference: stageMapSettings.bShowOnlySelectedPins,
      builder: (_, final bool bShowOnlySelectedPins) => Container(
        decoration: BoxDecoration(
          color: Theme.of(context).colorScheme.surface,
          borderRadius: BorderRadius.circular(16),
        ),
        ...
        child: EpicIconButton(
          tooltipMessage: bShowOnlySelectedPins
              ? AppLocalizations.of(context)!.stageMapShowOnlySelectedPinsOff
              : AppLocalizations.of(context)!.stageMapShowOnlySelectedPinsOn,
          iconPath: 'assets/images/icons/show_selected_pins.svg',
          buttonSize: const Size(48, 36),
          bIsToggledOn: bShowOnlySelectedPins,
          onPressed: () => stageMapSettings.bShowOnlySelectedPins.setValue(!bShowOnlySelectedPins),
        ),
      ),
    );
  }
