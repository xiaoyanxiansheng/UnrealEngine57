...
class EpicStageAppAPIVersion implements Comparable<EpicStageAppAPIVersion> {
  ...
  /// Whether the engine supports the Blending Mode property for light cards.
  bool get bIsLightCardBlendingModeAvailable => this >= const EpicStageAppAPIVersion(1, 10, 0);
}
