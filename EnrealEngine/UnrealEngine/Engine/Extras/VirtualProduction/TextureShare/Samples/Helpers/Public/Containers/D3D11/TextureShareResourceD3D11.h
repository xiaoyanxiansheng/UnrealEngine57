...
public:
	...
	FTextureShareResourceD3D11(const float InGamma, const bool bCreateSRV = true)
		: bCreateSRV(bCreateSRV), FTextureShareCustomResource(InGamma)
	{ }

	FTextureShareResourceD3D11(const FIntPoint& InCustomSize, const float InGamma, const bool bCreateSRV = true)
		: bCreateSRV(bCreateSRV), FTextureShareCustomResource(InCustomSize, InGamma)
	{ }

	FTextureShareResourceD3D11(const DXGI_FORMAT InCustomFormat, const float InGamma, const bool bCreateSRV = true)
		: bCreateSRV(bCreateSRV), FTextureShareCustomResource(InCustomFormat, InGamma)
	{ }

	FTextureShareResourceD3D11(const FIntPoint& InCustomSize, const DXGI_FORMAT InCustomFormat, const float InGamma, const bool bCreateSRV = true)
		: bCreateSRV(bCreateSRV), FTextureShareCustomResource(InCustomSize, InCustomFormat, InGamma)
	{ }
