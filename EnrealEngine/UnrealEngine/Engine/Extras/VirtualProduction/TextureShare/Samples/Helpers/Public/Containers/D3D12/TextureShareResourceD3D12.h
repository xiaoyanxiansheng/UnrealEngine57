...
public:
	...
	// Constructors with Gamma parameter
	FTextureShareResourceD3D12(const EResourceSRV InSRVIndex, const float InGamma, uint32 InNodeMask = 0)
		: bCreateSRV(true), SRVIndex((uint32)InSRVIndex), FTextureShareCustomResource(InGamma), NodeMask(InNodeMask)
	{ }

	FTextureShareResourceD3D12(const EResourceSRV InSRVIndex, const FIntPoint& InCustomSize, const float InGamma, uint32 InNodeMask = 0)
		: bCreateSRV(true), SRVIndex((uint32)InSRVIndex), FTextureShareCustomResource(InCustomSize, InGamma), NodeMask(InNodeMask)
	{ }

	FTextureShareResourceD3D12(const EResourceSRV InSRVIndex, const DXGI_FORMAT InCustomFormat, const float InGamma, uint32 InNodeMask = 0)
		: bCreateSRV(true), SRVIndex((uint32)InSRVIndex), FTextureShareCustomResource(InCustomFormat, InGamma), NodeMask(InNodeMask)
	{ }

	FTextureShareResourceD3D12(const EResourceSRV InSRVIndex, const FIntPoint& InCustomSize, const DXGI_FORMAT InCustomFormat, const float InGamma, uint32 InNodeMask = 0)
		: bCreateSRV(true), SRVIndex((uint32)InSRVIndex), FTextureShareCustomResource(InCustomSize, InCustomFormat, InGamma), NodeMask(InNodeMask)
	{ }
