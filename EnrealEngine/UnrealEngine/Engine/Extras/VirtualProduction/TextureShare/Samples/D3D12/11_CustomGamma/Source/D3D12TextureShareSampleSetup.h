...
namespace TextureShareSample
{
	...
	// Use only this gamma for sample app
	...
	namespace Receive
	{
		...
		namespace Texture1
		{
			...
			static FTextureShareResourceD3D12 Resource(EResourceSRV::texture1, DisplayGamma);
		}
		...
		namespace Texture2
		{
			...
			// Container for receive: Texture size are not defined on the user side (values on the UE side are used)
			static FTextureShareResourceD3D12 Resource(EResourceSRV::texture2, DisplayGamma);
		}
	}
