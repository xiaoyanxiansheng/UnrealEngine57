...
protocol RtcPeerConnectionFlutterApiProtocol {
  /// Called when a new local ICE [candidate] is found for the PeerConnection with the given [connectionId].
  func onIceCandidate(connectionId connectionIdArg: Int64, candidate candidateArg: RtcIceCandidate?, completion: @escaping (Result<Void, FlutterError>) -> Void)
  /// Called when the [state] of the PeerConnection with the given [connectionId] changes.
  func onStateChanged(connectionId connectionIdArg: Int64, state stateArg: RtcPeerConnectionState, completion: @escaping (Result<Void, FlutterError>) -> Void)
  /// Called when a MediaStreamTrack (described in [event]) is added to the PeerConnection with the given
  /// [connectionId].
  func onTrack(connectionId connectionIdArg: Int64, event eventArg: RtcTrackEvent, completion: @escaping (Result<Void, FlutterError>) -> Void)
  /// Called when a DataChannel with the given [dataChannelId] is added to the PeerConnection with the given
  /// [connectionId].
  func onDataChannel(connectionId connectionIdArg: Int64, dataChannelId dataChannelIdArg: Int64, completion: @escaping (Result<Void, FlutterError>) -> Void)
}
class RtcPeerConnectionFlutterApi: RtcPeerConnectionFlutterApiProtocol {
  ...
  /// Called when a new local ICE [candidate] is found for the PeerConnection with the given [connectionId].
  func onIceCandidate(connectionId connectionIdArg: Int64, candidate candidateArg: RtcIceCandidate?, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.live_link_vcam.RtcPeerConnectionFlutterApi.onIceCandidate"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([connectionIdArg, candidateArg] as [Any?]) { response in
  ...
  /// Called when the [state] of the PeerConnection with the given [connectionId] changes.
  func onStateChanged(connectionId connectionIdArg: Int64, state stateArg: RtcPeerConnectionState, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.live_link_vcam.RtcPeerConnectionFlutterApi.onStateChanged"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([connectionIdArg, stateArg.rawValue] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName:channelName)))
        return
      }
  ...
  /// [connectionId].
  func onTrack(connectionId connectionIdArg: Int64, event eventArg: RtcTrackEvent, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.live_link_vcam.RtcPeerConnectionFlutterApi.onTrack"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([connectionIdArg, eventArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName:channelName)))
        return
      }
  ...
  /// [connectionId].
  func onDataChannel(connectionId connectionIdArg: Int64, dataChannelId dataChannelIdArg: Int64, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.live_link_vcam.RtcPeerConnectionFlutterApi.onDataChannel"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([connectionIdArg, dataChannelIdArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName:channelName)))
        return
      }
...
///
/// Generated protocol from Pigeon that represents Flutter messages that can be called from Swift.
protocol RtcDataChannelFlutterApiProtocol {
  /// Called when the [state] of the DataChannel with the given [dataChannelId] changes.
  func onStateChanged(dataChannelId dataChannelIdArg: Int64, state stateArg: RtcDataChannelState, completion: @escaping (Result<Void, FlutterError>) -> Void)
  /// Called when a message contained in [buffer] is received on the data channel with the given [dataChannelId].
  func onMessage(dataChannelId dataChannelIdArg: Int64, buffer bufferArg: RtcDataBuffer, completion: @escaping (Result<Void, FlutterError>) -> Void)
}
class RtcDataChannelFlutterApi: RtcDataChannelFlutterApiProtocol {
  private let binaryMessenger: FlutterBinaryMessenger
  init(binaryMessenger: FlutterBinaryMessenger){
    self.binaryMessenger = binaryMessenger
  }
  ...
  /// Called when the [state] of the DataChannel with the given [dataChannelId] changes.
  func onStateChanged(dataChannelId dataChannelIdArg: Int64, state stateArg: RtcDataChannelState, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.live_link_vcam.RtcDataChannelFlutterApi.onStateChanged"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([dataChannelIdArg, stateArg.rawValue] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName:channelName)))
        return
      }
  ...
  /// Called when a message contained in [buffer] is received on the data channel with the given [dataChannelId].
  func onMessage(dataChannelId dataChannelIdArg: Int64, buffer bufferArg: RtcDataBuffer, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.live_link_vcam.RtcDataChannelFlutterApi.onMessage"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([dataChannelIdArg, bufferArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName:channelName)))
        return
      }
...
class RtcVideoViewControllerHostApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: RtcVideoViewControllerHostApi?) {
    ...
    /// Get the texture ID associated with the VideoViewController with the given [controllerId].
    let getTextureIdChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.live_link_vcam.RtcVideoViewControllerHostApi.getTextureId", binaryMessenger: binaryMessenger)
    if let api = api {
      getTextureIdChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let controllerIdArg = args[0] is Int64 ? args[0] as! Int64 : Int64(args[0] as! Int32)
        do {
          let result = try api.getTextureId(controllerId: controllerIdArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getTextureIdChannel.setMessageHandler(nil)
    }
    /// Clear the image of the VideoViewController with the given [controllerId].
    let clearChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.live_link_vcam.RtcVideoViewControllerHostApi.clear", binaryMessenger: binaryMessenger)
    if let api = api {
      clearChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let controllerIdArg = args[0] is Int64 ? args[0] as! Int64 : Int64(args[0] as! Int32)
        do {
          try api.clear(controllerId: controllerIdArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
...
///
/// Generated protocol from Pigeon that represents Flutter messages that can be called from Swift.
protocol RtcVideoViewControllerFlutterApiProtocol {
  ...
  func onFirstFrameRendered(controllerId controllerIdArg: Int64, completion: @escaping (Result<Void, FlutterError>) -> Void)
  /// Called when the size of a VideoViewController's frame size changes.
  func onFrameSizeChanged(controllerId controllerIdArg: Int64, width widthArg: Int64, height heightArg: Int64, completion: @escaping (Result<Void, FlutterError>) -> Void)
}
class RtcVideoViewControllerFlutterApi: RtcVideoViewControllerFlutterApiProtocol {
  private let binaryMessenger: FlutterBinaryMessenger
  init(binaryMessenger: FlutterBinaryMessenger){
    self.binaryMessenger = binaryMessenger
  }
  ...
  /// created or cleared (whichever is latest).
  func onFirstFrameRendered(controllerId controllerIdArg: Int64, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.live_link_vcam.RtcVideoViewControllerFlutterApi.onFirstFrameRendered"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger)
    channel.sendMessage([controllerIdArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName:channelName)))
        return
      }
  ...
  /// Called when the size of a VideoViewController's frame size changes.
  func onFrameSizeChanged(controllerId controllerIdArg: Int64, width widthArg: Int64, height heightArg: Int64, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.live_link_vcam.RtcVideoViewControllerFlutterApi.onFrameSizeChanged"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger)
    channel.sendMessage([controllerIdArg, widthArg, heightArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName:channelName)))
        return
      }
