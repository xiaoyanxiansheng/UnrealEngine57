...
This repository is a **fork** of [the original **streaming_shared_preferences**](https://github.com/roughike/streaming_shared_preferences) with its dependencies updated to avoid vulnerabilities.
