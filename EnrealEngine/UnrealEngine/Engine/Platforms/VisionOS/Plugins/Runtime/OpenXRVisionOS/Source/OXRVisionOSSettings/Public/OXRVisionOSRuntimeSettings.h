...
public:
	...
	// Defines a rotation adjustment to the grip surface pose from the OpenXR visionOS native controller orientation.  We provide a default adjustment to grip surface.
	UPROPERTY(config, EditAnywhere, Category = "OpenXR visionOS", Meta = (DisplayName = "Grip Surface Pose Adjustment"))
	FRotator OXRVisionOSGripSurfacePoseAdjustment = FRotator(0.0f, 0.0f, 0.0f);
