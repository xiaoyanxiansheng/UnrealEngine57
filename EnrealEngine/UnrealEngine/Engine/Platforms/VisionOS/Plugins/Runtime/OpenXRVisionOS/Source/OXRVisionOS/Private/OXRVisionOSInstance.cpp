...
void FOXRVisionOSInstance::CreateInteractionProfiles()
{
	...
	if (IsExtensionEnabled(XR_EPIC_OXRVISIONOS_CONTROLLER_NAME))
	{
		...
		Pairs.Add(StringToPath("/user/hand/left/input/grip_surface/pose"), EOXRVisionOSControllerButton::GripSurfaceL);
		Pairs.Add(StringToPath("/user/hand/right/input/grip_surface/pose"), EOXRVisionOSControllerButton::GripSurfaceR);
